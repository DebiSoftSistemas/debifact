...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_fc_serie = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_total']['fc_serie'];
      }
      else
      {
          $this->array_total_fc_serie = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_order']['fc_serie']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_order']['fc_serie'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_order']['fc_serie'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['fc_serie'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['fc_serie'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['fc_serie'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['fc_serie'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['fc_serie'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['fc_serie'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['fc_serie'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_fc_serie as $i_fc_serie => $d_fc_serie) {
           if (!isset($i_fc_serie, $this->comp_label[0]) || !in_array($i_fc_serie, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_fc_serie[3] ] = $d_fc_serie[2];
               $this->comp_label[0][ $d_fc_serie[3] ] = $d_fc_serie[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'fc_serie', 'prot' => '@aspass@'),
       );
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_fc_serie => $l_fc_serie) {
           if (isset($this->array_total_fc_serie[$i_fc_serie])) {
               $this->comp_group[$i_fc_serie] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_fc_serie;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_fc_serie("res", $this->NM_export);
      ...
      if (is_array($this->array_total_fc_serie)) {
          ksort($this->array_total_fc_serie);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['SC_Ind_Groupby'];
...
{ 
   ...
   //---- 
   function adiciona_registro($sum_fp_valor, $quebra_fc_serie, $quebra_fc_serie_orig)
   {
      //----- fc_serie
      if (!isset($this->array_total_fc_serie[$quebra_fc_serie_orig]))
      {
         $this->array_total_fc_serie[$quebra_fc_serie_orig][0] = 1;
         $this->array_total_fc_serie[$quebra_fc_serie_orig][1] = $sum_fp_valor;
         $this->array_total_fc_serie[$quebra_fc_serie_orig][2] = $quebra_fc_serie;
         $this->array_total_fc_serie[$quebra_fc_serie_orig][3] = $quebra_fc_serie_orig;
      }
      else
      {
         $this->array_total_fc_serie[$quebra_fc_serie_orig][0]++;
         $this->array_total_fc_serie[$quebra_fc_serie_orig][1] = bcadd($this->array_total_fc_serie[$quebra_fc_serie_orig][1], $sum_fp_valor, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('fc_serie', 'fc_serie');
     $campos_order = $this->Ini->Get_date_order_groupby("fc_serie", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->fp_valor, $this->fc_serie, $this->fc_serie_orig);
            }
   }
//
