...
class reporte_gastos_forma_pago_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_fc_fecha;
   var $array_total_fp_descripcion;
   var $array_total_fc_serie;
   var $array_total_fac_secuencial;
   var $array_total_pr_nombre;
   var $array_total_pr_identificacion;
   var $array_total_fc_usuario;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_fc_fecha          = array();
      $this->array_total_fp_descripcion    = array();
      $this->array_total_fc_serie          = array();
      $this->array_total_fac_secuencial    = array();
      $this->array_total_pr_nombre         = array();
      $this->array_total_pr_identificacion = array();
      $this->array_total_fc_usuario        = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['reporte_gastos_forma_pago']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['reporte_gastos_forma_pago']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_total']['fc_fecha'] = $this->array_total_fc_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_total']['fp_descripcion'] = $this->array_total_fp_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_total']['fc_serie'] = $this->array_total_fc_serie;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_total']['fac_secuencial'] = $this->array_total_fac_secuencial;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_total']['pr_nombre'] = $this->array_total_pr_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_total']['pr_identificacion'] = $this->array_total_pr_identificacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_total']['fc_usuario'] = $this->array_total_fc_usuario;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['json_use_label'])
       {
          $Lab_fc_fecha = "fc_fecha";
          $Lab_fp_descripcion = "fp_descripcion";
          $Lab_fc_serie = "fc_serie";
          $Lab_fac_secuencial = "fac_secuencial";
          $Lab_pr_nombre = "pr_nombre";
          $Lab_pr_identificacion = "pr_identificacion";
          $Lab_fc_usuario = "fc_usuario";
       }
       else
       {
       $Lab_fc_fecha = "" . $this->Ini->Nm_lang['lang_fecha'] . "";
       $Lab_fc_fecha =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_fc_fecha);
       $Lab_fp_descripcion = "" . $this->Ini->Nm_lang['lang_forma_pago'] . "";
       $Lab_fc_serie = "" . $this->Ini->Nm_lang['lang_serie_sri'] . "";
       ...
       $Lab_fc_usuario = "" . $this->Ini->Nm_lang['lang_usuario'] . "";
       }
       $prep_field = array();
       $prep_field['fc_fecha'] = $Lab_fc_fecha;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_fecha'] = $Lab_fc_fecha; 
       $prep_field['fp_descripcion'] = $Lab_fp_descripcion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fp_descripcion'] = $Lab_fp_descripcion; 
       $prep_field['fc_serie'] = $Lab_fc_serie;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_serie'] = $Lab_fc_serie; 
       $prep_field['fac_secuencial'] = $Lab_fac_secuencial;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fac_secuencial'] = $Lab_fac_secuencial; 
       $prep_field['pr_nombre'] = $Lab_pr_nombre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_nombre'] = $Lab_pr_nombre; 
       $prep_field['pr_identificacion'] = $Lab_pr_identificacion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_identificacion'] = $Lab_pr_identificacion; 
       $prep_field['fc_usuario'] = $Lab_fc_usuario;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_usuario'] = $Lab_fc_usuario; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_serie'] = "" . $this->Ini->Nm_lang['lang_serie_sri'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fac_secuencial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fac_secuencial'] = "" . $this->Ini->Nm_lang['lang_secuencial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_nombre'] = "" . $this->Ini->Nm_lang['lang_proveedor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_total'] = "" . $this->Ini->Nm_lang['lang_othr_chrt_totl'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fp_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fp_descripcion'] = "" . $this->Ini->Nm_lang['lang_forma_pago'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fp_valor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fp_valor'] = "" . $this->Ini->Nm_lang['lang_valor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_comentario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_comentario'] = "" . $this->Ini->Nm_lang['lang_comentario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_telefono'] = "Pr Telefono"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fac_numero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fac_numero'] = "" . $this->Ini->Nm_lang['lang_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_tipo_comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_tipo_comprobante'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['tc_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['tc_nombre'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_proveedor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_proveedor'] = "" . $this->Ini->Nm_lang['lang_proveedor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_tipo_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['pr_tipo_identificacion'] = "" . $this->Ini->Nm_lang['lang_tipo_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['liq_estado_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['liq_estado_sri'] = "" . $this->Ini->Nm_lang['lang_estado_sri'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_usuario'] = "" . $this->Ini->Nm_lang['lang_usuario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_autorizacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_autorizacion'] = "" . $this->Ini->Nm_lang['lang_autorizacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['liq_error_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['liq_error_sri'] = "" . $this->Ini->Nm_lang['lang_mensaje'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['fc_estado'] = "" . $this->Ini->Nm_lang['lang_estado'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['lib_tipo_libretin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['labels']['lib_tipo_libretin'] = "" . $this->Ini->Nm_lang['lang_tipo_libretin'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "" .  $this->Ini->Nm_lang['lang_valor'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "fp_valor", 'show' => true),
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['fc_fecha']['alin'] = "''";
       $Arr_parms['fc_fecha']['link'] = "S";
       $Arr_parms['fp_descripcion']['alin'] = "''";
       $Arr_parms['fp_descripcion']['link'] = "S";
       $Arr_parms['fc_serie']['alin'] = "''";
       $Arr_parms['fc_serie']['link'] = "S";
       ...
       $Arr_parms['fc_usuario']['alin'] = "''";
       $Arr_parms['fc_usuario']['link'] = "S";
       $Arr_parms['fc_fecha']['fill'] = "true";
       $Arr_parms['fc_fecha']['order'] = "value";
       $Arr_parms['fc_fecha']['order_start'] = 'asc';
       $Arr_parms['fc_fecha']['order_invert'] = 'false';
       $Arr_parms['fc_fecha']['order_enabled'] = 'true';
       $Arr_parms['fc_fecha']['order_datatype'] = 'date';
       $Arr_parms['fc_fecha']['rating_function'] = '';
       $Arr_parms['fp_descripcion']['fill'] = "true";
       $Arr_parms['fp_descripcion']['order'] = "label";
       $Arr_parms['fp_descripcion']['order_start'] = 'asc';
       $Arr_parms['fp_descripcion']['order_invert'] = 'false';
       $Arr_parms['fp_descripcion']['order_enabled'] = 'true';
       $Arr_parms['fp_descripcion']['order_datatype'] = 'varchar';
       $Arr_parms['fp_descripcion']['rating_function'] = '';
       $Arr_parms['fc_serie']['fill'] = "true";
       $Arr_parms['fc_serie']['order'] = "label";
       $Arr_parms['fc_serie']['order_start'] = 'asc';
       $Arr_parms['fc_serie']['order_invert'] = 'false';
       $Arr_parms['fc_serie']['order_enabled'] = 'true';
       $Arr_parms['fc_serie']['order_datatype'] = 'varchar';
       $Arr_parms['fc_serie']['rating_function'] = '';
       ...
       $Arr_parms['fc_usuario']['fill'] = "true";
       $Arr_parms['fc_usuario']['order'] = "label";
       $Arr_parms['fc_usuario']['order_start'] = 'asc';
       $Arr_parms['fc_usuario']['order_invert'] = 'false';
       $Arr_parms['fc_usuario']['order_enabled'] = 'true';
       $Arr_parms['fc_usuario']['order_datatype'] = 'varchar';
       $Arr_parms['fc_usuario']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['fc_fecha'] = array(0 => 'fc_fecha', 1 => '@aspass@');
       $prep_links_fl['fp_descripcion'] = array(0 => 'fp_descripcion', 1 => '@aspass@');
       $prep_links_fl['fc_serie'] = array(0 => 'fc_serie', 1 => '@aspass@');
       ...
       $prep_links_fl['fc_usuario'] = array(0 => 'fc_usuario', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@reporte_gastos_forma_pago@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "reporte_gastos_forma_pago_total.class.php"); 
      }
      ...
      $this->Total   = new reporte_gastos_forma_pago_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['ajax_nav']) {  
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reporte_gastos_forma_pago_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_reporte_gastos_forma_pago_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reporte_gastos_forma_pago_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "reporte_gastos_forma_pago/reporte_gastos_forma_pago_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "reporte_gastos_forma_pago/reporte_gastos_forma_pago_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "reporte_gastos_forma_pago/reporte_gastos_forma_pago_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=reporte_gastos_forma_pago&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "reporte_gastos_forma_pago/reporte_gastos_forma_pago_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "reporte_gastos_forma_pago/reporte_gastos_forma_pago_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "reporte_gastos_forma_pago/reporte_gastos_forma_pago_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "reporte_gastos_forma_pago/reporte_gastos_forma_pago_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("reporte_gastos_forma_pago_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['reporte_gastos_forma_pago']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['reporte_gastos_forma_pago']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'reporte_gastos_forma_pago_config_pivot.php?nome_apl=reporte_gastos_forma_pago&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"reporte_gastos_forma_pago_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reporte_gastos_forma_pago_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "reporte_gastos_forma_pago/reporte_gastos_forma_pago_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $fc_fecha = (isset($Busca_temp['fc_fecha'])) ? $Busca_temp['fc_fecha'] : ""; 
          $tmp_pos = (is_string($fc_fecha)) ? strpos($fc_fecha, "##@@") : false;
          if ($tmp_pos !== false && !is_array($fc_fecha))
          {
              $fc_fecha = substr($fc_fecha, 0, $tmp_pos);
          }
          $fc_fecha_2 = (isset($Busca_temp['fc_fecha_input_2'])) ? $Busca_temp['fc_fecha_input_2'] : ""; 
          $fc_serie = (isset($Busca_temp['fc_serie'])) ? $Busca_temp['fc_serie'] : ""; 
          $tmp_pos = (is_string($fc_serie)) ? strpos($fc_serie, "##@@") : false;
          if ($tmp_pos !== false && !is_array($fc_serie))
          {
              $fc_serie = substr($fc_serie, 0, $tmp_pos);
          }
          $fp_descripcion = (isset($Busca_temp['fp_descripcion'])) ? $Busca_temp['fp_descripcion'] : ""; 
          $tmp_pos = (is_string($fp_descripcion)) ? strpos($fp_descripcion, "##@@") : false;
          if ($tmp_pos !== false && !is_array($fp_descripcion))
          {
              $fp_descripcion = substr($fp_descripcion, 0, $tmp_pos);
          }
          ...
          $fc_usuario = (isset($Busca_temp['fc_usuario'])) ? $Busca_temp['fc_usuario'] : ""; 
          $tmp_pos = (is_string($fc_usuario)) ? strpos($fc_usuario, "##@@") : false;
          if ($tmp_pos !== false && !is_array($fc_usuario))
          {
              $fc_usuario = substr($fc_usuario, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($sum_fp_valor, $quebra_fc_fecha, $quebra_fp_descripcion, $quebra_fc_serie, $quebra_fac_secuencial, $quebra_pr_nombre, $quebra_pr_identificacion, $quebra_fc_usuario, $quebra_fc_fecha_orig, $quebra_fp_descripcion_orig, $quebra_fc_serie_orig, $quebra_fac_secuencial_orig, $quebra_pr_nombre_orig, $quebra_pr_identificacion_orig, $quebra_fc_usuario_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_fp_valor)) {$sum_fp_valor = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_fp_valor . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_fp_valor . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->fc_fecha = $Busca_temp['fc_fecha']; 
       $this->fc_fecha = (isset($Busca_temp['fc_fecha'])) ? $Busca_temp['fc_fecha'] : ""; 
       $tmp_pos = (is_string($this->fc_fecha)) ? strpos($this->fc_fecha, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->fc_fecha))
       {
       ...
       $fc_fecha_2 = (isset($Busca_temp['fc_fecha_input_2'])) ? $Busca_temp['fc_fecha_input_2'] : ""; 
       $this->fc_fecha_2 = $fc_fecha_2; 
       $this->fc_serie = $Busca_temp['fc_serie']; 
       $this->fc_serie = (isset($Busca_temp['fc_serie'])) ? $Busca_temp['fc_serie'] : ""; 
       $tmp_pos = (is_string($this->fc_serie)) ? strpos($this->fc_serie, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->fc_serie))
       {
       ...
       $this->fp_descripcion = $Busca_temp['fp_descripcion']; 
       $this->fp_descripcion = (isset($Busca_temp['fp_descripcion'])) ? $Busca_temp['fp_descripcion'] : ""; 
       $tmp_pos = (is_string($this->fp_descripcion)) ? strpos($this->fp_descripcion, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->fp_descripcion))
       {
       ...
       $this->fc_usuario = $Busca_temp['fc_usuario']; 
       $this->fc_usuario = (isset($Busca_temp['fc_usuario'])) ? $Busca_temp['fc_usuario'] : ""; 
       $tmp_pos = (is_string($this->fc_usuario)) ? strpos($this->fc_usuario, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->fc_usuario))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fc_fecha = $rs_res->fields[0] ;  
            $this->fc_serie = $rs_res->fields[1] ;  
            $this->fac_secuencial = $rs_res->fields[2] ;  
            $this->pr_nombre = $rs_res->fields[3] ;  
            $this->pr_identificacion = $rs_res->fields[4] ;  
            $this->fc_total = $rs_res->fields[5] ;  
            $this->fp_descripcion = $rs_res->fields[6] ;  
            $this->fp_valor = $rs_res->fields[7] ;  
            $this->fc_comentario = $rs_res->fields[8] ;  
            $this->pr_direccion = $rs_res->fields[9] ;  
            $this->pr_email = $rs_res->fields[10] ;  
            $this->pr_telefono = $rs_res->fields[11] ;  
            $this->fc_usuario = $rs_res->fields[12] ;  
            $this->fc_fecha_orig = $this->fc_fecha;
            $this->fp_descripcion_orig = $this->fp_descripcion;
            $this->fc_serie_orig = $this->fc_serie;
            ...
            $this->fc_usuario_orig = $this->fc_usuario;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->fp_valor, $this->fc_fecha, $this->fp_descripcion, $this->fc_serie, $this->fac_secuencial, $this->pr_nombre, $this->pr_identificacion, $this->fc_usuario, $this->fc_fecha_orig,  $this->fp_descripcion_orig,  $this->fc_serie_orig,  $this->fac_secuencial_orig,  $this->pr_nombre_orig,  $this->pr_identificacion_orig,  $this->fc_usuario_orig);
            }
   }
//
