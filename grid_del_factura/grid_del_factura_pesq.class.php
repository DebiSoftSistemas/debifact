...
class grid_del_factura_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_del_factura_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_del_factura_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_del_factura_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_fac_comentario')
      {
          $fac_comentario = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_fac_comentario($fac_comentario);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cl_email')
      {
          $cl_email = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cl_email($cl_email);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> del_factura</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_del_factura/grid_del_factura_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_del_factura_ajax_search.js"></script>
 <script type="text/javascript" src="grid_del_factura_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_del_factura_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_factura']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_factura']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_est_codigo||-||pen_serie_cond#NMF#' + search_get_sel_txt('SC_sc_field_0_cond') + '@NMF@';
  str_out += 'SC_est_codigo||-||pen_serie#NMF#' + search_get_Dselelect('SC_sc_field_0_dest') + '@NMF@';
  str_out += 'SC_fac_secuencial_cond#NMF#' + search_get_sel_txt('SC_fac_secuencial_cond') + '@NMF@';
  str_out += 'SC_fac_secuencial#NMF#' + search_get_text('SC_fac_secuencial') + '@NMF@';
  str_out += 'SC_fac_comentario_cond#NMF#' + search_get_sel_txt('SC_fac_comentario_cond') + '@NMF@';
  str_out += 'SC_fac_comentario#NMF#' + search_get_text('SC_fac_comentario') + '@NMF@';
  str_out += 'id_ac_fac_comentario#NMF#' + search_get_title('select2-id_ac_fac_comentario-container') + '@NMF@';
  ...
  str_out += 'SC_cl_email_cond#NMF#' + search_get_sel_txt('SC_cl_email_cond') + '@NMF@';
  str_out += 'SC_cl_email#NMF#' + search_get_text('SC_cl_email') + '@NMF@';
  str_out += 'id_ac_cl_email#NMF#' + search_get_title('select2-id_ac_cl_email-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-fac_comentario").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_fac_comentario",
      max_itens: "10",
   ...
   $("#SC_fac_comentario").val(e.params.data.id);
  });
  ...
  $(".sc-ui-autocomp-cl_email").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_cl_email",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_cl_email").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $fac_secuencial_cond, $fac_secuencial,
             $fac_comentario_cond, $fac_comentario, $fac_comentario_autocomp,
             $cl_nombre_cond, $cl_nombre, $cl_nombre_autocomp,
             $cl_identificacion_cond, $cl_identificacion, $cl_identificacion_autocomp,
             $cl_email_cond, $cl_email, $cl_email_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fac_fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_dia']; 
          $fac_fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_mes']; 
          $fac_fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_ano']; 
          $fac_fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_input_2_dia']; 
          $fac_fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_input_2_mes']; 
          $fac_fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_input_2_ano']; 
          $fac_fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_cond']; 
          $sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['sc_field_0']; 
          $sc_field_0_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['sc_field_0_cond']; 
          $fac_secuencial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_secuencial']; 
          $fac_secuencial_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_secuencial_cond']; 
          $fac_comentario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_comentario']; 
          $fac_comentario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_comentario_cond']; 
          $cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['cl_nombre']; 
          $cl_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['cl_nombre_cond']; 
          $cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['cl_identificacion']; 
          $cl_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['cl_identificacion_cond']; 
          $cl_email = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['cl_email']; 
          $cl_email_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['cl_email_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['NM_operador']; 
      } 
      if (!isset($fac_fecha_cond) || empty($fac_fecha_cond))
      {
         $fac_fecha_cond = "eq";
      }
      if (!isset($fac_secuencial_cond) || empty($fac_secuencial_cond))
      {
         $fac_secuencial_cond = "qp";
      }
      if (!isset($fac_comentario_cond) || empty($fac_comentario_cond))
      {
         $fac_comentario_cond = "qp";
      }
      ...
      if (!isset($cl_email_cond) || empty($cl_email_cond))
      {
         $cl_email_cond = "eq";
      }
      ...
      $str_hide_fac_secuencial = (in_array($fac_secuencial_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fac_comentario = (in_array($fac_comentario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_cl_email = (in_array($cl_email_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_fac_secuencial = ('bw' == $fac_secuencial_cond) ? $display_aberto : $display_fechado;
      $str_display_fac_comentario = ('bw' == $fac_comentario_cond) ? $display_aberto : $display_fechado;
      ...
      $str_display_cl_email = ('bw' == $cl_email_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($fac_secuencial) || $fac_secuencial == "")
      {
          $fac_secuencial = "";
      }
      if (isset($fac_secuencial) && !empty($fac_secuencial))
      {
      ...
      if (!isset($fac_comentario) || $fac_comentario == "")
      {
          $fac_comentario = "";
      }
      if (isset($fac_comentario) && !empty($fac_comentario))
      {
      ...
      if (!isset($cl_email) || $cl_email == "")
      {
          $cl_email = "";
      }
      if (isset($cl_email) && !empty($cl_email))
      {
...
?>
      ...
      <TD id='SC_sc_field_0_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "" . $this->Ini->Nm_lang['lang_serie_sri'] . ""; ?></TD>
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_sc_field_0_orig" name="sc_field_0_orig" size=7 multiple onDblClick="nm_add_sel('sc_field_0_orig', 'sc_field_0_dest', 'N' , '')">
<?php
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('sc_field_0_orig', 'sc_field_0_dest', 'N', '');", "nm_add_all('sc_field_0_orig', 'sc_field_0_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('sc_field_0_orig', 'sc_field_0_dest', 'N', '');", "nm_add_sel('sc_field_0_orig', 'sc_field_0_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('sc_field_0_dest', 'sc_field_0_orig', 'N', '');", "nm_del_sel('sc_field_0_dest', 'sc_field_0_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('sc_field_0_dest', 'sc_field_0_orig', 'N', '');", "nm_del_all('sc_field_0_dest', 'sc_field_0_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectEven" id="SC_sc_field_0_dest" name="sc_field_0_dest" size=7 multiple  onDblClick="nm_del_sel('sc_field_0_dest', 'sc_field_0_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_sc_field_0" name="sc_field_0" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.sc_field_0_dest.selectedIndex = -1;</script>
<?php
?>
      ...
      <TD id='SC_fac_secuencial_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fac_secuencial'])) ? $this->New_label['fac_secuencial'] : "" . $this->Ini->Nm_lang['lang_secuencial'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_fac_secuencial_cond" name="fac_secuencial_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fac_secuencial" <?php echo $str_hide_fac_secuencial?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fac_secuencial'])) ? $this->New_label['fac_secuencial'] : "" . $this->Ini->Nm_lang['lang_secuencial'] . "";
 $nmgp_tab_label .= "fac_secuencial?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_fac_secuencial" name="fac_secuencial" value="<?php echo NM_encode_input($fac_secuencial) ?>"  size=9 alt="{datatype: 'text', maxLength: 9, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_fac_comentario_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fac_comentario'])) ? $this->New_label['fac_comentario'] : "" . $this->Ini->Nm_lang['lang_comentario'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_fac_comentario_cond" name="fac_comentario_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fac_comentario" <?php echo $str_hide_fac_comentario?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['fac_comentario'])) ? $this->New_label['fac_comentario'] : "" . $this->Ini->Nm_lang['lang_comentario'] . "";
 $nmgp_tab_label .= "fac_comentario?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $fac_comentario;
      }
?>
<INPUT  type="text" id="SC_fac_comentario" name="fac_comentario" value="<?php echo NM_encode_input($fac_comentario) ?>"  size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-fac_comentario" id="id_ac_fac_comentario" name="fac_comentario_autocomp"><?php if ('' !=  $fac_comentario) { ?><option value="<?php echo $fac_comentario ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-cl_identificacion" id="id_ac_cl_identificacion" name="cl_identificacion_autocomp"><?php if ('' !=  $cl_identificacion) { ?><option value="<?php echo $cl_identificacion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_cl_email_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cl_email'])) ? $this->New_label['cl_email'] : "" . $this->Ini->Nm_lang['lang_email'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_cl_email_cond" name="cl_email_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cl_email" <?php echo $str_hide_cl_email?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cl_email'])) ? $this->New_label['cl_email'] : "" . $this->Ini->Nm_lang['lang_email'] . "";
 $nmgp_tab_label .= "cl_email?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $cl_email;
      }
?>
<INPUT  type="text" id="SC_cl_email" name="cl_email" value="<?php echo NM_encode_input($cl_email) ?>"  size=50 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cl_email" id="id_ac_cl_email" name="cl_email_autocomp"><?php if ('' !=  $cl_email) { ?><option value="<?php echo $cl_email ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_del_factura_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_factura']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_del_factura']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
   nm_pack('sc_field_0_dest', 'sc_field_0');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   nm_del_all('sc_field_0_dest', 'sc_field_0_orig', 'N', '');
   document.F1.fac_secuencial_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_fac_secuencial'), document.F1.fac_secuencial_cond, 'fac_secuencial');
   document.F1.fac_secuencial.value = "";
   document.F1.fac_comentario_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_fac_comentario'), document.F1.fac_comentario_cond, 'fac_comentario');
   document.F1.fac_comentario.value = "";
   document.F1.fac_comentario_autocomp.value = "";
   $('#select2-id_ac_fac_comentario-container').html('<?php echo $this->Val_init_fac_comentario['desc'] ?>');;
   ...
   document.F1.cl_email_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_cl_email'), document.F1.cl_email_cond, 'cl_email');
   document.F1.cl_email.value = "";
   document.F1.cl_email_autocomp.value = "";
   $('#select2-id_ac_cl_email-container').html('<?php echo $this->Val_init_cl_email['desc'] ?>');;
   Sc_carga_select2('all');
 }
 ...
 {
    $('#SC_fac_fecha_dia').bind('change', function() {sc_grid_del_factura_valida_dia(this)});
    $('#SC_fac_fecha_input_2_dia').bind('change', function() {sc_grid_del_factura_valida_dia(this)});
    $('#SC_fac_fecha_input_2_mes').bind('change', function() {sc_grid_del_factura_valida_mes(this)});
    $('#SC_fac_fecha_mes').bind('change', function() {sc_grid_del_factura_valida_mes(this)});
 }
 function sc_grid_del_factura_valida_dia(obj)
 {
 ...
 function sc_grid_del_factura_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_sc_field_0'] = 'dselect';
      $tp_fields['SC_fac_secuencial_cond'] = 'cond';
      $tp_fields['SC_fac_secuencial'] = 'text';
      $tp_fields['SC_fac_comentario_cond'] = 'cond';
      $tp_fields['SC_fac_comentario'] = 'text_aut';
      $tp_fields['id_ac_fac_comentario'] = 'select2_aut';
      ...
      $tp_fields['SC_cl_email_cond'] = 'cond';
      $tp_fields['SC_cl_email'] = 'text_aut';
      $tp_fields['id_ac_cl_email'] = 'select2_aut';
      $tp_fields['SC_NM_operador'] = 'text';
      $tb_fields_esp['SC_est_codigo||-||pen_serie_cond'] = 'SC_sc_field_0_cond';
      $tb_fields_esp['SC_est_codigo||-||pen_serie'] = 'SC_sc_field_0';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $fac_fecha_cond, $fac_fecha, $fac_fecha_dia, $fac_fecha_mes, $fac_fecha_ano, $fac_fecha_input_2_dia, $fac_fecha_input_2_mes, $fac_fecha_input_2_ano,
             ...
             $cl_nombre_cond, $cl_nombre, $cl_nombre_autocomp,
             $cl_identificacion_cond, $cl_identificacion, $cl_identificacion_autocomp,
             $cl_email_cond, $cl_email, $cl_email_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca'] as $Cmps => $Vals)
          {
              if ($Cmps == 'sc_field_0')
              {
                  $$Cmps = implode("@?@", $Vals);
      ...
      if (!empty($fac_comentario_autocomp) && empty($fac_comentario))
      {
          $fac_comentario = $fac_comentario_autocomp;
      }
      ...
      if (!empty($cl_email_autocomp) && empty($cl_email))
      {
          $cl_email = $cl_email_autocomp;
      }
      if (!empty($sc_field_0))
      {
          $sc_field_0 = explode("@?@", $sc_field_0);
      ...
      $fac_secuencial_cond_salva = $fac_secuencial_cond; 
      if (!isset($fac_secuencial_input_2) || $fac_secuencial_input_2 == "")
      {
          $fac_secuencial_input_2 = $fac_secuencial;
      }
      $fac_comentario_cond_salva = $fac_comentario_cond; 
      if (!isset($fac_comentario_input_2) || $fac_comentario_input_2 == "")
      {
          $fac_comentario_input_2 = $fac_comentario;
      }
      ...
      $cl_email_cond_salva = $cl_email_cond; 
      if (!isset($cl_email_input_2) || $cl_email_input_2 == "")
      {
          $cl_email_input_2 = $cl_email;
      }
      if (is_array($sc_field_0)) {
          foreach ($sc_field_0 as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['psq_check_ret']['sc_field_0'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_dia'] = $fac_fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_mes'] = $fac_fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_ano'] = $fac_fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_input_2_dia'] = $fac_fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_input_2_mes'] = $fac_fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_input_2_ano'] = $fac_fecha_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fac_fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fac_fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fac_fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fac_fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fac_fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fac_fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_cond'] = $fac_fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['cmp'] = "fac_fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['opc'] = $fac_fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['fac_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['sc_field_0'] = $sc_field_0; 
      if (is_array($sc_field_0) && !empty($sc_field_0))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0] = $sc_field_0;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0][0] = $sc_field_0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['sc_field_0_cond'] = $sc_field_0_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['cmp'] = "sc_field_0"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['opc'] = $sc_field_0_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['sc_field_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_secuencial'] = $fac_secuencial; 
      if (is_array($fac_secuencial) && !empty($fac_secuencial))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0] = $fac_secuencial;
      }
      elseif ($fac_secuencial_cond_salva == "nu" || $fac_secuencial_cond_salva == "nn" || $fac_secuencial_cond_salva == "ep" || $fac_secuencial_cond_salva == "ne" || !empty($fac_secuencial))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0][0] = $fac_secuencial;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_secuencial_cond'] = $fac_secuencial_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['cmp'] = "fac_secuencial"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['opc'] = $fac_secuencial_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['fac_secuencial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_comentario'] = $fac_comentario; 
      if (is_array($fac_comentario) && !empty($fac_comentario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0] = $fac_comentario;
      }
      elseif ($fac_comentario_cond_salva == "nu" || $fac_comentario_cond_salva == "nn" || $fac_comentario_cond_salva == "ep" || $fac_comentario_cond_salva == "ne" || !empty($fac_comentario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0][0] = $fac_comentario;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_comentario_cond'] = $fac_comentario_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['cmp'] = "fac_comentario"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['opc'] = $fac_comentario_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['fac_comentario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['cl_nombre'] = $cl_nombre; 
      if (is_array($cl_nombre) && !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0] = $cl_nombre;
      }
      elseif ($cl_nombre_cond_salva == "nu" || $cl_nombre_cond_salva == "nn" || $cl_nombre_cond_salva == "ep" || $cl_nombre_cond_salva == "ne" || !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0][0] = $cl_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['cl_nombre_cond'] = $cl_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['cmp'] = "cl_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['opc'] = $cl_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['cl_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['cl_identificacion'] = $cl_identificacion; 
      if (is_array($cl_identificacion) && !empty($cl_identificacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0] = $cl_identificacion;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0][0] = $cl_identificacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['cl_identificacion_cond'] = $cl_identificacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['cmp'] = "cl_identificacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['opc'] = $cl_identificacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['cl_identificacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['cl_email'] = $cl_email; 
      if (is_array($cl_email) && !empty($cl_email))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0] = $cl_email;
      }
      elseif ($cl_email_cond_salva == "nu" || $cl_email_cond_salva == "nn" || $cl_email_cond_salva == "ep" || $cl_email_cond_salva == "ne" || !empty($cl_email))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['val'][0][0] = $cl_email;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['cl_email_cond'] = $cl_email_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['cmp'] = "cl_email"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid]['opc'] = $cl_email_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['cl_email'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['sc_field_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['sc_field_0'];
      $this->cmp_formatado['sc_field_0_input_2'] = $sc_field_0_input_2;
      $Conteudo = $fac_secuencial;
      $this->cmp_formatado['fac_secuencial'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($fac_comentario != '') {
      $fac_comentario_look = (is_string($fac_comentario) ? substr($this->Db->qstr($fac_comentario), 1, -1) : $fac_comentario); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['fac_comentario'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['fac_comentario'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['fac_comentario'] = $fac_comentario;
      }
      $nmgp_def_dados = array();
    if ($cl_nombre != '') {
      $cl_nombre_look = (is_string($cl_nombre) ? substr($this->Db->qstr($cl_nombre), 1, -1) : $cl_nombre); 
    ...
    if ($cl_email != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cl_email'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['cl_email'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cl_email'] = $cl_email;
      }
      ...
      if ($fac_fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha'] = $val[0];
          ...
          if ($fac_fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']['fac_fecha_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['fac_fecha']['label'] = $nmgp_tab_label['fac_fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['fac_fecha']['descr'] = $nmgp_tab_label['fac_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['fac_fecha']['hint']  = $nmgp_tab_label['fac_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      if (is_array($sc_field_0) && count($sc_field_0) != 0)
      {
         ...
         {
             $this->comando        .= " #lowerI#est_codigo||'-'||pen_serie#lowerF# not in (";
             $this->comando_sum    .= " #lowerI#del_factura.est_codigo||'-'||pen_serie#lowerF# not in (";
             $this->comando_filtro .= " #lowerI#est_codigo||'-'||pen_serie#lowerF# not in (";
         }
         else
         {
             $this->comando        .= " #lowerI#est_codigo||'-'||pen_serie#lowerF# in (";
             $this->comando_sum    .= " #lowerI#del_factura.est_codigo||'-'||pen_serie#lowerF# in (";
             $this->comando_filtro .= " #lowerI#est_codigo||'-'||pen_serie#lowerF# in (";
         }
         $x                     = count($sc_field_0);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($sc_field_0 as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($sc_field_0) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $nmgp_tab_label['sc_field_0'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['sc_field_0']['label'] = $nmgp_tab_label['sc_field_0'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['sc_field_0']['descr'] = $nmgp_tab_label['sc_field_0'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']['sc_field_0']['hint'] = $nmgp_tab_label['sc_field_0'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($sc_field_0) && ($sc_field_0_cond == "nu" || $sc_field_0_cond == "nn" || $sc_field_0_cond == "ep" || $sc_field_0_cond == "ne"))
      {
         $this->monta_condicao("est_codigo||'-'||pen_serie", $sc_field_0_cond, "", "", "sc_field_0", "", false);
      }

      //----- $fac_secuencial
      $this->Date_part = false;
      if (isset($fac_secuencial) || $fac_secuencial_cond == "nu" || $fac_secuencial_cond == "nn" || $fac_secuencial_cond == "ep" || $fac_secuencial_cond == "ne")
      {
         $this->monta_condicao("fac_secuencial", $fac_secuencial_cond, $fac_secuencial, "", "fac_secuencial", "TEXT", false);
      }

      //----- $fac_comentario
      $this->Date_part = false;
      if (isset($fac_comentario) || $fac_comentario_cond == "nu" || $fac_comentario_cond == "nn" || $fac_comentario_cond == "ep" || $fac_comentario_cond == "ne")
      {
         $this->monta_condicao("fac_comentario", $fac_comentario_cond, $fac_comentario, "", "fac_comentario", "VARCHAR", false);
      }
      ...
      //----- $cl_email
      $this->Date_part = false;
      if (isset($cl_email) || $cl_email_cond == "nu" || $cl_email_cond == "nn" || $cl_email_cond == "ep" || $cl_email_cond == "ne")
      {
         $this->monta_condicao("cl_email", $cl_email_cond, $cl_email, "", "cl_email", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['cond_pesq'] .= $this->NM_operador;
