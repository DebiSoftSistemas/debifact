...
?>
   <span id="idAjaxSelect_sc_field_0">
      <SELECT class="scFilterObjectEven" id="SC_sc_field_0" name="sc_field_0[]"  size="7" multiple>
<?php
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "sc_field_0" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
