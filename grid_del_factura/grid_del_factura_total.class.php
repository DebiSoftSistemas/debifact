...
class grid_del_factura_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_del_factura']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_del_factura']['campos_busca']))
      { 
   ...
   //---- 
   function quebra_geral_punto_emision($res_limit=false, $res_export=false)
   {
      global $nada, $nm_lang , $fac_estado;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['contr_total_geral'] = "OK";
   } 

   //-----  sc_field_0
   function quebra_sc_field_0_punto_emision($sc_field_0, $arg_sum_sc_field_0) 
   {
      global $tot_sc_field_0, $fac_estado;
