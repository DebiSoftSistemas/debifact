<?php
//
class form_del_detalle_factura_apl
{
   ...
   var $form_vert_form_del_detalle_factura = array();
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['df_cantidad_nc_']))
          {
              $this->df_cantidad_nc_ = $this->NM_ajax_info['param']['df_cantidad_nc_'];
          }
          if (isset($this->NM_ajax_info['param']['df_descripcion_']))
          {
              $this->df_descripcion_ = $this->NM_ajax_info['param']['df_descripcion_'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['df_precio_sin_subsidio_']))
          {
              $this->df_precio_sin_subsidio_ = $this->NM_ajax_info['param']['df_precio_sin_subsidio_'];
          }
      ...
      $this->sc_conv_var['df_descripcion'] = "df_descripcion_";
      ...
      $this->sc_conv_var['df_cantidad_nc'] = "df_cantidad_nc_";
      $this->sc_conv_var['df_precio_sin_subsidio'] = "df_precio_sin_subsidio_";
      $this->sc_conv_var['df_bodega'] = "df_bodega_";
      $this->sc_conv_var['df_costo'] = "df_costo_";
      $this->sc_conv_var['df_unidad'] = "df_unidad_";
      if (!empty($_FILES))
      {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_del_detalle_factura($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_del_detalle_factura_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_detalle_factura']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_detalle_factura'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_detalle_factura']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_detalle_factura']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_del_detalle_factura') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_detalle_factura']['label'] = "Agregar Producto";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_del_detalle_factura")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->nm_new_label['df_descripcion_'] = '' . $this->Ini->Nm_lang['lang_inf_adicional'] . '';
      ...
      $this->nm_new_label['df_porcentaje_iva_'] = '' . $this->Ini->Nm_lang['lang_porcentaje_iva'] . '';
      $this->nm_new_label['df_valor_iva_'] = '' . $this->Ini->Nm_lang['lang_iva'] . '';
      $this->nm_new_label['df_base_ice_'] = '' . $this->Ini->Nm_lang['lang_base_ice'] . '';
      $this->nm_new_label['df_porcentaje_ice_'] = '' . $this->Ini->Nm_lang['lang_porcentaje_ice'] . '';
      ...
      $this->nm_new_label['df_porcentaje_irbpnr_'] = '' . $this->Ini->Nm_lang['lang_porcentaje_irbpnr'] . '';
      $this->nm_new_label['df_valor_irbpnr_'] = '' . $this->Ini->Nm_lang['lang_irbpnr'] . '';
      $this->nm_new_label['df_total_'] = '' . $this->Ini->Nm_lang['lang_othr_chrt_totl'] . '';
      $this->nm_new_label['df_cantidad_nc_'] = '' . $this->Ini->Nm_lang['lang_lot_cantidad'] . '';
      $this->nm_new_label['df_precio_sin_subsidio_'] = '' . $this->Ini->Nm_lang['lang_precio_sin_subsidio'] . '';
      ...
      $_SESSION['scriptcase']['error_icon']['form_del_detalle_factura']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_del_detalle_factura'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_detalle_factura'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_detalle_factura'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_del_detalle_factura", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_del_detalle_factura_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_del_detalle_factura_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_del_detalle_factura/form_del_detalle_factura_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_del_detalle_factura_erro.class.php"); 
      }
      $this->Erro      = new form_del_detalle_factura_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opcao']))
         { 
             if ($this->df_id_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_del_detalle_factura']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_del_detalle_factura']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['df_cantidad_']['symbol_grp'] = '';
      $this->field_config['df_cantidad_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['df_cantidad_']['symbol_dec'] = '.';
      $this->field_config['df_cantidad_']['symbol_neg'] = '-';
      $this->field_config['df_cantidad_']['format_neg'] = '2';
      //-- df_precio_unitario_
      ...
      $this->field_config['df_base_ice_']['symbol_grp'] = '';
      $this->field_config['df_base_ice_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['df_base_ice_']['symbol_dec'] = '.';
      $this->field_config['df_base_ice_']['symbol_neg'] = '-';
      $this->field_config['df_base_ice_']['format_neg'] = '2';
      //-- df_valor_ice_
      ...
      $this->field_config['df_base_irbpnr_']['symbol_grp'] = '';
      $this->field_config['df_base_irbpnr_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['df_base_irbpnr_']['symbol_dec'] = '.';
      $this->field_config['df_base_irbpnr_']['symbol_neg'] = '-';
      $this->field_config['df_base_irbpnr_']['format_neg'] = '2';
      //-- df_valor_irbpnr_
      ...
      //-- df_cantidad_nc_
      $this->field_config['df_cantidad_nc_']               = array();
      $this->field_config['df_cantidad_nc_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['df_cantidad_nc_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['df_cantidad_nc_']['symbol_dec'] = '';
      $this->field_config['df_cantidad_nc_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['df_cantidad_nc_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- df_precio_sin_subsidio_
      $this->field_config['df_precio_sin_subsidio_']               = array();
      $this->field_config['df_precio_sin_subsidio_']['symbol_grp'] = '';
      $this->field_config['df_precio_sin_subsidio_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['df_precio_sin_subsidio_']['symbol_dec'] = '.';
      $this->field_config['df_precio_sin_subsidio_']['symbol_neg'] = '-';
      $this->field_config['df_precio_sin_subsidio_']['format_neg'] = '2';
      //-- df_bodega_
      $this->field_config['df_bodega_']               = array();
      $this->field_config['df_bodega_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['df_bodega_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['df_bodega_']['symbol_dec'] = '';
      $this->field_config['df_bodega_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['df_bodega_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- df_costo_
      $this->field_config['df_costo_']               = array();
      $this->field_config['df_costo_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['df_costo_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['df_costo_']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['df_costo_']['symbol_mon'] = '';
      $this->field_config['df_costo_']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['df_costo_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
      //-- df_unidad_
      $this->field_config['df_unidad_']               = array();
      $this->field_config['df_unidad_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['df_unidad_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['df_unidad_']['symbol_dec'] = '';
      $this->field_config['df_unidad_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['df_unidad_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Gera_log_access'] = false;
      }
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'add_new_line' == $this->NM_ajax_opcao)
      {
         ...
         $this->NM_close_db();
         form_del_detalle_factura_pack_ajax_response();
         exit;
      }
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($this->df_descripcion_)) { $this->nm_limpa_alfa($this->df_descripcion_); }
         ...
         if (isset($this->df_cantidad_nc_)) { $this->nm_limpa_alfa($this->df_cantidad_nc_); }
         if (isset($this->df_precio_sin_subsidio_)) { $this->nm_limpa_alfa($this->df_precio_sin_subsidio_); }
         if (isset($this->Sc_num_lin_alt) && $this->Sc_num_lin_alt > 0) 
         {
             $sc_seq_vert = $this->Sc_num_lin_alt;
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_form'][$sc_seq_vert];
             $this->df_empresa_ = $this->nmgp_dados_form['df_empresa_']; 
             $this->df_estado_ = $this->nmgp_dados_form['df_estado_']; 
             $this->df_bodega_ = $this->nmgp_dados_form['df_bodega_']; 
             $this->df_costo_ = $this->nmgp_dados_form['df_costo_']; 
             $this->df_unidad_ = $this->nmgp_dados_form['df_unidad_']; 
         }
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_del_detalle_factura']) || !is_array($this->NM_ajax_info['errList']['geral_form_del_detalle_factura']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_del_detalle_factura'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_del_detalle_factura'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_del_detalle_factura'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_del_detalle_factura'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['sc_redir_atualiz'] == "ok")
          {
      ...
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
         ...
         $Campos_Erros = array();
          ...
          if ('validate_df_descripcion_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'df_descripcion_');
          }
          ...
          if ('validate_df_cantidad_nc_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'df_cantidad_nc_');
          }
          if ('validate_df_precio_sin_subsidio_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'df_precio_sin_subsidio_');
          }
          form_del_detalle_factura_pack_ajax_response();
          exit;
      }
      ...
      { 
         ...
         $this->df_descripcion_ = $GLOBALS["df_descripcion_" . $sc_seq_vert]; 
         ...
         $this->df_cantidad_nc_ = $GLOBALS["df_cantidad_nc_" . $sc_seq_vert]; 
         $this->df_precio_sin_subsidio_ = $GLOBALS["df_precio_sin_subsidio_" . $sc_seq_vert]; 
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_form'][$sc_seq_vert];
             $this->df_empresa_ = $this->nmgp_dados_form['df_empresa_']; 
         ...
         if (isset($this->df_cantidad_nc_)) { $this->nm_limpa_alfa($this->df_cantidad_nc_); }
         if (isset($this->df_precio_sin_subsidio_)) { $this->nm_limpa_alfa($this->df_precio_sin_subsidio_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert];
         }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_id_'] =  $this->df_id_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_factura_'] =  $this->df_factura_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_producto_'] =  $this->df_producto_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_descripcion_'] =  $this->df_descripcion_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_cantidad_'] =  $this->df_cantidad_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_precio_unitario_'] =  $this->df_precio_unitario_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_descuento_'] =  $this->df_descuento_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_subtotal_'] =  $this->df_subtotal_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_base_iva_'] =  $this->df_base_iva_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_porcentaje_iva_'] =  $this->df_porcentaje_iva_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_valor_iva_'] =  $this->df_valor_iva_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_total_'] =  $this->df_total_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_base_ice_'] =  $this->df_base_ice_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_porcentaje_ice_'] =  $this->df_porcentaje_ice_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_valor_ice_'] =  $this->df_valor_ice_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_base_irbpnr_'] =  $this->df_base_irbpnr_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_porcentaje_irbpnr_'] =  $this->df_porcentaje_irbpnr_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_valor_irbpnr_'] =  $this->df_valor_irbpnr_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_cantidad_nc_'] =  $this->df_cantidad_nc_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_precio_sin_subsidio_'] =  $this->df_precio_sin_subsidio_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_empresa_'] =  $this->df_empresa_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_estado_'] =  $this->df_estado_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_bodega_'] =  $this->df_bodega_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_costo_'] =  $this->df_costo_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_unidad_'] =  $this->df_unidad_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_del_detalle_factura);
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_df_cantidad__onchange' == $this->NM_ajax_opcao)
          {
              $this->df_cantidad__onChange();
          }
          if ('event_df_precio_unitario__onchange' == $this->NM_ajax_opcao)
          {
              $this->df_precio_unitario__onChange();
          }
          if ('event_df_cantidad__onblur' == $this->NM_ajax_opcao)
          {
              $this->df_cantidad__onBlur();
          }
          if ('event_df_precio_unitario__onblur' == $this->NM_ajax_opcao)
          {
              $this->df_precio_unitario__onBlur();
          }
          if ('event_df_descuento__onblur' == $this->NM_ajax_opcao)
          {
              $this->df_descuento__onBlur();
          }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_del_detalle_factura']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_del_detalle_factura.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("Agregar Producto") ?></TITLE>
...
<form name="Fdown" method="get" action="form_del_detalle_factura_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_del_detalle_factura"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_detalle_factura', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_del_detalle_factura', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_detalle_factura', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'df_valor_irbpnr_':
               ...
               break;
           case 'df_cantidad_nc_':
               return "" . $this->Ini->Nm_lang['lang_lot_cantidad'] . "";
               break;
           case 'df_precio_sin_subsidio_':
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_del_detalle_factura'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_id_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_factura_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_producto_";

      if ((!is_array($filtro) && ('' == $filtro || 'df_descripcion_' == $filtro)) || (is_array($filtro) && in_array('df_descripcion_', $filtro)))
        $this->ValidateField_df_descripcion_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_descripcion_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_cantidad_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_precio_unitario_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_descuento_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_subtotal_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_base_iva_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_porcentaje_iva_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_valor_iva_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_total_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_base_ice_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_porcentaje_ice_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_valor_ice_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_base_irbpnr_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_porcentaje_irbpnr_";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_valor_irbpnr_";

      if ((!is_array($filtro) && ('' == $filtro || 'df_cantidad_nc_' == $filtro)) || (is_array($filtro) && in_array('df_cantidad_nc_', $filtro)))
        $this->ValidateField_df_cantidad_nc_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_cantidad_nc_";

      if ((!is_array($filtro) && ('' == $filtro || 'df_precio_sin_subsidio_' == $filtro)) || (is_array($filtro) && in_array('df_precio_sin_subsidio_', $filtro)))
        $this->ValidateField_df_precio_sin_subsidio_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_precio_sin_subsidio_";
    ...
    function ValidateField_df_id_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Df Id: " . $this->Ini->Nm_lang['lang_errm_size']; 
    ...
    function ValidateField_df_factura_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Df Factura: " . $this->Ini->Nm_lang['lang_errm_size']; 
   ...
   if (isset($this->Field_no_validate['df_producto_'])) {
      ...
      if ($this->df_producto_ == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['php_cmp_required']['df_producto_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['php_cmp_required']['df_producto_'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_producto'] . "" ; 
          if (!isset($Campos_Erros['df_producto_']))
          {
              $Campos_Erros['df_producto_'] = array();
          }
          $Campos_Erros['df_producto_'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['df_producto_'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->df_producto_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Lookup_df_producto_']) && !in_array($this->df_producto_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Lookup_df_producto_']))
          {
              $hasError = true;
    ...
    function ValidateField_df_descripcion_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['df_descripcion_'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->df_descripcion_) > 300) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_inf_adicional'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['df_descripcion_']))
              {
                  $Campos_Erros['df_descripcion_'] = array();
              }
              $Campos_Erros['df_descripcion_'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['df_descripcion_']) || !is_array($this->NM_ajax_info['errList']['df_descripcion_']))
              {
                  $this->NM_ajax_info['errList']['df_descripcion_'] = array();
              }
              $this->NM_ajax_info['errList']['df_descripcion_'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'df_descripcion_';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_df_descripcion_
    ...
    function ValidateField_df_cantidad_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['php_cmp_required']['df_cantidad_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['php_cmp_required']['df_cantidad_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_lot_cantidad'] . "" ; 
              if (!isset($Campos_Erros['df_cantidad_']))
              {
                  $Campos_Erros['df_cantidad_'] = array();
              }
              $Campos_Erros['df_cantidad_'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['df_cantidad_']) || !is_array($this->NM_ajax_info['errList']['df_cantidad_']))
                  {
                      $this->NM_ajax_info['errList']['df_cantidad_'] = array();
                  }
                  $this->NM_ajax_info['errList']['df_cantidad_'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_df_precio_unitario_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['php_cmp_required']['df_precio_unitario_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['php_cmp_required']['df_precio_unitario_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_precio_unitario'] . "" ; 
              if (!isset($Campos_Erros['df_precio_unitario_']))
              {
                  $Campos_Erros['df_precio_unitario_'] = array();
              }
              $Campos_Erros['df_precio_unitario_'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['df_precio_unitario_']) || !is_array($this->NM_ajax_info['errList']['df_precio_unitario_']))
                  {
                      $this->NM_ajax_info['errList']['df_precio_unitario_'] = array();
                  }
                  $this->NM_ajax_info['errList']['df_precio_unitario_'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_df_descuento_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->df_descuento_, 9, 6, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_df_base_ice_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->df_base_ice_, 9, 6, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_df_porcentaje_ice_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->df_porcentaje_ice_) > 4) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_porcentaje_ice'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['df_porcentaje_ice_']))
              {
                  $Campos_Erros['df_porcentaje_ice_'] = array();
              }
              $Campos_Erros['df_porcentaje_ice_'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['df_porcentaje_ice_'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_df_base_irbpnr_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->df_base_irbpnr_, 9, 6, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_df_porcentaje_irbpnr_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->df_porcentaje_irbpnr_) > 4) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_porcentaje_irbpnr'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['df_porcentaje_irbpnr_']))
              {
                  $Campos_Erros['df_porcentaje_irbpnr_'] = array();
              }
              $Campos_Erros['df_porcentaje_irbpnr_'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['df_porcentaje_irbpnr_'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_df_cantidad_nc_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['df_cantidad_nc_'])) {
          nm_limpa_numero($this->df_cantidad_nc_, $this->field_config['df_cantidad_nc_']['symbol_grp']) ; 
          return;
      }
      if ($this->df_cantidad_nc_ === "" || is_null($this->df_cantidad_nc_))  
      { 
          $this->df_cantidad_nc_ = 0;
          $this->sc_force_zero[] = 'df_cantidad_nc_';
      } 
      nm_limpa_numero($this->df_cantidad_nc_, $this->field_config['df_cantidad_nc_']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->df_cantidad_nc_ != '')  
          { 
              $iTestSize = 9;
              if (strlen($this->df_cantidad_nc_) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_lot_cantidad'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['df_cantidad_nc_']))
                  {
                      $Campos_Erros['df_cantidad_nc_'] = array();
                  }
                  $Campos_Erros['df_cantidad_nc_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['df_cantidad_nc_']) || !is_array($this->NM_ajax_info['errList']['df_cantidad_nc_']))
                  {
                      $this->NM_ajax_info['errList']['df_cantidad_nc_'] = array();
                  }
                  $this->NM_ajax_info['errList']['df_cantidad_nc_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->df_cantidad_nc_, 9, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_lot_cantidad'] . "; " ; 
                  if (!isset($Campos_Erros['df_cantidad_nc_']))
                  ...
                  $Campos_Erros['df_cantidad_nc_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['df_cantidad_nc_']) || !is_array($this->NM_ajax_info['errList']['df_cantidad_nc_']))
                  {
                      $this->NM_ajax_info['errList']['df_cantidad_nc_'] = array();
                  }
                  $this->NM_ajax_info['errList']['df_cantidad_nc_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'df_cantidad_nc_';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_df_cantidad_nc_

    function ValidateField_df_precio_sin_subsidio_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['df_precio_sin_subsidio_'])) {
          if (!empty($this->field_config['df_precio_sin_subsidio_']['symbol_dec'])) {
              nm_limpa_valor($this->df_precio_sin_subsidio_, $this->field_config['df_precio_sin_subsidio_']['symbol_dec'], $this->field_config['df_precio_sin_subsidio_']['symbol_grp']) ; 
          }
          return;
      }
      if ($this->df_precio_sin_subsidio_ === "" || is_null($this->df_precio_sin_subsidio_))  
      { 
          $this->df_precio_sin_subsidio_ = 0;
          $this->sc_force_zero[] = 'df_precio_sin_subsidio_';
      } 
      if (!empty($this->field_config['df_precio_sin_subsidio_']['symbol_dec']))
      {
          nm_limpa_valor($this->df_precio_sin_subsidio_, $this->field_config['df_precio_sin_subsidio_']['symbol_dec'], $this->field_config['df_precio_sin_subsidio_']['symbol_grp']) ; 
          if ('.' == substr($this->df_precio_sin_subsidio_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->df_precio_sin_subsidio_, 1)))
              {
                  $this->df_precio_sin_subsidio_ = '';
              }
              else
              {
                  $this->df_precio_sin_subsidio_ = '0' . $this->df_precio_sin_subsidio_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->df_precio_sin_subsidio_ != '')  
          { 
              $iTestSize = 16;
              if (strlen($this->df_precio_sin_subsidio_) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_precio_sin_subsidio'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['df_precio_sin_subsidio_']))
                  {
                      $Campos_Erros['df_precio_sin_subsidio_'] = array();
                  }
                  $Campos_Erros['df_precio_sin_subsidio_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['df_precio_sin_subsidio_']) || !is_array($this->NM_ajax_info['errList']['df_precio_sin_subsidio_']))
                  {
                      $this->NM_ajax_info['errList']['df_precio_sin_subsidio_'] = array();
                  }
                  $this->NM_ajax_info['errList']['df_precio_sin_subsidio_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->df_precio_sin_subsidio_, 13, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['df_precio_sin_subsidio_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['df_precio_sin_subsidio_']) || !is_array($this->NM_ajax_info['errList']['df_precio_sin_subsidio_']))
                  {
                      $this->NM_ajax_info['errList']['df_precio_sin_subsidio_'] = array();
                  }
                  $this->NM_ajax_info['errList']['df_precio_sin_subsidio_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'df_precio_sin_subsidio_';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_df_precio_sin_subsidio_
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['df_descripcion_'] = $this->df_descripcion_;
    ...
    $this->nmgp_dados_form['df_cantidad_nc_'] = $this->df_cantidad_nc_;
    $this->nmgp_dados_form['df_precio_sin_subsidio_'] = $this->df_precio_sin_subsidio_;
    $this->nmgp_dados_form['df_empresa_'] = $this->df_empresa_;
    $this->nmgp_dados_form['df_estado_'] = $this->df_estado_;
    $this->nmgp_dados_form['df_bodega_'] = $this->df_bodega_;
    $this->nmgp_dados_form['df_costo_'] = $this->df_costo_;
    $this->nmgp_dados_form['df_unidad_'] = $this->df_unidad_;
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['df_cantidad_nc_'] = $this->df_cantidad_nc_;
      nm_limpa_numero($this->df_cantidad_nc_, $this->field_config['df_cantidad_nc_']['symbol_grp']) ; 
      $this->Before_unformat['df_precio_sin_subsidio_'] = $this->df_precio_sin_subsidio_;
      if (!empty($this->field_config['df_precio_sin_subsidio_']['symbol_dec']))
      {
         nm_limpa_valor($this->df_precio_sin_subsidio_, $this->field_config['df_precio_sin_subsidio_']['symbol_dec'], $this->field_config['df_precio_sin_subsidio_']['symbol_grp']);
      }
      $this->Before_unformat['df_bodega_'] = $this->df_bodega_;
      nm_limpa_numero($this->df_bodega_, $this->field_config['df_bodega_']['symbol_grp']) ; 
      $this->Before_unformat['df_costo_'] = $this->df_costo_;
      if (!empty($this->field_config['df_costo_']['symbol_dec']))
      {
         $this->sc_remove_currency($this->df_costo_, $this->field_config['df_costo_']['symbol_dec'], $this->field_config['df_costo_']['symbol_grp'], $this->field_config['df_costo_']['symbol_mon']);
         nm_limpa_valor($this->df_costo_, $this->field_config['df_costo_']['symbol_dec'], $this->field_config['df_costo_']['symbol_grp']);
      }
      $this->Before_unformat['df_unidad_'] = $this->df_unidad_;
      nm_limpa_numero($this->df_unidad_, $this->field_config['df_unidad_']['symbol_grp']) ; 
   }
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "df_cantidad_nc_")
      {
          nm_limpa_numero($this->df_cantidad_nc_, $this->field_config['df_cantidad_nc_']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "df_precio_sin_subsidio_")
      {
          if (!empty($this->field_config['df_precio_sin_subsidio_']['symbol_dec']))
          {
             nm_limpa_valor($this->df_precio_sin_subsidio_, $this->field_config['df_precio_sin_subsidio_']['symbol_dec'], $this->field_config['df_precio_sin_subsidio_']['symbol_grp']);
      ...
      if ($Nome_Campo == "df_bodega_")
      {
          nm_limpa_numero($this->df_bodega_, $this->field_config['df_bodega_']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "df_costo_")
      {
          if (!empty($this->field_config['df_costo_']['symbol_dec']))
          {
             $this->sc_remove_currency($this->df_costo_, $this->field_config['df_costo_']['symbol_dec'], $this->field_config['df_costo_']['symbol_grp'], $this->field_config['df_costo_']['symbol_mon']);
   ...
   function nm_formatar_campos($format_fields = array())
   {
      ...
      {
          nmgp_Form_Num_Val($this->df_descuento_, $this->field_config['df_descuento_']['symbol_grp'], $this->field_config['df_descuento_']['symbol_dec'], "6", "S", $this->field_config['df_descuento_']['format_neg'], "", "", "-", $this->field_config['df_descuento_']['symbol_fmt']) ; 
      }
      ...
      {
          nmgp_Form_Num_Val($this->df_base_ice_, $this->field_config['df_base_ice_']['symbol_grp'], $this->field_config['df_base_ice_']['symbol_dec'], "6", "S", $this->field_config['df_base_ice_']['format_neg'], "", "", "-", $this->field_config['df_base_ice_']['symbol_fmt']) ; 
      }
      ...
      {
          nmgp_Form_Num_Val($this->df_base_irbpnr_, $this->field_config['df_base_irbpnr_']['symbol_grp'], $this->field_config['df_base_irbpnr_']['symbol_dec'], "6", "S", $this->field_config['df_base_irbpnr_']['format_neg'], "", "", "-", $this->field_config['df_base_irbpnr_']['symbol_fmt']) ; 
      }
      ...
      if ('' !== $this->df_cantidad_nc_ || (!empty($format_fields) && isset($format_fields['df_cantidad_nc_'])))
      {
          nmgp_Form_Num_Val($this->df_cantidad_nc_, $this->field_config['df_cantidad_nc_']['symbol_grp'], $this->field_config['df_cantidad_nc_']['symbol_dec'], "0", "S", $this->field_config['df_cantidad_nc_']['format_neg'], "", "", "-", $this->field_config['df_cantidad_nc_']['symbol_fmt']) ; 
      }
      if ('' !== $this->df_precio_sin_subsidio_ || (!empty($format_fields) && isset($format_fields['df_precio_sin_subsidio_'])))
      {
          nmgp_Form_Num_Val($this->df_precio_sin_subsidio_, $this->field_config['df_precio_sin_subsidio_']['symbol_grp'], $this->field_config['df_precio_sin_subsidio_']['symbol_dec'], "2", "S", $this->field_config['df_precio_sin_subsidio_']['format_neg'], "", "", "-", $this->field_config['df_precio_sin_subsidio_']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['df_id_']['keyVal'] = form_del_detalle_factura_pack_protect_string($this->nmgp_dados_form['df_id_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_id_'] = $this->df_id_;
                  }
                  if (isset($this->NM_ajax_changed['df_factura_']) && $this->NM_ajax_changed['df_factura_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_factura_'] = $this->df_factura_;
                  }
                  if (isset($this->NM_ajax_changed['df_producto_']) && $this->NM_ajax_changed['df_producto_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_producto_'] = $this->df_producto_;
                  }
                  if (isset($this->NM_ajax_changed['df_descripcion_']) && $this->NM_ajax_changed['df_descripcion_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_descripcion_'] = $this->df_descripcion_;
                  }
                  if (isset($this->NM_ajax_changed['df_cantidad_']) && $this->NM_ajax_changed['df_cantidad_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_cantidad_'] = $this->df_cantidad_;
                  }
                  if (isset($this->NM_ajax_changed['df_precio_unitario_']) && $this->NM_ajax_changed['df_precio_unitario_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_precio_unitario_'] = $this->df_precio_unitario_;
                  }
                  if (isset($this->NM_ajax_changed['df_descuento_']) && $this->NM_ajax_changed['df_descuento_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_descuento_'] = $this->df_descuento_;
                  }
                  if (isset($this->NM_ajax_changed['df_subtotal_']) && $this->NM_ajax_changed['df_subtotal_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_subtotal_'] = $this->df_subtotal_;
                  }
                  if (isset($this->NM_ajax_changed['df_base_iva_']) && $this->NM_ajax_changed['df_base_iva_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_base_iva_'] = $this->df_base_iva_;
                  }
                  if (isset($this->NM_ajax_changed['df_porcentaje_iva_']) && $this->NM_ajax_changed['df_porcentaje_iva_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_porcentaje_iva_'] = $this->df_porcentaje_iva_;
                  }
                  if (isset($this->NM_ajax_changed['df_valor_iva_']) && $this->NM_ajax_changed['df_valor_iva_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_valor_iva_'] = $this->df_valor_iva_;
                  }
                  if (isset($this->NM_ajax_changed['df_total_']) && $this->NM_ajax_changed['df_total_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_total_'] = $this->df_total_;
                  }
                  if (isset($this->NM_ajax_changed['df_base_ice_']) && $this->NM_ajax_changed['df_base_ice_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_base_ice_'] = $this->df_base_ice_;
                  }
                  if (isset($this->NM_ajax_changed['df_porcentaje_ice_']) && $this->NM_ajax_changed['df_porcentaje_ice_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_porcentaje_ice_'] = $this->df_porcentaje_ice_;
                  }
                  if (isset($this->NM_ajax_changed['df_valor_ice_']) && $this->NM_ajax_changed['df_valor_ice_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_valor_ice_'] = $this->df_valor_ice_;
                  }
                  if (isset($this->NM_ajax_changed['df_base_irbpnr_']) && $this->NM_ajax_changed['df_base_irbpnr_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_base_irbpnr_'] = $this->df_base_irbpnr_;
                  }
                  if (isset($this->NM_ajax_changed['df_porcentaje_irbpnr_']) && $this->NM_ajax_changed['df_porcentaje_irbpnr_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_porcentaje_irbpnr_'] = $this->df_porcentaje_irbpnr_;
                  }
                  if (isset($this->NM_ajax_changed['df_valor_irbpnr_']) && $this->NM_ajax_changed['df_valor_irbpnr_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_valor_irbpnr_'] = $this->df_valor_irbpnr_;
                  }
                  if (isset($this->NM_ajax_changed['df_cantidad_nc_']) && $this->NM_ajax_changed['df_cantidad_nc_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_cantidad_nc_'] = $this->df_cantidad_nc_;
                  }
                  if (isset($this->NM_ajax_changed['df_precio_sin_subsidio_']) && $this->NM_ajax_changed['df_precio_sin_subsidio_'])
                  {
                      $this->form_vert_form_del_detalle_factura[$this->nmgp_refresh_row]['df_precio_sin_subsidio_'] = $this->df_precio_sin_subsidio_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_del_detalle_factura as $sc_seq_vert => $aRecData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Lookup_df_producto_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Lookup_df_producto_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Lookup_df_producto_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Lookup_df_producto_'] = array(); 
}
$aLookup[] = array(form_del_detalle_factura_pack_protect_string('') => str_replace('<', '&lt;',form_del_detalle_factura_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Lookup_df_producto_'][] = '';
   ...
   $old_value_df_cantidad_nc_ = $this->df_cantidad_nc_;
   $old_value_df_precio_sin_subsidio_ = $this->df_precio_sin_subsidio_;
   $this->nm_tira_formatacao();
   ...
   $unformatted_value_df_cantidad_nc_ = $this->df_cantidad_nc_;
   $unformatted_value_df_precio_sin_subsidio_ = $this->df_precio_sin_subsidio_;

   $nm_comando = "SELECT pro_codigo, pro_codigo||' - '||pro_descripcion FROM del_producto where pro_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "'  and pro_familia_producto in (1,3) and pro_estado='V' ORDER BY pro_codigo";
   ...
   $this->df_cantidad_nc_ = $old_value_df_cantidad_nc_;
   $this->df_precio_sin_subsidio_ = $old_value_df_precio_sin_subsidio_;
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_del_detalle_factura_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_del_detalle_factura_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Lookup_df_producto_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['df_producto_' . $sc_seq_vert]['valList'][$i] = form_del_detalle_factura_pack_protect_string($v);
          }
          ...
          $this->NM_ajax_info['fldList']['df_producto_' . $sc_seq_vert]['labList'] = $aLabel;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("df_descripcion_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['df_descripcion_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['df_descripcion_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("df_cantidad_nc_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['df_cantidad_nc_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['df_cantidad_nc_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("df_precio_sin_subsidio_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['df_precio_sin_subsidio_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['df_precio_sin_subsidio_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'label',
                       'valList' => array($sTmpValue),
                       );
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  function nm_proc_onload_record($sc_seq_vert=0)
  {
          ...
          $_SESSION['scriptcase']['form_del_detalle_factura']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_del_detalle_factura']['contr_erro'] = 'off'; 
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//
   ...
   { 
      ...
      $this->df_precio_sin_subsidio_ = str_replace($sc_parm1, $sc_parm2, $this->df_precio_sin_subsidio_); 
      $this->df_costo_ = str_replace($sc_parm1, $sc_parm2, $this->df_costo_); 
   } 
   ...
   { 
      ...
      $this->df_precio_sin_subsidio_ = "'" . $this->df_precio_sin_subsidio_ . "'";
      $this->df_costo_ = "'" . $this->df_costo_ . "'";
   } 
   ...
   { 
      ...
      $this->df_precio_sin_subsidio_ = str_replace("'", "", $this->df_precio_sin_subsidio_); 
      $this->df_costo_ = str_replace("'", "", $this->df_costo_); 
   } 
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          if ($this->nmgp_dados_select['df_id_'] == $this->df_id_ &&
              ...
              $this->nmgp_dados_select['df_descripcion_'] == $this->df_descripcion_ &&
              ...
              $this->nmgp_dados_select['df_cantidad_nc_'] == $this->df_cantidad_nc_ &&
              $this->nmgp_dados_select['df_precio_sin_subsidio_'] == $this->df_precio_sin_subsidio_)
          { }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_id_'] = $this->df_id_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_factura_'] = $this->df_factura_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_producto_'] = $this->df_producto_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_descripcion_'] = $this->df_descripcion_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_cantidad_'] = $this->df_cantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_precio_unitario_'] = $this->df_precio_unitario_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_descuento_'] = $this->df_descuento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_subtotal_'] = $this->df_subtotal_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_base_iva_'] = $this->df_base_iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_porcentaje_iva_'] = $this->df_porcentaje_iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_valor_iva_'] = $this->df_valor_iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_total_'] = $this->df_total_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_base_ice_'] = $this->df_base_ice_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_porcentaje_ice_'] = $this->df_porcentaje_ice_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_valor_ice_'] = $this->df_valor_ice_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_base_irbpnr_'] = $this->df_base_irbpnr_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_porcentaje_irbpnr_'] = $this->df_porcentaje_irbpnr_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_valor_irbpnr_'] = $this->df_valor_irbpnr_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_cantidad_nc_'] = $this->df_cantidad_nc_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert]['df_precio_sin_subsidio_'] = $this->df_precio_sin_subsidio_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ('incluir' == $this->nmgp_opcao && empty($this->df_factura_)) {$this->df_factura_ = "" . $_SESSION['var_factura'] . ""; $this->sc_force_zero[] = "df_factura_";}  
      if ('incluir' == $this->nmgp_opcao && empty($this->df_empresa_)) {$this->df_empresa_ = "" . $_SESSION['Igtech_RucEmpresa'] . ""; $NM_val_null[] = "df_empresa_";}  
      if ('incluir' == $this->nmgp_opcao && empty($this->df_estado_)) {$this->df_estado_ = "R"; $NM_val_null[] = "df_estado_";}  
      $NM_val_form['df_id_'] = $this->df_id_;
      $NM_val_form['df_factura_'] = $this->df_factura_;
      $NM_val_form['df_producto_'] = $this->df_producto_;
      $NM_val_form['df_descripcion_'] = $this->df_descripcion_;
      ...
      $NM_val_form['df_cantidad_nc_'] = $this->df_cantidad_nc_;
      $NM_val_form['df_precio_sin_subsidio_'] = $this->df_precio_sin_subsidio_;
      $NM_val_form['df_empresa_'] = $this->df_empresa_;
      $NM_val_form['df_estado_'] = $this->df_estado_;
      $NM_val_form['df_bodega_'] = $this->df_bodega_;
      $NM_val_form['df_costo_'] = $this->df_costo_;
      $NM_val_form['df_unidad_'] = $this->df_unidad_;
      if ($this->df_id_ === "" || is_null($this->df_id_))  
      { 
          $this->df_id_ = 0;
      } 
      ...
      if ($this->df_porcentaje_ice_ === "" || is_null($this->df_porcentaje_ice_))  
      { 
          $this->df_porcentaje_ice_ = 0;
          $this->sc_force_zero[] = 'df_porcentaje_ice_';
      } 
      if ($this->df_valor_ice_ === "" || is_null($this->df_valor_ice_))  
      { 
          $this->df_valor_ice_ = 0;
      ...
      if ($this->df_bodega_ === "" || is_null($this->df_bodega_))  
      { 
          $this->df_bodega_ = 0;
          $this->sc_force_zero[] = 'df_bodega_';
      } 
      if ($this->df_costo_ === "" || is_null($this->df_costo_))  
      { 
          $this->df_costo_ = 0;
          $this->sc_force_zero[] = 'df_costo_';
      } 
      if ($this->df_unidad_ === "" || is_null($this->df_unidad_))  
      { 
          $this->df_unidad_ = 0;
          $this->sc_force_zero[] = 'df_unidad_';
      } 
      $nm_bases_lob_geral = array_merge($this->Ini->nm_bases_oracle, $this->Ini->nm_bases_ibase, $this->Ini->nm_bases_informix, $this->Ini->nm_bases_mysql, $this->Ini->nm_bases_access, $this->Ini->nm_bases_sqlite, array('pdo_ibm'), array('pdo_sqlsrv'));
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          $this->df_descripcion__before_qstr = $this->df_descripcion_;
          $this->df_descripcion_ = substr($this->Db->qstr($this->df_descripcion_), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->df_descripcion_ = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->df_descripcion_);
          }
          if ($this->df_descripcion_ == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->df_descripcion_ = "null"; 
              $NM_val_null[] = "df_descripcion_";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "df_factura = $this->df_factura_, df_producto = '$this->df_producto_', df_descripcion = '$this->df_descripcion_', df_cantidad = $this->df_cantidad_, df_precio_unitario = $this->df_precio_unitario_, df_subtotal = $this->df_subtotal_, df_descuento = $this->df_descuento_, df_base_iva = $this->df_base_iva_, df_porcentaje_iva = $this->df_porcentaje_iva_, df_valor_iva = $this->df_valor_iva_, df_base_ice = $this->df_base_ice_, df_porcentaje_ice = $this->df_porcentaje_ice_, df_valor_ice = $this->df_valor_ice_, df_base_irbpnr = $this->df_base_irbpnr_, df_porcentaje_irbpnr = '$this->df_porcentaje_irbpnr_', df_valor_irbpnr = $this->df_valor_irbpnr_, df_total = $this->df_total_, df_cantidad_nc = $this->df_cantidad_nc_, df_precio_sin_subsidio = $this->df_precio_sin_subsidio_"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['df_empresa_']) && $NM_val_form['df_empresa_'] != $this->nmgp_dados_select['df_empresa_']) 
              { 
                  $SC_fields_update[] = "df_empresa = '$this->df_empresa_'"; 
              } 
              if (isset($NM_val_form['df_estado_']) && $NM_val_form['df_estado_'] != $this->nmgp_dados_select['df_estado_']) 
              { 
                  $SC_fields_update[] = "df_estado = '$this->df_estado_'"; 
              } 
              if (isset($NM_val_form['df_bodega_']) && $NM_val_form['df_bodega_'] != $this->nmgp_dados_select['df_bodega_']) 
              { 
                  $SC_fields_update[] = "df_bodega = $this->df_bodega_"; 
              } 
              if (isset($NM_val_form['df_costo_']) && $NM_val_form['df_costo_'] != $this->nmgp_dados_select['df_costo_']) 
              { 
                  $SC_fields_update[] = "df_costo = $this->df_costo_"; 
              } 
              if (isset($NM_val_form['df_unidad_']) && $NM_val_form['df_unidad_'] != $this->nmgp_dados_select['df_unidad_']) 
              { 
                  $SC_fields_update[] = "df_unidad = $this->df_unidad_"; 
              } 
              ...
              $this->df_descripcion_ = $this->df_descripcion__before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['df_descripcion_'])) { $this->df_descripcion_ = $NM_val_form['df_descripcion_']; }
              elseif (isset($this->df_descripcion_)) { $this->nm_limpa_alfa($this->df_descripcion_); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['df_cantidad_nc_'])) { $this->df_cantidad_nc_ = $NM_val_form['df_cantidad_nc_']; }
              elseif (isset($this->df_cantidad_nc_)) { $this->nm_limpa_alfa($this->df_cantidad_nc_); }
              if     (isset($NM_val_form) && isset($NM_val_form['df_precio_sin_subsidio_'])) { $this->df_precio_sin_subsidio_ = $NM_val_form['df_precio_sin_subsidio_']; }
              elseif (isset($this->df_precio_sin_subsidio_)) { $this->nm_limpa_alfa($this->df_precio_sin_subsidio_); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('df_id_', 'df_factura_', 'df_producto_', 'df_descripcion_', 'df_cantidad_', 'df_precio_unitario_', 'df_descuento_', 'df_subtotal_', 'df_base_iva_', 'df_porcentaje_iva_', 'df_valor_iva_', 'df_total_', 'df_base_ice_', 'df_porcentaje_ice_', 'df_valor_ice_', 'df_base_irbpnr_', 'df_porcentaje_irbpnr_', 'df_valor_irbpnr_', 'df_cantidad_nc_', 'df_precio_sin_subsidio_'), $aDoNotUpdate);
              $this->ajax_return_values();
              ...
              if (isset($this->Embutida_ronly) && $this->Embutida_ronly)
              {
                  ...
                  $this->NM_ajax_info['readOnly']['df_descripcion_' . $this->nmgp_refresh_row] = 'on';
                  ...
                  $this->NM_ajax_info['readOnly']['df_cantidad_nc_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['df_precio_sin_subsidio_' . $this->nmgp_refresh_row] = 'on';
      ...
      { 
          ...
          { 
              $NM_seq_auto = "NEXT VALUE FOR del_detalle_factura_df_id_seq, ";
              $NM_cmp_auto = "df_id, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $NM_seq_auto = "del_detalle_factura_df_id_seq.NEXTVAL, ";
              $NM_cmp_auto = "df_id, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
          { 
              $NM_seq_auto = "nextval('del_detalle_factura_df_id_seq'), ";
              $NM_cmp_auto = "df_id, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $NM_seq_auto = "gen_id(del_detalle_factura_df_id_seq, 1), ";
              $NM_cmp_auto = "df_id, ";
          } 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (df_factura, df_empresa, df_producto, df_descripcion, df_cantidad, df_precio_unitario, df_subtotal, df_descuento, df_base_iva, df_porcentaje_iva, df_valor_iva, df_base_ice, df_porcentaje_ice, df_valor_ice, df_base_irbpnr, df_porcentaje_irbpnr, df_valor_irbpnr, df_total, df_estado, df_cantidad_nc, df_precio_sin_subsidio, df_bodega, df_costo, df_unidad) VALUES ($this->df_factura_, '$this->df_empresa_', '$this->df_producto_', '$this->df_descripcion_', $this->df_cantidad_, $this->df_precio_unitario_, $this->df_subtotal_, $this->df_descuento_, $this->df_base_iva_, $this->df_porcentaje_iva_, $this->df_valor_iva_, $this->df_base_ice_, $this->df_porcentaje_ice_, $this->df_valor_ice_, $this->df_base_irbpnr_, '$this->df_porcentaje_irbpnr_', $this->df_valor_irbpnr_, $this->df_total_, '$this->df_estado_', $this->df_cantidad_nc_, $this->df_precio_sin_subsidio_, $this->df_bodega_, $this->df_costo_, $this->df_unidad_)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "df_factura, df_empresa, df_producto, df_descripcion, df_cantidad, df_precio_unitario, df_subtotal, df_descuento, df_base_iva, df_porcentaje_iva, df_valor_iva, df_base_ice, df_porcentaje_ice, df_valor_ice, df_base_irbpnr, df_porcentaje_irbpnr, df_valor_irbpnr, df_total, df_estado, df_cantidad_nc, df_precio_sin_subsidio, df_bodega, df_costo, df_unidad) VALUES (" . $NM_seq_auto . "$this->df_factura_, '$this->df_empresa_', '$this->df_producto_', '$this->df_descripcion_', $this->df_cantidad_, $this->df_precio_unitario_, $this->df_subtotal_, $this->df_descuento_, $this->df_base_iva_, $this->df_porcentaje_iva_, $this->df_valor_iva_, $this->df_base_ice_, $this->df_porcentaje_ice_, $this->df_valor_ice_, $this->df_base_irbpnr_, '$this->df_porcentaje_irbpnr_', $this->df_valor_irbpnr_, $this->df_total_, '$this->df_estado_', $this->df_cantidad_nc_, $this->df_precio_sin_subsidio_, $this->df_bodega_, $this->df_costo_, $this->df_unidad_)"; 
              }
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select del_detalle_factura_df_id_seq.currval from dual"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "values PREVVAL FOR del_detalle_factura_df_id_seq"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select CURRVAL('del_detalle_factura_df_id_seq')"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select gen_id(del_detalle_factura_df_id_seq, 0) from " . $this->Ini->nm_tabela; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              $this->NM_gera_log_new();
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['total']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_qtd']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_I_E']++; 
              ...
              if (isset($this->Embutida_form) && $this->Embutida_form)
              {
                  ...
                  $this->NM_ajax_info['fldList']['df_id_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_id_)));
                  ...
                  $tmpLabel_df_factura_ = $this->df_factura_;
                  $this->NM_ajax_info['fldList']['df_factura_' . $this->nmgp_refresh_row]['type']    = 'label';
                  ...
                  $this->NM_ajax_info['fldList']['df_factura_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_factura_)));
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_del_detalle_factura_pack_protect_string(NM_charset_to_utf8($this->df_producto_)))
              {
          ...
          $tmpLabel_df_producto_ = $sLabelTemp;
                  ...
                  $this->NM_ajax_info['fldList']['df_descripcion_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['df_descripcion_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->df_descripcion_)));
                  $this->NM_ajax_info['fldList']['df_descripcion_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_descripcion_)));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['df_descripcion_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['df_descripcion_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['df_cantidad_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_cantidad_)));
                  ...
                  $this->NM_ajax_info['fldList']['df_precio_unitario_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_precio_unitario_)));
                  ...
                  $this->NM_ajax_info['fldList']['df_descuento_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_descuento_)));
                  ...
                  $this->NM_ajax_info['fldList']['df_subtotal_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_subtotal_)));
                  ...
                  $tmpLabel_df_base_iva_ = $this->df_base_iva_;
                  $this->NM_ajax_info['fldList']['df_base_iva_' . $this->nmgp_refresh_row]['type']    = 'label';
                  ...
                  $this->NM_ajax_info['fldList']['df_base_iva_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_base_iva_)));
                  ...
                  $tmpLabel_df_porcentaje_iva_ = $this->df_porcentaje_iva_;
                  $this->NM_ajax_info['fldList']['df_porcentaje_iva_' . $this->nmgp_refresh_row]['type']    = 'label';
                  ...
                  $this->NM_ajax_info['fldList']['df_porcentaje_iva_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_porcentaje_iva_)));
                  ...
                  $this->NM_ajax_info['fldList']['df_valor_iva_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_valor_iva_)));
                  ...
                  $this->NM_ajax_info['fldList']['df_total_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_total_)));
                  ...
                  $this->NM_ajax_info['fldList']['df_base_ice_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_base_ice_)));
                  ...
                  $tmpLabel_df_porcentaje_ice_ = $this->df_porcentaje_ice_;
                  $this->NM_ajax_info['fldList']['df_porcentaje_ice_' . $this->nmgp_refresh_row]['type']    = 'label';
                  ...
                  $this->NM_ajax_info['fldList']['df_porcentaje_ice_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_porcentaje_ice_)));
                  ...
                  $this->NM_ajax_info['fldList']['df_valor_ice_' . $this->nmgp_refresh_row]['type']    = 'text';
                  ...
                  $this->NM_ajax_info['fldList']['df_valor_ice_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_valor_ice_)));
                  ...
                  $this->NM_ajax_info['fldList']['df_base_irbpnr_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_base_irbpnr_)));
                  ...
                  $tmpLabel_df_porcentaje_irbpnr_ = $this->df_porcentaje_irbpnr_;
                  $this->NM_ajax_info['fldList']['df_porcentaje_irbpnr_' . $this->nmgp_refresh_row]['type']    = 'label';
                  ...
                  $this->NM_ajax_info['fldList']['df_porcentaje_irbpnr_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_porcentaje_irbpnr_)));
                  ...
                  $this->NM_ajax_info['fldList']['df_valor_irbpnr_' . $this->nmgp_refresh_row]['type']    = 'text';
                  ...
                  $this->NM_ajax_info['fldList']['df_valor_irbpnr_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_valor_irbpnr_)));
                  ...
                  $this->NM_ajax_info['fldList']['df_cantidad_nc_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['df_cantidad_nc_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->df_cantidad_nc_)));
                  $this->NM_ajax_info['fldList']['df_cantidad_nc_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_cantidad_nc_)));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['df_cantidad_nc_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['df_cantidad_nc_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $tmpLabel_df_precio_sin_subsidio_ = $this->df_precio_sin_subsidio_;
                  $this->NM_ajax_info['fldList']['df_precio_sin_subsidio_' . $this->nmgp_refresh_row]['type']    = 'label';
                  $this->NM_ajax_info['fldList']['df_precio_sin_subsidio_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->df_precio_sin_subsidio_)));
                  $this->NM_ajax_info['fldList']['df_precio_sin_subsidio_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_precio_sin_subsidio_)));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['df_precio_sin_subsidio_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['df_precio_sin_subsidio_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
$update_sql = "SELECT sp_del_actualiza_factura(".$this->df_factura_ .");";
...
$check_sql = "SELECT fac_subtotal,
					...
					fac_total 
				FROM del_factura
				WHERE fac_numero=".$this->df_factura_ .";";
...
if (isset($this->rs[0][0])){
	...
	$this->sc_master_value('fac_propina', $this->rs[0][9]);
	$this->sc_master_value('fac_total', $this->rs[0][10]);
}
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_df_base_ice_ != $this->df_base_ice_ || (isset($bFlagRead_df_base_ice_) && $bFlagRead_df_base_ice_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_base_ice_' . $this->nmgp_refresh_row]['type']    = 'text';
        $this->NM_ajax_info['fldList']['df_base_ice_' . $this->nmgp_refresh_row]['valList'] = array($this->df_base_ice_);
        $this->NM_ajax_changed['df_base_ice_'] = true;
    }
    if (($original_df_base_irbpnr_ != $this->df_base_irbpnr_ || (isset($bFlagRead_df_base_irbpnr_) && $bFlagRead_df_base_irbpnr_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_base_irbpnr_' . $this->nmgp_refresh_row]['type']    = 'text';
        $this->NM_ajax_info['fldList']['df_base_irbpnr_' . $this->nmgp_refresh_row]['valList'] = array($this->df_base_irbpnr_);
        $this->NM_ajax_changed['df_base_irbpnr_'] = true;
    }
    if (($original_df_base_iva_ != $this->df_base_iva_ || (isset($bFlagRead_df_base_iva_) && $bFlagRead_df_base_iva_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_base_iva_' . $this->nmgp_refresh_row]['type']    = 'label';
        $this->NM_ajax_info['fldList']['df_base_iva_' . $this->nmgp_refresh_row]['valList'] = array($this->df_base_iva_);
        $this->NM_ajax_changed['df_base_iva_'] = true;
    }
    if (($original_df_cantidad_ != $this->df_cantidad_ || (isset($bFlagRead_df_cantidad_) && $bFlagRead_df_cantidad_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_cantidad_' . $this->nmgp_refresh_row]['type']    = 'text';
        $this->NM_ajax_info['fldList']['df_cantidad_' . $this->nmgp_refresh_row]['valList'] = array($this->df_cantidad_);
        $this->NM_ajax_changed['df_cantidad_'] = true;
    }
    if (($original_df_descuento_ != $this->df_descuento_ || (isset($bFlagRead_df_descuento_) && $bFlagRead_df_descuento_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_descuento_' . $this->nmgp_refresh_row]['type']    = 'text';
        $this->NM_ajax_info['fldList']['df_descuento_' . $this->nmgp_refresh_row]['valList'] = array($this->df_descuento_);
    ...
    if (($original_df_precio_unitario_ != $this->df_precio_unitario_ || (isset($bFlagRead_df_precio_unitario_) && $bFlagRead_df_precio_unitario_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_precio_unitario_' . $this->nmgp_refresh_row]['type']    = 'text';
        $this->NM_ajax_info['fldList']['df_precio_unitario_' . $this->nmgp_refresh_row]['valList'] = array($this->df_precio_unitario_);
        $this->NM_ajax_changed['df_precio_unitario_'] = true;
    }
    if (($original_df_producto_ != $this->df_producto_ || (isset($bFlagRead_df_producto_) && $bFlagRead_df_producto_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_producto_' . $this->nmgp_refresh_row]['type']    = 'select';
        $this->NM_ajax_info['fldList']['df_producto_' . $this->nmgp_refresh_row]['valList'] = array($this->df_producto_);
        $this->NM_ajax_changed['df_producto_'] = true;
    }
    if (($original_df_subtotal_ != $this->df_subtotal_ || (isset($bFlagRead_df_subtotal_) && $bFlagRead_df_subtotal_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_subtotal_' . $this->nmgp_refresh_row]['type']    = 'label';
        $this->NM_ajax_info['fldList']['df_subtotal_' . $this->nmgp_refresh_row]['valList'] = array($this->df_subtotal_);
        $this->NM_ajax_changed['df_subtotal_'] = true;
    }
    if (($original_df_total_ != $this->df_total_ || (isset($bFlagRead_df_total_) && $bFlagRead_df_total_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_total_' . $this->nmgp_refresh_row]['type']    = 'label';
        $this->NM_ajax_info['fldList']['df_total_' . $this->nmgp_refresh_row]['valList'] = array($this->df_total_);
        $this->NM_ajax_changed['df_total_'] = true;
    }
    if (($original_df_valor_ice_ != $this->df_valor_ice_ || (isset($bFlagRead_df_valor_ice_) && $bFlagRead_df_valor_ice_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_valor_ice_' . $this->nmgp_refresh_row]['type']    = 'text';
        $this->NM_ajax_info['fldList']['df_valor_ice_' . $this->nmgp_refresh_row]['valList'] = array($this->df_valor_ice_);
        $this->NM_ajax_changed['df_valor_ice_'] = true;
    }
    if (($original_df_valor_irbpnr_ != $this->df_valor_irbpnr_ || (isset($bFlagRead_df_valor_irbpnr_) && $bFlagRead_df_valor_irbpnr_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_valor_irbpnr_' . $this->nmgp_refresh_row]['type']    = 'text';
        $this->NM_ajax_info['fldList']['df_valor_irbpnr_' . $this->nmgp_refresh_row]['valList'] = array($this->df_valor_irbpnr_);
        $this->NM_ajax_changed['df_valor_irbpnr_'] = true;
    }
    if (($original_df_valor_iva_ != $this->df_valor_iva_ || (isset($bFlagRead_df_valor_iva_) && $bFlagRead_df_valor_iva_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_valor_iva_' . $this->nmgp_refresh_row]['type']    = 'label';
        $this->NM_ajax_info['fldList']['df_valor_iva_' . $this->nmgp_refresh_row]['valList'] = array($this->df_valor_iva_);
...
$_SESSION['scriptcase']['form_del_detalle_factura']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['parms'] = "df_id_?#?$this->df_id_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_qtd_reg'];
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_del_detalle_factura = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          $this->NM_where_filter = str_replace("@percent@", "%", $this->NM_where_filter);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter'] . ")";
          }
      }
      $sc_where = "";
      if ('' != $sc_where_filter)
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['total']))
          {
              ...
              $qt_geral_reg_form_del_detalle_factura = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['total'] = $qt_geral_reg_form_del_detalle_factura;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['total']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_I_E'] = 0; 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->df_id_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_del_detalle_factura = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_del_detalle_factura) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] += ($this->sc_max_reg + $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_I_E']); 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] > $qt_geral_reg_form_del_detalle_factura)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] = $qt_geral_reg_form_del_detalle_factura - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] = 0; 
              }
          }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] = ($qt_geral_reg_form_del_detalle_factura + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['ordem_ord'] = ' asc'; 
              switch ($this->nmgp_ordem) {
                  case "df_id":
                      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['ordem_ord'] = ' desc';
                      break;
                  case "df_factura":
                      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['ordem_ord'] = ' desc';
                      break;
          ...
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['ordem_ord'] = ' desc'; 
          }
          else
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nmgp_select = "SELECT df_id, df_factura, df_empresa, df_producto, df_descripcion, df_cantidad, df_precio_unitario, df_subtotal, df_descuento, df_base_iva, df_porcentaje_iva, df_valor_iva, df_base_ice, df_porcentaje_ice, df_valor_ice, df_base_irbpnr, df_porcentaje_irbpnr, df_valor_irbpnr, df_total, df_estado, df_cantidad_nc, df_precio_sin_subsidio, df_bodega, df_costo, df_unidad from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nmgp_select = "SELECT df_id, df_factura, df_empresa, df_producto, df_descripcion, df_cantidad, df_precio_unitario, df_subtotal, df_descuento, df_base_iva, df_porcentaje_iva, df_valor_iva, df_base_ice, df_porcentaje_ice, df_valor_ice, df_base_irbpnr, df_porcentaje_irbpnr, df_valor_irbpnr, df_total, df_estado, df_cantidad_nc, df_precio_sin_subsidio, df_bodega, df_costo, df_unidad from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      ...
      else
      {
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          {
              $sc_seq_vert = 0; 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['empty_filter'] = true;
              }
          }
          else
          {
          ...
          { 
              ...
              $this->nmgp_dados_select['df_producto_'] = $this->df_producto_;
              $this->df_descripcion_ = $rs->fields[4] ; 
              $this->nmgp_dados_select['df_descripcion_'] = $this->df_descripcion_;
              $this->df_cantidad_ = $rs->fields[5] ; 
              $this->nmgp_dados_select['df_cantidad_'] = $this->df_cantidad_;
              $this->df_precio_unitario_ = $rs->fields[6] ; 
              $this->nmgp_dados_select['df_precio_unitario_'] = $this->df_precio_unitario_;
              $this->df_subtotal_ = $rs->fields[7] ; 
              $this->nmgp_dados_select['df_subtotal_'] = $this->df_subtotal_;
              $this->df_descuento_ = $rs->fields[8] ; 
              $this->nmgp_dados_select['df_descuento_'] = $this->df_descuento_;
              $this->df_base_iva_ = $rs->fields[9] ; 
              $this->nmgp_dados_select['df_base_iva_'] = $this->df_base_iva_;
              $this->df_porcentaje_iva_ = $rs->fields[10] ; 
              $this->nmgp_dados_select['df_porcentaje_iva_'] = $this->df_porcentaje_iva_;
              $this->df_valor_iva_ = $rs->fields[11] ; 
              $this->nmgp_dados_select['df_valor_iva_'] = $this->df_valor_iva_;
              $this->df_base_ice_ = $rs->fields[12] ; 
              $this->nmgp_dados_select['df_base_ice_'] = $this->df_base_ice_;
              $this->df_porcentaje_ice_ = $rs->fields[13] ; 
              $this->nmgp_dados_select['df_porcentaje_ice_'] = $this->df_porcentaje_ice_;
              $this->df_valor_ice_ = $rs->fields[14] ; 
              $this->nmgp_dados_select['df_valor_ice_'] = $this->df_valor_ice_;
              $this->df_base_irbpnr_ = $rs->fields[15] ; 
              $this->nmgp_dados_select['df_base_irbpnr_'] = $this->df_base_irbpnr_;
              $this->df_porcentaje_irbpnr_ = $rs->fields[16] ; 
              $this->nmgp_dados_select['df_porcentaje_irbpnr_'] = $this->df_porcentaje_irbpnr_;
              $this->df_valor_irbpnr_ = $rs->fields[17] ; 
              $this->nmgp_dados_select['df_valor_irbpnr_'] = $this->df_valor_irbpnr_;
              $this->df_total_ = $rs->fields[18] ; 
              $this->nmgp_dados_select['df_total_'] = $this->df_total_;
              $this->df_estado_ = $rs->fields[19] ; 
              $this->nmgp_dados_select['df_estado_'] = $this->df_estado_;
              $this->df_cantidad_nc_ = $rs->fields[20] ; 
              $this->nmgp_dados_select['df_cantidad_nc_'] = $this->df_cantidad_nc_;
              $this->df_precio_sin_subsidio_ = $rs->fields[21] ; 
              $this->nmgp_dados_select['df_precio_sin_subsidio_'] = $this->df_precio_sin_subsidio_;
              $this->df_bodega_ = $rs->fields[22] ; 
              $this->nmgp_dados_select['df_bodega_'] = $this->df_bodega_;
              $this->df_costo_ = $rs->fields[23] ; 
              $this->nmgp_dados_select['df_costo_'] = $this->df_costo_;
              $this->df_unidad_ = $rs->fields[24] ; 
              $this->nmgp_dados_select['df_unidad_'] = $this->df_unidad_;
              $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->nm_troca_decimal(",", ".");
              ...
              $this->df_porcentaje_ice_ = (string)$this->df_porcentaje_ice_; 
              ...
              $this->df_cantidad_nc_ = (string)$this->df_cantidad_nc_; 
              $this->df_precio_sin_subsidio_ = (string)$this->df_precio_sin_subsidio_; 
              $this->df_bodega_ = (string)$this->df_bodega_; 
              $this->df_costo_ = (string)$this->df_costo_; 
              $this->df_unidad_ = (string)$this->df_unidad_; 
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['parms'] = "df_id_?#?$this->df_id_?@?";
              } 
              $this->nm_proc_onload_record($sc_seq_vert);
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_id_'] =  $this->df_id_; 
             $this->form_vert_form_del_detalle_factura[$sc_seq_vert]['df_factura_'] =  $this->df_factura_; 
          ...
          ksort ($this->form_vert_form_del_detalle_factura); 
          $rs->Close(); 
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['reg_start'] < (($qt_geral_reg_form_del_detalle_factura + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_multi']) 
          { 
          } 
          else 
          { 
          ...
          { 
              ...
              $this->df_valor_ice_ = "";  
              $this->df_base_irbpnr_ = htmlentities("0");  
              $this->df_porcentaje_irbpnr_ = "";  
              $this->df_valor_irbpnr_ = "";  
              $this->df_total_ = "";  
              $this->df_cantidad_nc_ = "";  
              $this->df_precio_sin_subsidio_ = "";  
              $this->nm_proc_onload_record($sc_seq_vert);
              if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['foreign_key']))
              {
...
// 
   ...
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert] ))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dados_select'][$sc_seq_vert] ;
           ...
           $this->SC_log_arr['fields']['df_descripcion']['0'] =  $nmgp_dados_select['df_descripcion_'];
           ...
           $this->SC_log_arr['fields']['df_cantidad_nc']['0'] =  $nmgp_dados_select['df_cantidad_nc_'];
           $this->SC_log_arr['fields']['df_precio_sin_subsidio']['0'] =  $nmgp_dados_select['df_precio_sin_subsidio_'];
           $this->SC_log_arr['fields']['df_bodega']['0'] =  $nmgp_dados_select['df_bodega_'];
           $this->SC_log_arr['fields']['df_costo']['0'] =  $nmgp_dados_select['df_costo_'];
           $this->SC_log_arr['fields']['df_unidad']['0'] =  $nmgp_dados_select['df_unidad_'];
       }
   }
// 
   function NM_gera_log_new() 
   {
       ...
       $this->SC_log_arr['fields']['df_descripcion']['1'] =  $this->df_descripcion_;
       ...
       $this->SC_log_arr['fields']['df_cantidad_nc']['1'] =  $this->df_cantidad_nc_;
       $this->SC_log_arr['fields']['df_precio_sin_subsidio']['1'] =  $this->df_precio_sin_subsidio_;
       $this->SC_log_arr['fields']['df_bodega']['1'] =  $this->df_bodega_;
       $this->SC_log_arr['fields']['df_costo']['1'] =  $this->df_costo_;
       $this->SC_log_arr['fields']['df_unidad']['1'] =  $this->df_unidad_;
   }
// 
...
// 
   function NM_gera_log_output() 
   {
       ...
       $prim_delim = "";
       $Log_labels = array();
       $Log_labels['df_factura'] =  "Df Factura";
       $Log_labels['df_empresa'] =  "Df Empresa";
       $Log_labels['df_producto'] =  "{lang_producto}";
       $Log_labels['df_descripcion'] =  "{lang_inf_adicional}";
       ...
       $Log_labels['df_porcentaje_iva'] =  "{lang_porcentaje_iva}";
       $Log_labels['df_valor_iva'] =  "{lang_iva}";
       $Log_labels['df_base_ice'] =  "{lang_base_ice}";
       $Log_labels['df_porcentaje_ice'] =  "{lang_porcentaje_ice}";
       $Log_labels['df_valor_ice'] =  "{lang_ice}";
       $Log_labels['df_base_irbpnr'] =  "{lang_base_irbpnr}";
       $Log_labels['df_porcentaje_irbpnr'] =  "{lang_porcentaje_irbpnr}";
       $Log_labels['df_valor_irbpnr'] =  "{lang_irbpnr}";
       $Log_labels['df_total'] =  "{lang_othr_chrt_totl}";
       $Log_labels['df_estado'] =  "{lang_estado}";
       $Log_labels['df_cantidad_nc'] =  "{lang_lot_cantidad}";
       $Log_labels['df_precio_sin_subsidio'] =  "{lang_precio_sin_subsidio}";
       $Log_labels['df_bodega'] =  "Df Bodega";
       $Log_labels['df_costo'] =  "Df Costo";
       $Log_labels['df_unidad'] =  "Df Unidad";
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
function df_cantidad__onChange()
{
$_SESSION['scriptcase']['form_del_detalle_factura']['contr_erro'] = 'on';
...
function df_precio_unitario__onBlur()
{
$_SESSION['scriptcase']['form_del_detalle_factura']['contr_erro'] = 'on';
...
if($this->df_producto_ <>''){
	...
	$check_sql=" SELECT iva_porcentaje
				 FROM v_del_iva_diferenciado 
				 WHERE 
				 est_id=(select fac_establecimiento from del_factura where fac_numero=".$this->sc_temp_var_factura.")
				 and pro_codigo='".$this->df_producto_  ."'
				 and pro_empresa='".$this->sc_temp_Igtech_RucEmpresa."'
				 and fid_fecha=(select fac_fecha from del_factura where fac_numero=".$this->sc_temp_var_factura.");";
	...
	$this->df_subtotal_ =round($this->df_cantidad_ *($this->df_precio_unitario_ -$this->df_descuento_ ),2);
	...
	if($this->df_base_ice_ <>''and $this->df_base_ice_ <>0 and $var_porcentaje_ice<>0 ){
		...
		$this->df_base_iva_ =round($this->df_subtotal_ ,2);
		$this->df_valor_iva_ =round($this->df_base_iva_ *$var_porcentaje_iva/100,2);
		$this->df_base_ice_ =0;  
		$this->df_valor_ice_ =0;
	}
...
$original_df_base_ice_ = $this->df_base_ice_;
$original_df_base_irbpnr_ = $this->df_base_irbpnr_;
$original_df_precio_sin_subsidio_ = $this->df_precio_sin_subsidio_;
$original_df_subtotal_ = $this->df_subtotal_;
$original_df_valor_ice_ = $this->df_valor_ice_;
$original_df_base_iva_ = $this->df_base_iva_;
$original_df_valor_iva_ = $this->df_valor_iva_;
...
if($this->df_producto_ <>''){
	...
	if (isset($this->rs[0][0])){
		...
		if($this->rs[0][7]=='S'){
			$this->df_precio_sin_subsidio_ =$this->rs[0][8];
		}
		
	}
	$check_sql=" SELECT fid_codigo_iva
				 FROM v_del_iva_diferenciado 
				 WHERE 
				 est_id=(select fac_establecimiento from del_factura where fac_numero=".$this->sc_temp_var_factura.")
				 and pro_codigo='".$this->df_producto_  ."'
	...
	if (isset($this->rs[0][0])){
		$this->df_porcentaje_iva_ =$this->rs[0][0];
	}
...
$modificado_df_base_ice_ = $this->df_base_ice_;
$modificado_df_base_irbpnr_ = $this->df_base_irbpnr_;
$modificado_df_precio_sin_subsidio_ = $this->df_precio_sin_subsidio_;
$modificado_df_subtotal_ = $this->df_subtotal_;
$modificado_df_valor_ice_ = $this->df_valor_ice_;
$modificado_df_base_iva_ = $this->df_base_iva_;
$modificado_df_valor_iva_ = $this->df_valor_iva_;
$modificado_df_valor_irbpnr_ = $this->df_valor_irbpnr_;
$modificado_df_total_ = $this->df_total_;
$this->nm_formatar_campos('df_producto_', 'df_cantidad_', 'df_precio_unitario_', 'df_descuento_', 'df_porcentaje_iva_', 'df_porcentaje_ice_', 'df_porcentaje_irbpnr_', 'df_base_ice_', 'df_base_irbpnr_', 'df_precio_sin_subsidio_', 'df_subtotal_', 'df_valor_ice_', 'df_base_iva_', 'df_valor_iva_', 'df_valor_irbpnr_', 'df_total_');
$this->nmgp_refresh_fields = array();
if ($original_df_producto_ !== $modificado_df_producto_ || isset($this->nmgp_cmp_readonly['df_producto_']) || (isset($bFlagRead_df_producto_) && $bFlagRead_df_producto_))
{
    $this->nmgp_refresh_fields[] = 'df_producto_';
...
if ($original_df_precio_sin_subsidio_ !== $modificado_df_precio_sin_subsidio_ || isset($this->nmgp_cmp_readonly['df_precio_sin_subsidio_']) || (isset($bFlagRead_df_precio_sin_subsidio_) && $bFlagRead_df_precio_sin_subsidio_))
{
    $this->nmgp_refresh_fields[] = 'df_precio_sin_subsidio_';
    $this->NM_ajax_changed['df_precio_sin_subsidio_'] = true;
    $this->NM_ajax_force_values = true;
}
if ($original_df_subtotal_ !== $modificado_df_subtotal_ || isset($this->nmgp_cmp_readonly['df_subtotal_']) || (isset($bFlagRead_df_subtotal_) && $bFlagRead_df_subtotal_))
{
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("df_id_", "df_factura_", "df_empresa_", "df_producto_", "df_descripcion_", "df_cantidad_", "df_precio_unitario_", "df_subtotal_", "df_descuento_", "df_base_iva_", "df_porcentaje_iva_", "df_valor_iva_", "df_base_ice_", "df_porcentaje_ice_", "df_valor_ice_", "df_base_irbpnr_", "df_porcentaje_irbpnr_", "df_valor_irbpnr_", "df_total_"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['empty_filter']);
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "df_porcentaje_ice", $arg_search, str_replace(",", ".", $data_search), "INT4", false);
          }
          if ($field == "SC_all_Cmp") 
          {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_del_detalle_factura = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['total'] = $qt_geral_reg_form_del_detalle_factura;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_del_detalle_factura_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "df_id";$nm_numeric[] = "df_factura";$nm_numeric[] = "df_cantidad";$nm_numeric[] = "df_precio_unitario";$nm_numeric[] = "df_subtotal";$nm_numeric[] = "df_descuento";$nm_numeric[] = "df_base_iva";$nm_numeric[] = "df_porcentaje_iva";$nm_numeric[] = "df_valor_iva";$nm_numeric[] = "df_base_ice";$nm_numeric[] = "df_porcentaje_ice";$nm_numeric[] = "df_valor_ice";$nm_numeric[] = "df_base_irbpnr";$nm_numeric[] = "df_valor_irbpnr";$nm_numeric[] = "df_total";$nm_numeric[] = "df_cantidad_nc";$nm_numeric[] = "df_precio_sin_subsidio";$nm_numeric[] = "df_bodega";$nm_numeric[] = "df_costo";$nm_numeric[] = "df_unidad";
   ...
   function SC_lookup_df_producto_($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT pro_codigo||' - '||pro_descripcion, pro_codigo FROM del_producto WHERE (#lowerI##cmp_ipro_codigo||' - '||pro_descripcion#cmp_f)#cmp_apos LIKE #lowerI#'%#arg_i" . $campo . "#arg_f%')#arg_apos) AND (pro_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') AND (pro_familia_producto in (1,3)) AND (pro_estado='V')" ; 
       if ($condicao == "ii")
       {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_del_detalle_factura_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_del_detalle_factura_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura']['ordem_ord'] == " desc") {
