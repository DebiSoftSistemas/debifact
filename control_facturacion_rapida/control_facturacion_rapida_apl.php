<?php
//
class control_facturacion_rapida_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['fr_cantidad']))
          {
              $this->fr_cantidad = $this->NM_ajax_info['param']['fr_cantidad'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['fr_idservicio']))
          {
              $this->fr_idservicio = $this->NM_ajax_info['param']['fr_idservicio'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['fr_servicio']))
          {
              $this->fr_servicio = $this->NM_ajax_info['param']['fr_servicio'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['fr_valor_fijo']))
          {
              $this->fr_valor_fijo = $this->NM_ajax_info['param']['fr_valor_fijo'];
          }
          if (isset($this->NM_ajax_info['param']['fr_valor_minimo']))
          {
              $this->fr_valor_minimo = $this->NM_ajax_info['param']['fr_valor_minimo'];
          }
      ...
      if (isset($this->servicio) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['servicio'] = $this->servicio;
      }
      ...
      if (isset($_POST["servicio"]) && isset($this->servicio)) 
      {
          $_SESSION['servicio'] = $this->servicio;
      }
      ...
      if (isset($_GET["servicio"]) && isset($this->servicio)) 
      {
          $_SESSION['servicio'] = $this->servicio;
      }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new control_facturacion_rapida_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_facturacion_rapida']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_facturacion_rapida'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_facturacion_rapida']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_facturacion_rapida']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('control_facturacion_rapida') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_facturacion_rapida']['label'] = "" . $this->Ini->Nm_lang['lang_facturacion_rapida'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "control_facturacion_rapida")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['control_facturacion_rapida']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['control_facturacion_rapida'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_facturacion_rapida'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_facturacion_rapida'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("control_facturacion_rapida", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      { 
          include_once($this->Ini->path_embutida . 'control_facturacion_rapida/Igtech.ApiCiudadanos.php');
      }
      else
      { 
      ...
      if ($this->Embutida_proc)
      { 
          include_once($this->Ini->path_embutida . 'control_facturacion_rapida/igtech.PocesarDocumentosElectronicos.php');
      }
      else
      { 
      ...
      if (is_file($this->Ini->path_aplicacao . 'control_facturacion_rapida_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'control_facturacion_rapida_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'control_facturacion_rapida/control_facturacion_rapida_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "control_facturacion_rapida_erro.class.php"); 
      }
      $this->Erro      = new control_facturacion_rapida_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['control_facturacion_rapida']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['control_facturacion_rapida']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- fr_idservicio
      $this->field_config['fr_idservicio']               = array();
      $this->field_config['fr_idservicio']['symbol_grp'] = '';
      $this->field_config['fr_idservicio']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['fr_idservicio']['symbol_dec'] = '';
      $this->field_config['fr_idservicio']['symbol_neg'] = '-';
      $this->field_config['fr_idservicio']['format_neg'] = '2';
      //-- fr_cantidad
      $this->field_config['fr_cantidad']               = array();
      $this->field_config['fr_cantidad']['symbol_grp'] = '';
      $this->field_config['fr_cantidad']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['fr_cantidad']['symbol_dec'] = '';
      $this->field_config['fr_cantidad']['symbol_neg'] = '-';
      $this->field_config['fr_cantidad']['format_neg'] = '2';
      //-- fr_valor
      ...
      //-- fr_valor_minimo
      $this->field_config['fr_valor_minimo']               = array();
      $this->field_config['fr_valor_minimo']['symbol_grp'] = '';
      $this->field_config['fr_valor_minimo']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['fr_valor_minimo']['symbol_dec'] = '.';
      $this->field_config['fr_valor_minimo']['symbol_neg'] = '-';
      $this->field_config['fr_valor_minimo']['format_neg'] = '2';
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          if ('validate_fr_idservicio' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fr_idservicio');
          }
          if ('validate_fr_servicio' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fr_servicio');
          }
          if ('validate_fr_cantidad' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fr_cantidad');
          }
          if ('validate_fr_valor' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fr_valor');
          }
          if ('validate_fr_valor_fijo' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fr_valor_fijo');
          }
          ...
          if ('validate_fr_valor_minimo' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fr_valor_minimo');
          }
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_fr_cedula_onblur' == $this->NM_ajax_opcao)
          {
              $this->fr_cedula_onBlur();
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->fr_telefono = "" ;  
          $this->fr_valor_minimo = "" ;  
          $this->fr_cantidad = "1" ;  
          $this->fr_total = "" ;  
          $this->fr_comentario = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos']))
              { 
                  $fr_idservicio = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][0]; 
                  $fr_servicio = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][1]; 
                  $fr_cantidad = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][2]; 
                  $fr_valor = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][3]; 
                  $fr_valor_fijo = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][4]; 
                  $fr_forma_pago = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][5]; 
                  $fr_total = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][6]; 
                  $fr_comentario = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][7]; 
                  $fr_cedula = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][8]; 
                  $fr_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][9]; 
                  $fr_provincia = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][10]; 
                  $fr_canton = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][11]; 
                  $fr_direccion = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][12]; 
                  $fr_tipo_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][13]; 
                  $fr_correo = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][14]; 
                  $fr_telefono = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][15]; 
                  $fr_valor_minimo = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][16]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][0] = $this->fr_idservicio; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][1] = $this->fr_servicio; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][2] = $this->fr_cantidad; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][3] = $this->fr_valor; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][4] = $this->fr_valor_fijo; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][5] = $this->fr_forma_pago; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][6] = $this->fr_total; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][7] = $this->fr_comentario; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][8] = $this->fr_cedula; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][9] = $this->fr_nombre; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][10] = $this->fr_provincia; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][11] = $this->fr_canton; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][12] = $this->fr_direccion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][13] = $this->fr_tipo_identificacion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][14] = $this->fr_correo; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][15] = $this->fr_telefono; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['campos'][16] = $this->fr_valor_minimo; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("control_facturacion_rapida", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("control_facturacion_rapida_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "control_facturacion_rapida.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_facturacion_rapida'] . "") ?></TITLE>
...
<form name="Fdown" method="get" action="control_facturacion_rapida_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="control_facturacion_rapida"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'control_facturacion_rapida', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'control_facturacion_rapida', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'control_facturacion_rapida', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           case 'fr_idservicio':
               ...
               break;
           case 'fr_servicio':
               return "" . $this->Ini->Nm_lang['lang_servicio'] . "";
               break;
           case 'fr_cantidad':
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_control_facturacion_rapida']) || !is_array($this->NM_ajax_info['errList']['geral_control_facturacion_rapida']))
              {
                  $this->NM_ajax_info['errList']['geral_control_facturacion_rapida'] = array();
              }
              $this->NM_ajax_info['errList']['geral_control_facturacion_rapida'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if ((!is_array($filtro) && ('' == $filtro || 'fr_idservicio' == $filtro)) || (is_array($filtro) && in_array('fr_idservicio', $filtro)))
        $this->ValidateField_fr_idservicio($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fr_servicio' == $filtro)) || (is_array($filtro) && in_array('fr_servicio', $filtro)))
        $this->ValidateField_fr_servicio($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fr_cantidad' == $filtro)) || (is_array($filtro) && in_array('fr_cantidad', $filtro)))
        $this->ValidateField_fr_cantidad($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fr_valor_fijo' == $filtro)) || (is_array($filtro) && in_array('fr_valor_fijo', $filtro)))
        $this->ValidateField_fr_valor_fijo($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fr_valor_minimo' == $filtro)) || (is_array($filtro) && in_array('fr_valor_minimo', $filtro)))
        $this->ValidateField_fr_valor_minimo($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if (empty($Campos_Crit) && empty($Campos_Falta) && empty($this->Campos_Mens_erro))
      {
          ...
          {
              $_SESSION['scriptcase']['control_facturacion_rapida']['contr_erro'] = 'on';
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_fr_cantidad = $this->fr_cantidad;
    ...
    $original_fr_idservicio = $this->fr_idservicio;
    ...
    $original_fr_valor_minimo = $this->fr_valor_minimo;
}
...
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
  $check_sql = "select sp_del_busca_parametro ('".$this->sc_temp_Igtech_RucEmpresa."','PARMAXCFINAL','50')";
...
if($this->fr_valor >=$this->fr_valor_minimo ){
	if($this->fr_cedula =='9999999999999' and $this->fr_valor >$w_valor_cfinal){
		$mensaje='NO se puede facturar mas de '.$w_valor_cfinal.' USD a Consumidor final';
	}else{
		...
		$check_sql = "SELECT * from sp_factura_rapida('".$this->sc_temp_Igtech_RucEmpresa."', 
      ...
      { 
		...
		if(isset($this->rs[0][0])){
			$documento=$this->rs[0][2];
			if($this->rs[0][0]==0 ){
				$select_sql='SELECT fac_tipo_comprobante,fac_tipo_libretin FROM del_factura WHERE fac_numero='.$documento;
      ...
      { 
          ...
          $this->dataset_erro = $this->Db->ErrorMsg();
				...
				if(isset($this->dataset[0][0])){
					if($this->dataset[0][0]=='01' and $this->dataset[0][1]=='E'){
						$mensaje=$this->autorizar_factura($documento,$this->sc_temp_Igtech_AutorizacionInmediata);
					}	
				}	
			}
			$mensaje.=$this->rs[0][1];
	...
	$mensaje='El valor Unitario  es menor al valor minimo del servicio';
}
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_fr_cantidad != $this->fr_cantidad || (isset($bFlagRead_fr_cantidad) && $bFlagRead_fr_cantidad)))
    {
        $this->ajax_return_values_fr_cantidad(true);
    }
    ...
    if (($original_fr_idservicio != $this->fr_idservicio || (isset($bFlagRead_fr_idservicio) && $bFlagRead_fr_idservicio)))
    {
        $this->ajax_return_values_fr_idservicio(true);
    }
    ...
    if (($original_fr_valor_minimo != $this->fr_valor_minimo || (isset($bFlagRead_fr_valor_minimo) && $bFlagRead_fr_valor_minimo)))
    {
        $this->ajax_return_values_fr_valor_minimo(true);
    }
}
$_SESSION['scriptcase']['control_facturacion_rapida']['contr_erro'] = 'off'; 
          }
    ...
    function ValidateField_fr_idservicio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fr_idservicio'])) {
          nm_limpa_numero($this->fr_idservicio, $this->field_config['fr_idservicio']['symbol_grp']) ; 
          return;
      }
      nm_limpa_numero($this->fr_idservicio, $this->field_config['fr_idservicio']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->fr_idservicio != '')  
          { 
              $iTestSize = 20;
              if ('-' == substr($this->fr_idservicio, 0, 1))
              {
                  $iTestSize++;
              }
              elseif ('-' == substr($this->fr_idservicio, -1))
              {
                  $iTestSize++;
                  $this->fr_idservicio = '-' . substr($this->fr_idservicio, 0, -1);
              }
              if (strlen($this->fr_idservicio) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_id'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['fr_idservicio']))
                  {
                      $Campos_Erros['fr_idservicio'] = array();
                  }
                  $Campos_Erros['fr_idservicio'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['fr_idservicio']) || !is_array($this->NM_ajax_info['errList']['fr_idservicio']))
                  {
                      $this->NM_ajax_info['errList']['fr_idservicio'] = array();
                  }
                  $this->NM_ajax_info['errList']['fr_idservicio'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->fr_idservicio, 20, 0, 0, 0, "S") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['fr_idservicio'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['fr_idservicio']) || !is_array($this->NM_ajax_info['errList']['fr_idservicio']))
                  {
                      $this->NM_ajax_info['errList']['fr_idservicio'] = array();
                  }
                  $this->NM_ajax_info['errList']['fr_idservicio'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_idservicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_idservicio'] == "on") 
           { 
              $hasError = true;
              ...
              $Campos_Erros['fr_idservicio'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['fr_idservicio']) || !is_array($this->NM_ajax_info['errList']['fr_idservicio']))
                  {
                      $this->NM_ajax_info['errList']['fr_idservicio'] = array();
                  }
                  $this->NM_ajax_info['errList']['fr_idservicio'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fr_idservicio';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fr_idservicio

    function ValidateField_fr_servicio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fr_servicio'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_servicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_servicio'] == "on")) 
      { 
          if ($this->fr_servicio == "")  
          { 
              $hasError = true;
              $Campos_Falta[] =  "" . $this->Ini->Nm_lang['lang_servicio'] . "" ; 
              if (!isset($Campos_Erros['fr_servicio']))
              {
                  $Campos_Erros['fr_servicio'] = array();
              }
              $Campos_Erros['fr_servicio'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['fr_servicio']) || !is_array($this->NM_ajax_info['errList']['fr_servicio']))
                  {
                      $this->NM_ajax_info['errList']['fr_servicio'] = array();
                  }
                  $this->NM_ajax_info['errList']['fr_servicio'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          } 
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fr_servicio) > 200) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_servicio'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 200 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['fr_servicio']))
              {
                  $Campos_Erros['fr_servicio'] = array();
              }
              $Campos_Erros['fr_servicio'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 200 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['fr_servicio']) || !is_array($this->NM_ajax_info['errList']['fr_servicio']))
              {
                  $this->NM_ajax_info['errList']['fr_servicio'] = array();
              }
              $this->NM_ajax_info['errList']['fr_servicio'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 200 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fr_servicio';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fr_servicio

    function ValidateField_fr_cantidad(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fr_cantidad'])) {
          nm_limpa_numero($this->fr_cantidad, $this->field_config['fr_cantidad']['symbol_grp']) ; 
          return;
      }
      if ($this->fr_cantidad === "" || is_null($this->fr_cantidad))  
      { 
          $this->fr_cantidad = 0;
          $this->sc_force_zero[] = 'fr_cantidad';
      } 
      nm_limpa_numero($this->fr_cantidad, $this->field_config['fr_cantidad']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 20;
              if (strlen($this->fr_cantidad) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cantidad'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['fr_cantidad']))
                  {
                      $Campos_Erros['fr_cantidad'] = array();
                  }
                  $Campos_Erros['fr_cantidad'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['fr_cantidad']) || !is_array($this->NM_ajax_info['errList']['fr_cantidad']))
                  {
                      $this->NM_ajax_info['errList']['fr_cantidad'] = array();
                  }
                  $this->NM_ajax_info['errList']['fr_cantidad'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->fr_cantidad, 20, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['fr_cantidad'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['fr_cantidad']) || !is_array($this->NM_ajax_info['errList']['fr_cantidad']))
                  {
                      $this->NM_ajax_info['errList']['fr_cantidad'] = array();
                  }
                  $this->NM_ajax_info['errList']['fr_cantidad'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fr_cantidad';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fr_cantidad
    ...
    function ValidateField_fr_valor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->fr_valor, 18, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_valor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_valor'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_fr_valor_fijo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fr_valor_fijo'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_valor_fijo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_valor_fijo'] == "on")) 
      { 
          if ($this->fr_valor_fijo == "")  
          { 
              $hasError = true;
              $Campos_Falta[] =  "" . $this->Ini->Nm_lang['lang_valor_fijo'] . "" ; 
              if (!isset($Campos_Erros['fr_valor_fijo']))
              {
                  $Campos_Erros['fr_valor_fijo'] = array();
              }
              $Campos_Erros['fr_valor_fijo'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['fr_valor_fijo']) || !is_array($this->NM_ajax_info['errList']['fr_valor_fijo']))
                  {
                      $this->NM_ajax_info['errList']['fr_valor_fijo'] = array();
                  }
                  $this->NM_ajax_info['errList']['fr_valor_fijo'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          } 
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fr_valor_fijo) > 20) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_valor_fijo'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['fr_valor_fijo']))
              {
                  $Campos_Erros['fr_valor_fijo'] = array();
              }
              $Campos_Erros['fr_valor_fijo'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['fr_valor_fijo']) || !is_array($this->NM_ajax_info['errList']['fr_valor_fijo']))
              {
                  $this->NM_ajax_info['errList']['fr_valor_fijo'] = array();
              }
              $this->NM_ajax_info['errList']['fr_valor_fijo'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fr_valor_fijo';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fr_valor_fijo
   ...
   if (isset($this->Field_no_validate['fr_forma_pago'])) {
      ...
      if ($this->fr_forma_pago == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_forma_pago']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_forma_pago'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->fr_forma_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_forma_pago']) && !in_array($this->fr_forma_pago, $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_forma_pago']))
          {
              $hasError = true;
    ...
    function ValidateField_fr_cedula(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_cedula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_cedula'] == "on")) 
      { 
          if ($this->fr_cedula == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_fr_nombre(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      $this->fr_nombre = sc_strtoupper($this->fr_nombre); 
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_nombre'] == "on")) 
      { 
          if ($this->fr_nombre == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['fr_provincia'])) {
      ...
      if ($this->fr_provincia == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_provincia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_provincia'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->fr_provincia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_provincia']) && !in_array($this->fr_provincia, $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_provincia']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['fr_provincia']))
   ...
   if (isset($this->Field_no_validate['fr_canton'])) {
      ...
      if ($this->fr_canton == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_canton']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_canton'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->fr_canton) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_canton']) && !in_array($this->fr_canton, $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_canton']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['fr_canton']))
    ...
    function ValidateField_fr_direccion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_direccion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_direccion'] == "on")) 
      { 
    ...
    function ValidateField_fr_tipo_identificacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_tipo_identificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_tipo_identificacion'] == "on")) 
      { 
    ...
    function ValidateField_fr_correo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_correo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_correo'] == "on")) 
      { 
          if ($this->fr_correo == "")  
          { 
              $hasError = true;
...
;
    ...
    function ValidateField_fr_valor_minimo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fr_valor_minimo'])) {
          if (!empty($this->field_config['fr_valor_minimo']['symbol_dec'])) {
              nm_limpa_valor($this->fr_valor_minimo, $this->field_config['fr_valor_minimo']['symbol_dec'], $this->field_config['fr_valor_minimo']['symbol_grp']) ; 
          }
          return;
      }
      if ($this->fr_valor_minimo === "" || is_null($this->fr_valor_minimo))  
      { 
          $this->fr_valor_minimo = 0;
          $this->sc_force_zero[] = 'fr_valor_minimo';
      } 
      if (!empty($this->field_config['fr_valor_minimo']['symbol_dec']))
      {
          nm_limpa_valor($this->fr_valor_minimo, $this->field_config['fr_valor_minimo']['symbol_dec'], $this->field_config['fr_valor_minimo']['symbol_grp']) ; 
          if ('.' == substr($this->fr_valor_minimo, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->fr_valor_minimo, 1)))
              {
                  $this->fr_valor_minimo = '';
              }
              else
              {
                  $this->fr_valor_minimo = '0' . $this->fr_valor_minimo;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->fr_valor_minimo != '')  
          { 
              $iTestSize = 21;
              if ('-' == substr($this->fr_valor_minimo, 0, 1))
              {
              ...
              elseif ('-' == substr($this->fr_valor_minimo, -1))
              {
                  $iTestSize++;
                  $this->fr_valor_minimo = '-' . substr($this->fr_valor_minimo, 0, -1);
              }
              if (strlen($this->fr_valor_minimo) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Valor Mínimo: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['fr_valor_minimo']))
                  {
                      $Campos_Erros['fr_valor_minimo'] = array();
                  }
                  $Campos_Erros['fr_valor_minimo'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['fr_valor_minimo']) || !is_array($this->NM_ajax_info['errList']['fr_valor_minimo']))
                  {
                      $this->NM_ajax_info['errList']['fr_valor_minimo'] = array();
                  }
                  $this->NM_ajax_info['errList']['fr_valor_minimo'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->fr_valor_minimo, 18, 2, 0, 0, "S") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Valor Mínimo; " ; 
                  if (!isset($Campos_Erros['fr_valor_minimo']))
                  {
                      $Campos_Erros['fr_valor_minimo'] = array();
                  }
                  $Campos_Erros['fr_valor_minimo'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['fr_valor_minimo']) || !is_array($this->NM_ajax_info['errList']['fr_valor_minimo']))
                  {
                      $this->NM_ajax_info['errList']['fr_valor_minimo'] = array();
                  }
                  $this->NM_ajax_info['errList']['fr_valor_minimo'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fr_valor_minimo';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fr_valor_minimo
   ...
   function nm_guardar_campos()
   {
    global
           $sc_seq_vert;
    $this->nmgp_dados_form['fr_idservicio'] = $this->fr_idservicio;
    $this->nmgp_dados_form['fr_servicio'] = $this->fr_servicio;
    $this->nmgp_dados_form['fr_cantidad'] = $this->fr_cantidad;
    $this->nmgp_dados_form['fr_valor'] = $this->fr_valor;
    $this->nmgp_dados_form['fr_valor_fijo'] = $this->fr_valor_fijo;
    ...
    $this->nmgp_dados_form['fr_valor_minimo'] = $this->fr_valor_minimo;
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['fr_idservicio'] = $this->fr_idservicio;
      nm_limpa_numero($this->fr_idservicio, $this->field_config['fr_idservicio']['symbol_grp']) ; 
      $this->Before_unformat['fr_cantidad'] = $this->fr_cantidad;
      nm_limpa_numero($this->fr_cantidad, $this->field_config['fr_cantidad']['symbol_grp']) ; 
      ...
      $this->Before_unformat['fr_valor_minimo'] = $this->fr_valor_minimo;
      if (!empty($this->field_config['fr_valor_minimo']['symbol_dec']))
      {
         nm_limpa_valor($this->fr_valor_minimo, $this->field_config['fr_valor_minimo']['symbol_dec'], $this->field_config['fr_valor_minimo']['symbol_grp']);
      }
   ...
   {
      if ($Nome_Campo == "fr_idservicio")
      {
          nm_limpa_numero($this->fr_idservicio, $this->field_config['fr_idservicio']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "fr_cantidad")
      {
          nm_limpa_numero($this->fr_cantidad, $this->field_config['fr_cantidad']['symbol_grp']) ; 
      }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if ('' !== $this->fr_idservicio || (!empty($format_fields) && isset($format_fields['fr_idservicio'])))
      {
          nmgp_Form_Num_Val($this->fr_idservicio, $this->field_config['fr_idservicio']['symbol_grp'], $this->field_config['fr_idservicio']['symbol_dec'], "0", "S", $this->field_config['fr_idservicio']['format_neg'], "", "", "-", $this->field_config['fr_idservicio']['symbol_fmt']) ; 
      }
      if ('' !== $this->fr_cantidad || (!empty($format_fields) && isset($format_fields['fr_cantidad'])))
      {
          nmgp_Form_Num_Val($this->fr_cantidad, $this->field_config['fr_cantidad']['symbol_grp'], $this->field_config['fr_cantidad']['symbol_dec'], "0", "S", $this->field_config['fr_cantidad']['format_neg'], "", "", "-", $this->field_config['fr_cantidad']['symbol_fmt']) ; 
      }
      ...
      if ('' !== $this->fr_valor_minimo || (!empty($format_fields) && isset($format_fields['fr_valor_minimo'])))
      {
          nmgp_Form_Num_Val($this->fr_valor_minimo, $this->field_config['fr_valor_minimo']['symbol_grp'], $this->field_config['fr_valor_minimo']['symbol_dec'], "2", "S", $this->field_config['fr_valor_minimo']['format_neg'], "", "", "-", $this->field_config['fr_valor_minimo']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   {
          $this->ajax_return_values_fr_idservicio();
          $this->ajax_return_values_fr_servicio();
          $this->ajax_return_values_fr_cantidad();
          $this->ajax_return_values_fr_valor();
          $this->ajax_return_values_fr_valor_fijo();
          ...
          $this->ajax_return_values_fr_valor_minimo();
          ...
          //----- fr_idservicio
   function ajax_return_values_fr_idservicio($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fr_idservicio", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fr_idservicio);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fr_idservicio'] = array(
                       'row'    => '',
               'type'    => 'text',
          ...
          //----- fr_servicio
   function ajax_return_values_fr_servicio($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fr_servicio", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fr_servicio);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fr_servicio'] = array(
                       'row'    => '',
               'type'    => 'text',
          ...
          //----- fr_cantidad
   function ajax_return_values_fr_cantidad($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fr_cantidad", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fr_cantidad);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fr_cantidad'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_fr_valor($bForce = false)
   {
          ...
          //----- fr_valor_fijo
   function ajax_return_values_fr_valor_fijo($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fr_valor_fijo", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fr_valor_fijo);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fr_valor_fijo'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_forma_pago']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_forma_pago'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_forma_pago']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_forma_pago'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(control_facturacion_rapida_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', control_facturacion_rapida_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_forma_pago'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fr_forma_pago']['valList'][$i] = control_facturacion_rapida_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_provincia']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_provincia'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_provincia']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_provincia'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_provincia'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fr_provincia']['valList'][$i] = control_facturacion_rapida_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_canton']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_canton'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_canton']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_canton'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['Lookup_fr_canton'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fr_canton']['valList'][$i] = control_facturacion_rapida_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_fr_telefono($bForce = false)
   {
          ...
          //----- fr_valor_minimo
   function ajax_return_values_fr_valor_minimo($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fr_valor_minimo", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fr_valor_minimo);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fr_valor_minimo'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
if($this->fr_cantidad ==0){
	$this->fr_cantidad =1;
}
$this->fr_total =$this->fr_cantidad *$this->fr_valor ;

$modificado_fr_cantidad = $this->fr_cantidad;
$modificado_fr_total = $this->fr_total;
$modificado_fr_valor = $this->fr_valor;
$this->nm_formatar_campos('fr_cantidad', 'fr_total', 'fr_valor');
if ($original_fr_cantidad !== $modificado_fr_cantidad || isset($this->nmgp_cmp_readonly['fr_cantidad']) || (isset($bFlagRead_fr_cantidad) && $bFlagRead_fr_cantidad))
{
    $this->ajax_return_values_fr_cantidad(true);
}
...
$modificado_fr_cantidad = $this->fr_cantidad;
$modificado_fr_valor = $this->fr_valor;
$this->nm_formatar_campos('fr_total', 'fr_cantidad', 'fr_valor');
if ($original_fr_total !== $modificado_fr_total || isset($this->nmgp_cmp_readonly['fr_total']) || (isset($bFlagRead_fr_total) && $bFlagRead_fr_total))
{
    $this->ajax_return_values_fr_total(true);
}
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_fr_cantidad = $this->fr_cantidad;
    $original_fr_idservicio = $this->fr_idservicio;
    $original_fr_servicio = $this->fr_servicio;
    $original_fr_total = $this->fr_total;
    $original_fr_valor = $this->fr_valor;
    $original_fr_valor_fijo = $this->fr_valor_fijo;
    $original_fr_valor_minimo = $this->fr_valor_minimo;
}
if (!isset($this->sc_temp_servicio)) {$this->sc_temp_servicio = (isset($_SESSION['servicio'])) ? $_SESSION['servicio'] : "";}
if (!isset($this->sc_temp_var_procesar)) {$this->sc_temp_var_procesar = (isset($_SESSION['var_procesar'])) ? $_SESSION['var_procesar'] : "";}
if (!isset($this->sc_temp_Igtech_SesionLogin)) {$this->sc_temp_Igtech_SesionLogin = (isset($_SESSION['Igtech_SesionLogin'])) ? $_SESSION['Igtech_SesionLogin'] : "";}
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
  $check_sql="SELECT lib_id,est_codigo||' - '||pen_serie
				...
				AND lib_tipo_comprobante in ( '01','99')";
...
if(isset($_REQUEST['servicio'])){
	$this->sc_temp_servicio=$_REQUEST['servicio'];
}else{
	 if (isset($this->sc_temp_Igtech_RucEmpresa)) { $_SESSION['Igtech_RucEmpresa'] = $this->sc_temp_Igtech_RucEmpresa;}
 if (isset($this->sc_temp_Igtech_SesionLogin)) { $_SESSION['Igtech_SesionLogin'] = $this->sc_temp_Igtech_SesionLogin;}
 if (isset($this->sc_temp_var_procesar)) { $_SESSION['var_procesar'] = $this->sc_temp_var_procesar;}
 if (isset($this->sc_temp_servicio)) { $_SESSION['servicio'] = $this->sc_temp_servicio;}
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('blank_servicios_rapidos') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
 };
}
...
WHERE fac_id=".$this->sc_temp_servicio;
...
if (isset($this->rs[0][0])){	 
	$this->sc_field_readonly("fr_servicio", 'on');
	$this->fr_idservicio =$this->sc_temp_servicio;
 	$this->fr_servicio = $this->rs[0][0];
    $this->fr_valor = $this->rs[0][1];
	$this->fr_valor_minimo =$this->rs[0][1];
	$this->fr_valor_fijo =$this->rs[0][2];
	$this->fr_total =$this->fr_cantidad *$this->rs[0][1];
	if($this->rs[0][2]=='S'){
		$this->sc_field_readonly("fr_valor", 'on');	
	}else{
	    $this->sc_field_readonly("fr_valor", 'off');
	}
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_fr_servicio != $this->fr_servicio || (isset($bFlagRead_fr_servicio) && $bFlagRead_fr_servicio)))
    {
        $this->ajax_return_values_fr_servicio(true);
    }
    if (($original_fr_total != $this->fr_total || (isset($bFlagRead_fr_total) && $bFlagRead_fr_total)))
    {
        $this->ajax_return_values_fr_total(true);
    ...
    if (($original_fr_valor_fijo != $this->fr_valor_fijo || (isset($bFlagRead_fr_valor_fijo) && $bFlagRead_fr_valor_fijo)))
    {
        $this->ajax_return_values_fr_valor_fijo(true);
    }
    if (($original_fr_valor_minimo != $this->fr_valor_minimo || (isset($bFlagRead_fr_valor_minimo) && $bFlagRead_fr_valor_minimo)))
    {
        $this->ajax_return_values_fr_valor_minimo(true);
...
$_SESSION['scriptcase']['control_facturacion_rapida']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("control_facturacion_rapida_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "control_facturacion_rapida_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['nm_run_menu'] = 2;
       $nmgp_saida_form = "control_facturacion_rapida_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['link_info']['compact_mode']) {
            return;
        }
?>
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR valign="middle">
        ...
        <TD align="left" class="scFormHeaderFont">
          <?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_facturacion_rapida'] . ""; } else { echo "" . $this->Ini->Nm_lang['lang_facturacion_rapida'] . ""; } ?>
        </TD>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['ordem_ord'] == " desc") {
