<?php
//
class control_facturacion_rapida_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new control_facturacion_rapida_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['control_facturacion_rapida_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_facturacion_rapida_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_facturacion_rapida_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_facturacion_rapida_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_facturacion_rapida_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('control_facturacion_rapida_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_facturacion_rapida_mob']['label'] = "" . $this->Ini->Nm_lang['lang_facturacion_rapida'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "control_facturacion_rapida_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['control_facturacion_rapida_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['control_facturacion_rapida_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_facturacion_rapida_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_facturacion_rapida_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_facturacion_rapida_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("control_facturacion_rapida_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'control_facturacion_rapida_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'control_facturacion_rapida_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'control_facturacion_rapida/control_facturacion_rapida_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "control_facturacion_rapida_mob_erro.class.php"); 
      }
      $this->Erro      = new control_facturacion_rapida_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['control_facturacion_rapida_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['control_facturacion_rapida_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['control_facturacion_rapida_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->fr_total = "" ;  
          $this->fr_comentario = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos']))
              { 
                  $fr_idservicio = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][0]; 
                  $fr_servicio = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][1]; 
                  $fr_cantidad = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][2]; 
                  $fr_valor = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][3]; 
                  $fr_valor_fijo = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][4]; 
                  $fr_forma_pago = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][5]; 
                  $fr_total = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][6]; 
                  $fr_comentario = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][7]; 
                  $fr_cedula = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][8]; 
                  $fr_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][9]; 
                  $fr_provincia = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][10]; 
                  $fr_canton = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][11]; 
                  $fr_direccion = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][12]; 
                  $fr_tipo_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][13]; 
                  $fr_correo = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][14]; 
                  $fr_telefono = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][15]; 
                  $fr_valor_minimo = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][16]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][0] = $this->fr_idservicio; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][1] = $this->fr_servicio; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][2] = $this->fr_cantidad; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][3] = $this->fr_valor; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][4] = $this->fr_valor_fijo; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][5] = $this->fr_forma_pago; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][6] = $this->fr_total; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][7] = $this->fr_comentario; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][8] = $this->fr_cedula; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][9] = $this->fr_nombre; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][10] = $this->fr_provincia; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][11] = $this->fr_canton; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][12] = $this->fr_direccion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][13] = $this->fr_tipo_identificacion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][14] = $this->fr_correo; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][15] = $this->fr_telefono; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['campos'][16] = $this->fr_valor_minimo; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("control_facturacion_rapida_mob", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("control_facturacion_rapida_mob_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "control_facturacion_rapida_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="control_facturacion_rapida_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="control_facturacion_rapida_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="control_facturacion_rapida_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'control_facturacion_rapida_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'control_facturacion_rapida_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'control_facturacion_rapida_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_control_facturacion_rapida_mob']) || !is_array($this->NM_ajax_info['errList']['geral_control_facturacion_rapida_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_control_facturacion_rapida_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_control_facturacion_rapida_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if (empty($Campos_Crit) && empty($Campos_Falta) && empty($this->Campos_Mens_erro))
      {
          ...
          {
              $_SESSION['scriptcase']['control_facturacion_rapida_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['control_facturacion_rapida_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_fr_idservicio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_idservicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_idservicio'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_fr_servicio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_servicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_servicio'] == "on")) 
      { 
          if ($this->fr_servicio == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_fr_cantidad(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->fr_cantidad, 20, 0, -0, 1.0E+20, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_fr_valor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_valor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_valor'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_fr_valor_fijo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_valor_fijo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_valor_fijo'] == "on")) 
      { 
   ...
   if (isset($this->Field_no_validate['fr_forma_pago'])) {
      ...
      if ($this->fr_forma_pago == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_forma_pago']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_forma_pago'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->fr_forma_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['Lookup_fr_forma_pago']) && !in_array($this->fr_forma_pago, $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['Lookup_fr_forma_pago']))
          {
              $hasError = true;
    ...
    function ValidateField_fr_cedula(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_cedula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_cedula'] == "on")) 
      { 
          if ($this->fr_cedula == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_fr_nombre(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_nombre'] == "on")) 
      { 
          if ($this->fr_nombre == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['fr_provincia'])) {
      ...
      if ($this->fr_provincia == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_provincia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_provincia'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->fr_provincia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['Lookup_fr_provincia']) && !in_array($this->fr_provincia, $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['Lookup_fr_provincia']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['fr_provincia']))
   ...
   if (isset($this->Field_no_validate['fr_canton'])) {
      ...
      if ($this->fr_canton == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_canton']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_canton'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->fr_canton) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['Lookup_fr_canton']) && !in_array($this->fr_canton, $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['Lookup_fr_canton']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['fr_canton']))
    ...
    function ValidateField_fr_direccion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_direccion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_direccion'] == "on")) 
      { 
    ...
    function ValidateField_fr_tipo_identificacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_tipo_identificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_tipo_identificacion'] == "on")) 
      { 
    ...
    function ValidateField_fr_correo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_correo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['php_cmp_required']['fr_correo'] == "on")) 
      { 
          if ($this->fr_correo == "")  
          { 
              $hasError = true;
...
;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(control_facturacion_rapida_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', control_facturacion_rapida_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fr_forma_pago']['valList'][$i] = control_facturacion_rapida_mob_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fr_provincia']['valList'][$i] = control_facturacion_rapida_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fr_canton']['valList'][$i] = control_facturacion_rapida_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_fr_valor_minimo($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
$_SESSION['scriptcase']['control_facturacion_rapida_mob']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("control_facturacion_rapida_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "control_facturacion_rapida_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "control_facturacion_rapida_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida_mob']['ordem_ord'] == " desc") {
