<?php
class grid_del_nota_debito_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'])
   { 
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_del_nota_debito'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_bot();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_del_nota_debito/grid_del_nota_debito_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['pesq_tab_label'] .= "cl_nombre?#?" . "" . $this->Ini->Nm_lang['lang_cliente'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['pesq_tab_label'] .= "cl_identificacion?#?" . "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("cl_nombre","cl_identificacion");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_del_nota_debito", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $this->Cmps_ord_def["est_codigo||'-'||pen_serie||'-'||nd_secuencial"] = "";
   $this->Cmps_ord_def['sc_field_1'] = " asc";
   $this->Cmps_ord_def["nd_serie_docmod||'-'||nd_secuencial_docmod"] = "";
   $this->Cmps_ord_def['cl_nombre'] = " asc";
   $this->Cmps_ord_def['cl_identificacion'] = " asc";
   $this->Cmps_ord_def['cl_direccion'] = " asc";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] = "muda_qt_linhas";
   } 
   $this->New_label['nd_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . "";
   $this->New_label['sc_field_0'] = "" . $this->Ini->Nm_lang['lang_nota_debito'] . "";
   $this->New_label['sc_field_1'] = "" . $this->Ini->Nm_lang['lang_documento_sustento'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_del_nota_debito'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_del_nota_debito'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_del_nota_debito/grid_del_nota_debito_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_del_nota_debito_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_del_nota_debito_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_select']['nd_numero'] = 'desc'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_orig'] = " where (nd_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and nd_usuario='" . $_SESSION['Igtech_SesionLogin'] . "')";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid'];
   }
//----- 
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
   { 
       $nmgp_select = "SELECT str_replace (convert(char(10),nd_fecha,102), '.', '-') + ' ' + convert(char(8),nd_fecha,20), est_codigo||'-'||pen_serie||'-'||nd_secuencial as sc_field_0, nd_serie_docmod||'-'||nd_secuencial_docmod as sc_field_1, cl_nombre, cl_identificacion, nd_total, nd_estado_sri, cl_direccion, nd_autorizacion, nd_error_sri, nd_numero, nd_estado from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT nd_fecha, est_codigo||'-'||pen_serie||'-'||nd_secuencial as sc_field_0, nd_serie_docmod||'-'||nd_secuencial_docmod as sc_field_1, cl_nombre, cl_identificacion, nd_total, nd_estado_sri, cl_direccion, nd_autorizacion, nd_error_sri, nd_numero, nd_estado from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT convert(char(23),nd_fecha,121), est_codigo||'-'||pen_serie||'-'||nd_secuencial as sc_field_0, nd_serie_docmod||'-'||nd_secuencial_docmod as sc_field_1, cl_nombre, cl_identificacion, nd_total, nd_estado_sri, cl_direccion, nd_autorizacion, nd_error_sri, nd_numero, nd_estado from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT EXTEND(nd_fecha, YEAR TO DAY), est_codigo||'-'||pen_serie||'-'||nd_secuencial as sc_field_0, nd_serie_docmod||'-'||nd_secuencial_docmod as sc_field_1, cl_nombre, cl_identificacion, nd_total, nd_estado_sri, cl_direccion, nd_autorizacion, nd_error_sri, nd_numero, nd_estado from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT nd_fecha, est_codigo||'-'||pen_serie||'-'||nd_secuencial as sc_field_0, nd_serie_docmod||'-'||nd_secuencial_docmod as sc_field_1, cl_nombre, cl_identificacion, nd_total, nd_estado_sri, cl_direccion, nd_autorizacion, nd_error_sri, nd_numero, nd_estado from " . $this->Ini->nm_tabela; 
   } 
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->nd_error_sri = $this->rs_grid->fields[9] ;  
       $this->nd_numero = $this->rs_grid->fields[10] ;  
       $this->nd_numero = (string)$this->nd_numero;
       $this->nd_estado = $this->rs_grid->fields[11] ;  
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
           $this->pb = new scProgressBar();
           $this->pb->setRoot($this->Ini->root);
           $this->pb->setDir($_SESSION['scriptcase']['grid_del_nota_debito']['glo_nm_path_imag_temp'] . "/");
           $this->pb->setProgressbarMd5($_GET['pbmd5']);
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_del_nota_debito_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_del_nota_debito_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_del_nota_debito_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_del_nota_debito_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_del_nota_debito_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_del_nota_debito_jquery_3190.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_del_nota_debito_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_del_nota_debito_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida']) {  
...
$nm_saida->saida("    </style>\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_del_nota_debito-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_del_nota_debito-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_del_nota_debito-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-543daa9e\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_del_nota_debito_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_del_nota_debito_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_del_nota_debito_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_del_nota_debito/grid_del_nota_debito_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_del_nota_debito_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_del_nota_debito_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".grid_del_nota_debito_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'])
   { 
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['doc_word'])
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf_vert'])
   {
   }
   else
   {
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != "print") 
       { 
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_grid_del_nota_debito\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_grid_del_nota_debito\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
       }
           $nm_saida->saida("    <TR>\r\n");
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_grid_del_nota_debito\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_grid_del_nota_debito\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_grid_del_nota_debito\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_grid_del_nota_debito\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_del_nota_debito']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_del_nota_debito']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_del_nota_debito']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_del_nota_debito']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida']) ? "grid_del_nota_debito_" : "";
   $this->css_sep = " ";
   ...
   $this->css_nd_error_sri_label = $compl_css_emb . "css_nd_error_sri_label";
   $this->css_nd_error_sri_grid_line = $compl_css_emb . "css_nd_error_sri_grid_line";
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_label'])
   { 
       $this->New_label['nd_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . "";
       $this->New_label['sc_field_0'] = "" . $this->Ini->Nm_lang['lang_nota_debito'] . "";
       $this->New_label['sc_field_1'] = "" . $this->Ini->Nm_lang['lang_documento_sustento'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_del_nota_debito__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_del_nota_debito-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nd_numero_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nd_numero_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf") {
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . " sc-col-actionbar-left \"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nd_numero_label'] . "\" ><style>\r\n");
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".grid_del_nota_debito_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "" . $this->Ini->Nm_lang['lang_nota_debito'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_sc_field_0_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_sc_field_0_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != 'pdf') {
        ...
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "est_codigo||'-'||pen_serie||'-'||nd_secuencial";
        }
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['sc_field_1'])) ? $this->New_label['sc_field_1'] : "" . $this->Ini->Nm_lang['lang_documento_sustento'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_sc_field_1_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_sc_field_1_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != 'pdf') {
        ...
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
            $NM_cmp_class = "nd_serie_docmod||'-'||nd_secuencial_docmod";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
            $NM_cmp_class = "nd_serie_docmod||'-'||nd_secuencial_docmod";
        }
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_sc_field_1_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_sc_field_1_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_nd_error_sri()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nd_error_sri'])) ? $this->New_label['nd_error_sri'] : "Nd Error Sri";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['nd_error_sri']) || $this->NM_cmp_hidden['nd_error_sri'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nd_error_sri_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nd_error_sri_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
...
function SC_label_rightActionBar()
{
   ...
   $nm_saida->saida("</TD>\r\n");
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $this->NM_cmp_hidden['nd_numero'] = "off"; 
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels']['nd_fecha'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels']['sc_field_0'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['sc_field_1'])) ? $this->New_label['sc_field_1'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels']['sc_field_1'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_nombre'])) ? $this->New_label['cl_nombre'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels']['cl_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_identificacion'])) ? $this->New_label['cl_identificacion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels']['cl_identificacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nd_total'])) ? $this->New_label['nd_total'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels']['nd_total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nd_estado_sri'])) ? $this->New_label['nd_estado_sri'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels']['nd_estado_sri'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_direccion'])) ? $this->New_label['cl_direccion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels']['cl_direccion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nd_autorizacion'])) ? $this->New_label['nd_autorizacion'] : "Nd Autorizacion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels']['nd_autorizacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nd_error_sri'])) ? $this->New_label['nd_error_sri'] : "Nd Error Sri";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels']['nd_error_sri'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nd_numero'])) ? $this->New_label['nd_numero'] : "Nd Numero";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['labels']['nd_numero'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_del_nota_debito']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_del_nota_debito#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito']['lig_iframe_modal'] = "nmsc_iframe_liga_grid_del_nota_debito";
           }
           $nm_saida->saida(" <TR> \r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != "print") 
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_del_nota_debito\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_del_nota_debito\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_grid_del_nota_debito', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_grid_del_nota_debito', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_grid_del_nota_debito', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" &&
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_grid_del_nota_debito\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_grid_del_nota_debito\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               if (!$_SESSION['scriptcase']['proc_mobile']) {
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_grid_del_nota_debito\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_grid_del_nota_debito\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               }
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
   ...
   { 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf'])
{
}
else
{
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_del_nota_debito\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_del_nota_debito\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_grid_del_nota_debito#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-543daa9e\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Page_break_PDF'] = array();
       }
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_del_nota_debito_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->nd_estado = $this->rs_grid->fields[11] ;  
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['rows_emb']++;
          $this->sc_proc_grid = true;
          $_SESSION['scriptcase']['grid_del_nota_debito']['contr_erro'] = 'on';
  if($this->nd_estado_sri <>'AUTORIZADO'and $this->nd_estado_sri <>'ANULADO' ){
...
$_SESSION['scriptcase']['grid_del_nota_debito']['contr_erro'] = 'off';
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf'])
          {
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"display:" . $FieldDisp . ";" . $this->Css_Cmp['css_nd_numero_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"display:" . $FieldDisp . ";" . $this->Css_Cmp['css_nd_numero_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['mostra_edit'] != "N"){ 
              if ($this->grid_emb_form_full)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito']['lig_iframe_modal'] = "nmsc_iframe_liga_grid_del_nota_debito";
              }
              $Sc_parent = ($this->grid_emb_form_full) ? "S" : "";
              $linkTarget = isset($this->Ini->sc_lig_target['A_@scinf__@scinf_form_del_nota_debito']) ? $this->Ini->sc_lig_target['A_@scinf__@scinf_form_del_nota_debito'] : (isset($this->Ini->sc_lig_target['A_@scinf_']) ? $this->Ini->sc_lig_target['A_@scinf_'] : null);
              if (isset($this->Ini->sc_lig_md5["form_del_nota_debito"]) && $this->Ini->sc_lig_md5["form_del_nota_debito"] == "S")
              {
                  ...
                  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['under_dashboard'] && isset($linkTarget))
                  {
                      if ('' != $Parms_Edt && '?@?' != substr($Parms_Edt, -3) && '*scout' != substr($Parms_Edt, -6))
                      {
                          $Parms_Edt .= '*scout';
                      }
                      $Parms_Edt .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $linkTarget . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['compact_mode'] ? '1' : '0') . '*scoutremove_margin*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['remove_margin'] ? '1' : '0') . '*scoutremove_border*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['remove_border'] ? '1' : '0');
                  }
                  $Md5_Edt    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_del_nota_debito@SC_par@" . md5($Parms_Edt);
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Lig_Md5'][md5($Parms_Edt)] = $Parms_Edt;
              }
              else
              {
              ...
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_form_del_nota_debito . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'form_del_nota_debito', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_form_del_nota_debito . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'form_del_nota_debito', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['mostra_edit'] == "N"){ 
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
...
function SC_grid_rightActionBar()
{
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['mostra_edit'] != "N"){ 
   ...
   $nm_saida->saida("<td style=\"padding: 0\">\r\n");
            ...
            if (isset($this->Ini->sc_lig_md5["pdf_mostrar"]) && $this->Ini->sc_lig_md5["pdf_mostrar"] == "S") {
                ...
                $Md5_Lig = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_del_nota_debito@SC_par@" . md5($Parms_Lig);
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
            } else {
 ...
 function NM_grid_sc_field_1()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_sc_field_1_grid_line . "\"  style=\"" . $this->Css_Cmp['css_sc_field_1_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_sc_field_1_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_cl_nombre()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['cl_nombre']) || $this->NM_cmp_hidden['cl_nombre'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function NM_grid_nd_error_sri()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nd_error_sri']) || $this->NM_cmp_hidden['nd_error_sri'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->nd_error_sri));
              $conteudo_original = NM_encode_input(sc_strip_script($this->nd_error_sri));
          }
          else {
              $conteudo = sc_strip_script($this->nd_error_sri); 
              $conteudo_original = sc_strip_script($this->nd_error_sri); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nd_error_sri_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nd_error_sri_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nd_error_sri_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_nd_numero()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nd_numero_grid_line . "\"  style=\"display:" . $FieldDisp . ";" . $this->Css_Cmp['css_nd_numero_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nd_numero_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
 }
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['print_navigator'] == "Netscape")
            {
        ...
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ajax_nav'])
          {
          ...
          if (is_file("grid_del_nota_debito_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_del_nota_debito_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['sc_modal'])
        {
      ...
      { 
          $this->nm_btn_exist['Nueva'][] = "sc_Nueva_top";
           if (isset($this->Ini->sc_lig_md5["blank_nueva_factura"]) && $this->Ini->sc_lig_md5["blank_nueva_factura"] == "S") {
               $Parms_Lig  = "var_tipo_documento*scin05*scoutscript_case_init*scin" . NM_encode_input($this->Ini->sc_page) . "*scout";
               $Md5_Lig    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_del_nota_debito@SC_par@" . md5($Parms_Lig);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
           } else {
               $Md5_Lig  = "var_tipo_documento*scin05*scoutscript_case_init*scin" . NM_encode_input($this->Ini->sc_page) . "*scout";
           }
          $Cod_Btn = nmButtonOutput($this->arr_buttons, "Nueva", "nm_gp_submit5('" .  $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link  . "" .  SC_dir_app_name('blank_nueva_factura')  . "/index.php', '$this->nm_location', '" .  $Md5_Lig  . "', '_self', '', '', '', '', 'blank_nueva_factura');;", "nm_gp_submit5('" .  $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link  . "" .  SC_dir_app_name('blank_nueva_factura')  . "/index.php', '$this->nm_location', '" .  $Md5_Lig  . "', '_self', '', '', '', '', 'blank_nueva_factura');;", "sc_Nueva_top", "", "" . $this->Ini->Nm_lang['lang_nueva_nota_debito'] . "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          $nm_saida->saida("          $Cod_Btn \r\n");
          $NM_btn = true;
      } 
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_del_nota_debito/grid_del_nota_debito_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_del_nota_debito/grid_del_nota_debito_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      ...
      { 
          $this->nm_btn_exist['Autorizar'][] = "sc_Autorizar_top";
           if (isset($this->Ini->sc_lig_md5["blank_autorizar_notas_debito_pendientes"]) && $this->Ini->sc_lig_md5["blank_autorizar_notas_debito_pendientes"] == "S") {
          ...
          $Cod_Btn = nmButtonOutput($this->arr_buttons, "Autorizar", "nm_gp_submit5('" .  $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link  . "" .  SC_dir_app_name('blank_autorizar_notas_debito_pendientes')  . "/index.php', '$this->nm_location', '" .  $Md5_Lig  . "', '_self', '', '', '', '', 'blank_autorizar_notas_debito_pendientes');;", "nm_gp_submit5('" .  $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link  . "" .  SC_dir_app_name('blank_autorizar_notas_debito_pendientes')  . "/index.php', '$this->nm_location', '" .  $Md5_Lig  . "', '_self', '', '', '', '', 'blank_autorizar_notas_debito_pendientes');;", "sc_Autorizar_top", "", "" . $this->Ini->Nm_lang['lang_autorizar'] . "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          $nm_saida->saida("          $Cod_Btn \r\n");
          $NM_btn = true;
      } 
          $nm_saida->saida("         </td> \r\n");
...
$nm_saida->saida("    </style>\r\n");
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['cond_pesq'];
       $pos = strrpos($tmp, "##*@@");
       if ($pos !== false)
       {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('cl_nombre','cl_identificacion');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq']) < 2)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_cl_nombre($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (nd_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and nd_usuario='" . $_SESSION['Igtech_SesionLogin'] . "') and #lowerI#cl_nombre#lowerF# = #lowerI#'$cl_nombre_look'#lowerF# order by cl_nombre"; 
   ...
   function grid_search_cl_identificacion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (nd_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and nd_usuario='" . $_SESSION['Igtech_SesionLogin'] . "') and #lowerI#cl_identificacion#lowerF# = #lowerI#'$cl_identificacion_look'#lowerF# order by cl_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function lookup_ajax_cl_nombre($cl_nombre)
   {
       ...
       $cl_nombre_look = (is_string($cl_nombre) ? substr($this->Db->qstr($cl_nombre), 1, -1) : $cl_nombre); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (nd_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and nd_usuario='" . $_SESSION['Igtech_SesionLogin'] . "') and  #lowerI#cl_nombre#lowerF# like #lowerI#'%" . $cl_nombre . "%'#lowerF# order by cl_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_del_nota_debito_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_cl_identificacion($cl_identificacion)
   {
       ...
       $cl_identificacion_look = (is_string($cl_identificacion) ? substr($this->Db->qstr($cl_identificacion), 1, -1) : $cl_identificacion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (nd_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and nd_usuario='" . $_SESSION['Igtech_SesionLogin'] . "') and  #lowerI#cl_identificacion#lowerF# like #lowerI#'%" . $cl_identificacion . "%'#lowerF# order by cl_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "debi_doc_electronicos/grid_del_nota_debito";
...
function sc_actionbar_disable($buttonName)
{
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_grid_del_nota_debito\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_grid_del_nota_debito\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_del_nota_debito', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_del_nota_debito\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_del_nota_debito_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_del_nota_debito/grid_del_nota_debito_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_del_nota_debito_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=grid_del_nota_debito';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_grid_del_nota_debito');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_grid_del_nota_debito');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_grid_del_nota_debito');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_grid_del_nota_debito');} \r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['grid_del_nota_debito_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_del_nota_debito@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_del_nota_debito_iframe.php\";\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_del_nota_debito_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_del_nota_debito']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_del_nota_debito_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_debito']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_del_nota_debito')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_del_nota_debito', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
