<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="inv_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['inv_id_']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_inventario_inline']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_inventario_inline']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_inv_inventario_inline"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_inventario']['where_detal']))
  {
?>  
  if (parent && parent.nmsc_iframe_liga_form_inv_inventario.scInlineFormReceive)
  {
    parent.nmsc_iframe_liga_form_inv_inventario.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_inventario_inline']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
...
?>  
  ...
  {
    parent.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_inventario_inline']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
