  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_inventario_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inv_inventario_inline_form();
	}
...
?>
  ...
  // ---------- Validate inv_id_
  function do_ajax_form_inv_inventario_inline_validate_inv_id_()
  {
    var nomeCampo_inv_id_ = "inv_id_";
    var var_inv_id_ = scAjaxGetFieldHidden(nomeCampo_inv_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_inventario_inline_validate_inv_id_(var_inv_id_, var_script_case_init, do_ajax_form_inv_inventario_inline_validate_inv_id__cb);
  } // do_ajax_form_inv_inventario_inline_validate_inv_id_

  function do_ajax_form_inv_inventario_inline_validate_inv_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_inventario_inline_validate_inv_id__cb

  // ---------- Validate inv_bodega_
  function do_ajax_form_inv_inventario_inline_validate_inv_bodega_()
  {
    var nomeCampo_inv_bodega_ = "inv_bodega_";
    var var_inv_bodega_ = scAjaxGetFieldText(nomeCampo_inv_bodega_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_inventario_inline_validate_inv_bodega_(var_inv_bodega_, var_script_case_init, do_ajax_form_inv_inventario_inline_validate_inv_bodega__cb);
  } // do_ajax_form_inv_inventario_inline_validate_inv_bodega_

  function do_ajax_form_inv_inventario_inline_validate_inv_bodega__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_inventario_inline_validate_inv_bodega__cb

  // ---------- Validate inv_producto_
  function do_ajax_form_inv_inventario_inline_validate_inv_producto_()
  {
    var nomeCampo_inv_producto_ = "inv_producto_";
    var var_inv_producto_ = scAjaxGetFieldSelect(nomeCampo_inv_producto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_inventario_inline_validate_inv_producto_(var_inv_producto_, var_script_case_init, do_ajax_form_inv_inventario_inline_validate_inv_producto__cb);
  } // do_ajax_form_inv_inventario_inline_validate_inv_producto_

  function do_ajax_form_inv_inventario_inline_validate_inv_producto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_inventario_inline_validate_inv_producto__cb

  // ---------- Validate inv_cantidad_
  function do_ajax_form_inv_inventario_inline_validate_inv_cantidad_()
  {
    var nomeCampo_inv_cantidad_ = "inv_cantidad_";
    var var_inv_cantidad_ = scAjaxGetFieldText(nomeCampo_inv_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_inventario_inline_validate_inv_cantidad_(var_inv_cantidad_, var_script_case_init, do_ajax_form_inv_inventario_inline_validate_inv_cantidad__cb);
  } // do_ajax_form_inv_inventario_inline_validate_inv_cantidad_

  function do_ajax_form_inv_inventario_inline_validate_inv_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_inventario_inline_validate_inv_cantidad__cb

  // ---------- Validate inv_costo_promedio_
  function do_ajax_form_inv_inventario_inline_validate_inv_costo_promedio_()
  {
    var nomeCampo_inv_costo_promedio_ = "inv_costo_promedio_";
    var var_inv_costo_promedio_ = scAjaxGetFieldText(nomeCampo_inv_costo_promedio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_inventario_inline_validate_inv_costo_promedio_(var_inv_costo_promedio_, var_script_case_init, do_ajax_form_inv_inventario_inline_validate_inv_costo_promedio__cb);
  } // do_ajax_form_inv_inventario_inline_validate_inv_costo_promedio_

  function do_ajax_form_inv_inventario_inline_validate_inv_costo_promedio__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_inventario_inline_validate_inv_costo_promedio__cb

  // ---------- Validate inv_total_inventario_
  function do_ajax_form_inv_inventario_inline_validate_inv_total_inventario_()
  {
    var nomeCampo_inv_total_inventario_ = "inv_total_inventario_";
    var var_inv_total_inventario_ = scAjaxGetFieldText(nomeCampo_inv_total_inventario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_inventario_inline_validate_inv_total_inventario_(var_inv_total_inventario_, var_script_case_init, do_ajax_form_inv_inventario_inline_validate_inv_total_inventario__cb);
  } // do_ajax_form_inv_inventario_inline_validate_inv_total_inventario_

  function do_ajax_form_inv_inventario_inline_validate_inv_total_inventario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_inventario_inline_validate_inv_total_inventario__cb

  // ---------- Validate inv_punto_reposicion_
  function do_ajax_form_inv_inventario_inline_validate_inv_punto_reposicion_()
  {
    var nomeCampo_inv_punto_reposicion_ = "inv_punto_reposicion_";
    var var_inv_punto_reposicion_ = scAjaxGetFieldText(nomeCampo_inv_punto_reposicion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_inventario_inline_validate_inv_punto_reposicion_(var_inv_punto_reposicion_, var_script_case_init, do_ajax_form_inv_inventario_inline_validate_inv_punto_reposicion__cb);
  } // do_ajax_form_inv_inventario_inline_validate_inv_punto_reposicion_

  function do_ajax_form_inv_inventario_inline_validate_inv_punto_reposicion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_inventario_inline_validate_inv_punto_reposicion__cb

  // ---------- Validate inv_stock_maximo_
  function do_ajax_form_inv_inventario_inline_validate_inv_stock_maximo_()
  {
    var nomeCampo_inv_stock_maximo_ = "inv_stock_maximo_";
    var var_inv_stock_maximo_ = scAjaxGetFieldText(nomeCampo_inv_stock_maximo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_inventario_inline_validate_inv_stock_maximo_(var_inv_stock_maximo_, var_script_case_init, do_ajax_form_inv_inventario_inline_validate_inv_stock_maximo__cb);
  } // do_ajax_form_inv_inventario_inline_validate_inv_stock_maximo_

  function do_ajax_form_inv_inventario_inline_validate_inv_stock_maximo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_inventario_inline_validate_inv_stock_maximo__cb

  // ---------- Validate inv_stock_minimo_
  function do_ajax_form_inv_inventario_inline_validate_inv_stock_minimo_()
  {
    var nomeCampo_inv_stock_minimo_ = "inv_stock_minimo_";
    var var_inv_stock_minimo_ = scAjaxGetFieldText(nomeCampo_inv_stock_minimo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_inventario_inline_validate_inv_stock_minimo_(var_inv_stock_minimo_, var_script_case_init, do_ajax_form_inv_inventario_inline_validate_inv_stock_minimo__cb);
  } // do_ajax_form_inv_inventario_inline_validate_inv_stock_minimo_

  function do_ajax_form_inv_inventario_inline_validate_inv_stock_minimo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_inventario_inline_validate_inv_stock_minimo__cb

  // ---------- Validate inv_unidad_
  function do_ajax_form_inv_inventario_inline_validate_inv_unidad_()
  {
    var nomeCampo_inv_unidad_ = "inv_unidad_";
    var var_inv_unidad_ = scAjaxGetFieldSelect(nomeCampo_inv_unidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_inventario_inline_validate_inv_unidad_(var_inv_unidad_, var_script_case_init, do_ajax_form_inv_inventario_inline_validate_inv_unidad__cb);
  } // do_ajax_form_inv_inventario_inline_validate_inv_unidad_

  function do_ajax_form_inv_inventario_inline_validate_inv_unidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_inventario_inline_validate_inv_unidad__cb

  // ---------- Validate inv_empresa_
  function do_ajax_form_inv_inventario_inline_validate_inv_empresa_()
  {
    var nomeCampo_inv_empresa_ = "inv_empresa_";
    var var_inv_empresa_ = scAjaxGetFieldText(nomeCampo_inv_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_inventario_inline_validate_inv_empresa_(var_inv_empresa_, var_script_case_init, do_ajax_form_inv_inventario_inline_validate_inv_empresa__cb);
  } // do_ajax_form_inv_inventario_inline_validate_inv_empresa_

  function do_ajax_form_inv_inventario_inline_validate_inv_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_inventario_inline_validate_inv_empresa__cb

  // ---------- Validate inv_estado_
  function do_ajax_form_inv_inventario_inline_validate_inv_estado_()
  {
    var nomeCampo_inv_estado_ = "inv_estado_";
    var var_inv_estado_ = scAjaxGetFieldText(nomeCampo_inv_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_inventario_inline_validate_inv_estado_(var_inv_estado_, var_script_case_init, do_ajax_form_inv_inventario_inline_validate_inv_estado__cb);
  } // do_ajax_form_inv_inventario_inline_validate_inv_estado_

  function do_ajax_form_inv_inventario_inline_validate_inv_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_inventario_inline_validate_inv_estado__cb

  // ---------- Event onchange inv_punto_reposicion_
  function do_ajax_form_inv_inventario_inline_event_inv_punto_reposicion__onchange()
  {
    var var_inv_punto_reposicion_ = scAjaxGetFieldText("inv_punto_reposicion_");
    var var_inv_stock_maximo_ = scAjaxGetFieldText("inv_stock_maximo_");
    var var_inv_stock_minimo_ = scAjaxGetFieldText("inv_stock_minimo_");
    var var_inv_id_ = scAjaxGetFieldHidden("inv_id_");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_inventario_inline_event_inv_punto_reposicion__onchange(var_inv_punto_reposicion_, var_inv_stock_maximo_, var_inv_stock_minimo_, var_inv_id_, var_script_case_init, do_ajax_form_inv_inventario_inline_event_inv_punto_reposicion__onchange_cb);
  } // do_ajax_form_inv_inventario_inline_event_inv_punto_reposicion__onchange

  function do_ajax_form_inv_inventario_inline_event_inv_punto_reposicion__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "inv_punto_reposicion_";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inv_inventario_inline_event_inv_punto_reposicion__onchange_cb_after_alert);
  } // do_ajax_form_inv_inventario_inline_event_inv_punto_reposicion__onchange_cb
  function do_ajax_form_inv_inventario_inline_event_inv_punto_reposicion__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_inv_inventario_inline_event_inv_punto_reposicion__onchange_cb_after_alert

  // ---------- Event onchange inv_stock_maximo_
  function do_ajax_form_inv_inventario_inline_event_inv_stock_maximo__onchange()
  {
    var var_inv_punto_reposicion_ = scAjaxGetFieldText("inv_punto_reposicion_");
    var var_inv_stock_maximo_ = scAjaxGetFieldText("inv_stock_maximo_");
    var var_inv_stock_minimo_ = scAjaxGetFieldText("inv_stock_minimo_");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_inventario_inline_event_inv_stock_maximo__onchange(var_inv_punto_reposicion_, var_inv_stock_maximo_, var_inv_stock_minimo_, var_inv_id_, var_script_case_init, do_ajax_form_inv_inventario_inline_event_inv_stock_maximo__onchange_cb);
  } // do_ajax_form_inv_inventario_inline_event_inv_stock_maximo__onchange

  function do_ajax_form_inv_inventario_inline_event_inv_stock_maximo__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "inv_stock_maximo_";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inv_inventario_inline_event_inv_stock_maximo__onchange_cb_after_alert);
  } // do_ajax_form_inv_inventario_inline_event_inv_stock_maximo__onchange_cb
  function do_ajax_form_inv_inventario_inline_event_inv_stock_maximo__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_inv_inventario_inline_event_inv_stock_maximo__onchange_cb_after_alert

  // ---------- Event onchange inv_stock_minimo_
  function do_ajax_form_inv_inventario_inline_event_inv_stock_minimo__onchange()
  {
    var var_inv_punto_reposicion_ = scAjaxGetFieldText("inv_punto_reposicion_");
    var var_inv_stock_maximo_ = scAjaxGetFieldText("inv_stock_maximo_");
    var var_inv_stock_minimo_ = scAjaxGetFieldText("inv_stock_minimo_");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_inventario_inline_event_inv_stock_minimo__onchange(var_inv_punto_reposicion_, var_inv_stock_maximo_, var_inv_stock_minimo_, var_inv_id_, var_script_case_init, do_ajax_form_inv_inventario_inline_event_inv_stock_minimo__onchange_cb);
  } // do_ajax_form_inv_inventario_inline_event_inv_stock_minimo__onchange

  function do_ajax_form_inv_inventario_inline_event_inv_stock_minimo__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "inv_stock_minimo_";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inv_inventario_inline_event_inv_stock_minimo__onchange_cb_after_alert);
  } // do_ajax_form_inv_inventario_inline_event_inv_stock_minimo__onchange_cb
  function do_ajax_form_inv_inventario_inline_event_inv_stock_minimo__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_inv_inventario_inline_event_inv_stock_minimo__onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_inv_inventario_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_inv_inventario_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_inv_id_ = scAjaxGetFieldHidden("inv_id_");
    var var_inv_bodega_ = scAjaxGetFieldText("inv_bodega_");
    var var_inv_producto_ = scAjaxGetFieldSelect("inv_producto_");
    var var_inv_cantidad_ = scAjaxGetFieldText("inv_cantidad_");
    var var_inv_costo_promedio_ = scAjaxGetFieldText("inv_costo_promedio_");
    var var_inv_total_inventario_ = scAjaxGetFieldText("inv_total_inventario_");
    var var_inv_punto_reposicion_ = scAjaxGetFieldText("inv_punto_reposicion_");
    var var_inv_stock_maximo_ = scAjaxGetFieldText("inv_stock_maximo_");
    var var_inv_stock_minimo_ = scAjaxGetFieldText("inv_stock_minimo_");
    var var_inv_unidad_ = scAjaxGetFieldSelect("inv_unidad_");
    var var_inv_empresa_ = scAjaxGetFieldText("inv_empresa_");
    var var_inv_estado_ = scAjaxGetFieldText("inv_estado_");
    ...
    scAjaxProcOn();
    x_ajax_form_inv_inventario_inline_submit_form(var_inv_id_, var_inv_bodega_, var_inv_producto_, var_inv_cantidad_, var_inv_costo_promedio_, var_inv_total_inventario_, var_inv_punto_reposicion_, var_inv_stock_maximo_, var_inv_stock_minimo_, var_inv_unidad_, var_inv_empresa_, var_inv_estado_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_inventario_inline_submit_form_cb);
  } // do_ajax_form_inv_inventario_inline_submit_form

  function do_ajax_form_inv_inventario_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("inv_id_");
      scAjaxHideErrorDisplay("inv_bodega_");
      scAjaxHideErrorDisplay("inv_producto_");
      scAjaxHideErrorDisplay("inv_cantidad_");
      scAjaxHideErrorDisplay("inv_costo_promedio_");
      scAjaxHideErrorDisplay("inv_total_inventario_");
      scAjaxHideErrorDisplay("inv_punto_reposicion_");
      scAjaxHideErrorDisplay("inv_stock_maximo_");
      scAjaxHideErrorDisplay("inv_stock_minimo_");
      scAjaxHideErrorDisplay("inv_unidad_");
      scAjaxHideErrorDisplay("inv_empresa_");
      scAjaxHideErrorDisplay("inv_estado_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_inv_inventario_inline_submit_form_cb_after_alert);
  } // do_ajax_form_inv_inventario_inline_submit_form_cb
  function do_ajax_form_inv_inventario_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_inventario_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_inv_inventario_inline_navigate_form()
  {
    perform_ajax_form_inv_inventario_inline_navigate_form();
  }

  function perform_ajax_form_inv_inventario_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_inv_inventario_inline_navigate_form(var_inv_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_inventario_inline_navigate_form_cb);
  } // do_ajax_form_inv_inventario_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_inventario_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_inventario_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_inventario_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_inventario_inline_navigate_form_cb
  function do_ajax_form_inv_inventario_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_inv_inventario_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_inv_inventario_inline_navigate_form_cb_after_alert

  function sc_hide_form_inv_inventario_inline_form()
  {
  ...
  ajax_field_list[0] = "inv_id_";
  ajax_field_list[1] = "inv_bodega_";
  ajax_field_list[2] = "inv_producto_";
  ajax_field_list[3] = "inv_cantidad_";
  ajax_field_list[4] = "inv_costo_promedio_";
  ajax_field_list[5] = "inv_total_inventario_";
  ajax_field_list[6] = "inv_punto_reposicion_";
  ajax_field_list[7] = "inv_stock_maximo_";
  ajax_field_list[8] = "inv_stock_minimo_";
  ajax_field_list[9] = "inv_unidad_";
  ajax_field_list[10] = "inv_empresa_";
  ajax_field_list[11] = "inv_estado_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "inv_id_": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inv_bodega_": {"label": "<?php echo $this->Ini->Nm_lang['lang_bodega'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inv_producto_": {"label": "<?php echo $this->Ini->Nm_lang['lang_producto'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inv_cantidad_": {"label": "<?php echo $this->Ini->Nm_lang['lang_existencia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inv_costo_promedio_": {"label": "<?php echo $this->Ini->Nm_lang['lang_costo_promedio'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inv_total_inventario_": {"label": "<?php echo $this->Ini->Nm_lang['lang_total_inventario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inv_punto_reposicion_": {"label": "<?php echo $this->Ini->Nm_lang['lang_punto_reposicion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inv_stock_maximo_": {"label": "<?php echo $this->Ini->Nm_lang['lang_existencia_maxima'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inv_stock_minimo_": {"label": "<?php echo $this->Ini->Nm_lang['lang_existencia_minima'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inv_unidad_": {"label": "<?php echo $this->Ini->Nm_lang['lang_unidad'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inv_empresa_": {"label": "Inv Empresa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inv_estado_": {"label": "Inv Estado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["inv_id_"][1] = "inv_id_";
  ajax_field_mult["inv_bodega_"][1] = "inv_bodega_";
  ajax_field_mult["inv_producto_"][1] = "inv_producto_";
  ajax_field_mult["inv_cantidad_"][1] = "inv_cantidad_";
  ajax_field_mult["inv_costo_promedio_"][1] = "inv_costo_promedio_";
  ajax_field_mult["inv_total_inventario_"][1] = "inv_total_inventario_";
  ajax_field_mult["inv_punto_reposicion_"][1] = "inv_punto_reposicion_";
  ajax_field_mult["inv_stock_maximo_"][1] = "inv_stock_maximo_";
  ajax_field_mult["inv_stock_minimo_"][1] = "inv_stock_minimo_";
  ajax_field_mult["inv_unidad_"][1] = "inv_unidad_";
  ajax_field_mult["inv_empresa_"][1] = "inv_empresa_";
  ajax_field_mult["inv_estado_"][1] = "inv_estado_";

  var ajax_field_id = {
    "inv_producto_": new Array("hidden_field_label_inv_producto_", "hidden_field_data_inv_producto_"),
    "inv_cantidad_": new Array("hidden_field_label_inv_cantidad_", "hidden_field_data_inv_cantidad_"),
    "inv_costo_promedio_": new Array("hidden_field_label_inv_costo_promedio_", "hidden_field_data_inv_costo_promedio_"),
    "inv_total_inventario_": new Array("hidden_field_label_inv_total_inventario_", "hidden_field_data_inv_total_inventario_"),
    "inv_punto_reposicion_": new Array("hidden_field_label_inv_punto_reposicion_", "hidden_field_data_inv_punto_reposicion_"),
    "inv_stock_maximo_": new Array("hidden_field_label_inv_stock_maximo_", "hidden_field_data_inv_stock_maximo_"),
    "inv_stock_minimo_": new Array("hidden_field_label_inv_stock_minimo_", "hidden_field_data_inv_stock_minimo_"),
    "inv_unidad_": new Array("hidden_field_label_inv_unidad_", "hidden_field_data_inv_unidad_")
  };
  ...
  var ajax_read_only = {
    ...
    "inv_producto_": "on",
    "inv_cantidad_": "on",
    "inv_costo_promedio_": "on",
    "inv_total_inventario_": "on",
    "inv_punto_reposicion_": "off",
    "inv_stock_maximo_": "off",
    "inv_stock_minimo_": "off",
    "inv_unidad_": "on",
    "inv_empresa_": "off",
    "inv_estado_": "off"
  };
