...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_factura_compra/form_del_factura_compra_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_factura_compra_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_factura_compra_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['link_info']['remove_border']) {
...
<?php
 include_once("form_del_factura_compra_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_factura_compra'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_factura_compra'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-1';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['nuevo']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['nuevo']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['nuevo']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['nuevo']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['nuevo'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['anular']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['anular']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['anular']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['anular']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['anular'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['enviar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['enviar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['enviar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['enviar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['enviar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['retencion']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['retencion']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['retencion']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['retencion']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['retencion'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['ride']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_disabled']['ride']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['ride']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['ride']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['btn_label']['ride'];
        }
?>
...
<?php } 
?> 
<?php $sStyleHidden_fc_sustento_gasto_dumb = ('' == $sStyleHidden_fc_sustento_gasto) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fc_sustento_gasto_dumb" style="<?php echo $sStyleHidden_fc_sustento_gasto_dumb; ?>"></TD>
<?php $sStyleHidden_vacio_dumb = ('' == $sStyleHidden_vacio) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vacio_dumb" style="<?php echo $sStyleHidden_vacio_dumb; ?>"></TD>
...
<?php $sStyleHidden_fc_tipo_comprobante_dumb = ('' == $sStyleHidden_fc_tipo_comprobante) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fc_tipo_comprobante_dumb" style="<?php echo $sStyleHidden_fc_tipo_comprobante_dumb; ?>"></TD>
...
<input type=hidden name="liq_libretin" value="<?php echo $this->form_encode_input($this->liq_libretin) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['Lookup_liq_libretin']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['Lookup_liq_libretin'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['Lookup_liq_libretin']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['Lookup_liq_libretin'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['Lookup_liq_libretin'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->liq_libretin_1))
          {
              foreach ($this->liq_libretin_1 as $tmp_liq_libretin)
              {
                  if (trim($tmp_liq_libretin) === trim($cadaselect[1])) {$liq_libretin_look .= $cadaselect[0] . '__SC_BREAK_LINE__';}
              }
          }
          elseif (isset($cadaselect[1]) && is_string($this->liq_libretin) && trim($this->liq_libretin) === trim($cadaselect[1])) {$liq_libretin_look .= $cadaselect[0];} 
          $x++; 
   }

?>
<input type="hidden" name="liq_libretin" value="<?php echo $this->form_encode_input($liq_libretin) . "\">" . $liq_libretin_look . ""; ?>
<?php } else { ?>
<?php
   $todo = $this->Form_lookup_liq_libretin();
   $x = 0 ; 
   $liq_libretin_look = ""; 
   while (!empty($todo[$x])) 
   {
          ...
          if (empty($liq_libretin_look))
          {
              $liq_libretin_look = $this->liq_libretin;
          }
   $x = 0; 
   echo "<span id=\"id_read_on_liq_libretin\" class=\"css_liq_libretin_line\" style=\"" .  $sStyleReadLab_liq_libretin . "\">" . $this->form_format_readonly("liq_libretin", $this->form_encode_input($liq_libretin_look)) . "</span><span id=\"id_read_off_liq_libretin\" class=\"css_read_off_liq_libretin" . $this->classes_100perc_fields['span_input'] . "\" style=\"white-space: nowrap; " . $sStyleReadInp_liq_libretin . "\">";
   echo " <span id=\"idAjaxSelect_liq_libretin\" class=\"" . $this->classes_100perc_fields['span_select'] . "\"><select class=\"sc-js-input scFormObjectOdd css_liq_libretin_obj" . $this->classes_100perc_fields['input'] . "\" style=\"\" id=\"id_sc_field_liq_libretin\" name=\"liq_libretin\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->liq_libretin) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
          {
              if (empty($this->liq_libretin)) 
              {
                  echo " selected" ;
              } 
           } 
...
<?php } 
?> 
<?php $sStyleHidden_liq_libretin_dumb = ('' == $sStyleHidden_liq_libretin) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_libretin_dumb" style="<?php echo $sStyleHidden_liq_libretin_dumb; ?>"></TD>
<?php $sStyleHidden_liq_secuencial_dumb = ('' == $sStyleHidden_liq_secuencial) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_secuencial_dumb" style="<?php echo $sStyleHidden_liq_secuencial_dumb; ?>"></TD>
<?php $sStyleHidden_liq_tipo_libretin_dumb = ('' == $sStyleHidden_liq_tipo_libretin) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_tipo_libretin_dumb" style="<?php echo $sStyleHidden_liq_tipo_libretin_dumb; ?>"></TD>
...
<?php $sStyleHidden_liq_establecimiento_dumb = ('' == $sStyleHidden_liq_establecimiento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_establecimiento_dumb" style="<?php echo $sStyleHidden_liq_establecimiento_dumb; ?>"></TD>
<?php $sStyleHidden_liq_punto_emision_dumb = ('' == $sStyleHidden_liq_punto_emision) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_punto_emision_dumb" style="<?php echo $sStyleHidden_liq_punto_emision_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $sStyleHidden_liq_ambiente_dumb = ('' == $sStyleHidden_liq_ambiente) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_ambiente_dumb" style="<?php echo $sStyleHidden_liq_ambiente_dumb; ?>"></TD>
<?php $sStyleHidden_liq_estado_sri_dumb = ('' == $sStyleHidden_liq_estado_sri) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_estado_sri_dumb" style="<?php echo $sStyleHidden_liq_estado_sri_dumb; ?>"></TD>
<?php $sStyleHidden_liq_error_sri_dumb = ('' == $sStyleHidden_liq_error_sri) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_error_sri_dumb" style="<?php echo $sStyleHidden_liq_error_sri_dumb; ?>"></TD>
<?php $sStyleHidden_liq_fecha_autorizacion_dumb = ('' == $sStyleHidden_liq_fecha_autorizacion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_fecha_autorizacion_dumb" style="<?php echo $sStyleHidden_liq_fecha_autorizacion_dumb; ?>"></TD>
<?php $sStyleHidden_liq_clave_dumb = ('' == $sStyleHidden_liq_clave) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_clave_dumb" style="<?php echo $sStyleHidden_liq_clave_dumb; ?>"></TD>
...
<?php $sStyleHidden_fc_serie_dumb = ('' == $sStyleHidden_fc_serie) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fc_serie_dumb" style="<?php echo $sStyleHidden_fc_serie_dumb; ?>"></TD>
<?php $sStyleHidden_fc_secuencial_dumb = ('' == $sStyleHidden_fc_secuencial) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fc_secuencial_dumb" style="<?php echo $sStyleHidden_fc_secuencial_dumb; ?>"></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_proveedor_label" id="hidden_field_label_fc_proveedor" style="<?php echo $sStyleHidden_fc_proveedor; ?>"><span id="id_label_fc_proveedor"><?php echo $this->nm_new_label['fc_proveedor']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_proveedor_line" id="hidden_field_data_fc_proveedor" style="<?php echo $sStyleHidden_fc_proveedor; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_proveedor_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="fc_proveedor" value="<?php echo $this->form_encode_input($fc_proveedor); ?>"><span id="id_ajax_label_fc_proveedor"><?php echo nl2br($fc_proveedor); ?></span>
<?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_del_factura_compra*scout' : '';
   if (isset($this->Ini->sc_lig_md5["busca_proveedor"]) && $this->Ini->sc_lig_md5["busca_proveedor"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_del_factura_compra@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_ruc_proveedor_label" id="hidden_field_label_fc_ruc_proveedor" style="<?php echo $sStyleHidden_fc_ruc_proveedor; ?>"><span id="id_label_fc_ruc_proveedor"><?php echo $this->nm_new_label['fc_ruc_proveedor']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_ruc_proveedor_line" id="hidden_field_data_fc_ruc_proveedor" style="<?php echo $sStyleHidden_fc_ruc_proveedor; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_ruc_proveedor_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_nombre_proveedor_label" id="hidden_field_label_fc_nombre_proveedor" style="<?php echo $sStyleHidden_fc_nombre_proveedor; ?>"><span id="id_label_fc_nombre_proveedor"><?php echo $this->nm_new_label['fc_nombre_proveedor']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_direccion_proveedor_label" id="hidden_field_label_fc_direccion_proveedor" style="<?php echo $sStyleHidden_fc_direccion_proveedor; ?>"><span id="id_label_fc_direccion_proveedor"><?php echo $this->nm_new_label['fc_direccion_proveedor']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_direccion_proveedor_line" id="hidden_field_data_fc_direccion_proveedor" style="<?php echo $sStyleHidden_fc_direccion_proveedor; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_direccion_proveedor_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_email_proveedor_label" id="hidden_field_label_fc_email_proveedor" style="<?php echo $sStyleHidden_fc_email_proveedor; ?>"><span id="id_label_fc_email_proveedor"><?php echo $this->nm_new_label['fc_email_proveedor']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_email_proveedor_line" id="hidden_field_data_fc_email_proveedor" style="<?php echo $sStyleHidden_fc_email_proveedor; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_email_proveedor_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_aplica_ret_label" id="hidden_field_label_fc_aplica_ret" style="<?php echo $sStyleHidden_fc_aplica_ret; ?>"><span id="id_label_fc_aplica_ret"><?php echo $this->nm_new_label['fc_aplica_ret']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_aplica_ret_line" id="hidden_field_data_fc_aplica_ret" style="<?php echo $sStyleHidden_fc_aplica_ret; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_aplica_ret_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_comentario_label" id="hidden_field_label_fc_comentario" style="<?php echo $sStyleHidden_fc_comentario; ?>"><span id="id_label_fc_comentario"><?php echo $this->nm_new_label['fc_comentario']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_comentario_line" id="hidden_field_data_fc_comentario" style="<?php echo $sStyleHidden_fc_comentario; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_comentario_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_aplica_propina_label" id="hidden_field_label_fc_aplica_propina" style="<?php echo $sStyleHidden_fc_aplica_propina; ?>"><span id="id_label_fc_aplica_propina"><?php echo $this->nm_new_label['fc_aplica_propina']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_aplica_propina_line" id="hidden_field_data_fc_aplica_propina" style="<?php echo $sStyleHidden_fc_aplica_propina; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_aplica_propina_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalles'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalles'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalles'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_liga_qtd_reg'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_detalle_factura_compra']['embutida_parms'] = "var_factura*scin" . $this->nmgp_dados_form['fc_id'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init'] ]['form_del_factura_compra']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_factura_compra_empty.htm' : $this->Ini->link_form_del_detalle_factura_compra_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=440';
if (isset($this->Ini->sc_lig_target['C_@scinf_detalles']) && 'nmsc_iframe_liga_form_del_detalle_factura_compra' != $this->Ini->sc_lig_target['C_@scinf_detalles'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalles'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_detalle_factura_compra_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_del_detalle_factura_compra"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="440" width="100%" name="nmsc_iframe_liga_form_del_detalle_factura_compra"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_subtotal_label" id="hidden_field_label_fc_subtotal" style="<?php echo $sStyleHidden_fc_subtotal; ?>"><span id="id_label_fc_subtotal"><?php echo $this->nm_new_label['fc_subtotal']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_subtotal_line" id="hidden_field_data_fc_subtotal" style="<?php echo $sStyleHidden_fc_subtotal; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_subtotal_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_subtotal_iva_label" id="hidden_field_label_fc_subtotal_iva" style="<?php echo $sStyleHidden_fc_subtotal_iva; ?>"><span id="id_label_fc_subtotal_iva"><?php echo $this->nm_new_label['fc_subtotal_iva']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_subtotal_iva_line" id="hidden_field_data_fc_subtotal_iva" style="<?php echo $sStyleHidden_fc_subtotal_iva; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_subtotal_iva_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_subtotal_cero_label" id="hidden_field_label_fc_subtotal_cero" style="<?php echo $sStyleHidden_fc_subtotal_cero; ?>"><span id="id_label_fc_subtotal_cero"><?php echo $this->nm_new_label['fc_subtotal_cero']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_subtotal_cero_line" id="hidden_field_data_fc_subtotal_cero" style="<?php echo $sStyleHidden_fc_subtotal_cero; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_subtotal_cero_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_subtotal_no_objeto_label" id="hidden_field_label_fc_subtotal_no_objeto" style="<?php echo $sStyleHidden_fc_subtotal_no_objeto; ?>"><span id="id_label_fc_subtotal_no_objeto"><?php echo $this->nm_new_label['fc_subtotal_no_objeto']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_subtotal_excento_label" id="hidden_field_label_fc_subtotal_excento" style="<?php echo $sStyleHidden_fc_subtotal_excento; ?>"><span id="id_label_fc_subtotal_excento"><?php echo $this->nm_new_label['fc_subtotal_excento']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_subtotal_excento_line" id="hidden_field_data_fc_subtotal_excento" style="<?php echo $sStyleHidden_fc_subtotal_excento; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_subtotal_excento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_total_descuento_label" id="hidden_field_label_fc_total_descuento" style="<?php echo $sStyleHidden_fc_total_descuento; ?>"><span id="id_label_fc_total_descuento"><?php echo $this->nm_new_label['fc_total_descuento']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_total_descuento_line" id="hidden_field_data_fc_total_descuento" style="<?php echo $sStyleHidden_fc_total_descuento; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_total_descuento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_valor_ice_label" id="hidden_field_label_fc_valor_ice" style="<?php echo $sStyleHidden_fc_valor_ice; ?>"><span id="id_label_fc_valor_ice"><?php echo $this->nm_new_label['fc_valor_ice']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_valor_ice_line" id="hidden_field_data_fc_valor_ice" style="<?php echo $sStyleHidden_fc_valor_ice; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_valor_ice_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_valor_iva_label" id="hidden_field_label_fc_valor_iva" style="<?php echo $sStyleHidden_fc_valor_iva; ?>"><span id="id_label_fc_valor_iva"><?php echo $this->nm_new_label['fc_valor_iva']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_valor_iva_line" id="hidden_field_data_fc_valor_iva" style="<?php echo $sStyleHidden_fc_valor_iva; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_valor_iva_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_valor_irbpnr_label" id="hidden_field_label_fc_valor_irbpnr" style="<?php echo $sStyleHidden_fc_valor_irbpnr; ?>"><span id="id_label_fc_valor_irbpnr"><?php echo $this->nm_new_label['fc_valor_irbpnr']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_valor_irbpnr_line" id="hidden_field_data_fc_valor_irbpnr" style="<?php echo $sStyleHidden_fc_valor_irbpnr; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_valor_irbpnr_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_propina_label" id="hidden_field_label_fc_propina" style="<?php echo $sStyleHidden_fc_propina; ?>"><span id="id_label_fc_propina"><?php echo $this->nm_new_label['fc_propina']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_propina_line" id="hidden_field_data_fc_propina" style="<?php echo $sStyleHidden_fc_propina; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_propina_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fc_total_label" id="hidden_field_label_fc_total" style="<?php echo $sStyleHidden_fc_total; ?>"><span id="id_label_fc_total"><?php echo $this->nm_new_label['fc_total']; ?></span></TD>
    <TD class="scFormDataOdd css_fc_total_line" id="hidden_field_data_fc_total" style="<?php echo $sStyleHidden_fc_total; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_total_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_forma_pago'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_forma_pago'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_forma_pago'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_liga_qtd_reg'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_forma_pago_factura_compra']['embutida_parms'] = "var_factura*scin" . $this->nmgp_dados_form['fc_id'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init'] ]['form_del_factura_compra']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_factura_compra_empty.htm' : $this->Ini->link_form_del_forma_pago_factura_compra_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=200';
if (isset($this->Ini->sc_lig_target['C_@scinf_forma_pago']) && 'nmsc_iframe_liga_form_del_forma_pago_factura_compra' != $this->Ini->sc_lig_target['C_@scinf_forma_pago'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_forma_pago'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['form_del_forma_pago_factura_compra_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_del_forma_pago_factura_compra"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="200" width="100%" name="nmsc_iframe_liga_form_del_forma_pago_factura_compra"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_factura_compra");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_factura_compra");
 parent.scAjaxDetailHeight("form_del_factura_compra", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
