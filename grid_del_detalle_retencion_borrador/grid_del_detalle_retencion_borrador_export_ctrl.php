<?php
@session_start() ;
$_SESSION['scriptcase']['grid_del_detalle_retencion_borrador']['sc_process_barr'] = true;
require_once('../grid_del_detalle_retencion_borrador/index.php');
unset($_SESSION['scriptcase']['grid_del_detalle_retencion_borrador']['sc_process_barr']);
$ExportCtrl = new grid_del_detalle_retencion_borrador_export_control;
$ExportCtrl->Export_barr();

class grid_del_detalle_retencion_borrador_export_control
{
