  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_forma_pago_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_forma_pago_inline_form();
	}
...
?>
  ...
  // ---------- Validate fp_id_
  function do_ajax_form_del_forma_pago_inline_validate_fp_id_()
  {
    var nomeCampo_fp_id_ = "fp_id_";
    var var_fp_id_ = scAjaxGetFieldHidden(nomeCampo_fp_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_inline_validate_fp_id_(var_fp_id_, var_script_case_init, do_ajax_form_del_forma_pago_inline_validate_fp_id__cb);
  } // do_ajax_form_del_forma_pago_inline_validate_fp_id_

  function do_ajax_form_del_forma_pago_inline_validate_fp_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_inline_validate_fp_id__cb

  // ---------- Validate fp_empresa_
  function do_ajax_form_del_forma_pago_inline_validate_fp_empresa_()
  {
    var nomeCampo_fp_empresa_ = "fp_empresa_";
    var var_fp_empresa_ = scAjaxGetFieldText(nomeCampo_fp_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_inline_validate_fp_empresa_(var_fp_empresa_, var_script_case_init, do_ajax_form_del_forma_pago_inline_validate_fp_empresa__cb);
  } // do_ajax_form_del_forma_pago_inline_validate_fp_empresa_

  function do_ajax_form_del_forma_pago_inline_validate_fp_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_inline_validate_fp_empresa__cb

  // ---------- Validate fp_descripcion_
  function do_ajax_form_del_forma_pago_inline_validate_fp_descripcion_()
  {
    var nomeCampo_fp_descripcion_ = "fp_descripcion_";
    var var_fp_descripcion_ = scAjaxGetFieldText(nomeCampo_fp_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_inline_validate_fp_descripcion_(var_fp_descripcion_, var_script_case_init, do_ajax_form_del_forma_pago_inline_validate_fp_descripcion__cb);
  } // do_ajax_form_del_forma_pago_inline_validate_fp_descripcion_

  function do_ajax_form_del_forma_pago_inline_validate_fp_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_inline_validate_fp_descripcion__cb

  // ---------- Validate fp_sri_
  function do_ajax_form_del_forma_pago_inline_validate_fp_sri_()
  {
    var nomeCampo_fp_sri_ = "fp_sri_";
    var var_fp_sri_ = scAjaxGetFieldSelect(nomeCampo_fp_sri_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_inline_validate_fp_sri_(var_fp_sri_, var_script_case_init, do_ajax_form_del_forma_pago_inline_validate_fp_sri__cb);
  } // do_ajax_form_del_forma_pago_inline_validate_fp_sri_

  function do_ajax_form_del_forma_pago_inline_validate_fp_sri__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fp_sri_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_inline_validate_fp_sri__cb

  // ---------- Validate fp_tipo_
  function do_ajax_form_del_forma_pago_inline_validate_fp_tipo_()
  {
    var nomeCampo_fp_tipo_ = "fp_tipo_";
    var var_fp_tipo_ = scAjaxGetFieldSelect(nomeCampo_fp_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_inline_validate_fp_tipo_(var_fp_tipo_, var_script_case_init, do_ajax_form_del_forma_pago_inline_validate_fp_tipo__cb);
  } // do_ajax_form_del_forma_pago_inline_validate_fp_tipo_

  function do_ajax_form_del_forma_pago_inline_validate_fp_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_inline_validate_fp_tipo__cb

  // ---------- Validate fp_compra_venta_
  function do_ajax_form_del_forma_pago_inline_validate_fp_compra_venta_()
  {
    var nomeCampo_fp_compra_venta_ = "fp_compra_venta_";
    var var_fp_compra_venta_ = scAjaxGetFieldSelect(nomeCampo_fp_compra_venta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_inline_validate_fp_compra_venta_(var_fp_compra_venta_, var_script_case_init, do_ajax_form_del_forma_pago_inline_validate_fp_compra_venta__cb);
  } // do_ajax_form_del_forma_pago_inline_validate_fp_compra_venta_

  function do_ajax_form_del_forma_pago_inline_validate_fp_compra_venta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_inline_validate_fp_compra_venta__cb

  // ---------- Validate fp_estado_
  function do_ajax_form_del_forma_pago_inline_validate_fp_estado_()
  {
    var nomeCampo_fp_estado_ = "fp_estado_";
    var var_fp_estado_ = scAjaxGetFieldSelect(nomeCampo_fp_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_inline_validate_fp_estado_(var_fp_estado_, var_script_case_init, do_ajax_form_del_forma_pago_inline_validate_fp_estado__cb);
  } // do_ajax_form_del_forma_pago_inline_validate_fp_estado_

  function do_ajax_form_del_forma_pago_inline_validate_fp_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_inline_validate_fp_estado__cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_forma_pago_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_forma_pago_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fp_id_ = scAjaxGetFieldHidden("fp_id_");
    var var_fp_empresa_ = scAjaxGetFieldText("fp_empresa_");
    var var_fp_descripcion_ = scAjaxGetFieldText("fp_descripcion_");
    var var_fp_sri_ = scAjaxGetFieldSelect("fp_sri_");
    var var_fp_tipo_ = scAjaxGetFieldSelect("fp_tipo_");
    var var_fp_compra_venta_ = scAjaxGetFieldSelect("fp_compra_venta_");
    var var_fp_estado_ = scAjaxGetFieldSelect("fp_estado_");
    ...
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_inline_submit_form(var_fp_id_, var_fp_empresa_, var_fp_descripcion_, var_fp_sri_, var_fp_tipo_, var_fp_compra_venta_, var_fp_estado_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_forma_pago_inline_submit_form_cb);
  } // do_ajax_form_del_forma_pago_inline_submit_form

  function do_ajax_form_del_forma_pago_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("fp_id_");
      scAjaxHideErrorDisplay("fp_empresa_");
      scAjaxHideErrorDisplay("fp_descripcion_");
      scAjaxHideErrorDisplay("fp_sri_");
      scAjaxHideErrorDisplay("fp_tipo_");
      scAjaxHideErrorDisplay("fp_compra_venta_");
      scAjaxHideErrorDisplay("fp_estado_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_forma_pago_inline_submit_form_cb_after_alert);
  } // do_ajax_form_del_forma_pago_inline_submit_form_cb
  function do_ajax_form_del_forma_pago_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_forma_pago_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_forma_pago_inline_navigate_form()
  {
    perform_ajax_form_del_forma_pago_inline_navigate_form();
  }

  function perform_ajax_form_del_forma_pago_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_inline_navigate_form(var_fp_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_forma_pago_inline_navigate_form_cb);
  } // do_ajax_form_del_forma_pago_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_forma_pago_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_forma_pago_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_forma_pago_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_del_forma_pago_inline_navigate_form_cb
  function do_ajax_form_del_forma_pago_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_forma_pago_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_forma_pago_inline_navigate_form_cb_after_alert

  function sc_hide_form_del_forma_pago_inline_form()
  {
  ...
  ajax_field_list[0] = "fp_id_";
  ajax_field_list[1] = "fp_empresa_";
  ajax_field_list[2] = "fp_descripcion_";
  ajax_field_list[3] = "fp_sri_";
  ajax_field_list[4] = "fp_tipo_";
  ajax_field_list[5] = "fp_compra_venta_";
  ajax_field_list[6] = "fp_estado_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "fp_id_": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fp_empresa_": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fp_descripcion_": {"label": "<?php echo $this->Ini->Nm_lang['lang_forma_pago'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fp_sri_": {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo_sri'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fp_tipo_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_tesoreria'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fp_compra_venta_": {"label": "<?php echo $this->Ini->Nm_lang['lang_modulo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fp_estado_": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["fp_id_"][1] = "fp_id_";
  ajax_field_mult["fp_empresa_"][1] = "fp_empresa_";
  ajax_field_mult["fp_descripcion_"][1] = "fp_descripcion_";
  ajax_field_mult["fp_sri_"][1] = "fp_sri_";
  ajax_field_mult["fp_tipo_"][1] = "fp_tipo_";
  ajax_field_mult["fp_compra_venta_"][1] = "fp_compra_venta_";
  ajax_field_mult["fp_estado_"][1] = "fp_estado_";

  var ajax_field_id = {
    "fp_descripcion_": new Array("hidden_field_label_fp_descripcion_", "hidden_field_data_fp_descripcion_"),
    "fp_sri_": new Array("hidden_field_label_fp_sri_", "hidden_field_data_fp_sri_"),
    "fp_tipo_": new Array("hidden_field_label_fp_tipo_", "hidden_field_data_fp_tipo_"),
    "fp_compra_venta_": new Array("hidden_field_label_fp_compra_venta_", "hidden_field_data_fp_compra_venta_"),
    "fp_estado_": new Array("hidden_field_label_fp_estado_", "hidden_field_data_fp_estado_")
  };
