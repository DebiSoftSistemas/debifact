  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_forma_pago" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_forma_pago_form();
	}
...
?>
  ...
  // ---------- Validate fp_id_
  function do_ajax_form_del_forma_pago_validate_fp_id_(iNumLinha)
  {
    var nomeCampo_fp_id_ = "fp_id_" + iNumLinha;
    var var_fp_id_ = scAjaxGetFieldHidden(nomeCampo_fp_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_validate_fp_id_(var_fp_id_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_validate_fp_id__cb);
  } // do_ajax_form_del_forma_pago_validate_fp_id_

  function do_ajax_form_del_forma_pago_validate_fp_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "fp_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_validate_fp_id__cb

  // ---------- Validate fp_empresa_
  function do_ajax_form_del_forma_pago_validate_fp_empresa_(iNumLinha)
  {
    var nomeCampo_fp_empresa_ = "fp_empresa_" + iNumLinha;
    var var_fp_empresa_ = scAjaxGetFieldText(nomeCampo_fp_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_validate_fp_empresa_(var_fp_empresa_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_validate_fp_empresa__cb);
  } // do_ajax_form_del_forma_pago_validate_fp_empresa_

  function do_ajax_form_del_forma_pago_validate_fp_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_validate_fp_empresa__cb

  // ---------- Validate fp_descripcion_
  function do_ajax_form_del_forma_pago_validate_fp_descripcion_(iNumLinha)
  {
    var nomeCampo_fp_descripcion_ = "fp_descripcion_" + iNumLinha;
    var var_fp_descripcion_ = scAjaxGetFieldText(nomeCampo_fp_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_validate_fp_descripcion_(var_fp_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_validate_fp_descripcion__cb);
  } // do_ajax_form_del_forma_pago_validate_fp_descripcion_

  function do_ajax_form_del_forma_pago_validate_fp_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_validate_fp_descripcion__cb

  // ---------- Validate fp_sri_
  function do_ajax_form_del_forma_pago_validate_fp_sri_(iNumLinha)
  {
    var nomeCampo_fp_sri_ = "fp_sri_" + iNumLinha;
    var var_fp_sri_ = scAjaxGetFieldSelect(nomeCampo_fp_sri_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_validate_fp_sri_(var_fp_sri_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_validate_fp_sri__cb);
  } // do_ajax_form_del_forma_pago_validate_fp_sri_

  function do_ajax_form_del_forma_pago_validate_fp_sri__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_sri_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_sri_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_sri_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_sri_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_validate_fp_sri__cb

  // ---------- Validate fp_tipo_
  function do_ajax_form_del_forma_pago_validate_fp_tipo_(iNumLinha)
  {
    var nomeCampo_fp_tipo_ = "fp_tipo_" + iNumLinha;
    var var_fp_tipo_ = scAjaxGetFieldSelect(nomeCampo_fp_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_validate_fp_tipo_(var_fp_tipo_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_validate_fp_tipo__cb);
  } // do_ajax_form_del_forma_pago_validate_fp_tipo_

  function do_ajax_form_del_forma_pago_validate_fp_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_tipo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_tipo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_tipo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_tipo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_validate_fp_tipo__cb

  // ---------- Validate fp_compra_venta_
  function do_ajax_form_del_forma_pago_validate_fp_compra_venta_(iNumLinha)
  {
    var nomeCampo_fp_compra_venta_ = "fp_compra_venta_" + iNumLinha;
    var var_fp_compra_venta_ = scAjaxGetFieldSelect(nomeCampo_fp_compra_venta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_validate_fp_compra_venta_(var_fp_compra_venta_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_validate_fp_compra_venta__cb);
  } // do_ajax_form_del_forma_pago_validate_fp_compra_venta_

  function do_ajax_form_del_forma_pago_validate_fp_compra_venta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_compra_venta_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_compra_venta_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_compra_venta_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_compra_venta_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_validate_fp_compra_venta__cb

  // ---------- Validate fp_estado_
  function do_ajax_form_del_forma_pago_validate_fp_estado_(iNumLinha)
  {
    var nomeCampo_fp_estado_ = "fp_estado_" + iNumLinha;
    var var_fp_estado_ = scAjaxGetFieldSelect(nomeCampo_fp_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_validate_fp_estado_(var_fp_estado_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_validate_fp_estado__cb);
  } // do_ajax_form_del_forma_pago_validate_fp_estado_

  function do_ajax_form_del_forma_pago_validate_fp_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_validate_fp_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_forma_pago_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_forma_pago_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_forma_pago_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_forma_pago_add_new_line_cb);
  } // do_ajax_form_del_forma_pago_add_new_line

  function do_ajax_form_del_forma_pago_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_forma_pago_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_forma_pago_backup_line(iNumLinha)
  {
    var var_fp_id_ = scAjaxGetFieldHidden("fp_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_backup_line(var_fp_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_forma_pago_backup_line_cb);
  } // do_ajax_form_del_forma_pago_backup_line

  function do_ajax_form_del_forma_pago_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_forma_pago_backup_line_cb

  function do_ajax_form_del_forma_pago_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_forma_pago_cancel_insert

  function do_ajax_form_del_forma_pago_cancel_update(iSeqVert)
  {
    do_ajax_form_del_forma_pago_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_forma_pago_cancel_update

  function do_ajax_form_del_forma_pago_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_forma_pago_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_forma_pago_table_refresh()
  {
    var var_fp_id_ = document.F2.fp_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_table_refresh(var_fp_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_forma_pago_table_refresh_cb);
  } //  do_ajax_form_del_forma_pago_table_refresh

  function do_ajax_form_del_forma_pago_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.fp_id_.value = scAjaxGetKeyValue("fp_id_");
    ...
    scAjaxAlert(do_ajax_form_del_forma_pago_table_refresh_cb_after_alert);
  } // do_ajax_form_del_forma_pago_table_refresh_cb
  function do_ajax_form_del_forma_pago_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_del_forma_pago_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_forma_pago_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_forma_pago_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_fp_id_ = scAjaxGetFieldHidden("fp_id_" + iNumLinha);
    var var_fp_empresa_ = scAjaxGetFieldText("fp_empresa_" + iNumLinha);
    var var_fp_descripcion_ = scAjaxGetFieldText("fp_descripcion_" + iNumLinha);
    var var_fp_sri_ = scAjaxGetFieldSelect("fp_sri_" + iNumLinha);
    var var_fp_tipo_ = scAjaxGetFieldSelect("fp_tipo_" + iNumLinha);
    var var_fp_compra_venta_ = scAjaxGetFieldSelect("fp_compra_venta_" + iNumLinha);
    var var_fp_estado_ = scAjaxGetFieldSelect("fp_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_forma_pago_submit_form(var_fp_id_, var_fp_empresa_, var_fp_descripcion_, var_fp_sri_, var_fp_tipo_, var_fp_compra_venta_, var_fp_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_forma_pago_submit_form_cb);
  } // do_ajax_form_del_forma_pago_submit_form

  function do_ajax_form_del_forma_pago_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("fp_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_empresa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_sri_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_tipo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_compra_venta_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_forma_pago_submit_form_cb_after_alert);
  } // do_ajax_form_del_forma_pago_submit_form_cb
  function do_ajax_form_del_forma_pago_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_forma_pago_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_forma_pago_navigate_form()
  {
    perform_ajax_form_del_forma_pago_navigate_form();
  }

  function perform_ajax_form_del_forma_pago_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_forma_pago_cancel_insert(sc_form_del_forma_pago_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("fp_id_" + iNavForm);
      scAjaxHideErrorDisplay("fp_empresa_" + iNavForm);
      scAjaxHideErrorDisplay("fp_descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("fp_sri_" + iNavForm);
      scAjaxHideErrorDisplay("fp_tipo_" + iNavForm);
      scAjaxHideErrorDisplay("fp_compra_venta_" + iNavForm);
      scAjaxHideErrorDisplay("fp_estado_" + iNavForm);
    }
    var var_fp_id_ = document.F2.fp_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_navigate_form(var_fp_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_forma_pago_navigate_form_cb);
  } // do_ajax_form_del_forma_pago_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_forma_pago']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_forma_pago_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.fp_id_.value = scAjaxGetKeyValue("fp_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_forma_pago_navigate_form_cb_after_alert);
  } // do_ajax_form_del_forma_pago_navigate_form_cb
  function do_ajax_form_del_forma_pago_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_forma_pago_navigate_form_cb_after_alert

    function sc_form_del_forma_pago_get_last_line_number()
    {
    ...
    } //sc_form_del_forma_pago_get_last_line_number

  function sc_hide_form_del_forma_pago_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "fp_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_sri_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_tipo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_compra_venta_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["fp_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_forma_pago'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_sri_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo_sri'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_tipo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_tesoreria'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_compra_venta_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_modulo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["fp_id_"][iNumLinha] = "fp_id_" + iNumLinha;
    ajax_field_mult["fp_empresa_"][iNumLinha] = "fp_empresa_" + iNumLinha;
    ajax_field_mult["fp_descripcion_"][iNumLinha] = "fp_descripcion_" + iNumLinha;
    ajax_field_mult["fp_sri_"][iNumLinha] = "fp_sri_" + iNumLinha;
    ajax_field_mult["fp_tipo_"][iNumLinha] = "fp_tipo_" + iNumLinha;
    ajax_field_mult["fp_compra_venta_"][iNumLinha] = "fp_compra_venta_" + iNumLinha;
    ajax_field_mult["fp_estado_"][iNumLinha] = "fp_estado_" + iNumLinha;
    ajax_field_id["fp_descripcion_" + iNumLinha] = new Array("hidden_field_label_fp_descripcion_", "hidden_field_data_fp_descripcion_" + iNumLinha);
    ajax_field_id["fp_sri_" + iNumLinha] = new Array("hidden_field_label_fp_sri_", "hidden_field_data_fp_sri_" + iNumLinha);
    ajax_field_id["fp_tipo_" + iNumLinha] = new Array("hidden_field_label_fp_tipo_", "hidden_field_data_fp_tipo_" + iNumLinha);
    ajax_field_id["fp_compra_venta_" + iNumLinha] = new Array("hidden_field_label_fp_compra_venta_", "hidden_field_data_fp_compra_venta_" + iNumLinha);
    ajax_field_id["fp_estado_" + iNumLinha] = new Array("hidden_field_label_fp_estado_", "hidden_field_data_fp_estado_" + iNumLinha);
    ajax_error_count["fp_id_" + iNumLinha] = "off";
    ajax_error_count["fp_empresa_" + iNumLinha] = "off";
    ajax_error_count["fp_descripcion_" + iNumLinha] = "off";
    ajax_error_count["fp_sri_" + iNumLinha] = "off";
    ajax_error_count["fp_tipo_" + iNumLinha] = "off";
    ajax_error_count["fp_compra_venta_" + iNumLinha] = "off";
    ajax_error_count["fp_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["fp_id_" + iNumLinha] = "on";
    ajax_read_only["fp_empresa_" + iNumLinha] = "off";
    ajax_read_only["fp_descripcion_" + iNumLinha] = "off";
    ajax_read_only["fp_sri_" + iNumLinha] = "off";
    ajax_read_only["fp_tipo_" + iNumLinha] = "off";
    ajax_read_only["fp_compra_venta_" + iNumLinha] = "off";
    ajax_read_only["fp_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["fp_id_" + iNumLinha] = "on";
    ajax_read_only["fp_empresa_" + iNumLinha] = "on";
    ajax_read_only["fp_descripcion_" + iNumLinha] = "on";
    ajax_read_only["fp_sri_" + iNumLinha] = "on";
    ajax_read_only["fp_tipo_" + iNumLinha] = "on";
    ajax_read_only["fp_compra_venta_" + iNumLinha] = "on";
    ajax_read_only["fp_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["fp_id_" + iNumLinha] = null;
    ajax_error_list["fp_empresa_" + iNumLinha] = null;
    ajax_error_list["fp_descripcion_" + iNumLinha] = null;
    ajax_error_list["fp_sri_" + iNumLinha] = null;
    ajax_error_list["fp_tipo_" + iNumLinha] = null;
    ajax_error_list["fp_compra_venta_" + iNumLinha] = null;
    ajax_error_list["fp_estado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "fp_id_": new Array(),
    "fp_empresa_": new Array(),
    "fp_descripcion_": new Array(),
    "fp_sri_": new Array(),
    "fp_tipo_": new Array(),
    "fp_compra_venta_": new Array(),
    "fp_estado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["fp_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_empresa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_sri_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_sri_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_sri_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_sri_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_sri_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_tipo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_tipo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_tipo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_tipo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_tipo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_compra_venta_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_compra_venta_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_compra_venta_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_compra_venta_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_compra_venta_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_id_'])) ? $this->nmgp_cmp_readonly['fp_id_'] : 'on';
?>
    scAjaxFieldRead("fp_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_empresa_'])) ? $this->nmgp_cmp_readonly['fp_empresa_'] : 'off';
?>
    scAjaxFieldRead("fp_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_descripcion_'])) ? $this->nmgp_cmp_readonly['fp_descripcion_'] : 'off';
?>
    scAjaxFieldRead("fp_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_sri_'])) ? $this->nmgp_cmp_readonly['fp_sri_'] : 'off';
?>
    scAjaxFieldRead("fp_sri_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_tipo_'])) ? $this->nmgp_cmp_readonly['fp_tipo_'] : 'off';
?>
    scAjaxFieldRead("fp_tipo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_compra_venta_'])) ? $this->nmgp_cmp_readonly['fp_compra_venta_'] : 'off';
?>
    scAjaxFieldRead("fp_compra_venta_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_estado_'])) ? $this->nmgp_cmp_readonly['fp_estado_'] : 'off';
?>
    scAjaxFieldRead("fp_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("fp_id_" + iSeq, "on");
    scAjaxFieldRead("fp_empresa_" + iSeq, "on");
    scAjaxFieldRead("fp_descripcion_" + iSeq, "on");
    scAjaxFieldRead("fp_sri_" + iSeq, "on");
    scAjaxFieldRead("fp_tipo_" + iSeq, "on");
    scAjaxFieldRead("fp_compra_venta_" + iSeq, "on");
    scAjaxFieldRead("fp_estado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["fp_id_" + iRow] || "on" == ajax_error_count["fp_empresa_" + iRow] || "on" == ajax_error_count["fp_descripcion_" + iRow] || "on" == ajax_error_count["fp_sri_" + iRow] || "on" == ajax_error_count["fp_tipo_" + iRow] || "on" == ajax_error_count["fp_compra_venta_" + iRow] || "on" == ajax_error_count["fp_estado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_empresa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_sri_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_tipo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_compra_venta_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["fp_id_" + iRow] && "off" == ajax_error_count["fp_empresa_" + iRow] && "off" == ajax_error_count["fp_descripcion_" + iRow] && "off" == ajax_error_count["fp_sri_" + iRow] && "off" == ajax_error_count["fp_tipo_" + iRow] && "off" == ajax_error_count["fp_compra_venta_" + iRow] && "off" == ajax_error_count["fp_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["fp_id_" + iRow] = "off";
        ajax_error_count["fp_empresa_" + iRow] = "off";
        ajax_error_count["fp_descripcion_" + iRow] = "off";
        ajax_error_count["fp_sri_" + iRow] = "off";
        ajax_error_count["fp_tipo_" + iRow] = "off";
        ajax_error_count["fp_compra_venta_" + iRow] = "off";
        ajax_error_count["fp_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_fp_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_empresa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_sri_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_tipo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_compra_venta_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
