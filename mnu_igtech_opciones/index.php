<?php
include_once('mnu_igtech_opciones_session.php');
...
$_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod']      = "";
$_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_perfil']         = "igtech_conexion";
$_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_imag_temp'] = "";
$_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo']      = "";
...
//check prod
if(empty($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod']))
{
   /*check prod*/$_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check tmp
if(empty($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_imag_temp']))
{
   /*check tmp*/$_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
...
class mnu_igtech_opciones_class
{
  var $Db;
 ...
 function mnu_igtech_opciones_menu()
 {
    global $mnu_igtech_opciones_menuData;
...
$nm_versao_sc  = "" ; 
$_SESSION['scriptcase']['mnu_igtech_opciones']['contr_erro'] = 'off';
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_mnu_igtech_opciones'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_mnu_igtech_opciones'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_mnu_igtech_opciones'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod'] . "/third";
$url_third      = $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "mnu_igtech_opciones/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$path_lib_php   = $str_root . $path_link . "_lib/lib/php";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_imag_temp'];
$menu_largura   = '200';
$menu_mobile_hide          = 'N';
...
$mobile_menu_mobile_hide_onclick  = 'N';
$mobile_menutree_mobile_float     = 'S';
$mobile_menu_mobile_hide_icon     = 'N';
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib");
if(function_exists('set_php_timezone')) set_php_timezone('mnu_igtech_opciones');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/mnu_igtech_opciones_erro.php");
}
include_once(dirname(__FILE__) . "/mnu_igtech_opciones_erro.class.php"); 
$this->Erro = new mnu_igtech_opciones_erro();
$str_path = substr($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_conexao']);
}
/* Definiciones de las rutas */
$mnu_igtech_opciones_menuData          = array();
$mnu_igtech_opciones_menuData['path']  = array();
$mnu_igtech_opciones_menuData['url']   = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $mnu_igtech_opciones_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $mnu_igtech_opciones_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $mnu_igtech_opciones_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $mnu_igtech_opciones_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$mnu_igtech_opciones_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$mnu_igtech_opciones_menuData['url']['web']   = str_replace("\\", '/', $mnu_igtech_opciones_menuData['url']['web']);
$mnu_igtech_opciones_menuData['path']['root'] = substr($mnu_igtech_opciones_menuData['path']['sys'],  0, -1 * strlen($mnu_igtech_opciones_menuData['url']['web']));
$mnu_igtech_opciones_menuData['path']['app']  = substr($mnu_igtech_opciones_menuData['path']['sys'],  0, strrpos($mnu_igtech_opciones_menuData['path']['sys'],  '/'));
$mnu_igtech_opciones_menuData['path']['link'] = substr($mnu_igtech_opciones_menuData['path']['app'],  0, strrpos($mnu_igtech_opciones_menuData['path']['app'],  '/'));
$mnu_igtech_opciones_menuData['path']['link'] = substr($mnu_igtech_opciones_menuData['path']['link'], 0, strrpos($mnu_igtech_opciones_menuData['path']['link'], '/')) . '/';
$mnu_igtech_opciones_menuData['path']['app'] .= '/';
$mnu_igtech_opciones_menuData['url']['app']   = substr($mnu_igtech_opciones_menuData['url']['web'],  0, strrpos($mnu_igtech_opciones_menuData['url']['web'],  '/'));
$mnu_igtech_opciones_menuData['url']['link']  = substr($mnu_igtech_opciones_menuData['url']['app'],  0, strrpos($mnu_igtech_opciones_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] == "S")
{
    $mnu_igtech_opciones_menuData['url']['link']  = substr($mnu_igtech_opciones_menuData['url']['link'], 0, strrpos($mnu_igtech_opciones_menuData['url']['link'], '/'));
}
$mnu_igtech_opciones_menuData['url']['link']  .= '/';
$mnu_igtech_opciones_menuData['url']['app']   .= '/';

$_SESSION['scriptcase']['mnu_igtech_opciones']['sc_apl_link'] = $mnu_igtech_opciones_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['mnu_igtech_opciones']['actual_lang']) || $_SESSION['scriptcase']['mnu_igtech_opciones']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['mnu_igtech_opciones']['actual_lang'] = $this->str_lang;
...
if ($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] != "S")
{
    ...
    $_SESSION['scriptcase']['menu_atual'] = "mnu_igtech_opciones";
    $_SESSION['scriptcase']['menu_apls']['mnu_igtech_opciones'] = array();
    if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
    {
        foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
        {
            if (isset($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_conexao']) && $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_conexao'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_conexao'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_perfil']) && $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_perfil'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_perfil'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_con_' . $NM_con_orig]))
            {
                $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_con_' . $NM_con_orig] = $NM_con_dest;
            }
        }
    }
...
if (isset($_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']);
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']['redir']))
{
...
if (isset($script_case_init))
{
    $_SESSION['sc_session'][1]['mnu_igtech_opciones']['init'] = $script_case_init;
}
elseif (!isset($_SESSION['sc_session'][1]['mnu_igtech_opciones']['init']))
{
    $_SESSION['sc_session'][1]['mnu_igtech_opciones']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['mnu_igtech_opciones']['init'];
...
if (!isset($Igtech_Sesiones) && isset($igtech_sesiones)) 
{
    $_SESSION["Igtech_Sesiones"] = $igtech_sesiones;
}
if (!isset($Igtech_esEmpleado) && isset($igtech_esempleado)) 
{
    $_SESSION["Igtech_esEmpleado"] = $igtech_esempleado;
}
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod'], 'debi_doc_electronicos', 2); 
}
if (isset($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['mnu_igtech_opciones']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['mnu_igtech_opciones']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['mnu_igtech_opciones']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['mnu_igtech_opciones']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['mnu_igtech_opciones']['sc_outra_jan']) && $_SESSION['sc_session'][1]['mnu_igtech_opciones']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod'], 'debi_doc_electronicos'); 
} 
else 
{ 
...
if (in_array(strtolower($nm_tpbanco), $this->nm_bases_oracle))
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['mnu_igtech_opciones']['decimal_db'] = ".";
} 
//
$this->NM_gera_log_insert("Scriptcase", "access");
if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'mnu_igtech_opciones'))
{
    $_SESSION['sc_session'][1]['mnu_igtech_opciones']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_mnu_igtech_opciones'] = "javascript:window.close()";
}

/* Menú de configuración de las variables */
$mnu_igtech_opciones_menuData['iframe'] = TRUE;

$mnu_igtech_opciones_menuData['height'] = '100%';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
if(is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/blank_menu_tarjetas_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] . '_lib/_app_data/blank_menu_tarjetas_ini.php');
    ...
    {
      if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_menu_tarjetas']))
      {
        $_SESSION['scriptcase']['sc_apl_seg']['blank_menu_tarjetas'] = "on";
      }
    }
}
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_seguridad_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_seguridad_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_seguridad']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['mnu_seguridad'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_sri_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_sri_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_sri']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['mnu_sri'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_productos_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_productos_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_productos']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['mnu_productos'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_recaudacion_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_recaudacion_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_recaudacion']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['mnu_recaudacion'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_empresas_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_empresas_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_empresas']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['mnu_empresas'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_comisionistas_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_comisionistas_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_comisionistas']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['mnu_comisionistas'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/control_enviar_coreo_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/control_enviar_coreo_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_enviar_coreo']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['control_enviar_coreo'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_cierre_sesion_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_cierre_sesion_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_cierre_sesion']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_cierre_sesion'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
$_SESSION['scriptcase']['mnu_igtech_opciones']['contr_erro'] = 'on';
if (!isset($_SESSION['Igtech_esEmpleado'])) {$_SESSION['Igtech_esEmpleado'] = "";}
if (!isset($this->sc_temp_Igtech_esEmpleado)) {$this->sc_temp_Igtech_esEmpleado = (isset($_SESSION['Igtech_esEmpleado'])) ? $_SESSION['Igtech_esEmpleado'] : "";}
 if ($this->sc_temp_Igtech_esEmpleado == 'S')     
{
	$this->nmgp_botoes["btn_2"] = 'on';;
}
else  
{
	$this->nmgp_botoes["btn_2"] = 'off';;
}
if (isset($this->sc_temp_Igtech_esEmpleado)) {$_SESSION['Igtech_esEmpleado'] = $this->sc_temp_Igtech_esEmpleado;}
$_SESSION['scriptcase']['mnu_igtech_opciones']['contr_erro'] = 'off';
if ($this->Db)
{
    $this->Db->Close(); 
...
<head>
 <title><?php echo $this->Nm_lang['lang_ig_tech'] ?></title>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="mnu_igtech_opciones_message.js"></script>
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_mnu_igtech_opciones'];
$mnu_igtech_opciones_menuData['data'] = array();
$nextLevelToBeWrite = false;
$str_disabled = "N";
$str_link = "mnu_igtech_opciones_form_php.php?sc_item_menu=item_12&sc_apl_menu=blank_menu_tarjetas&sc_apl_link=" . urlencode($mnu_igtech_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_menu_tarjetas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_menu_tarjetas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "usr__NM__ico__NM__home.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $mnu_igtech_opciones_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_inicio'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[0] . "",
        'id'       => "item_12",
        ...
        'target'   => " target=\"" . $this->mnu_igtech_opciones_target('_self') . "\"",
        'sc_id'    => "item_12",
...
$str_disabled = "N";
$str_link = "mnu_igtech_opciones_form_php.php?sc_item_menu=item_2&sc_apl_menu=mnu_seguridad&sc_apl_link=" . urlencode($mnu_igtech_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_seguridad']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_seguridad']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "sys__NM__ico__NM__engrane.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    if(empty($str_icon) && isset($arr_menuicons['menu']['active']))
    {
        $str_icon = $arr_menuicons['menu']['active'];
    }
...
$str_disabled = "N";
$str_link = "mnu_igtech_opciones_form_php.php?sc_item_menu=item_7&sc_apl_menu=mnu_sri&sc_apl_link=" . urlencode($mnu_igtech_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_sri']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_sri']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "usr__NM__ico__NM__contabilidad.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    if(empty($str_icon) && isset($arr_menuicons['menu']['active']))
    {
...
$str_disabled = "N";
$str_link = "mnu_igtech_opciones_form_php.php?sc_item_menu=item_6&sc_apl_menu=mnu_productos&sc_apl_link=" . urlencode($mnu_igtech_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_productos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_productos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "usr__NM__ico__NM__inventario.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    if(empty($str_icon) && isset($arr_menuicons['menu']['active']))
    {
...
$str_disabled = "N";
$str_link = "mnu_igtech_opciones_form_php.php?sc_item_menu=item_8&sc_apl_menu=mnu_recaudacion&sc_apl_link=" . urlencode($mnu_igtech_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_recaudacion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_recaudacion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "usr__NM__ico__NM__recaudacion.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    if(empty($str_icon) && isset($arr_menuicons['menu']['active']))
    {
    ...
    $mnu_igtech_opciones_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_recaudacion'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[4] . "",
        'id'       => "item_8",
        ...
        'display'  => "text_fontawesomeicon",
        'display_position'    => "text_right",
        'icon_fa'  => "fas fa-hand-holding-usd",
        'icon_fa_aba'  => "",
        'icon_fa_aba_inactive'  => "",
        'icon_color'  => "",
        'icon_color_hover'  => "",
...
$str_disabled = "N";
$str_link = "mnu_igtech_opciones_form_php.php?sc_item_menu=item_14&sc_apl_menu=mnu_empresas&sc_apl_link=" . urlencode($mnu_igtech_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_empresas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_empresas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $mnu_igtech_opciones_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_empresas'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[5] . "",
        'id'       => "item_14",
...
$str_disabled = "N";
$str_link = "mnu_igtech_opciones_form_php.php?sc_item_menu=item_16&sc_apl_menu=mnu_comisionistas&sc_apl_link=" . urlencode($mnu_igtech_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_comisionistas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_comisionistas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $mnu_igtech_opciones_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_comisionistas'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[6] . "",
        'id'       => "item_16",
...
$str_disabled = "N";
$str_link = "mnu_igtech_opciones_form_php.php?sc_item_menu=item_15&sc_apl_menu=control_enviar_coreo&sc_apl_link=" . urlencode($mnu_igtech_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_enviar_coreo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_enviar_coreo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $mnu_igtech_opciones_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_correo'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[7] . "",
        'id'       => "item_15",
...
$str_disabled = "N";
$str_link = "mnu_igtech_opciones_form_php.php?sc_item_menu=item_3&sc_apl_menu=form_cierre_sesion&sc_apl_link=" . urlencode($mnu_igtech_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_cierre_sesion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_cierre_sesion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "sys__NM__ico__NM__salir.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    if(empty($str_icon) && isset($arr_menuicons['blank']['active']))
    {
    ...
    $mnu_igtech_opciones_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " target=\"" . $this->mnu_igtech_opciones_target('_parent') . "\"",
        'sc_id'    => "item_3",
        'disabled' => $str_disabled,
        'display'  => "text_fontawesomeicon",
        'display_position'    => "text_right",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['mnu_igtech_opciones']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['mnu_igtech_opciones']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'mnu_igtech_opciones');
    $mnu_igtech_opciones_menuData['data'] = $str_menu_usu;
}
if (is_file("mnu_igtech_opciones_help.txt"))
{
    $Arq_WebHelp = file("mnu_igtech_opciones_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $mnu_igtech_opciones_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->mnu_igtech_opciones_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'  => "text",
                    'display_position'    => "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['mnu_igtech_opciones']) && !empty($_SESSION['scriptcase']['sc_menu_del']['mnu_igtech_opciones']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($mnu_igtech_opciones_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['mnu_igtech_opciones']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($mnu_igtech_opciones_menuData['data'][$i_menu]);
       }
    ...
    $mnu_igtech_opciones_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['mnu_igtech_opciones']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['mnu_igtech_opciones']))
{
    $disable_menu = false;
    foreach ($mnu_igtech_opciones_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['mnu_igtech_opciones']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $mnu_igtech_opciones_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
foreach ($mnu_igtech_opciones_menuData['data'] as $chave => $cada_menu)
{
        if($level_to_delete !== false && $mnu_igtech_opciones_menuData['data'][$chave]['level'] > $level_to_delete)
        {
                unset($mnu_igtech_opciones_menuData['data'][$chave]);
        }
        else
        {
                $level_to_delete = false;
                
                if ($mnu_igtech_opciones_menuData['data'][$chave]['disabled'] == 'Y')
                {
                        $level_to_delete = $mnu_igtech_opciones_menuData['data'][$chave]['level'];
                        unset($mnu_igtech_opciones_menuData['data'][$chave]);
                }
        }
}
$mnu_igtech_opciones_menuData['data'] = array_values($mnu_igtech_opciones_menuData['data']);
$flag = 1;
while ($flag == 1)
{
    $flag = 0;
    foreach ($mnu_igtech_opciones_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if ($mnu_igtech_opciones_menuData['data'][$chave]['disabled'] == 'Y')
            {
                    unset($mnu_igtech_opciones_menuData['data'][$chave]['disabled']);
                    foreach ($mnu_igtech_opciones_menuData['data'] as $_key => $_val)
                    {
                            if($_key > $chave)
                            {
                                    if($mnu_igtech_opciones_menuData['data'][$_key]['level'] > $mnu_igtech_opciones_menuData['data'][$chave]['level'])
                                    {
                                            unset($mnu_igtech_opciones_menuData['data'][$_key]);
                                    }
                                    else
                                    {
                                            break;
            ...
            if (isset($mnu_igtech_opciones_menuData['data'][$chave + 1]) && !empty($mnu_igtech_opciones_menuData['data'][$chave + 1]))
            {
                if ($mnu_igtech_opciones_menuData['data'][$chave]['link'] == "#")
                {
                    if ($mnu_igtech_opciones_menuData['data'][$chave]['level'] >= $mnu_igtech_opciones_menuData['data'][$chave + 1]['level'] )
                    {
                        unset($mnu_igtech_opciones_menuData['data'][$chave]);
                        $flag = 1;
                    }
            ...
            elseif ($mnu_igtech_opciones_menuData['data'][$chave]['link'] == "#")
            {
                unset($mnu_igtech_opciones_menuData['data'][$chave]);
            }
        }
...
<?php
    $link_default = "";
    if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_menu_tarjetas']) && $_SESSION['scriptcase']['sc_apl_seg']['blank_menu_tarjetas'] == "on") 
    { 
    $_SESSION['scriptcase']['mnu_igtech_opciones']['apl_inicial'] = "";
    $link_default = " onclick=\"openMenuItem('iframe_mnu_igtech_opciones');\" item-href=\"mnu_igtech_opciones_form_php.php?sc_item_menu=mnu_igtech_opciones&sc_apl_menu=blank_menu_tarjetas&sc_apl_link=" . urlencode($mnu_igtech_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] . "\"  item-target=\"mnu_igtech_opciones_iframe\"";
    } 
    else
    { 
        $_SESSION['scriptcase']['mnu_igtech_opciones']['apl_inicial'] = ($NM_scr_iframe != "") ? $NM_scr_iframe : "mnu_igtech_opciones_pag_ini.php";
    } 
    $_SESSION['scriptcase']['mnu_igtech_opciones']['path_link'] = $path_link;
?>
        ...
        <td class="scMenuTTableM" valign="top">
                <table cellpadding=0 cellspacing=0>
                    <tr>
                       <td>
                      <?php
                      echo $this->mnu_igtech_opciones_escreveMenu($mnu_igtech_opciones_menuData['data']);
                      ?>
                            </td>
                    </tr>
                </table>
...
<div class="ui-layout-center">
  <table cellspacing=0 cellpadding=0 style="height: 100%; width: 100%" cellpadding=0 cellspacing=0>
    <tr>
        ...
        <iframe name="mnu_igtech_opciones_iframe" id="iframe_mnu_igtech_opciones" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $_SESSION['scriptcase']['mnu_igtech_opciones']['apl_inicial']?>"<?php echo $link_default ?>></iframe>
      </tr>
    </table>
</div>
<script type="text/javascript">
...
Iframe_atual = "mnu_igtech_opciones_iframe";
Tab_links = new Array();
<?php
echo "Tab_links['mnu_igtech_opciones']   = \"\";\r\n";
 if(isset($mnu_igtech_opciones_menuData['data']) && !empty($mnu_igtech_opciones_menuData['data']))
 {
   foreach ($mnu_igtech_opciones_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($mnu_igtech_opciones_menuData['data_vertical']) && !empty($mnu_igtech_opciones_menuData['data_vertical']))
 {
   foreach ($mnu_igtech_opciones_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         echo "Tab_links['" . $dados_menu['id'] . "']   = \"\";\r\n";
...
{
  if (str_id != "iframe_mnu_igtech_opciones")
  {
      str_id        = str_id.replace("mnu_igtech_opciones_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_mnu_igtech_opciones', 'mnu_igtech_opciones');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_mnu_igtech_opciones').length)
        $('#iframe_mnu_igtech_opciones')[0].contentWindow.focus();
  }
}
...
{
    echo "   document.getElementById('iframe_mnu_igtech_opciones').click();\r\n";
}
?>
</script>
</body>
...
/* Control de Target */
function mnu_igtech_opciones_escreveMenu($arr_menu)
{
    $aMenuItemList = array();
...
/* Control de Target */
   function mnu_igtech_opciones_target($str_target)
   {
       global $mnu_igtech_opciones_menuData;
       ...
       elseif ($mnu_igtech_opciones_menuData['iframe'])
       {
           return 'mnu_igtech_opciones_iframe';
       }
       else
       {
           return $str_target;
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "javascript:parent.nm_out_menu('mnu_igtech_opciones_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_igtech_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] . "')";  
               }
               else
               {
                    $str_line['link'] = "mnu_igtech_opciones_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_igtech_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_usa_grupo'] . ""; 
               }
           }
           elseif ($arr_item['target'] == '_parent')
           {
               $str_line['link'] = "javascript:parent.nm_out_menu('" . $_SESSION['scriptcase']['sc_saida_mnu_igtech_opciones'] . "')"; 
           }
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->mnu_igtech_opciones_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['mnu_igtech_opciones']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['scriptcase']['mnu_igtech_opciones']['SC_sep_date']) && !empty($_SESSION['scriptcase']['mnu_igtech_opciones']['SC_sep_date']))
       {
           $delim  = $_SESSION['scriptcase']['mnu_igtech_opciones']['SC_sep_date'];
           $delim1 = $_SESSION['scriptcase']['mnu_igtech_opciones']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'mnu_igtech_opciones', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'mnu_igtech_opciones', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'mnu_igtech_opciones', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['mnu_igtech_opciones']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "mnu_igtech_opciones") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_debi_doc_electronicos'])) {
            $_SESSION['scriptcase']['mnu_igtech_opciones']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_debi_doc_electronicos'];
        }
    }
}
...
$contr_mnu_igtech_opciones = new mnu_igtech_opciones_class;
$contr_mnu_igtech_opciones->mnu_igtech_opciones_menu();
