...
class grid_del_retencion_dos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_del_retencion_dos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_del_retencion_dos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_del_retencion_dos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> del_retencion</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_del_retencion_dos/grid_del_retencion_dos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_del_retencion_dos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_del_retencion_dos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_del_retencion_dos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_retencion_dos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_retencion_dos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_ret_fecha_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_ret_fecha_dia').value + '/';
          var_dt_ini += document.getElementById('SC_ret_fecha_mes').value + '/';
          var_dt_ini += document.getElementById('SC_ret_fecha_ano').value;
          document.getElementById('sc_ret_fecha_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_ret_fecha_dia').value = aParts[0];
          document.getElementById('SC_ret_fecha_mes').value = aParts[1];
          document.getElementById('SC_ret_fecha_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_ret_fecha_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_ret_fecha_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_ret_fecha_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_ret_fecha_input_2_ano').value;
          document.getElementById('sc_ret_fecha_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_ret_fecha_input_2_dia').value = aParts[0];
          document.getElementById('SC_ret_fecha_input_2_mes').value = aParts[1];
          document.getElementById('SC_ret_fecha_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_ret_fecha_cond#NMF#' + search_get_sel_txt('SC_ret_fecha_cond') + '@NMF@';
  str_out += 'SC_ret_fecha_dia#NMF#' + search_get_sel_txt('SC_ret_fecha_dia') + '@NMF@';
  str_out += 'SC_ret_fecha_mes#NMF#' + search_get_sel_txt('SC_ret_fecha_mes') + '@NMF@';
  str_out += 'SC_ret_fecha_ano#NMF#' + search_get_sel_txt('SC_ret_fecha_ano') + '@NMF@';
  str_out += 'SC_ret_fecha_input_2_dia#NMF#' + search_get_sel_txt('SC_ret_fecha_input_2_dia') + '@NMF@';
  str_out += 'SC_ret_fecha_input_2_mes#NMF#' + search_get_sel_txt('SC_ret_fecha_input_2_mes') + '@NMF@';
  str_out += 'SC_ret_fecha_input_2_ano#NMF#' + search_get_sel_txt('SC_ret_fecha_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $ret_fecha_cond, $ret_fecha, $ret_fecha_dia, $ret_fecha_mes, $ret_fecha_ano, $ret_fecha_input_2_dia, $ret_fecha_input_2_mes, $ret_fecha_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $ret_fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_dia']; 
          $ret_fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_mes']; 
          $ret_fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_ano']; 
          $ret_fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_input_2_dia']; 
          $ret_fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_input_2_mes']; 
          $ret_fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_input_2_ano']; 
          $ret_fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['NM_operador']; 
      } 
      if (!isset($ret_fecha_cond) || empty($ret_fecha_cond))
      {
         $ret_fecha_cond = "eq";
      }
      ...
      $str_hide_ret_fecha = (in_array($ret_fecha_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_ret_fecha = ('bw' == $ret_fecha_cond) ? $display_aberto : $display_fechado;

      if (!isset($ret_fecha) || $ret_fecha == "")
      {
          $ret_fecha = "";
      }
      if (isset($ret_fecha) && !empty($ret_fecha))
      {
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_ret_fecha_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ret_fecha'])) ? $this->New_label['ret_fecha'] : "" . $this->Ini->Nm_lang['lang_fecha'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ret_fecha_cond" name="ret_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_ret_fecha'), this, 'ret_fecha')">
       <OPTION value="eq" <?php if ("eq" == $ret_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $ret_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ret_fecha" <?php echo $str_hide_ret_fecha?> valign="top">
 ...
 $nmgp_tab_label .= "ret_fecha?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_ret_fecha_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_ret_fecha_dia" name="ret_fecha_dia" value="<?php echo NM_encode_input($ret_fecha_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
<INPUT type="hidden" id="sc_ret_fecha_jq">
<?php
}
?>
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_ret_fecha_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_ret_fecha_mes" name="ret_fecha_mes" value="<?php echo NM_encode_input($ret_fecha_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_ret_fecha_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_ret_fecha_ano" name="ret_fecha_ano" value="<?php echo NM_encode_input($ret_fecha_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
        <SPAN id="id_css_ret_fecha"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_ret_fecha"  <?php echo $str_display_ret_fecha; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_ret_fecha_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_ret_fecha_input_2_dia" name="ret_fecha_input_2_dia" value="<?php echo NM_encode_input($ret_fecha_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
<INPUT type="hidden" id="sc_ret_fecha_jq2">
<?php
}
?>
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_ret_fecha_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_ret_fecha_input_2_mes" name="ret_fecha_input_2_mes" value="<?php echo NM_encode_input($ret_fecha_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_ret_fecha_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_ret_fecha_input_2_ano" name="ret_fecha_input_2_ano" value="<?php echo NM_encode_input($ret_fecha_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_del_retencion_dos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_retencion_dos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_del_retencion_dos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.ret_fecha_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_ret_fecha'), document.F1.ret_fecha_cond, 'ret_fecha');
   document.F1.ret_fecha_dia.value = "";
   document.F1.ret_fecha_mes.value = "";
   document.F1.ret_fecha_ano.value = "";
   document.F1.ret_fecha_input_2_dia.value = "";
   document.F1.ret_fecha_input_2_mes.value = "";
   document.F1.ret_fecha_input_2_ano.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_ret_fecha_dia').bind('change', function() {sc_grid_del_retencion_dos_valida_dia(this)});
    $('#SC_ret_fecha_input_2_dia').bind('change', function() {sc_grid_del_retencion_dos_valida_dia(this)});
    $('#SC_ret_fecha_input_2_mes').bind('change', function() {sc_grid_del_retencion_dos_valida_mes(this)});
    $('#SC_ret_fecha_mes').bind('change', function() {sc_grid_del_retencion_dos_valida_mes(this)});
 }
 function sc_grid_del_retencion_dos_valida_dia(obj)
 {
 ...
 function sc_grid_del_retencion_dos_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_del_retencion_dos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_ret_fecha_cond'] = 'cond';
      $tp_fields['SC_ret_fecha_dia'] = 'text';
      $tp_fields['SC_ret_fecha_mes'] = 'text';
      $tp_fields['SC_ret_fecha_ano'] = 'text';
      $tp_fields['SC_ret_fecha_input_2_dia'] = 'text';
      $tp_fields['SC_ret_fecha_input_2_mes'] = 'text';
      $tp_fields['SC_ret_fecha_input_2_ano'] = 'text';
   ...
   {
      global $ret_fecha_cond, $ret_fecha, $ret_fecha_dia, $ret_fecha_mes, $ret_fecha_ano, $ret_fecha_input_2_dia, $ret_fecha_input_2_mes, $ret_fecha_input_2_ano, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $ret_fecha_cond_salva = $ret_fecha_cond; 
      if (!isset($ret_fecha_input_2_dia) || $ret_fecha_input_2_dia == "")
      {
          $ret_fecha_input_2_dia = $ret_fecha_dia;
      }
      if (!isset($ret_fecha_input_2_mes) || $ret_fecha_input_2_mes == "")
      {
          $ret_fecha_input_2_mes = $ret_fecha_mes;
      }
      if (!isset($ret_fecha_input_2_ano) || $ret_fecha_input_2_ano == "")
      {
          $ret_fecha_input_2_ano = $ret_fecha_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_dia'] = $ret_fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_mes'] = $ret_fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_ano'] = $ret_fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_input_2_dia'] = $ret_fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_input_2_mes'] = $ret_fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_input_2_ano'] = $ret_fecha_input_2_ano; 
      if (!empty($ret_fecha_dia) || !empty($ret_fecha_mes) || !empty($ret_fecha_ano) || $ret_fecha_cond_salva == "nu" || $ret_fecha_cond_salva == "nn" || $ret_fecha_cond_salva == "ep" || $ret_fecha_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $ret_fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $ret_fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $ret_fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $ret_fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $ret_fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $ret_fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_cond'] = $ret_fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['Grid_search'][$I_Grid]['cmp'] = "ret_fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['Grid_search'][$I_Grid]['opc'] = $ret_fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq']['ret_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($ret_fecha_cond != "bi_TP")
      {
          $ret_fecha_cond = strtoupper($ret_fecha_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $ret_fecha_ano;
          $Dtxt .= $ret_fecha_mes;
          $Dtxt .= $ret_fecha_dia;
          $val[0]['ano'] = $ret_fecha_ano;
          $val[0]['mes'] = $ret_fecha_mes;
          $val[0]['dia'] = $ret_fecha_dia;
          if ($ret_fecha_cond == "BW")
          {
              $val[1]['ano'] = $ret_fecha_input_2_ano;
              $val[1]['mes'] = $ret_fecha_input_2_mes;
              $val[1]['dia'] = $ret_fecha_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $ret_fecha_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $ret_fecha_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $ret_fecha = $val[0];
          $this->cmp_formatado['ret_fecha'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['ret_fecha'], "YYYY-MM-DD");
          $this->cmp_formatado['ret_fecha'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($ret_fecha_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $ret_fecha_input_2     = $val[1];
              $this->cmp_formatado['ret_fecha_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']['ret_fecha_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['ret_fecha_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['ret_fecha_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $ret_fecha_cond == "NU" || $ret_fecha_cond == "NN"|| $ret_fecha_cond == "EP"|| $ret_fecha_cond == "NE")
          {
              $this->monta_condicao("ret_fecha", $ret_fecha_cond, $ret_fecha, $ret_fecha_input_2, 'ret_fecha', 'DATE');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq']['ret_fecha']['label'] = $nmgp_tab_label['ret_fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq']['ret_fecha']['descr'] = $nmgp_tab_label['ret_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['grid_pesq']['ret_fecha']['hint']  = $nmgp_tab_label['ret_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['cond_pesq'] .= $this->NM_operador;
