...
function grid_del_retencion_dos_right_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_right" + seqRow).html();
}

function grid_del_retencion_dos_right_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_right" + seqRow).html(newValue);
}
...
function grid_del_retencion_dos_getValue(field, seqRow) {
  ...
  if ("right" == field) {
    SC_tmp = grid_del_retencion_dos_right_getValue(seqRow);
  }
...
function grid_del_retencion_dos_setValue(field, newValue, seqRow) {
  ...
  if ("right" == field) {
    grid_del_retencion_dos_right_setValue(newValue, seqRow);
  }
  if ("ret_cliente" == field) {
