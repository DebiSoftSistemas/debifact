...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "ret_fecha";$Nm_numeric[] = "ret_numero";$Nm_numeric[] = "ret_establecimiento";$Nm_numeric[] = "ret_punto_emision";$Nm_numeric[] = "ret_cliente";$Nm_numeric[] = "ret_ambiente";$Nm_numeric[] = "ret_libretin";$Nm_numeric[] = "ret_anio_periodo_fiscal";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ret_fecha_cond" name="ret_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_ret_fecha'), this, 'ret_fecha')">
      ...
      <br><span id="id_hide_ret_fecha"  <?php echo $str_hide_ret_fecha?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_ret_fecha"  <?php echo $str_display_ret_fecha; ?> class="scFilterFieldFontOdd">
