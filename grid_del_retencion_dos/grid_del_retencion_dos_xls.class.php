...
class grid_del_retencion_dos_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function sc_actionbar_disable($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_del_retencion_dos/grid_del_retencion_dos_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_del_retencion_dos_res_xls.class.php");
              $this->Res_xls = new grid_del_retencion_dos_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_del_retencion_dos.zip";
          $this->Arquivo   .= "_grid_del_retencion_dos" . $this->Xls_tp;
          $this->Tit_doc    = "grid_del_retencion_dos" . $this->Xls_tp;
          $this->Tit_zip    = "grid_del_retencion_dos.zip";
      ...
      require_once($this->Ini->path_aplicacao . "grid_del_retencion_dos_total.class.php"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['field_order'] as $Cada_cmp)
      {
      ...
      { 
          ...
          $this->ret_fecha_2 = (isset($Busca_temp['ret_fecha_input_2'])) ? $Busca_temp['ret_fecha_input_2'] : ""; 
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->Xls_col = 0;
         $this->Xls_row++;
         $this->ret_fecha = $rs->fields[0] ;  
         $this->ret_establecimiento = $rs->fields[1] ;  
         $this->ret_establecimiento = (string)$this->ret_establecimiento;
         $this->ret_punto_emision = $rs->fields[2] ;  
         $this->ret_punto_emision = (string)$this->ret_punto_emision;
         $this->ret_secuencial = $rs->fields[3] ;  
         $this->ret_cliente = $rs->fields[4] ;  
         $this->ret_cliente = (string)$this->ret_cliente;
         $this->ret_mes_periodo_fiscal = $rs->fields[5] ;  
         $this->ret_anio_periodo_fiscal = $rs->fields[6] ;  
         $this->ret_anio_periodo_fiscal = (string)$this->ret_anio_periodo_fiscal;
         $this->ret_estado_sri = $rs->fields[7] ;  
         $this->ret_error_sri = $rs->fields[8] ;  
         $this->ret_numero = $rs->fields[9] ;  
         $this->ret_numero = (string)$this->ret_numero;
         $this->ret_estado = $rs->fields[10] ;  
     ...
     $prim_gb = false;
     $nm_houve_quebra = "N";
         //----- lookup - ret_establecimiento
         $this->look_ret_establecimiento = $this->ret_establecimiento; 
         $this->Lookup->lookup_ret_establecimiento($this->look_ret_establecimiento, $this->ret_establecimiento) ; 
         $this->look_ret_establecimiento = ($this->look_ret_establecimiento == "&nbsp;") ? "" : $this->look_ret_establecimiento; 
         //----- lookup - ret_punto_emision
         $this->look_ret_punto_emision = $this->ret_punto_emision; 
         $this->Lookup->lookup_ret_punto_emision($this->look_ret_punto_emision, $this->ret_punto_emision) ; 
         $this->look_ret_punto_emision = ($this->look_ret_punto_emision == "&nbsp;") ? "" : $this->look_ret_punto_emision; 
         //----- lookup - ret_cliente
         $this->look_ret_cliente = $this->ret_cliente; 
         $this->Lookup->lookup_ret_cliente($this->look_ret_cliente, $this->ret_cliente) ; 
         $this->look_ret_cliente = ($this->look_ret_cliente == "&nbsp;") ? "" : $this->look_ret_cliente; 
         //----- lookup - ret_mes_periodo_fiscal
         ...
         $this->look_ret_mes_periodo_fiscal = ($this->look_ret_mes_periodo_fiscal == "&nbsp;") ? "" : $this->look_ret_mes_periodo_fiscal; 
...
$_SESSION['scriptcase']['grid_del_retencion_dos']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "ret_fecha" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
          ...
          if ($Cada_col == "ret_establecimiento" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "ret_punto_emision" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "ret_secuencial" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "ret_cliente" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "ret_mes_periodo_fiscal" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "ret_anio_periodo_fiscal" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "ret_estado_sri" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "ret_error_sri" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "ret_numero" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   function NM_export_ret_fecha()
   {
         ...
         $this->ret_fecha = substr($this->ret_fecha, 0, 10);
         if (empty($this->ret_fecha) || $this->ret_fecha == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ret_fecha, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ret_fecha, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->ret_fecha);
             $this->NM_ctrl_style[$current_cell_ref]['format'] = $this->SC_date_conf_region;
         }
         $this->Xls_col++;
   }
   //----- ret_establecimiento
   function NM_export_ret_establecimiento()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->look_ret_establecimiento = NM_charset_to_utf8($this->look_ret_establecimiento);
         if (is_numeric($this->look_ret_establecimiento))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_ret_establecimiento);
         $this->Xls_col++;
   }
   //----- ret_punto_emision
   function NM_export_ret_punto_emision()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->look_ret_punto_emision = NM_charset_to_utf8($this->look_ret_punto_emision);
         if (is_numeric($this->look_ret_punto_emision))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_ret_punto_emision);
         $this->Xls_col++;
   }
   //----- ret_secuencial
   function NM_export_ret_secuencial()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->ret_secuencial = html_entity_decode($this->ret_secuencial, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ret_secuencial = strip_tags($this->ret_secuencial);
         $this->ret_secuencial = NM_charset_to_utf8($this->ret_secuencial);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ret_secuencial, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ret_secuencial, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ret_cliente
   function NM_export_ret_cliente()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->look_ret_cliente = NM_charset_to_utf8($this->look_ret_cliente);
         if (is_numeric($this->look_ret_cliente))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_ret_cliente);
         $this->Xls_col++;
   }
   //----- ret_mes_periodo_fiscal
   function NM_export_ret_mes_periodo_fiscal()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->look_ret_mes_periodo_fiscal = html_entity_decode($this->look_ret_mes_periodo_fiscal, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_ret_mes_periodo_fiscal = strip_tags($this->look_ret_mes_periodo_fiscal);
         $this->look_ret_mes_periodo_fiscal = NM_charset_to_utf8($this->look_ret_mes_periodo_fiscal);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_ret_mes_periodo_fiscal, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_ret_mes_periodo_fiscal, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ret_anio_periodo_fiscal
   function NM_export_ret_anio_periodo_fiscal()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->ret_anio_periodo_fiscal = NM_charset_to_utf8($this->ret_anio_periodo_fiscal);
         if (is_numeric($this->ret_anio_periodo_fiscal))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->ret_anio_periodo_fiscal);
         $this->Xls_col++;
   }
   //----- ret_estado_sri
   function NM_export_ret_estado_sri()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->ret_estado_sri = html_entity_decode($this->ret_estado_sri, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ret_estado_sri = strip_tags($this->ret_estado_sri);
         $this->ret_estado_sri = NM_charset_to_utf8($this->ret_estado_sri);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ret_estado_sri, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ret_estado_sri, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ret_error_sri
   function NM_export_ret_error_sri()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->ret_error_sri = html_entity_decode($this->ret_error_sri, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ret_error_sri = strip_tags($this->ret_error_sri);
         $this->ret_error_sri = NM_charset_to_utf8($this->ret_error_sri);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ret_error_sri, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ret_error_sri, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ret_numero
   function NM_export_ret_numero()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->ret_numero = html_entity_decode($this->ret_numero, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ret_numero = NM_charset_to_utf8($this->ret_numero);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ret_numero, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ret_numero, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ret_fecha
   function NM_sub_cons_ret_fecha()
   {
         $this->ret_fecha = substr($this->ret_fecha, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ret_fecha;
   ...
   //----- ret_establecimiento
   function NM_sub_cons_ret_establecimiento()
   {
         $this->look_ret_establecimiento = NM_charset_to_utf8($this->look_ret_establecimiento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_ret_establecimiento;
   ...
   //----- ret_punto_emision
   function NM_sub_cons_ret_punto_emision()
   {
         $this->look_ret_punto_emision = NM_charset_to_utf8($this->look_ret_punto_emision);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_ret_punto_emision;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- ret_secuencial
   function NM_sub_cons_ret_secuencial()
   {
         $this->ret_secuencial = html_entity_decode($this->ret_secuencial, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ret_secuencial = strip_tags($this->ret_secuencial);
         $this->ret_secuencial = NM_charset_to_utf8($this->ret_secuencial);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ret_secuencial;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
   ...
   //----- ret_cliente
   function NM_sub_cons_ret_cliente()
   {
         $this->look_ret_cliente = NM_charset_to_utf8($this->look_ret_cliente);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_ret_cliente;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- ret_mes_periodo_fiscal
   function NM_sub_cons_ret_mes_periodo_fiscal()
   {
         $this->look_ret_mes_periodo_fiscal = html_entity_decode($this->look_ret_mes_periodo_fiscal, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_ret_mes_periodo_fiscal = strip_tags($this->look_ret_mes_periodo_fiscal);
         $this->look_ret_mes_periodo_fiscal = NM_charset_to_utf8($this->look_ret_mes_periodo_fiscal);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_ret_mes_periodo_fiscal;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- ret_anio_periodo_fiscal
   function NM_sub_cons_ret_anio_periodo_fiscal()
   {
         $this->ret_anio_periodo_fiscal = NM_charset_to_utf8($this->ret_anio_periodo_fiscal);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ret_anio_periodo_fiscal;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- ret_estado_sri
   function NM_sub_cons_ret_estado_sri()
   {
         $this->ret_estado_sri = html_entity_decode($this->ret_estado_sri, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ret_estado_sri = strip_tags($this->ret_estado_sri);
         $this->ret_estado_sri = NM_charset_to_utf8($this->ret_estado_sri);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ret_estado_sri;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- ret_error_sri
   function NM_sub_cons_ret_error_sri()
   {
         $this->ret_error_sri = html_entity_decode($this->ret_error_sri, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ret_error_sri = strip_tags($this->ret_error_sri);
         $this->ret_error_sri = NM_charset_to_utf8($this->ret_error_sri);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ret_error_sri;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- ret_numero
   function NM_sub_cons_ret_numero()
   {
         $this->ret_numero = html_entity_decode($this->ret_numero, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ret_numero = NM_charset_to_utf8($this->ret_numero);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ret_numero;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> del_retencion :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_retencion_dos']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
