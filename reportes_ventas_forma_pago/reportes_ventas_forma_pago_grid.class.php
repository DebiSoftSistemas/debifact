<?php
class reportes_ventas_forma_pago_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['charts_html'] = '';
   ...
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "reportes_ventas_forma_pago/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new reportes_ventas_forma_pago_resumo();
       $this->Res->Db     = $this->Db;
       $this->Res->Erro   = $this->Erro;
       $this->Res->Ini    = $this->Ini;
       $this->Res->Lookup = $this->Lookup;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pdf_res'])
       {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['reportes_ventas_forma_pago'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf")
       { 
           if (isset($_GET['flash_graf']) && 'chart' == $_GET['flash_graf'])
           {
               $this->Res->monta_resumo(true);
               require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
               $this->Graf  = new reportes_ventas_forma_pago_grafico();
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pesq_tab_label'] .= "fac_fecha?#?" . "" . $this->Ini->Nm_lang['lang_fecha'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pesq_tab_label'] .= "fac_serie?#?" . "" . $this->Ini->Nm_lang['lang_serie_sri'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pesq_tab_label'] .= "fp_descripcion?#?" . "" . $this->Ini->Nm_lang['lang_forma_pago'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pesq_tab_label'] .= "cl_nombre?#?" . "" . $this->Ini->Nm_lang['lang_cliente'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pesq_tab_label'] .= "cl_identificacion?#?" . "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pesq_tab_label'] .= "fac_usuario?#?" . "" . $this->Ini->Nm_lang['lang_usuario'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("cl_nombre","cl_identificacion");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "sc_free_group_by")
   {
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']) > 1)
       {
           $this->width_tabula_quebra  = (((count($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']) - 1) * 13) + 3) . "px";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['mostra_edit'] = "N";
   }
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("reportes_ventas_forma_pago", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $this->Cmps_ord_def['fac_tipo_comprobante'] = " asc";
   ...
   $this->Cmps_ord_def['fac_comentario'] = " asc";
   $this->Cmps_ord_def['cl_direccion'] = " asc";
   $this->Cmps_ord_def['cl_telefono'] = " asc";
   $this->Cmps_ord_def['cl_email'] = " asc";
   $this->Cmps_ord_def['fac_autorizacion'] = " asc";
   $this->Cmps_ord_def['fac_error_sri'] = " asc";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_pesq_ant'];  
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] = "muda_qt_linhas";
   } 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['reportes_ventas_forma_pago'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['reportes_ventas_forma_pago'];
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura']['insert'] != '')
   {
       $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura']['insert'];
       $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura']['insert'];
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura']['update'] != '')
   {
       $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura']['update'];
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura']['delete'] != '')
   {
       $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura']['delete'];
   }
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "reportes_ventas_forma_pago_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_lin_grid'] = 50;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "fac_serie_fac_secuencial") 
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_quebra'] = array(); 
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_sql'] as $cmp_var => $resto)
           {
               foreach ($resto as $SC_Sql_col => $SC_Sql_order)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_quebra'][$cmp_var][$SC_Sql_col] = $SC_Sql_order;
               }
           }
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "fac_serie_fac_secuencial") 
   {
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_quebra']['fac_serie']["fac_serie"] = "asc"; 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_orig'] = " where (fac_estado='V' and fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   $this->sum_fp_valor = 0;
   $this->arg_sum_fac_fecha = "";
   $this->count_fac_fecha = 0;
   $this->sum_fac_fecha_fp_valor = 0;
   $this->arg_sum_fac_tipo_comprobante = "";
   $this->count_fac_tipo_comprobante = 0;
   $this->sum_fac_tipo_comprobante_fp_valor = 0;
   $this->arg_sum_fp_descripcion = "";
   $this->count_fp_descripcion = 0;
   $this->sum_fp_descripcion_fp_valor = 0;
   $this->arg_sum_fac_serie = "";
   $this->count_fac_serie = 0;
   $this->sum_fac_serie_fp_valor = 0;
   ...
   $this->arg_sum_fac_usuario = "";
   $this->count_fac_usuario = 0;
   $this->sum_fac_usuario_fp_valor = 0;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid'] == "all") 
   { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['contr_array_resumo']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['contr_array_resumo'] = "NAO";
       } 
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral'][1];
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid'];
   }
//----- 
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
   { 
       $nmgp_select = "SELECT str_replace (convert(char(10),fac_fecha,102), '.', '-') + ' ' + convert(char(8),fac_fecha,20), fac_tipo_comprobante, fac_serie, fac_secuencial, cl_nombre, cl_identificacion, fac_total, fp_descripcion, fp_valor, fac_comentario, cl_direccion, cl_telefono, cl_email, fac_autorizacion, fac_error_sri, fac_estado_sri, fac_usuario, fac_numero from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT fac_fecha, fac_tipo_comprobante, fac_serie, fac_secuencial, cl_nombre, cl_identificacion, fac_total, fp_descripcion, fp_valor, fac_comentario, cl_direccion, cl_telefono, cl_email, fac_autorizacion, fac_error_sri, fac_estado_sri, fac_usuario, fac_numero from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT convert(char(23),fac_fecha,121), fac_tipo_comprobante, fac_serie, fac_secuencial, cl_nombre, cl_identificacion, fac_total, fp_descripcion, fp_valor, fac_comentario, cl_direccion, cl_telefono, cl_email, fac_autorizacion, fac_error_sri, fac_estado_sri, fac_usuario, fac_numero from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT EXTEND(fac_fecha, YEAR TO DAY), fac_tipo_comprobante, fac_serie, fac_secuencial, cl_nombre, cl_identificacion, fac_total, fp_descripcion, fp_valor, fac_comentario, cl_direccion, cl_telefono, cl_email, fac_autorizacion, fac_error_sri, fac_estado_sri, fac_usuario, fac_numero from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT fac_fecha, fac_tipo_comprobante, fac_serie, fac_secuencial, cl_nombre, cl_identificacion, fac_total, fp_descripcion, fp_valor, fac_comentario, cl_direccion, cl_telefono, cl_email, fac_autorizacion, fac_error_sri, fac_estado_sri, fac_usuario, fac_numero from " . $this->Ini->nm_tabela; 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->fac_tipo_comprobante = $this->rs_grid->fields[1] ;  
       $this->fac_serie = $this->rs_grid->fields[2] ;  
       $this->fac_secuencial = $this->rs_grid->fields[3] ;  
       $this->cl_nombre = $this->rs_grid->fields[4] ;  
       $this->cl_identificacion = $this->rs_grid->fields[5] ;  
       $this->fac_total = $this->rs_grid->fields[6] ;  
       $this->fac_total = (string)$this->fac_total;
       $this->fp_descripcion = $this->rs_grid->fields[7] ;  
       $this->fp_valor = $this->rs_grid->fields[8] ;  
       $this->fp_valor = (string)$this->fp_valor;
       $this->fac_comentario = $this->rs_grid->fields[9] ;  
       $this->cl_direccion = $this->rs_grid->fields[10] ;  
       $this->cl_telefono = $this->rs_grid->fields[11] ;  
       $this->cl_email = $this->rs_grid->fields[12] ;  
       $this->fac_autorizacion = $this->rs_grid->fields[13] ;  
       $this->fac_error_sri = $this->rs_grid->fields[14] ;  
       $this->fac_estado_sri = $this->rs_grid->fields[15] ;  
       $this->fac_usuario = $this->rs_grid->fields[16] ;  
       $this->fac_numero = $this->rs_grid->fields[17] ;  
       ...
       if (!isset($this->fac_fecha)) { $this->fac_fecha = ""; }
       if (!isset($this->fac_tipo_comprobante)) { $this->fac_tipo_comprobante = ""; }
       if (!isset($this->fp_descripcion)) { $this->fp_descripcion = ""; }
       if (!isset($this->fac_serie)) { $this->fac_serie = ""; }
       ...
       if (!isset($this->fac_usuario)) { $this->fac_usuario = ""; }
       $GLOBALS["fac_tipo_comprobante"] = $this->rs_grid->fields[1] ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "sc_free_group_by")
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
           {
               ...
               if ($Cmp_orig == "fac_fecha")
               {
                   ...
                   $TP_Time = (in_array('fac_fecha', $this->Ini->Cmp_Sql_Time)) ? "0000-00-00 " : "";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_facturas_forma_pago'] ?> :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               reportes_ventas_forma_pago_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               reportes_ventas_forma_pago_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               reportes_ventas_forma_pago_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               reportes_ventas_forma_pago_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               reportes_ventas_forma_pago_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_facturas_forma_pago'] . "</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"reportes_ventas_forma_pago_jquery_3110.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"reportes_ventas_forma_pago_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"reportes_ventas_forma_pago_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
          <?php }
           ...
           $nm_saida->saida(".sc-actb-btn_baucher.sc-acts-state1 { color: #1d211f !important; }\r\n");
           $nm_saida->saida("</style>\r\n");
           $nm_saida->saida("<script>\r\n");
           ...
           $nm_saida->saida("            break;\r\n");
           $nm_saida->saida("        case 'btn_baucher':\r\n");
           $nm_saida->saida("            stateHtml = actionBar_displayState_btn_baucher(buttonState);\r\n");
           $nm_saida->saida("            buttonId = \"sc-actionbar-actbtn_btn_baucher\" + buttonRow;\r\n");
           $nm_saida->saida("            break;\r\n");
           $nm_saida->saida("    }\r\n");
           ...
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function actionBar_displayState_btn_baucher(buttonState)\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    switch (buttonState) {\r\n");
           $nm_saida->saida("        case 'state1':\r\n");
           $nm_saida->saida("            return \"<i class=\\\"icon_fa sc-actb-btn_baucher sc-acts-state1 fas fa-file-invoice\\\"></i>\";\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           ...
           $nm_saida->saida("        case 'btn_baucher':\r\n");
           $nm_saida->saida("            return actionBar_getStateHint_btn_baucher(buttonState);\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           ...
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function actionBar_getStateHint_btn_baucher(buttonState)\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    switch (buttonState) {\r\n");
           $nm_saida->saida("        case 'state1':\r\n");
           $nm_saida->saida("            return \"Baucher\";\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           ...
           $nm_saida->saida("        case 'btn_baucher':\r\n");
           $nm_saida->saida("            return actionBar_getStateConfirm_btn_baucher(buttonState);\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           ...
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function actionBar_getStateConfirm_btn_baucher(buttonState)\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    switch (buttonState) {\r\n");
           $nm_saida->saida("        case 'state1':\r\n");
           $nm_saida->saida("            return \"\";\r\n");
        ...
        if ($this->Fix_bar_top) {
           ...
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    selectedFields = $(\".sc-ui-grid-header-row-reportes_ventas_forma_pago-1 .sc-op-fix-col.sc-op-fix-col-fixed\");\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-reportes_ventas_forma_pago-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-reportes_ventas_forma_pago-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-reportes_ventas_forma_pago-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-cbde91bc\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reportes_ventas_forma_pago_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reportes_ventas_forma_pago_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_reportes_ventas_forma_pago_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".reportes_ventas_forma_pago_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .reportes_ventas_forma_pago_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".reportes_ventas_forma_pago_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               ...
               {
                   $groupByLabel = sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", "fac_fecha");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "fac_serie_fac_secuencial")
           {
               ...
               {
                   $groupByLabel = sprintf("fac_serie", "fac_serie");
                   $nm_saida->saida("          <div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">{$groupByLabel}</H1></div>\r\n");
               } 
           }
       } 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['doc_word'])
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf_vert'])
   {
   }
   else
   {
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != "print") 
       { 
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_reportes_ventas_forma_pago\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_reportes_ventas_forma_pago\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
       }
           $nm_saida->saida("    <TR>\r\n");
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_reportes_ventas_forma_pago\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_reportes_ventas_forma_pago\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_reportes_ventas_forma_pago\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_reportes_ventas_forma_pago\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['reportes_ventas_forma_pago']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['reportes_ventas_forma_pago']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['reportes_ventas_forma_pago']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['reportes_ventas_forma_pago']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida']) ? "reportes_ventas_forma_pago_" : "";
   $this->css_sep = " ";
   ...
   $this->css_fac_tipo_comprobante_label = $compl_css_emb . "css_fac_tipo_comprobante_label";
   $this->css_fac_tipo_comprobante_grid_line = $compl_css_emb . "css_fac_tipo_comprobante_grid_line";
   ...
   $this->css_fac_comentario_label = $compl_css_emb . "css_fac_comentario_label";
   $this->css_fac_comentario_grid_line = $compl_css_emb . "css_fac_comentario_grid_line";
   ...
   $this->css_fac_autorizacion_label = $compl_css_emb . "css_fac_autorizacion_label";
   $this->css_fac_autorizacion_grid_line = $compl_css_emb . "css_fac_autorizacion_grid_line";
   $this->css_fac_error_sri_label = $compl_css_emb . "css_fac_error_sri_label";
   $this->css_fac_error_sri_grid_line = $compl_css_emb . "css_fac_error_sri_grid_line";
 }  
 function cabecalho()
 {
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['cond_pesq'], 0, $trab_pos);
...
$_SESSION['scriptcase']['reportes_ventas_forma_pago']['contr_erro'] = 'off';
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sv_dt_head'] = array();
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sv_dt_head'][1] = $sc_data_cab1;
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sv_dt_head']['fix'] = $nm_data_fixa;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf")
   { 
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida("       <TR valign=\"middle\">\r\n");
   $nm_saida->saida("        <TD align=\"left\" class=\"" . $this->css_scGridHeaderFont . "\">\r\n");
   $nm_saida->saida("          " . $this->Ini->Nm_lang['lang_facturas_forma_pago'] . "\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("        <TD style=\"font-size: 5px\">\r\n");
   $nm_saida->saida("          &nbsp; &nbsp;\r\n");
   $nm_saida->saida("        </TD>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_label'])
   { 
       $this->New_label['fac_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . "";
       $this->New_label['fac_tipo_comprobante'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . "";
       $this->New_label['fac_serie'] = "" . $this->Ini->Nm_lang['lang_serie_sri'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_reportes_ventas_forma_pago__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-reportes_ventas_forma_pago-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_error_sri_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_error_sri_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf") {
       $classColFld = "";
       $classColTitle = "";
       $classColActions = "";
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . " sc-col-actionbar-left  " . $classColFld . $classColTitle . $classColActions . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_error_sri_label'] . "\" >\r\n");
   $nm_saida->saida("<style>\r\n");
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".reportes_ventas_forma_pago_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_fac_fecha()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fac_fecha_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_fecha_label'] . "\" >\r\n");
 ...
 function NM_label_fac_tipo_comprobante()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['fac_tipo_comprobante']) || $this->NM_cmp_hidden['fac_tipo_comprobante'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fac_tipo_comprobante_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_tipo_comprobante_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('fac_tipo_comprobante');
        $fieldSortIcon = $this->scGetColumnOrderIcon('fac_tipo_comprobante', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_fac_tipo_comprobante_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_fac_tipo_comprobante_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('fac_tipo_comprobante')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = "<span class=\"sc-op-fix-col sc-op-fix-col-" . $this->grid_fixed_column_no . " sc-op-fix-col-notfixed\" data-fixcolid=\"" . $this->grid_fixed_column_no . "\" id=\"sc-fld-fix-col-" . $this->grid_fixed_column_no . "\"><i class=\"fas fa-thumbtack\"></i></span>";
 ...
 function NM_label_fac_serie()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fac_serie_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_serie_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
 ...
 function NM_label_fac_secuencial()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fac_secuencial_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_secuencial_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
 ...
 function NM_label_fac_total()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fac_total_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_total_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != 'pdf') {
        // label & order
 ...
 function NM_label_fac_comentario()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['fac_comentario']) || $this->NM_cmp_hidden['fac_comentario'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fac_comentario_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_comentario_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('fac_comentario');
        $fieldSortIcon = $this->scGetColumnOrderIcon('fac_comentario', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_fac_comentario_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_fac_comentario_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('fac_comentario')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = "<span class=\"sc-op-fix-col sc-op-fix-col-" . $this->grid_fixed_column_no . " sc-op-fix-col-notfixed\" data-fixcolid=\"" . $this->grid_fixed_column_no . "\" id=\"sc-fld-fix-col-" . $this->grid_fixed_column_no . "\"><i class=\"fas fa-thumbtack\"></i></span>";
 ...
 function NM_label_fac_autorizacion()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['fac_autorizacion']) || $this->NM_cmp_hidden['fac_autorizacion'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fac_autorizacion_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_autorizacion_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('fac_autorizacion');
        $fieldSortIcon = $this->scGetColumnOrderIcon('fac_autorizacion', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_fac_autorizacion_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_fac_autorizacion_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('fac_autorizacion')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = "<span class=\"sc-op-fix-col sc-op-fix-col-" . $this->grid_fixed_column_no . " sc-op-fix-col-notfixed\" data-fixcolid=\"" . $this->grid_fixed_column_no . "\" id=\"sc-fld-fix-col-" . $this->grid_fixed_column_no . "\"><i class=\"fas fa-thumbtack\"></i></span>";
 ...
 function NM_label_fac_error_sri()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['fac_error_sri']) || $this->NM_cmp_hidden['fac_error_sri'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fac_error_sri_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_error_sri_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('fac_error_sri');
        $fieldSortIcon = $this->scGetColumnOrderIcon('fac_error_sri', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_fac_error_sri_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_fac_error_sri_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('fac_error_sri')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = "<span class=\"sc-op-fix-col sc-op-fix-col-" . $this->grid_fixed_column_no . " sc-op-fix-col-notfixed\" data-fixcolid=\"" . $this->grid_fixed_column_no . "\" id=\"sc-fld-fix-col-" . $this->grid_fixed_column_no . "\"><i class=\"fas fa-thumbtack\"></i></span>";
...
function SC_label_rightActionBar()
{
   ...
   $nm_saida->saida("</TD>\r\n");
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_fecha'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fac_tipo_comprobante'])) ? $this->New_label['fac_tipo_comprobante'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_tipo_comprobante'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fac_serie'])) ? $this->New_label['fac_serie'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_serie'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fac_secuencial'])) ? $this->New_label['fac_secuencial'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_secuencial'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_nombre'])) ? $this->New_label['cl_nombre'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_identificacion'])) ? $this->New_label['cl_identificacion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_identificacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fac_total'])) ? $this->New_label['fac_total'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fp_descripcion'])) ? $this->New_label['fp_descripcion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_descripcion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fp_valor'])) ? $this->New_label['fp_valor'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_valor'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fac_comentario'])) ? $this->New_label['fac_comentario'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_comentario'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_direccion'])) ? $this->New_label['cl_direccion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_direccion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_telefono'])) ? $this->New_label['cl_telefono'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_telefono'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_email'])) ? $this->New_label['cl_email'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fac_autorizacion'])) ? $this->New_label['fac_autorizacion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_autorizacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fac_error_sri'])) ? $this->New_label['fac_error_sri'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_error_sri'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['reportes_ventas_forma_pago']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_reportes_ventas_forma_pago#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura']['lig_iframe_modal'] = "nmsc_iframe_liga_reportes_ventas_forma_pago";
           }
           $nm_saida->saida(" <TR> \r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && 
               $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != "print") 
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_reportes_ventas_forma_pago\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_reportes_ventas_forma_pago\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_reportes_ventas_forma_pago', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_reportes_ventas_forma_pago', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_reportes_ventas_forma_pago', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" &&
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_reportes_ventas_forma_pago\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_reportes_ventas_forma_pago\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               if (!$_SESSION['scriptcase']['proc_mobile']) {
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_reportes_ventas_forma_pago\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_reportes_ventas_forma_pago\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               }
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
...
else
{
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_reportes_ventas_forma_pago\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_reportes_ventas_forma_pago\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_reportes_ventas_forma_pago#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-cbde91bc\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_grid'])
...
// 
   ...
   $this->Break_pag_pdf['sc_free_group_by']['fac_fecha'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['fac_fecha'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['fac_tipo_comprobante'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['fac_tipo_comprobante'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['fp_descripcion'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['fp_descripcion'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['fac_serie'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['fac_serie'] = "N";
   ...
   $this->Break_pag_pdf['sc_free_group_by']['fac_usuario'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['fac_usuario'] = "N";
   $this->Break_pag_pdf['fac_serie_fac_secuencial']['fac_serie'] = "N";
   $this->Break_pag_prt['fac_serie_fac_secuencial']['fac_serie'] = "N";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Page_break_PDF'] = array();
       }
   }
   $this->SC_top       = array();
   $this->SC_bot       = array();
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  reportes_ventas_forma_pago_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->arg_sum_fac_usuario = " = " . $this->Db->qstr($this->fac_usuario);
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['rows_emb']++;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "sc_free_group_by") 
          {  
              $SC_arg_Gby = array();
              ...
              {
                  $cmp = $SC_lst_Gby[0];
                  if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby']][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Page_break_PDF'][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
              }
          ...
          {  
              ...
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby']]['fac_serie'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Page_break_PDF']['fac_serie'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->fac_serie_Old = $this->fac_serie ; 
...
$_SESSION['scriptcase']['reportes_ventas_forma_pago']['contr_erro'] = 'off';
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_fac_error_sri_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_fac_error_sri_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['mostra_edit'] != "N"){ 
              if ($this->grid_emb_form_full)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura']['lig_iframe_modal'] = "nmsc_iframe_liga_reportes_ventas_forma_pago";
              }
              $Sc_parent = ($this->grid_emb_form_full) ? "S" : "";
              $linkTarget = isset($this->Ini->sc_lig_target['A_@scinf__@scinf_form_del_factura']) ? $this->Ini->sc_lig_target['A_@scinf__@scinf_form_del_factura'] : (isset($this->Ini->sc_lig_target['A_@scinf_']) ? $this->Ini->sc_lig_target['A_@scinf_'] : null);
              if (isset($this->Ini->sc_lig_md5["form_del_factura"]) && $this->Ini->sc_lig_md5["form_del_factura"] == "S")
              {
                  $Parms_Edt  = "fac_numero*scin" . str_replace('"', "@aspasd@", $this->fac_numero) . "*scoutvar_id_factura*scin" . str_replace('"', "@aspasd@", $this->fac_numero) . "*scoutvar_abre_aplicacion*scinreportes_ventas_forma_pago*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutnmgp_opcao*scinigual*scoutNMSC_modal*scinok*scout";
                  if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['under_dashboard'] && isset($linkTarget))
                  {
                      if ('' != $Parms_Edt && '?@?' != substr($Parms_Edt, -3) && '*scout' != substr($Parms_Edt, -6))
                      {
                          $Parms_Edt .= '*scout';
                      }
                      $Parms_Edt .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $linkTarget . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['compact_mode'] ? '1' : '0') . '*scoutremove_margin*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['remove_margin'] ? '1' : '0') . '*scoutremove_border*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['remove_border'] ? '1' : '0');
                  }
                  $Md5_Edt    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@reportes_ventas_forma_pago@SC_par@" . md5($Parms_Edt);
                  $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Lig_Md5'][md5($Parms_Edt)] = $Parms_Edt;
              }
              else
              {
                  $Md5_Edt  = "fac_numero*scin" . str_replace('"', "@aspasd@", $this->fac_numero) . "*scoutvar_id_factura*scin" . str_replace('"', "@aspasd@", $this->fac_numero) . "*scoutvar_abre_aplicacion*scinreportes_ventas_forma_pago*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutnmgp_opcao*scinigual*scoutNMSC_modal*scinok*scout";
              }
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_form_del_factura . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'form_del_factura', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_form_del_factura . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'form_del_factura', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
 ...
 $this->grid_fixed_column_no++;} 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
...
function SC_grid_rightActionBar()
{
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['mostra_edit'] != "N"){ 
   ...
   $nm_saida->saida("</script>\r\n");
              ...
              $buttonHint = $this->actionBar_getStateHint('btn_baucher');
              if ('' != $buttonHint) {
   $nm_saida->saida("<script>\r\n");
   $nm_saida->saida("$(function() {\r\n");
   $nm_saida->saida("    tippy(\"#sc-actionbar-actbtn_btn_baucher_" . $this->SC_seq_page . "\", {\r\n");
   $nm_saida->saida("        content: \"" . $buttonHint . "\",\r\n");
   $nm_saida->saida("        theme: \"light\",\r\n");
   $nm_saida->saida("    });\r\n");
   $nm_saida->saida("    $(\"#sc-actionbar-actbtn_btn_baucher_" . $this->SC_seq_page . "\").attr(\"title\", \"\");\r\n");
   $nm_saida->saida("});\r\n");
   $nm_saida->saida("</script>\r\n");
              }
   ...
   $nm_saida->saida("<td style=\"padding: 0\">\r\n");
            ...
            if (isset($this->Ini->sc_lig_md5["pdf_mostrar"]) && $this->Ini->sc_lig_md5["pdf_mostrar"] == "S") {
                $Parms_Lig = "nmgp_lig_edit_lapis?#?S?@?var_tipo_documento?#?01?@?var_id_documento?#?" . str_replace("'", "@aspass@", $this->fac_numero) . "?@?var_extension_documento?#?pdf?@?";
                if ($_SESSION['scriptcase']['proc_mobile']) {
                ...
                $Md5_Lig = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@reportes_ventas_forma_pago@SC_par@" . md5($Parms_Lig);
                $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
            } else {
                $Md5_Lig = "nmgp_lig_edit_lapis?#?S?@?var_tipo_documento?#?01?@?var_id_documento?#?" . str_replace("'", "@aspass@", $this->fac_numero) . "?@?var_extension_documento?#?pdf?@?";
            }
            $linkConfirm = "";
   ...
   $nm_saida->saida("<td style=\"padding: 0\">\r\n");
            ...
            if (isset($this->Ini->sc_lig_md5["pdf_mostrar"]) && $this->Ini->sc_lig_md5["pdf_mostrar"] == "S") {
                $Parms_Lig = "nmgp_lig_edit_lapis?#?S?@?var_tipo_documento?#?01?@?var_id_documento?#?" . str_replace("'", "@aspass@", $this->fac_numero) . "?@?var_extension_documento?#?xml?@?";
                if ($_SESSION['scriptcase']['proc_mobile']) {
                    $Parms_Lig = str_replace("NM_run_iframe?#?1?@?", "", $Parms_Lig);
                }
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['under_dashboard'] && isset($linkTarget)) {
                ...
                $Md5_Lig = "nmgp_lig_edit_lapis?#?S?@?var_tipo_documento?#?01?@?var_id_documento?#?" . str_replace("'", "@aspass@", $this->fac_numero) . "?@?var_extension_documento?#?xml?@?";
            }
            $linkConfirm = "";
   ...
   $nm_saida->saida("<td style=\"padding: 0\">\r\n");
            $linkTarget = isset($this->Ini->sc_lig_target['T_@scinf_btn_baucher_@scinf_pdf_factura_baucher']) ? $this->Ini->sc_lig_target['T_@scinf_btn_baucher_@scinf_pdf_factura_baucher'] : (isset($this->Ini->sc_lig_target['T_@scinf_btn_baucher']) ? $this->Ini->sc_lig_target['T_@scinf_btn_baucher'] : null);
            if (isset($this->Ini->sc_lig_md5["pdf_factura_baucher"]) && $this->Ini->sc_lig_md5["pdf_factura_baucher"] == "S") {
                $Parms_Lig = "nmgp_lig_edit_lapis?#?S?@?var_documento?#?" . str_replace("'", "@aspass@", $this->fac_numero) . "?@?";
                if ($_SESSION['scriptcase']['proc_mobile']) {
                    $Parms_Lig = str_replace("NM_run_iframe?#?1?@?", "", $Parms_Lig);
                }
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['under_dashboard'] && isset($linkTarget)) {
                ...
                $Md5_Lig = "nmgp_lig_edit_lapis?#?S?@?var_documento?#?" . str_replace("'", "@aspass@", $this->fac_numero) . "?@?";
            }
            $linkConfirm = "";
   $nm_saida->saida("<a href=\"javascript:actionBar_linkSubmit5('sc-actionbar-actbtn_btn_baucher_" . $this->SC_seq_page . "', '" . $this->Ini->link_pdf_factura_baucher_blk . "', '$this->nm_location', '$Md5_Lig', '" . (isset($linkTarget) ? $linkTarget : '_blank') . "', '', '0', '0', '', 'pdf_factura_baucher', '" . $this->SC_ancora . "', '" . $linkConfirm . "')\" title=\"Baucher\" id=\"sc-actionbar-actbtn_btn_baucher_" . $this->SC_seq_page . "\" data-actionbar-pos=\"" . $dataActionbarPos . "\" data-actionbar-row=\"_" . $this->SC_seq_page . "\" class=\"scButton_fontawesome sc-actionbar-fa " . $this->Ini->cor_link_dados . $this->css_sep . $this->actionBar_getStateDisable('btn_baucher') . $this->actionBar_getStateHide('btn_baucher') . "\">" . $this->actionBar_displayState('btn_baucher') . "</a></td>\r\n");
   $nm_saida->saida("</tr></table\r\n");
   $nm_saida->saida("></TD>\r\n");
 $this->grid_fixed_column_no++;} 
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['mostra_edit'] == "N"){ 
 ...
 function NM_grid_fac_fecha()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fac_fecha_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fac_fecha_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fac_fecha_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_fac_tipo_comprobante()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['fac_tipo_comprobante']) || $this->NM_cmp_hidden['fac_tipo_comprobante'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              ...
              $conteudo_original = NM_encode_input(sc_strip_script($this->fac_tipo_comprobante));
          }
          else {
              $conteudo = sc_strip_script($this->fac_tipo_comprobante); 
              $conteudo_original = sc_strip_script($this->fac_tipo_comprobante); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          $this->Lookup->lookup_fac_tipo_comprobante($conteudo , $this->fac_tipo_comprobante) ; 
          $str_tem_display = $conteudo;
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != 'pdf') {
              $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fac_tipo_comprobante_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fac_tipo_comprobante_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fac_tipo_comprobante_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_fac_serie()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fac_serie_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fac_serie_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fac_serie_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_fac_secuencial()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fac_secuencial_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fac_secuencial_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fac_secuencial_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_fac_total()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fac_total_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fac_total_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fac_total_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_fac_comentario()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['fac_comentario']) || $this->NM_cmp_hidden['fac_comentario'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->fac_comentario));
              $conteudo_original = NM_encode_input(sc_strip_script($this->fac_comentario));
          }
          else {
              $conteudo = sc_strip_script($this->fac_comentario); 
              $conteudo_original = sc_strip_script($this->fac_comentario); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fac_comentario_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fac_comentario_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fac_comentario_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_fac_autorizacion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['fac_autorizacion']) || $this->NM_cmp_hidden['fac_autorizacion'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->fac_autorizacion));
              $conteudo_original = NM_encode_input(sc_strip_script($this->fac_autorizacion));
          }
          else {
              $conteudo = sc_strip_script($this->fac_autorizacion); 
              $conteudo_original = sc_strip_script($this->fac_autorizacion); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fac_autorizacion_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fac_autorizacion_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fac_autorizacion_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_fac_error_sri()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['fac_error_sri']) || $this->NM_cmp_hidden['fac_error_sri'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->fac_error_sri));
              $conteudo_original = NM_encode_input(sc_strip_script($this->fac_error_sri));
          }
          else {
              $conteudo = sc_strip_script($this->fac_error_sri); 
              $conteudo_original = sc_strip_script($this->fac_error_sri); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fac_error_sri_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fac_error_sri_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fac_error_sri_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_fac_fecha_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $tot_fac_fecha = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['fac_fecha'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_fac_fecha = 0; 
   $cont_quebra_fac_fecha++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['rows_emb']++;
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_reportes_ventas_forma_pago_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_open_reportes_ventas_forma_pago_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_reportes_ventas_forma_pago_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_reportes_ventas_forma_pago, 'reportes_ventas_forma_pago'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_reportes_ventas_forma_pago_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_close_reportes_ventas_forma_pago_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_reportes_ventas_forma_pago_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_reportes_ventas_forma_pago, 'reportes_ventas_forma_pago'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['fac_fecha']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   $this->Label_fac_fecha = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_fac_fecha .= "<tr>"; 
       $this->Label_fac_fecha .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_fac_fecha .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_fac_fecha .= "</tr>"; 
   } 
   $this->Label_fac_fecha .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   ...
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_fac_fecha . $nm_fecha_pdf_old . "\r\n");
   ...
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['fac_fecha'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['fac_fecha']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
 ...
 function quebra_fac_fecha_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['fac_fecha'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "fac_tipo_comprobante" && (!isset($this->NM_cmp_hidden['fac_tipo_comprobante']) || $this->NM_cmp_hidden['fac_tipo_comprobante'] != "off"))
    {
        $colspan++;
    }
    ...
    if ($Cada_cmp == "fp_valor" && (!isset($this->NM_cmp_hidden['fp_valor']) || $this->NM_cmp_hidden['fp_valor'] != "off"))
    {
      ...
      {
          $conteudo =  $tot_fac_fecha[$NM_cmp_tot['fp_valor'][$Tipo_Sum]]; 
    ...
    if ($Cada_cmp == "fac_comentario" && (!isset($this->NM_cmp_hidden['fac_comentario']) || $this->NM_cmp_hidden['fac_comentario'] != "off"))
    {
        $colspan++;
    }
    ...
    if ($Cada_cmp == "fac_autorizacion" && (!isset($this->NM_cmp_hidden['fac_autorizacion']) || $this->NM_cmp_hidden['fac_autorizacion'] != "off"))
    {
        $colspan++;
    }
    if ($Cada_cmp == "fac_error_sri" && (!isset($this->NM_cmp_hidden['fac_error_sri']) || $this->NM_cmp_hidden['fac_error_sri'] != "off"))
    {
        $colspan++;
    }
   }
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = false;
       $nm_saida->saida("    </TBODY>");
   }
 ...
 function quebra_fac_tipo_comprobante_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_fac_tipo_comprobante = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['fac_tipo_comprobante'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_fac_tipo_comprobante = 0; 
   $cont_quebra_fac_tipo_comprobante++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['rows_emb']++;
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['fac_tipo_comprobante']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   $conteudo = $tot_fac_tipo_comprobante[0] ;  
    $thisColspan = 2;
   $colspan = $this->NM_colspan;
   $this->Label_fac_tipo_comprobante = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_fac_tipo_comprobante .= "<tr>"; 
       $this->Label_fac_tipo_comprobante .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_fac_tipo_comprobante .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_fac_tipo_comprobante .= "</tr>"; 
   } 
   $this->Label_fac_tipo_comprobante .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   ...
   $nm_saida->saida("       " . $link_div . "\r\n");
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_fac_tipo_comprobante . $nm_fecha_pdf_old . "\r\n");
   $nm_saida->saida("       " . $link_div_2 . "\r\n");
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['fac_tipo_comprobante'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['fac_tipo_comprobante']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_fac_tipo_comprobante_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $NM_cmp_tot['fp_valor']['S'] = 2;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['fac_tipo_comprobante'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "fp_valor" && (!isset($this->NM_cmp_hidden['fp_valor']) || $this->NM_cmp_hidden['fp_valor'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['fp_valor'][$Tipo_Sum]))
      {
          $conteudo =  $tot_fac_tipo_comprobante[$NM_cmp_tot['fp_valor'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:2", "-") ; 
          }
 ...
 function quebra_fp_descripcion_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_fp_descripcion = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['fp_descripcion'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['fp_descripcion']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['fp_descripcion'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['fp_descripcion']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_fp_descripcion_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['fp_valor']['S'] = 2;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['fp_descripcion'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
 ...
 function quebra_fac_serie_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_fac_serie = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['fac_serie'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_fac_serie = 0; 
   $cont_quebra_fac_serie++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['rows_emb']++;
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['fac_serie']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   $conteudo = $tot_fac_serie[0] ;  
    $thisColspan = 2;
   $colspan = $this->NM_colspan;
   $this->Label_fac_serie = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_fac_serie .= "<tr>"; 
       $this->Label_fac_serie .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_fac_serie .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_fac_serie .= "</tr>"; 
   } 
   $this->Label_fac_serie .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\"  " . "colspan=\"" . $colspan . "\"" . " align=\"\">\r\n");
   $nm_saida->saida("       " . $link_div . "\r\n");
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_fac_serie . $nm_fecha_pdf_old . "\r\n");
   $nm_saida->saida("       " . $link_div_2 . "\r\n");
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['fac_serie'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['fac_serie']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_fac_serie_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $NM_cmp_tot['fp_valor']['S'] = 2;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['fac_serie'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "fp_valor" && (!isset($this->NM_cmp_hidden['fp_valor']) || $this->NM_cmp_hidden['fp_valor'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['fp_valor'][$Tipo_Sum]))
      {
          $conteudo =  $tot_fac_serie[$NM_cmp_tot['fp_valor'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:2", "-") ; 
          }
 ...
 function quebra_fac_secuencial_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_fac_secuencial = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['fac_secuencial'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['fac_secuencial']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['fac_secuencial'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['fac_secuencial']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_fac_secuencial_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['fp_valor']['S'] = 2;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['fac_secuencial'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
 ...
 function quebra_cl_nombre_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_cl_nombre = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['cl_nombre'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_nombre']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['cl_nombre'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_nombre']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_cl_nombre_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['fp_valor']['S'] = 2;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['cl_nombre'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
 ...
 function quebra_cl_identificacion_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_cl_identificacion = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['cl_identificacion'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_identificacion']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['cl_identificacion'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_identificacion']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_cl_identificacion_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['fp_valor']['S'] = 2;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['cl_identificacion'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
 ...
 function quebra_fac_usuario_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_fac_usuario = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['fac_usuario'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_fac_usuario = 0; 
   $cont_quebra_fac_usuario++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['rows_emb']++;
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['fac_usuario']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   $conteudo = $tot_fac_usuario[0] ;  
    $thisColspan = 2;
   $colspan = $this->NM_colspan;
   $this->Label_fac_usuario = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_fac_usuario .= "<tr>"; 
       $this->Label_fac_usuario .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_fac_usuario .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_fac_usuario .= "</tr>"; 
   } 
   $this->Label_fac_usuario .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\"  " . "colspan=\"" . $colspan . "\"" . " align=\"\">\r\n");
   $nm_saida->saida("       " . $link_div . "\r\n");
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_fac_usuario . $nm_fecha_pdf_old . "\r\n");
   $nm_saida->saida("       " . $link_div_2 . "\r\n");
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['fac_usuario'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body][$this->Tab_Nv_tree['fac_usuario']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_fac_usuario_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $NM_cmp_tot['fp_valor']['S'] = 2;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['fac_usuario'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "fp_valor" && (!isset($this->NM_cmp_hidden['fp_valor']) || $this->NM_cmp_hidden['fp_valor'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['fp_valor'][$Tipo_Sum]))
      {
          $conteudo =  $tot_fac_usuario[$NM_cmp_tot['fp_valor'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:2", "-") ; 
          }
 ...
 { global
          $fac_serie_ant_desc, 
          $nm_saida, $tot_fac_serie;
   $this->SC_tab_quebra = 0;
   $fac_serie_ant_desc = $this->campos_quebra_fac_serie[0]['cmp'];
   static $cont_quebra_fac_serie = 0; 
   $cont_quebra_fac_serie++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body]['1'] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" && !$this->Print_All)
   {
       $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H2 style=\"font-size:0;padding:1px\">" .  $this->campos_quebra_fac_serie[0]['cmp'] ;
       $nm_fecha_pdf_new = "</H2></div>";
   }
   $conteudo = $tot_fac_serie[0] ;  
    $thisColspan = 2;
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ind_tree'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['reportes_ventas_forma_pago'][$this->NM_cont_body]['1'] = 'bot';
       $nm_saida->saida("    <TBODY id=\"tbody_reportes_ventas_forma_pago_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
       $this->NM_tbody_open = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_grid'] && $this->nm_prim_linha)
 ...
 function quebra_geral_sc_free_group_by_bot() 
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      = $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral'][0];
   $tit_lin_sumariza_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral'][0];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "fp_valor" && (!isset($this->NM_cmp_hidden['fp_valor']) || $this->NM_cmp_hidden['fp_valor'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['fp_valor'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral'][$NM_cmp_tot['fp_valor'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:2", "-") ; 
          }
 ...
 function quebra_geral_fac_serie_fac_secuencial_top() 
 {
   global $nm_saida; 
   if (isset($this->NM_tbody_open) && $this->NM_tbody_open)
   {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']))
      {
          ...
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=reportes_ventas_forma_pago&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          $Tem_word_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Tem_xls_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=reportes_ventas_forma_pago&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $Tem_pdf_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']))
          ...
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Groupby_hide']))
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']))
            { }
            else {
          ...
          if (is_file("reportes_ventas_forma_pago_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("reportes_ventas_forma_pago_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "fac_serie")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "fac_serie";
                           $lin_obj = $this->grid_search_fac_serie($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('fac_fecha','fac_serie','fp_descripcion','cl_nombre','cl_identificacion','fac_usuario');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq']) < 6)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_fac_serie($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_fac_serie_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_fac_serie_cond_" . $ind . "' name='cond_grid_search_fac_serie_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $lin_obj .= "       <span id=\"grid_fac_serie_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['psq_check_ret']['fac_serie'] = array();
       $fac_serie_look = (is_string($fac_serie) ? substr($this->Db->qstr($fac_serie), 1, -1) : $fac_serie); 
       $nmgp_def_dados  = ""; 
       $nm_comando = "select distinct fac_serie from " . $this->Ini->nm_tabela . " where (fac_estado='V' and fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') order by fac_serie"; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['psq_check_ret']['fac_serie'][] = trim($rs->fields[0]);
       ...
       $lin_obj .= "    <input id='grid_search_fac_serie_val_" . $ind . "' name='val_grid_search_fac_serie_" . $ind . "' type='hidden' value=''>";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' style='height : auto;' id=\"grid_search_fac_serie_val_" . $ind . "_orig\" name=\"val_grid_search_fac_serie_" . $ind . "_orig\" size=7 multiple onDblClick=\"nm_add_sel_Grid('grid_search_fac_serie_val_" . $ind . "_orig', 'grid_search_fac_serie_val_" . $ind . "_dest', 'N')\">";
       $delimitador = "##@@";
          ...
          if (!empty($nm_opcao))
          {
             ...
             if (is_array($val) && !empty($val))
             {
                ...
                foreach ($val as $Dados)
                {
                    ...
                    if ($Dados === $nm_opc_cod)
                    {
                        $fac_serie_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                        break;
                    }
                }
             }
             ...
             {
                $fac_serie_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $fac_serie_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "   </td>";
       ...
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all_Grid('grid_search_fac_serie_val_" . $ind . "_orig', 'grid_search_fac_serie_val_" . $ind . "_dest', 'N');", "nm_add_all_Grid('grid_search_fac_serie_val_" . $ind . "_orig', 'grid_search_fac_serie_val_" . $ind . "_dest', 'N');", "G_Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel_Grid('grid_search_fac_serie_val_" . $ind . "_orig', 'grid_search_fac_serie_val_" . $ind . "_dest', 'N');", "nm_add_sel_Grid('grid_search_fac_serie_val_" . $ind . "_orig', 'grid_search_fac_serie_val_" . $ind . "_dest', 'N');", "G_Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel_Grid('grid_search_fac_serie_val_" . $ind . "_dest', 'grid_search_fac_serie_val_" . $ind . "_orig', 'N');", "nm_del_sel_Grid('grid_search_fac_serie_val_" . $ind . "_dest', 'grid_search_fac_serie_val_" . $ind . "_orig', 'N');", "G_Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all_Grid('grid_search_fac_serie_val_" . $ind . "_dest', 'grid_search_fac_serie_val_" . $ind . "_orig', 'N');", "nm_del_all_Grid('grid_search_fac_serie_val_" . $ind . "_dest', 'grid_search_fac_serie_val_" . $ind . "_orig', 'N');", "G_Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   </td>";
       $lin_obj .= "   <td>";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' style='height : auto;' id=\"grid_search_fac_serie_val_" . $ind . "_dest\" name=\"val_grid_search_fac_serie_" . $ind . "_dest\" size=7 multiple onDblClick=\"nm_del_sel_Grid('grid_search_fac_serie_val_" . $ind . "_dest', 'grid_search_fac_serie_val_" . $ind . "_orig', 'N')\">";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       foreach ($nm_opcoes as $nm_opcao)
       {
   ...
   function grid_search_fp_descripcion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['psq_check_ret']['fp_descripcion'] = array();
       $fp_descripcion_look = (is_string($fp_descripcion) ? substr($this->Db->qstr($fp_descripcion), 1, -1) : $fp_descripcion); 
       $nmgp_def_dados  = ""; 
       $nm_comando = "select distinct fp_descripcion from " . $this->Ini->nm_tabela . " where (fac_estado='V' and fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') order by fp_descripcion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['psq_check_ret']['fp_descripcion'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_cl_nombre($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (fac_estado='V' and fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and #lowerI#cl_nombre#lowerF# = #lowerI#'$cl_nombre_look'#lowerF# order by cl_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function grid_search_cl_identificacion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (fac_estado='V' and fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and #lowerI#cl_identificacion#lowerF# = #lowerI#'$cl_identificacion_look'#lowerF# order by cl_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function grid_search_fac_usuario($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['psq_check_ret']['fac_usuario'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['psq_check_ret']['fac_usuario'][] = trim($rs->fields[0]);
   ...
   function lookup_ajax_cl_nombre($cl_nombre)
   {
       ...
       $cl_nombre_look = (is_string($cl_nombre) ? substr($this->Db->qstr($cl_nombre), 1, -1) : $cl_nombre); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (fac_estado='V' and fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  #lowerI#cl_nombre#lowerF# like #lowerI#'%" . $cl_nombre . "%'#lowerF# order by cl_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = reportes_ventas_forma_pago_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_cl_identificacion($cl_identificacion)
   {
       ...
       $cl_identificacion_look = (is_string($cl_identificacion) ? substr($this->Db->qstr($cl_identificacion), 1, -1) : $cl_identificacion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (fac_estado='V' and fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  #lowerI#cl_identificacion#lowerF# like #lowerI#'%" . $cl_identificacion . "%'#lowerF# order by cl_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "debi_doc_electronicos/reportes_ventas_forma_pago";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_reportes_ventas_forma_pago_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_reportes_ventas_forma_pago_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_mes'] =  'sc_reportes_ventas_forma_pago_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_dia'] =  'sc_reportes_ventas_forma_pago_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_v2__mes'] =  'sc_reportes_ventas_forma_pago_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_v2__dia'] =  'sc_reportes_ventas_forma_pago_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_mes']", 'value' => 'sc_reportes_ventas_forma_pago_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_dia']", 'value' => 'sc_reportes_ventas_forma_pago_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_v2__mes']", 'value' => 'sc_reportes_ventas_forma_pago_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_v2__dia']", 'value' => 'sc_reportes_ventas_forma_pago_valida_dia(this)');
       } 
       ...
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'fac_serie')\r\n");
       $nm_saida->saida("                 {\r\n");
...
function sc_actionbar_disable($buttonName)
{
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_reportes_ventas_forma_pago\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_reportes_ventas_forma_pago\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('reportes_ventas_forma_pago', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"reportes_ventas_forma_pago\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"reportes_ventas_forma_pago_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"reportes_ventas_forma_pago_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"reportes_ventas_forma_pago_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=reportes_ventas_forma_pago';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_reportes_ventas_forma_pago');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_reportes_ventas_forma_pago');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_reportes_ventas_forma_pago');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_reportes_ventas_forma_pago');} \r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['reportes_ventas_forma_pago_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@reportes_ventas_forma_pago@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"reportes_ventas_forma_pago_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"reportes_ventas_forma_pago_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"reportes_ventas_forma_pago_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['reportes_ventas_forma_pago']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"reportes_ventas_forma_pago_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('reportes_ventas_forma_pago')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('reportes_ventas_forma_pago', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
