...
class reportes_ventas_forma_pago_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['reportes_ventas_forma_pago']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['reportes_ventas_forma_pago']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_total']['fac_fecha'] = $this->array_total_fac_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_total']['fac_tipo_comprobante'] = $this->array_total_fac_tipo_comprobante;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_total']['fp_descripcion'] = $this->array_total_fp_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_total']['fac_serie'] = $this->array_total_fac_serie;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_total']['fac_secuencial'] = $this->array_total_fac_secuencial;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_total']['cl_nombre'] = $this->array_total_cl_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_total']['cl_identificacion'] = $this->array_total_cl_identificacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_total']['fac_usuario'] = $this->array_total_fac_usuario;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['json_use_label'])
       {
       ...
       $Lab_fac_fecha =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_fac_fecha);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_fecha'] = $Lab_fac_fecha; 
       $prep_field['fac_tipo_comprobante'] = $Lab_fac_tipo_comprobante;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_tipo_comprobante'] = $Lab_fac_tipo_comprobante; 
       $prep_field['fp_descripcion'] = $Lab_fp_descripcion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_descripcion'] = $Lab_fp_descripcion; 
       $prep_field['fac_serie'] = $Lab_fac_serie;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_serie'] = $Lab_fac_serie; 
       $prep_field['fac_secuencial'] = $Lab_fac_secuencial;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_secuencial'] = $Lab_fac_secuencial; 
       $prep_field['cl_nombre'] = $Lab_cl_nombre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_nombre'] = $Lab_cl_nombre; 
       $prep_field['cl_identificacion'] = $Lab_cl_identificacion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_identificacion'] = $Lab_cl_identificacion; 
       $prep_field['fac_usuario'] = $Lab_fac_usuario;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_usuario'] = $Lab_fac_usuario; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_tipo_comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_tipo_comprobante'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_serie'] = "" . $this->Ini->Nm_lang['lang_serie_sri'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_secuencial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_secuencial'] = "" . $this->Ini->Nm_lang['lang_secuencial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_nombre'] = "" . $this->Ini->Nm_lang['lang_cliente'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_total'] = "" . $this->Ini->Nm_lang['lang_othr_chrt_totl'] . " Facturado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_descripcion'] = "" . $this->Ini->Nm_lang['lang_forma_pago'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_valor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_valor'] = "" . $this->Ini->Nm_lang['lang_valor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_comentario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_comentario'] = "" . $this->Ini->Nm_lang['lang_comentario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_autorizacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_autorizacion'] = "" . $this->Ini->Nm_lang['lang_autorizacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_error_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_error_sri'] = "" . $this->Ini->Nm_lang['lang_mensaje'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_numero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_numero'] = "" . $this->Ini->Nm_lang['lang_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_ambiente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_ambiente'] = "" . $this->Ini->Nm_lang['lang_tipo_ambiente'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['est_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['est_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion_oficina'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_id'] = "" . $this->Ini->Nm_lang['lang_cliente'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_tipo_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['cl_tipo_identificacion'] = "" . $this->Ini->Nm_lang['lang_tipo_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_estado_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_estado_sri'] = "" . $this->Ini->Nm_lang['lang_estado_sri'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_usuario'] = "" . $this->Ini->Nm_lang['lang_usuario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_estado'] = "" . $this->Ini->Nm_lang['lang_estado'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_tipo_libretin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fac_tipo_libretin'] = "" . $this->Ini->Nm_lang['lang_tipo_libretin'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@reportes_ventas_forma_pago@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new reportes_ventas_forma_pago_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ajax_nav']) {  
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reportes_ventas_forma_pago_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_reportes_ventas_forma_pago_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reportes_ventas_forma_pago_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=reportes_ventas_forma_pago&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("reportes_ventas_forma_pago_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['reportes_ventas_forma_pago']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['reportes_ventas_forma_pago']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'reportes_ventas_forma_pago_config_pivot.php?nome_apl=reportes_ventas_forma_pago&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"reportes_ventas_forma_pago_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reportes_ventas_forma_pago_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "reportes_ventas_forma_pago/reportes_ventas_forma_pago_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($sum_fp_valor, $quebra_fac_fecha, $quebra_fac_tipo_comprobante, $quebra_fp_descripcion, $quebra_fac_serie, $quebra_fac_secuencial, $quebra_cl_nombre, $quebra_cl_identificacion, $quebra_fac_usuario, $quebra_fac_fecha_orig, $quebra_fac_tipo_comprobante_orig, $quebra_fp_descripcion_orig, $quebra_fac_serie_orig, $quebra_fac_secuencial_orig, $quebra_cl_nombre_orig, $quebra_cl_identificacion_orig, $quebra_fac_usuario_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fac_serie = $rs_res->fields[2] ;  
            $this->fac_secuencial = $rs_res->fields[3] ;  
            $this->cl_nombre = $rs_res->fields[4] ;  
            $this->cl_identificacion = $rs_res->fields[5] ;  
            $this->fac_total = $rs_res->fields[6] ;  
            $this->fp_descripcion = $rs_res->fields[7] ;  
            $this->fp_valor = $rs_res->fields[8] ;  
            $this->fac_comentario = $rs_res->fields[9] ;  
            $this->cl_direccion = $rs_res->fields[10] ;  
            $this->cl_telefono = $rs_res->fields[11] ;  
            $this->cl_email = $rs_res->fields[12] ;  
            $this->fac_autorizacion = $rs_res->fields[13] ;  
            $this->fac_error_sri = $rs_res->fields[14] ;  
            $this->fac_estado_sri = $rs_res->fields[15] ;  
            $this->fac_usuario = $rs_res->fields[16] ;  
            $this->fac_numero = $rs_res->fields[17] ;  
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->fp_valor, $this->fac_fecha, $this->fac_tipo_comprobante, $this->fp_descripcion, $this->fac_serie, $this->fac_secuencial, $this->cl_nombre, $this->cl_identificacion, $this->fac_usuario, $this->fac_fecha_orig,  $this->fac_tipo_comprobante_orig,  $this->fp_descripcion_orig,  $this->fac_serie_orig,  $this->fac_secuencial_orig,  $this->cl_nombre_orig,  $this->cl_identificacion_orig,  $this->fac_usuario_orig);
            }
   }
//
