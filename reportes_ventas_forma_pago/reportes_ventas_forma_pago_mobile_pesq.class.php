...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "fac_fecha";$Nm_numeric[] = "fac_numero";$Nm_numeric[] = "fac_ambiente";$Nm_numeric[] = "cl_id";$Nm_numeric[] = "fac_total";$Nm_numeric[] = "fp_valor";
...
?>
   <span id="idAjaxSelect_fac_serie">
      <SELECT class="scFilterObjectEven" id="SC_fac_serie" name="fac_serie[]"  size="7" multiple>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fp_descripcion"  <?php echo $str_hide_fp_descripcion?>>
<?php
...
?>
   <span id="idAjaxSelect_fp_descripcion">
      <SELECT class="scFilterObjectOdd" id="SC_fp_descripcion" name="fp_descripcion[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
 ...
 function limpa_form()
 {
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'fp_descripcion[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "fac_serie" : return ('class="scFilterObjectEven"'); break;
         case "fp_descripcion" : return ('class="scFilterObjectOdd"'); break;
