...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_reportes_ventas_forma_pago').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_reportes_ventas_forma_pago').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_reportes_ventas_forma_pago').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_reportes_ventas_forma_pago').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_reportes_ventas_forma_pago').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_reportes_ventas_forma_pago').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_reportes_ventas_forma_pago').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_reportes_ventas_forma_pago').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_reportes_ventas_forma_pago').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_reportes_ventas_forma_pago').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_reportes_ventas_forma_pago').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_reportes_ventas_forma_pago').style.width  = '0px';
        }
        if (oResp["setValue"]) {
