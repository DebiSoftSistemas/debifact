  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_proveedor" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_proveedor_form();
	}
...
?>
  ...
  // ---------- Validate pr_id
  function do_ajax_form_del_proveedor_validate_pr_id()
  {
    var nomeCampo_pr_id = "pr_id";
    var var_pr_id = scAjaxGetFieldHidden(nomeCampo_pr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_id(var_pr_id, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_id_cb);
  } // do_ajax_form_del_proveedor_validate_pr_id

  function do_ajax_form_del_proveedor_validate_pr_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_id_cb

  // ---------- Validate pr_empresa
  function do_ajax_form_del_proveedor_validate_pr_empresa()
  {
    var nomeCampo_pr_empresa = "pr_empresa";
    var var_pr_empresa = scAjaxGetFieldText(nomeCampo_pr_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_empresa(var_pr_empresa, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_empresa_cb);
  } // do_ajax_form_del_proveedor_validate_pr_empresa

  function do_ajax_form_del_proveedor_validate_pr_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_empresa_cb

  // ---------- Validate pr_tipo_identificacion
  function do_ajax_form_del_proveedor_validate_pr_tipo_identificacion()
  {
    var nomeCampo_pr_tipo_identificacion = "pr_tipo_identificacion";
    var var_pr_tipo_identificacion = scAjaxGetFieldSelect(nomeCampo_pr_tipo_identificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_tipo_identificacion(var_pr_tipo_identificacion, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_tipo_identificacion_cb);
  } // do_ajax_form_del_proveedor_validate_pr_tipo_identificacion

  function do_ajax_form_del_proveedor_validate_pr_tipo_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_tipo_identificacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_tipo_identificacion_cb

  // ---------- Validate pr_tipo_persona
  function do_ajax_form_del_proveedor_validate_pr_tipo_persona()
  {
    var nomeCampo_pr_tipo_persona = "pr_tipo_persona";
    var var_pr_tipo_persona = scAjaxGetFieldSelect(nomeCampo_pr_tipo_persona);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_tipo_persona(var_pr_tipo_persona, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_tipo_persona_cb);
  } // do_ajax_form_del_proveedor_validate_pr_tipo_persona

  function do_ajax_form_del_proveedor_validate_pr_tipo_persona_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_tipo_persona";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_tipo_persona_cb

  // ---------- Validate pr_identificacion
  function do_ajax_form_del_proveedor_validate_pr_identificacion()
  {
    var nomeCampo_pr_identificacion = "pr_identificacion";
    var var_pr_identificacion = scAjaxGetFieldText(nomeCampo_pr_identificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_identificacion(var_pr_identificacion, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_identificacion_cb);
  } // do_ajax_form_del_proveedor_validate_pr_identificacion

  function do_ajax_form_del_proveedor_validate_pr_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_identificacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_identificacion_cb

  // ---------- Validate pr_nombre
  function do_ajax_form_del_proveedor_validate_pr_nombre()
  {
    var nomeCampo_pr_nombre = "pr_nombre";
    var var_pr_nombre = scAjaxGetFieldText(nomeCampo_pr_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_nombre(var_pr_nombre, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_nombre_cb);
  } // do_ajax_form_del_proveedor_validate_pr_nombre

  function do_ajax_form_del_proveedor_validate_pr_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_nombre_cb

  // ---------- Validate pr_parte_relacionada
  function do_ajax_form_del_proveedor_validate_pr_parte_relacionada()
  {
    var nomeCampo_pr_parte_relacionada = "pr_parte_relacionada";
    var var_pr_parte_relacionada = scAjaxGetFieldCheckbox(nomeCampo_pr_parte_relacionada, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_parte_relacionada(var_pr_parte_relacionada, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_parte_relacionada_cb);
  } // do_ajax_form_del_proveedor_validate_pr_parte_relacionada

  function do_ajax_form_del_proveedor_validate_pr_parte_relacionada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_parte_relacionada";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_parte_relacionada_cb

  // ---------- Validate pr_email
  function do_ajax_form_del_proveedor_validate_pr_email()
  {
    var nomeCampo_pr_email = "pr_email";
    var var_pr_email = scAjaxGetFieldText(nomeCampo_pr_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_email(var_pr_email, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_email_cb);
  } // do_ajax_form_del_proveedor_validate_pr_email

  function do_ajax_form_del_proveedor_validate_pr_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_email_cb

  // ---------- Validate pr_telefono
  function do_ajax_form_del_proveedor_validate_pr_telefono()
  {
    var nomeCampo_pr_telefono = "pr_telefono";
    var var_pr_telefono = scAjaxGetFieldText(nomeCampo_pr_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_telefono(var_pr_telefono, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_telefono_cb);
  } // do_ajax_form_del_proveedor_validate_pr_telefono

  function do_ajax_form_del_proveedor_validate_pr_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_telefono";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_telefono_cb

  // ---------- Validate pr_celular
  function do_ajax_form_del_proveedor_validate_pr_celular()
  {
    var nomeCampo_pr_celular = "pr_celular";
    var var_pr_celular = scAjaxGetFieldText(nomeCampo_pr_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_celular(var_pr_celular, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_celular_cb);
  } // do_ajax_form_del_proveedor_validate_pr_celular

  function do_ajax_form_del_proveedor_validate_pr_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_celular";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_celular_cb

  // ---------- Validate pr_pais
  function do_ajax_form_del_proveedor_validate_pr_pais()
  {
    var nomeCampo_pr_pais = "pr_pais";
    var var_pr_pais = scAjaxGetFieldSelect(nomeCampo_pr_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_pais(var_pr_pais, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_pais_cb);
  } // do_ajax_form_del_proveedor_validate_pr_pais

  function do_ajax_form_del_proveedor_validate_pr_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_pais";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_pais_cb

  // ---------- Validate pr_provincia
  function do_ajax_form_del_proveedor_validate_pr_provincia()
  {
    var nomeCampo_pr_provincia = "pr_provincia";
    var var_pr_provincia = scAjaxGetFieldSelect(nomeCampo_pr_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_provincia(var_pr_provincia, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_provincia_cb);
  } // do_ajax_form_del_proveedor_validate_pr_provincia

  function do_ajax_form_del_proveedor_validate_pr_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_provincia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_provincia_cb

  // ---------- Validate pr_ciudad
  function do_ajax_form_del_proveedor_validate_pr_ciudad()
  {
    var nomeCampo_pr_ciudad = "pr_ciudad";
    var var_pr_ciudad = scAjaxGetFieldSelect(nomeCampo_pr_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_ciudad(var_pr_ciudad, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_ciudad_cb);
  } // do_ajax_form_del_proveedor_validate_pr_ciudad

  function do_ajax_form_del_proveedor_validate_pr_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_ciudad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_ciudad_cb

  // ---------- Validate pr_direccion
  function do_ajax_form_del_proveedor_validate_pr_direccion()
  {
    var nomeCampo_pr_direccion = "pr_direccion";
    var var_pr_direccion = scAjaxGetFieldText(nomeCampo_pr_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_direccion(var_pr_direccion, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_direccion_cb);
  } // do_ajax_form_del_proveedor_validate_pr_direccion

  function do_ajax_form_del_proveedor_validate_pr_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_direccion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_direccion_cb

  // ---------- Validate pr_retencion_iva
  function do_ajax_form_del_proveedor_validate_pr_retencion_iva()
  {
    var nomeCampo_pr_retencion_iva = "pr_retencion_iva";
    var var_pr_retencion_iva = scAjaxGetFieldSelect(nomeCampo_pr_retencion_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_validate_pr_retencion_iva(var_pr_retencion_iva, var_script_case_init, do_ajax_form_del_proveedor_validate_pr_retencion_iva_cb);
  } // do_ajax_form_del_proveedor_validate_pr_retencion_iva

  function do_ajax_form_del_proveedor_validate_pr_retencion_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_retencion_iva";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_validate_pr_retencion_iva_cb

  // ---------- Refresh pr_pais
  function do_ajax_form_del_proveedor_refresh_pr_pais()
  {
    var var_pr_pais = scAjaxGetFieldSelect("pr_pais");
    var var_pr_provincia = scAjaxGetFieldSelect("pr_provincia");
    var var_nmgp_refresh_fields = "pr_provincia_#fld#_pr_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_proveedor_refresh_pr_pais(var_pr_pais, var_pr_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_proveedor_refresh_pr_pais_cb);
  } // do_ajax_form_del_proveedor_refresh_pr_pais

  function do_ajax_form_del_proveedor_refresh_pr_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_del_proveedor_refresh_pr_provincia();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_refresh_pr_pais_cb

  // ---------- Refresh pr_provincia
  function do_ajax_form_del_proveedor_refresh_pr_provincia()
  {
    var var_pr_provincia = scAjaxGetFieldSelect("pr_provincia");
    var var_nmgp_refresh_fields = "pr_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_proveedor_refresh_pr_provincia(var_pr_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_proveedor_refresh_pr_provincia_cb);
  } // do_ajax_form_del_proveedor_refresh_pr_provincia

  function do_ajax_form_del_proveedor_refresh_pr_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_refresh_pr_provincia_cb

  // ---------- Event onblur pr_identificacion
  function do_ajax_form_del_proveedor_event_pr_identificacion_onblur()
  {
    var var_pr_identificacion = scAjaxGetFieldText("pr_identificacion");
    var var_pr_tipo_identificacion = scAjaxGetFieldSelect("pr_tipo_identificacion");
    var var_pr_nombre = scAjaxGetFieldText("pr_nombre");
    var var_pr_direccion = scAjaxGetFieldText("pr_direccion");
    var var_pr_email = scAjaxGetFieldText("pr_email");
    var var_pr_telefono = scAjaxGetFieldText("pr_telefono");
    var var_pr_pais = scAjaxGetFieldSelect("pr_pais");
    var var_pr_provincia = scAjaxGetFieldSelect("pr_provincia");
    var var_pr_ciudad = scAjaxGetFieldSelect("pr_ciudad");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_proveedor_event_pr_identificacion_onblur(var_pr_identificacion, var_pr_tipo_identificacion, var_pr_nombre, var_pr_direccion, var_pr_email, var_pr_telefono, var_pr_pais, var_pr_provincia, var_pr_ciudad, var_script_case_init, do_ajax_form_del_proveedor_event_pr_identificacion_onblur_cb);
  } // do_ajax_form_del_proveedor_event_pr_identificacion_onblur

  function do_ajax_form_del_proveedor_event_pr_identificacion_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pr_identificacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_proveedor_event_pr_identificacion_onblur_cb_after_alert);
  } // do_ajax_form_del_proveedor_event_pr_identificacion_onblur_cb
  function do_ajax_form_del_proveedor_event_pr_identificacion_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_proveedor_event_pr_identificacion_onblur_cb_after_alert

  // ---------- Event onchange pr_tipo_identificacion
  function do_ajax_form_del_proveedor_event_pr_tipo_identificacion_onchange()
  {
    var var_pr_tipo_identificacion = scAjaxGetFieldSelect("pr_tipo_identificacion");
    var var_pr_tipo_persona = scAjaxGetFieldSelect("pr_tipo_persona");
    var var_pr_identificacion = scAjaxGetFieldText("pr_identificacion");
    var var_pr_nombre = scAjaxGetFieldText("pr_nombre");
    var var_pr_direccion = scAjaxGetFieldText("pr_direccion");
    var var_pr_email = scAjaxGetFieldText("pr_email");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_proveedor_event_pr_tipo_identificacion_onchange(var_pr_tipo_identificacion, var_pr_tipo_persona, var_pr_identificacion, var_pr_nombre, var_pr_direccion, var_pr_email, var_pr_telefono, var_pr_pais, var_pr_provincia, var_pr_ciudad, var_script_case_init, do_ajax_form_del_proveedor_event_pr_tipo_identificacion_onchange_cb);
  } // do_ajax_form_del_proveedor_event_pr_tipo_identificacion_onchange

  function do_ajax_form_del_proveedor_event_pr_tipo_identificacion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pr_tipo_identificacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_proveedor_event_pr_tipo_identificacion_onchange_cb_after_alert);
  } // do_ajax_form_del_proveedor_event_pr_tipo_identificacion_onchange_cb
  function do_ajax_form_del_proveedor_event_pr_tipo_identificacion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_proveedor_event_pr_tipo_identificacion_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_proveedor_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_proveedor_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pr_id = scAjaxGetFieldHidden("pr_id");
    var var_pr_empresa = scAjaxGetFieldText("pr_empresa");
    var var_pr_tipo_identificacion = scAjaxGetFieldSelect("pr_tipo_identificacion");
    var var_pr_tipo_persona = scAjaxGetFieldSelect("pr_tipo_persona");
    var var_pr_identificacion = scAjaxGetFieldText("pr_identificacion");
    var var_pr_nombre = scAjaxGetFieldText("pr_nombre");
    var var_pr_parte_relacionada = scAjaxGetFieldCheckbox("pr_parte_relacionada", ";");
    var var_pr_email = scAjaxGetFieldText("pr_email");
    var var_pr_telefono = scAjaxGetFieldText("pr_telefono");
    var var_pr_celular = scAjaxGetFieldText("pr_celular");
    var var_pr_pais = scAjaxGetFieldSelect("pr_pais");
    var var_pr_provincia = scAjaxGetFieldSelect("pr_provincia");
    var var_pr_ciudad = scAjaxGetFieldSelect("pr_ciudad");
    var var_pr_direccion = scAjaxGetFieldText("pr_direccion");
    var var_pr_retencion_iva = scAjaxGetFieldSelect("pr_retencion_iva");
    ...
    scAjaxProcOn();
    x_ajax_form_del_proveedor_submit_form(var_pr_id, var_pr_empresa, var_pr_tipo_identificacion, var_pr_tipo_persona, var_pr_identificacion, var_pr_nombre, var_pr_parte_relacionada, var_pr_email, var_pr_telefono, var_pr_celular, var_pr_pais, var_pr_provincia, var_pr_ciudad, var_pr_direccion, var_pr_retencion_iva, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_proveedor_submit_form_cb);
  } // do_ajax_form_del_proveedor_submit_form

  function do_ajax_form_del_proveedor_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pr_id");
      scAjaxHideErrorDisplay("pr_empresa");
      scAjaxHideErrorDisplay("pr_tipo_identificacion");
      scAjaxHideErrorDisplay("pr_tipo_persona");
      scAjaxHideErrorDisplay("pr_identificacion");
      scAjaxHideErrorDisplay("pr_nombre");
      scAjaxHideErrorDisplay("pr_parte_relacionada");
      scAjaxHideErrorDisplay("pr_email");
      scAjaxHideErrorDisplay("pr_telefono");
      scAjaxHideErrorDisplay("pr_celular");
      scAjaxHideErrorDisplay("pr_pais");
      scAjaxHideErrorDisplay("pr_provincia");
      scAjaxHideErrorDisplay("pr_ciudad");
      scAjaxHideErrorDisplay("pr_direccion");
      scAjaxHideErrorDisplay("pr_retencion_iva");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_proveedor_submit_form_cb_after_alert);
  } // do_ajax_form_del_proveedor_submit_form_cb
  function do_ajax_form_del_proveedor_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_proveedor_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_proveedor_navigate_form()
  {
    perform_ajax_form_del_proveedor_navigate_form();
  }

  function perform_ajax_form_del_proveedor_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("pr_direccion");
    scAjaxHideErrorDisplay("pr_retencion_iva");
    var var_pr_id = document.F2.pr_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_proveedor_navigate_form(var_pr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_proveedor_navigate_form_cb);
  } // do_ajax_form_del_proveedor_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_proveedor_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.pr_id.value = scAjaxGetKeyValue("pr_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_proveedor_navigate_form_cb_after_alert);
  } // do_ajax_form_del_proveedor_navigate_form_cb
  function do_ajax_form_del_proveedor_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_proveedor_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_proveedor_navigate_form_cb_after_alert

  function sc_hide_form_del_proveedor_form()
  {
  ...
  ajax_field_list[0] = "pr_id";
  ajax_field_list[1] = "pr_empresa";
  ajax_field_list[2] = "pr_tipo_identificacion";
  ajax_field_list[3] = "pr_tipo_persona";
  ajax_field_list[4] = "pr_identificacion";
  ajax_field_list[5] = "pr_nombre";
  ajax_field_list[6] = "pr_parte_relacionada";
  ajax_field_list[7] = "pr_email";
  ajax_field_list[8] = "pr_telefono";
  ajax_field_list[9] = "pr_celular";
  ajax_field_list[10] = "pr_pais";
  ajax_field_list[11] = "pr_provincia";
  ajax_field_list[12] = "pr_ciudad";
  ajax_field_list[13] = "pr_direccion";
  ajax_field_list[14] = "pr_retencion_iva";
  ...
  var ajax_error_list = {
    "pr_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_tipo_identificacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_identificacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_tipo_persona": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_persona'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_identificacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_identificacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_nombre'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_parte_relacionada": {"label": "<?php echo $this->Ini->Nm_lang['lang_parte_relacionada'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_telefono": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_telefono'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_celular": {"label": "<?php echo $this->Ini->Nm_lang['lang_celular'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_pais": {"label": "<?php echo $this->Ini->Nm_lang['lang_pais'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_provincia": {"label": "<?php echo $this->Ini->Nm_lang['lang_provincia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_ciudad": {"label": "<?php echo $this->Ini->Nm_lang['lang_ciudad'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_direccion": {"label": "<?php echo $this->Ini->Nm_lang['lang_direccion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_retencion_iva": {"label": "<?php echo $this->Ini->Nm_lang['lang_porcentaje_ret_iva'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "pr_id": new Array(),
    "pr_empresa": new Array(),
    "pr_tipo_identificacion": new Array(),
    "pr_tipo_persona": new Array(),
    "pr_identificacion": new Array(),
    "pr_nombre": new Array(),
    "pr_parte_relacionada": new Array(),
    "pr_email": new Array(),
    "pr_telefono": new Array(),
    "pr_celular": new Array(),
    "pr_pais": new Array(),
    "pr_provincia": new Array(),
    "pr_ciudad": new Array(),
    "pr_direccion": new Array(),
    "pr_retencion_iva": new Array()
  };
  ajax_field_mult["pr_id"][1] = "pr_id";
  ajax_field_mult["pr_empresa"][1] = "pr_empresa";
  ajax_field_mult["pr_tipo_identificacion"][1] = "pr_tipo_identificacion";
  ajax_field_mult["pr_tipo_persona"][1] = "pr_tipo_persona";
  ajax_field_mult["pr_identificacion"][1] = "pr_identificacion";
  ajax_field_mult["pr_nombre"][1] = "pr_nombre";
  ajax_field_mult["pr_parte_relacionada"][1] = "pr_parte_relacionada";
  ajax_field_mult["pr_email"][1] = "pr_email";
  ajax_field_mult["pr_telefono"][1] = "pr_telefono";
  ajax_field_mult["pr_celular"][1] = "pr_celular";
  ajax_field_mult["pr_pais"][1] = "pr_pais";
  ajax_field_mult["pr_provincia"][1] = "pr_provincia";
  ajax_field_mult["pr_ciudad"][1] = "pr_ciudad";
  ajax_field_mult["pr_direccion"][1] = "pr_direccion";
  ajax_field_mult["pr_retencion_iva"][1] = "pr_retencion_iva";

  var ajax_field_id = {
    "pr_tipo_identificacion": new Array("hidden_field_label_pr_tipo_identificacion", "hidden_field_data_pr_tipo_identificacion"),
    "pr_tipo_persona": new Array("hidden_field_label_pr_tipo_persona", "hidden_field_data_pr_tipo_persona"),
    "pr_identificacion": new Array("hidden_field_label_pr_identificacion", "hidden_field_data_pr_identificacion"),
    "pr_nombre": new Array("hidden_field_label_pr_nombre", "hidden_field_data_pr_nombre"),
    "pr_parte_relacionada": new Array("hidden_field_label_pr_parte_relacionada", "hidden_field_data_pr_parte_relacionada"),
    "pr_email": new Array("hidden_field_label_pr_email", "hidden_field_data_pr_email"),
    "pr_telefono": new Array("hidden_field_label_pr_telefono", "hidden_field_data_pr_telefono"),
    "pr_celular": new Array("hidden_field_label_pr_celular", "hidden_field_data_pr_celular"),
    "pr_pais": new Array("hidden_field_label_pr_pais", "hidden_field_data_pr_pais"),
    "pr_provincia": new Array("hidden_field_label_pr_provincia", "hidden_field_data_pr_provincia"),
    "pr_ciudad": new Array("hidden_field_label_pr_ciudad", "hidden_field_data_pr_ciudad"),
    "pr_direccion": new Array("hidden_field_label_pr_direccion", "hidden_field_data_pr_direccion"),
    "pr_retencion_iva": new Array("hidden_field_label_pr_retencion_iva", "hidden_field_data_pr_retencion_iva")
  };

  var ajax_read_only = {
    "pr_id": "on",
    "pr_empresa": "off",
    "pr_tipo_identificacion": "off",
    "pr_tipo_persona": "off",
    "pr_identificacion": "off",
    "pr_nombre": "off",
    "pr_parte_relacionada": "off",
    "pr_email": "off",
    "pr_telefono": "off",
    "pr_celular": "off",
    "pr_pais": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("pr_tipo_identificacion" == sIndex)
    {
    ...
    if ("pr_parte_relacionada" == sIndex)
    {
