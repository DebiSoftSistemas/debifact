  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_proveedor_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_proveedor_mob_form();
	}
...
?>
  ...
  // ---------- Validate pr_id
  function do_ajax_form_del_proveedor_mob_validate_pr_id()
  {
    var nomeCampo_pr_id = "pr_id";
    var var_pr_id = scAjaxGetFieldHidden(nomeCampo_pr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_id(var_pr_id, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_id_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_id

  function do_ajax_form_del_proveedor_mob_validate_pr_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_id_cb

  // ---------- Validate pr_empresa
  function do_ajax_form_del_proveedor_mob_validate_pr_empresa()
  {
    var nomeCampo_pr_empresa = "pr_empresa";
    var var_pr_empresa = scAjaxGetFieldText(nomeCampo_pr_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_empresa(var_pr_empresa, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_empresa_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_empresa

  function do_ajax_form_del_proveedor_mob_validate_pr_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_empresa_cb

  // ---------- Validate pr_tipo_identificacion
  function do_ajax_form_del_proveedor_mob_validate_pr_tipo_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_tipo_identificacion(var_pr_tipo_identificacion, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_tipo_identificacion_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_tipo_identificacion

  function do_ajax_form_del_proveedor_mob_validate_pr_tipo_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_tipo_identificacion_cb

  // ---------- Validate pr_tipo_persona
  function do_ajax_form_del_proveedor_mob_validate_pr_tipo_persona()
  {
    var nomeCampo_pr_tipo_persona = "pr_tipo_persona";
    var var_pr_tipo_persona = scAjaxGetFieldSelect(nomeCampo_pr_tipo_persona);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_tipo_persona(var_pr_tipo_persona, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_tipo_persona_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_tipo_persona

  function do_ajax_form_del_proveedor_mob_validate_pr_tipo_persona_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_tipo_persona_cb

  // ---------- Validate pr_identificacion
  function do_ajax_form_del_proveedor_mob_validate_pr_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_identificacion(var_pr_identificacion, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_identificacion_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_identificacion

  function do_ajax_form_del_proveedor_mob_validate_pr_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_identificacion_cb

  // ---------- Validate pr_nombre
  function do_ajax_form_del_proveedor_mob_validate_pr_nombre()
  {
    var nomeCampo_pr_nombre = "pr_nombre";
    var var_pr_nombre = scAjaxGetFieldText(nomeCampo_pr_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_nombre(var_pr_nombre, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_nombre_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_nombre

  function do_ajax_form_del_proveedor_mob_validate_pr_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_nombre_cb

  // ---------- Validate pr_parte_relacionada
  function do_ajax_form_del_proveedor_mob_validate_pr_parte_relacionada()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_parte_relacionada(var_pr_parte_relacionada, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_parte_relacionada_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_parte_relacionada

  function do_ajax_form_del_proveedor_mob_validate_pr_parte_relacionada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_parte_relacionada_cb

  // ---------- Validate pr_email
  function do_ajax_form_del_proveedor_mob_validate_pr_email()
  {
    var nomeCampo_pr_email = "pr_email";
    var var_pr_email = scAjaxGetFieldText(nomeCampo_pr_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_email(var_pr_email, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_email_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_email

  function do_ajax_form_del_proveedor_mob_validate_pr_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_email_cb

  // ---------- Validate pr_telefono
  function do_ajax_form_del_proveedor_mob_validate_pr_telefono()
  {
    var nomeCampo_pr_telefono = "pr_telefono";
    var var_pr_telefono = scAjaxGetFieldText(nomeCampo_pr_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_telefono(var_pr_telefono, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_telefono_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_telefono

  function do_ajax_form_del_proveedor_mob_validate_pr_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_telefono_cb

  // ---------- Validate pr_celular
  function do_ajax_form_del_proveedor_mob_validate_pr_celular()
  {
    var nomeCampo_pr_celular = "pr_celular";
    var var_pr_celular = scAjaxGetFieldText(nomeCampo_pr_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_celular(var_pr_celular, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_celular_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_celular

  function do_ajax_form_del_proveedor_mob_validate_pr_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_celular_cb

  // ---------- Validate pr_pais
  function do_ajax_form_del_proveedor_mob_validate_pr_pais()
  {
    var nomeCampo_pr_pais = "pr_pais";
    var var_pr_pais = scAjaxGetFieldSelect(nomeCampo_pr_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_pais(var_pr_pais, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_pais_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_pais

  function do_ajax_form_del_proveedor_mob_validate_pr_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_pais";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_pais_cb

  // ---------- Validate pr_provincia
  function do_ajax_form_del_proveedor_mob_validate_pr_provincia()
  {
    var nomeCampo_pr_provincia = "pr_provincia";
    var var_pr_provincia = scAjaxGetFieldSelect(nomeCampo_pr_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_provincia(var_pr_provincia, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_provincia_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_provincia

  function do_ajax_form_del_proveedor_mob_validate_pr_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_provincia_cb

  // ---------- Validate pr_ciudad
  function do_ajax_form_del_proveedor_mob_validate_pr_ciudad()
  {
    var nomeCampo_pr_ciudad = "pr_ciudad";
    var var_pr_ciudad = scAjaxGetFieldSelect(nomeCampo_pr_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_ciudad(var_pr_ciudad, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_ciudad_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_ciudad

  function do_ajax_form_del_proveedor_mob_validate_pr_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_ciudad_cb

  // ---------- Validate pr_direccion
  function do_ajax_form_del_proveedor_mob_validate_pr_direccion()
  {
    var nomeCampo_pr_direccion = "pr_direccion";
    var var_pr_direccion = scAjaxGetFieldText(nomeCampo_pr_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_direccion(var_pr_direccion, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_direccion_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_direccion

  function do_ajax_form_del_proveedor_mob_validate_pr_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_direccion_cb

  // ---------- Validate pr_retencion_iva
  function do_ajax_form_del_proveedor_mob_validate_pr_retencion_iva()
  {
    var nomeCampo_pr_retencion_iva = "pr_retencion_iva";
    var var_pr_retencion_iva = scAjaxGetFieldSelect(nomeCampo_pr_retencion_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_proveedor_mob_validate_pr_retencion_iva(var_pr_retencion_iva, var_script_case_init, do_ajax_form_del_proveedor_mob_validate_pr_retencion_iva_cb);
  } // do_ajax_form_del_proveedor_mob_validate_pr_retencion_iva

  function do_ajax_form_del_proveedor_mob_validate_pr_retencion_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_validate_pr_retencion_iva_cb

  // ---------- Refresh pr_pais
  function do_ajax_form_del_proveedor_mob_refresh_pr_pais()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_del_proveedor_mob_refresh_pr_pais(var_pr_pais, var_pr_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_proveedor_mob_refresh_pr_pais_cb);
  } // do_ajax_form_del_proveedor_mob_refresh_pr_pais

  function do_ajax_form_del_proveedor_mob_refresh_pr_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_refresh_pr_pais_cb

  // ---------- Refresh pr_provincia
  function do_ajax_form_del_proveedor_mob_refresh_pr_provincia()
  {
    var var_pr_provincia = scAjaxGetFieldSelect("pr_provincia");
    var var_nmgp_refresh_fields = "pr_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_proveedor_mob_refresh_pr_provincia(var_pr_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_proveedor_mob_refresh_pr_provincia_cb);
  } // do_ajax_form_del_proveedor_mob_refresh_pr_provincia

  function do_ajax_form_del_proveedor_mob_refresh_pr_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_proveedor_mob_refresh_pr_provincia_cb

  // ---------- Event onblur pr_identificacion
  function do_ajax_form_del_proveedor_mob_event_pr_identificacion_onblur()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_proveedor_mob_event_pr_identificacion_onblur(var_pr_identificacion, var_pr_tipo_identificacion, var_pr_nombre, var_pr_direccion, var_pr_email, var_pr_telefono, var_pr_pais, var_pr_provincia, var_pr_ciudad, var_script_case_init, do_ajax_form_del_proveedor_mob_event_pr_identificacion_onblur_cb);
  } // do_ajax_form_del_proveedor_mob_event_pr_identificacion_onblur

  function do_ajax_form_del_proveedor_mob_event_pr_identificacion_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pr_identificacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_proveedor_mob_event_pr_identificacion_onblur_cb_after_alert);
  } // do_ajax_form_del_proveedor_mob_event_pr_identificacion_onblur_cb
  function do_ajax_form_del_proveedor_mob_event_pr_identificacion_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_proveedor_mob_event_pr_identificacion_onblur_cb_after_alert

  // ---------- Event onchange pr_tipo_identificacion
  function do_ajax_form_del_proveedor_mob_event_pr_tipo_identificacion_onchange()
  {
    var var_pr_tipo_identificacion = scAjaxGetFieldSelect("pr_tipo_identificacion");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_proveedor_mob_event_pr_tipo_identificacion_onchange(var_pr_tipo_identificacion, var_pr_tipo_persona, var_pr_identificacion, var_pr_nombre, var_pr_direccion, var_pr_email, var_pr_telefono, var_pr_pais, var_pr_provincia, var_pr_ciudad, var_script_case_init, do_ajax_form_del_proveedor_mob_event_pr_tipo_identificacion_onchange_cb);
  } // do_ajax_form_del_proveedor_mob_event_pr_tipo_identificacion_onchange

  function do_ajax_form_del_proveedor_mob_event_pr_tipo_identificacion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pr_tipo_identificacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_proveedor_mob_event_pr_tipo_identificacion_onchange_cb_after_alert);
  } // do_ajax_form_del_proveedor_mob_event_pr_tipo_identificacion_onchange_cb
  function do_ajax_form_del_proveedor_mob_event_pr_tipo_identificacion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_proveedor_mob_event_pr_tipo_identificacion_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_proveedor_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_proveedor_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_proveedor_mob_submit_form(var_pr_id, var_pr_empresa, var_pr_tipo_identificacion, var_pr_tipo_persona, var_pr_identificacion, var_pr_nombre, var_pr_parte_relacionada, var_pr_email, var_pr_telefono, var_pr_celular, var_pr_pais, var_pr_provincia, var_pr_ciudad, var_pr_direccion, var_pr_retencion_iva, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_proveedor_mob_submit_form_cb);
  } // do_ajax_form_del_proveedor_mob_submit_form

  function do_ajax_form_del_proveedor_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_proveedor_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_proveedor_mob_submit_form_cb
  function do_ajax_form_del_proveedor_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_proveedor_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_proveedor_mob_navigate_form()
  {
    perform_ajax_form_del_proveedor_mob_navigate_form();
  }

  function perform_ajax_form_del_proveedor_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_proveedor_mob_navigate_form(var_pr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_proveedor_mob_navigate_form_cb);
  } // do_ajax_form_del_proveedor_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_proveedor_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_proveedor_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_proveedor_mob_navigate_form_cb
  function do_ajax_form_del_proveedor_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_proveedor_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_proveedor_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_proveedor_mob_form()
  {
