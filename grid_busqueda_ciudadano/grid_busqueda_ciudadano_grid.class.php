<?php
class grid_busqueda_ciudadano_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'])
   { 
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_busqueda_ciudadano'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_bot();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['pesq_tab_label'] .= "ciu_identificacion?#?" . "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("ciu_identificacion");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_busqueda_ciudadano", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $this->Cmps_ord_def['ciu_identificacion'] = " asc";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campos_busca'];
       if ($_SESSION['scriptcase']['charset'] != "UTF-8")
       {
           $Busca_temp = NM_conv_charset($Busca_temp, $_SESSION['scriptcase']['charset'], "UTF-8");
       }
       $this->ciu_identificacion = (isset($Busca_temp['ciu_identificacion'])) ? $Busca_temp['ciu_identificacion'] : ""; 
       $tmp_pos = (is_string($this->ciu_identificacion)) ? strpos($this->ciu_identificacion, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ciu_identificacion))
       {
           $this->ciu_identificacion = substr($this->ciu_identificacion, 0, $tmp_pos);
       }
   } 
   $this->nm_field_dinamico = array();
   $this->nm_order_dinamico = array();
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] = "muda_qt_linhas";
   } 
   $this->New_label['ciu_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "";
   $this->New_label['ciu_nombre'] = "" . $this->Ini->Nm_lang['lang_nombre'] . "";
   $this->New_label['ciu_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion'] . "";
   $this->New_label['ciu_correo'] = "" . $this->Ini->Nm_lang['lang_email'] . "";
   $this->New_label['ciu_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . "";

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_busqueda_ciudadano'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_busqueda_ciudadano'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_busqueda_ciudadano_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_busqueda_ciudadano_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_orig'] = "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid'];
   }
//----- 
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
   { 
       $nmgp_select = "SELECT ciu_identificacion, ciu_nombre, ciu_direccion, ciu_correo, ciu_telefono from " . $this->Ini->nm_tabela; 
   } 
   ...
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       $this->ciu_identificacion = $this->rs_grid->fields[0] ;  
       $this->ciu_nombre = $this->rs_grid->fields[1] ;  
       $this->ciu_direccion = $this->rs_grid->fields[2] ;  
       $this->ciu_correo = $this->rs_grid->fields[3] ;  
       $this->ciu_telefono = $this->rs_grid->fields[4] ;  
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
           $this->pb = new scProgressBar();
           $this->pb->setRoot($this->Ini->root);
           $this->pb->setDir($_SESSION['scriptcase']['grid_busqueda_ciudadano']['glo_nm_path_imag_temp'] . "/");
           $this->pb->setProgressbarMd5($_GET['pbmd5']);
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_busqueda_ciudadano'] ?> :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_busqueda_ciudadano_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_busqueda_ciudadano_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_busqueda_ciudadano_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_busqueda_ciudadano_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_busqueda_ciudadano_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_busqueda_ciudadano'] . "</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_busqueda_ciudadano_jquery_2348.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_busqueda_ciudadano_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_busqueda_ciudadano_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida']) {  
...
$nm_saida->saida("    </style>\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_busqueda_ciudadano-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_busqueda_ciudadano-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_busqueda_ciudadano-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-52bc08a5\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_busqueda_ciudadano_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_busqueda_ciudadano_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_busqueda_ciudadano_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_busqueda_ciudadano_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_busqueda_ciudadano_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".grid_busqueda_ciudadano_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf" && !$this->Print_All)
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_busqueda_ciudadano']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_busqueda_ciudadano']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_busqueda_ciudadano']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_busqueda_ciudadano']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida']) ? "grid_busqueda_ciudadano_" : "";
   $this->css_sep = " ";
   $this->css_ciu_identificacion_label = $compl_css_emb . "css_ciu_identificacion_label";
   $this->css_ciu_identificacion_grid_line = $compl_css_emb . "css_ciu_identificacion_grid_line";
   $this->css_ciu_nombre_label = $compl_css_emb . "css_ciu_nombre_label";
   $this->css_ciu_nombre_grid_line = $compl_css_emb . "css_ciu_nombre_grid_line";
   $this->css_ciu_direccion_label = $compl_css_emb . "css_ciu_direccion_label";
   $this->css_ciu_direccion_grid_line = $compl_css_emb . "css_ciu_direccion_grid_line";
   $this->css_ciu_correo_label = $compl_css_emb . "css_ciu_correo_label";
   $this->css_ciu_correo_grid_line = $compl_css_emb . "css_ciu_correo_grid_line";
   $this->css_ciu_telefono_label = $compl_css_emb . "css_ciu_telefono_label";
   $this->css_ciu_telefono_grid_line = $compl_css_emb . "css_ciu_telefono_grid_line";
 }  
 function cabecalho()
 {
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['cond_pesq'], 0, $trab_pos);
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida("          " . $this->Ini->Nm_lang['lang_busqueda_ciudadano'] . "\r\n");
   $nm_saida->saida("        </TD>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_label'])
   { 
       $this->New_label['ciu_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "";
       $this->New_label['ciu_nombre'] = "" . $this->Ini->Nm_lang['lang_nombre'] . "";
       $this->New_label['ciu_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_busqueda_ciudadano__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_busqueda_ciudadano-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ciu_telefono_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ciu_telefono_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".grid_busqueda_ciudadano_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 }
 function NM_label_ciu_identificacion()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ciu_identificacion'])) ? $this->New_label['ciu_identificacion'] : "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
     $classColTitle = " sc-col-title";
   }
   if (!isset($this->NM_cmp_hidden['ciu_identificacion']) || $this->NM_cmp_hidden['ciu_identificacion'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_ciu_identificacion_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ciu_identificacion_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('ciu_identificacion');
        $fieldSortIcon = $this->scGetColumnOrderIcon('ciu_identificacion', $fieldSortRule);
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_ciu_identificacion_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
            ...
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_ciu_identificacion_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        ...
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('ciu_identificacion')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
 ...
 function NM_label_ciu_nombre()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ciu_nombre'])) ? $this->New_label['ciu_nombre'] : "" . $this->Ini->Nm_lang['lang_nombre'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['ciu_nombre']) || $this->NM_cmp_hidden['ciu_nombre'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_ciu_nombre_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ciu_nombre_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
 ...
 function NM_label_ciu_direccion()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ciu_direccion'])) ? $this->New_label['ciu_direccion'] : "" . $this->Ini->Nm_lang['lang_direccion'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['ciu_direccion']) || $this->NM_cmp_hidden['ciu_direccion'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_ciu_direccion_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ciu_direccion_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
 ...
 function NM_label_ciu_correo()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ciu_correo'])) ? $this->New_label['ciu_correo'] : "" . $this->Ini->Nm_lang['lang_email'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['ciu_correo']) || $this->NM_cmp_hidden['ciu_correo'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_ciu_correo_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ciu_correo_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
 ...
 function NM_label_ciu_telefono()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ciu_telefono'])) ? $this->New_label['ciu_telefono'] : "" . $this->Ini->Nm_lang['lang_lot_telefono'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['ciu_telefono']) || $this->NM_cmp_hidden['ciu_telefono'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_ciu_telefono_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ciu_telefono_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ini_cor_grid']);
       }
   }
   ...
   $this->sc_where_filtro  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['where_pesq_filtro'];
// 
   $SC_Label = (isset($this->New_label['ciu_identificacion'])) ? $this->New_label['ciu_identificacion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['labels']['ciu_identificacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ciu_nombre'])) ? $this->New_label['ciu_nombre'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['labels']['ciu_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ciu_direccion'])) ? $this->New_label['ciu_direccion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['labels']['ciu_direccion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ciu_correo'])) ? $this->New_label['ciu_correo'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['labels']['ciu_correo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ciu_telefono'])) ? $this->New_label['ciu_telefono'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['labels']['ciu_telefono'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_busqueda_ciudadano']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_busqueda_ciudadano#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_busqueda_ciudadano#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-52bc08a5\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['Page_break_PDF'] = array();
       }
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_busqueda_ciudadano_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->ciu_telefono = $this->rs_grid->fields[4] ;  
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['rows_emb']++;
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_ciu_telefono_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_ciu_telefono_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_ciu_identificacion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['ciu_identificacion']) || $this->NM_cmp_hidden['ciu_identificacion'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->ciu_identificacion));
              $conteudo_original = NM_encode_input(sc_strip_script($this->ciu_identificacion));
          }
          else {
              $conteudo = sc_strip_script($this->ciu_identificacion); 
              $conteudo_original = sc_strip_script($this->ciu_identificacion); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_ciu_identificacion_grid_line . "\"  style=\"" . $this->Css_Cmp['css_ciu_identificacion_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_ciu_identificacion_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_ciu_nombre()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['ciu_nombre']) || $this->NM_cmp_hidden['ciu_nombre'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->ciu_nombre));
              $conteudo_original = NM_encode_input(sc_strip_script($this->ciu_nombre));
          }
          else {
              $conteudo = sc_strip_script($this->ciu_nombre); 
              $conteudo_original = sc_strip_script($this->ciu_nombre); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_ciu_nombre_grid_line . "\"  style=\"" . $this->Css_Cmp['css_ciu_nombre_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_ciu_nombre_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_ciu_direccion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['ciu_direccion']) || $this->NM_cmp_hidden['ciu_direccion'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->ciu_direccion));
              $conteudo_original = NM_encode_input(sc_strip_script($this->ciu_direccion));
          }
          else {
              $conteudo = sc_strip_script($this->ciu_direccion); 
              $conteudo_original = sc_strip_script($this->ciu_direccion); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_ciu_direccion_grid_line . "\"  style=\"" . $this->Css_Cmp['css_ciu_direccion_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_ciu_direccion_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_ciu_correo()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['ciu_correo']) || $this->NM_cmp_hidden['ciu_correo'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->ciu_correo));
              $conteudo_original = NM_encode_input(sc_strip_script($this->ciu_correo));
          }
          else {
              $conteudo = sc_strip_script($this->ciu_correo); 
              $conteudo_original = sc_strip_script($this->ciu_correo); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_ciu_correo_grid_line . "\"  style=\"" . $this->Css_Cmp['css_ciu_correo_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_ciu_correo_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_ciu_telefono()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['ciu_telefono']) || $this->NM_cmp_hidden['ciu_telefono'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->ciu_telefono));
              $conteudo_original = NM_encode_input(sc_strip_script($this->ciu_telefono));
          }
          else {
              $conteudo = sc_strip_script($this->ciu_telefono); 
              $conteudo_original = sc_strip_script($this->ciu_telefono); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_ciu_telefono_grid_line . "\"  style=\"" . $this->Css_Cmp['css_ciu_telefono_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_ciu_telefono_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      $Tem_pdf_res = "n";
          ...
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid&nm_all_modules=grid&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_busqueda_ciudadano&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Gb_Free_cmp']))
          {
              $Tem_word_res = "n";
          }
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_busqueda_ciudadano&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid&nm_all_modules=grid&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['SC_Ind_Groupby'] != "sc_free_total")
        {
          ...
          if (is_file("grid_busqueda_ciudadano_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_busqueda_ciudadano_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
      ...
      $Tem_pdf_res = "n";
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid&nm_all_modules=grid&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_busqueda_ciudadano&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['xml'][] = "xml_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_busqueda_ciudadano/grid_busqueda_ciudadano_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "ciu_identificacion")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "ciu_identificacion";
                           $lin_obj = $this->grid_search_ciu_identificacion($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('ciu_identificacion');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq']) < 1)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_ciu_identificacion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_ciu_identificacion_" . $ind . "' style='display:none; z-index: 10'>";
       ...
       $lin_obj .= "       <select id='grid_search_ciu_identificacion_cond_" . $ind . "' name='cond_grid_search_ciu_identificacion_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       ...
       $lin_obj .= "       <span id=\"grid_ciu_identificacion_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $ciu_identificacion = $val_cmp;
       if ($ciu_identificacion != "")
       {
       $ciu_identificacion_look = (is_string($ciu_identificacion) ? substr($this->Db->qstr($ciu_identificacion), 1, -1) : $ciu_identificacion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct ciu_identificacion from " . $this->Ini->nm_tabela . " where #lowerI#ciu_identificacion#lowerF# = #lowerI#'$ciu_identificacion_look'#lowerF# order by ciu_identificacion"; 
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       if (isset($nmgp_def_dados[0][$ciu_identificacion]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$ciu_identificacion];
       }
       else
       {
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_ciu_identificacion_val_" . $ind . "' name='val_grid_search_ciu_identificacion_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=13 alt=\"{datatype: 'text', maxLength: 13, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}\" style='display: none'>";
       ...
       $lin_obj .= "     <select class='sc-ui-autocomp-ciu_identificacion " . $this->css_scAppDivToolbarInput . "' id='id_ac_grid_ciu_identificacion" . $ind . "' name='val_grid_search_ciu_identificacion_autocomp" . $ind . "'>";
       if ('' !=  $ciu_identificacion) {
           $lin_obj .= "     <option value='" . $ciu_identificacion . "'  selected>" . $sAutocompValue . "</option>";
       }
       $lin_obj .= "     </select>";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   function lookup_ajax_ciu_identificacion($ciu_identificacion)
   {
       $ciu_identificacion = substr($this->Db->qstr($ciu_identificacion), 1, -1);
       $this->NM_case_insensitive = true;
       $ciu_identificacion_look = (is_string($ciu_identificacion) ? substr($this->Db->qstr($ciu_identificacion), 1, -1) : $ciu_identificacion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct ciu_identificacion from " . $this->Ini->nm_tabela . " where  #lowerI#ciu_identificacion#lowerF# like #lowerI#'%" . $ciu_identificacion . "%'#lowerF# order by ciu_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_busqueda_ciudadano_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "debi_doc_electronicos/grid_busqueda_ciudadano";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("             {\r\n");
       $nm_saida->saida("                 tmp = Tab_obj_grid_search[i];\r\n");
       $nm_saida->saida("                 if (tmp == 'ciu_identificacion')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_ciu_identificacion = i;\r\n");
       $nm_saida->saida("                        $(\".sc-ui-autocomp-ciu_identificacion\").on(\"focus\", function() {\r\n");
       ...
       $nm_saida->saida("                            field: \"ciu_identificacion\",\r\n");
       ...
       $nm_saida->saida("                         $(\"#grid_search_ciu_identificacion_val_\" + x_ciu_identificacion).val(e.params.data.id);\r\n");
       $nm_saida->saida("                        });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("             }\r\n");
       $nm_saida->saida("         }\r\n");
       ...
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'ciu_identificacion')\r\n");
       $nm_saida->saida("                 {\r\n");
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_busqueda_ciudadano', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_busqueda_ciudadano\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_busqueda_ciudadano_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_busqueda_ciudadano_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_busqueda_ciudadano_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['grid_busqueda_ciudadano_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_busqueda_ciudadano@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_busqueda_ciudadano_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_busqueda_ciudadano_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_busqueda_ciudadano_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_busqueda_ciudadano']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_busqueda_ciudadano_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_busqueda_ciudadano']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_busqueda_ciudadano')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_busqueda_ciudadano', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
