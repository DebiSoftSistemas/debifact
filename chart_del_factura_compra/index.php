<?php
   include_once('chart_del_factura_compra_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_perfil']          = "igtech_conexion";
   $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class chart_del_factura_compra_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "chart_del_factura_compra"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['chart_del_factura_compra']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['chart_del_factura_compra']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['chart_del_factura_compra']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/chart_del_factura_compra';
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['chart_del_factura_compra']['actual_lang']) || $_SESSION['scriptcase']['chart_del_factura_compra']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['chart_del_factura_compra']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("chart_del_factura_compra_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["chart_del_factura_compra"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["chart_del_factura_compra"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['responsive_chart'] = array(
              'enabled' => true,
              'active'  => true,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['path_doc'] = $this->path_doc; 
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
         ...
         echo $str_message;
          if (!$_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "chart_del_factura_compra_erro.class.php"); 
      $this->Erro = new chart_del_factura_compra_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('chart_del_factura_compra'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['Gera_log_access'] = true;
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['initialize']      = false;
      } 
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_conexao']) && $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_perfil']) && $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['chart_del_factura_compra']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['chart_del_factura_compra']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_conexao'], $this->root . $this->path_prod, 'debi_doc_electronicos', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_sep_date1'];
           }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'chart_del_factura_compra', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'chart_del_factura_compra', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'chart_del_factura_compra', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['chart_del_factura_compra']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class chart_del_factura_compra_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['chart_del_factura_compra']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['chart_del_factura_compra'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class chart_del_factura_compra_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['chart_del_factura_compra']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['chart_del_factura_compra'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_chart_del_factura_compra($cadapar[1]);
                       nm_protect_num_chart_del_factura_compra($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
          ...
          if (isset($Igtech_RucEmpresa)) 
          {
              ...
              nm_limpa_str_chart_del_factura_compra($_SESSION["Igtech_RucEmpresa"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_ibase'])) 
      { 
          $this->Ini = new chart_del_factura_compra_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if (!isset($nmgp_opcao)) {
         $nmgp_opcao = "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'])) {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "";
      }
       if ($nmgp_opcao == "link_res")  
       { 
           $nmgp_opcao = "inicio";  
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "inicio";  
           $Temp_parms = "";  
           ...
           {
                $cadapar  = explode("?#?", $param);
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Ind_Groupby'] == "sc_free_group_by")
                { 
                    ...
                    elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_Free_orig'][$cadapar[0]]))
                    {
                        list ($Sql_orig, $Sql_order) = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_Free_sql'][$cadapar[0]];
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['chart_del_factura_compra']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['chart_del_factura_compra'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['chart_del_factura_compra']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['chart_del_factura_compra']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('chart_del_factura_compra') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['chart_del_factura_compra']['label'] = "Total de Compras";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "chart_del_factura_compra")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'])
      {
          $this->Change_Menu = false;
      }
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "chart_del_factura_compra/chart_del_factura_compra_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "chart_del_factura_compra_erro.class.php"); 
      } 
      $this->Erro      = new chart_del_factura_compra_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "chart_del_factura_compra/chart_del_factura_compra_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "chart_del_factura_compra_lookup.class.php"); 
      } 
      $this->Lookup       = new chart_del_factura_compra_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_chart_del_factura_compra_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['arr_total']);
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_prefix_date_format']['sc_free_group_by']['fc_fecha'] = "" . $this->Ini->Nm_lang['lang_othr_valueYYYYMM'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_date_format']['sc_free_group_by']['fc_fecha'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_date_format']['sc_free_group_by']['fc_fecha'] = 'YYYYMM';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_All_Groupby'] = array('sc_free_group_by' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if ($Tp == "grid")
              {
                  continue;
              }
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Ind_Groupby'] = $Ind;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_Free_cmp'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_Free_cmp']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_Free_sql']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_Free_orig'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_Free_cmp']['fc_fecha'] = "fc_fecha";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_Free_sql']['fc_fecha']["fc_fecha"] = 'asc';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          $Arr_free_labels = array();
          $Arr_free_labels['fc_fecha'] = "" . sprintf("" . $this->Ini->Nm_lang['lang_srch_mnth'] . "", "" . $this->Ini->Nm_lang['lang_fecha'] . "") . "";
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_Free_cmp'] as $Field => $Label)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['Labels_GB'][] = $Arr_free_labels[$Field];
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['summarizing_fields_display']['sc_free_group_by'][2]['display'] = true;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['summarizing_fields_control']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['summarizing_fields_control']['sc_free_group_by'] = array(
               array(
                   'cmp_res' => "fc_total",
                   'label' => "" .  $this->Ini->Nm_lang['lang_othr_chrt_totl'] . "",
                   'label_field' => "Fc Total",
                   'options' => array(
                       array('op' => 'S', 'index' => '2', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "", 'abbrev' => "Sum"),
                   ),
                   'select' => "<select class=\"sc-ui-select-fc_total\" onChange=\"scSummChange($(this))\"><option value=\"2\" class=\"sc-ui-select-option-S\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "</option></select>",
               ),
           );
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "chart_del_factura_compra_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "chart_del_factura_compra_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['SC_Ind_Groupby'] . ".class.php"; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['Gera_log_access'])
      {
          $this->Ini->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['Gera_log_access'] = false;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_chart_del_factura_compra_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_chart_del_factura_compra_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf')
      { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
          }
          else
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['graf_disp']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['graf_disp']        = array('Bar');
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_larg']        = '800';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['graf_exibe_val']    = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_barra_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cfg_graf']['graf_pyram_forma'] = 'S';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_treeview'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_opcao']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida_opcao'] = "";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_empresa";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_tipo_comprobante";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_proveedor";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_fecha";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_serie";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_secuencial";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_autorizacion";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_desde";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_hasta";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_fecha_caducidad";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_subtotal_iva";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_subtotal_cero";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_subtotal_no_objeto";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_subtotal_excento";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_subtotal";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_valor_ice";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_valor_iva";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_valor_irbpnr";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_total";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_comentario";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_usuario";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_aplica_ret";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_estado";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "liq_libretin";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "liq_estado_sri";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "liq_error_sri";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "liq_fecha_autorizacion";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "liq_clave";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_total_descuento";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_propina";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "liq_establecimiento";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "liq_punto_emision";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "liq_ambiente";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_aplica_propina";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'][] = "fc_retencion";
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_id'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_empresa'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_tipo_comprobante'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_proveedor'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_fecha'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_serie'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_secuencial'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_autorizacion'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_desde'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_hasta'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_fecha_caducidad'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_subtotal_iva'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_subtotal_cero'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_subtotal_no_objeto'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_subtotal_excento'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_subtotal'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_valor_ice'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_valor_iva'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_valor_irbpnr'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_total'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_comentario'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_usuario'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_aplica_ret'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_estado'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['liq_libretin'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['liq_estado_sri'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['liq_error_sri'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['liq_fecha_autorizacion'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['liq_clave'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_total_descuento'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_propina'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['liq_establecimiento'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['liq_punto_emision'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['liq_ambiente'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_aplica_propina'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel']['fc_retencion'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_del_factura_compra']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['chart_del_factura_compra']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['chart_del_factura_compra']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_del_factura_compra']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['chart_del_factura_compra']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] == "pdf")
      { 
          $this->Ini->path_img_modelo = $this->Ini->path_img_modelo;
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = 'inicio';
          } 
      } 
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_orig'] = " where fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fc_estado='V' AND year(fc_fecha)=year(getdate())";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['cond_pesq']         = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['campos_busca']      = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['grid_pesq']         = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['Grid_search']       = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['tot_geral']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['contr_array_resumo'] = "NAO";
      } 
      if (!in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'], array('config_print', 'word_res', 'xls_res', 'xml_res', 'json_res', 'csv_res', 'rtf_res', 'image_res', 'ajax_comb_table', 'ajax_comb_save', 'ajax_comb_file_view', 'ajax_comb_file_download'))) {
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_pesq_ant'];  
      }
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_chart_del_factura_compra_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_chart_del_factura_compra.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_chart_del_factura_compra_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_chart_del_factura_compra_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($this->NM_ajax_opcao == "ajax_comb_table")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_del_factura_compra/" . $this->Ini->Apl_resumo);
          }
          else 
          {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['comb_field_display_type'][ $_POST['sumcfg_field'] ] = $_POST['sumcfg_value'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['chart_display_values'][ $_POST['sumcfg_field'] ]    = 1 == $_POST['sumcfg_display'];
          echo 'ok';
          exit;
      }
      else
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['chart_combination_order_rule']   = 'asc' == $_POST['sort_option'] || 'desc' == $_POST['sort_option'] ? $_POST['sort_option'] : '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['chart_combination_order_field']  = $_POST['sort_field'];
          if ('orig' == $_POST['sort_option'])
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['chart_combination_order_forced'] = false;
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['chart_combination_order_forced'] = true;
          }
          echo 'ok';
          exit;
      }
      ...
      {
          if (!isset($_SESSION['scriptcase']['chart_export_file']['chart_del_factura_compra']) || !isset($_SESSION['scriptcase']['chart_export_file']['chart_del_factura_compra'][ $_REQUEST['chart_file_md5'] ]))
          {
              echo 'error_file_not_found';
          }
          else
          {
              echo $this->Ini->path_imag_temp . '/' . $_SESSION['scriptcase']['chart_export_file']['chart_del_factura_compra'][ $_REQUEST['chart_file_md5'] ]['name'];
          }
          exit;
      }
      else
      if ($nmgp_opcao == "ajax_comb_file_download")
      {
          ...
          {
              $filename = $_SESSION['scriptcase']['chart_export_file']['chart_del_factura_compra'][ $_REQUEST['chart_file_md5'] ]['name'];
              $path     = $_SESSION['scriptcase']['chart_export_file']['chart_del_factura_compra'][ $_REQUEST['chart_file_md5'] ]['dir'] . $filename;
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . chart_del_factura_compra . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new chart_del_factura_compra_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "chart_del_factura_compra_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "chart_del_factura_compra_mobile_pesq.class.php"); 
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['where_pesq'];  
          $this->pesq  = new chart_del_factura_compra_pesq();
      ...
      { 
          ...
          $this->Res = new chart_del_factura_compra_resumo();
...
<?php
      ...
      {
         $nm_saida->finaliza();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['ajax_nav'])
         {
             $Temp = ob_get_clean();
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['opcao'] != "ajax_detalhe")  
             {
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['contr_total_geral']  = '';
            // ----- PDF log
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pdf_file'] = $nm_arquivo_pdf_serv;
}
?>
...
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['label'] as $series_name)
        {
...
<?php
        $this->outputCombinationTableRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableData], 0, $tableDef);
?>
</table>
<?php
        exit;
...
<?php
            ...
            {
?>
  <td class="scGridFieldOdd scGridFieldOddFont" style="text-align: right"><?php echo chart_del_factura_compra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['summ'][$index], $value); ?></td>
<?php
            }
?>
 </tr>
<?php
	...
	function outputCombinationZipPassword($type, $fileName, $password) {
		$zipCommand  = "";
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imag_temp'] . '/';
	...
	function outputCombinationData() {
		if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['anlt_table_def']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['anlt_table_def'])) {
	...
	function outputCombinationExport($type, $content, $password) {
		...
		$fileName = "sc_{$type}_{$dateTime}_{$fileSeq}_chart_del_factura_compra.{$type}";
		...
		if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$testFilename . '_name'])) {
			$fileName = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$testFilename . '_name'];
		}
		...
		if (!isset($_SESSION['scriptcase']['chart_export_file']['chart_del_factura_compra'])) {
			$_SESSION['scriptcase']['chart_export_file']['chart_del_factura_compra'] = array();
		}
		$_SESSION['scriptcase']['chart_export_file']['chart_del_factura_compra'][$fileMd5] = array(
			'dir'  => $fileDir,
			'name' => $fileName
		);
		...
		switch ($type) {
			...
			case 'html':
				if ($this->Ini->sc_export_ajax) {
					$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['export_print_files'][] = $fileName;

					$this->outputCombinationEmail($this->Res->zipFileList($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['export_print_files']));
				}
				else {
...
SCEOT;
	...
	function outputCombinationPrintConfig() {
		...
		$hasOneGroupByLevel = 1 >= count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['Labels_GB']);
		$isMultiSeriesChart = !isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['summarizing_drill_down'];
...
SCEOT;
		...
		$lastGroupby = count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['Labels_GB']) - 1;
		foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['Labels_GB'] as $groupbyIndex => $groupbyLabel) {
...
SCEOT;
	...
	function outputCombinationPrintCss() {
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['chart_export_print_css'] = 'color';

		if ('bw' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['chart_export_print_css']) {
	...
	function outputCombinationPrintCharts() {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['export_print_bw'] = isset($_POST['export_chart_bw']) && 'Y' == $_POST['export_chart_bw'];

		$chartImages = $this->Res->generateChartImages();

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['export_print_bw'] = false;
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['export_print_files'] = $chartImages;
    ...
    {
        $jsonData = $this->outputCombinationJsonRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableData], 0, $tableDef);
...
/* mantis 0019720  */
            ...
            foreach ($data['values'] as $index => $value) {
                $thisMetric = array(
                    'field' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['field'][$index],
                    'value' => $this->outputCombinationJsonProtectNumber($value)
                );

                if ($this->jsonShowFormatted) {
                	$thisMetric['formatted'] = $this->outputCombinationJsonProtectNumber(chart_del_factura_compra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['summ'][$index], $value));
                }
                if ($this->jsonShowLabel) {
                	$thisMetric['label'] = $this->outputCombinationJsonProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['label'][$index]);
                }
	...
	function outputCombinationXmlContent($tableDef, $tableData) {
		return "<?xml version=\"1.0\" encoding=\"{$_SESSION['scriptcase']['charset']}\" ?>\r\n" .
		       "<chart_del_factura_compra>\r\n" .
		       $this->outputCombinationXmlRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableData], 0, $tableDef) .
		       "</chart_del_factura_compra>";
	...
	function outputCombinationXmlRow($rows, $level, $tableDef) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$aggregateLabelTag = $this->xmlLabel ? $this->outputCombinationXmlProtectTag($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['label'][$index]) : $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['field'][$index];

				if ($this->xmlDisplayAsAttributes) {
					$outputData .= "<aggregate_{$aggregateLabelTag} label=\"" . $this->outputCombinationXmlProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['label'][$index]) . "\" value=\"" . $this->outputCombinationXmlProtectNumber(chart_del_factura_compra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['summ'][$index], $value)) . "\" />\r\n";
				} else {
					$outputData .= "<aggregate_{$aggregateLabelTag}>\r\n";
					$outputData .= "<label>" . $this->outputCombinationXmlProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['label'][$index]) . "</label>\r\n";
					$outputData .= "<value>" . $this->outputCombinationXmlProtectNumber(chart_del_factura_compra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['summ'][$index], $value)) . "</value>\r\n";
					$outputData .= "</aggregate_{$aggregateLabelTag}>\r\n";
				}
			}
	...
	function outputCombinationCsvContent($tableDef, $tableData) {
        $hasChildren = $this->outputCombinationHasChildren($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableData]);

		if ($this->csvHeader) {
			return $this->outputCombinationCsvHeader($tableDef, $hasChildren) .
			       $this->outputCombinationCsvRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pivot_y_axys']), $hasChildren);
		} else {
			return $this->outputCombinationCsvRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pivot_y_axys']), $hasChildren);
		}
	...
	function outputCombinationCsvHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pivot_group_by'] as $groupByName) {
				$headers[] = $groupByName;
			}
		}
		else {
			$headers[] = current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pivot_group_by']);
		}

		foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['label'] as $summName) {
			$headers[] = $summName;
		}
	...
	function outputCombinationCsvRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$thisRow[] = $this->outputCombinationCsvProtectNumber(chart_del_factura_compra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['summ'][$index], $value));
			}
	...
	function outputCombinationRtfContent($tableDef, $tableData) {
		...
		return "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\r\n" .
		       ...
		       $this->outputCombinationRtfRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pivot_y_axys']), $hasChildren) .
			   "</table>\r\n" .
		       "</DOC>\r\n";
	...
	function outputCombinationRtfHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$headers .= "<td>" . current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pivot_group_by']) . "</td>\r\n";
		}
	...
	function outputCombinationRtfRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<td>" . $this->outputCombinationRtfProtectNumber(chart_del_factura_compra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['summ'][$index], $value)) . "</td>\r\n";
			}
	...
	function outputCombinationXlsContent($tableDef, $tableData) {
		...
		$this->outputCombinationXlsRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pivot_y_axys']), $hasChildren);
	...
	function outputCombinationXlsHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$this->addXlsCell(array(
				'col'     => $column++,
				'row'     => $this->thisRow,
				'content' => current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pivot_group_by']),
				'size'    => 'auto',
				'bold'    => true,
				'align'   => 'left'
			));
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$this->addXlsCell(array(
					'col'     => $column++,
					'row'     => $this->thisRow,
					'content' => $this->outputCombinationXlsProtectNumber(chart_del_factura_compra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['summ'][$index], $value)),
					'align'   => 'right'
				));
			}
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['chart_export_word_css'] = 'color';

        if (isset($_REQUEST['nmgp_cor_word'])) {
            if ('pb' == $_REQUEST['nmgp_cor_word']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['chart_export_word_css'] = 'bw';
	...
	function outputCombinationWordContent($tableDef, $tableData) {
		...
		return "<html xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:x=\"urn:schemas-microsoft-com:office:word\" xmlns=\"http://www.w3.org/TR/REC-html40\"{$_SESSION['scriptcase']['reg_conf']['html_dir']}>\r\n" .
		       ...
		       $this->outputCombinationWordRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pivot_y_axys']), $hasChildren) .
		       "</table>\r\n" .
		       "</body>\r\n" .
		       "</html>\r\n";
	...
	function outputCombinationWordCss() {
		if ('bw' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['chart_export_word_css']) {
			$cssFile    = "{$this->Ini->str_schema_all}_grid_bw.css";
			$cssDirFile = "{$this->Ini->str_schema_all}_grid_bw{$_SESSION['scriptcase']['reg_conf']['css_dir']}.css";
		}
		else {
	...
	function outputCombinationWordHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$headers .= "<td class=\"scGridLabelFont\">" . current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['pivot_group_by']) . "</td>\r\n";
		}
	...
	function outputCombinationWordRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<td class=\"scGridFieldOdd scGridFieldOddFont\">" . $this->outputCombinationWordProtectNumber(chart_del_factura_compra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$tableDef]['summ'][$index], $value)) . "</td>\r\n";
			}
...
SCEOT;
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imag_temp'] . "/");
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Total de Compras :: Doc</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
<form name="Fdown" method="get" action="chart_del_factura_compra_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="chart_del_factura_compra"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_factura_compra'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['chart_del_factura_compra']['sc_process_barr'])) {
       return;
   }
   ...
   $_SESSION['scriptcase']['chart_del_factura_compra']['contr_erro'] = 'off';
   $sc_conv_var = array();
   $Sc_lig_md5 = false;
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_chart_del_factura_compra($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_chart_del_factura_compra($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['chart_del_factura_compra']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "chart_del_factura_compra") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_debi_doc_electronicos'])) {
               $_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_debi_doc_electronicos'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['chart_del_factura_compra']['master_pai']) && $_SESSION['sc_session'][$init_filho]['chart_del_factura_compra']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['chart_del_factura_compra']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['chart_del_factura_compra']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['chart_del_factura_compra']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['chart_del_factura_compra']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['chart_del_factura_compra']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['chart_del_factura_compra']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['chart_del_factura_compra']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['chart_del_factura_compra']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['chart_del_factura_compra']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']);
               $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['b_sair'] = false;
           }   
       } 
   } 
   if (!isset($nmgp_opcao)) {
   ...
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida']) && $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['chart_del_factura_compra']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['chart_del_factura_compra']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['chart_del_factura_compra']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['chart_del_factura_compra']['protect_modal']) && !empty($_SESSION['scriptcase']['chart_del_factura_compra']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['chart_del_factura_compra']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "chart_del_factura_compra";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'chart_del_factura_compra' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/chart_del_factura_compra/'))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['contr_total_geral'] = "NAO";
   }
   ...
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['b_sair'] = true;
   }
   $STR_lang    = (isset($_SESSION['scriptcase']['str_lang']) && !empty($_SESSION['scriptcase']['str_lang'])) ? $_SESSION['scriptcase']['str_lang'] : "es";
   if (isset($_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Debifact/Debifact";
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'chart_del_factura_compra')
   {
       $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/chart_del_factura_compra_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opcao'] = $nmgp_opcao ;  
       }   
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['sc_modal'] = false;
       }
       if (isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['volta_redirect_tp'] = "";
           $nm_url_saida = "chart_del_factura_compra_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['sc_modal'] = true;
               }
               $nm_url_saida = "chart_del_factura_compra_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['mostra_edit'] = "N";   
           } 
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['chart_del_factura_compra'] = "on";
       } 
       if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['chart_del_factura_compra'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opc_psq'] && !isset($_SESSION['scriptcase']['chart_del_factura_compra']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['chart_del_factura_compra']) || $_SESSION['scriptcase']['sc_apl_seg']['chart_del_factura_compra'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("chart_del_factura_compra", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida']) && $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
...
<?php
       ...
       $contr_chart_del_factura_compra = new chart_del_factura_compra_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opcao'] = "busca";
          $contr_chart_del_factura_compra->NM_ajax_flag = true;
          $contr_chart_del_factura_compra->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opcao'] = "busca";
          $contr_chart_del_factura_compra->NM_ajax_flag = true;
          $contr_chart_del_factura_compra->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opcao'] = "busca";
          $contr_chart_del_factura_compra->NM_ajax_flag = true;
          $contr_chart_del_factura_compra->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opcao'] = "busca";
          $contr_chart_del_factura_compra->NM_ajax_flag = true;
          $contr_chart_del_factura_compra->NM_ajax_opcao = "ajax_filter_select";
      }
      if ('ajax_comb_table' == $nmgp_opcao)
      {
          $contr_chart_del_factura_compra->NM_ajax_flag = true;
          $contr_chart_del_factura_compra->NM_ajax_opcao = "ajax_comb_table";
      }
      if ('ajax_comb_save' == $nmgp_opcao)
      {
          $contr_chart_del_factura_compra->NM_ajax_flag = true;
          $contr_chart_del_factura_compra->NM_ajax_opcao = "ajax_comb_save";
      }
      if ('ajax_comb_sort' == $nmgp_opcao)
      {
          $contr_chart_del_factura_compra->NM_ajax_flag = true;
          $contr_chart_del_factura_compra->NM_ajax_opcao = "ajax_comb_sort";
      }
       $contr_chart_del_factura_compra->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_chart_del_factura_compra(&$str)
   {
   }
   function nm_protect_num_chart_del_factura_compra($name, &$val)
   {
       if (empty($val))
       {
          return;
       ...
       $Nm_numeric[] = "fc_total";
       $Nm_numeric[] = "liq_libretin";
       $Nm_numeric[] = "fc_total_descuento";
       $Nm_numeric[] = "fc_propina";
       $Nm_numeric[] = "liq_establecimiento";
       $Nm_numeric[] = "liq_punto_emision";
       $Nm_numeric[] = "liq_ambiente";
       $Nm_numeric[] = "fc_retencion";
   ...
   function chart_del_factura_compra_pack_protect_string($sString)
   {
    ...
    function chart_del_factura_compra_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
