...
class grid_v_del_promociones_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_v_del_promociones']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_v_del_promociones']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['contr_total_geral'] == "OK")
      {
          $this->array_total_pr_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['arr_total']['pr_nombre'];
      }
      else
      {
          $this->array_total_pr_nombre = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['arr_total']['pr_nombre'] = $this->array_total_pr_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['json_use_label'])
       {
          $Lab_pr_nombre = "pr_nombre";
       }
       else
       {
       $Lab_pr_nombre = "" . $this->Ini->Nm_lang['lang_tipo_libretin'] . "";
       }
       $this->comp_field = array(
           $Lab_pr_nombre,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['pr_imagen']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['pr_imagen'] = ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['pr_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['pr_descripcion'] = "" . $this->Ini->Nm_lang['lang_descripcion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['pr_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['pr_total'] = "" . $this->Ini->Nm_lang['lang_valor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['btn_agregar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['btn_agregar'] = ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['pr_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['pr_id'] = "Pr Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['pr_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['pr_nombre'] = "" . $this->Ini->Nm_lang['lang_tipo_libretin'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['var_libretin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['labels']['var_libretin'] = ""; 
       }
       //-----
       $this->comp_field_nm = array(
           'pr_nombre' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['summarizing_fields_order']['pr_nombre']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['summarizing_fields_order']['pr_nombre'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['summarizing_fields_order']['pr_nombre'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['summarizing_fields_display']['pr_nombre'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['summarizing_fields_display']['pr_nombre'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['summarizing_fields_display']['pr_nombre'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['summarizing_fields_display']['pr_nombre'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['summarizing_fields_display']['pr_nombre'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['summarizing_fields_display']['pr_nombre'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['summarizing_fields_display']['pr_nombre'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_pr_nombre as $i_pr_nombre => $d_pr_nombre) {
           if (!isset($i_pr_nombre, $this->comp_label[0]) || !in_array($i_pr_nombre, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_pr_nombre[2] ] = $d_pr_nombre[1];
               $this->comp_label[0][ $d_pr_nombre[2] ] = $d_pr_nombre[1];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'pr_nombre', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_pr_nombre => $l_pr_nombre) {
           if (isset($this->array_total_pr_nombre[$i_pr_nombre])) {
               $this->comp_group[$i_pr_nombre] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_pr_nombre;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_del_promociones@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_v_del_promociones_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_pr_nombre("res", $this->NM_export);
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_pr_nombre)) {
          ksort($this->array_total_pr_nombre);
      }
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " v_del_promociones</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['ajax_nav']) {  
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_promociones_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_v_del_promociones_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_promociones_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_del_promociones/grid_v_del_promociones_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_promociones/grid_v_del_promociones_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_del_promociones&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=N&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_promociones/grid_v_del_promociones_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_promociones/grid_v_del_promociones_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_promociones/grid_v_del_promociones_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_v_del_promociones_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_del_promociones']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_del_promociones']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_v_del_promociones_config_pivot.php?nome_apl=grid_v_del_promociones&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_v_del_promociones_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_v_del_promociones_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_v_del_promociones_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_promociones_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_v_del_promociones/grid_v_del_promociones_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_promociones']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $pr_id = (isset($Busca_temp['pr_id'])) ? $Busca_temp['pr_id'] : ""; 
          $tmp_pos = (is_string($pr_id)) ? strpos($pr_id, "##@@") : false;
          if ($tmp_pos !== false && !is_array($pr_id))
          {
              $pr_id = substr($pr_id, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($quebra_pr_nombre, $quebra_pr_nombre_orig)
   {
      //----- pr_nombre
      if (!isset($this->array_total_pr_nombre[$quebra_pr_nombre_orig]))
      {
         $this->array_total_pr_nombre[$quebra_pr_nombre_orig][0] = 1;
         $this->array_total_pr_nombre[$quebra_pr_nombre_orig][1] = $quebra_pr_nombre;
         $this->array_total_pr_nombre[$quebra_pr_nombre_orig][2] = $quebra_pr_nombre_orig;
      }
      else
      {
         $this->array_total_pr_nombre[$quebra_pr_nombre_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('pr_nombre', 'pr_nombre');
     $campos_order = $this->Ini->Get_date_order_groupby("pr_nombre", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->pr_imagen = $rs_res->fields[0] ;  
            $this->pr_descripcion = $rs_res->fields[1] ;  
            $this->pr_total = $rs_res->fields[2] ;  
            $this->pr_total =  str_replace(",", ".", $this->pr_total);
            $this->pr_nombre = $rs_res->fields[3] ;  
            $this->pr_id = $rs_res->fields[4] ;  
...
$_SESSION['scriptcase']['grid_v_del_promociones']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->pr_nombre, $this->pr_nombre_orig);
            }
   }
//
