...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "nc_fecha";$Nm_numeric[] = "nc_numero";$Nm_numeric[] = "nc_subtotal";$Nm_numeric[] = "nc_subtotal_iva";$Nm_numeric[] = "nc_valor_iva";$Nm_numeric[] = "nc_subtotal_cero";$Nm_numeric[] = "nc_subtotal_no_objeto";$Nm_numeric[] = "nc_subtotal_excento";$Nm_numeric[] = "nc_total_descuento";$Nm_numeric[] = "nc_valor_ice";$Nm_numeric[] = "nc_valor_irbpnr";$Nm_numeric[] = "nc_total";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nc_fecha_cond" name="nc_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_nc_fecha'), this, 'nc_fecha')">
      ...
      <br><span id="id_hide_nc_fecha"  <?php echo $str_hide_nc_fecha?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_nc_fecha"  <?php echo $str_display_nc_fecha; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nc_usuario"  <?php echo $str_hide_nc_usuario?>>
<?php
...
?>
   <span id="idAjaxSelect_nc_usuario">
      <SELECT class="scFilterObjectEven" id="SC_nc_usuario" name="nc_usuario[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
 ...
 function limpa_form()
 {
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'nc_usuario[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "nc_usuario" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
