...
class grid_resumen_nc_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_resumen_nc_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_resumen_nc_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_resumen_nc_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "v_del_datos_nota_credito_sri.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Notas de Crédito en Ventas</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_resumen_nc/grid_resumen_nc_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_resumen_nc_ajax_search.js"></script>
 <script type="text/javascript" src="grid_resumen_nc_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_resumen_nc_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_resumen_nc']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_resumen_nc']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_nc_usuario_cond#NMF#' + search_get_sel_txt('SC_nc_usuario_cond') + '@NMF@';
  str_out += 'SC_nc_usuario#NMF#' + search_get_Dselelect('SC_nc_usuario_dest') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $nc_fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_dia']; 
          $nc_fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_mes']; 
          $nc_fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_ano']; 
          $nc_fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_input_2_dia']; 
          $nc_fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_input_2_mes']; 
          $nc_fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_input_2_ano']; 
          $nc_fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_cond']; 
          $est_codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['est_codigo']; 
          $est_codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['est_codigo_cond']; 
          $pen_serie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['pen_serie']; 
          $pen_serie_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['pen_serie_cond']; 
          $cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['cl_identificacion']; 
          $cl_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['cl_identificacion_cond']; 
          $cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['cl_nombre']; 
          $cl_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['cl_nombre_cond']; 
          $nc_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_usuario']; 
          $nc_usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_usuario_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['NM_operador']; 
      } 
      if (!isset($nc_fecha_cond) || empty($nc_fecha_cond))
      {
         $nc_fecha_cond = "eq";
      }
      if (!isset($est_codigo_cond) || empty($est_codigo_cond))
      {
         $est_codigo_cond = "eq";
      }
      if (!isset($pen_serie_cond) || empty($pen_serie_cond))
      {
         $pen_serie_cond = "eq";
      }
      ...
      if (!isset($nc_usuario_cond) || empty($nc_usuario_cond))
      {
         $nc_usuario_cond = "eq";
      }
      ...
      $str_hide_nc_usuario = (in_array($nc_usuario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_nc_usuario = ('bw' == $nc_usuario_cond) ? $display_aberto : $display_fechado;
      ...
      // nc_usuario
      if (is_array($nc_usuario) && !empty($nc_usuario))
      {
         $tmp_array = array();
         $nc_usuario_val_str = "";
         foreach ($nc_usuario as $tmp_val_cmp)
         {
            if ("" != $nc_usuario_val_str)
            {
               $nc_usuario_val_str .= ",";
            }
            $tmp_pos = (is_string($tmp_val_cmp)) ? strpos($tmp_val_cmp, "##@@") : false;
            ...
            $nc_usuario_val_str .= "'$tmp_val_cmp'";
         }
         $nc_usuario = $tmp_array;
      }
      else
      {
         $nc_usuario_val_str = "''";
      ...
      if (!isset($nc_usuario) || $nc_usuario == "")
      {
          $nc_usuario = array();
      }
?>
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cl_nombre" id="id_ac_cl_nombre" name="cl_nombre_autocomp"><?php if ('' !=  $cl_nombre) { ?><option value="<?php echo $cl_nombre ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_nc_usuario_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nc_usuario'])) ? $this->New_label['nc_usuario'] : "" . $this->Ini->Nm_lang['lang_usuario'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_nc_usuario_cond" name="nc_usuario_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nc_usuario" <?php echo $str_hide_nc_usuario?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nc_usuario'])) ? $this->New_label['nc_usuario'] : "" . $this->Ini->Nm_lang['lang_usuario'] . "";
 $nmgp_tab_label .= "nc_usuario?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_nc_usuario_orig" name="nc_usuario_orig" size=7 multiple onDblClick="nm_add_sel('nc_usuario_orig', 'nc_usuario_dest', 'N' , '')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $nc_usuario_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('nc_usuario_orig', 'nc_usuario_dest', 'N', '');", "nm_add_all('nc_usuario_orig', 'nc_usuario_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('nc_usuario_orig', 'nc_usuario_dest', 'N', '');", "nm_add_sel('nc_usuario_orig', 'nc_usuario_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('nc_usuario_dest', 'nc_usuario_orig', 'N', '');", "nm_del_sel('nc_usuario_dest', 'nc_usuario_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('nc_usuario_dest', 'nc_usuario_orig', 'N', '');", "nm_del_all('nc_usuario_dest', 'nc_usuario_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectEven" id="SC_nc_usuario_dest" name="nc_usuario_dest" size=7 multiple  onDblClick="nm_del_sel('nc_usuario_dest', 'nc_usuario_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_nc_usuario" name="nc_usuario" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.nc_usuario_dest.selectedIndex = -1;</script>
<?php
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_resumen_nc_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function nm_submit_form()
 {
   ...
   nm_pack('nc_usuario_dest', 'nc_usuario');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   document.F1.est_codigo_cond.value = 'eq';
   ...
   document.F1.pen_serie_cond.value = 'eq';
   ...
   document.F1.nc_usuario_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_nc_usuario'), document.F1.nc_usuario_cond, 'nc_usuario');
   nm_del_all('nc_usuario_dest', 'nc_usuario_orig', 'N', '');
   Sc_carga_select2('all');
 }
 ...
 {
    $('#SC_nc_fecha_dia').bind('change', function() {sc_grid_resumen_nc_valida_dia(this)});
    $('#SC_nc_fecha_input_2_dia').bind('change', function() {sc_grid_resumen_nc_valida_dia(this)});
    $('#SC_nc_fecha_input_2_mes').bind('change', function() {sc_grid_resumen_nc_valida_mes(this)});
    $('#SC_nc_fecha_mes').bind('change', function() {sc_grid_resumen_nc_valida_mes(this)});
 }
 function sc_grid_resumen_nc_valida_dia(obj)
 {
 ...
 function sc_grid_resumen_nc_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_nc_usuario_cond'] = 'cond';
      $tp_fields['SC_nc_usuario'] = 'dselect';
   ...
   function trata_campos()
   {
      global $nc_fecha_cond, $nc_fecha, $nc_fecha_dia, $nc_fecha_mes, $nc_fecha_ano, $nc_fecha_input_2_dia, $nc_fecha_input_2_mes, $nc_fecha_input_2_ano,
             ...
             $cl_identificacion_cond, $cl_identificacion, $cl_identificacion_autocomp,
             $cl_nombre_cond, $cl_nombre, $cl_nombre_autocomp,
             $nc_usuario_cond, $nc_usuario, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca'] as $Cmps => $Vals)
          {
              if ($Cmps == 'est_codigo' || $Cmps == 'pen_serie' || $Cmps == 'nc_usuario')
              {
                  $$Cmps = implode("@?@", $Vals);
              }
              else
      ...
      $nc_usuario_cond_salva = $nc_usuario_cond; 
      if (!isset($nc_usuario_input_2) || $nc_usuario_input_2 == "")
      {
          $nc_usuario_input_2 = $nc_usuario;
      }
      if (is_array($est_codigo)) {
          foreach ($est_codigo as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['psq_check_ret']['est_codigo'])) {
      ...
      if (is_array($pen_serie)) {
          foreach ($pen_serie as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['psq_check_ret']['pen_serie'])) {
      ...
      if (is_array($nc_usuario)) {
          foreach ($nc_usuario as $I => $Val) {
              $tmp_pos = (is_string($Val)) ? strpos($Val, "##@@") : false;
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['psq_check_ret']['nc_usuario'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_dia'] = $nc_fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_mes'] = $nc_fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_ano'] = $nc_fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_input_2_dia'] = $nc_fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_input_2_mes'] = $nc_fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_input_2_ano'] = $nc_fecha_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $nc_fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $nc_fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $nc_fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $nc_fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $nc_fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $nc_fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_cond'] = $nc_fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['cmp'] = "nc_fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['opc'] = $nc_fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['nc_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['est_codigo'] = $est_codigo; 
      if (is_array($est_codigo) && !empty($est_codigo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0] = $est_codigo;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0][0] = $est_codigo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['est_codigo_cond'] = $est_codigo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['cmp'] = "est_codigo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['opc'] = $est_codigo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['est_codigo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['pen_serie'] = $pen_serie; 
      if (is_array($pen_serie) && !empty($pen_serie))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0] = $pen_serie;
      }
      elseif ($pen_serie_cond_salva == "nu" || $pen_serie_cond_salva == "nn" || $pen_serie_cond_salva == "ep" || $pen_serie_cond_salva == "ne" || !empty($pen_serie))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0][0] = $pen_serie;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['pen_serie_cond'] = $pen_serie_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['cmp'] = "pen_serie"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['opc'] = $pen_serie_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['pen_serie'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['cl_identificacion'] = $cl_identificacion; 
      if (is_array($cl_identificacion) && !empty($cl_identificacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0] = $cl_identificacion;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0][0] = $cl_identificacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['cl_identificacion_cond'] = $cl_identificacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['cmp'] = "cl_identificacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['opc'] = $cl_identificacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['cl_identificacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['cl_nombre'] = $cl_nombre; 
      if (is_array($cl_nombre) && !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0] = $cl_nombre;
      }
      elseif ($cl_nombre_cond_salva == "nu" || $cl_nombre_cond_salva == "nn" || $cl_nombre_cond_salva == "ep" || $cl_nombre_cond_salva == "ne" || !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0][0] = $cl_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['cl_nombre_cond'] = $cl_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['cmp'] = "cl_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['opc'] = $cl_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['cl_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_usuario'] = $nc_usuario; 
      if (is_array($nc_usuario) && !empty($nc_usuario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0] = $nc_usuario;
      }
      elseif ($nc_usuario_cond_salva == "nu" || $nc_usuario_cond_salva == "nn" || $nc_usuario_cond_salva == "ep" || $nc_usuario_cond_salva == "ne" || !empty($nc_usuario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['val'][0][0] = $nc_usuario;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_usuario_cond'] = $nc_usuario_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['cmp'] = "nc_usuario"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid]['opc'] = $nc_usuario_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['nc_usuario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['est_codigo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['est_codigo'];
      $this->cmp_formatado['est_codigo_input_2'] = $est_codigo_input_2;
      $this->cmp_formatado['pen_serie'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['pen_serie'];
    ...
    if ($cl_nombre != '') {
      ...
      $this->cmp_formatado['nc_usuario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_usuario'];
      $this->cmp_formatado['nc_usuario_input_2'] = $nc_usuario_input_2;
      ...
      if ($nc_fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha'] = $val[0];
          ...
          if ($nc_fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['nc_fecha_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['nc_fecha']['label'] = $nmgp_tab_label['nc_fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['nc_fecha']['descr'] = $nmgp_tab_label['nc_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['nc_fecha']['hint']  = $nmgp_tab_label['nc_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      if (is_array($est_codigo) && count($est_codigo) != 0)
      {
         ...
         if ($est_codigo_cond == "df" || $est_codigo_cond == "np")
         {
             ...
             $this->comando_sum    .= " #lowerI#v_del_datos_nota_credito_sri.est_codigo#lowerF# not in (";
             $this->comando_filtro .= " #lowerI#est_codigo#lowerF# not in (";
         }
         else
         {
             $this->comando        .= " #lowerI#est_codigo#lowerF# in (";
             $this->comando_sum    .= " #lowerI#v_del_datos_nota_credito_sri.est_codigo#lowerF# in (";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label['est_codigo'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['est_codigo']['label'] = $nmgp_tab_label['est_codigo'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['est_codigo']['descr'] = $nmgp_tab_label['est_codigo'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['est_codigo']['hint'] = $nmgp_tab_label['est_codigo'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      ...
      if (is_array($pen_serie) && count($pen_serie) != 0)
      {
         ...
         if ($pen_serie_cond == "df" || $pen_serie_cond == "np")
         {
             ...
             $this->comando_sum    .= " #lowerI#v_del_datos_nota_credito_sri.pen_serie#lowerF# not in (";
             $this->comando_filtro .= " #lowerI#pen_serie#lowerF# not in (";
         }
         else
         {
             $this->comando        .= " #lowerI#pen_serie#lowerF# in (";
             $this->comando_sum    .= " #lowerI#v_del_datos_nota_credito_sri.pen_serie#lowerF# in (";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label['pen_serie'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['pen_serie']['label'] = $nmgp_tab_label['pen_serie'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['pen_serie']['descr'] = $nmgp_tab_label['pen_serie'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['pen_serie']['hint'] = $nmgp_tab_label['pen_serie'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      ...
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($nc_usuario_cond == "nu" || $nc_usuario_cond == "nn" || $nc_usuario_cond == "ep" || $nc_usuario_cond == "ne")
      {
          $nc_usuario = array();
      }
      if (is_array($nc_usuario) && count($nc_usuario) != 0)
      {
         foreach ($nc_usuario as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
      ...
      if (is_array($nc_usuario) && count($nc_usuario) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($nc_usuario_cond == "df" || $nc_usuario_cond == "np")
         {
             $this->comando        .= " #lowerI#nc_usuario#lowerF# not in (";
             $this->comando_sum    .= " #lowerI#v_del_datos_nota_credito_sri.nc_usuario#lowerF# not in (";
             $this->comando_filtro .= " #lowerI#nc_usuario#lowerF# not in (";
         }
         else
         {
             $this->comando        .= " #lowerI#nc_usuario#lowerF# in (";
             $this->comando_sum    .= " #lowerI#v_del_datos_nota_credito_sri.nc_usuario#lowerF# in (";
             $this->comando_filtro .= " #lowerI#nc_usuario#lowerF# in (";
         }
         $x                     = count($nc_usuario);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($nc_usuario as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($nc_usuario) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr['df'] = $this->Ini->Nm_lang['lang_srch_diff'];
         $Lang_descr['np'] = $this->Ini->Nm_lang['lang_srch_not_like'];
         $Lang_descr_final = isset($Lang_descr[$nc_usuario_cond]) ? $Lang_descr[$nc_usuario_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $nmgp_tab_label['nc_usuario'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['nc_usuario']['label'] = $nmgp_tab_label['nc_usuario'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['nc_usuario']['descr'] = $nmgp_tab_label['nc_usuario'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']['nc_usuario']['hint'] = $nmgp_tab_label['nc_usuario'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($nc_usuario) && ($nc_usuario_cond == "nu" || $nc_usuario_cond == "nn" || $nc_usuario_cond == "ep" || $nc_usuario_cond == "ne"))
      {
         $this->monta_condicao("nc_usuario", $nc_usuario_cond, "", "", "nc_usuario", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'] .= $this->NM_operador;
