...
class grid_resumen_nc_grid
{
   ...
   var $count_ger;
   var $sum_nc_subtotal;
   var $sum_nc_total_descuento;
   var $sum_nc_valor_iva;
   var $sum_nc_total;
   var $sum_nc_subtotal_iva;
   var $sum_nc_subtotal_cero;
   var $sum_nc_subtotal_no_objeto;
   var $sum_nc_subtotal_excento;
   var $sum_nc_valor_ice;
   var $sum_nc_valor_irbpnr;
   var $nc_fecha_Old;
   var $arg_sum_nc_fecha;
   var $Label_nc_fecha;
   var $sc_proc_quebra_nc_fecha;
   var $count_nc_fecha;
   var $sum_nc_fecha_nc_subtotal;
   var $sum_nc_fecha_nc_total_descuento;
   var $sum_nc_fecha_nc_valor_iva;
   var $sum_nc_fecha_nc_total;
   var $sum_nc_fecha_nc_subtotal_iva;
   var $sum_nc_fecha_nc_subtotal_cero;
   var $sum_nc_fecha_nc_subtotal_no_objeto;
   var $sum_nc_fecha_nc_subtotal_excento;
   var $sum_nc_fecha_nc_valor_ice;
   var $sum_nc_fecha_nc_valor_irbpnr;
   var $est_codigo_Old;
   var $arg_sum_est_codigo;
   var $Label_est_codigo;
   var $sc_proc_quebra_est_codigo;
   var $count_est_codigo;
   var $sum_est_codigo_nc_subtotal;
   var $sum_est_codigo_nc_total_descuento;
   var $sum_est_codigo_nc_valor_iva;
   var $sum_est_codigo_nc_total;
   var $sum_est_codigo_nc_subtotal_iva;
   var $sum_est_codigo_nc_subtotal_cero;
   var $sum_est_codigo_nc_subtotal_no_objeto;
   var $sum_est_codigo_nc_subtotal_excento;
   var $sum_est_codigo_nc_valor_ice;
   var $sum_est_codigo_nc_valor_irbpnr;
   var $pen_serie_Old;
   var $arg_sum_pen_serie;
   var $Label_pen_serie;
   var $sc_proc_quebra_pen_serie;
   var $count_pen_serie;
   var $sum_pen_serie_nc_subtotal;
   var $sum_pen_serie_nc_total_descuento;
   var $sum_pen_serie_nc_valor_iva;
   var $sum_pen_serie_nc_total;
   var $sum_pen_serie_nc_subtotal_iva;
   var $sum_pen_serie_nc_subtotal_cero;
   var $sum_pen_serie_nc_subtotal_no_objeto;
   var $sum_pen_serie_nc_subtotal_excento;
   var $sum_pen_serie_nc_valor_ice;
   var $sum_pen_serie_nc_valor_irbpnr;
   ...
   var $sum_cl_identificacion_nc_subtotal;
   var $sum_cl_identificacion_nc_total_descuento;
   var $sum_cl_identificacion_nc_valor_iva;
   var $sum_cl_identificacion_nc_total;
   var $sum_cl_identificacion_nc_subtotal_iva;
   var $sum_cl_identificacion_nc_subtotal_cero;
   var $sum_cl_identificacion_nc_subtotal_no_objeto;
   var $sum_cl_identificacion_nc_subtotal_excento;
   var $sum_cl_identificacion_nc_valor_ice;
   var $sum_cl_identificacion_nc_valor_irbpnr;
   var $cl_nombre_Old;
   var $arg_sum_cl_nombre;
   var $Label_cl_nombre;
   var $sc_proc_quebra_cl_nombre;
   var $count_cl_nombre;
   var $sum_cl_nombre_nc_subtotal;
   var $sum_cl_nombre_nc_total_descuento;
   var $sum_cl_nombre_nc_valor_iva;
   var $sum_cl_nombre_nc_total;
   var $sum_cl_nombre_nc_subtotal_iva;
   var $sum_cl_nombre_nc_subtotal_cero;
   var $sum_cl_nombre_nc_subtotal_no_objeto;
   var $sum_cl_nombre_nc_subtotal_excento;
   var $sum_cl_nombre_nc_valor_ice;
   var $sum_cl_nombre_nc_valor_irbpnr;
   var $nc_secuencial_docmod_Old;
   var $arg_sum_nc_secuencial_docmod;
   var $Label_nc_secuencial_docmod;
   var $sc_proc_quebra_nc_secuencial_docmod;
   var $count_nc_secuencial_docmod;
   var $sum_nc_secuencial_docmod_nc_subtotal;
   var $sum_nc_secuencial_docmod_nc_total_descuento;
   var $sum_nc_secuencial_docmod_nc_valor_iva;
   var $sum_nc_secuencial_docmod_nc_total;
   var $sum_nc_secuencial_docmod_nc_subtotal_iva;
   var $sum_nc_secuencial_docmod_nc_subtotal_cero;
   var $sum_nc_secuencial_docmod_nc_subtotal_no_objeto;
   var $sum_nc_secuencial_docmod_nc_subtotal_excento;
   var $sum_nc_secuencial_docmod_nc_valor_ice;
   var $sum_nc_secuencial_docmod_nc_valor_irbpnr;
   var $nc_usuario_Old;
   var $arg_sum_nc_usuario;
   var $Label_nc_usuario;
   var $sc_proc_quebra_nc_usuario;
   var $count_nc_usuario;
   var $sum_nc_usuario_nc_subtotal;
   var $sum_nc_usuario_nc_total_descuento;
   var $sum_nc_usuario_nc_valor_iva;
   var $sum_nc_usuario_nc_total;
   var $sum_nc_usuario_nc_subtotal_iva;
   var $sum_nc_usuario_nc_subtotal_cero;
   var $sum_nc_usuario_nc_subtotal_no_objeto;
   var $sum_nc_usuario_nc_subtotal_excento;
   var $sum_nc_usuario_nc_valor_ice;
   var $sum_nc_usuario_nc_valor_irbpnr;
   var $nc_usuario;
   var $nc_numero;
   var $nc_fecha;
   var $est_codigo;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'])
   { 
   ...
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "grid_resumen_nc/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new grid_resumen_nc_resumo();
       $this->Res->Db     = $this->Db;
       $this->Res->Erro   = $this->Erro;
       $this->Res->Ini    = $this->Ini;
       $this->Res->Lookup = $this->Lookup;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pdf_res'])
       {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_resumen_nc'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf")
       { 
           if (isset($_GET['flash_graf']) && 'chart' == $_GET['flash_graf'])
           {
               $this->Res->monta_resumo(true);
               require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
               $this->Graf  = new grid_resumen_nc_grafico();
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_resumen_nc/grid_resumen_nc_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pesq_tab_label'] .= "nc_fecha?#?" . "" . $this->Ini->Nm_lang['lang_fecha'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pesq_tab_label'] .= "est_codigo?#?" . "" . $this->Ini->Nm_lang['lang_establecimiento'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pesq_tab_label'] .= "pen_serie?#?" . "" . $this->Ini->Nm_lang['lang_punto_emision'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pesq_tab_label'] .= "cl_identificacion?#?" . "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pesq_tab_label'] .= "cl_nombre?#?" . "" . $this->Ini->Nm_lang['lang_cliente'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pesq_tab_label'] .= "nc_usuario?#?" . "" . $this->Ini->Nm_lang['lang_usuario'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("cl_identificacion","cl_nombre");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']) > 1)
   {
       $this->width_tabula_quebra  = (((count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']) - 1) * 13) + 3) . "px";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['mostra_edit'] = "N";
   }
   ...
   $this->sc_proc_quebra_nc_secuencial_docmod = false;
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_resumen_nc", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_ant'];  
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] = "muda_qt_linhas";
   } 
   ...
   $this->New_label['nc_subtotal'] = "" . $this->Ini->Nm_lang['lang_subtotal'] . "";
   $this->New_label['nc_total_descuento'] = "" . $this->Ini->Nm_lang['lang_descuento'] . "";
   $this->New_label['nc_valor_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . "";
   ...
   $this->New_label['nc_subtotal_iva'] = "" . $this->Ini->Nm_lang['lang_subtotal_iva'] . "";
   $this->New_label['nc_subtotal_cero'] = "" . $this->Ini->Nm_lang['lang_subtotal_cero'] . "";
   $this->New_label['nc_subtotal_no_objeto'] = "" . $this->Ini->Nm_lang['lang_subtotal_no_objeto'] . "";
   $this->New_label['nc_subtotal_excento'] = "" . $this->Ini->Nm_lang['lang_subtotal_exento'] . "";
   $this->New_label['nc_valor_ice'] = "" . $this->Ini->Nm_lang['lang_ice'] . "";
   $this->New_label['nc_valor_irbpnr'] = "" . $this->Ini->Nm_lang['lang_irbpnr'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_resumen_nc'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_resumen_nc'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_resumen_nc/grid_resumen_nc_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_resumen_nc_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_resumen_nc_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_lin_grid'] = 50;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_select']['nc_fecha'] = 'desc'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_quebra'] = array(); 
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_sql'] as $cmp_var => $resto)
           {
               foreach ($resto as $SC_Sql_col => $SC_Sql_order)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_quebra'][$cmp_var][$SC_Sql_col] = $SC_Sql_order;
               }
           }
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_orig'] = " where (nc_estado='V' and nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   $this->sum_nc_subtotal = 0;
   $this->sum_nc_total_descuento = 0;
   $this->sum_nc_valor_iva = 0;
   $this->sum_nc_total = 0;
   $this->sum_nc_subtotal_iva = 0;
   $this->sum_nc_subtotal_cero = 0;
   $this->sum_nc_subtotal_no_objeto = 0;
   $this->sum_nc_subtotal_excento = 0;
   $this->sum_nc_valor_ice = 0;
   $this->sum_nc_valor_irbpnr = 0;
   $this->arg_sum_nc_fecha = "";
   $this->count_nc_fecha = 0;
   $this->sum_nc_fecha_nc_subtotal = 0;
   $this->sum_nc_fecha_nc_total_descuento = 0;
   $this->sum_nc_fecha_nc_valor_iva = 0;
   $this->sum_nc_fecha_nc_total = 0;
   $this->sum_nc_fecha_nc_subtotal_iva = 0;
   $this->sum_nc_fecha_nc_subtotal_cero = 0;
   $this->sum_nc_fecha_nc_subtotal_no_objeto = 0;
   $this->sum_nc_fecha_nc_subtotal_excento = 0;
   $this->sum_nc_fecha_nc_valor_ice = 0;
   $this->sum_nc_fecha_nc_valor_irbpnr = 0;
   $this->arg_sum_est_codigo = "";
   $this->count_est_codigo = 0;
   $this->sum_est_codigo_nc_subtotal = 0;
   $this->sum_est_codigo_nc_total_descuento = 0;
   $this->sum_est_codigo_nc_valor_iva = 0;
   $this->sum_est_codigo_nc_total = 0;
   $this->sum_est_codigo_nc_subtotal_iva = 0;
   $this->sum_est_codigo_nc_subtotal_cero = 0;
   $this->sum_est_codigo_nc_subtotal_no_objeto = 0;
   $this->sum_est_codigo_nc_subtotal_excento = 0;
   $this->sum_est_codigo_nc_valor_ice = 0;
   $this->sum_est_codigo_nc_valor_irbpnr = 0;
   $this->arg_sum_pen_serie = "";
   $this->count_pen_serie = 0;
   $this->sum_pen_serie_nc_subtotal = 0;
   $this->sum_pen_serie_nc_total_descuento = 0;
   $this->sum_pen_serie_nc_valor_iva = 0;
   $this->sum_pen_serie_nc_total = 0;
   $this->sum_pen_serie_nc_subtotal_iva = 0;
   $this->sum_pen_serie_nc_subtotal_cero = 0;
   $this->sum_pen_serie_nc_subtotal_no_objeto = 0;
   $this->sum_pen_serie_nc_subtotal_excento = 0;
   $this->sum_pen_serie_nc_valor_ice = 0;
   $this->sum_pen_serie_nc_valor_irbpnr = 0;
   $this->arg_sum_cl_identificacion = "";
   $this->count_cl_identificacion = 0;
   $this->sum_cl_identificacion_nc_subtotal = 0;
   $this->sum_cl_identificacion_nc_total_descuento = 0;
   $this->sum_cl_identificacion_nc_valor_iva = 0;
   $this->sum_cl_identificacion_nc_total = 0;
   $this->sum_cl_identificacion_nc_subtotal_iva = 0;
   $this->sum_cl_identificacion_nc_subtotal_cero = 0;
   $this->sum_cl_identificacion_nc_subtotal_no_objeto = 0;
   $this->sum_cl_identificacion_nc_subtotal_excento = 0;
   $this->sum_cl_identificacion_nc_valor_ice = 0;
   $this->sum_cl_identificacion_nc_valor_irbpnr = 0;
   $this->arg_sum_cl_nombre = "";
   $this->count_cl_nombre = 0;
   $this->sum_cl_nombre_nc_subtotal = 0;
   $this->sum_cl_nombre_nc_total_descuento = 0;
   $this->sum_cl_nombre_nc_valor_iva = 0;
   $this->sum_cl_nombre_nc_total = 0;
   $this->sum_cl_nombre_nc_subtotal_iva = 0;
   $this->sum_cl_nombre_nc_subtotal_cero = 0;
   $this->sum_cl_nombre_nc_subtotal_no_objeto = 0;
   $this->sum_cl_nombre_nc_subtotal_excento = 0;
   $this->sum_cl_nombre_nc_valor_ice = 0;
   $this->sum_cl_nombre_nc_valor_irbpnr = 0;
   $this->arg_sum_nc_secuencial_docmod = "";
   $this->count_nc_secuencial_docmod = 0;
   $this->sum_nc_secuencial_docmod_nc_subtotal = 0;
   $this->sum_nc_secuencial_docmod_nc_total_descuento = 0;
   $this->sum_nc_secuencial_docmod_nc_valor_iva = 0;
   $this->sum_nc_secuencial_docmod_nc_total = 0;
   $this->sum_nc_secuencial_docmod_nc_subtotal_iva = 0;
   $this->sum_nc_secuencial_docmod_nc_subtotal_cero = 0;
   $this->sum_nc_secuencial_docmod_nc_subtotal_no_objeto = 0;
   $this->sum_nc_secuencial_docmod_nc_subtotal_excento = 0;
   $this->sum_nc_secuencial_docmod_nc_valor_ice = 0;
   $this->sum_nc_secuencial_docmod_nc_valor_irbpnr = 0;
   $this->arg_sum_nc_usuario = "";
   $this->count_nc_usuario = 0;
   $this->sum_nc_usuario_nc_subtotal = 0;
   $this->sum_nc_usuario_nc_total_descuento = 0;
   $this->sum_nc_usuario_nc_valor_iva = 0;
   $this->sum_nc_usuario_nc_total = 0;
   $this->sum_nc_usuario_nc_subtotal_iva = 0;
   $this->sum_nc_usuario_nc_subtotal_cero = 0;
   $this->sum_nc_usuario_nc_subtotal_no_objeto = 0;
   $this->sum_nc_usuario_nc_subtotal_excento = 0;
   $this->sum_nc_usuario_nc_valor_ice = 0;
   $this->sum_nc_usuario_nc_valor_irbpnr = 0;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['contr_array_resumo']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['contr_array_resumo'] = "NAO";
       } 
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][1];
   ...
   { 
       ...
       $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq']; 
       if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq'])) 
       { 
           $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_resumo']; 
       } 
       else
       { 
           $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_resumo'] . ")"; 
       } 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid'];
   }
//----- 
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
   { 
       $nmgp_select = "SELECT nc_numero, str_replace (convert(char(10),nc_fecha,102), '.', '-') + ' ' + convert(char(8),nc_fecha,20), est_codigo, pen_serie, nc_secuencial, cl_nombre, cl_identificacion, nc_secuencial_docmod, nc_subtotal, nc_total_descuento, nc_valor_iva, nc_total, nc_estado_sri, cl_direccion, cl_telefono, cl_email, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_valor_ice, nc_valor_irbpnr, nc_motivo, nc_usuario from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT nc_numero, nc_fecha, est_codigo, pen_serie, nc_secuencial, cl_nombre, cl_identificacion, nc_secuencial_docmod, nc_subtotal, nc_total_descuento, nc_valor_iva, nc_total, nc_estado_sri, cl_direccion, cl_telefono, cl_email, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_valor_ice, nc_valor_irbpnr, nc_motivo, nc_usuario from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT nc_numero, convert(char(23),nc_fecha,121), est_codigo, pen_serie, nc_secuencial, cl_nombre, cl_identificacion, nc_secuencial_docmod, nc_subtotal, nc_total_descuento, nc_valor_iva, nc_total, nc_estado_sri, cl_direccion, cl_telefono, cl_email, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_valor_ice, nc_valor_irbpnr, nc_motivo, nc_usuario from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT nc_numero, EXTEND(nc_fecha, YEAR TO DAY), est_codigo, pen_serie, nc_secuencial, cl_nombre, cl_identificacion, nc_secuencial_docmod, nc_subtotal, nc_total_descuento, nc_valor_iva, nc_total, nc_estado_sri, cl_direccion, cl_telefono, cl_email, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_valor_ice, nc_valor_irbpnr, nc_motivo, nc_usuario from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT nc_numero, nc_fecha, est_codigo, pen_serie, nc_secuencial, cl_nombre, cl_identificacion, nc_secuencial_docmod, nc_subtotal, nc_total_descuento, nc_valor_iva, nc_total, nc_estado_sri, cl_direccion, cl_telefono, cl_email, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_valor_ice, nc_valor_irbpnr, nc_motivo, nc_usuario from " . $this->Ini->nm_tabela; 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       $this->nc_numero = $this->rs_grid->fields[0] ;  
       $this->nc_numero = (string)$this->nc_numero;
       $this->nc_fecha = $this->rs_grid->fields[1] ;  
       $this->est_codigo = $this->rs_grid->fields[2] ;  
       $this->pen_serie = $this->rs_grid->fields[3] ;  
       $this->nc_secuencial = $this->rs_grid->fields[4] ;  
       $this->cl_nombre = $this->rs_grid->fields[5] ;  
       $this->cl_identificacion = $this->rs_grid->fields[6] ;  
       $this->nc_secuencial_docmod = $this->rs_grid->fields[7] ;  
       $this->nc_subtotal = $this->rs_grid->fields[8] ;  
       $this->nc_subtotal = (string)$this->nc_subtotal;
       $this->nc_total_descuento = $this->rs_grid->fields[9] ;  
       $this->nc_total_descuento = (string)$this->nc_total_descuento;
       $this->nc_valor_iva = $this->rs_grid->fields[10] ;  
       $this->nc_valor_iva = (string)$this->nc_valor_iva;
       $this->nc_total = $this->rs_grid->fields[11] ;  
       $this->nc_total = (string)$this->nc_total;
       $this->nc_estado_sri = $this->rs_grid->fields[12] ;  
       $this->cl_direccion = $this->rs_grid->fields[13] ;  
       $this->cl_telefono = $this->rs_grid->fields[14] ;  
       $this->cl_email = $this->rs_grid->fields[15] ;  
       $this->nc_subtotal_iva = $this->rs_grid->fields[16] ;  
       $this->nc_subtotal_iva = (string)$this->nc_subtotal_iva;
       $this->nc_subtotal_cero = $this->rs_grid->fields[17] ;  
       $this->nc_subtotal_cero = (string)$this->nc_subtotal_cero;
       $this->nc_subtotal_no_objeto = $this->rs_grid->fields[18] ;  
       $this->nc_subtotal_no_objeto = (string)$this->nc_subtotal_no_objeto;
       $this->nc_subtotal_excento = $this->rs_grid->fields[19] ;  
       $this->nc_subtotal_excento = (string)$this->nc_subtotal_excento;
       $this->nc_valor_ice = $this->rs_grid->fields[20] ;  
       $this->nc_valor_ice = (string)$this->nc_valor_ice;
       $this->nc_valor_irbpnr = $this->rs_grid->fields[21] ;  
       $this->nc_valor_irbpnr = (string)$this->nc_valor_irbpnr;
       $this->nc_motivo = $this->rs_grid->fields[22] ;  
       $this->nc_usuario = $this->rs_grid->fields[23] ;  
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_orig']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_orig'] as $Cmp_clone => $Cmp_orig)
           {
       ...
       if (!isset($this->nc_secuencial_docmod)) { $this->nc_secuencial_docmod = ""; }
       if (!isset($this->nc_usuario)) { $this->nc_usuario = ""; }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'] == "sc_free_group_by")
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
           {
               $Cmp_orig = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
       ...
       $this->arg_sum_nc_secuencial_docmod = " = " . $this->Db->qstr($this->nc_secuencial_docmod);
       $this->arg_sum_nc_usuario = " = " . $this->Db->qstr($this->nc_usuario);
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'] == "sc_free_group_by") 
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp'] as $cmp => $sql)
           {
               $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_orig'][$cmp] : $cmp;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
           $this->pb = new scProgressBar();
           $this->pb->setRoot($this->Ini->root);
           $this->pb->setDir($_SESSION['scriptcase']['grid_resumen_nc']['glo_nm_path_imag_temp'] . "/");
           $this->pb->setProgressbarMd5($_GET['pbmd5']);
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE>Notas de Crédito en Ventas :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_resumen_nc_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_resumen_nc_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_resumen_nc_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_resumen_nc_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_resumen_nc_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>Notas de Crédito en Ventas</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_resumen_nc_jquery_2093.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_resumen_nc_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_resumen_nc_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida']) {  
...
$nm_saida->saida("    </style>\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_resumen_nc-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_resumen_nc-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_resumen_nc-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-f5977687\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_nc_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_nc_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_resumen_nc_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_resumen_nc/grid_resumen_nc_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_resumen_nc_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_resumen_nc_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".grid_resumen_nc_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->Print_All)
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_resumen_nc']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_resumen_nc']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_resumen_nc']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_resumen_nc']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida']) ? "grid_resumen_nc_" : "";
   $this->css_sep = " ";
   ...
   $this->css_nc_subtotal_label = $compl_css_emb . "css_nc_subtotal_label";
   $this->css_nc_subtotal_grid_line = $compl_css_emb . "css_nc_subtotal_grid_line";
   $this->css_nc_total_descuento_label = $compl_css_emb . "css_nc_total_descuento_label";
   $this->css_nc_total_descuento_grid_line = $compl_css_emb . "css_nc_total_descuento_grid_line";
   $this->css_nc_valor_iva_label = $compl_css_emb . "css_nc_valor_iva_label";
   $this->css_nc_valor_iva_grid_line = $compl_css_emb . "css_nc_valor_iva_grid_line";
   ...
   $this->css_nc_subtotal_iva_label = $compl_css_emb . "css_nc_subtotal_iva_label";
   $this->css_nc_subtotal_iva_grid_line = $compl_css_emb . "css_nc_subtotal_iva_grid_line";
   $this->css_nc_subtotal_cero_label = $compl_css_emb . "css_nc_subtotal_cero_label";
   $this->css_nc_subtotal_cero_grid_line = $compl_css_emb . "css_nc_subtotal_cero_grid_line";
   $this->css_nc_subtotal_no_objeto_label = $compl_css_emb . "css_nc_subtotal_no_objeto_label";
   $this->css_nc_subtotal_no_objeto_grid_line = $compl_css_emb . "css_nc_subtotal_no_objeto_grid_line";
   $this->css_nc_subtotal_excento_label = $compl_css_emb . "css_nc_subtotal_excento_label";
   $this->css_nc_subtotal_excento_grid_line = $compl_css_emb . "css_nc_subtotal_excento_grid_line";
   $this->css_nc_valor_ice_label = $compl_css_emb . "css_nc_valor_ice_label";
   $this->css_nc_valor_ice_grid_line = $compl_css_emb . "css_nc_valor_ice_grid_line";
   $this->css_nc_valor_irbpnr_label = $compl_css_emb . "css_nc_valor_irbpnr_label";
   $this->css_nc_valor_irbpnr_grid_line = $compl_css_emb . "css_nc_valor_irbpnr_grid_line";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cond_pesq'], 0, $trab_pos);
   ...
   $_SESSION['scriptcase']['grid_resumen_nc']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_resumen_nc']['contr_erro'] = 'off';
   $this->nm_data->SetaData(date("Y/m/d H:i:s"), "YYYY/MM/DD HH:II:SS"); 
   $nm_saida->saida(" <TR id=\"sc_grid_head\">\r\n");
   $this->nm_data->SetaData(date("Y/m/d H:i:s"), "YYYY/MM/DD HH:II:SS");
   $sc_data_cab1 = $this->nm_data->FormataSaida("l, d @?#?@de F @?#?@de Y");
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sv_dt_head'] = array();
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sv_dt_head'][1] = $sc_data_cab1;
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sv_dt_head']['fix'] = $nm_data_fixa;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf")
   { 
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida("       <TR valign=\"middle\">\r\n");
   $nm_saida->saida("        <TD align=\"left\" class=\"" . $this->css_scGridHeaderFont . "\">\r\n");
   $nm_saida->saida("          Notas de Crédito en Ventas\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("        <TD style=\"font-size: 5px\">\r\n");
   $nm_saida->saida("          &nbsp; &nbsp;\r\n");
   $nm_saida->saida("        </TD>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_label'])
   { 
       $this->New_label['nc_numero'] = "" . $this->Ini->Nm_lang['lang_id'] . "";
       $this->New_label['nc_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . "";
       $this->New_label['est_codigo'] = "" . $this->Ini->Nm_lang['lang_establecimiento'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_resumen_nc__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_resumen_nc-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_motivo_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_motivo_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".grid_resumen_nc_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nc_numero'])) ? $this->New_label['nc_numero'] : "" . $this->Ini->Nm_lang['lang_id'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
 ...
 function NM_label_nc_secuencial()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nc_secuencial_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_secuencial_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
 ...
 function NM_label_nc_subtotal()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nc_subtotal'])) ? $this->New_label['nc_subtotal'] : "" . $this->Ini->Nm_lang['lang_subtotal'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['nc_subtotal']) || $this->NM_cmp_hidden['nc_subtotal'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nc_subtotal_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_subtotal_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
 ...
 function NM_label_nc_total_descuento()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nc_total_descuento'])) ? $this->New_label['nc_total_descuento'] : "" . $this->Ini->Nm_lang['lang_descuento'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['nc_total_descuento']) || $this->NM_cmp_hidden['nc_total_descuento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nc_total_descuento_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_total_descuento_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
 ...
 function NM_label_nc_valor_iva()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nc_valor_iva'])) ? $this->New_label['nc_valor_iva'] : "" . $this->Ini->Nm_lang['lang_iva'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['nc_valor_iva']) || $this->NM_cmp_hidden['nc_valor_iva'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nc_valor_iva_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_valor_iva_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
 ...
 function NM_label_nc_subtotal_iva()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nc_subtotal_iva'])) ? $this->New_label['nc_subtotal_iva'] : "" . $this->Ini->Nm_lang['lang_subtotal_iva'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['nc_subtotal_iva']) || $this->NM_cmp_hidden['nc_subtotal_iva'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nc_subtotal_iva_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_subtotal_iva_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
 ...
 function NM_label_nc_subtotal_cero()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nc_subtotal_cero'])) ? $this->New_label['nc_subtotal_cero'] : "" . $this->Ini->Nm_lang['lang_subtotal_cero'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['nc_subtotal_cero']) || $this->NM_cmp_hidden['nc_subtotal_cero'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nc_subtotal_cero_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_subtotal_cero_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
 ...
 function NM_label_nc_subtotal_no_objeto()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nc_subtotal_no_objeto'])) ? $this->New_label['nc_subtotal_no_objeto'] : "" . $this->Ini->Nm_lang['lang_subtotal_no_objeto'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['nc_subtotal_no_objeto']) || $this->NM_cmp_hidden['nc_subtotal_no_objeto'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nc_subtotal_no_objeto_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_subtotal_no_objeto_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
 ...
 function NM_label_nc_subtotal_excento()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nc_subtotal_excento'])) ? $this->New_label['nc_subtotal_excento'] : "" . $this->Ini->Nm_lang['lang_subtotal_exento'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['nc_subtotal_excento']) || $this->NM_cmp_hidden['nc_subtotal_excento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nc_subtotal_excento_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_subtotal_excento_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
 ...
 function NM_label_nc_valor_ice()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nc_valor_ice'])) ? $this->New_label['nc_valor_ice'] : "" . $this->Ini->Nm_lang['lang_ice'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['nc_valor_ice']) || $this->NM_cmp_hidden['nc_valor_ice'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nc_valor_ice_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_valor_ice_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
 ...
 function NM_label_nc_valor_irbpnr()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nc_valor_irbpnr'])) ? $this->New_label['nc_valor_irbpnr'] : "" . $this->Ini->Nm_lang['lang_irbpnr'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['nc_valor_irbpnr']) || $this->NM_cmp_hidden['nc_valor_irbpnr'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nc_valor_irbpnr_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_valor_irbpnr_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
 ...
 function NM_label_nc_motivo()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nc_motivo_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nc_motivo_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
...
function SC_label_rightActionBar()
{
   ...
   $nm_saida->saida("</TD>\r\n");
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ini_cor_grid']);
       }
   }
   ...
   $this->sc_where_filtro  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['where_pesq_filtro'];
// 
   $SC_Label = (isset($this->New_label['nc_numero'])) ? $this->New_label['nc_numero'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_numero'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_fecha'])) ? $this->New_label['nc_fecha'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_fecha'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['est_codigo'])) ? $this->New_label['est_codigo'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['est_codigo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pen_serie'])) ? $this->New_label['pen_serie'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['pen_serie'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_secuencial'])) ? $this->New_label['nc_secuencial'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_secuencial'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_nombre'])) ? $this->New_label['cl_nombre'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['cl_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_identificacion'])) ? $this->New_label['cl_identificacion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['cl_identificacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_secuencial_docmod'])) ? $this->New_label['nc_secuencial_docmod'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_secuencial_docmod'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_subtotal'])) ? $this->New_label['nc_subtotal'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_subtotal'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_total_descuento'])) ? $this->New_label['nc_total_descuento'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_total_descuento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_valor_iva'])) ? $this->New_label['nc_valor_iva'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_valor_iva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_total'])) ? $this->New_label['nc_total'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_estado_sri'])) ? $this->New_label['nc_estado_sri'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_estado_sri'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_direccion'])) ? $this->New_label['cl_direccion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['cl_direccion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_telefono'])) ? $this->New_label['cl_telefono'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['cl_telefono'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_email'])) ? $this->New_label['cl_email'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['cl_email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_subtotal_iva'])) ? $this->New_label['nc_subtotal_iva'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_subtotal_iva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_subtotal_cero'])) ? $this->New_label['nc_subtotal_cero'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_subtotal_cero'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_subtotal_no_objeto'])) ? $this->New_label['nc_subtotal_no_objeto'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_subtotal_no_objeto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_subtotal_excento'])) ? $this->New_label['nc_subtotal_excento'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_subtotal_excento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_valor_ice'])) ? $this->New_label['nc_valor_ice'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_valor_ice'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_valor_irbpnr'])) ? $this->New_label['nc_valor_irbpnr'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_valor_irbpnr'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nc_motivo'])) ? $this->New_label['nc_motivo'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['labels']['nc_motivo'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_nc']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_resumen_nc#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_resumen_nc#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-f5977687\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_grid'])
...
// 
   ...
   $this->Break_pag_pdf['sc_free_group_by']['nc_secuencial_docmod'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['nc_secuencial_docmod'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['nc_usuario'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['nc_usuario'] = "N";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Page_break_PDF'] = array();
       }
   }
   $this->SC_top       = array();
   $this->SC_bot       = array();
   ...
   $this->SC_bot[]     = "nc_secuencial_docmod"; 
   $this->SC_top[]     = "nc_secuencial_docmod"; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       ...
       $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']);
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_resumen_nc_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->arg_sum_nc_usuario = " = " . $this->Db->qstr($this->nc_usuario);
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['rows_emb']++;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'] == "sc_free_group_by") 
          {  
              $SC_arg_Gby = array();
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
                      $sql_where .= (!empty($sql_where)) ? " and " : "";
              ...
              {
                  $cmp = $SC_lst_Gby[0];
                  if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby']][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Page_break_PDF'][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
              }
...
$_SESSION['scriptcase']['grid_resumen_nc']['contr_erro'] = 'off';
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_nc_motivo_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_nc_motivo_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'] . "_bot";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['mostra_edit'] != "N"){ 
   ...
   $nm_saida->saida("<td style=\"padding: 0\">\r\n");
            ...
            if (isset($this->Ini->sc_lig_md5["pdf_mostrar"]) && $this->Ini->sc_lig_md5["pdf_mostrar"] == "S") {
                ...
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['under_dashboard'] && isset($linkTarget)) {
                    if ('' != $Parms_Lig) {
                        $Parms_Lig .= '*scout';
                    }
                    $Parms_Lig .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $linkTarget . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['compact_mode'] ? '1' : '0') . '*scoutremove_margin*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['remove_margin'] ? '1' : '0') . '*scoutremove_border*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['remove_border'] ? '1' : '0');
                }
                $Md5_Lig = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_resumen_nc@SC_par@" . md5($Parms_Lig);
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
            } else {
 ...
 function NM_grid_nc_numero()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nc_numero_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nc_numero_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nc_numero_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_nc_secuencial()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nc_secuencial_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nc_secuencial_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nc_secuencial_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_nc_secuencial_docmod()
 {
      ...
      if (!isset($this->NM_cmp_hidden['nc_secuencial_docmod']) || $this->NM_cmp_hidden['nc_secuencial_docmod'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              ...
              $conteudo = sc_strip_script($this->nc_secuencial_docmod); 
              $conteudo_original = sc_strip_script($this->nc_secuencial_docmod); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
 ...
 function NM_grid_nc_subtotal()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nc_subtotal']) || $this->NM_cmp_hidden['nc_subtotal'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->nc_subtotal)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->nc_subtotal)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nc_subtotal_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nc_subtotal_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nc_subtotal_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_nc_total_descuento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nc_total_descuento']) || $this->NM_cmp_hidden['nc_total_descuento'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->nc_total_descuento)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->nc_total_descuento)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nc_total_descuento_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nc_total_descuento_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nc_total_descuento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_nc_valor_iva()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nc_valor_iva']) || $this->NM_cmp_hidden['nc_valor_iva'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->nc_valor_iva)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->nc_valor_iva)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nc_valor_iva_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nc_valor_iva_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nc_valor_iva_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_nc_subtotal_iva()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nc_subtotal_iva']) || $this->NM_cmp_hidden['nc_subtotal_iva'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->nc_subtotal_iva)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->nc_subtotal_iva)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nc_subtotal_iva_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nc_subtotal_iva_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nc_subtotal_iva_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_nc_subtotal_cero()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nc_subtotal_cero']) || $this->NM_cmp_hidden['nc_subtotal_cero'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->nc_subtotal_cero)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->nc_subtotal_cero)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nc_subtotal_cero_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nc_subtotal_cero_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nc_subtotal_cero_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_nc_subtotal_no_objeto()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nc_subtotal_no_objeto']) || $this->NM_cmp_hidden['nc_subtotal_no_objeto'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->nc_subtotal_no_objeto)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->nc_subtotal_no_objeto)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nc_subtotal_no_objeto_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nc_subtotal_no_objeto_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nc_subtotal_no_objeto_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_nc_subtotal_excento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nc_subtotal_excento']) || $this->NM_cmp_hidden['nc_subtotal_excento'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->nc_subtotal_excento)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->nc_subtotal_excento)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nc_subtotal_excento_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nc_subtotal_excento_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nc_subtotal_excento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_nc_valor_ice()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nc_valor_ice']) || $this->NM_cmp_hidden['nc_valor_ice'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->nc_valor_ice)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->nc_valor_ice)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nc_valor_ice_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nc_valor_ice_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nc_valor_ice_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_nc_valor_irbpnr()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nc_valor_irbpnr']) || $this->NM_cmp_hidden['nc_valor_irbpnr'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->nc_valor_irbpnr)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->nc_valor_irbpnr)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nc_valor_irbpnr_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nc_valor_irbpnr_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nc_valor_irbpnr_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_nc_motivo()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nc_motivo_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nc_motivo_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nc_motivo_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_nc_fecha_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_nc_fecha_nc_subtotal = $tot_nc_fecha[2];
   $this->sum_nc_fecha_nc_total_descuento = $tot_nc_fecha[3];
   $this->sum_nc_fecha_nc_valor_iva = $tot_nc_fecha[4];
   $this->sum_nc_fecha_nc_total = $tot_nc_fecha[5];
   $this->sum_nc_fecha_nc_subtotal_iva = $tot_nc_fecha[6];
   $this->sum_nc_fecha_nc_subtotal_cero = $tot_nc_fecha[7];
   $this->sum_nc_fecha_nc_subtotal_no_objeto = $tot_nc_fecha[8];
   $this->sum_nc_fecha_nc_subtotal_excento = $tot_nc_fecha[9];
   $this->sum_nc_fecha_nc_valor_ice = $tot_nc_fecha[10];
   $this->sum_nc_fecha_nc_valor_irbpnr = $tot_nc_fecha[11];
 ...
 function quebra_est_codigo_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_est_codigo_nc_subtotal = $tot_est_codigo[2];
   $this->sum_est_codigo_nc_total_descuento = $tot_est_codigo[3];
   $this->sum_est_codigo_nc_valor_iva = $tot_est_codigo[4];
   $this->sum_est_codigo_nc_total = $tot_est_codigo[5];
   $this->sum_est_codigo_nc_subtotal_iva = $tot_est_codigo[6];
   $this->sum_est_codigo_nc_subtotal_cero = $tot_est_codigo[7];
   $this->sum_est_codigo_nc_subtotal_no_objeto = $tot_est_codigo[8];
   $this->sum_est_codigo_nc_subtotal_excento = $tot_est_codigo[9];
   $this->sum_est_codigo_nc_valor_ice = $tot_est_codigo[10];
   $this->sum_est_codigo_nc_valor_irbpnr = $tot_est_codigo[11];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->est_codigo)); 
   }
 ...
 function quebra_pen_serie_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_pen_serie_nc_subtotal = $tot_pen_serie[2];
   $this->sum_pen_serie_nc_total_descuento = $tot_pen_serie[3];
   $this->sum_pen_serie_nc_valor_iva = $tot_pen_serie[4];
   $this->sum_pen_serie_nc_total = $tot_pen_serie[5];
   $this->sum_pen_serie_nc_subtotal_iva = $tot_pen_serie[6];
   $this->sum_pen_serie_nc_subtotal_cero = $tot_pen_serie[7];
   $this->sum_pen_serie_nc_subtotal_no_objeto = $tot_pen_serie[8];
   $this->sum_pen_serie_nc_subtotal_excento = $tot_pen_serie[9];
   $this->sum_pen_serie_nc_valor_ice = $tot_pen_serie[10];
   $this->sum_pen_serie_nc_valor_irbpnr = $tot_pen_serie[11];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->pen_serie)); 
   }
 ...
 function quebra_cl_identificacion_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_cl_identificacion_nc_subtotal = $tot_cl_identificacion[2];
   $this->sum_cl_identificacion_nc_total_descuento = $tot_cl_identificacion[3];
   $this->sum_cl_identificacion_nc_valor_iva = $tot_cl_identificacion[4];
   $this->sum_cl_identificacion_nc_total = $tot_cl_identificacion[5];
   $this->sum_cl_identificacion_nc_subtotal_iva = $tot_cl_identificacion[6];
   $this->sum_cl_identificacion_nc_subtotal_cero = $tot_cl_identificacion[7];
   $this->sum_cl_identificacion_nc_subtotal_no_objeto = $tot_cl_identificacion[8];
   $this->sum_cl_identificacion_nc_subtotal_excento = $tot_cl_identificacion[9];
   $this->sum_cl_identificacion_nc_valor_ice = $tot_cl_identificacion[10];
   $this->sum_cl_identificacion_nc_valor_irbpnr = $tot_cl_identificacion[11];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->cl_identificacion)); 
   }
 ...
 function quebra_cl_nombre_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_cl_nombre_nc_subtotal = $tot_cl_nombre[2];
   $this->sum_cl_nombre_nc_total_descuento = $tot_cl_nombre[3];
   $this->sum_cl_nombre_nc_valor_iva = $tot_cl_nombre[4];
   $this->sum_cl_nombre_nc_total = $tot_cl_nombre[5];
   $this->sum_cl_nombre_nc_subtotal_iva = $tot_cl_nombre[6];
   $this->sum_cl_nombre_nc_subtotal_cero = $tot_cl_nombre[7];
   $this->sum_cl_nombre_nc_subtotal_no_objeto = $tot_cl_nombre[8];
   $this->sum_cl_nombre_nc_subtotal_excento = $tot_cl_nombre[9];
   $this->sum_cl_nombre_nc_valor_ice = $tot_cl_nombre[10];
   $this->sum_cl_nombre_nc_valor_irbpnr = $tot_cl_nombre[11];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->cl_nombre)); 
   }
 ...
 function quebra_nc_secuencial_docmod_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $this->sc_proc_quebra_cl_nombre = false;
   $this->sc_proc_quebra_nc_usuario = false;
   $this->sc_proc_quebra_nc_secuencial_docmod = true; 
   $this->Tot->quebra_nc_secuencial_docmod_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name);
   $tot_nc_secuencial_docmod = $$Var_name_gb;
   $conteudo = $tot_nc_secuencial_docmod[0] ;  
   $this->count_nc_secuencial_docmod = $tot_nc_secuencial_docmod[1];
   $this->sum_nc_secuencial_docmod_nc_subtotal = $tot_nc_secuencial_docmod[2];
   $this->sum_nc_secuencial_docmod_nc_total_descuento = $tot_nc_secuencial_docmod[3];
   $this->sum_nc_secuencial_docmod_nc_valor_iva = $tot_nc_secuencial_docmod[4];
   $this->sum_nc_secuencial_docmod_nc_total = $tot_nc_secuencial_docmod[5];
   $this->sum_nc_secuencial_docmod_nc_subtotal_iva = $tot_nc_secuencial_docmod[6];
   $this->sum_nc_secuencial_docmod_nc_subtotal_cero = $tot_nc_secuencial_docmod[7];
   $this->sum_nc_secuencial_docmod_nc_subtotal_no_objeto = $tot_nc_secuencial_docmod[8];
   $this->sum_nc_secuencial_docmod_nc_subtotal_excento = $tot_nc_secuencial_docmod[9];
   $this->sum_nc_secuencial_docmod_nc_valor_ice = $tot_nc_secuencial_docmod[10];
   $this->sum_nc_secuencial_docmod_nc_valor_irbpnr = $tot_nc_secuencial_docmod[11];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->nc_secuencial_docmod)); 
   }
   ...
   $Temp_cmp_quebra[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['nc_secuencial_docmod']))
   {
       $Temp_cmp_quebra[0]['lab'] = $this->nmgp_label_quebras['nc_secuencial_docmod']; 
   }
   else
   {
 ...
 function quebra_nc_usuario_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_nc_usuario_nc_subtotal = $tot_nc_usuario[2];
   $this->sum_nc_usuario_nc_total_descuento = $tot_nc_usuario[3];
   $this->sum_nc_usuario_nc_valor_iva = $tot_nc_usuario[4];
   $this->sum_nc_usuario_nc_total = $tot_nc_usuario[5];
   $this->sum_nc_usuario_nc_subtotal_iva = $tot_nc_usuario[6];
   $this->sum_nc_usuario_nc_subtotal_cero = $tot_nc_usuario[7];
   $this->sum_nc_usuario_nc_subtotal_no_objeto = $tot_nc_usuario[8];
   $this->sum_nc_usuario_nc_subtotal_excento = $tot_nc_usuario[9];
   $this->sum_nc_usuario_nc_valor_ice = $tot_nc_usuario[10];
   $this->sum_nc_usuario_nc_valor_irbpnr = $tot_nc_usuario[11];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
   ...
   $this->Lookup->lookup_sc_free_group_by_nc_usuario($conteudo , $this->nc_usuario) ; 
   $Temp_cmp_quebra[0]['cmp'] = $conteudo; 
 ...
 function quebra_nc_fecha_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   $tot_nc_fecha = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['nc_fecha'] : 0;
   ...
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_grid_resumen_nc_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_open_grid_resumen_nc_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_grid_resumen_nc_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_resumen_nc, 'grid_resumen_nc'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_grid_resumen_nc_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_close_grid_resumen_nc_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_grid_resumen_nc_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_resumen_nc, 'grid_resumen_nc'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['nc_fecha']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['nc_fecha'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['nc_fecha']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
 ...
 function quebra_nc_fecha_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   global 
          ...
          $nm_saida, $$Var_name_gb;
   $tot_nc_fecha = $$Var_name_gb;
   $NM_cmp_tot['nc_subtotal']['S'] = 2;
   $NM_cmp_tot['nc_total_descuento']['S'] = 3;
   $NM_cmp_tot['nc_valor_iva']['S'] = 4;
   $NM_cmp_tot['nc_total']['S'] = 5;
   $NM_cmp_tot['nc_subtotal_iva']['S'] = 6;
   $NM_cmp_tot['nc_subtotal_cero']['S'] = 7;
   $NM_cmp_tot['nc_subtotal_no_objeto']['S'] = 8;
   $NM_cmp_tot['nc_subtotal_excento']['S'] = 9;
   $NM_cmp_tot['nc_valor_ice']['S'] = 10;
   $NM_cmp_tot['nc_valor_irbpnr']['S'] = 11;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['nc_fecha'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['field_order'] as $Cada_cmp)
   {
    if ($Cada_cmp == "nc_numero" && (!isset($this->NM_cmp_hidden['nc_numero']) || $this->NM_cmp_hidden['nc_numero'] != "off"))
    {
        $colspan++;
    }
    ...
    if ($Cada_cmp == "nc_secuencial_docmod" && (!isset($this->NM_cmp_hidden['nc_secuencial_docmod']) || $this->NM_cmp_hidden['nc_secuencial_docmod'] != "off"))
    {
        $colspan++;
    }
    if ($Cada_cmp == "nc_subtotal" && (!isset($this->NM_cmp_hidden['nc_subtotal']) || $this->NM_cmp_hidden['nc_subtotal'] != "off"))
    {
      if ($colspan > 0)
      {
          $NM_css_field = ""; 
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['nc_subtotal'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_fecha[$NM_cmp_tot['nc_subtotal'][$Tipo_Sum]]; 
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_subtotal_S_sub_tot";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_total_descuento" && (!isset($this->NM_cmp_hidden['nc_total_descuento']) || $this->NM_cmp_hidden['nc_total_descuento'] != "off"))
    {
      if ($colspan > 0)
      {
          $NM_css_field = ""; 
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_fecha[$NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_total_descuento_S_sub_tot";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_valor_iva" && (!isset($this->NM_cmp_hidden['nc_valor_iva']) || $this->NM_cmp_hidden['nc_valor_iva'] != "off"))
    {
      if ($colspan > 0)
      {
          $NM_css_field = ""; 
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_fecha[$NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_valor_iva_S_sub_tot";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_total" && (!isset($this->NM_cmp_hidden['nc_total']) || $this->NM_cmp_hidden['nc_total'] != "off"))
    {
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['nc_total'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_fecha[$NM_cmp_tot['nc_total'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_total_S_sub_tot";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_estado_sri" && (!isset($this->NM_cmp_hidden['nc_estado_sri']) || $this->NM_cmp_hidden['nc_estado_sri'] != "off"))
    {
        $colspan++;
    }
    ...
    if ($Cada_cmp == "nc_subtotal_iva" && (!isset($this->NM_cmp_hidden['nc_subtotal_iva']) || $this->NM_cmp_hidden['nc_subtotal_iva'] != "off"))
    {
      if ($colspan > 0)
      {
          $NM_css_field = ""; 
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_fecha[$NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_subtotal_iva_S_sub_tot";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_subtotal_cero" && (!isset($this->NM_cmp_hidden['nc_subtotal_cero']) || $this->NM_cmp_hidden['nc_subtotal_cero'] != "off"))
    {
      if ($colspan > 0)
      {
          $NM_css_field = ""; 
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_fecha[$NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_subtotal_cero_S_sub_tot";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_subtotal_no_objeto" && (!isset($this->NM_cmp_hidden['nc_subtotal_no_objeto']) || $this->NM_cmp_hidden['nc_subtotal_no_objeto'] != "off"))
    {
      if ($colspan > 0)
      {
          $NM_css_field = ""; 
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_fecha[$NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_subtotal_no_objeto_S_sub_tot";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_subtotal_excento" && (!isset($this->NM_cmp_hidden['nc_subtotal_excento']) || $this->NM_cmp_hidden['nc_subtotal_excento'] != "off"))
    {
      if ($colspan > 0)
      {
          $NM_css_field = ""; 
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_fecha[$NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_subtotal_excento_S_sub_tot";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_valor_ice" && (!isset($this->NM_cmp_hidden['nc_valor_ice']) || $this->NM_cmp_hidden['nc_valor_ice'] != "off"))
    {
      if ($colspan > 0)
      {
          $NM_css_field = ""; 
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_fecha[$NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_valor_ice_S_sub_tot";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_valor_irbpnr" && (!isset($this->NM_cmp_hidden['nc_valor_irbpnr']) || $this->NM_cmp_hidden['nc_valor_irbpnr'] != "off"))
    {
      if ($colspan > 0)
      {
          $NM_css_field = ""; 
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_fecha[$NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_valor_irbpnr_S_sub_tot";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = false;
       $nm_saida->saida("    </TBODY>");
   }
 ...
 function quebra_est_codigo_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_est_codigo = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['est_codigo'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['est_codigo']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['est_codigo'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['est_codigo']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_est_codigo_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['nc_valor_irbpnr']['S'] = 11;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['est_codigo'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "nc_subtotal" && (!isset($this->NM_cmp_hidden['nc_subtotal']) || $this->NM_cmp_hidden['nc_subtotal'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal'][$Tipo_Sum]))
      {
          $conteudo =  $tot_est_codigo[$NM_cmp_tot['nc_subtotal'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_total_descuento" && (!isset($this->NM_cmp_hidden['nc_total_descuento']) || $this->NM_cmp_hidden['nc_total_descuento'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_est_codigo[$NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_iva" && (!isset($this->NM_cmp_hidden['nc_valor_iva']) || $this->NM_cmp_hidden['nc_valor_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_est_codigo[$NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_total" && (!isset($this->NM_cmp_hidden['nc_total']) || $this->NM_cmp_hidden['nc_total'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_total'][$Tipo_Sum]))
      {
          $conteudo =  $tot_est_codigo[$NM_cmp_tot['nc_total'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_iva" && (!isset($this->NM_cmp_hidden['nc_subtotal_iva']) || $this->NM_cmp_hidden['nc_subtotal_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_est_codigo[$NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_cero" && (!isset($this->NM_cmp_hidden['nc_subtotal_cero']) || $this->NM_cmp_hidden['nc_subtotal_cero'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]))
      {
          $conteudo =  $tot_est_codigo[$NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_no_objeto" && (!isset($this->NM_cmp_hidden['nc_subtotal_no_objeto']) || $this->NM_cmp_hidden['nc_subtotal_no_objeto'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]))
      {
          $conteudo =  $tot_est_codigo[$NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_excento" && (!isset($this->NM_cmp_hidden['nc_subtotal_excento']) || $this->NM_cmp_hidden['nc_subtotal_excento'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_est_codigo[$NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_ice" && (!isset($this->NM_cmp_hidden['nc_valor_ice']) || $this->NM_cmp_hidden['nc_valor_ice'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]))
      {
          $conteudo =  $tot_est_codigo[$NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_irbpnr" && (!isset($this->NM_cmp_hidden['nc_valor_irbpnr']) || $this->NM_cmp_hidden['nc_valor_irbpnr'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]))
      {
          $conteudo =  $tot_est_codigo[$NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
 ...
 function quebra_pen_serie_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_pen_serie = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['pen_serie'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['pen_serie']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['pen_serie'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['pen_serie']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_pen_serie_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['nc_valor_irbpnr']['S'] = 11;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['pen_serie'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "nc_subtotal" && (!isset($this->NM_cmp_hidden['nc_subtotal']) || $this->NM_cmp_hidden['nc_subtotal'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal'][$Tipo_Sum]))
      {
          $conteudo =  $tot_pen_serie[$NM_cmp_tot['nc_subtotal'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_total_descuento" && (!isset($this->NM_cmp_hidden['nc_total_descuento']) || $this->NM_cmp_hidden['nc_total_descuento'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_pen_serie[$NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_iva" && (!isset($this->NM_cmp_hidden['nc_valor_iva']) || $this->NM_cmp_hidden['nc_valor_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_pen_serie[$NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_total" && (!isset($this->NM_cmp_hidden['nc_total']) || $this->NM_cmp_hidden['nc_total'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_total'][$Tipo_Sum]))
      {
          $conteudo =  $tot_pen_serie[$NM_cmp_tot['nc_total'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_iva" && (!isset($this->NM_cmp_hidden['nc_subtotal_iva']) || $this->NM_cmp_hidden['nc_subtotal_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_pen_serie[$NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_cero" && (!isset($this->NM_cmp_hidden['nc_subtotal_cero']) || $this->NM_cmp_hidden['nc_subtotal_cero'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]))
      {
          $conteudo =  $tot_pen_serie[$NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_no_objeto" && (!isset($this->NM_cmp_hidden['nc_subtotal_no_objeto']) || $this->NM_cmp_hidden['nc_subtotal_no_objeto'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]))
      {
          $conteudo =  $tot_pen_serie[$NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_excento" && (!isset($this->NM_cmp_hidden['nc_subtotal_excento']) || $this->NM_cmp_hidden['nc_subtotal_excento'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_pen_serie[$NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_ice" && (!isset($this->NM_cmp_hidden['nc_valor_ice']) || $this->NM_cmp_hidden['nc_valor_ice'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]))
      {
          $conteudo =  $tot_pen_serie[$NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_irbpnr" && (!isset($this->NM_cmp_hidden['nc_valor_irbpnr']) || $this->NM_cmp_hidden['nc_valor_irbpnr'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]))
      {
          $conteudo =  $tot_pen_serie[$NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
 ...
 function quebra_cl_identificacion_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_cl_identificacion = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['cl_identificacion'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_identificacion']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['cl_identificacion'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_identificacion']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_cl_identificacion_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['nc_valor_irbpnr']['S'] = 11;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['cl_identificacion'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "nc_subtotal" && (!isset($this->NM_cmp_hidden['nc_subtotal']) || $this->NM_cmp_hidden['nc_subtotal'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_identificacion[$NM_cmp_tot['nc_subtotal'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_total_descuento" && (!isset($this->NM_cmp_hidden['nc_total_descuento']) || $this->NM_cmp_hidden['nc_total_descuento'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_identificacion[$NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_iva" && (!isset($this->NM_cmp_hidden['nc_valor_iva']) || $this->NM_cmp_hidden['nc_valor_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_identificacion[$NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_total" && (!isset($this->NM_cmp_hidden['nc_total']) || $this->NM_cmp_hidden['nc_total'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_total'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_identificacion[$NM_cmp_tot['nc_total'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_iva" && (!isset($this->NM_cmp_hidden['nc_subtotal_iva']) || $this->NM_cmp_hidden['nc_subtotal_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_identificacion[$NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_cero" && (!isset($this->NM_cmp_hidden['nc_subtotal_cero']) || $this->NM_cmp_hidden['nc_subtotal_cero'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_identificacion[$NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_no_objeto" && (!isset($this->NM_cmp_hidden['nc_subtotal_no_objeto']) || $this->NM_cmp_hidden['nc_subtotal_no_objeto'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_identificacion[$NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_excento" && (!isset($this->NM_cmp_hidden['nc_subtotal_excento']) || $this->NM_cmp_hidden['nc_subtotal_excento'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_identificacion[$NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_ice" && (!isset($this->NM_cmp_hidden['nc_valor_ice']) || $this->NM_cmp_hidden['nc_valor_ice'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_identificacion[$NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_irbpnr" && (!isset($this->NM_cmp_hidden['nc_valor_irbpnr']) || $this->NM_cmp_hidden['nc_valor_irbpnr'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_identificacion[$NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
 ...
 function quebra_cl_nombre_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_cl_nombre = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['cl_nombre'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_nombre']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['cl_nombre'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_nombre']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_cl_nombre_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['nc_valor_irbpnr']['S'] = 11;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['cl_nombre'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "nc_subtotal" && (!isset($this->NM_cmp_hidden['nc_subtotal']) || $this->NM_cmp_hidden['nc_subtotal'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_nombre[$NM_cmp_tot['nc_subtotal'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_total_descuento" && (!isset($this->NM_cmp_hidden['nc_total_descuento']) || $this->NM_cmp_hidden['nc_total_descuento'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_nombre[$NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_iva" && (!isset($this->NM_cmp_hidden['nc_valor_iva']) || $this->NM_cmp_hidden['nc_valor_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_nombre[$NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_total" && (!isset($this->NM_cmp_hidden['nc_total']) || $this->NM_cmp_hidden['nc_total'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_total'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_nombre[$NM_cmp_tot['nc_total'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_iva" && (!isset($this->NM_cmp_hidden['nc_subtotal_iva']) || $this->NM_cmp_hidden['nc_subtotal_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_nombre[$NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_cero" && (!isset($this->NM_cmp_hidden['nc_subtotal_cero']) || $this->NM_cmp_hidden['nc_subtotal_cero'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_nombre[$NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_no_objeto" && (!isset($this->NM_cmp_hidden['nc_subtotal_no_objeto']) || $this->NM_cmp_hidden['nc_subtotal_no_objeto'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_nombre[$NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_excento" && (!isset($this->NM_cmp_hidden['nc_subtotal_excento']) || $this->NM_cmp_hidden['nc_subtotal_excento'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_nombre[$NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_ice" && (!isset($this->NM_cmp_hidden['nc_valor_ice']) || $this->NM_cmp_hidden['nc_valor_ice'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_nombre[$NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_irbpnr" && (!isset($this->NM_cmp_hidden['nc_valor_irbpnr']) || $this->NM_cmp_hidden['nc_valor_irbpnr'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]))
      {
          $conteudo =  $tot_cl_nombre[$NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
 ...
 function quebra_nc_secuencial_docmod_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_nc_secuencial_docmod = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['nc_secuencial_docmod'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_nc_secuencial_docmod = 0; 
   $cont_quebra_nc_secuencial_docmod++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['rows_emb']++;
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['nc_secuencial_docmod']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   $conteudo = $tot_nc_secuencial_docmod[0] ;  
    $thisColspan = 2;
   $colspan = $this->NM_colspan;
   $this->Label_nc_secuencial_docmod = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_nc_secuencial_docmod .= "<tr>"; 
       $this->Label_nc_secuencial_docmod .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_nc_secuencial_docmod .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_nc_secuencial_docmod .= "</tr>"; 
   } 
   $this->Label_nc_secuencial_docmod .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\"  " . "colspan=\"" . $colspan . "\"" . " align=\"\">\r\n");
   $nm_saida->saida("       " . $link_div . "\r\n");
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_nc_secuencial_docmod . $nm_fecha_pdf_old . "\r\n");
   $nm_saida->saida("       " . $link_div_2 . "\r\n");
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['nc_secuencial_docmod'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['nc_secuencial_docmod']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_nc_secuencial_docmod_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $NM_cmp_tot['nc_valor_irbpnr']['S'] = 11;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['nc_secuencial_docmod'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "nc_subtotal" && (!isset($this->NM_cmp_hidden['nc_subtotal']) || $this->NM_cmp_hidden['nc_subtotal'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_secuencial_docmod[$NM_cmp_tot['nc_subtotal'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_total_descuento" && (!isset($this->NM_cmp_hidden['nc_total_descuento']) || $this->NM_cmp_hidden['nc_total_descuento'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_secuencial_docmod[$NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_iva" && (!isset($this->NM_cmp_hidden['nc_valor_iva']) || $this->NM_cmp_hidden['nc_valor_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_secuencial_docmod[$NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_total" && (!isset($this->NM_cmp_hidden['nc_total']) || $this->NM_cmp_hidden['nc_total'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_total'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_secuencial_docmod[$NM_cmp_tot['nc_total'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_iva" && (!isset($this->NM_cmp_hidden['nc_subtotal_iva']) || $this->NM_cmp_hidden['nc_subtotal_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_secuencial_docmod[$NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_cero" && (!isset($this->NM_cmp_hidden['nc_subtotal_cero']) || $this->NM_cmp_hidden['nc_subtotal_cero'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_secuencial_docmod[$NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_no_objeto" && (!isset($this->NM_cmp_hidden['nc_subtotal_no_objeto']) || $this->NM_cmp_hidden['nc_subtotal_no_objeto'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_secuencial_docmod[$NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_excento" && (!isset($this->NM_cmp_hidden['nc_subtotal_excento']) || $this->NM_cmp_hidden['nc_subtotal_excento'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_secuencial_docmod[$NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_ice" && (!isset($this->NM_cmp_hidden['nc_valor_ice']) || $this->NM_cmp_hidden['nc_valor_ice'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_secuencial_docmod[$NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_irbpnr" && (!isset($this->NM_cmp_hidden['nc_valor_irbpnr']) || $this->NM_cmp_hidden['nc_valor_irbpnr'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_secuencial_docmod[$NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
 ...
 function quebra_nc_usuario_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_nc_usuario = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['nc_usuario'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['nc_usuario']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['nc_usuario'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_resumen_nc'][$this->NM_cont_body][$this->Tab_Nv_tree['nc_usuario']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_resumen_nc_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_nc_usuario_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['nc_valor_irbpnr']['S'] = 11;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['nc_usuario'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "nc_subtotal" && (!isset($this->NM_cmp_hidden['nc_subtotal']) || $this->NM_cmp_hidden['nc_subtotal'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_usuario[$NM_cmp_tot['nc_subtotal'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_total_descuento" && (!isset($this->NM_cmp_hidden['nc_total_descuento']) || $this->NM_cmp_hidden['nc_total_descuento'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_usuario[$NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_iva" && (!isset($this->NM_cmp_hidden['nc_valor_iva']) || $this->NM_cmp_hidden['nc_valor_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_usuario[$NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_total" && (!isset($this->NM_cmp_hidden['nc_total']) || $this->NM_cmp_hidden['nc_total'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_total'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_usuario[$NM_cmp_tot['nc_total'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_iva" && (!isset($this->NM_cmp_hidden['nc_subtotal_iva']) || $this->NM_cmp_hidden['nc_subtotal_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_usuario[$NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_cero" && (!isset($this->NM_cmp_hidden['nc_subtotal_cero']) || $this->NM_cmp_hidden['nc_subtotal_cero'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_usuario[$NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_no_objeto" && (!isset($this->NM_cmp_hidden['nc_subtotal_no_objeto']) || $this->NM_cmp_hidden['nc_subtotal_no_objeto'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_usuario[$NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_subtotal_excento" && (!isset($this->NM_cmp_hidden['nc_subtotal_excento']) || $this->NM_cmp_hidden['nc_subtotal_excento'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_usuario[$NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_ice" && (!isset($this->NM_cmp_hidden['nc_valor_ice']) || $this->NM_cmp_hidden['nc_valor_ice'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_usuario[$NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "nc_valor_irbpnr" && (!isset($this->NM_cmp_hidden['nc_valor_irbpnr']) || $this->NM_cmp_hidden['nc_valor_irbpnr'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]))
      {
          $conteudo =  $tot_nc_usuario[$NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
 ...
 function quebra_geral_sc_free_group_by_bot() 
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      =  $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][1] . ")";
   $tit_lin_sumariza_orig =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][1] . ")";
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "nc_subtotal" && (!isset($this->NM_cmp_hidden['nc_subtotal']) || $this->NM_cmp_hidden['nc_subtotal'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][$NM_cmp_tot['nc_subtotal'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_subtotal_S_tot_ger";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_nc_subtotal_tot_ger\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_total_descuento" && (!isset($this->NM_cmp_hidden['nc_total_descuento']) || $this->NM_cmp_hidden['nc_total_descuento'] != "off"))
    {
      if ($colspan > 0)
      ...
      if (isset($NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][$NM_cmp_tot['nc_total_descuento'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_total_descuento_S_tot_ger";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_nc_total_descuento_tot_ger\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_valor_iva" && (!isset($this->NM_cmp_hidden['nc_valor_iva']) || $this->NM_cmp_hidden['nc_valor_iva'] != "off"))
    {
      if ($colspan > 0)
      ...
      if (isset($NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][$NM_cmp_tot['nc_valor_iva'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_valor_iva_S_tot_ger";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_nc_valor_iva_tot_ger\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_total" && (!isset($this->NM_cmp_hidden['nc_total']) || $this->NM_cmp_hidden['nc_total'] != "off"))
    {
      if ($colspan > 0)
      ...
      if (isset($NM_cmp_tot['nc_total'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][$NM_cmp_tot['nc_total'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_total_S_tot_ger";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_nc_total_tot_ger\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_estado_sri" && (!isset($this->NM_cmp_hidden['nc_estado_sri']) || $this->NM_cmp_hidden['nc_estado_sri'] != "off"))
    {
       $colspan++;
    ...
    if ($Cada_cmp == "nc_subtotal_iva" && (!isset($this->NM_cmp_hidden['nc_subtotal_iva']) || $this->NM_cmp_hidden['nc_subtotal_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][$NM_cmp_tot['nc_subtotal_iva'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_subtotal_iva_S_tot_ger";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_nc_subtotal_iva_tot_ger\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_subtotal_cero" && (!isset($this->NM_cmp_hidden['nc_subtotal_cero']) || $this->NM_cmp_hidden['nc_subtotal_cero'] != "off"))
    {
      if ($colspan > 0)
      ...
      if (isset($NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][$NM_cmp_tot['nc_subtotal_cero'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_subtotal_cero_S_tot_ger";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_nc_subtotal_cero_tot_ger\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_subtotal_no_objeto" && (!isset($this->NM_cmp_hidden['nc_subtotal_no_objeto']) || $this->NM_cmp_hidden['nc_subtotal_no_objeto'] != "off"))
    {
      if ($colspan > 0)
      ...
      if (isset($NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][$NM_cmp_tot['nc_subtotal_no_objeto'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_subtotal_no_objeto_S_tot_ger";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_nc_subtotal_no_objeto_tot_ger\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_subtotal_excento" && (!isset($this->NM_cmp_hidden['nc_subtotal_excento']) || $this->NM_cmp_hidden['nc_subtotal_excento'] != "off"))
    {
      if ($colspan > 0)
      ...
      if (isset($NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][$NM_cmp_tot['nc_subtotal_excento'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_subtotal_excento_S_tot_ger";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_nc_subtotal_excento_tot_ger\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_valor_ice" && (!isset($this->NM_cmp_hidden['nc_valor_ice']) || $this->NM_cmp_hidden['nc_valor_ice'] != "off"))
    {
      if ($colspan > 0)
      ...
      if (isset($NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][$NM_cmp_tot['nc_valor_ice'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_valor_ice_S_tot_ger";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_nc_valor_ice_tot_ger\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_valor_irbpnr" && (!isset($this->NM_cmp_hidden['nc_valor_irbpnr']) || $this->NM_cmp_hidden['nc_valor_irbpnr'] != "off"))
    {
      if ($colspan > 0)
      ...
      if (isset($NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['tot_geral'][$NM_cmp_tot['nc_valor_irbpnr'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_nc_valor_irbpnr_S_tot_ger";} 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_nc_valor_irbpnr_tot_ger\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "nc_motivo" && (!isset($this->NM_cmp_hidden['nc_motivo']) || $this->NM_cmp_hidden['nc_motivo'] != "off"))
    {
       $colspan++;
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
      $Tem_gb_pdf  = "s";
      $Tem_pdf_res = "n";
      $Tem_pdf_res = "s";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
      }
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_nc/grid_resumen_nc_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_resumen_nc&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          $Tem_word_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_nc/grid_resumen_nc_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Tem_xls_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_nc/grid_resumen_nc_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_resumen_nc&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $Tem_pdf_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']))
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_resumen_nc/grid_resumen_nc_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_resumen_nc/grid_resumen_nc_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Groupby_hide']))
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_resumen_nc/grid_resumen_nc_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_resumen_nc/grid_resumen_nc_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['SC_Gb_Free_cmp']))
            { }
            else {
          ...
          if (is_file("grid_resumen_nc_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_resumen_nc_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('nc_fecha','est_codigo','pen_serie','cl_identificacion','cl_nombre','nc_usuario');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq']) < 6)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_est_codigo($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['psq_check_ret']['est_codigo'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['psq_check_ret']['est_codigo'][] = trim($rs->fields[0]);
   ...
   function grid_search_pen_serie($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['psq_check_ret']['pen_serie'] = array();
       $pen_serie_look = (is_string($pen_serie) ? substr($this->Db->qstr($pen_serie), 1, -1) : $pen_serie); 
       $nmgp_def_dados  = ""; 
       $est_codigo = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['est_codigo'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campos_busca']['est_codigo'] : "";
       $est_codigo_val_str = "''";
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['psq_check_ret']['pen_serie'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_cl_identificacion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (nc_estado='V' and nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and #lowerI#cl_identificacion#lowerF# = #lowerI#'$cl_identificacion_look'#lowerF# order by cl_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function grid_search_cl_nombre($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (nc_estado='V' and nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and #lowerI#cl_nombre#lowerF# = #lowerI#'$cl_nombre_look'#lowerF# order by cl_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function grid_search_nc_usuario($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['psq_check_ret']['nc_usuario'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['psq_check_ret']['nc_usuario'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function lookup_ajax_cl_identificacion($cl_identificacion)
   {
       ...
       $cl_identificacion_look = (is_string($cl_identificacion) ? substr($this->Db->qstr($cl_identificacion), 1, -1) : $cl_identificacion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (nc_estado='V' and nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  #lowerI#cl_identificacion#lowerF# like #lowerI#'%" . $cl_identificacion . "%'#lowerF# order by cl_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_resumen_nc_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_cl_nombre($cl_nombre)
   {
       ...
       $cl_nombre_look = (is_string($cl_nombre) ? substr($this->Db->qstr($cl_nombre), 1, -1) : $cl_nombre); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (nc_estado='V' and nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  #lowerI#cl_nombre#lowerF# like #lowerI#'%" . $cl_nombre . "%'#lowerF# order by cl_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "debi_doc_electronicos/grid_resumen_nc";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_resumen_nc_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_resumen_nc_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['nc_fecha_mes'] =  'sc_grid_resumen_nc_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['nc_fecha_dia'] =  'sc_grid_resumen_nc_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['nc_fecha_v2__mes'] =  'sc_grid_resumen_nc_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['nc_fecha_v2__dia'] =  'sc_grid_resumen_nc_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['nc_fecha_mes']", 'value' => 'sc_grid_resumen_nc_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['nc_fecha_dia']", 'value' => 'sc_grid_resumen_nc_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['nc_fecha_v2__mes']", 'value' => 'sc_grid_resumen_nc_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['nc_fecha_v2__dia']", 'value' => 'sc_grid_resumen_nc_valida_dia(this)');
       } 
...
function sc_actionbar_disable($buttonName)
{
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_resumen_nc', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_resumen_nc\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_resumen_nc_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_resumen_nc_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_resumen_nc/grid_resumen_nc_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_resumen_nc_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=grid_resumen_nc';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_grid_resumen_nc');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_grid_resumen_nc');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_grid_resumen_nc');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_grid_resumen_nc');} \r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['grid_resumen_nc_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_resumen_nc@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_resumen_nc_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_resumen_nc_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_resumen_nc_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_resumen_nc']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_resumen_nc_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_resumen_nc')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_resumen_nc', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
