...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_imr_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_total']['imr_descripcion'];
      }
      else
      {
          $this->array_total_imr_descripcion = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_order']['imr_descripcion']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_order']['imr_descripcion'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_order']['imr_descripcion'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['imr_descripcion'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['imr_descripcion'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['imr_descripcion'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['imr_descripcion'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['imr_descripcion'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['imr_descripcion'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['imr_descripcion'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_imr_descripcion as $i_imr_descripcion => $d_imr_descripcion) {
           if (!isset($i_imr_descripcion, $this->comp_label[0]) || !in_array($i_imr_descripcion, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_imr_descripcion[3] ] = $d_imr_descripcion[2];
               $this->comp_label[0][ $d_imr_descripcion[3] ] = $d_imr_descripcion[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'imr_descripcion', 'prot' => '@aspass@'),
       );
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_imr_descripcion => $l_imr_descripcion) {
           if (isset($this->array_total_imr_descripcion[$i_imr_descripcion])) {
               $this->comp_group[$i_imr_descripcion] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_imr_descripcion;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_imr_descripcion("res", $this->NM_export);
      ...
      if (is_array($this->array_total_imr_descripcion)) {
          ksort($this->array_total_imr_descripcion);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['SC_Ind_Groupby'];
...
{ 
   ...
   //---- 
   function adiciona_registro($sum_dr_valor_retenido, $quebra_imr_descripcion, $quebra_imr_descripcion_orig)
   {
      //----- imr_descripcion
      if (!isset($this->array_total_imr_descripcion[$quebra_imr_descripcion_orig]))
      {
         $this->array_total_imr_descripcion[$quebra_imr_descripcion_orig][0] = 1;
         $this->array_total_imr_descripcion[$quebra_imr_descripcion_orig][1] = $sum_dr_valor_retenido;
         $this->array_total_imr_descripcion[$quebra_imr_descripcion_orig][2] = $quebra_imr_descripcion;
         $this->array_total_imr_descripcion[$quebra_imr_descripcion_orig][3] = $quebra_imr_descripcion_orig;
      }
      else
      {
         $this->array_total_imr_descripcion[$quebra_imr_descripcion_orig][0]++;
         $this->array_total_imr_descripcion[$quebra_imr_descripcion_orig][1] = bcadd($this->array_total_imr_descripcion[$quebra_imr_descripcion_orig][1], $sum_dr_valor_retenido, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('imr_descripcion', 'imr_descripcion');
     $campos_order = $this->Ini->Get_date_order_groupby("imr_descripcion", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->look_ret_mes_periodo_fiscal = $this->ret_mes_periodo_fiscal; 
            $this->Lookup->lookup_ret_mes_periodo_fiscal($this->look_ret_mes_periodo_fiscal, $this->ret_mes_periodo_fiscal) ; 
            $this->imr_descripcion_orig = $this->imr_descripcion;
            $this->ret_mes_periodo_fiscal = $this->look_ret_mes_periodo_fiscal ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->dr_valor_retenido, $this->imr_descripcion, $this->imr_descripcion_orig);
            }
   }
//
