...
class grid_resumen_retenciones_ventas_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_imr_descripcion;
   var $array_total_ret_fecha;
   var $array_total_ret_mes_periodo_fiscal;
   var $array_total_ret_anio_periodo_fiscal;
   var $array_total_pr_identificacion;
   var $array_total_pr_nombre;
   var $array_total_pri_descripcion;
   var $array_total_ret_usuario;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_imr_descripcion         = array();
      $this->array_total_ret_fecha               = array();
      $this->array_total_ret_mes_periodo_fiscal  = array();
      $this->array_total_ret_anio_periodo_fiscal = array();
      $this->array_total_pr_identificacion       = array();
      $this->array_total_pr_nombre               = array();
      $this->array_total_pri_descripcion         = array();
      $this->array_total_ret_usuario             = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_resumen_retenciones_ventas']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_resumen_retenciones_ventas']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_total']['imr_descripcion'] = $this->array_total_imr_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_total']['ret_fecha'] = $this->array_total_ret_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_total']['ret_mes_periodo_fiscal'] = $this->array_total_ret_mes_periodo_fiscal;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_total']['ret_anio_periodo_fiscal'] = $this->array_total_ret_anio_periodo_fiscal;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_total']['pr_identificacion'] = $this->array_total_pr_identificacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_total']['pr_nombre'] = $this->array_total_pr_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_total']['pri_descripcion'] = $this->array_total_pri_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_total']['ret_usuario'] = $this->array_total_ret_usuario;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['json_use_label'])
       {
          $Lab_imr_descripcion = "imr_descripcion";
          $Lab_ret_fecha = "ret_fecha";
          $Lab_ret_mes_periodo_fiscal = "ret_mes_periodo_fiscal";
          $Lab_ret_anio_periodo_fiscal = "ret_anio_periodo_fiscal";
          $Lab_pr_identificacion = "pr_identificacion";
          $Lab_pr_nombre = "pr_nombre";
          $Lab_pri_descripcion = "pri_descripcion";
          $Lab_ret_usuario = "ret_usuario";
       }
       else
       {
       $Lab_imr_descripcion = "" . $this->Ini->Nm_lang['lang_impuesto_retencion'] . "";
       $Lab_ret_fecha = "" . $this->Ini->Nm_lang['lang_fecha'] . "";
       $Lab_ret_mes_periodo_fiscal = "" . $this->Ini->Nm_lang['lang_mes_fiscal'] . "";
       $Lab_ret_anio_periodo_fiscal = "" . $this->Ini->Nm_lang['lang_anio_fiscal'] . "";
       $Lab_pr_identificacion = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "";
       $Lab_pr_nombre = "" . $this->Ini->Nm_lang['lang_proveedor'] . "";
       $Lab_pri_descripcion = "" . $this->Ini->Nm_lang['lang_motivo'] . " " . $this->Ini->Nm_lang['lang_retencion'] . "";
       $Lab_ret_usuario = "" . $this->Ini->Nm_lang['lang_username'] . "";
       }
       $prep_field = array();
       $prep_field['imr_descripcion'] = $Lab_imr_descripcion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['imr_descripcion'] = $Lab_imr_descripcion; 
       $prep_field['ret_fecha'] = $Lab_ret_fecha;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_fecha'] = $Lab_ret_fecha; 
       $prep_field['ret_mes_periodo_fiscal'] = $Lab_ret_mes_periodo_fiscal;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_mes_periodo_fiscal'] = $Lab_ret_mes_periodo_fiscal; 
       $prep_field['ret_anio_periodo_fiscal'] = $Lab_ret_anio_periodo_fiscal;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_anio_periodo_fiscal'] = $Lab_ret_anio_periodo_fiscal; 
       $prep_field['pr_identificacion'] = $Lab_pr_identificacion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pr_identificacion'] = $Lab_pr_identificacion; 
       $prep_field['pr_nombre'] = $Lab_pr_nombre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pr_nombre'] = $Lab_pr_nombre; 
       $prep_field['pri_descripcion'] = $Lab_pri_descripcion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pri_descripcion'] = $Lab_pri_descripcion; 
       $prep_field['ret_usuario'] = $Lab_ret_usuario;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_usuario'] = $Lab_ret_usuario; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_serie'] = "" . $this->Ini->Nm_lang['lang_serie_sri'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['secuencial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['secuencial'] = "" . $this->Ini->Nm_lang['lang_secuencial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_mes_periodo_fiscal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_mes_periodo_fiscal'] = "" . $this->Ini->Nm_lang['lang_mes_fiscal'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_anio_periodo_fiscal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_anio_periodo_fiscal'] = "" . $this->Ini->Nm_lang['lang_anio_fiscal'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pr_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pr_nombre'] = "" . $this->Ini->Nm_lang['lang_proveedor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pr_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pr_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['dr_cod_doc_sustento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['dr_cod_doc_sustento'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . " Sustento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['serie_doc_sustento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['serie_doc_sustento'] = "" . $this->Ini->Nm_lang['lang_documento_sustento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pri_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pri_descripcion'] = "" . $this->Ini->Nm_lang['lang_motivo'] . " " . $this->Ini->Nm_lang['lang_retencion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pri_porcentaje']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pri_porcentaje'] = "" . $this->Ini->Nm_lang['lang_porcentaje_retencion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['dr_base_imponible']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['dr_base_imponible'] = "" . $this->Ini->Nm_lang['lang_base_imponible'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['dr_valor_retenido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['dr_valor_retenido'] = "" . $this->Ini->Nm_lang['lang_valor_retenido'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['imr_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['imr_descripcion'] = "" . $this->Ini->Nm_lang['lang_impuesto'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pr_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pr_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pr_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pr_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pr_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pr_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pri_codigo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['pri_codigo'] = "" . $this->Ini->Nm_lang['lang_codigo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_usuario'] = "" . $this->Ini->Nm_lang['lang_username'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_numero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_numero'] = "" . $this->Ini->Nm_lang['lang_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_estado_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['labels']['ret_estado_sri'] = "" . $this->Ini->Nm_lang['lang_estado_sri'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "" .  $this->Ini->Nm_lang['lang_valor_retenido'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "dr_valor_retenido", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_dr_valor_retenido_sum",
       );

       //-----
       $this->comp_sum_nm = array(
           2 => "dr_valor_retenido_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['imr_descripcion']['alin'] = "''";
       $Arr_parms['imr_descripcion']['link'] = "S";
       $Arr_parms['ret_fecha']['alin'] = "''";
       $Arr_parms['ret_fecha']['link'] = "S";
       $Arr_parms['ret_mes_periodo_fiscal']['alin'] = "''";
       $Arr_parms['ret_mes_periodo_fiscal']['link'] = "S";
       $Arr_parms['ret_anio_periodo_fiscal']['alin'] = "''";
       $Arr_parms['ret_anio_periodo_fiscal']['link'] = "S";
       $Arr_parms['pr_identificacion']['alin'] = "''";
       $Arr_parms['pr_identificacion']['link'] = "S";
       $Arr_parms['pr_nombre']['alin'] = "''";
       $Arr_parms['pr_nombre']['link'] = "S";
       $Arr_parms['pri_descripcion']['alin'] = "''";
       $Arr_parms['pri_descripcion']['link'] = "S";
       $Arr_parms['ret_usuario']['alin'] = "''";
       $Arr_parms['ret_usuario']['link'] = "S";
       $Arr_parms['imr_descripcion']['fill'] = "true";
       $Arr_parms['imr_descripcion']['order'] = "label";
       $Arr_parms['imr_descripcion']['order_start'] = 'asc';
       $Arr_parms['imr_descripcion']['order_invert'] = 'false';
       $Arr_parms['imr_descripcion']['order_enabled'] = 'true';
       $Arr_parms['imr_descripcion']['order_datatype'] = 'varchar';
       $Arr_parms['imr_descripcion']['rating_function'] = '';
       $Arr_parms['ret_fecha']['fill'] = "true";
       $Arr_parms['ret_fecha']['order'] = "value";
       $Arr_parms['ret_fecha']['order_start'] = 'asc';
       $Arr_parms['ret_fecha']['order_invert'] = 'false';
       $Arr_parms['ret_fecha']['order_enabled'] = 'true';
       $Arr_parms['ret_fecha']['order_datatype'] = 'date';
       $Arr_parms['ret_fecha']['rating_function'] = '';
       $Arr_parms['ret_mes_periodo_fiscal']['fill'] = "true";
       $Arr_parms['ret_mes_periodo_fiscal']['order'] = "label";
       $Arr_parms['ret_mes_periodo_fiscal']['order_start'] = 'asc';
       $Arr_parms['ret_mes_periodo_fiscal']['order_invert'] = 'false';
       $Arr_parms['ret_mes_periodo_fiscal']['order_enabled'] = 'true';
       $Arr_parms['ret_mes_periodo_fiscal']['order_datatype'] = 'varchar';
       $Arr_parms['ret_mes_periodo_fiscal']['rating_function'] = '';
       $Arr_parms['ret_anio_periodo_fiscal']['fill'] = "true";
       $Arr_parms['ret_anio_periodo_fiscal']['order'] = "label";
       $Arr_parms['ret_anio_periodo_fiscal']['order_start'] = 'asc';
       $Arr_parms['ret_anio_periodo_fiscal']['order_invert'] = 'false';
       $Arr_parms['ret_anio_periodo_fiscal']['order_enabled'] = 'true';
       $Arr_parms['ret_anio_periodo_fiscal']['order_datatype'] = 'int4';
       $Arr_parms['ret_anio_periodo_fiscal']['rating_function'] = '';
       $Arr_parms['pr_identificacion']['fill'] = "true";
       $Arr_parms['pr_identificacion']['order'] = "label";
       $Arr_parms['pr_identificacion']['order_start'] = 'asc';
       $Arr_parms['pr_identificacion']['order_invert'] = 'false';
       $Arr_parms['pr_identificacion']['order_enabled'] = 'true';
       $Arr_parms['pr_identificacion']['order_datatype'] = 'varchar';
       $Arr_parms['pr_identificacion']['rating_function'] = '';
       $Arr_parms['pr_nombre']['fill'] = "true";
       $Arr_parms['pr_nombre']['order'] = "label";
       $Arr_parms['pr_nombre']['order_start'] = 'asc';
       $Arr_parms['pr_nombre']['order_invert'] = 'false';
       $Arr_parms['pr_nombre']['order_enabled'] = 'true';
       $Arr_parms['pr_nombre']['order_datatype'] = 'varchar';
       $Arr_parms['pr_nombre']['rating_function'] = '';
       $Arr_parms['pri_descripcion']['fill'] = "true";
       $Arr_parms['pri_descripcion']['order'] = "label";
       $Arr_parms['pri_descripcion']['order_start'] = 'asc';
       $Arr_parms['pri_descripcion']['order_invert'] = 'false';
       $Arr_parms['pri_descripcion']['order_enabled'] = 'true';
       $Arr_parms['pri_descripcion']['order_datatype'] = 'varchar';
       $Arr_parms['pri_descripcion']['rating_function'] = '';
       $Arr_parms['ret_usuario']['fill'] = "true";
       $Arr_parms['ret_usuario']['order'] = "label";
       $Arr_parms['ret_usuario']['order_start'] = 'asc';
       $Arr_parms['ret_usuario']['order_invert'] = 'false';
       $Arr_parms['ret_usuario']['order_enabled'] = 'true';
       $Arr_parms['ret_usuario']['order_datatype'] = 'varchar';
       $Arr_parms['ret_usuario']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['imr_descripcion'] = array(0 => 'imr_descripcion', 1 => '@aspass@');
       $prep_links_fl['ret_fecha'] = array(0 => 'ret_fecha', 1 => '@aspass@');
       $prep_links_fl['ret_mes_periodo_fiscal'] = array(0 => 'ret_mes_periodo_fiscal', 1 => '@aspass@');
       $prep_links_fl['ret_anio_periodo_fiscal'] = array(0 => 'ret_anio_periodo_fiscal', 1 => '');
       $prep_links_fl['pr_identificacion'] = array(0 => 'pr_identificacion', 1 => '@aspass@');
       $prep_links_fl['pr_nombre'] = array(0 => 'pr_nombre', 1 => '@aspass@');
       $prep_links_fl['pri_descripcion'] = array(0 => 'pri_descripcion', 1 => '@aspass@');
       $prep_links_fl['ret_usuario'] = array(0 => 'ret_usuario', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_resumen_retenciones_ventas@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_resumen_retenciones_ventas_total.class.php"); 
      }
      ...
      $this->Total   = new grid_resumen_retenciones_ventas_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['ajax_nav']) {  
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_retenciones_ventas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_resumen_retenciones_ventas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_retenciones_ventas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_resumen_retenciones_ventas/grid_resumen_retenciones_ventas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_retenciones_ventas/grid_resumen_retenciones_ventas_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_resumen_retenciones_ventas&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_retenciones_ventas/grid_resumen_retenciones_ventas_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_retenciones_ventas/grid_resumen_retenciones_ventas_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_resumen_retenciones_ventas_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_resumen_retenciones_ventas']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_resumen_retenciones_ventas']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_resumen_retenciones_ventas_config_pivot.php?nome_apl=grid_resumen_retenciones_ventas&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_resumen_retenciones_ventas_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_retenciones_ventas_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_resumen_retenciones_ventas/grid_resumen_retenciones_ventas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $ret_fecha = (isset($Busca_temp['ret_fecha'])) ? $Busca_temp['ret_fecha'] : ""; 
          $tmp_pos = (is_string($ret_fecha)) ? strpos($ret_fecha, "##@@") : false;
          if ($tmp_pos !== false && !is_array($ret_fecha))
          {
              $ret_fecha = substr($ret_fecha, 0, $tmp_pos);
          }
          $ret_fecha_2 = (isset($Busca_temp['ret_fecha_input_2'])) ? $Busca_temp['ret_fecha_input_2'] : ""; 
          $imr_descripcion = (isset($Busca_temp['imr_descripcion'])) ? $Busca_temp['imr_descripcion'] : ""; 
          $tmp_pos = (is_string($imr_descripcion)) ? strpos($imr_descripcion, "##@@") : false;
          if ($tmp_pos !== false && !is_array($imr_descripcion))
          {
              $imr_descripcion = substr($imr_descripcion, 0, $tmp_pos);
          }
          $ret_serie = (isset($Busca_temp['ret_serie'])) ? $Busca_temp['ret_serie'] : ""; 
          $tmp_pos = (is_string($ret_serie)) ? strpos($ret_serie, "##@@") : false;
          if ($tmp_pos !== false && !is_array($ret_serie))
          {
              $ret_serie = substr($ret_serie, 0, $tmp_pos);
          }
          $ret_mes_periodo_fiscal = (isset($Busca_temp['ret_mes_periodo_fiscal'])) ? $Busca_temp['ret_mes_periodo_fiscal'] : ""; 
          $tmp_pos = (is_string($ret_mes_periodo_fiscal)) ? strpos($ret_mes_periodo_fiscal, "##@@") : false;
          if ($tmp_pos !== false && !is_array($ret_mes_periodo_fiscal))
          {
              $ret_mes_periodo_fiscal = substr($ret_mes_periodo_fiscal, 0, $tmp_pos);
          }
          $ret_anio_periodo_fiscal = (isset($Busca_temp['ret_anio_periodo_fiscal'])) ? $Busca_temp['ret_anio_periodo_fiscal'] : ""; 
          $tmp_pos = (is_string($ret_anio_periodo_fiscal)) ? strpos($ret_anio_periodo_fiscal, "##@@") : false;
          if ($tmp_pos !== false && !is_array($ret_anio_periodo_fiscal))
          {
              $ret_anio_periodo_fiscal = substr($ret_anio_periodo_fiscal, 0, $tmp_pos);
          }
          $pr_identificacion = (isset($Busca_temp['pr_identificacion'])) ? $Busca_temp['pr_identificacion'] : ""; 
          $tmp_pos = (is_string($pr_identificacion)) ? strpos($pr_identificacion, "##@@") : false;
          if ($tmp_pos !== false && !is_array($pr_identificacion))
          {
              $pr_identificacion = substr($pr_identificacion, 0, $tmp_pos);
          }
          $pr_nombre = (isset($Busca_temp['pr_nombre'])) ? $Busca_temp['pr_nombre'] : ""; 
          $tmp_pos = (is_string($pr_nombre)) ? strpos($pr_nombre, "##@@") : false;
          if ($tmp_pos !== false && !is_array($pr_nombre))
          {
              $pr_nombre = substr($pr_nombre, 0, $tmp_pos);
          }
          $pri_descripcion = (isset($Busca_temp['pri_descripcion'])) ? $Busca_temp['pri_descripcion'] : ""; 
          $tmp_pos = (is_string($pri_descripcion)) ? strpos($pri_descripcion, "##@@") : false;
          if ($tmp_pos !== false && !is_array($pri_descripcion))
          {
              $pri_descripcion = substr($pri_descripcion, 0, $tmp_pos);
          }
          $ret_usuario = (isset($Busca_temp['ret_usuario'])) ? $Busca_temp['ret_usuario'] : ""; 
          $tmp_pos = (is_string($ret_usuario)) ? strpos($ret_usuario, "##@@") : false;
          if ($tmp_pos !== false && !is_array($ret_usuario))
          {
              $ret_usuario = substr($ret_usuario, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($sum_dr_valor_retenido, $quebra_imr_descripcion, $quebra_ret_fecha, $quebra_ret_mes_periodo_fiscal, $quebra_ret_anio_periodo_fiscal, $quebra_pr_identificacion, $quebra_pr_nombre, $quebra_pri_descripcion, $quebra_ret_usuario, $quebra_imr_descripcion_orig, $quebra_ret_fecha_orig, $quebra_ret_mes_periodo_fiscal_orig, $quebra_ret_anio_periodo_fiscal_orig, $quebra_pr_identificacion_orig, $quebra_pr_nombre_orig, $quebra_pri_descripcion_orig, $quebra_ret_usuario_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones_ventas']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_dr_valor_retenido)) {$sum_dr_valor_retenido = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_dr_valor_retenido . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_dr_valor_retenido . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->ret_fecha = $Busca_temp['ret_fecha']; 
       $this->ret_fecha = (isset($Busca_temp['ret_fecha'])) ? $Busca_temp['ret_fecha'] : ""; 
       $tmp_pos = (is_string($this->ret_fecha)) ? strpos($this->ret_fecha, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ret_fecha))
       {
       ...
       $ret_fecha_2 = (isset($Busca_temp['ret_fecha_input_2'])) ? $Busca_temp['ret_fecha_input_2'] : ""; 
       $this->ret_fecha_2 = $ret_fecha_2; 
       $this->imr_descripcion = $Busca_temp['imr_descripcion']; 
       $this->imr_descripcion = (isset($Busca_temp['imr_descripcion'])) ? $Busca_temp['imr_descripcion'] : ""; 
       $tmp_pos = (is_string($this->imr_descripcion)) ? strpos($this->imr_descripcion, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->imr_descripcion))
       {
       ...
       $this->ret_serie = $Busca_temp['ret_serie']; 
       $this->ret_serie = (isset($Busca_temp['ret_serie'])) ? $Busca_temp['ret_serie'] : ""; 
       $tmp_pos = (is_string($this->ret_serie)) ? strpos($this->ret_serie, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ret_serie))
       {
       ...
       $this->ret_mes_periodo_fiscal = $Busca_temp['ret_mes_periodo_fiscal']; 
       $this->ret_mes_periodo_fiscal = (isset($Busca_temp['ret_mes_periodo_fiscal'])) ? $Busca_temp['ret_mes_periodo_fiscal'] : ""; 
       $tmp_pos = (is_string($this->ret_mes_periodo_fiscal)) ? strpos($this->ret_mes_periodo_fiscal, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ret_mes_periodo_fiscal))
       {
       ...
       $this->ret_anio_periodo_fiscal = $Busca_temp['ret_anio_periodo_fiscal']; 
       $this->ret_anio_periodo_fiscal = (isset($Busca_temp['ret_anio_periodo_fiscal'])) ? $Busca_temp['ret_anio_periodo_fiscal'] : ""; 
       $tmp_pos = (is_string($this->ret_anio_periodo_fiscal)) ? strpos($this->ret_anio_periodo_fiscal, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ret_anio_periodo_fiscal))
       {
       ...
       $this->pr_identificacion = $Busca_temp['pr_identificacion']; 
       $this->pr_identificacion = (isset($Busca_temp['pr_identificacion'])) ? $Busca_temp['pr_identificacion'] : ""; 
       $tmp_pos = (is_string($this->pr_identificacion)) ? strpos($this->pr_identificacion, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->pr_identificacion))
       {
       ...
       $this->pr_nombre = $Busca_temp['pr_nombre']; 
       $this->pr_nombre = (isset($Busca_temp['pr_nombre'])) ? $Busca_temp['pr_nombre'] : ""; 
       $tmp_pos = (is_string($this->pr_nombre)) ? strpos($this->pr_nombre, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->pr_nombre))
       {
       ...
       $this->pri_descripcion = $Busca_temp['pri_descripcion']; 
       $this->pri_descripcion = (isset($Busca_temp['pri_descripcion'])) ? $Busca_temp['pri_descripcion'] : ""; 
       $tmp_pos = (is_string($this->pri_descripcion)) ? strpos($this->pri_descripcion, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->pri_descripcion))
       {
       ...
       $this->ret_usuario = $Busca_temp['ret_usuario']; 
       $this->ret_usuario = (isset($Busca_temp['ret_usuario'])) ? $Busca_temp['ret_usuario'] : ""; 
       $tmp_pos = (is_string($this->ret_usuario)) ? strpos($this->ret_usuario, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->ret_usuario))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->ret_fecha = $rs_res->fields[0] ;  
            $this->ret_serie = $rs_res->fields[1] ;  
            $this->secuencial = $rs_res->fields[2] ;  
            $this->ret_mes_periodo_fiscal = $rs_res->fields[3] ;  
            $this->ret_anio_periodo_fiscal = $rs_res->fields[4] ;  
            $this->pr_nombre = $rs_res->fields[5] ;  
            $this->pr_identificacion = $rs_res->fields[6] ;  
            $this->dr_cod_doc_sustento = $rs_res->fields[7] ;  
            $this->serie_doc_sustento = $rs_res->fields[8] ;  
            $this->pri_descripcion = $rs_res->fields[9] ;  
            $this->pri_porcentaje = $rs_res->fields[10] ;  
            $this->pri_porcentaje =  str_replace(",", ".", $this->pri_porcentaje);
            $this->dr_base_imponible = $rs_res->fields[11] ;  
            $this->dr_valor_retenido = $rs_res->fields[12] ;  
            $this->imr_descripcion = $rs_res->fields[13] ;  
            $this->pr_direccion = $rs_res->fields[14] ;  
            $this->pr_email = $rs_res->fields[15] ;  
            $this->pr_telefono = $rs_res->fields[16] ;  
            $this->pri_codigo = $rs_res->fields[17] ;  
            $this->ret_usuario = $rs_res->fields[18] ;  
            $this->imr_descripcion_orig = $this->imr_descripcion;
            $this->ret_fecha_orig = $this->ret_fecha;
            $this->ret_mes_periodo_fiscal_orig = $this->ret_mes_periodo_fiscal;
            $this->ret_anio_periodo_fiscal_orig = $this->ret_anio_periodo_fiscal;
            $this->pr_identificacion_orig = $this->pr_identificacion;
            $this->pr_nombre_orig = $this->pr_nombre;
            $this->pri_descripcion_orig = $this->pri_descripcion;
            $this->ret_usuario_orig = $this->ret_usuario;
            nmgp_Form_Num_Val($this->ret_anio_periodo_fiscal, "", ",", "0", "S", "2", "", "N:", "-") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->dr_valor_retenido, $this->imr_descripcion, $this->ret_fecha, $this->ret_mes_periodo_fiscal, $this->ret_anio_periodo_fiscal, $this->pr_identificacion, $this->pr_nombre, $this->pri_descripcion, $this->ret_usuario, $this->imr_descripcion_orig,  $this->ret_fecha_orig,  $this->ret_mes_periodo_fiscal_orig,  $this->ret_anio_periodo_fiscal_orig,  $this->pr_identificacion_orig,  $this->pr_nombre_orig,  $this->pri_descripcion_orig,  $this->ret_usuario_orig);
            }
   }
//
