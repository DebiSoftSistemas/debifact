  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_canton_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_canton_inline_form();
	}
...
?>
  ...
  // ---------- Validate can_id_
  function do_ajax_form_sis_canton_inline_validate_can_id_()
  {
    var nomeCampo_can_id_ = "can_id_";
    var var_can_id_ = scAjaxGetFieldHidden(nomeCampo_can_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_canton_inline_validate_can_id_(var_can_id_, var_script_case_init, do_ajax_form_sis_canton_inline_validate_can_id__cb);
  } // do_ajax_form_sis_canton_inline_validate_can_id_

  function do_ajax_form_sis_canton_inline_validate_can_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_canton_inline_validate_can_id__cb

  // ---------- Validate can_pais_
  function do_ajax_form_sis_canton_inline_validate_can_pais_()
  {
    var nomeCampo_can_pais_ = "can_pais_";
    var var_can_pais_ = scAjaxGetFieldSelect(nomeCampo_can_pais_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_canton_inline_validate_can_pais_(var_can_pais_, var_script_case_init, do_ajax_form_sis_canton_inline_validate_can_pais__cb);
  } // do_ajax_form_sis_canton_inline_validate_can_pais_

  function do_ajax_form_sis_canton_inline_validate_can_pais__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_canton_inline_validate_can_pais__cb

  // ---------- Validate can_provincia_
  function do_ajax_form_sis_canton_inline_validate_can_provincia_()
  {
    var nomeCampo_can_provincia_ = "can_provincia_";
    var var_can_provincia_ = scAjaxGetFieldSelect(nomeCampo_can_provincia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_canton_inline_validate_can_provincia_(var_can_provincia_, var_script_case_init, do_ajax_form_sis_canton_inline_validate_can_provincia__cb);
  } // do_ajax_form_sis_canton_inline_validate_can_provincia_

  function do_ajax_form_sis_canton_inline_validate_can_provincia__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_canton_inline_validate_can_provincia__cb

  // ---------- Validate can_nombre_
  function do_ajax_form_sis_canton_inline_validate_can_nombre_()
  {
    var nomeCampo_can_nombre_ = "can_nombre_";
    var var_can_nombre_ = scAjaxGetFieldText(nomeCampo_can_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_canton_inline_validate_can_nombre_(var_can_nombre_, var_script_case_init, do_ajax_form_sis_canton_inline_validate_can_nombre__cb);
  } // do_ajax_form_sis_canton_inline_validate_can_nombre_

  function do_ajax_form_sis_canton_inline_validate_can_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_canton_inline_validate_can_nombre__cb

  // ---------- Validate can_codigo_
  function do_ajax_form_sis_canton_inline_validate_can_codigo_()
  {
    var nomeCampo_can_codigo_ = "can_codigo_";
    var var_can_codigo_ = scAjaxGetFieldText(nomeCampo_can_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_canton_inline_validate_can_codigo_(var_can_codigo_, var_script_case_init, do_ajax_form_sis_canton_inline_validate_can_codigo__cb);
  } // do_ajax_form_sis_canton_inline_validate_can_codigo_

  function do_ajax_form_sis_canton_inline_validate_can_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_canton_inline_validate_can_codigo__cb

  // ---------- Refresh can_pais_
  function do_ajax_form_sis_canton_inline_refresh_can_pais_()
  {
    var var_can_pais_ = scAjaxGetFieldSelect("can_pais_");
    var var_nmgp_refresh_fields = "can_provincia_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_canton_inline_refresh_can_pais_(var_can_pais_, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_canton_inline_refresh_can_pais__cb);
  } // do_ajax_form_sis_canton_inline_refresh_can_pais_

  function do_ajax_form_sis_canton_inline_refresh_can_pais__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_canton_inline_refresh_can_pais__cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_canton_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_canton_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_can_id_ = scAjaxGetFieldHidden("can_id_");
    var var_can_pais_ = scAjaxGetFieldSelect("can_pais_");
    var var_can_provincia_ = scAjaxGetFieldSelect("can_provincia_");
    var var_can_nombre_ = scAjaxGetFieldText("can_nombre_");
    var var_can_codigo_ = scAjaxGetFieldText("can_codigo_");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_canton_inline_submit_form(var_can_id_, var_can_pais_, var_can_provincia_, var_can_nombre_, var_can_codigo_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_canton_inline_submit_form_cb);
  } // do_ajax_form_sis_canton_inline_submit_form

  function do_ajax_form_sis_canton_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("can_id_");
      scAjaxHideErrorDisplay("can_pais_");
      scAjaxHideErrorDisplay("can_provincia_");
      scAjaxHideErrorDisplay("can_nombre_");
      scAjaxHideErrorDisplay("can_codigo_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_canton_inline_submit_form_cb_after_alert);
  } // do_ajax_form_sis_canton_inline_submit_form_cb
  function do_ajax_form_sis_canton_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_canton_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_canton_inline_navigate_form()
  {
    perform_ajax_form_sis_canton_inline_navigate_form();
  }

  function perform_ajax_form_sis_canton_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_canton_inline_navigate_form(var_can_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_canton_inline_navigate_form_cb);
  } // do_ajax_form_sis_canton_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_canton_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_canton_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_canton_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_canton_inline_navigate_form_cb
  function do_ajax_form_sis_canton_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sis_canton_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_canton_inline_navigate_form_cb_after_alert

  function sc_hide_form_sis_canton_inline_form()
  {
  ...
  ajax_field_list[0] = "can_id_";
  ajax_field_list[1] = "can_pais_";
  ajax_field_list[2] = "can_provincia_";
  ajax_field_list[3] = "can_nombre_";
  ajax_field_list[4] = "can_codigo_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "can_id_": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "can_pais_": {"label": "<?php echo $this->Ini->Nm_lang['lang_pais'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "can_provincia_": {"label": "<?php echo $this->Ini->Nm_lang['lang_provincia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "can_nombre_": {"label": "<?php echo $this->Ini->Nm_lang['lang_ciudad'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "can_codigo_": {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["can_id_"][1] = "can_id_";
  ajax_field_mult["can_pais_"][1] = "can_pais_";
  ajax_field_mult["can_provincia_"][1] = "can_provincia_";
  ajax_field_mult["can_nombre_"][1] = "can_nombre_";
  ajax_field_mult["can_codigo_"][1] = "can_codigo_";

  var ajax_field_id = {
    "can_id_": new Array("hidden_field_label_can_id_", "hidden_field_data_can_id_"),
    "can_pais_": new Array("hidden_field_label_can_pais_", "hidden_field_data_can_pais_"),
    "can_provincia_": new Array("hidden_field_label_can_provincia_", "hidden_field_data_can_provincia_"),
    "can_nombre_": new Array("hidden_field_label_can_nombre_", "hidden_field_data_can_nombre_"),
    "can_codigo_": new Array("hidden_field_label_can_codigo_", "hidden_field_data_can_codigo_")
  };
