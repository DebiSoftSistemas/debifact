  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_canton" == sTestField)
        {
...
?>
  ...
  // ---------- Validate can_id_
  function do_ajax_form_sis_canton_validate_can_id_(iNumLinha)
  {
    var nomeCampo_can_id_ = "can_id_" + iNumLinha;
    var var_can_id_ = scAjaxGetFieldHidden(nomeCampo_can_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_canton_validate_can_id_(var_can_id_, iNumLinha, var_script_case_init, do_ajax_form_sis_canton_validate_can_id__cb);
  } // do_ajax_form_sis_canton_validate_can_id_

  function do_ajax_form_sis_canton_validate_can_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "can_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "can_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "can_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "can_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_canton_validate_can_id__cb

  // ---------- Validate can_pais_
  function do_ajax_form_sis_canton_validate_can_pais_(iNumLinha)
  {
    var nomeCampo_can_pais_ = "can_pais_" + iNumLinha;
    var var_can_pais_ = scAjaxGetFieldSelect(nomeCampo_can_pais_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_canton_validate_can_pais_(var_can_pais_, iNumLinha, var_script_case_init, do_ajax_form_sis_canton_validate_can_pais__cb);
  } // do_ajax_form_sis_canton_validate_can_pais_

  function do_ajax_form_sis_canton_validate_can_pais__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "can_pais_" + iLineNumber;
    }
    else
    {
      sFieldValid = "can_pais_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "can_pais_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "can_pais_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_canton_validate_can_pais__cb

  // ---------- Validate can_provincia_
  function do_ajax_form_sis_canton_validate_can_provincia_(iNumLinha)
  {
    var nomeCampo_can_provincia_ = "can_provincia_" + iNumLinha;
    var var_can_provincia_ = scAjaxGetFieldSelect(nomeCampo_can_provincia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_canton_validate_can_provincia_(var_can_provincia_, iNumLinha, var_script_case_init, do_ajax_form_sis_canton_validate_can_provincia__cb);
  } // do_ajax_form_sis_canton_validate_can_provincia_

  function do_ajax_form_sis_canton_validate_can_provincia__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "can_provincia_" + iLineNumber;
    }
    else
    {
      sFieldValid = "can_provincia_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "can_provincia_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "can_provincia_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_canton_validate_can_provincia__cb

  // ---------- Validate can_nombre_
  function do_ajax_form_sis_canton_validate_can_nombre_(iNumLinha)
  {
    var nomeCampo_can_nombre_ = "can_nombre_" + iNumLinha;
    var var_can_nombre_ = scAjaxGetFieldText(nomeCampo_can_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_canton_validate_can_nombre_(var_can_nombre_, iNumLinha, var_script_case_init, do_ajax_form_sis_canton_validate_can_nombre__cb);
  } // do_ajax_form_sis_canton_validate_can_nombre_

  function do_ajax_form_sis_canton_validate_can_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "can_nombre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "can_nombre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "can_nombre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "can_nombre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_canton_validate_can_nombre__cb

  // ---------- Validate can_codigo_
  function do_ajax_form_sis_canton_validate_can_codigo_(iNumLinha)
  {
    var nomeCampo_can_codigo_ = "can_codigo_" + iNumLinha;
    var var_can_codigo_ = scAjaxGetFieldText(nomeCampo_can_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_canton_validate_can_codigo_(var_can_codigo_, iNumLinha, var_script_case_init, do_ajax_form_sis_canton_validate_can_codigo__cb);
  } // do_ajax_form_sis_canton_validate_can_codigo_

  function do_ajax_form_sis_canton_validate_can_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "can_codigo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "can_codigo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "can_codigo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "can_codigo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_canton_validate_can_codigo__cb

  // ---------- Refresh can_pais_
  function do_ajax_form_sis_canton_refresh_can_pais_(iSeqForm)
  {
    var var_can_pais_ = scAjaxGetFieldSelect("can_pais_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "can_provincia_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_canton_refresh_can_pais_(var_can_pais_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_canton_refresh_can_pais__cb);
  } // do_ajax_form_sis_canton_refresh_can_pais_

  function do_ajax_form_sis_canton_refresh_can_pais__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_canton_refresh_can_pais__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_canton_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_canton_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_canton_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_canton_add_new_line_cb);
  } // do_ajax_form_sis_canton_add_new_line

  function do_ajax_form_sis_canton_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_canton_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_canton_backup_line(iNumLinha)
  {
    var var_can_id_ = scAjaxGetFieldHidden("can_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_canton_backup_line(var_can_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_canton_backup_line_cb);
  } // do_ajax_form_sis_canton_backup_line

  function do_ajax_form_sis_canton_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_canton_backup_line_cb

  function do_ajax_form_sis_canton_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_canton_cancel_insert

  function do_ajax_form_sis_canton_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_canton_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_canton_cancel_update

  function do_ajax_form_sis_canton_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_canton_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_canton_table_refresh()
  {
    var var_can_id_ = document.F2.can_id_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_canton_table_refresh(var_can_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_canton_table_refresh_cb);
  } //  do_ajax_form_sis_canton_table_refresh

  function do_ajax_form_sis_canton_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.can_id_.value = scAjaxGetKeyValue("can_id_");
    ...
    scAjaxAlert(do_ajax_form_sis_canton_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_canton_table_refresh_cb
  function do_ajax_form_sis_canton_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_canton_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_canton_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_canton_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_can_id_ = scAjaxGetFieldHidden("can_id_" + iNumLinha);
    var var_can_pais_ = scAjaxGetFieldSelect("can_pais_" + iNumLinha);
    var var_can_provincia_ = scAjaxGetFieldSelect("can_provincia_" + iNumLinha);
    var var_can_nombre_ = scAjaxGetFieldText("can_nombre_" + iNumLinha);
    var var_can_codigo_ = scAjaxGetFieldText("can_codigo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_canton_submit_form(var_can_id_, var_can_pais_, var_can_provincia_, var_can_nombre_, var_can_codigo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_canton_submit_form_cb);
  } // do_ajax_form_sis_canton_submit_form

  function do_ajax_form_sis_canton_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("can_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("can_pais_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("can_provincia_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("can_nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("can_codigo_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_canton_submit_form_cb_after_alert);
  } // do_ajax_form_sis_canton_submit_form_cb
  function do_ajax_form_sis_canton_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_canton_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_canton_navigate_form()
  {
    perform_ajax_form_sis_canton_navigate_form();
  }

  function perform_ajax_form_sis_canton_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_canton_cancel_insert(sc_form_sis_canton_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("can_id_" + iNavForm);
      scAjaxHideErrorDisplay("can_pais_" + iNavForm);
      scAjaxHideErrorDisplay("can_provincia_" + iNavForm);
      scAjaxHideErrorDisplay("can_nombre_" + iNavForm);
      scAjaxHideErrorDisplay("can_codigo_" + iNavForm);
    }
    var var_can_id_ = document.F2.can_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_canton_navigate_form(var_can_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_canton_navigate_form_cb);
  } // do_ajax_form_sis_canton_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_canton']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_canton_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.can_id_.value = scAjaxGetKeyValue("can_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_canton_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_canton_navigate_form_cb
  function do_ajax_form_sis_canton_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_canton_navigate_form_cb_after_alert

    function sc_form_sis_canton_get_last_line_number()
    {
    ...
    } //sc_form_sis_canton_get_last_line_number

  function sc_hide_form_sis_canton_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "can_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "can_pais_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "can_provincia_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "can_nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "can_codigo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["can_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["can_pais_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_pais'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["can_provincia_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_provincia'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["can_nombre_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_ciudad'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["can_codigo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["can_id_"][iNumLinha] = "can_id_" + iNumLinha;
    ajax_field_mult["can_pais_"][iNumLinha] = "can_pais_" + iNumLinha;
    ajax_field_mult["can_provincia_"][iNumLinha] = "can_provincia_" + iNumLinha;
    ajax_field_mult["can_nombre_"][iNumLinha] = "can_nombre_" + iNumLinha;
    ajax_field_mult["can_codigo_"][iNumLinha] = "can_codigo_" + iNumLinha;
    ajax_field_id["can_id_" + iNumLinha] = new Array("hidden_field_label_can_id_", "hidden_field_data_can_id_" + iNumLinha);
    ajax_field_id["can_pais_" + iNumLinha] = new Array("hidden_field_label_can_pais_", "hidden_field_data_can_pais_" + iNumLinha);
    ajax_field_id["can_provincia_" + iNumLinha] = new Array("hidden_field_label_can_provincia_", "hidden_field_data_can_provincia_" + iNumLinha);
    ajax_field_id["can_nombre_" + iNumLinha] = new Array("hidden_field_label_can_nombre_", "hidden_field_data_can_nombre_" + iNumLinha);
    ajax_field_id["can_codigo_" + iNumLinha] = new Array("hidden_field_label_can_codigo_", "hidden_field_data_can_codigo_" + iNumLinha);
    ajax_error_count["can_id_" + iNumLinha] = "off";
    ajax_error_count["can_pais_" + iNumLinha] = "off";
    ajax_error_count["can_provincia_" + iNumLinha] = "off";
    ajax_error_count["can_nombre_" + iNumLinha] = "off";
    ajax_error_count["can_codigo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["can_id_" + iNumLinha] = "on";
    ajax_read_only["can_pais_" + iNumLinha] = "off";
    ajax_read_only["can_provincia_" + iNumLinha] = "off";
    ajax_read_only["can_nombre_" + iNumLinha] = "off";
    ajax_read_only["can_codigo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["can_id_" + iNumLinha] = "on";
    ajax_read_only["can_pais_" + iNumLinha] = "on";
    ajax_read_only["can_provincia_" + iNumLinha] = "on";
    ajax_read_only["can_nombre_" + iNumLinha] = "on";
    ajax_read_only["can_codigo_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["can_id_" + iNumLinha] = null;
    ajax_error_list["can_pais_" + iNumLinha] = null;
    ajax_error_list["can_provincia_" + iNumLinha] = null;
    ajax_error_list["can_nombre_" + iNumLinha] = null;
    ajax_error_list["can_codigo_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "can_id_": new Array(),
    "can_pais_": new Array(),
    "can_provincia_": new Array(),
    "can_nombre_": new Array(),
    "can_codigo_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["can_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["can_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["can_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["can_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["can_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["can_pais_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["can_pais_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["can_pais_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["can_pais_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["can_pais_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["can_provincia_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["can_provincia_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["can_provincia_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["can_provincia_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["can_provincia_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["can_nombre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["can_nombre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["can_nombre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["can_nombre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["can_nombre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["can_codigo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["can_codigo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["can_codigo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["can_codigo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["can_codigo_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['can_id_'])) ? $this->nmgp_cmp_readonly['can_id_'] : 'on';
?>
    scAjaxFieldRead("can_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['can_pais_'])) ? $this->nmgp_cmp_readonly['can_pais_'] : 'off';
?>
    scAjaxFieldRead("can_pais_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['can_provincia_'])) ? $this->nmgp_cmp_readonly['can_provincia_'] : 'off';
?>
    scAjaxFieldRead("can_provincia_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['can_nombre_'])) ? $this->nmgp_cmp_readonly['can_nombre_'] : 'off';
?>
    scAjaxFieldRead("can_nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['can_codigo_'])) ? $this->nmgp_cmp_readonly['can_codigo_'] : 'off';
?>
    scAjaxFieldRead("can_codigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("can_id_" + iSeq, "on");
    scAjaxFieldRead("can_pais_" + iSeq, "on");
    scAjaxFieldRead("can_provincia_" + iSeq, "on");
    scAjaxFieldRead("can_nombre_" + iSeq, "on");
    scAjaxFieldRead("can_codigo_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["can_id_" + iRow] || "on" == ajax_error_count["can_pais_" + iRow] || "on" == ajax_error_count["can_provincia_" + iRow] || "on" == ajax_error_count["can_nombre_" + iRow] || "on" == ajax_error_count["can_codigo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_can_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_can_pais_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_can_provincia_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_can_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_can_codigo_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["can_id_" + iRow] && "off" == ajax_error_count["can_pais_" + iRow] && "off" == ajax_error_count["can_provincia_" + iRow] && "off" == ajax_error_count["can_nombre_" + iRow] && "off" == ajax_error_count["can_codigo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["can_id_" + iRow] = "off";
        ajax_error_count["can_pais_" + iRow] = "off";
        ajax_error_count["can_provincia_" + iRow] = "off";
        ajax_error_count["can_nombre_" + iRow] = "off";
        ajax_error_count["can_codigo_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_can_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_can_pais_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_can_provincia_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_can_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_can_codigo_" + iRow).removeClass("scFormErrorLine");
    }
  }
