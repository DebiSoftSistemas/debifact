...
class grid_del_factura_compra_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_del_factura_compra_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_del_factura_compra_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_del_factura_compra_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_pr_nombre')
      {
          $pr_nombre = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_pr_nombre($pr_nombre);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_pr_identificacion')
      {
          $pr_identificacion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_pr_identificacion($pr_identificacion);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "del_factura_compra.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> del_factura_compra</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_del_factura_compra/grid_del_factura_compra_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_del_factura_compra_ajax_search.js"></script>
 <script type="text/javascript" src="grid_del_factura_compra_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_del_factura_compra_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_factura_compra']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_factura_compra']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_fc_fecha_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fc_fecha_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fc_fecha_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fc_fecha_ano').value;
          document.getElementById('sc_fc_fecha_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fc_fecha_dia').value = aParts[0];
          document.getElementById('SC_fc_fecha_mes').value = aParts[1];
          document.getElementById('SC_fc_fecha_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_fc_fecha_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fc_fecha_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fc_fecha_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fc_fecha_input_2_ano').value;
          document.getElementById('sc_fc_fecha_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fc_fecha_input_2_dia').value = aParts[0];
          document.getElementById('SC_fc_fecha_input_2_mes').value = aParts[1];
          document.getElementById('SC_fc_fecha_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_fc_fecha_cond#NMF#' + search_get_sel_txt('SC_fc_fecha_cond') + '@NMF@';
  str_out += 'SC_fc_fecha_dia#NMF#' + search_get_sel_txt('SC_fc_fecha_dia') + '@NMF@';
  str_out += 'SC_fc_fecha_mes#NMF#' + search_get_sel_txt('SC_fc_fecha_mes') + '@NMF@';
  str_out += 'SC_fc_fecha_ano#NMF#' + search_get_sel_txt('SC_fc_fecha_ano') + '@NMF@';
  str_out += 'SC_fc_fecha_input_2_dia#NMF#' + search_get_sel_txt('SC_fc_fecha_input_2_dia') + '@NMF@';
  str_out += 'SC_fc_fecha_input_2_mes#NMF#' + search_get_sel_txt('SC_fc_fecha_input_2_mes') + '@NMF@';
  str_out += 'SC_fc_fecha_input_2_ano#NMF#' + search_get_sel_txt('SC_fc_fecha_input_2_ano') + '@NMF@';
  str_out += 'SC_pr_nombre_cond#NMF#' + search_get_sel_txt('SC_pr_nombre_cond') + '@NMF@';
  str_out += 'SC_pr_nombre#NMF#' + search_get_text('SC_pr_nombre') + '@NMF@';
  str_out += 'id_ac_pr_nombre#NMF#' + search_get_title('select2-id_ac_pr_nombre-container') + '@NMF@';
  str_out += 'SC_pr_identificacion_cond#NMF#' + search_get_sel_txt('SC_pr_identificacion_cond') + '@NMF@';
  str_out += 'SC_pr_identificacion#NMF#' + search_get_text('SC_pr_identificacion') + '@NMF@';
  str_out += 'id_ac_pr_identificacion#NMF#' + search_get_title('select2-id_ac_pr_identificacion-container') + '@NMF@';
  str_out += 'SC_fc_tipo_comprobante_cond#NMF#' + search_get_sel_txt('SC_fc_tipo_comprobante_cond') + '@NMF@';
  str_out += 'SC_fc_tipo_comprobante#NMF#' + search_get_Dselelect('SC_fc_tipo_comprobante_dest') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-pr_nombre").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_pr_nombre",
      max_itens: "10",
   ...
   $("#SC_pr_nombre").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-pr_identificacion").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_pr_identificacion",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_pr_identificacion").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $fc_fecha_cond, $fc_fecha, $fc_fecha_dia, $fc_fecha_mes, $fc_fecha_ano, $fc_fecha_input_2_dia, $fc_fecha_input_2_mes, $fc_fecha_input_2_ano,
             $pr_nombre_cond, $pr_nombre, $pr_nombre_autocomp,
             $pr_identificacion_cond, $pr_identificacion, $pr_identificacion_autocomp,
             $fc_tipo_comprobante_cond, $fc_tipo_comprobante,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      if (isset($bprocessa) && ($bprocessa == "recarga" || $bprocessa == "save_form" || $bprocessa == "filter_delete"))
      {
          if (!empty($fc_tipo_comprobante))
          {
              $fc_tipo_comprobante = explode("@?@", $fc_tipo_comprobante);
          }
          else
          {
              $fc_tipo_comprobante = array();
          }
      }
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fc_fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_dia']; 
          $fc_fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_mes']; 
          $fc_fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_ano']; 
          $fc_fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_input_2_dia']; 
          $fc_fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_input_2_mes']; 
          $fc_fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_input_2_ano']; 
          $fc_fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_cond']; 
          $pr_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['pr_nombre']; 
          $pr_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['pr_nombre_cond']; 
          $pr_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['pr_identificacion']; 
          $pr_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['pr_identificacion_cond']; 
          $fc_tipo_comprobante = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_tipo_comprobante']; 
          $fc_tipo_comprobante_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_tipo_comprobante_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['NM_operador']; 
      } 
      if (!isset($fc_fecha_cond) || empty($fc_fecha_cond))
      {
         $fc_fecha_cond = "eq";
      }
      if (!isset($pr_nombre_cond) || empty($pr_nombre_cond))
      {
         $pr_nombre_cond = "eq";
      }
      if (!isset($pr_identificacion_cond) || empty($pr_identificacion_cond))
      {
         $pr_identificacion_cond = "eq";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_fc_fecha = (in_array($fc_fecha_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pr_nombre = (in_array($pr_nombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pr_identificacion = (in_array($pr_identificacion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fc_tipo_comprobante = (in_array($fc_tipo_comprobante_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_fc_fecha = ('bw' == $fc_fecha_cond) ? $display_aberto : $display_fechado;
      $str_display_pr_nombre = ('bw' == $pr_nombre_cond) ? $display_aberto : $display_fechado;
      $str_display_pr_identificacion = ('bw' == $pr_identificacion_cond) ? $display_aberto : $display_fechado;
      $str_display_fc_tipo_comprobante = ('bw' == $fc_tipo_comprobante_cond) ? $display_aberto : $display_fechado;

      // fc_tipo_comprobante
      if (is_array($fc_tipo_comprobante) && !empty($fc_tipo_comprobante))
      {
         $tmp_array = array();
         $fc_tipo_comprobante_val_str = "";
         foreach ($fc_tipo_comprobante as $tmp_val_cmp)
         {
            if ("" != $fc_tipo_comprobante_val_str)
            {
               $fc_tipo_comprobante_val_str .= ",";
            }
            ...
            $fc_tipo_comprobante_val_str .= "'$tmp_val_cmp'";
         }
         $fc_tipo_comprobante = $tmp_array;
      }
      else
      {
         $fc_tipo_comprobante_val_str = "''";
      }
      if (!isset($fc_fecha) || $fc_fecha == "")
      {
          $fc_fecha = "";
      }
      if (isset($fc_fecha) && !empty($fc_fecha))
      {
      ...
      if (!isset($pr_nombre) || $pr_nombre == "")
      {
          $pr_nombre = "";
      }
      if (isset($pr_nombre) && !empty($pr_nombre))
      {
      ...
      if (!isset($pr_identificacion) || $pr_identificacion == "")
      {
          $pr_identificacion = "";
      }
      if (isset($pr_identificacion) && !empty($pr_identificacion))
      {
      ...
      if (!isset($fc_tipo_comprobante) || $fc_tipo_comprobante == "")
      {
          $fc_tipo_comprobante = array();
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fc_fecha_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fc_fecha'])) ? $this->New_label['fc_fecha'] : "" . $this->Ini->Nm_lang['lang_fecha'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fc_fecha_cond" name="fc_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_fc_fecha'), this, 'fc_fecha')">
       <OPTION value="eq" <?php if ("eq" == $fc_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $fc_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fc_fecha" <?php echo $str_hide_fc_fecha?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fc_fecha'])) ? $this->New_label['fc_fecha'] : "" . $this->Ini->Nm_lang['lang_fecha'] . "";
 $nmgp_tab_label .= "fc_fecha?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_fc_fecha_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fc_fecha_dia" name="fc_fecha_dia" value="<?php echo NM_encode_input($fc_fecha_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
<INPUT type="hidden" id="sc_fc_fecha_jq">
<?php
}
?>
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fc_fecha_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fc_fecha_mes" name="fc_fecha_mes" value="<?php echo NM_encode_input($fc_fecha_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_fc_fecha_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fc_fecha_ano" name="fc_fecha_ano" value="<?php echo NM_encode_input($fc_fecha_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
        <SPAN id="id_css_fc_fecha"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_fc_fecha"  <?php echo $str_display_fc_fecha; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_fc_fecha_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fc_fecha_input_2_dia" name="fc_fecha_input_2_dia" value="<?php echo NM_encode_input($fc_fecha_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
<INPUT type="hidden" id="sc_fc_fecha_jq2">
<?php
}
?>
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fc_fecha_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fc_fecha_input_2_mes" name="fc_fecha_input_2_mes" value="<?php echo NM_encode_input($fc_fecha_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_fc_fecha_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fc_fecha_input_2_ano" name="fc_fecha_input_2_ano" value="<?php echo NM_encode_input($fc_fecha_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
      ...
      <TD id='SC_pr_nombre_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['pr_nombre'])) ? $this->New_label['pr_nombre'] : "" . $this->Ini->Nm_lang['lang_proveedor'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_pr_nombre_cond" name="pr_nombre_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pr_nombre" <?php echo $str_hide_pr_nombre?> valign="top">
 ...
 $nmgp_tab_label .= "pr_nombre?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $pr_nombre;
      }
?>
<INPUT  type="text" id="SC_pr_nombre" name="pr_nombre" value="<?php echo NM_encode_input($pr_nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-pr_nombre" id="id_ac_pr_nombre" name="pr_nombre_autocomp"><?php if ('' !=  $pr_nombre) { ?><option value="<?php echo $pr_nombre ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_pr_identificacion_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pr_identificacion'])) ? $this->New_label['pr_identificacion'] : "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_pr_identificacion_cond" name="pr_identificacion_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pr_identificacion" <?php echo $str_hide_pr_identificacion?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 ...
 $nmgp_tab_label .= "pr_identificacion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $pr_identificacion;
      }
?>
<INPUT  type="text" id="SC_pr_identificacion" name="pr_identificacion" value="<?php echo NM_encode_input($pr_identificacion) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-pr_identificacion" id="id_ac_pr_identificacion" name="pr_identificacion_autocomp"><?php if ('' !=  $pr_identificacion) { ?><option value="<?php echo $pr_identificacion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_fc_tipo_comprobante_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fc_tipo_comprobante'])) ? $this->New_label['fc_tipo_comprobante'] : "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_fc_tipo_comprobante_cond" name="fc_tipo_comprobante_cond" onChange="nm_campos_between(document.getElementById('id_vis_fc_tipo_comprobante'), this, 'fc_tipo_comprobante')">
       <OPTION value="eq" <?php if ("eq" == $fc_tipo_comprobante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fc_tipo_comprobante" <?php echo $str_hide_fc_tipo_comprobante?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 ...
 $nmgp_tab_label .= "fc_tipo_comprobante?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_fc_tipo_comprobante_orig" name="fc_tipo_comprobante_orig" size=7 multiple onDblClick="nm_add_sel('fc_tipo_comprobante_orig', 'fc_tipo_comprobante_dest', 'N' , '')">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($fc_tipo_comprobante) && !empty($fc_tipo_comprobante))
            {
               ...
               foreach ($fc_tipo_comprobante as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $fc_tipo_comprobante_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('fc_tipo_comprobante_orig', 'fc_tipo_comprobante_dest', 'N', '');", "nm_add_all('fc_tipo_comprobante_orig', 'fc_tipo_comprobante_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('fc_tipo_comprobante_orig', 'fc_tipo_comprobante_dest', 'N', '');", "nm_add_sel('fc_tipo_comprobante_orig', 'fc_tipo_comprobante_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('fc_tipo_comprobante_dest', 'fc_tipo_comprobante_orig', 'N', '');", "nm_del_sel('fc_tipo_comprobante_dest', 'fc_tipo_comprobante_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('fc_tipo_comprobante_dest', 'fc_tipo_comprobante_orig', 'N', '');", "nm_del_all('fc_tipo_comprobante_dest', 'fc_tipo_comprobante_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectEven" id="SC_fc_tipo_comprobante_dest" name="fc_tipo_comprobante_dest" size=7 multiple  onDblClick="nm_del_sel('fc_tipo_comprobante_dest', 'fc_tipo_comprobante_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_fc_tipo_comprobante" name="fc_tipo_comprobante" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.fc_tipo_comprobante_dest.selectedIndex = -1;</script>
<?php
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_del_factura_compra_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_factura_compra']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_del_factura_compra']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
   nm_pack('fc_tipo_comprobante_dest', 'fc_tipo_comprobante');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   document.F1.fc_fecha_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fc_fecha'), document.F1.fc_fecha_cond, 'fc_fecha');
   document.F1.fc_fecha_dia.value = "";
   document.F1.fc_fecha_mes.value = "";
   document.F1.fc_fecha_ano.value = "";
   document.F1.fc_fecha_input_2_dia.value = "";
   document.F1.fc_fecha_input_2_mes.value = "";
   document.F1.fc_fecha_input_2_ano.value = "";
   document.F1.pr_nombre_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_pr_nombre'), document.F1.pr_nombre_cond, 'pr_nombre');
   document.F1.pr_nombre.value = "";
   document.F1.pr_nombre_autocomp.value = "";
   $('#select2-id_ac_pr_nombre-container').html('<?php echo $this->Val_init_pr_nombre['desc'] ?>');;
   document.F1.pr_identificacion_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_pr_identificacion'), document.F1.pr_identificacion_cond, 'pr_identificacion');
   document.F1.pr_identificacion.value = "";
   document.F1.pr_identificacion_autocomp.value = "";
   $('#select2-id_ac_pr_identificacion-container').html('<?php echo $this->Val_init_pr_identificacion['desc'] ?>');;
   nm_campos_between(document.getElementById('id_vis_fc_tipo_comprobante'), document.F1.fc_tipo_comprobante_cond, 'fc_tipo_comprobante');
   nm_del_all('fc_tipo_comprobante_dest', 'fc_tipo_comprobante_orig', 'N', '');
   Sc_carga_select2('all');
 }
 ...
 {
    $('#SC_fc_fecha_dia').bind('change', function() {sc_grid_del_factura_compra_valida_dia(this)});
    $('#SC_fc_fecha_input_2_dia').bind('change', function() {sc_grid_del_factura_compra_valida_dia(this)});
    $('#SC_fc_fecha_input_2_mes').bind('change', function() {sc_grid_del_factura_compra_valida_mes(this)});
    $('#SC_fc_fecha_mes').bind('change', function() {sc_grid_del_factura_compra_valida_mes(this)});
 }
 function sc_grid_del_factura_compra_valida_dia(obj)
 {
 ...
 function sc_grid_del_factura_compra_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_del_factura_compra/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fc_fecha_cond'] = 'cond';
      $tp_fields['SC_fc_fecha_dia'] = 'text';
      $tp_fields['SC_fc_fecha_mes'] = 'text';
      $tp_fields['SC_fc_fecha_ano'] = 'text';
      $tp_fields['SC_fc_fecha_input_2_dia'] = 'text';
      $tp_fields['SC_fc_fecha_input_2_mes'] = 'text';
      $tp_fields['SC_fc_fecha_input_2_ano'] = 'text';
      $tp_fields['SC_pr_nombre_cond'] = 'cond';
      $tp_fields['SC_pr_nombre'] = 'text_aut';
      $tp_fields['id_ac_pr_nombre'] = 'select2_aut';
      $tp_fields['SC_pr_identificacion_cond'] = 'cond';
      $tp_fields['SC_pr_identificacion'] = 'text_aut';
      $tp_fields['id_ac_pr_identificacion'] = 'select2_aut';
      $tp_fields['SC_fc_tipo_comprobante_cond'] = 'cond';
      $tp_fields['SC_fc_tipo_comprobante'] = 'dselect';
   ...
   {
      global $fc_fecha_cond, $fc_fecha, $fc_fecha_dia, $fc_fecha_mes, $fc_fecha_ano, $fc_fecha_input_2_dia, $fc_fecha_input_2_mes, $fc_fecha_input_2_ano,
             $pr_nombre_cond, $pr_nombre, $pr_nombre_autocomp,
             $pr_identificacion_cond, $pr_identificacion, $pr_identificacion_autocomp,
             $fc_tipo_comprobante_cond, $fc_tipo_comprobante, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca'] as $Cmps => $Vals)
          {
              if ($Cmps == 'fc_tipo_comprobante')
              {
                  $$Cmps = implode("@?@", $Vals);
              }
              else
      ...
      if (!empty($pr_nombre_autocomp) && empty($pr_nombre))
      {
          $pr_nombre = $pr_nombre_autocomp;
      }
      if (!empty($pr_identificacion_autocomp) && empty($pr_identificacion))
      {
          $pr_identificacion = $pr_identificacion_autocomp;
      }
      if (!empty($fc_tipo_comprobante))
      {
          $fc_tipo_comprobante = explode("@?@", $fc_tipo_comprobante);
      ...
      $fc_fecha_cond_salva = $fc_fecha_cond; 
      if (!isset($fc_fecha_input_2_dia) || $fc_fecha_input_2_dia == "")
      {
          $fc_fecha_input_2_dia = $fc_fecha_dia;
      }
      if (!isset($fc_fecha_input_2_mes) || $fc_fecha_input_2_mes == "")
      {
          $fc_fecha_input_2_mes = $fc_fecha_mes;
      }
      if (!isset($fc_fecha_input_2_ano) || $fc_fecha_input_2_ano == "")
      {
          $fc_fecha_input_2_ano = $fc_fecha_ano;
      }
      $pr_nombre_cond_salva = $pr_nombre_cond; 
      if (!isset($pr_nombre_input_2) || $pr_nombre_input_2 == "")
      {
          $pr_nombre_input_2 = $pr_nombre;
      }
      $pr_identificacion_cond_salva = $pr_identificacion_cond; 
      if (!isset($pr_identificacion_input_2) || $pr_identificacion_input_2 == "")
      {
          $pr_identificacion_input_2 = $pr_identificacion;
      }
      $fc_tipo_comprobante_cond_salva = $fc_tipo_comprobante_cond; 
      if (!isset($fc_tipo_comprobante_input_2) || $fc_tipo_comprobante_input_2 == "")
      {
          $fc_tipo_comprobante_input_2 = $fc_tipo_comprobante;
      }
      if (is_array($fc_tipo_comprobante)) {
          foreach ($fc_tipo_comprobante as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['psq_check_ret']['fc_tipo_comprobante'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_dia'] = $fc_fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_mes'] = $fc_fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_ano'] = $fc_fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_input_2_dia'] = $fc_fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_input_2_mes'] = $fc_fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_input_2_ano'] = $fc_fecha_input_2_ano; 
      if (!empty($fc_fecha_dia) || !empty($fc_fecha_mes) || !empty($fc_fecha_ano) || $fc_fecha_cond_salva == "nu" || $fc_fecha_cond_salva == "nn" || $fc_fecha_cond_salva == "ep" || $fc_fecha_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fc_fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fc_fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fc_fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fc_fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fc_fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fc_fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_cond'] = $fc_fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['cmp'] = "fc_fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['opc'] = $fc_fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq']['fc_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['pr_nombre'] = $pr_nombre; 
      if (is_array($pr_nombre) && !empty($pr_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['val'][0] = $pr_nombre;
      }
      elseif ($pr_nombre_cond_salva == "nu" || $pr_nombre_cond_salva == "nn" || $pr_nombre_cond_salva == "ep" || $pr_nombre_cond_salva == "ne" || !empty($pr_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['val'][0][0] = $pr_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['pr_nombre_cond'] = $pr_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['cmp'] = "pr_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['opc'] = $pr_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq']['pr_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['pr_identificacion'] = $pr_identificacion; 
      if (is_array($pr_identificacion) && !empty($pr_identificacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['val'][0] = $pr_identificacion;
      }
      elseif ($pr_identificacion_cond_salva == "nu" || $pr_identificacion_cond_salva == "nn" || $pr_identificacion_cond_salva == "ep" || $pr_identificacion_cond_salva == "ne" || !empty($pr_identificacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['val'][0][0] = $pr_identificacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['pr_identificacion_cond'] = $pr_identificacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['cmp'] = "pr_identificacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['opc'] = $pr_identificacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq']['pr_identificacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_tipo_comprobante'] = $fc_tipo_comprobante; 
      if (is_array($fc_tipo_comprobante) && !empty($fc_tipo_comprobante))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['val'][0] = $fc_tipo_comprobante;
      }
      elseif ($fc_tipo_comprobante_cond_salva == "nu" || $fc_tipo_comprobante_cond_salva == "nn" || $fc_tipo_comprobante_cond_salva == "ep" || $fc_tipo_comprobante_cond_salva == "ne" || !empty($fc_tipo_comprobante))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['val'][0][0] = $fc_tipo_comprobante;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_tipo_comprobante_cond'] = $fc_tipo_comprobante_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['cmp'] = "fc_tipo_comprobante"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid]['opc'] = $fc_tipo_comprobante_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq']['fc_tipo_comprobante'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($pr_nombre != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['pr_nombre'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['pr_nombre'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['pr_nombre'] = $pr_nombre;
      }
      $nmgp_def_dados = array();
    if ($pr_identificacion != '') {
      $pr_identificacion_look = (is_string($pr_identificacion) ? substr($this->Db->qstr($pr_identificacion), 1, -1) : $pr_identificacion); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['pr_identificacion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['pr_identificacion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['pr_identificacion'] = $pr_identificacion;
      }
      $this->cmp_formatado['fc_tipo_comprobante'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_tipo_comprobante'];
      $this->cmp_formatado['fc_tipo_comprobante_input_2'] = $fc_tipo_comprobante_input_2;

      //----- $fc_fecha
      $this->Date_part = false;
      if ($fc_fecha_cond != "bi_TP")
      {
          $fc_fecha_cond = strtoupper($fc_fecha_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fc_fecha_ano;
          $Dtxt .= $fc_fecha_mes;
          $Dtxt .= $fc_fecha_dia;
          $val[0]['ano'] = $fc_fecha_ano;
          $val[0]['mes'] = $fc_fecha_mes;
          $val[0]['dia'] = $fc_fecha_dia;
          if ($fc_fecha_cond == "BW")
          {
              $val[1]['ano'] = $fc_fecha_input_2_ano;
              $val[1]['mes'] = $fc_fecha_input_2_mes;
              $val[1]['dia'] = $fc_fecha_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $fc_fecha_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $fc_fecha_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fc_fecha = $val[0];
          $this->cmp_formatado['fc_fecha'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fc_fecha'], "YYYY-MM-DD");
          $this->cmp_formatado['fc_fecha'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($fc_fecha_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fc_fecha_input_2     = $val[1];
              $this->cmp_formatado['fc_fecha_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']['fc_fecha_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fc_fecha_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['fc_fecha_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $fc_fecha_cond == "NU" || $fc_fecha_cond == "NN"|| $fc_fecha_cond == "EP"|| $fc_fecha_cond == "NE")
          {
              $this->monta_condicao("fc_fecha", $fc_fecha_cond, $fc_fecha, $fc_fecha_input_2, 'fc_fecha', 'DATE');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq']['fc_fecha']['label'] = $nmgp_tab_label['fc_fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq']['fc_fecha']['descr'] = $nmgp_tab_label['fc_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq']['fc_fecha']['hint']  = $nmgp_tab_label['fc_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $pr_nombre
      $this->Date_part = false;
      if (isset($pr_nombre) || $pr_nombre_cond == "nu" || $pr_nombre_cond == "nn" || $pr_nombre_cond == "ep" || $pr_nombre_cond == "ne")
      {
         $this->monta_condicao("pr_nombre", $pr_nombre_cond, $pr_nombre, "", "pr_nombre", "VARCHAR", false);
      }

      //----- $pr_identificacion
      $this->Date_part = false;
      if (isset($pr_identificacion) || $pr_identificacion_cond == "nu" || $pr_identificacion_cond == "nn" || $pr_identificacion_cond == "ep" || $pr_identificacion_cond == "ne")
      {
         $this->monta_condicao("pr_identificacion", $pr_identificacion_cond, $pr_identificacion, "", "pr_identificacion", "VARCHAR", false);
      }

      //----- $fc_tipo_comprobante
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($fc_tipo_comprobante_cond == "nu" || $fc_tipo_comprobante_cond == "nn" || $fc_tipo_comprobante_cond == "ep" || $fc_tipo_comprobante_cond == "ne")
      {
          $fc_tipo_comprobante = array();
      }
      if (is_array($fc_tipo_comprobante) && count($fc_tipo_comprobante) != 0)
      {
         foreach ($fc_tipo_comprobante as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
                unset($fc_tipo_comprobante[$i]);
            }
         }
      }
      if (is_array($fc_tipo_comprobante) && count($fc_tipo_comprobante) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($fc_tipo_comprobante_cond == "df" || $fc_tipo_comprobante_cond == "np")
         {
             $this->comando        .= " #lowerI#fc_tipo_comprobante#lowerF# not in (";
             $this->comando_sum    .= " #lowerI#del_factura_compra.fc_tipo_comprobante#lowerF# not in (";
             $this->comando_filtro .= " #lowerI#fc_tipo_comprobante#lowerF# not in (";
         }
         else
         {
             $this->comando        .= " #lowerI#fc_tipo_comprobante#lowerF# in (";
             $this->comando_sum    .= " #lowerI#del_factura_compra.fc_tipo_comprobante#lowerF# in (";
             $this->comando_filtro .= " #lowerI#fc_tipo_comprobante#lowerF# in (";
         }
         $x                     = count($fc_tipo_comprobante);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($fc_tipo_comprobante as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($fc_tipo_comprobante) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr_final = isset($Lang_descr[$fc_tipo_comprobante_cond]) ? $Lang_descr[$fc_tipo_comprobante_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $nmgp_tab_label['fc_tipo_comprobante'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq']['fc_tipo_comprobante']['label'] = $nmgp_tab_label['fc_tipo_comprobante'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq']['fc_tipo_comprobante']['descr'] = $nmgp_tab_label['fc_tipo_comprobante'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['grid_pesq']['fc_tipo_comprobante']['hint'] = $nmgp_tab_label['fc_tipo_comprobante'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($fc_tipo_comprobante) && ($fc_tipo_comprobante_cond == "nu" || $fc_tipo_comprobante_cond == "nn" || $fc_tipo_comprobante_cond == "ep" || $fc_tipo_comprobante_cond == "ne"))
      {
         $this->monta_condicao("fc_tipo_comprobante", $fc_tipo_comprobante_cond, "", "", "fc_tipo_comprobante", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['cond_pesq'] .= $this->NM_operador;
