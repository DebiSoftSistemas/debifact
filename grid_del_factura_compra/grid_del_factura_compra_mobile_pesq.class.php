...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "fc_fecha";$Nm_numeric[] = "fc_id";$Nm_numeric[] = "fc_proveedor";$Nm_numeric[] = "fc_total";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fc_fecha_cond" name="fc_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_fc_fecha'), this, 'fc_fecha')">
      ...
      <br><span id="id_hide_fc_fecha"  <?php echo $str_hide_fc_fecha?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fc_fecha"  <?php echo $str_display_fc_fecha; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_pr_nombre"  <?php echo $str_hide_pr_nombre?>><?php
      if ($pr_nombre != "")
      {
      $pr_nombre_look = (is_string($pr_nombre) ? substr($this->Db->qstr($pr_nombre), 1, -1) : $pr_nombre); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_pr_identificacion"  <?php echo $str_hide_pr_identificacion?>><?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_fc_tipo_comprobante_cond" name="fc_tipo_comprobante_cond" onChange="nm_campos_between(document.getElementById('id_vis_fc_tipo_comprobante'), this, 'fc_tipo_comprobante')">
       <OPTION value="eq" <?php if ("eq" == $fc_tipo_comprobante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_fc_tipo_comprobante"  <?php echo $str_hide_fc_tipo_comprobante?>>
<?php
...
?>
   <span id="idAjaxSelect_fc_tipo_comprobante">
      <SELECT class="scFilterObjectEven" id="SC_fc_tipo_comprobante" name="fc_tipo_comprobante[]"  size="7" multiple>
<?php
         ...
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($fc_tipo_comprobante) && !empty($fc_tipo_comprobante))
            {
               ...
               foreach ($fc_tipo_comprobante as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $fc_tipo_comprobante_sel = "selected";
                       break;
                   }
               }
            }
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'fc_tipo_comprobante[]')
      {
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "fc_tipo_comprobante" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
