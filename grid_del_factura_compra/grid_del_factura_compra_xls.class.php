...
class grid_del_factura_compra_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function sc_actionbar_disable($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_del_factura_compra/grid_del_factura_compra_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_del_factura_compra_res_xls.class.php");
              $this->Res_xls = new grid_del_factura_compra_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_del_factura_compra.zip";
          $this->Arquivo   .= "_grid_del_factura_compra" . $this->Xls_tp;
          $this->Tit_doc    = "grid_del_factura_compra" . $this->Xls_tp;
          $this->Tit_zip    = "grid_del_factura_compra.zip";
      ...
      require_once($this->Ini->path_aplicacao . "grid_del_factura_compra_total.class.php"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->Xls_col = 0;
         $this->Xls_row++;
         $this->fc_tipo_comprobante = $rs->fields[0] ;  
         $this->sc_field_0 = $rs->fields[1] ;  
         $this->fc_fecha = $rs->fields[2] ;  
         $this->pr_nombre = $rs->fields[3] ;  
         $this->pr_identificacion = $rs->fields[4] ;  
         $this->fc_total = $rs->fields[5] ;  
         $this->fc_total = (string)$this->fc_total;
         $this->liq_estado_sri = $rs->fields[6] ;  
         $this->fc_autorizacion = $rs->fields[7] ;  
         $this->liq_error_sri = $rs->fields[8] ;  
         $this->fc_id = $rs->fields[9] ;  
         $this->fc_id = (string)$this->fc_id;
         $this->fc_estado = $rs->fields[10] ;  
...
$_SESSION['scriptcase']['grid_del_factura_compra']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "liq_estado_sri" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "liq_error_sri" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "fc_id" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   function NM_export_fc_total()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fc_total = NM_charset_to_utf8($this->fc_total);
         if (is_numeric($this->fc_total))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->fc_total);
         $this->Xls_col++;
   }
   //----- liq_estado_sri
   function NM_export_liq_estado_sri()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->liq_estado_sri = html_entity_decode($this->liq_estado_sri, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->liq_estado_sri = strip_tags($this->liq_estado_sri);
         $this->liq_estado_sri = NM_charset_to_utf8($this->liq_estado_sri);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->liq_estado_sri, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->liq_estado_sri, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fc_autorizacion
   function NM_export_fc_autorizacion()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fc_autorizacion = html_entity_decode($this->fc_autorizacion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fc_autorizacion = strip_tags($this->fc_autorizacion);
         $this->fc_autorizacion = NM_charset_to_utf8($this->fc_autorizacion);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fc_autorizacion, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fc_autorizacion, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- liq_error_sri
   function NM_export_liq_error_sri()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->liq_error_sri = html_entity_decode($this->liq_error_sri, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->liq_error_sri = strip_tags($this->liq_error_sri);
         $this->liq_error_sri = NM_charset_to_utf8($this->liq_error_sri);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->liq_error_sri, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->liq_error_sri, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fc_id
   function NM_export_fc_id()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fc_id = html_entity_decode($this->fc_id, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fc_id = NM_charset_to_utf8($this->fc_id);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fc_id, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fc_id, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fc_tipo_comprobante
   ...
   //----- fc_total
   function NM_sub_cons_fc_total()
   {
         $this->fc_total = NM_charset_to_utf8($this->fc_total);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fc_total;
   ...
   //----- liq_estado_sri
   function NM_sub_cons_liq_estado_sri()
   {
         $this->liq_estado_sri = html_entity_decode($this->liq_estado_sri, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->liq_estado_sri = strip_tags($this->liq_estado_sri);
         $this->liq_estado_sri = NM_charset_to_utf8($this->liq_estado_sri);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->liq_estado_sri;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- fc_autorizacion
   function NM_sub_cons_fc_autorizacion()
   {
         $this->fc_autorizacion = html_entity_decode($this->fc_autorizacion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fc_autorizacion = strip_tags($this->fc_autorizacion);
         $this->fc_autorizacion = NM_charset_to_utf8($this->fc_autorizacion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fc_autorizacion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- liq_error_sri
   function NM_sub_cons_liq_error_sri()
   {
         $this->liq_error_sri = html_entity_decode($this->liq_error_sri, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->liq_error_sri = strip_tags($this->liq_error_sri);
         $this->liq_error_sri = NM_charset_to_utf8($this->liq_error_sri);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->liq_error_sri;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- fc_id
   function NM_sub_cons_fc_id()
   {
         $this->fc_id = html_entity_decode($this->fc_id, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fc_id = NM_charset_to_utf8($this->fc_id);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fc_id;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> del_factura_compra :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura_compra']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
