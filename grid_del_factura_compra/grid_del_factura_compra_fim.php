...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_factura_compra"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_factura_compra"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_factura_compra'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_factura_compra']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_factura_compra']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_factura_compra']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_factura_compra']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_factura_compra']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_factura_compra</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_factura_compra']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_factura_compra']['embutida_filho'] as $ind => $sc_init)
          {
