...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_inventario_bodega"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_inventario_bodega"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_inventario_bodega'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_bodega']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_inventario_bodega']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_bodega']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_inventario_bodega']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_inventario_bodega']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_inventario_bodega</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_bodega']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_inventario_bodega']['embutida_filho'] as $ind => $sc_init)
          {
