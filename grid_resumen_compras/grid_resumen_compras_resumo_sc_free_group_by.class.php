...
class grid_resumen_compras_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_tc_nombre         = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_resumen_compras']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_resumen_compras']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['tot_geral'][6];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['tot_geral'][7];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['tot_geral'][8];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['tot_geral'][9];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['tot_geral'][3];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['tot_geral'][10];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['tot_geral'][4];
      $this->array_total_geral[8] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['tot_geral'][11];
      $this->array_total_geral[9] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['tot_geral'][5];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['arr_total']['tc_nombre'] = $this->array_total_tc_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['arr_total']['fc_fecha'] = $this->array_total_fc_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['arr_total']['fc_serie'] = $this->array_total_fc_serie;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['arr_total']['fc_usuario'] = $this->array_total_fc_usuario;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['arr_total']['pr_identificacion'] = $this->array_total_pr_identificacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['arr_total']['pr_nombre'] = $this->array_total_pr_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['json_use_label'])
       {
          $Lab_tc_nombre = "tc_nombre";
       ...
       {
       $Lab_tc_nombre = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . "";
       ...
       $prep_field = array();
       $prep_field['tc_nombre'] = $Lab_tc_nombre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['tc_nombre'] = $Lab_tc_nombre; 
       $prep_field['fc_fecha'] = $Lab_fc_fecha;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_fecha'] = $Lab_fc_fecha; 
       $prep_field['fc_serie'] = $Lab_fc_serie;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_serie'] = $Lab_fc_serie; 
       $prep_field['fc_usuario'] = $Lab_fc_usuario;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_usuario'] = $Lab_fc_usuario; 
       $prep_field['pr_identificacion'] = $Lab_pr_identificacion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['pr_identificacion'] = $Lab_pr_identificacion; 
       $prep_field['pr_nombre'] = $Lab_pr_nombre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['pr_nombre'] = $Lab_pr_nombre; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['pr_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['pr_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['pr_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['pr_nombre'] = "" . $this->Ini->Nm_lang['lang_proveedor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_serie'] = "" . $this->Ini->Nm_lang['lang_serie_sri'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fac_secuencial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fac_secuencial'] = "" . $this->Ini->Nm_lang['lang_secuencial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_subtotal'] = "" . $this->Ini->Nm_lang['lang_subtotal'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_total_descuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_total_descuento'] = "" . $this->Ini->Nm_lang['lang_descuento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_valor_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_valor_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_total'] = "" . $this->Ini->Nm_lang['lang_othr_chrt_totl'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['pr_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['pr_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['pr_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['pr_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_subtotal_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_subtotal_iva'] = "" . $this->Ini->Nm_lang['lang_subtotal_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_subtotal_cero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_subtotal_cero'] = "" . $this->Ini->Nm_lang['lang_subtotal_cero'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_subtotal_no_objeto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_subtotal_no_objeto'] = "" . $this->Ini->Nm_lang['lang_subtotal_no_objeto'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_subtotal_excento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_subtotal_excento'] = "" . $this->Ini->Nm_lang['lang_subtotal_exento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_valor_ice']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_valor_ice'] = "" . $this->Ini->Nm_lang['lang_ice'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_valor_irbpnr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_valor_irbpnr'] = "" . $this->Ini->Nm_lang['lang_irbpnr'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_autorizacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_autorizacion'] = "" . $this->Ini->Nm_lang['lang_autorizacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_fecha_caducidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_fecha_caducidad'] = "" . $this->Ini->Nm_lang['lang_fecha_caducidad'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_id'] = "" . $this->Ini->Nm_lang['lang_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_tipo_comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_tipo_comprobante'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_proveedor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_proveedor'] = "" . $this->Ini->Nm_lang['lang_proveedor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_comentario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_comentario'] = "" . $this->Ini->Nm_lang['lang_comentario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['fc_usuario'] = "" . $this->Ini->Nm_lang['lang_usuario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['tc_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['labels']['tc_nombre'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       $this->comp_sum = array(
           ...
           3 => "Subtotal Iva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "Subtotal Cero (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           5 => "Subtotal No Objeto (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           6 => "Subtotal Excento (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           7 => "Total Descuento (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           8 => "Ice (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           9 => "Iva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           10 => "Irbpnr (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           11 => "Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "fc_subtotal", 'show' => true),
           3 => array('field' => "fc_subtotal_iva", 'show' => true),
           4 => array('field' => "fc_subtotal_cero", 'show' => true),
           5 => array('field' => "fc_subtotal_no_objeto", 'show' => true),
           6 => array('field' => "fc_subtotal_excento", 'show' => true),
           7 => array('field' => "fc_total_descuento", 'show' => true),
           8 => array('field' => "fc_valor_ice", 'show' => true),
           9 => array('field' => "fc_valor_iva", 'show' => true),
           10 => array('field' => "fc_valor_irbpnr", 'show' => true),
           11 => array('field' => "fc_total", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_fc_subtotal_sum",
           3 => "css_fc_subtotal_iva_sum",
           4 => "css_fc_subtotal_cero_sum",
           5 => "css_fc_subtotal_no_objeto_sum",
           6 => "css_fc_subtotal_excento_sum",
           7 => "css_fc_total_descuento_sum",
           8 => "css_fc_valor_ice_sum",
           9 => "css_fc_valor_iva_sum",
           10 => "css_fc_valor_irbpnr_sum",
           11 => "css_fc_total_sum",
       );
       ...
       $this->comp_sum_nm = array(
           2 => "fc_subtotal_sum",
           3 => "fc_subtotal_iva_sum",
           4 => "fc_subtotal_cero_sum",
           5 => "fc_subtotal_no_objeto_sum",
           6 => "fc_subtotal_excento_sum",
           7 => "fc_total_descuento_sum",
           8 => "fc_valor_ice_sum",
           9 => "fc_valor_iva_sum",
           10 => "fc_valor_irbpnr_sum",
           11 => "fc_total_sum",
       );
      ...
      for ($ix = 0; $ix < sizeof($Arr_gb); $ix++)
      {
          ...
          $Str_gb .= "         \$this->comp_index[" . $ix . "][\$dados_" . $Arr_gb[$ix] . "[12] ] = \$dados_" . $Arr_gb[$ix] . "[11];";
          $Str_gb .= "         \$this->comp_label[" . $ix . "]" . $Arr_lab[$ix] . "[ \$dados_" . $Arr_gb[$ix] . "[12] ] = \$dados_" . $Arr_gb[$ix] . "[11];";
          $Str_gb .= "    }";
      }
      for ($ix = 0; $ix < sizeof($Arr_gb); $ix++)
      {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['tc_nombre']['alin'] = "''";
       $Arr_parms['tc_nombre']['link'] = "S";
       ...
       $Arr_parms['tc_nombre']['fill'] = "true";
       $Arr_parms['tc_nombre']['order'] = "label";
       $Arr_parms['tc_nombre']['order_start'] = 'asc';
       $Arr_parms['tc_nombre']['order_invert'] = 'false';
       $Arr_parms['tc_nombre']['order_enabled'] = 'true';
       $Arr_parms['tc_nombre']['order_datatype'] = 'varchar';
       $Arr_parms['tc_nombre']['rating_function'] = '';
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['tc_nombre'] = array(0 => 'tc_nombre', 1 => '@aspass@');
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_resumen_compras@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_resumen_compras_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['ajax_nav']) {  
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_compras_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_resumen_compras_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_compras_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_resumen_compras/grid_resumen_compras_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_compras/grid_resumen_compras_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_resumen_compras&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_compras/grid_resumen_compras_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_compras/grid_resumen_compras_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_compras/grid_resumen_compras_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_resumen_compras_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_resumen_compras']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_resumen_compras']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_resumen_compras_config_pivot.php?nome_apl=grid_resumen_compras&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_resumen_compras_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_compras_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_resumen_compras/grid_resumen_compras_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $fc_fecha_2 = (isset($Busca_temp['fc_fecha_input_2'])) ? $Busca_temp['fc_fecha_input_2'] : ""; 
          $tc_nombre = (isset($Busca_temp['tc_nombre'])) ? $Busca_temp['tc_nombre'] : ""; 
          $tmp_pos = (is_string($tc_nombre)) ? strpos($tc_nombre, "##@@") : false;
          if ($tmp_pos !== false && !is_array($tc_nombre))
          {
              $tc_nombre = substr($tc_nombre, 0, $tmp_pos);
          }
   ...
   //---- 
   function adiciona_registro($sum_fc_subtotal, $sum_fc_total_descuento, $sum_fc_valor_iva, $sum_fc_total, $sum_fc_subtotal_iva, $sum_fc_subtotal_cero, $sum_fc_subtotal_no_objeto, $sum_fc_subtotal_excento, $sum_fc_valor_ice, $sum_fc_valor_irbpnr, $quebra_tc_nombre, $quebra_fc_fecha, $quebra_fc_serie, $quebra_fc_usuario, $quebra_pr_identificacion, $quebra_pr_nombre, $quebra_tc_nombre_orig, $quebra_fc_fecha_orig, $quebra_fc_serie_orig, $quebra_fc_usuario_orig, $quebra_pr_identificacion_orig, $quebra_pr_nombre_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_fc_subtotal)) {$sum_fc_subtotal = '0';}
          if (empty($sum_fc_total_descuento)) {$sum_fc_total_descuento = '0';}
          if (empty($sum_fc_valor_iva)) {$sum_fc_valor_iva = '0';}
          if (empty($sum_fc_total)) {$sum_fc_total = '0';}
          if (empty($sum_fc_subtotal_iva)) {$sum_fc_subtotal_iva = '0';}
          if (empty($sum_fc_subtotal_cero)) {$sum_fc_subtotal_cero = '0';}
          if (empty($sum_fc_subtotal_no_objeto)) {$sum_fc_subtotal_no_objeto = '0';}
          if (empty($sum_fc_subtotal_excento)) {$sum_fc_subtotal_excento = '0';}
          if (empty($sum_fc_valor_ice)) {$sum_fc_valor_ice = '0';}
          if (empty($sum_fc_valor_irbpnr)) {$sum_fc_valor_irbpnr = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_fc_subtotal . ';
              $this->' . $arr_name . '[2] = ' . $sum_fc_total_descuento . ';
              $this->' . $arr_name . '[3] = ' . $sum_fc_valor_iva . ';
              $this->' . $arr_name . '[4] = ' . $sum_fc_total . ';
              $this->' . $arr_name . '[5] = ' . $sum_fc_subtotal_iva . ';
              $this->' . $arr_name . '[6] = ' . $sum_fc_subtotal_cero . ';
              $this->' . $arr_name . '[7] = ' . $sum_fc_subtotal_no_objeto . ';
              $this->' . $arr_name . '[8] = ' . $sum_fc_subtotal_excento . ';
              $this->' . $arr_name . '[9] = ' . $sum_fc_valor_ice . ';
              $this->' . $arr_name . '[10] = ' . $sum_fc_valor_irbpnr . ';
              $this->' . $arr_name . '[11] = "' . addslashes($$cmp_look) . '";
              $this->' . $arr_name . '[12] = "' . $$cmp_orig . '";
          }
          else
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_fc_subtotal . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_fc_total_descuento . ', 10);
              $this->' . $arr_name . '[3] = bcadd($this->' . $arr_name . '[3], ' . $sum_fc_valor_iva . ', 10);
              $this->' . $arr_name . '[4] = bcadd($this->' . $arr_name . '[4], ' . $sum_fc_total . ', 10);
              $this->' . $arr_name . '[5] = bcadd($this->' . $arr_name . '[5], ' . $sum_fc_subtotal_iva . ', 10);
              $this->' . $arr_name . '[6] = bcadd($this->' . $arr_name . '[6], ' . $sum_fc_subtotal_cero . ', 10);
              $this->' . $arr_name . '[7] = bcadd($this->' . $arr_name . '[7], ' . $sum_fc_subtotal_no_objeto . ', 10);
              $this->' . $arr_name . '[8] = bcadd($this->' . $arr_name . '[8], ' . $sum_fc_subtotal_excento . ', 10);
              $this->' . $arr_name . '[9] = bcadd($this->' . $arr_name . '[9], ' . $sum_fc_valor_ice . ', 10);
              $this->' . $arr_name . '[10] = bcadd($this->' . $arr_name . '[10], ' . $sum_fc_valor_irbpnr . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $fc_fecha_2 = (isset($Busca_temp['fc_fecha_input_2'])) ? $Busca_temp['fc_fecha_input_2'] : ""; 
       $this->fc_fecha_2 = $fc_fecha_2; 
       $this->tc_nombre = $Busca_temp['tc_nombre']; 
       $this->tc_nombre = (isset($Busca_temp['tc_nombre'])) ? $Busca_temp['tc_nombre'] : ""; 
       $tmp_pos = (is_string($this->tc_nombre)) ? strpos($this->tc_nombre, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->tc_nombre))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->pr_identificacion = $rs_res->fields[1] ;  
            $this->pr_nombre = $rs_res->fields[2] ;  
            $this->fc_serie = $rs_res->fields[3] ;  
            $this->fac_secuencial = $rs_res->fields[4] ;  
            $this->fc_subtotal = $rs_res->fields[5] ;  
            $this->fc_total_descuento = $rs_res->fields[6] ;  
            $this->fc_valor_iva = $rs_res->fields[7] ;  
            $this->fc_total = $rs_res->fields[8] ;  
            $this->pr_direccion = $rs_res->fields[9] ;  
            $this->pr_email = $rs_res->fields[10] ;  
            $this->fc_subtotal_iva = $rs_res->fields[11] ;  
            $this->fc_subtotal_cero = $rs_res->fields[12] ;  
            $this->fc_subtotal_no_objeto = $rs_res->fields[13] ;  
            $this->fc_subtotal_excento = $rs_res->fields[14] ;  
            $this->fc_valor_ice = $rs_res->fields[15] ;  
            $this->fc_valor_irbpnr = $rs_res->fields[16] ;  
            $this->fc_autorizacion = $rs_res->fields[17] ;  
            $this->fc_fecha_caducidad = $rs_res->fields[18] ;  
            $this->fc_usuario = $rs_res->fields[19] ;  
            $this->tc_nombre = $rs_res->fields[20] ;  
            $this->tc_nombre_orig = $this->tc_nombre;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->fc_subtotal, $this->fc_total_descuento, $this->fc_valor_iva, $this->fc_total, $this->fc_subtotal_iva, $this->fc_subtotal_cero, $this->fc_subtotal_no_objeto, $this->fc_subtotal_excento, $this->fc_valor_ice, $this->fc_valor_irbpnr, $this->tc_nombre, $this->fc_fecha, $this->fc_serie, $this->fc_usuario, $this->pr_identificacion, $this->pr_nombre, $this->tc_nombre_orig,  $this->fc_fecha_orig,  $this->fc_serie_orig,  $this->fc_usuario_orig,  $this->pr_identificacion_orig,  $this->pr_nombre_orig);
            }
   }
//
