...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_tc_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['arr_total']['tc_nombre'];
      }
      else
      {
          $this->array_total_tc_nombre = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_order']['fc_tipo_comprobante']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_order']['fc_tipo_comprobante'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_order']['fc_tipo_comprobante'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['fc_tipo_comprobante'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['fc_tipo_comprobante'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['fc_tipo_comprobante'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['fc_tipo_comprobante'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['fc_tipo_comprobante'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['fc_tipo_comprobante'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['summarizing_fields_display']['fc_tipo_comprobante'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_tc_nombre as $i_tc_nombre => $d_tc_nombre) {
           if (!isset($i_tc_nombre, $this->comp_label[0]) || !in_array($i_tc_nombre, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tc_nombre[12] ] = $d_tc_nombre[11];
               $this->comp_label[0][ $d_tc_nombre[12] ] = $d_tc_nombre[11];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'tc_nombre', 'prot' => '@aspass@'),
       );
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_tc_nombre => $l_tc_nombre) {
           if (isset($this->array_total_tc_nombre[$i_tc_nombre])) {
               $this->comp_group[$i_tc_nombre] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_tc_nombre;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_fc_tipo_comprobante("res", $this->NM_export);
      ...
      if (is_array($this->array_total_tc_nombre)) {
          ksort($this->array_total_tc_nombre);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_compras']['SC_Ind_Groupby'];
...
{ 
   ...
   //---- 
   function adiciona_registro($sum_fc_subtotal, $sum_fc_total_descuento, $sum_fc_valor_iva, $sum_fc_total, $sum_fc_subtotal_iva, $sum_fc_subtotal_cero, $sum_fc_subtotal_no_objeto, $sum_fc_subtotal_excento, $sum_fc_valor_ice, $sum_fc_valor_irbpnr, $quebra_tc_nombre, $quebra_tc_nombre_orig)
   {
      //----- tc_nombre
      if (!isset($this->array_total_tc_nombre[$quebra_tc_nombre_orig]))
      {
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][0] = 1;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][1] = $sum_fc_subtotal;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][2] = $sum_fc_total_descuento;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][3] = $sum_fc_valor_iva;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][4] = $sum_fc_total;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][5] = $sum_fc_subtotal_iva;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][6] = $sum_fc_subtotal_cero;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][7] = $sum_fc_subtotal_no_objeto;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][8] = $sum_fc_subtotal_excento;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][9] = $sum_fc_valor_ice;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][10] = $sum_fc_valor_irbpnr;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][11] = $quebra_tc_nombre;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][12] = $quebra_tc_nombre_orig;
      }
      else
      {
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][0]++;
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][1] = bcadd($this->array_total_tc_nombre[$quebra_tc_nombre_orig][1], $sum_fc_subtotal, 10);
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][2] = bcadd($this->array_total_tc_nombre[$quebra_tc_nombre_orig][2], $sum_fc_total_descuento, 10);
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][3] = bcadd($this->array_total_tc_nombre[$quebra_tc_nombre_orig][3], $sum_fc_valor_iva, 10);
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][4] = bcadd($this->array_total_tc_nombre[$quebra_tc_nombre_orig][4], $sum_fc_total, 10);
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][5] = bcadd($this->array_total_tc_nombre[$quebra_tc_nombre_orig][5], $sum_fc_subtotal_iva, 10);
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][6] = bcadd($this->array_total_tc_nombre[$quebra_tc_nombre_orig][6], $sum_fc_subtotal_cero, 10);
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][7] = bcadd($this->array_total_tc_nombre[$quebra_tc_nombre_orig][7], $sum_fc_subtotal_no_objeto, 10);
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][8] = bcadd($this->array_total_tc_nombre[$quebra_tc_nombre_orig][8], $sum_fc_subtotal_excento, 10);
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][9] = bcadd($this->array_total_tc_nombre[$quebra_tc_nombre_orig][9], $sum_fc_valor_ice, 10);
         $this->array_total_tc_nombre[$quebra_tc_nombre_orig][10] = bcadd($this->array_total_tc_nombre[$quebra_tc_nombre_orig][10], $sum_fc_valor_irbpnr, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('fc_tipo_comprobante', 'tc_nombre');
     $campos_order = $this->Ini->Get_date_order_groupby("tc_nombre", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->fc_subtotal, $this->fc_total_descuento, $this->fc_valor_iva, $this->fc_total, $this->fc_subtotal_iva, $this->fc_subtotal_cero, $this->fc_subtotal_no_objeto, $this->fc_subtotal_excento, $this->fc_valor_ice, $this->fc_valor_irbpnr, $this->tc_nombre, $this->tc_nombre_orig);
            }
   }
//
