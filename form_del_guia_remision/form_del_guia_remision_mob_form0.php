...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_guia_remision/form_del_guia_remision_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_guia_remision_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_guia_remision_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_del_guia_remision']['error_buffer']) && '' != $_SESSION['scriptcase']['form_del_guia_remision']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_del_guia_remision']['error_buffer'];
}
...
<?php
 include_once("form_del_guia_remision_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_del_guia_remision_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_guia_remision_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_guia_remision_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-13';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['nuevo']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['nuevo']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['nuevo']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['nuevo']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['nuevo'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['group_group_1']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['group_group_1']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['group_group_1']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['group_group_1']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['group_group_1'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['desde_factura']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['desde_factura']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['desde_factura']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['desde_factura']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['desde_factura'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['entre_establecimiento']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['entre_establecimiento']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['entre_establecimiento']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['entre_establecimiento']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['entre_establecimiento'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['autorizar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['autorizar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['autorizar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['autorizar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['autorizar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['anular']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['anular']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['anular']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['anular']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['anular'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['group_group_2']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['group_group_2']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['group_group_2']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['group_group_2']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['group_group_2'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['imprimir']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['imprimir']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['imprimir']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['imprimir']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['imprimir'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['baucher']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_disabled']['baucher']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['baucher']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['baucher']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['btn_label']['baucher'];
        }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_gr_transportista_line" id="hidden_field_data_gr_transportista" style="<?php echo $sStyleHidden_gr_transportista; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_gr_transportista_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_gr_transportista_label" style=""><span id="id_label_gr_transportista"><?php echo $this->nm_new_label['gr_transportista']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['php_cmp_required']['gr_transportista']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['php_cmp_required']['gr_transportista'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><input type="hidden" name="gr_transportista" value="<?php echo $this->form_encode_input($gr_transportista); ?>"><span id="id_ajax_label_gr_transportista"><?php echo nl2br($gr_transportista); ?></span>
<?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_del_guia_remision_mob*scout' : '';
   if (isset($this->Ini->sc_lig_md5["busca_transportista"]) && $this->Ini->sc_lig_md5["busca_transportista"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_del_guia_remision_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php if (!$this->Ini->Export_img_zip) { ?>  <div class="scBtnGrpText scBtnGrpClick"  style="<?php echo $sCondStyle; ?>" id="gbl_cap_gr_transportista">
<?php echo nmButtonOutput($this->arr_buttons, "bform_captura", "nm_submit_cap('" . $this->Ini->link_busca_transportista_cons_psq. "', '" . $Md5_Lig . "')", "nm_submit_cap('" . $this->Ini->link_busca_transportista_cons_psq. "', '" . $Md5_Lig . "')", "cap_gr_transportista", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
  </div>
<?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ruc_transportista_line" id="hidden_field_data_ruc_transportista" style="<?php echo $sStyleHidden_ruc_transportista; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ruc_transportista_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ruc_transportista_label" style=""><span id="id_label_ruc_transportista"><?php echo $this->nm_new_label['ruc_transportista']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_gr_fecha_ini_transporte_line" id="hidden_field_data_gr_fecha_ini_transporte" style="<?php echo $sStyleHidden_gr_fecha_ini_transporte; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_gr_fecha_ini_transporte_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_gr_fecha_ini_transporte_label" style=""><span id="id_label_gr_fecha_ini_transporte"><?php echo $this->nm_new_label['gr_fecha_ini_transporte']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['php_cmp_required']['gr_fecha_ini_transporte']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['php_cmp_required']['gr_fecha_ini_transporte'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_gr_fecha_fin_transporte_line" id="hidden_field_data_gr_fecha_fin_transporte" style="<?php echo $sStyleHidden_gr_fecha_fin_transporte; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_gr_fecha_fin_transporte_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_gr_fecha_fin_transporte_label" style=""><span id="id_label_gr_fecha_fin_transporte"><?php echo $this->nm_new_label['gr_fecha_fin_transporte']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['php_cmp_required']['gr_fecha_fin_transporte']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['php_cmp_required']['gr_fecha_fin_transporte'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_gr_direccion_partida_line" id="hidden_field_data_gr_direccion_partida" style="<?php echo $sStyleHidden_gr_direccion_partida; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_gr_direccion_partida_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_gr_direccion_partida_label" style=""><span id="id_label_gr_direccion_partida"><?php echo $this->nm_new_label['gr_direccion_partida']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['php_cmp_required']['gr_direccion_partida']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['php_cmp_required']['gr_direccion_partida'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php $sStyleHidden_gr_direccion_partida_dumb = ('' == $sStyleHidden_gr_direccion_partida) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_gr_direccion_partida_dumb" style="<?php echo $sStyleHidden_gr_direccion_partida_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_destinatario'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_destinatario'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['grid_del_destinatario_guia_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_destinatario'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['grid_del_destinatario_guia_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_guia_remision_mob_empty.htm' : $this->Ini->link_grid_del_destinatario_guia_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=500' . $parms_lig_cons;
...
if (isset($this->Ini->sc_lig_target['C_@scinf_destinatario']) && 'nmsc_iframe_liga_grid_del_destinatario_guia' != $this->Ini->sc_lig_target['C_@scinf_destinatario'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_destinatario'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['grid_del_destinatario_guia_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_guia_remision_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_guia_remision_mob");
 parent.scAjaxDetailHeight("form_del_guia_remision_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_guia_remision_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
