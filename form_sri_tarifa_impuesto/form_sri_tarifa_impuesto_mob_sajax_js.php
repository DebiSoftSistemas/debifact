  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sri_tarifa_impuesto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sri_tarifa_impuesto_mob_form();
	}
...
?>
  ...
  // ---------- Validate ti_id
  function do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_id()
  {
    var nomeCampo_ti_id = "ti_id";
    var var_ti_id = scAjaxGetFieldHidden(nomeCampo_ti_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_impuesto_mob_validate_ti_id(var_ti_id, var_script_case_init, do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_id_cb);
  } // do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_id

  function do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_id_cb

  // ---------- Validate ti_impuesto
  function do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_impuesto()
  {
    var nomeCampo_ti_impuesto = "ti_impuesto";
    var var_ti_impuesto = scAjaxGetFieldText(nomeCampo_ti_impuesto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_impuesto_mob_validate_ti_impuesto(var_ti_impuesto, var_script_case_init, do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_impuesto_cb);
  } // do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_impuesto

  function do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_impuesto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ti_impuesto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_impuesto_cb

  // ---------- Validate ti_descripcion
  function do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_descripcion()
  {
    var nomeCampo_ti_descripcion = "ti_descripcion";
    var var_ti_descripcion = scAjaxGetFieldText(nomeCampo_ti_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_impuesto_mob_validate_ti_descripcion(var_ti_descripcion, var_script_case_init, do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_descripcion_cb);
  } // do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_descripcion

  function do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ti_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_descripcion_cb

  // ---------- Validate ti_codigo
  function do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_codigo()
  {
    var nomeCampo_ti_codigo = "ti_codigo";
    var var_ti_codigo = scAjaxGetFieldText(nomeCampo_ti_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_impuesto_mob_validate_ti_codigo(var_ti_codigo, var_script_case_init, do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_codigo_cb);
  } // do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_codigo

  function do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ti_codigo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_codigo_cb

  // ---------- Validate ti_tarifa
  function do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_tarifa()
  {
    var nomeCampo_ti_tarifa = "ti_tarifa";
    var var_ti_tarifa = scAjaxGetFieldText(nomeCampo_ti_tarifa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_impuesto_mob_validate_ti_tarifa(var_ti_tarifa, var_script_case_init, do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_tarifa_cb);
  } // do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_tarifa

  function do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_tarifa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ti_tarifa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_tarifa_cb

  // ---------- Validate ti_estado
  function do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_estado()
  {
    var nomeCampo_ti_estado = "ti_estado";
    var var_ti_estado = scAjaxGetFieldText(nomeCampo_ti_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_impuesto_mob_validate_ti_estado(var_ti_estado, var_script_case_init, do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_estado_cb);
  } // do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_estado

  function do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ti_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_impuesto_mob_validate_ti_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sri_tarifa_impuesto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sri_tarifa_impuesto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_ti_id = scAjaxGetFieldHidden("ti_id");
    var var_ti_impuesto = scAjaxGetFieldText("ti_impuesto");
    var var_ti_descripcion = scAjaxGetFieldText("ti_descripcion");
    var var_ti_codigo = scAjaxGetFieldText("ti_codigo");
    var var_ti_tarifa = scAjaxGetFieldText("ti_tarifa");
    var var_ti_estado = scAjaxGetFieldText("ti_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_sri_tarifa_impuesto_mob_submit_form(var_ti_id, var_ti_impuesto, var_ti_descripcion, var_ti_codigo, var_ti_tarifa, var_ti_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sri_tarifa_impuesto_mob_submit_form_cb);
  } // do_ajax_form_sri_tarifa_impuesto_mob_submit_form

  function do_ajax_form_sri_tarifa_impuesto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ti_id");
      scAjaxHideErrorDisplay("ti_impuesto");
      scAjaxHideErrorDisplay("ti_descripcion");
      scAjaxHideErrorDisplay("ti_codigo");
      scAjaxHideErrorDisplay("ti_tarifa");
      scAjaxHideErrorDisplay("ti_estado");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sri_tarifa_impuesto_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sri_tarifa_impuesto_mob_submit_form_cb
  function do_ajax_form_sri_tarifa_impuesto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sri_tarifa_impuesto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sri_tarifa_impuesto_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_sri_tarifa_impuesto_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_sri_tarifa_impuesto_mob_navigate_form();
    }
  }

  function perform_ajax_form_sri_tarifa_impuesto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("ti_tarifa");
    scAjaxHideErrorDisplay("ti_estado");
    var var_ti_id = document.F2.ti_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sri_tarifa_impuesto_mob_navigate_form(var_ti_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_tarifa_impuesto_mob_navigate_form_cb);
  } // do_ajax_form_sri_tarifa_impuesto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sri_tarifa_impuesto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sri_tarifa_impuesto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ti_id.value = scAjaxGetKeyValue("ti_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sri_tarifa_impuesto_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sri_tarifa_impuesto_mob_navigate_form_cb
  function do_ajax_form_sri_tarifa_impuesto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sri_tarifa_impuesto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sri_tarifa_impuesto_mob_navigate_form_cb_after_alert

  function sc_hide_form_sri_tarifa_impuesto_mob_form()
  {
  ...
  ajax_field_list[0] = "ti_id";
  ajax_field_list[1] = "ti_impuesto";
  ajax_field_list[2] = "ti_descripcion";
  ajax_field_list[3] = "ti_codigo";
  ajax_field_list[4] = "ti_tarifa";
  ajax_field_list[5] = "ti_estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "ti_id": {"label": "Ti Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ti_impuesto": {"label": "Ti Impuesto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ti_descripcion": {"label": "Ti Descripcion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ti_codigo": {"label": "Ti Codigo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ti_tarifa": {"label": "Ti Tarifa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ti_estado": {"label": "Ti Estado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "ti_id": new Array(),
    "ti_impuesto": new Array(),
    "ti_descripcion": new Array(),
    "ti_codigo": new Array(),
    "ti_tarifa": new Array(),
    "ti_estado": new Array()
  };
  ajax_field_mult["ti_id"][1] = "ti_id";
  ajax_field_mult["ti_impuesto"][1] = "ti_impuesto";
  ajax_field_mult["ti_descripcion"][1] = "ti_descripcion";
  ajax_field_mult["ti_codigo"][1] = "ti_codigo";
  ajax_field_mult["ti_tarifa"][1] = "ti_tarifa";
  ajax_field_mult["ti_estado"][1] = "ti_estado";

  var ajax_field_id = {
    "ti_id": new Array("hidden_field_label_ti_id", "hidden_field_data_ti_id"),
    "ti_impuesto": new Array("hidden_field_label_ti_impuesto", "hidden_field_data_ti_impuesto"),
    "ti_descripcion": new Array("hidden_field_label_ti_descripcion", "hidden_field_data_ti_descripcion"),
    "ti_codigo": new Array("hidden_field_label_ti_codigo", "hidden_field_data_ti_codigo"),
    "ti_tarifa": new Array("hidden_field_label_ti_tarifa", "hidden_field_data_ti_tarifa"),
    "ti_estado": new Array("hidden_field_label_ti_estado", "hidden_field_data_ti_estado")
  };
