  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_factura_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_factura_mob_form();
	}
...
?>
  ...
  // ---------- Validate titulo
  function do_ajax_form_del_factura_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldHidden(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_del_factura_mob_validate_titulo_cb);
  } // do_ajax_form_del_factura_mob_validate_titulo

  function do_ajax_form_del_factura_mob_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_titulo_cb

  // ---------- Validate fac_estado_sri
  function do_ajax_form_del_factura_mob_validate_fac_estado_sri()
  {
    var nomeCampo_fac_estado_sri = "fac_estado_sri";
    var var_fac_estado_sri = scAjaxGetFieldHidden(nomeCampo_fac_estado_sri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_estado_sri(var_fac_estado_sri, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_estado_sri_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_estado_sri

  function do_ajax_form_del_factura_mob_validate_fac_estado_sri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_estado_sri_cb

  // ---------- Validate fac_error_sri
  function do_ajax_form_del_factura_mob_validate_fac_error_sri()
  {
    var nomeCampo_fac_error_sri = "fac_error_sri";
    var var_fac_error_sri = scAjaxGetFieldText(nomeCampo_fac_error_sri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_error_sri(var_fac_error_sri, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_error_sri_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_error_sri

  function do_ajax_form_del_factura_mob_validate_fac_error_sri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_error_sri_cb

  // ---------- Validate fac_factura_socio
  function do_ajax_form_del_factura_mob_validate_fac_factura_socio()
  {
    var nomeCampo_fac_factura_socio = "fac_factura_socio";
    var var_fac_factura_socio = scAjaxGetFieldHidden(nomeCampo_fac_factura_socio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_factura_socio(var_fac_factura_socio, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_factura_socio_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_factura_socio

  function do_ajax_form_del_factura_mob_validate_fac_factura_socio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_factura_socio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_factura_socio_cb

  // ---------- Validate fac_fecha
  function do_ajax_form_del_factura_mob_validate_fac_fecha()
  {
    var nomeCampo_fac_fecha = "fac_fecha";
    var var_fac_fecha = scAjaxGetFieldText(nomeCampo_fac_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_fecha(var_fac_fecha, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_fecha_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_fecha

  function do_ajax_form_del_factura_mob_validate_fac_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_fecha_cb

  // ---------- Validate fac_libretin
  function do_ajax_form_del_factura_mob_validate_fac_libretin()
  {
    var nomeCampo_fac_libretin = "fac_libretin";
    var var_fac_libretin = scAjaxGetFieldSelect(nomeCampo_fac_libretin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_libretin(var_fac_libretin, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_libretin_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_libretin

  function do_ajax_form_del_factura_mob_validate_fac_libretin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_libretin_cb

  // ---------- Validate secuencial
  function do_ajax_form_del_factura_mob_validate_secuencial()
  {
    var nomeCampo_secuencial = "secuencial";
    var var_secuencial = scAjaxGetFieldText(nomeCampo_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_secuencial(var_secuencial, var_script_case_init, do_ajax_form_del_factura_mob_validate_secuencial_cb);
  } // do_ajax_form_del_factura_mob_validate_secuencial

  function do_ajax_form_del_factura_mob_validate_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_secuencial_cb

  // ---------- Validate fac_moneda
  function do_ajax_form_del_factura_mob_validate_fac_moneda()
  {
    var nomeCampo_fac_moneda = "fac_moneda";
    var var_fac_moneda = scAjaxGetFieldSelect(nomeCampo_fac_moneda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_moneda(var_fac_moneda, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_moneda_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_moneda

  function do_ajax_form_del_factura_mob_validate_fac_moneda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_moneda_cb

  // ---------- Validate fac_serie_guia
  function do_ajax_form_del_factura_mob_validate_fac_serie_guia()
  {
    var nomeCampo_fac_serie_guia = "fac_serie_guia";
    var var_fac_serie_guia = scAjaxGetFieldText(nomeCampo_fac_serie_guia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_serie_guia(var_fac_serie_guia, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_serie_guia_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_serie_guia

  function do_ajax_form_del_factura_mob_validate_fac_serie_guia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_serie_guia_cb

  // ---------- Validate establecimiento
  function do_ajax_form_del_factura_mob_validate_establecimiento()
  {
    var nomeCampo_establecimiento = "establecimiento";
    var var_establecimiento = scAjaxGetFieldText(nomeCampo_establecimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_establecimiento(var_establecimiento, var_script_case_init, do_ajax_form_del_factura_mob_validate_establecimiento_cb);
  } // do_ajax_form_del_factura_mob_validate_establecimiento

  function do_ajax_form_del_factura_mob_validate_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_establecimiento_cb

  // ---------- Validate punto_emision
  function do_ajax_form_del_factura_mob_validate_punto_emision()
  {
    var nomeCampo_punto_emision = "punto_emision";
    var var_punto_emision = scAjaxGetFieldText(nomeCampo_punto_emision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_punto_emision(var_punto_emision, var_script_case_init, do_ajax_form_del_factura_mob_validate_punto_emision_cb);
  } // do_ajax_form_del_factura_mob_validate_punto_emision

  function do_ajax_form_del_factura_mob_validate_punto_emision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_punto_emision_cb

  // ---------- Validate tipo_libretin
  function do_ajax_form_del_factura_mob_validate_tipo_libretin()
  {
    var nomeCampo_tipo_libretin = "tipo_libretin";
    var var_tipo_libretin = scAjaxGetFieldText(nomeCampo_tipo_libretin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_tipo_libretin(var_tipo_libretin, var_script_case_init, do_ajax_form_del_factura_mob_validate_tipo_libretin_cb);
  } // do_ajax_form_del_factura_mob_validate_tipo_libretin

  function do_ajax_form_del_factura_mob_validate_tipo_libretin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_tipo_libretin_cb

  // ---------- Validate ambiente
  function do_ajax_form_del_factura_mob_validate_ambiente()
  {
    var nomeCampo_ambiente = "ambiente";
    var var_ambiente = scAjaxGetFieldText(nomeCampo_ambiente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_ambiente(var_ambiente, var_script_case_init, do_ajax_form_del_factura_mob_validate_ambiente_cb);
  } // do_ajax_form_del_factura_mob_validate_ambiente

  function do_ajax_form_del_factura_mob_validate_ambiente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_ambiente_cb

  // ---------- Validate fac_establecimiento
  function do_ajax_form_del_factura_mob_validate_fac_establecimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_establecimiento(var_fac_establecimiento, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_establecimiento_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_establecimiento

  function do_ajax_form_del_factura_mob_validate_fac_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_establecimiento_cb

  // ---------- Validate fac_punto_emision
  function do_ajax_form_del_factura_mob_validate_fac_punto_emision()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_punto_emision(var_fac_punto_emision, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_punto_emision_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_punto_emision

  function do_ajax_form_del_factura_mob_validate_fac_punto_emision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_punto_emision_cb

  // ---------- Validate fac_secuencial
  function do_ajax_form_del_factura_mob_validate_fac_secuencial()
  {
    var nomeCampo_fac_secuencial = "fac_secuencial";
    var var_fac_secuencial = scAjaxGetFieldHidden(nomeCampo_fac_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_secuencial(var_fac_secuencial, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_secuencial_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_secuencial

  function do_ajax_form_del_factura_mob_validate_fac_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_secuencial_cb

  // ---------- Validate fac_tipo_libretin
  function do_ajax_form_del_factura_mob_validate_fac_tipo_libretin()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_tipo_libretin(var_fac_tipo_libretin, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_tipo_libretin_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_tipo_libretin

  function do_ajax_form_del_factura_mob_validate_fac_tipo_libretin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_tipo_libretin_cb

  // ---------- Validate fac_ambiente
  function do_ajax_form_del_factura_mob_validate_fac_ambiente()
  {
    var nomeCampo_fac_ambiente = "fac_ambiente";
    var var_fac_ambiente = scAjaxGetFieldHidden(nomeCampo_fac_ambiente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_ambiente(var_fac_ambiente, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_ambiente_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_ambiente

  function do_ajax_form_del_factura_mob_validate_fac_ambiente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_ambiente_cb

  // ---------- Validate fac_tipo_comprobante
  function do_ajax_form_del_factura_mob_validate_fac_tipo_comprobante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_tipo_comprobante(var_fac_tipo_comprobante, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_tipo_comprobante_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_tipo_comprobante

  function do_ajax_form_del_factura_mob_validate_fac_tipo_comprobante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_tipo_comprobante_cb

  // ---------- Validate fac_socio_transportista
  function do_ajax_form_del_factura_mob_validate_fac_socio_transportista()
  {
    var nomeCampo_fac_socio_transportista = "fac_socio_transportista";
    var var_fac_socio_transportista = scAjaxGetFieldSelect(nomeCampo_fac_socio_transportista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_socio_transportista(var_fac_socio_transportista, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_socio_transportista_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_socio_transportista

  function do_ajax_form_del_factura_mob_validate_fac_socio_transportista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_socio_transportista";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_socio_transportista_cb

  // ---------- Validate fac_transporte_usuario
  function do_ajax_form_del_factura_mob_validate_fac_transporte_usuario()
  {
    var nomeCampo_fac_transporte_usuario = "fac_transporte_usuario";
    var var_fac_transporte_usuario = scAjaxGetFieldSelect(nomeCampo_fac_transporte_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_transporte_usuario(var_fac_transporte_usuario, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_transporte_usuario_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_transporte_usuario

  function do_ajax_form_del_factura_mob_validate_fac_transporte_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_transporte_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_transporte_usuario_cb

  // ---------- Validate fac_correo_enviado
  function do_ajax_form_del_factura_mob_validate_fac_correo_enviado()
  {
    var nomeCampo_fac_correo_enviado = "fac_correo_enviado";
    var var_fac_correo_enviado = scAjaxGetFieldText(nomeCampo_fac_correo_enviado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_correo_enviado(var_fac_correo_enviado, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_correo_enviado_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_correo_enviado

  function do_ajax_form_del_factura_mob_validate_fac_correo_enviado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_correo_enviado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_correo_enviado_cb

  // ---------- Validate fac_asiento
  function do_ajax_form_del_factura_mob_validate_fac_asiento()
  {
    var nomeCampo_fac_asiento = "fac_asiento";
    var var_fac_asiento = scAjaxGetFieldText(nomeCampo_fac_asiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_asiento(var_fac_asiento, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_asiento_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_asiento

  function do_ajax_form_del_factura_mob_validate_fac_asiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_asiento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_asiento_cb

  // ---------- Validate fac_cliente
  function do_ajax_form_del_factura_mob_validate_fac_cliente()
  {
    var nomeCampo_fac_cliente = "fac_cliente";
    var var_fac_cliente = scAjaxGetFieldHidden(nomeCampo_fac_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_cliente(var_fac_cliente, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_cliente_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_cliente

  function do_ajax_form_del_factura_mob_validate_fac_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_cliente_cb

  // ---------- Validate ruc
  function do_ajax_form_del_factura_mob_validate_ruc()
  {
    var nomeCampo_ruc = "ruc";
    var var_ruc = scAjaxGetFieldText(nomeCampo_ruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_ruc(var_ruc, var_script_case_init, do_ajax_form_del_factura_mob_validate_ruc_cb);
  } // do_ajax_form_del_factura_mob_validate_ruc

  function do_ajax_form_del_factura_mob_validate_ruc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ruc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_ruc_cb

  // ---------- Validate fac_nombre_cliente
  function do_ajax_form_del_factura_mob_validate_fac_nombre_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_nombre_cliente(var_fac_nombre_cliente, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_nombre_cliente_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_nombre_cliente

  function do_ajax_form_del_factura_mob_validate_fac_nombre_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_nombre_cliente_cb

  // ---------- Validate fac_direccion_cliente
  function do_ajax_form_del_factura_mob_validate_fac_direccion_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_direccion_cliente(var_fac_direccion_cliente, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_direccion_cliente_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_direccion_cliente

  function do_ajax_form_del_factura_mob_validate_fac_direccion_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_direccion_cliente_cb

  // ---------- Validate fac_email_cliente
  function do_ajax_form_del_factura_mob_validate_fac_email_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_email_cliente(var_fac_email_cliente, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_email_cliente_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_email_cliente

  function do_ajax_form_del_factura_mob_validate_fac_email_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_email_cliente_cb

  // ---------- Validate fac_aplica_propina
  function do_ajax_form_del_factura_mob_validate_fac_aplica_propina()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_aplica_propina(var_fac_aplica_propina, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_aplica_propina_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_aplica_propina

  function do_ajax_form_del_factura_mob_validate_fac_aplica_propina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_aplica_propina_cb

  // ---------- Validate fac_diagnostico
  function do_ajax_form_del_factura_mob_validate_fac_diagnostico()
  {
    var nomeCampo_fac_diagnostico = "fac_diagnostico";
    var var_fac_diagnostico = scAjaxGetFieldSelect(nomeCampo_fac_diagnostico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_diagnostico(var_fac_diagnostico, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_diagnostico_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_diagnostico

  function do_ajax_form_del_factura_mob_validate_fac_diagnostico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_diagnostico_cb

  // ---------- Validate fac_comentario
  function do_ajax_form_del_factura_mob_validate_fac_comentario()
  {
    var nomeCampo_fac_comentario = "fac_comentario";
    var var_fac_comentario = scAjaxGetFieldText(nomeCampo_fac_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_comentario(var_fac_comentario, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_comentario_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_comentario

  function do_ajax_form_del_factura_mob_validate_fac_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_comentario_cb

  // ---------- Validate detalle
  function do_ajax_form_del_factura_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_del_factura_mob_validate_detalle_cb);
  } // do_ajax_form_del_factura_mob_validate_detalle

  function do_ajax_form_del_factura_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_detalle_cb

  // ---------- Validate fac_subtotal
  function do_ajax_form_del_factura_mob_validate_fac_subtotal()
  {
    var nomeCampo_fac_subtotal = "fac_subtotal";
    var var_fac_subtotal = scAjaxGetFieldText(nomeCampo_fac_subtotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_subtotal(var_fac_subtotal, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_subtotal_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_subtotal

  function do_ajax_form_del_factura_mob_validate_fac_subtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_subtotal_cb

  // ---------- Validate fac_subtotal_iva
  function do_ajax_form_del_factura_mob_validate_fac_subtotal_iva()
  {
    var nomeCampo_fac_subtotal_iva = "fac_subtotal_iva";
    var var_fac_subtotal_iva = scAjaxGetFieldText(nomeCampo_fac_subtotal_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_subtotal_iva(var_fac_subtotal_iva, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_subtotal_iva_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_subtotal_iva

  function do_ajax_form_del_factura_mob_validate_fac_subtotal_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_subtotal_iva_cb

  // ---------- Validate fac_subtotal_cero
  function do_ajax_form_del_factura_mob_validate_fac_subtotal_cero()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_subtotal_cero(var_fac_subtotal_cero, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_subtotal_cero_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_subtotal_cero

  function do_ajax_form_del_factura_mob_validate_fac_subtotal_cero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_subtotal_cero_cb

  // ---------- Validate fac_subtotal_no_objeto
  function do_ajax_form_del_factura_mob_validate_fac_subtotal_no_objeto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_subtotal_no_objeto(var_fac_subtotal_no_objeto, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_subtotal_no_objeto_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_subtotal_no_objeto

  function do_ajax_form_del_factura_mob_validate_fac_subtotal_no_objeto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_subtotal_no_objeto_cb

  // ---------- Validate fac_subtotal_excento
  function do_ajax_form_del_factura_mob_validate_fac_subtotal_excento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_subtotal_excento(var_fac_subtotal_excento, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_subtotal_excento_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_subtotal_excento

  function do_ajax_form_del_factura_mob_validate_fac_subtotal_excento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_subtotal_excento_cb

  // ---------- Validate fac_total_descuento
  function do_ajax_form_del_factura_mob_validate_fac_total_descuento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_total_descuento(var_fac_total_descuento, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_total_descuento_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_total_descuento

  function do_ajax_form_del_factura_mob_validate_fac_total_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_total_descuento_cb

  // ---------- Validate fac_valor_ice
  function do_ajax_form_del_factura_mob_validate_fac_valor_ice()
  {
    var nomeCampo_fac_valor_ice = "fac_valor_ice";
    var var_fac_valor_ice = scAjaxGetFieldText(nomeCampo_fac_valor_ice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_valor_ice(var_fac_valor_ice, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_valor_ice_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_valor_ice

  function do_ajax_form_del_factura_mob_validate_fac_valor_ice_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_valor_ice_cb

  // ---------- Validate fac_valor_iva
  function do_ajax_form_del_factura_mob_validate_fac_valor_iva()
  {
    var nomeCampo_fac_valor_iva = "fac_valor_iva";
    var var_fac_valor_iva = scAjaxGetFieldText(nomeCampo_fac_valor_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_valor_iva(var_fac_valor_iva, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_valor_iva_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_valor_iva

  function do_ajax_form_del_factura_mob_validate_fac_valor_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_valor_iva_cb

  // ---------- Validate fac_valor_irbpnr
  function do_ajax_form_del_factura_mob_validate_fac_valor_irbpnr()
  {
    var nomeCampo_fac_valor_irbpnr = "fac_valor_irbpnr";
    var var_fac_valor_irbpnr = scAjaxGetFieldText(nomeCampo_fac_valor_irbpnr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_valor_irbpnr(var_fac_valor_irbpnr, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_valor_irbpnr_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_valor_irbpnr

  function do_ajax_form_del_factura_mob_validate_fac_valor_irbpnr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_valor_irbpnr_cb

  // ---------- Validate fac_propina
  function do_ajax_form_del_factura_mob_validate_fac_propina()
  {
    var nomeCampo_fac_propina = "fac_propina";
    var var_fac_propina = scAjaxGetFieldText(nomeCampo_fac_propina);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_propina(var_fac_propina, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_propina_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_propina

  function do_ajax_form_del_factura_mob_validate_fac_propina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_propina_cb

  // ---------- Validate fac_total
  function do_ajax_form_del_factura_mob_validate_fac_total()
  {
    var nomeCampo_fac_total = "fac_total";
    var var_fac_total = scAjaxGetFieldText(nomeCampo_fac_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_total(var_fac_total, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_total_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_total

  function do_ajax_form_del_factura_mob_validate_fac_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_total_cb

  // ---------- Validate fac_valor_entrega
  function do_ajax_form_del_factura_mob_validate_fac_valor_entrega()
  {
    var nomeCampo_fac_valor_entrega = "fac_valor_entrega";
    var var_fac_valor_entrega = scAjaxGetFieldText(nomeCampo_fac_valor_entrega);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_valor_entrega(var_fac_valor_entrega, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_valor_entrega_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_valor_entrega

  function do_ajax_form_del_factura_mob_validate_fac_valor_entrega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_valor_entrega_cb

  // ---------- Validate fac_cambio
  function do_ajax_form_del_factura_mob_validate_fac_cambio()
  {
    var nomeCampo_fac_cambio = "fac_cambio";
    var var_fac_cambio = scAjaxGetFieldText(nomeCampo_fac_cambio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_fac_cambio(var_fac_cambio, var_script_case_init, do_ajax_form_del_factura_mob_validate_fac_cambio_cb);
  } // do_ajax_form_del_factura_mob_validate_fac_cambio

  function do_ajax_form_del_factura_mob_validate_fac_cambio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_cambio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_fac_cambio_cb

  // ---------- Validate forma_pago
  function do_ajax_form_del_factura_mob_validate_forma_pago()
  {
    var nomeCampo_forma_pago = "forma_pago";
    var var_forma_pago = scAjaxGetFieldText(nomeCampo_forma_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_mob_validate_forma_pago(var_forma_pago, var_script_case_init, do_ajax_form_del_factura_mob_validate_forma_pago_cb);
  } // do_ajax_form_del_factura_mob_validate_forma_pago

  function do_ajax_form_del_factura_mob_validate_forma_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_validate_forma_pago_cb

  // ---------- Refresh fac_libretin
  function do_ajax_form_del_factura_mob_refresh_fac_libretin()
  {
    var var_fac_libretin = scAjaxGetFieldSelect("fac_libretin");
    var var_fac_socio_transportista = scAjaxGetFieldSelect("fac_socio_transportista");
    var var_nmgp_refresh_fields = "fac_transporte_usuario";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_mob_refresh_fac_libretin(var_fac_libretin, var_fac_socio_transportista, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_factura_mob_refresh_fac_libretin_cb);
  } // do_ajax_form_del_factura_mob_refresh_fac_libretin

  function do_ajax_form_del_factura_mob_refresh_fac_libretin_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_refresh_fac_libretin_cb

  // ---------- Refresh fac_socio_transportista
  function do_ajax_form_del_factura_mob_refresh_fac_socio_transportista()
  {
    var var_fac_socio_transportista = scAjaxGetFieldSelect("fac_socio_transportista");
    var var_nmgp_refresh_fields = "fac_transporte_usuario";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_mob_refresh_fac_socio_transportista(var_fac_socio_transportista, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_factura_mob_refresh_fac_socio_transportista_cb);
  } // do_ajax_form_del_factura_mob_refresh_fac_socio_transportista

  function do_ajax_form_del_factura_mob_refresh_fac_socio_transportista_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_mob_refresh_fac_socio_transportista_cb

  // ---------- Event onchange fac_libretin
  function do_ajax_form_del_factura_mob_event_fac_libretin_onchange()
  {
    var var_fac_libretin = scAjaxGetFieldSelect("fac_libretin");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_mob_event_fac_libretin_onchange(var_fac_libretin, var_fac_establecimiento, var_fac_punto_emision, var_fac_secuencial, var_fac_ambiente, var_fac_tipo_libretin, var_establecimiento, var_punto_emision, var_secuencial, var_ambiente, var_tipo_libretin, var_fac_estado_sri, var_fac_tipo_comprobante, var_script_case_init, do_ajax_form_del_factura_mob_event_fac_libretin_onchange_cb);
  } // do_ajax_form_del_factura_mob_event_fac_libretin_onchange

  function do_ajax_form_del_factura_mob_event_fac_libretin_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_libretin";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_mob_event_fac_libretin_onchange_cb_after_alert);
  } // do_ajax_form_del_factura_mob_event_fac_libretin_onchange_cb
  function do_ajax_form_del_factura_mob_event_fac_libretin_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_del_factura_mob_refresh_fac_libretin();
    scAjaxRedir();
  } // do_ajax_form_del_factura_mob_event_fac_libretin_onchange_cb_after_alert

  // ---------- Event onblur fac_valor_entrega
  function do_ajax_form_del_factura_mob_event_fac_valor_entrega_onblur()
  {
    var var_fac_total = scAjaxGetFieldText("fac_total");
    var var_fac_valor_entrega = scAjaxGetFieldText("fac_valor_entrega");
    var var_fac_cambio = scAjaxGetFieldText("fac_cambio");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_mob_event_fac_valor_entrega_onblur(var_fac_total, var_fac_valor_entrega, var_fac_cambio, var_script_case_init, do_ajax_form_del_factura_mob_event_fac_valor_entrega_onblur_cb);
  } // do_ajax_form_del_factura_mob_event_fac_valor_entrega_onblur

  function do_ajax_form_del_factura_mob_event_fac_valor_entrega_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_valor_entrega";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_mob_event_fac_valor_entrega_onblur_cb_after_alert);
  } // do_ajax_form_del_factura_mob_event_fac_valor_entrega_onblur_cb
  function do_ajax_form_del_factura_mob_event_fac_valor_entrega_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_factura_mob_event_fac_valor_entrega_onblur_cb_after_alert

  // ---------- Event onchange fac_aplica_propina
  function do_ajax_form_del_factura_mob_event_fac_aplica_propina_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_mob_event_fac_aplica_propina_onchange(var_fac_aplica_propina, var_fac_subtotal, var_fac_subtotal_iva, var_fac_subtotal_cero, var_fac_subtotal_no_objeto, var_fac_subtotal_excento, var_fac_total_descuento, var_fac_valor_ice, var_fac_valor_iva, var_fac_valor_irbpnr, var_fac_propina, var_fac_total, var_script_case_init, do_ajax_form_del_factura_mob_event_fac_aplica_propina_onchange_cb);
  } // do_ajax_form_del_factura_mob_event_fac_aplica_propina_onchange

  function do_ajax_form_del_factura_mob_event_fac_aplica_propina_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_aplica_propina";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_mob_event_fac_aplica_propina_onchange_cb_after_alert);
  } // do_ajax_form_del_factura_mob_event_fac_aplica_propina_onchange_cb
  function do_ajax_form_del_factura_mob_event_fac_aplica_propina_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_factura_mob_event_fac_aplica_propina_onchange_cb_after_alert

  // ---------- Event onchange fac_cliente
  function do_ajax_form_del_factura_mob_event_fac_cliente_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_mob_event_fac_cliente_onchange(var_fac_cliente, var_fac_nombre_cliente, var_fac_direccion_cliente, var_fac_email_cliente, var_ruc, var_script_case_init, do_ajax_form_del_factura_mob_event_fac_cliente_onchange_cb);
  } // do_ajax_form_del_factura_mob_event_fac_cliente_onchange

  function do_ajax_form_del_factura_mob_event_fac_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_mob_event_fac_cliente_onchange_cb_after_alert);
  } // do_ajax_form_del_factura_mob_event_fac_cliente_onchange_cb
  function do_ajax_form_del_factura_mob_event_fac_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_factura_mob_event_fac_cliente_onchange_cb_after_alert

  // ---------- Event onchange fac_fecha
  function do_ajax_form_del_factura_mob_event_fac_fecha_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_mob_event_fac_fecha_onchange(var_fac_fecha, var_fac_subtotal, var_fac_subtotal_iva, var_fac_subtotal_cero, var_fac_subtotal_no_objeto, var_fac_subtotal_excento, var_fac_total_descuento, var_fac_valor_ice, var_fac_valor_iva, var_fac_valor_irbpnr, var_fac_propina, var_fac_total, var_script_case_init, do_ajax_form_del_factura_mob_event_fac_fecha_onchange_cb);
  } // do_ajax_form_del_factura_mob_event_fac_fecha_onchange

  function do_ajax_form_del_factura_mob_event_fac_fecha_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_fecha";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_mob_event_fac_fecha_onchange_cb_after_alert);
  } // do_ajax_form_del_factura_mob_event_fac_fecha_onchange_cb
  function do_ajax_form_del_factura_mob_event_fac_fecha_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_factura_mob_event_fac_fecha_onchange_cb_after_alert

  // ---------- Event onblur fac_fecha
  function do_ajax_form_del_factura_mob_event_fac_fecha_onblur()
  {
    var var_fac_fecha = scAjaxGetFieldText("fac_fecha");
    var var_fac_subtotal = scAjaxGetFieldText("fac_subtotal");
    var var_fac_subtotal_iva = scAjaxGetFieldText("fac_subtotal_iva");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_mob_event_fac_fecha_onblur(var_fac_fecha, var_fac_subtotal, var_fac_subtotal_iva, var_fac_subtotal_cero, var_fac_subtotal_no_objeto, var_fac_subtotal_excento, var_fac_total_descuento, var_fac_valor_ice, var_fac_valor_iva, var_fac_valor_irbpnr, var_fac_propina, var_fac_total, var_script_case_init, do_ajax_form_del_factura_mob_event_fac_fecha_onblur_cb);
  } // do_ajax_form_del_factura_mob_event_fac_fecha_onblur

  function do_ajax_form_del_factura_mob_event_fac_fecha_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_fecha";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_mob_event_fac_fecha_onblur_cb_after_alert);
  } // do_ajax_form_del_factura_mob_event_fac_fecha_onblur_cb
  function do_ajax_form_del_factura_mob_event_fac_fecha_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_factura_mob_event_fac_fecha_onblur_cb_after_alert

  // ---------- Event onclick scajaxbutton_enviar
  function do_ajax_form_del_factura_mob_event_scajaxbutton_enviar_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_mob_event_scajaxbutton_enviar_onclick(var_script_case_init, do_ajax_form_del_factura_mob_event_scajaxbutton_enviar_onclick_cb);
  } // do_ajax_form_del_factura_mob_event_scajaxbutton_enviar_onclick

  function do_ajax_form_del_factura_mob_event_scajaxbutton_enviar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_mob_event_scajaxbutton_enviar_onclick_cb_after_alert);
  } // do_ajax_form_del_factura_mob_event_scajaxbutton_enviar_onclick_cb
  function do_ajax_form_del_factura_mob_event_scajaxbutton_enviar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_factura_mob_event_scajaxbutton_enviar_onclick_cb_after_alert

  // ---------- Event onclick scajaxbutton_anular
  function do_ajax_form_del_factura_mob_event_scajaxbutton_anular_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_mob_event_scajaxbutton_anular_onclick(var_script_case_init, do_ajax_form_del_factura_mob_event_scajaxbutton_anular_onclick_cb);
  } // do_ajax_form_del_factura_mob_event_scajaxbutton_anular_onclick

  function do_ajax_form_del_factura_mob_event_scajaxbutton_anular_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_mob_event_scajaxbutton_anular_onclick_cb_after_alert);
  } // do_ajax_form_del_factura_mob_event_scajaxbutton_anular_onclick_cb
  function do_ajax_form_del_factura_mob_event_scajaxbutton_anular_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_factura_mob_event_scajaxbutton_anular_onclick_cb_after_alert

  // ---------- Event onclick scajaxbutton_facturar_socio
  function do_ajax_form_del_factura_mob_event_scajaxbutton_facturar_socio_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_mob_event_scajaxbutton_facturar_socio_onclick(var_script_case_init, do_ajax_form_del_factura_mob_event_scajaxbutton_facturar_socio_onclick_cb);
  } // do_ajax_form_del_factura_mob_event_scajaxbutton_facturar_socio_onclick

  function do_ajax_form_del_factura_mob_event_scajaxbutton_facturar_socio_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scajaxbutton_facturar_socio";
    scAjaxUpdateFieldErrors(sFieldValid, "onclick");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_mob_event_scajaxbutton_facturar_socio_onclick_cb_after_alert);
  } // do_ajax_form_del_factura_mob_event_scajaxbutton_facturar_socio_onclick_cb
  function do_ajax_form_del_factura_mob_event_scajaxbutton_facturar_socio_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_factura_mob_event_scajaxbutton_facturar_socio_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_factura_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_factura_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_fac_factura_socio = scAjaxGetFieldHidden("fac_factura_socio");
    var var_fac_fecha = scAjaxGetFieldText("fac_fecha");
    var var_fac_libretin = scAjaxGetFieldSelect("fac_libretin");
    var var_secuencial = scAjaxGetFieldText("secuencial");
    ...
    var var_fac_tipo_comprobante = scAjaxGetFieldHidden("fac_tipo_comprobante");
    var var_fac_socio_transportista = scAjaxGetFieldSelect("fac_socio_transportista");
    var var_fac_transporte_usuario = scAjaxGetFieldSelect("fac_transporte_usuario");
    var var_fac_correo_enviado = scAjaxGetFieldText("fac_correo_enviado");
    var var_fac_asiento = scAjaxGetFieldText("fac_asiento");
    var var_fac_cliente = scAjaxGetFieldHidden("fac_cliente");
    var var_ruc = scAjaxGetFieldText("ruc");
    var var_fac_nombre_cliente = scAjaxGetFieldText("fac_nombre_cliente");
    var var_fac_direccion_cliente = scAjaxGetFieldText("fac_direccion_cliente");
    ...
    var var_fac_valor_entrega = scAjaxGetFieldText("fac_valor_entrega");
    var var_fac_cambio = scAjaxGetFieldText("fac_cambio");
    var var_fac_numero = scAjaxGetFieldText("fac_numero");
    ...
    scAjaxProcOn();
    x_ajax_form_del_factura_mob_submit_form(var_titulo, var_fac_estado_sri, var_fac_error_sri, var_fac_factura_socio, var_fac_fecha, var_fac_libretin, var_secuencial, var_fac_moneda, var_fac_serie_guia, var_establecimiento, var_punto_emision, var_tipo_libretin, var_ambiente, var_fac_establecimiento, var_fac_punto_emision, var_fac_secuencial, var_fac_tipo_libretin, var_fac_ambiente, var_fac_tipo_comprobante, var_fac_socio_transportista, var_fac_transporte_usuario, var_fac_correo_enviado, var_fac_asiento, var_fac_cliente, var_ruc, var_fac_nombre_cliente, var_fac_direccion_cliente, var_fac_email_cliente, var_fac_aplica_propina, var_fac_diagnostico, var_fac_comentario, var_fac_subtotal, var_fac_subtotal_iva, var_fac_subtotal_cero, var_fac_subtotal_no_objeto, var_fac_subtotal_excento, var_fac_total_descuento, var_fac_valor_ice, var_fac_valor_iva, var_fac_valor_irbpnr, var_fac_propina, var_fac_total, var_fac_valor_entrega, var_fac_cambio, var_fac_numero, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_factura_mob_submit_form_cb);
  } // do_ajax_form_del_factura_mob_submit_form

  function do_ajax_form_del_factura_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("fac_factura_socio");
      ...
      scAjaxHideErrorDisplay("fac_socio_transportista");
      scAjaxHideErrorDisplay("fac_transporte_usuario");
      scAjaxHideErrorDisplay("fac_correo_enviado");
      scAjaxHideErrorDisplay("fac_asiento");
      ...
      scAjaxHideErrorDisplay("fac_valor_entrega");
      scAjaxHideErrorDisplay("fac_cambio");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_factura_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_factura_mob_submit_form_cb
  function do_ajax_form_del_factura_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_factura_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_del_detalle_factura_mob"] = "off";
  scStatusDetail["form_del_forma_pago_factura_mob"] = "off";

  function do_ajax_form_del_factura_mob_navigate_form()
  {
    perform_ajax_form_del_factura_mob_navigate_form();
  }

  function perform_ajax_form_del_factura_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_del_detalle_factura_mob"] = "on";
    scStatusDetail["form_del_forma_pago_factura_mob"] = "on";
    x_ajax_form_del_factura_mob_navigate_form(var_fac_numero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_factura_mob_navigate_form_cb);
  } // do_ajax_form_del_factura_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_factura_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_del_detalle_factura_mob"] && "nmsc_iframe_liga_form_del_detalle_factura_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_del_detalle_factura_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_del_detalle_factura_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_del_detalle_factura_mob').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_del_detalle_factura_mob').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_del_detalle_factura_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_del_forma_pago_factura_mob"] && "nmsc_iframe_liga_form_del_forma_pago_factura_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_del_forma_pago_factura_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_del_forma_pago_factura_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_del_forma_pago_factura_mob').contentWindow.nm_move('apl_detalhe', true, '200');
        document.getElementById('nmsc_iframe_liga_form_del_forma_pago_factura_mob').style.height = "200";
        document.getElementById('nmsc_iframe_liga_form_del_forma_pago_factura_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_factura_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_factura_mob_navigate_form_cb
  function do_ajax_form_del_factura_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_factura_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_del_factura_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_factura_mob_form()
  {
  ...
  function do_ajax_form_del_factura_mob_lkpedt_refresh_fac_cliente()
  {
    var var_fac_cliente = scAjaxGetFieldHidden("fac_cliente");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "fac_cliente";
    x_ajax_form_del_factura_mob_lkpedt_refresh_fac_cliente(var_fac_cliente, nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_factura_mob_lkpedt_refresh_fac_cliente_cb);
  } // do_ajax_form_del_factura_mob_lkpedt_refresh_fac_cliente

  function do_ajax_form_del_factura_mob_lkpedt_refresh_fac_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_del_factura_mob_lkpedt_refresh_fac_cliente_cb

  function do_ajax_form_del_factura_mob_lkpedt_refresh_fac_diagnostico()
  {
    var var_fac_diagnostico = scAjaxGetFieldSelect("fac_diagnostico");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "fac_diagnostico";
    x_ajax_form_del_factura_mob_lkpedt_refresh_fac_diagnostico(var_fac_diagnostico, nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_factura_mob_lkpedt_refresh_fac_diagnostico_cb);
  } // do_ajax_form_del_factura_mob_lkpedt_refresh_fac_diagnostico

  function do_ajax_form_del_factura_mob_lkpedt_refresh_fac_diagnostico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_del_factura_mob_lkpedt_refresh_fac_diagnostico_cb
  ...
  {
    if ("off" == scStatusDetail["form_del_detalle_factura_mob"] && "off" == scStatusDetail["form_del_forma_pago_factura_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[3] = "fac_factura_socio";
  ajax_field_list[4] = "fac_fecha";
  ajax_field_list[5] = "fac_libretin";
  ajax_field_list[6] = "secuencial";
  ajax_field_list[7] = "fac_moneda";
  ajax_field_list[8] = "fac_serie_guia";
  ajax_field_list[9] = "establecimiento";
  ajax_field_list[10] = "punto_emision";
  ajax_field_list[11] = "tipo_libretin";
  ajax_field_list[12] = "ambiente";
  ajax_field_list[13] = "fac_establecimiento";
  ajax_field_list[14] = "fac_punto_emision";
  ajax_field_list[15] = "fac_secuencial";
  ajax_field_list[16] = "fac_tipo_libretin";
  ajax_field_list[17] = "fac_ambiente";
  ajax_field_list[18] = "fac_tipo_comprobante";
  ajax_field_list[19] = "fac_socio_transportista";
  ajax_field_list[20] = "fac_transporte_usuario";
  ajax_field_list[21] = "fac_correo_enviado";
  ajax_field_list[22] = "fac_asiento";
  ajax_field_list[23] = "fac_cliente";
  ajax_field_list[24] = "ruc";
  ajax_field_list[25] = "fac_nombre_cliente";
  ajax_field_list[26] = "fac_direccion_cliente";
  ajax_field_list[27] = "fac_email_cliente";
  ajax_field_list[28] = "fac_aplica_propina";
  ajax_field_list[29] = "fac_diagnostico";
  ajax_field_list[30] = "fac_comentario";
  ajax_field_list[31] = "detalle";
  ajax_field_list[32] = "fac_subtotal";
  ajax_field_list[33] = "fac_subtotal_iva";
  ajax_field_list[34] = "fac_subtotal_cero";
  ajax_field_list[35] = "fac_subtotal_no_objeto";
  ajax_field_list[36] = "fac_subtotal_excento";
  ajax_field_list[37] = "fac_total_descuento";
  ajax_field_list[38] = "fac_valor_ice";
  ajax_field_list[39] = "fac_valor_iva";
  ajax_field_list[40] = "fac_valor_irbpnr";
  ajax_field_list[41] = "fac_propina";
  ajax_field_list[42] = "fac_total";
  ajax_field_list[43] = "fac_valor_entrega";
  ajax_field_list[44] = "fac_cambio";
  ajax_field_list[45] = "forma_pago";
  ...
  var ajax_error_list = {
    ...
    "fac_factura_socio": {"label": "Fac Factura Socio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "fac_socio_transportista": {"label": "<?php echo $this->Ini->Nm_lang['lang_socio'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fac_transporte_usuario": {"label": "<?php echo $this->Ini->Nm_lang['lang_vehiculos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fac_correo_enviado": {"label": "Fac Correo Enviado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fac_asiento": {"label": "Fac Asiento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "fac_valor_entrega": {"label": "<?php echo $this->Ini->Nm_lang['lang_pago'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fac_cambio": {"label": "<?php echo $this->Ini->Nm_lang['lang_cambio'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "fac_socio_transportista": new Array(),
    "fac_transporte_usuario": new Array(),
    "fac_correo_enviado": new Array(),
    "fac_asiento": new Array(),
    ...
    "fac_total": new Array(),
    "fac_valor_entrega": new Array(),
    "fac_cambio": new Array(),
  ...
  ajax_field_mult["fac_factura_socio"][1] = "fac_factura_socio";
  ...
  ajax_field_mult["fac_socio_transportista"][1] = "fac_socio_transportista";
  ajax_field_mult["fac_transporte_usuario"][1] = "fac_transporte_usuario";
  ajax_field_mult["fac_correo_enviado"][1] = "fac_correo_enviado";
  ajax_field_mult["fac_asiento"][1] = "fac_asiento";
  ...
  ajax_field_mult["fac_valor_entrega"][1] = "fac_valor_entrega";
  ajax_field_mult["fac_cambio"][1] = "fac_cambio";
  ...
  var ajax_field_id = {
    ...
    "fac_socio_transportista": new Array("hidden_field_label_fac_socio_transportista", "hidden_field_data_fac_socio_transportista"),
    "fac_transporte_usuario": new Array("hidden_field_label_fac_transporte_usuario", "hidden_field_data_fac_transporte_usuario"),
    "fac_cliente": new Array("hidden_field_label_fac_cliente", "hidden_field_data_fac_cliente"),
    ...
    "fac_subtotal": new Array("hidden_field_label_fac_subtotal", "hidden_field_data_fac_subtotal"),
    "fac_subtotal_iva": new Array("hidden_field_label_fac_subtotal_iva", "hidden_field_data_fac_subtotal_iva"),
    "fac_subtotal_cero": new Array("hidden_field_label_fac_subtotal_cero", "hidden_field_data_fac_subtotal_cero"),
    "fac_subtotal_no_objeto": new Array("hidden_field_label_fac_subtotal_no_objeto", "hidden_field_data_fac_subtotal_no_objeto"),
    "fac_subtotal_excento": new Array("hidden_field_label_fac_subtotal_excento", "hidden_field_data_fac_subtotal_excento"),
    "fac_total_descuento": new Array("hidden_field_label_fac_total_descuento", "hidden_field_data_fac_total_descuento"),
    "fac_valor_ice": new Array("hidden_field_label_fac_valor_ice", "hidden_field_data_fac_valor_ice"),
    "fac_valor_iva": new Array("hidden_field_label_fac_valor_iva", "hidden_field_data_fac_valor_iva"),
    "fac_valor_irbpnr": new Array("hidden_field_label_fac_valor_irbpnr", "hidden_field_data_fac_valor_irbpnr"),
    "fac_propina": new Array("hidden_field_label_fac_propina", "hidden_field_data_fac_propina"),
    "fac_total": new Array("hidden_field_label_fac_total", "hidden_field_data_fac_total"),
    "fac_valor_entrega": new Array("hidden_field_label_fac_valor_entrega", "hidden_field_data_fac_valor_entrega"),
    "fac_cambio": new Array("hidden_field_label_fac_cambio", "hidden_field_data_fac_cambio"),
  ...
  var ajax_read_only = {
    ...
    "fac_socio_transportista": "off",
    "fac_transporte_usuario": "off",
    "fac_correo_enviado": "off",
    "fac_asiento": "off",
    "fac_cliente": "off",
    "ruc": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("fac_socio_transportista" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("fac_transporte_usuario" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
