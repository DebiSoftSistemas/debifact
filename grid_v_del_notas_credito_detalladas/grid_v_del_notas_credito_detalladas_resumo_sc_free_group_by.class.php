...
class grid_v_del_notas_credito_detalladas_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_mes;
   var $array_total_nc_fecha;
   var $array_total_nc_serie;
   var $array_total_nc_secuencial;
   var $array_total_pro_descripcion;
   var $array_total_nc_usuario;
   ...
   var $conv_col;
   var $count_ger;
   var $sum_dnc_subtotal;
   var $sum_dnc_descuento;
   var $sum_dnc_base_iva;
   var $sum_dnc_valor_iva;
   var $sum_dnc_total;
   var $sum_dnc_valor_ice;
   var $sum_dnc_valor_irbpnr;
   var $sc_proc_quebra_anio;
   var $count_anio;
   var $sum_anio_dnc_subtotal;
   var $sum_anio_dnc_descuento;
   var $sum_anio_dnc_base_iva;
   var $sum_anio_dnc_valor_iva;
   var $sum_anio_dnc_total;
   var $sum_anio_dnc_valor_ice;
   var $sum_anio_dnc_valor_irbpnr;
   var $sc_proc_quebra_mes;
   var $count_mes;
   var $sum_mes_dnc_subtotal;
   var $sum_mes_dnc_descuento;
   var $sum_mes_dnc_base_iva;
   var $sum_mes_dnc_valor_iva;
   var $sum_mes_dnc_total;
   var $sum_mes_dnc_valor_ice;
   var $sum_mes_dnc_valor_irbpnr;
   var $sc_proc_quebra_nc_fecha;
   var $count_nc_fecha;
   var $sum_nc_fecha_dnc_subtotal;
   var $sum_nc_fecha_dnc_descuento;
   var $sum_nc_fecha_dnc_base_iva;
   var $sum_nc_fecha_dnc_valor_iva;
   var $sum_nc_fecha_dnc_total;
   var $sum_nc_fecha_dnc_valor_ice;
   var $sum_nc_fecha_dnc_valor_irbpnr;
   var $sc_proc_quebra_nc_serie;
   var $count_nc_serie;
   var $sum_nc_serie_dnc_subtotal;
   var $sum_nc_serie_dnc_descuento;
   var $sum_nc_serie_dnc_base_iva;
   var $sum_nc_serie_dnc_valor_iva;
   var $sum_nc_serie_dnc_total;
   var $sum_nc_serie_dnc_valor_ice;
   var $sum_nc_serie_dnc_valor_irbpnr;
   var $sc_proc_quebra_nc_secuencial;
   var $count_nc_secuencial;
   var $sum_nc_secuencial_dnc_subtotal;
   var $sum_nc_secuencial_dnc_descuento;
   var $sum_nc_secuencial_dnc_base_iva;
   var $sum_nc_secuencial_dnc_valor_iva;
   var $sum_nc_secuencial_dnc_total;
   var $sum_nc_secuencial_dnc_valor_ice;
   var $sum_nc_secuencial_dnc_valor_irbpnr;
   var $sc_proc_quebra_pro_descripcion;
   var $count_pro_descripcion;
   var $sum_pro_descripcion_dnc_subtotal;
   var $sum_pro_descripcion_dnc_descuento;
   var $sum_pro_descripcion_dnc_base_iva;
   var $sum_pro_descripcion_dnc_valor_iva;
   var $sum_pro_descripcion_dnc_total;
   var $sum_pro_descripcion_dnc_valor_ice;
   var $sum_pro_descripcion_dnc_valor_irbpnr;
   var $sc_proc_quebra_nc_usuario;
   var $count_nc_usuario;
   var $sum_nc_usuario_dnc_subtotal;
   var $sum_nc_usuario_dnc_descuento;
   var $sum_nc_usuario_dnc_base_iva;
   var $sum_nc_usuario_dnc_valor_iva;
   var $sum_nc_usuario_dnc_total;
   var $sum_nc_usuario_dnc_valor_ice;
   var $sum_nc_usuario_dnc_valor_irbpnr;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_nc_fecha        = array();
      $this->array_total_nc_serie        = array();
      $this->array_total_nc_secuencial   = array();
      $this->array_total_pro_descripcion = array();
      $this->array_total_nc_usuario      = array();
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_v_del_notas_credito_detalladas'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_v_del_notas_credito_detalladas'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
           $this->nmgp_botoes[$BTN] = $BTN_opc;
       }
   }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_notas_credito_detalladas']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_notas_credito_detalladas']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_notas_credito_detalladas']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_v_del_notas_credito_detalladas']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_v_del_notas_credito_detalladas']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['orig_pesq'] = "resumo";
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['campos_busca'];
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pesq_tab_label'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pesq_tab_label'] .= "anio?#?" . "" . $this->Ini->Nm_lang['lang_srch_year'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pesq_tab_label'] .= "mes?#?" . "" . $this->Ini->Nm_lang['lang_srch_mnth'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pesq_tab_label'] .= "nc_fecha?#?" . "" . $this->Ini->Nm_lang['lang_fecha'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pesq_tab_label'] .= "nc_serie?#?" . "" . $this->Ini->Nm_lang['lang_serie_sri'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pesq_tab_label'] .= "cl_nombre?#?" . "" . $this->Ini->Nm_lang['lang_nombre'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pesq_tab_label'] .= "cl_identificacion?#?" . "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pesq_tab_label'] .= "pro_descripcion?#?" . "" . $this->Ini->Nm_lang['lang_producto'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pesq_tab_label'] .= "nc_usuario?#?" . "" . $this->Ini->Nm_lang['lang_username'] . "" . "?@?";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_search_add']);
          exit;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dyn_search_aut_comp']))
      {
          $Cmp_select2 = array("cl_nombre","cl_identificacion","pro_descripcion");
          ob_start();
          $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dyn_search_aut_comp']['cmp'];
          ...
          foreach ($nmgp_def_dados as $Ind => $Lista)
          {
             if (is_array($Lista))
             {
                 foreach ($Lista as $Cod => $Valor)
                 {
                     ...
                     if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                     {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dyn_search_aut_comp']);
          exit;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("grid_v_del_notas_credito_detalladas", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral(false, $this->NM_export);
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['tot_geral'][4];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['tot_geral'][7];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['tot_geral'][8];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['tot_geral'][6];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['arr_total']['anio'] = $this->array_total_anio;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['arr_total']['mes'] = $this->array_total_mes;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['arr_total']['nc_fecha'] = $this->array_total_nc_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['arr_total']['nc_serie'] = $this->array_total_nc_serie;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['arr_total']['nc_secuencial'] = $this->array_total_nc_secuencial;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['arr_total']['pro_descripcion'] = $this->array_total_pro_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['arr_total']['nc_usuario'] = $this->array_total_nc_usuario;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['json_use_label'])
       {
          $Lab_anio = "anio";
          $Lab_mes = "mes";
          $Lab_nc_fecha = "nc_fecha";
          $Lab_nc_serie = "nc_serie";
          $Lab_nc_secuencial = "nc_secuencial";
          $Lab_pro_descripcion = "pro_descripcion";
          $Lab_nc_usuario = "nc_usuario";
       }
       else
       {
       $Lab_anio = "" . $this->Ini->Nm_lang['lang_srch_year'] . "";
       $Lab_mes = "" . $this->Ini->Nm_lang['lang_srch_mnth'] . "";
       $Lab_nc_fecha = "" . $this->Ini->Nm_lang['lang_fecha'] . "";
       $Lab_nc_fecha =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_nc_fecha);
       $Lab_nc_serie = "" . $this->Ini->Nm_lang['lang_serie_sri'] . "";
       $Lab_nc_secuencial = "" . $this->Ini->Nm_lang['lang_secuencial'] . "";
       $Lab_pro_descripcion = "" . $this->Ini->Nm_lang['lang_producto'] . "";
       $Lab_nc_usuario = "" . $this->Ini->Nm_lang['lang_username'] . "";
       }
       $prep_field = array();
       $prep_field['anio'] = $Lab_anio;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['anio'] = $Lab_anio; 
       $prep_field['mes'] = $Lab_mes;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['mes'] = $Lab_mes; 
       $prep_field['nc_fecha'] = $Lab_nc_fecha;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_fecha'] = $Lab_nc_fecha; 
       $prep_field['nc_serie'] = $Lab_nc_serie;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_serie'] = $Lab_nc_serie; 
       $prep_field['nc_secuencial'] = $Lab_nc_secuencial;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_secuencial'] = $Lab_nc_secuencial; 
       $prep_field['pro_descripcion'] = $Lab_pro_descripcion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['pro_descripcion'] = $Lab_pro_descripcion; 
       $prep_field['nc_usuario'] = $Lab_nc_usuario;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_usuario'] = $Lab_nc_usuario; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_serie'] = "" . $this->Ini->Nm_lang['lang_serie_sri'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_secuencial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_secuencial'] = "" . $this->Ini->Nm_lang['lang_secuencial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['cl_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['cl_nombre'] = "" . $this->Ini->Nm_lang['lang_nombre'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['pro_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['pro_descripcion'] = "" . $this->Ini->Nm_lang['lang_producto'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_subtotal'] = "" . $this->Ini->Nm_lang['lang_subtotal'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_descuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_descuento'] = "" . $this->Ini->Nm_lang['lang_descuento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_base_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_base_iva'] = "" . $this->Ini->Nm_lang['lang_base_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_valor_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_valor_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_total'] = "" . $this->Ini->Nm_lang['lang_total'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_numero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_numero'] = "" . $this->Ini->Nm_lang['lang_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_tipo_comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_tipo_comprobante'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['cl_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['cl_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['cl_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['cl_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['cl_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['cl_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['cl_celular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['cl_celular'] = "" . $this->Ini->Nm_lang['lang_celular'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['cl_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['cl_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_motivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_motivo'] = "" . $this->Ini->Nm_lang['lang_motivo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['pro_codigo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['pro_codigo'] = "" . $this->Ini->Nm_lang['lang_codigo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_cantidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_cantidad'] = "" . $this->Ini->Nm_lang['lang_lot_cantidad'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_precio_unitario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_precio_unitario'] = "" . $this->Ini->Nm_lang['lang_precio_unitario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_valor_ice']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_valor_ice'] = "" . $this->Ini->Nm_lang['lang_ice'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_valor_irbpnr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_valor_irbpnr'] = "" . $this->Ini->Nm_lang['lang_irbpnr'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['mes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['mes'] = "" . $this->Ini->Nm_lang['lang_srch_mnth'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['anio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['anio'] = "" . $this->Ini->Nm_lang['lang_srch_year'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_cliente'] = "" . $this->Ini->Nm_lang['lang_cliente'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['dnc_descripcion'] = "" . $this->Ini->Nm_lang['lang_descripcion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_usuario'] = "" . $this->Ini->Nm_lang['lang_username'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_asiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['nc_asiento'] = "" . $this->Ini->Nm_lang['lang_asiento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['concepto_factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['labels']['concepto_factura'] = "Concepto"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "dnc_subtotal", 'show' => true),
           3 => array('field' => "dnc_descuento", 'show' => true),
           4 => array('field' => "dnc_base_iva", 'show' => true),
           5 => array('field' => "dnc_valor_ice", 'show' => true),
           6 => array('field' => "dnc_valor_iva", 'show' => true),
           7 => array('field' => "dnc_valor_irbpnr", 'show' => true),
           8 => array('field' => "dnc_total", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_dnc_subtotal_sum",
           3 => "css_dnc_descuento_sum",
           4 => "css_dnc_base_iva_sum",
           5 => "css_dnc_valor_ice_sum",
           6 => "css_dnc_valor_iva_sum",
           7 => "css_dnc_valor_irbpnr_sum",
           8 => "css_dnc_total_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['nc_fecha']['alin'] = "''";
       $Arr_parms['nc_fecha']['link'] = "S";
       $Arr_parms['nc_serie']['alin'] = "''";
       $Arr_parms['nc_serie']['link'] = "S";
       $Arr_parms['nc_secuencial']['alin'] = "''";
       $Arr_parms['nc_secuencial']['link'] = "S";
       $Arr_parms['pro_descripcion']['alin'] = "''";
       $Arr_parms['pro_descripcion']['link'] = "S";
       $Arr_parms['nc_usuario']['alin'] = "''";
       $Arr_parms['nc_usuario']['link'] = "S";
       ...
       $Arr_parms['nc_fecha']['fill'] = "true";
       $Arr_parms['nc_fecha']['order'] = "value";
       $Arr_parms['nc_fecha']['order_start'] = 'asc';
       $Arr_parms['nc_fecha']['order_invert'] = 'false';
       $Arr_parms['nc_fecha']['order_enabled'] = 'true';
       $Arr_parms['nc_fecha']['order_datatype'] = 'date';
       $Arr_parms['nc_fecha']['rating_function'] = '';
       $Arr_parms['nc_serie']['fill'] = "true";
       $Arr_parms['nc_serie']['order'] = "label";
       $Arr_parms['nc_serie']['order_start'] = 'asc';
       $Arr_parms['nc_serie']['order_invert'] = 'false';
       $Arr_parms['nc_serie']['order_enabled'] = 'true';
       $Arr_parms['nc_serie']['order_datatype'] = 'text';
       $Arr_parms['nc_serie']['rating_function'] = '';
       $Arr_parms['nc_secuencial']['fill'] = "true";
       $Arr_parms['nc_secuencial']['order'] = "label";
       $Arr_parms['nc_secuencial']['order_start'] = 'asc';
       $Arr_parms['nc_secuencial']['order_invert'] = 'false';
       $Arr_parms['nc_secuencial']['order_enabled'] = 'true';
       $Arr_parms['nc_secuencial']['order_datatype'] = 'text';
       $Arr_parms['nc_secuencial']['rating_function'] = '';
       ...
       $Arr_parms['nc_usuario']['fill'] = "true";
       $Arr_parms['nc_usuario']['order'] = "label";
       $Arr_parms['nc_usuario']['order_start'] = 'asc';
       $Arr_parms['nc_usuario']['order_invert'] = 'false';
       $Arr_parms['nc_usuario']['order_enabled'] = 'true';
       $Arr_parms['nc_usuario']['order_datatype'] = 'varchar';
       $Arr_parms['nc_usuario']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['nc_fecha'] = array(0 => 'nc_fecha', 1 => '@aspass@');
       $prep_links_fl['nc_serie'] = array(0 => 'nc_serie', 1 => '@aspass@');
       $prep_links_fl['nc_secuencial'] = array(0 => 'nc_secuencial', 1 => '@aspass@');
       $prep_links_fl['pro_descripcion'] = array(0 => 'pro_descripcion', 1 => '@aspass@');
       $prep_links_fl['nc_usuario'] = array(0 => 'nc_usuario', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_del_notas_credito_detalladas@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
         ...
         { 
            ...
            { 
                $seq_search = 1;
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_pesq'] as $cmp => $def)
                {
                   $Seq_grid      = $seq_search;
                   $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_v_del_notas_credito_detalladas']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_v_del_notas_credito_detalladas']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_v_del_notas_credito_detalladas']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_v_del_notas_credito_detalladas']) . "_";
               } 
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_v_del_notas_credito_detalladas_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_v_del_notas_credito_detalladas_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_detalles'] . " " . $this->Ini->Nm_lang['lang_notas_credito'] . "</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['ajax_nav']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_v_del_notas_credito_detalladas_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_v_del_notas_credito_detalladas_jquery_496.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_v_del_notas_credito_detalladas_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_notas_credito_detalladas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_v_del_notas_credito_detalladas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_notas_credito_detalladas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_del_notas_credito_detalladas/grid_v_del_notas_credito_detalladas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . " sc-app-grid\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_notas_credito_detalladas/grid_v_del_notas_credito_detalladas_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_del_notas_credito_detalladas&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_notas_credito_detalladas/grid_v_del_notas_credito_detalladas_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_notas_credito_detalladas/grid_v_del_notas_credito_detalladas_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_del_notas_credito_detalladas&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_del_notas_credito_detalladas/grid_v_del_notas_credito_detalladas_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume&nm_all_modules=grid,resume&nm_json_format=N&nm_json_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_notas_credito_detalladas/grid_v_del_notas_credito_detalladas_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_del_notas_credito_detalladas/grid_v_del_notas_credito_detalladas_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_del_notas_credito_detalladas/grid_v_del_notas_credito_detalladas_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_v_del_notas_credito_detalladas_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_v_del_notas_credito_detalladas_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_del_notas_credito_detalladas']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_del_notas_credito_detalladas']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_v_del_notas_credito_detalladas_config_pivot.php?nome_apl=grid_v_del_notas_credito_detalladas&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_v_del_notas_credito_detalladas_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_v_del_notas_credito_detalladas/grid_v_del_notas_credito_detalladas_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_v_del_notas_credito_detalladas_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_v_del_notas_credito_detalladas_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_v_del_notas_credito_detalladas_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_v_del_notas_credito_detalladas_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_del_notas_credito_detalladas@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_v_del_notas_credito_detalladas_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_notas_credito_detalladas_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_v_del_notas_credito_detalladas/grid_v_del_notas_credito_detalladas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $nc_fecha = (isset($Busca_temp['nc_fecha'])) ? $Busca_temp['nc_fecha'] : ""; 
          $tmp_pos = (is_string($nc_fecha)) ? strpos($nc_fecha, "##@@") : false;
          if ($tmp_pos !== false && !is_array($nc_fecha))
          {
              $nc_fecha = substr($nc_fecha, 0, $tmp_pos);
          }
          $nc_fecha_2 = (isset($Busca_temp['nc_fecha_input_2'])) ? $Busca_temp['nc_fecha_input_2'] : ""; 
          $nc_serie = (isset($Busca_temp['nc_serie'])) ? $Busca_temp['nc_serie'] : ""; 
          $tmp_pos = (is_string($nc_serie)) ? strpos($nc_serie, "##@@") : false;
          if ($tmp_pos !== false && !is_array($nc_serie))
          {
              $nc_serie = substr($nc_serie, 0, $tmp_pos);
          }
          ...
          $nc_usuario = (isset($Busca_temp['nc_usuario'])) ? $Busca_temp['nc_usuario'] : ""; 
          $tmp_pos = (is_string($nc_usuario)) ? strpos($nc_usuario, "##@@") : false;
          if ($tmp_pos !== false && !is_array($nc_usuario))
          {
              $nc_usuario = substr($nc_usuario, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['cond_pesq'], 0, $trab_pos);
   ...
   $sc_data_cab1 = $this->nm_data->FormataSaida("l, d @?#?@de F @?#?@de Y");
      ...
      $nm_saida->saida("       <TR valign=\"middle\">\r\n");
      $nm_saida->saida("        <TD align=\"left\" class=\"" . $this->css_scGridHeaderFont . "\">\r\n");
      $nm_saida->saida("          " . $this->Ini->Nm_lang['lang_detalles'] . " " . $this->Ini->Nm_lang['lang_notas_credito'] . "\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("        <TD style=\"font-size: 5px\">\r\n");
      $nm_saida->saida("          &nbsp; &nbsp;\r\n");
      $nm_saida->saida("        </TD>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_dnc_subtotal, $sum_dnc_descuento, $sum_dnc_base_iva, $sum_dnc_valor_iva, $sum_dnc_total, $sum_dnc_valor_ice, $sum_dnc_valor_irbpnr, $quebra_anio, $quebra_mes, $quebra_nc_fecha, $quebra_nc_serie, $quebra_nc_secuencial, $quebra_pro_descripcion, $quebra_nc_usuario, $quebra_anio_orig, $quebra_mes_orig, $quebra_nc_fecha_orig, $quebra_nc_serie_orig, $quebra_nc_secuencial_orig, $quebra_pro_descripcion_orig, $quebra_nc_usuario_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_dnc_subtotal)) {$sum_dnc_subtotal = '0';}
          if (empty($sum_dnc_descuento)) {$sum_dnc_descuento = '0';}
          if (empty($sum_dnc_base_iva)) {$sum_dnc_base_iva = '0';}
          if (empty($sum_dnc_valor_iva)) {$sum_dnc_valor_iva = '0';}
          if (empty($sum_dnc_total)) {$sum_dnc_total = '0';}
          if (empty($sum_dnc_valor_ice)) {$sum_dnc_valor_ice = '0';}
          if (empty($sum_dnc_valor_irbpnr)) {$sum_dnc_valor_irbpnr = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_dnc_subtotal . ';
              $this->' . $arr_name . '[2] = ' . $sum_dnc_descuento . ';
              $this->' . $arr_name . '[3] = ' . $sum_dnc_base_iva . ';
              $this->' . $arr_name . '[4] = ' . $sum_dnc_valor_iva . ';
              $this->' . $arr_name . '[5] = ' . $sum_dnc_total . ';
              $this->' . $arr_name . '[6] = ' . $sum_dnc_valor_ice . ';
              $this->' . $arr_name . '[7] = ' . $sum_dnc_valor_irbpnr . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_dnc_subtotal . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_dnc_descuento . ', 10);
              $this->' . $arr_name . '[3] = bcadd($this->' . $arr_name . '[3], ' . $sum_dnc_base_iva . ', 10);
              $this->' . $arr_name . '[4] = bcadd($this->' . $arr_name . '[4], ' . $sum_dnc_valor_iva . ', 10);
              $this->' . $arr_name . '[5] = bcadd($this->' . $arr_name . '[5], ' . $sum_dnc_total . ', 10);
              $this->' . $arr_name . '[6] = bcadd($this->' . $arr_name . '[6], ' . $sum_dnc_valor_ice . ', 10);
              $this->' . $arr_name . '[7] = bcadd($this->' . $arr_name . '[7], ' . $sum_dnc_valor_irbpnr . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->nc_fecha = $Busca_temp['nc_fecha']; 
       $this->nc_fecha = (isset($Busca_temp['nc_fecha'])) ? $Busca_temp['nc_fecha'] : ""; 
       $tmp_pos = (is_string($this->nc_fecha)) ? strpos($this->nc_fecha, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->nc_fecha))
       {
       ...
       $nc_fecha_2 = (isset($Busca_temp['nc_fecha_input_2'])) ? $Busca_temp['nc_fecha_input_2'] : ""; 
       $this->nc_fecha_2 = $nc_fecha_2; 
       $this->nc_serie = $Busca_temp['nc_serie']; 
       $this->nc_serie = (isset($Busca_temp['nc_serie'])) ? $Busca_temp['nc_serie'] : ""; 
       $tmp_pos = (is_string($this->nc_serie)) ? strpos($this->nc_serie, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->nc_serie))
       {
       ...
       $this->nc_usuario = $Busca_temp['nc_usuario']; 
       $this->nc_usuario = (isset($Busca_temp['nc_usuario'])) ? $Busca_temp['nc_usuario'] : ""; 
       $tmp_pos = (is_string($this->nc_usuario)) ? strpos($this->nc_usuario, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->nc_usuario))
       {
     ...
     { 
         $nmgp_select = "SELECT str_replace (convert(char(10),nc_fecha,102), '.', '-') + ' ' + convert(char(8),nc_fecha,20), nc_serie, nc_secuencial, cl_nombre, pro_descripcion, dnc_subtotal, dnc_descuento, dnc_base_iva, dnc_valor_iva, dnc_total, nc_numero, nc_tipo_comprobante, nc_empresa, cl_identificacion, cl_direccion, cl_telefono, cl_celular, cl_email, nc_motivo, pro_codigo, dnc_cantidad, dnc_precio_unitario, dnc_valor_ice, dnc_valor_irbpnr, mes, anio, nc_usuario from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT nc_fecha, nc_serie, nc_secuencial, cl_nombre, pro_descripcion, dnc_subtotal, dnc_descuento, dnc_base_iva, dnc_valor_iva, dnc_total, nc_numero, nc_tipo_comprobante, nc_empresa, cl_identificacion, cl_direccion, cl_telefono, cl_celular, cl_email, nc_motivo, pro_codigo, dnc_cantidad, dnc_precio_unitario, dnc_valor_ice, dnc_valor_irbpnr, mes, anio, nc_usuario from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT convert(char(23),nc_fecha,121), nc_serie, nc_secuencial, cl_nombre, pro_descripcion, dnc_subtotal, dnc_descuento, dnc_base_iva, dnc_valor_iva, dnc_total, nc_numero, nc_tipo_comprobante, nc_empresa, cl_identificacion, cl_direccion, cl_telefono, cl_celular, cl_email, nc_motivo, pro_codigo, dnc_cantidad, dnc_precio_unitario, dnc_valor_ice, dnc_valor_irbpnr, mes, anio, nc_usuario from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT nc_fecha, nc_serie, nc_secuencial, cl_nombre, pro_descripcion, dnc_subtotal, dnc_descuento, dnc_base_iva, dnc_valor_iva, dnc_total, nc_numero, nc_tipo_comprobante, nc_empresa, cl_identificacion, cl_direccion, cl_telefono, cl_celular, cl_email, nc_motivo, pro_codigo, dnc_cantidad, dnc_precio_unitario, dnc_valor_ice, dnc_valor_irbpnr, mes, anio, nc_usuario from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->nc_fecha = $rs_res->fields[0] ;  
            $this->nc_serie = $rs_res->fields[1] ;  
            $this->nc_secuencial = $rs_res->fields[2] ;  
            $this->cl_nombre = $rs_res->fields[3] ;  
            $this->pro_descripcion = $rs_res->fields[4] ;  
            $this->dnc_subtotal = $rs_res->fields[5] ;  
            $this->dnc_descuento = $rs_res->fields[6] ;  
            $this->dnc_base_iva = $rs_res->fields[7] ;  
            $this->dnc_valor_iva = $rs_res->fields[8] ;  
            $this->dnc_total = $rs_res->fields[9] ;  
            $this->nc_numero = $rs_res->fields[10] ;  
            $this->nc_tipo_comprobante = $rs_res->fields[11] ;  
            $this->nc_empresa = $rs_res->fields[12] ;  
            $this->cl_identificacion = $rs_res->fields[13] ;  
            $this->cl_direccion = $rs_res->fields[14] ;  
            $this->cl_telefono = $rs_res->fields[15] ;  
            $this->cl_celular = $rs_res->fields[16] ;  
            $this->cl_email = $rs_res->fields[17] ;  
            $this->nc_motivo = $rs_res->fields[18] ;  
            $this->pro_codigo = $rs_res->fields[19] ;  
            $this->dnc_cantidad = $rs_res->fields[20] ;  
            $this->dnc_precio_unitario = $rs_res->fields[21] ;  
            $this->dnc_valor_ice = $rs_res->fields[22] ;  
            $this->dnc_valor_irbpnr = $rs_res->fields[23] ;  
            $this->mes = $rs_res->fields[24] ;  
            $this->anio = $rs_res->fields[25] ;  
            $this->nc_usuario = $rs_res->fields[26] ;  
            $this->anio_orig = $this->anio;
            $this->mes_orig = $this->mes;
            $this->nc_fecha_orig = $this->nc_fecha;
            $this->nc_serie_orig = $this->nc_serie;
            $this->nc_secuencial_orig = $this->nc_secuencial;
            $this->pro_descripcion_orig = $this->pro_descripcion;
            $this->nc_usuario_orig = $this->nc_usuario;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->dnc_subtotal, $this->dnc_descuento, $this->dnc_base_iva, $this->dnc_valor_iva, $this->dnc_total, $this->dnc_valor_ice, $this->dnc_valor_irbpnr, $this->anio, $this->mes, $this->nc_fecha, $this->nc_serie, $this->nc_secuencial, $this->pro_descripcion, $this->nc_usuario, $this->anio_orig,  $this->mes_orig,  $this->nc_fecha_orig,  $this->nc_serie_orig,  $this->nc_secuencial_orig,  $this->pro_descripcion_orig,  $this->nc_usuario_orig);
            }
   }
//
   ...
   function html_grid_search()
   {
       ...
       $this->grid_search_str = "";
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['campos_slider']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['campos_slider'] = array(); 
       }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['ajax_nav'])
        { 
           $_SESSION['scriptcase']['saida_html'] = "";
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_pesq']))
           { 
   ...
   {
       global $nm_saida;
       $this->Cmps_select2_grid = array('nc_serie');
       $lin_obj  = "";
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('anio','mes','nc_fecha','nc_serie','cl_nombre','cl_identificacion','pro_descripcion','nc_usuario');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_pesq']) < 8)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_anio($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['psq_check_ret']['anio'] = array();
       $anio_look = (is_string($anio) ? substr($this->Db->qstr($anio), 1, -1) : $anio); 
       $nmgp_def_dados  = ""; 
       $nm_comando = "select distinct anio from " . $this->Ini->nm_tabela . " where (nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') order by anio"; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['psq_check_ret']['anio'][] = trim($rs->fields[0]);
   ...
   function grid_search_mes($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['psq_check_ret']['mes'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['psq_check_ret']['mes'][] = trim($rs->fields[0]);
   ...
   function grid_search_nc_serie($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['psq_check_ret']['nc_serie'] = array();
       $nc_serie_look = (is_string($nc_serie) ? substr($this->Db->qstr($nc_serie), 1, -1) : $nc_serie); 
       $nmgp_def_dados  = ""; 
       $nm_comando = "select distinct nc_serie from " . $this->Ini->nm_tabela . " where (nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') order by nc_serie"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['psq_check_ret']['nc_serie'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
       ...
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"grid_search_nc_serie_val_" . $ind . "\" name=\"val_grid_search_nc_serie_" . $ind . "\"  size=1>";
       $delimitador = "##@@";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       $val = isset($val[0]) ? $val[0] : array();
   ...
   function grid_search_cl_nombre($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and cl_nombre = '$cl_nombre_look' order by cl_nombre"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function grid_search_cl_identificacion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and cl_identificacion = '$cl_identificacion_look' order by cl_identificacion"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function grid_search_pro_descripcion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct pro_descripcion from " . $this->Ini->nm_tabela . " where (nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and pro_descripcion = '$pro_descripcion_look' order by pro_descripcion"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function grid_search_nc_usuario($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['psq_check_ret']['nc_usuario'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['psq_check_ret']['nc_usuario'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function lookup_ajax_cl_nombre($cl_nombre)
   {
       ...
       $cl_nombre_look = (is_string($cl_nombre) ? substr($this->Db->qstr($cl_nombre), 1, -1) : $cl_nombre); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  cl_nombre like '%" . $cl_nombre . "%' order by cl_nombre"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_v_del_notas_credito_detalladas_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_cl_identificacion($cl_identificacion)
   {
       ...
       $cl_identificacion_look = (is_string($cl_identificacion) ? substr($this->Db->qstr($cl_identificacion), 1, -1) : $cl_identificacion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  cl_identificacion like '%" . $cl_identificacion . "%' order by cl_identificacion"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function lookup_ajax_pro_descripcion($pro_descripcion)
   {
       ...
       $pro_descripcion_look = (is_string($pro_descripcion) ? substr($this->Db->qstr($pro_descripcion), 1, -1) : $pro_descripcion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct pro_descripcion from " . $this->Ini->nm_tabela . " where (nc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  pro_descripcion like '%" . $pro_descripcion . "%' order by pro_descripcion"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "debi_doc_electronicos/grid_v_del_notas_credito_detalladas";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_v_del_notas_credito_detalladas_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_v_del_notas_credito_detalladas_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['nc_fecha_mes'] =  'sc_grid_v_del_notas_credito_detalladas_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['nc_fecha_dia'] =  'sc_grid_v_del_notas_credito_detalladas_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['nc_fecha_v2__mes'] =  'sc_grid_v_del_notas_credito_detalladas_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['nc_fecha_v2__dia'] =  'sc_grid_v_del_notas_credito_detalladas_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['nc_fecha_mes']", 'value' => 'sc_grid_v_del_notas_credito_detalladas_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['nc_fecha_dia']", 'value' => 'sc_grid_v_del_notas_credito_detalladas_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['nc_fecha_v2__mes']", 'value' => 'sc_grid_v_del_notas_credito_detalladas_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['nc_fecha_v2__dia']", 'value' => 'sc_grid_v_del_notas_credito_detalladas_valida_dia(this)');
       } 
       $nm_saida->saida("     function Sc_carga_select2_grid_nc_serie(SEQ)\r\n");
       $nm_saida->saida("     {\r\n");
       $nm_saida->saida("      $(\"#grid_search_nc_serie_val_\" + SEQ).select2(\r\n");
       $nm_saida->saida("        {\r\n");
       ...
       $nm_saida->saida("      );\r\n");
       $nm_saida->saida("     }\r\n");
 foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['campos_slider'] as $SCmp => $STp)
 {
     foreach ($STp as $Cada_tp => $Val_tp)
     {
        $Val_slider = (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['campos_slider'][$SCmp][$Cada_tp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_notas_credito_detalladas']['campos_slider'][$SCmp][$Cada_tp] : "''";
