...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_productos_venta_empresas').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_productos_venta_empresas').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_productos_venta_empresas').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_productos_venta_empresas').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_productos_venta_empresas').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_productos_venta_empresas').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_productos_venta_empresas').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_productos_venta_empresas').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_productos_venta_empresas').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_productos_venta_empresas').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_productos_venta_empresas').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_productos_venta_empresas').style.width  = '0px';
        }
        if (oResp["setValue"]) {
          for (i = 0; i < oResp["setValue"].length; i++) {
            if ("sc_grid_body" == oResp["setValue"][i]["field"] && !scrollNavigateReload) {
              $("#sc-ui-grid-body-1150607a > tbody").append(oResp["setValue"][i]["value"]);
            }
            else {
