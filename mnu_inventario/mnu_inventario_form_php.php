...
class mnu_inventario_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['mnu_inventario']['sc_apl_link'];
...
switch ($this->sc_menu_item){
	case "item_31": $check_sql = "SELECT usu_super_administrador,per_permiso
								  FROM v_sis_permisos_usuario
								  WHERE rou_usuario='".$this->sc_temp_Igtech_SesionLogin."'
								  AND opm_nombre='PRODUCTOS'
								  AND dec_nombre='CONFIGURACION'
								  AND mm_descripcion='CLASE'";
      ...
      { 
          ...
          $this->rs_erro = $this->Db->ErrorMsg();
					...
					if ($this->rs[0][0]=='S' or $this->rs[0][1]=='S' ) {
   						$check_sql = "SELECT cat_id,cat_nombre FROM sis_catalogo where cat_id=33";
      ...
      { 
          ...
          $this->rs_erro = $this->Db->ErrorMsg();
						...
						$_SESSION['scriptcase']['sc_apl_seg']['form_sis_detalle_catalogo_configurador'] = "off";;
					}
					break;
	case "item_34": $check_sql = "SELECT usu_super_administrador,per_permiso
								  FROM v_sis_permisos_usuario
								  WHERE rou_usuario='".$this->sc_temp_Igtech_SesionLogin."'
								  AND opm_nombre='PRODUCTOS'
								  AND dec_nombre='CONFIGURACION'
								  AND mm_descripcion='UNIDAD'";
      ...
      { 
          ...
          $this->rs_erro = $this->Db->ErrorMsg();
					...
					if ($this->rs[0][0]=='S' or $this->rs[0][1]=='S' ) {
   						$check_sql = "SELECT cat_id,cat_nombre FROM sis_catalogo where cat_id=34";
      ...
      { 
          ...
          $this->rs_erro = $this->Db->ErrorMsg();
					...
					break;
	case "item_33": $check_sql = "SELECT usu_super_administrador,per_permiso
								  FROM v_sis_permisos_usuario
								  WHERE rou_usuario='".$this->sc_temp_Igtech_SesionLogin."'
								  AND opm_nombre='PRODUCTOS'
								  AND dec_nombre='CONFIGURACION'
								  AND mm_descripcion='TIPO DE INVENTARIO'";
      ...
      { 
          ...
          $this->rs_erro = $this->Db->ErrorMsg();
					...
					if ($this->rs[0][0]=='S' or $this->rs[0][1]=='S' ) {
   						$check_sql = "SELECT cat_id,cat_nombre FROM sis_catalogo where cat_id=35";
      ...
      { 
          ...
          $this->rs_erro = $this->Db->ErrorMsg();
					...
					break;
	case "item_35": $check_sql = "SELECT usu_super_administrador,per_permiso
								  FROM v_sis_permisos_usuario
								  WHERE rou_usuario='".$this->sc_temp_Igtech_SesionLogin."'
								  AND opm_nombre='PRODUCTOS'
								  AND dec_nombre='CONFIGURACION'
								  AND mm_descripcion='ESTADO DE PRODUTOS'";
      ...
      { 
          ...
          $this->rs_erro = $this->Db->ErrorMsg();
					...
					if ($this->rs[0][0]=='S' or $this->rs[0][1]=='S' ) {
   						$check_sql = "SELECT cat_id,cat_nombre FROM sis_catalogo where cat_id=36";
...
if ($this->Db)
{
    $this->Db->Close(); 
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['mnu_inventario'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_del_grupo_productos_compras") . "/?nm_run_menu=1&nm_apl_menu=mnu_inventario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_38")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_del_grupo_productos_ventas") . "/?nm_run_menu=1&nm_apl_menu=mnu_inventario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_32")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_del_categoria_producto") . "/?nm_run_menu=1&nm_apl_menu=mnu_inventario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_41")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_inv_unidad") . "/?nm_run_menu=1&nm_apl_menu=mnu_inventario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_37")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_del_producto") . "/?nm_run_menu=1&nm_apl_menu=mnu_inventario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_57")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_del_actualizcion_producto") . "/?nm_run_menu=1&nm_apl_menu=mnu_inventario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_40")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_v_del_inventario") . "/?nm_run_menu=1&nm_apl_menu=mnu_inventario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="mnu_inventario"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "mnu_inventario")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'mnu_inventario', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new mnu_inventario_form_php();
$controle->init();
?>
