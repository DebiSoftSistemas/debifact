<?php
include_once('mnu_inventario_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['mnu_inventario']['glo_nm_perfil']         = "igtech_conexion";
    $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class mnu_inventario_class
{
  var $Db;
 ...
 function mnu_inventario_menu()
 {
    global $mnu_inventario_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['mnu_inventario']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "mnu_inventario/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('mnu_inventario');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/mnu_inventario_erro.php");
}
include_once(dirname(__FILE__) . "/mnu_inventario_erro.class.php"); 
$this->Erro = new mnu_inventario_erro();
$str_path = substr($_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['mnu_inventario']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$mnu_inventario_menuData         = array();
$mnu_inventario_menuData['path'] = array();
$mnu_inventario_menuData['url']  = array();
$mnu_inventario_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $mnu_inventario_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $mnu_inventario_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $mnu_inventario_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $mnu_inventario_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$mnu_inventario_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$mnu_inventario_menuData['url']['web']   = str_replace("\\", '/', $mnu_inventario_menuData['url']['web']);
$mnu_inventario_menuData['path']['root'] = substr($mnu_inventario_menuData['path']['sys'],  0, -1 * strlen($mnu_inventario_menuData['url']['web']));
$mnu_inventario_menuData['path']['app']  = substr($mnu_inventario_menuData['path']['sys'],  0, strrpos($mnu_inventario_menuData['path']['sys'],  '/'));
$mnu_inventario_menuData['path']['link'] = substr($mnu_inventario_menuData['path']['app'],  0, strrpos($mnu_inventario_menuData['path']['app'],  '/'));
$mnu_inventario_menuData['path']['link'] = substr($mnu_inventario_menuData['path']['link'], 0, strrpos($mnu_inventario_menuData['path']['link'], '/')) . '/';
$mnu_inventario_menuData['path']['app'] .= '/';
$mnu_inventario_menuData['url']['app']   = substr($mnu_inventario_menuData['url']['web'],  0, strrpos($mnu_inventario_menuData['url']['web'],  '/'));
$mnu_inventario_menuData['url']['link']  = substr($mnu_inventario_menuData['url']['app'],  0, strrpos($mnu_inventario_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] == "S")
{
    $mnu_inventario_menuData['url']['link']  = substr($mnu_inventario_menuData['url']['link'], 0, strrpos($mnu_inventario_menuData['url']['link'], '/'));
}
$mnu_inventario_menuData['url']['link']  .= '/';
$mnu_inventario_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['mnu_inventario']['sc_apl_link'] = $mnu_inventario_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['mnu_inventario']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['mnu_inventario']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['mnu_inventario']['actual_lang']) || $_SESSION['scriptcase']['mnu_inventario']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['mnu_inventario']['actual_lang'] = $this->str_lang;
...
include_once("mnu_inventario_toolbar.php");
...
if ($_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "mnu_inventario";
     $_SESSION['scriptcase']['menu_apls']['mnu_inventario'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['mnu_inventario']['glo_nm_conexao']) && $_SESSION['scriptcase']['mnu_inventario']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['mnu_inventario']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['mnu_inventario']['glo_nm_perfil']) && $_SESSION['scriptcase']['mnu_inventario']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['mnu_inventario']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['mnu_inventario']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['mnu_inventario']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['mnu_inventario']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['mnu_inventario']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['mnu_inventario']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['mnu_inventario']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['mnu_inventario']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['mnu_inventario']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['mnu_inventario']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['mnu_inventario']['init']))
{
    $_SESSION['sc_session'][1]['mnu_inventario']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['mnu_inventario']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['mnu_inventario']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_mnu_inventario'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_mnu_inventario'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_mnu_inventario'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['mnu_inventario']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['mnu_inventario']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['mnu_inventario']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod'], 'debi_doc_electronicos', 2); 
}
if (isset($_SESSION['scriptcase']['mnu_inventario']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['mnu_inventario']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['mnu_inventario']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['mnu_inventario']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['mnu_inventario']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['mnu_inventario']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['mnu_inventario']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['mnu_inventario']['sc_outra_jan']) && $_SESSION['sc_session'][1]['mnu_inventario']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['mnu_inventario']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['mnu_inventario']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['mnu_inventario']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod'], 'debi_doc_electronicos'); 
} 
else 
{ 
...
if (in_array(strtolower($nm_tpbanco), $this->nm_bases_oracle))
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['mnu_inventario']['decimal_db'] = ".";
} 
//
$this->NM_gera_log_insert("Scriptcase", "access");
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'mnu_inventario'))
{
    $_SESSION['sc_session'][1]['mnu_inventario']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_mnu_inventario'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$mnu_inventario_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_del_grupo_productos_compras_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_del_grupo_productos_compras_ini.php');
    ...
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_grupo_productos_compras']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_del_grupo_productos_ventas_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_del_grupo_productos_ventas_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_grupo_productos_ventas']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_del_categoria_producto_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_del_categoria_producto_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_categoria_producto']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_inv_unidad_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_inv_unidad_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_inv_unidad']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_del_actualizcion_producto_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_del_actualizcion_producto_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_actualizcion_producto']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_del_actualizcion_producto'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_v_del_inventario_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_v_del_inventario_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_del_inventario']))
        {
...
/* Elementos de menú */
$_SESSION['scriptcase']['mnu_inventario']['contr_erro'] = 'on';
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_mnu_inventario'];
$mnu_inventario_menuData['data'] .= "item_1|.|" . $this->Nm_lang['lang_configuracion'] . "||" . $nm_var_hint[0] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_grupo_productos_compras']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_del_grupo_productos_compras']) == "on")
{
    $mnu_inventario_menuData['data'] .= "item_39|..|" . $this->Nm_lang['lang_grupo_compras'] . "|mnu_inventario_form_php.php?sc_item_menu=item_39&sc_apl_menu=form_del_grupo_productos_compras&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->mnu_inventario_target('_self') . "|" . "\n";
}
else
{
    $mnu_inventario_menuData['data'] .= "item_39|..|" . $this->Nm_lang['lang_grupo_compras'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_grupo_productos_ventas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_del_grupo_productos_ventas']) == "on")
{
    $mnu_inventario_menuData['data'] .= "item_38|..|" . $this->Nm_lang['lang_grupo_ventas'] . "|mnu_inventario_form_php.php?sc_item_menu=item_38&sc_apl_menu=form_del_grupo_productos_ventas&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->mnu_inventario_target('_self') . "|" . "\n";
}
else
{
    $mnu_inventario_menuData['data'] .= "item_38|..|" . $this->Nm_lang['lang_grupo_ventas'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_categoria_producto']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_del_categoria_producto']) == "on")
{
    $mnu_inventario_menuData['data'] .= "item_32|..|" . $this->Nm_lang['lang_categoria'] . "|mnu_inventario_form_php.php?sc_item_menu=item_32&sc_apl_menu=form_del_categoria_producto&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->mnu_inventario_target('_self') . "|" . "\n";
}
else
{
    $mnu_inventario_menuData['data'] .= "item_32|..|" . $this->Nm_lang['lang_categoria'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_inv_unidad']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_inv_unidad']) == "on")
{
    $mnu_inventario_menuData['data'] .= "item_41|..|" . $this->Nm_lang['lang_unidad'] . "|mnu_inventario_form_php.php?sc_item_menu=item_41&sc_apl_menu=grid_inv_unidad&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->mnu_inventario_target('_self') . "|" . "\n";
}
else
{
    $mnu_inventario_menuData['data'] .= "item_41|..|" . $this->Nm_lang['lang_unidad'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_del_producto']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_del_producto']) == "on")
{
    $mnu_inventario_menuData['data'] .= "item_37|..|" . $this->Nm_lang['lang_productos'] . "|mnu_inventario_form_php.php?sc_item_menu=item_37&sc_apl_menu=grid_del_producto&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->mnu_inventario_target('_self') . "|" . "\n";
}
else
{
    $mnu_inventario_menuData['data'] .= "item_37|..|" . $this->Nm_lang['lang_productos'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_actualizcion_producto']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_del_actualizcion_producto']) == "on")
{
    $mnu_inventario_menuData['data'] .= "item_57|..|" . $this->Nm_lang['lang_edic_rapida_producto'] . "|mnu_inventario_form_php.php?sc_item_menu=item_57&sc_apl_menu=form_del_actualizcion_producto&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->mnu_inventario_target('_self') . "|" . "\n";
}
else
{
    $mnu_inventario_menuData['data'] .= "item_57|..|" . $this->Nm_lang['lang_edic_rapida_producto'] . "||||_self|disabled\n";
}
$mnu_inventario_menuData['data'] .= "item_3|.|" . $this->Nm_lang['lang_reporte'] . "||" . $nm_var_hint[7] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_del_inventario']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_v_del_inventario']) == "on")
{
    $mnu_inventario_menuData['data'] .= "item_40|..|" . $this->Nm_lang['lang_inventario_general'] . "|mnu_inventario_form_php.php?sc_item_menu=item_40&sc_apl_menu=grid_v_del_inventario&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->mnu_inventario_target('_self') . "|" . "\n";
}
else
{
    $mnu_inventario_menuData['data'] .= "item_40|..|" . $this->Nm_lang['lang_inventario_general'] . "||||_self|disabled\n";
}
...
$mnu_inventario_menuData['data'] = array();
$str_disabled = "N";
$str_link = "#";
$str_icon = "";
$icon_aba = "";
...
$str_disabled = "N";
$str_link = "mnu_inventario_form_php.php?sc_item_menu=item_39&sc_apl_menu=form_del_grupo_productos_compras&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_grupo_productos_compras']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_del_grupo_productos_compras']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_inventario_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->mnu_inventario_target('_self') . "\"",
        'sc_id'    => "item_39",
        'disabled' => $str_disabled,
        'display'     => "text_img",
        'display_position'=> "text_right",
...
$str_disabled = "N";
$str_link = "mnu_inventario_form_php.php?sc_item_menu=item_38&sc_apl_menu=form_del_grupo_productos_ventas&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_grupo_productos_ventas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_del_grupo_productos_ventas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "mnu_inventario_form_php.php?sc_item_menu=item_32&sc_apl_menu=form_del_categoria_producto&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_categoria_producto']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_del_categoria_producto']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_inventario_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_categoria'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[3] . "",
        'id'       => "item_32",
...
$str_disabled = "N";
$str_link = "mnu_inventario_form_php.php?sc_item_menu=item_41&sc_apl_menu=grid_inv_unidad&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_inv_unidad']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_inv_unidad']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_inventario_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_unidad'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[4] . "",
        'id'       => "item_41",
...
$str_disabled = "N";
$str_link = "mnu_inventario_form_php.php?sc_item_menu=item_37&sc_apl_menu=grid_del_producto&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_del_producto']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_del_producto']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "mnu_inventario_form_php.php?sc_item_menu=item_57&sc_apl_menu=form_del_actualizcion_producto&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_actualizcion_producto']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_del_actualizcion_producto']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_inventario_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_edic_rapida_producto'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[6] . "",
        'id'       => "item_57",
...
$str_disabled = "N";
$str_link = "mnu_inventario_form_php.php?sc_item_menu=item_40&sc_apl_menu=grid_v_del_inventario&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_del_inventario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_v_del_inventario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_inventario_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_inventario_general'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[8] . "",
        'id'       => "item_40",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['mnu_inventario']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['mnu_inventario']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'mnu_inventario');
    $mnu_inventario_menuData['data'] = $str_menu_usu;
}
if (is_file("mnu_inventario_help.txt"))
{
    $Arq_WebHelp = file("mnu_inventario_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $mnu_inventario_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->mnu_inventario_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['mnu_inventario']) && !empty($_SESSION['scriptcase']['sc_menu_del']['mnu_inventario']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($mnu_inventario_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['mnu_inventario']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($mnu_inventario_menuData['data'][$i_menu]);
       }
    ...
    $mnu_inventario_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['mnu_inventario']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['mnu_inventario']))
{
    $disable_menu = false;
    foreach ($mnu_inventario_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['mnu_inventario']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $mnu_inventario_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
if($this->force_mobile || ($_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']))
{
    $_SESSION['scriptcase']['menu_mobile'] = "mnu_inventario";
    include('mnu_inventario_mobile.php');
    exit;
}
/* Cabecera HTML */
if ($mnu_inventario_menuData['iframe'])
{
    $mnu_inventario_menuData['height'] = '100%';
...
<head>
 <title><?php echo $this->Nm_lang['lang_inventario'] ?></title>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $mnu_inventario_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->str_schema_all ?>_sweetalert.css" />
<script type="text/javascript" src="mnu_inventario_message.js"></script>
...
Iframe_atual = "mnu_inventario_iframe";
...
{
  if (str_id != "iframe_mnu_inventario")
  {
      str_id        = str_id.replace("mnu_inventario_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    ...
    if(str_target != '_blank' && $('#iframe_mnu_inventario').length)
        $('#iframe_mnu_inventario')[0].contentWindow.focus();
  }
}
</script>
<?php
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR valign="middle">
        ...
        <TD align="left" class="scMenuHHeaderFont">
          <?php echo "" . $this->Nm_lang['lang_inventario'] . "" ?>
        </TD>
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $mnu_inventario_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->mnu_inventario_escreveMenu($mnu_inventario_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Control de iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $mnu_inventario_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
?>
    <div id="Iframe_control" style='width:100%; height:100%; margin:0px; padding:0px;'>
      <iframe id="iframe_mnu_inventario" name="mnu_inventario_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "mnu_inventario_pag_ini.php"); ?>"></iframe>
<?php
}
?></div></td>
  </tr>
...
/* Control de Target */
function mnu_inventario_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function mnu_inventario_target($str_target)
{
    global $mnu_inventario_menuData;
    ...
    elseif ($mnu_inventario_menuData['iframe'])
    {
        return 'mnu_inventario_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $mnu_inventario_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "mnu_inventario_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "mnu_inventario_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_inventario_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->mnu_inventario_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['mnu_inventario']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['scriptcase']['mnu_inventario']['SC_sep_date']) && !empty($_SESSION['scriptcase']['mnu_inventario']['SC_sep_date']))
       {
           $delim  = $_SESSION['scriptcase']['mnu_inventario']['SC_sep_date'];
           $delim1 = $_SESSION['scriptcase']['mnu_inventario']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'mnu_inventario', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'mnu_inventario', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'mnu_inventario', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['mnu_inventario']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "mnu_inventario") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['mnu_inventario']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['mnu_inventario']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['mnu_inventario']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_debi_doc_electronicos'])) {
            $_SESSION['scriptcase']['mnu_inventario']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_debi_doc_electronicos'];
        }
    }
}
...
$contr_mnu_inventario = new mnu_inventario_class;
$contr_mnu_inventario->mnu_inventario_menu();
