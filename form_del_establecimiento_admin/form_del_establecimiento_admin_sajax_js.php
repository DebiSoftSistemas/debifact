  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_establecimiento_admin" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_establecimiento_admin_form();
	}
...
?>
  ...
  // ---------- Validate est_id
  function do_ajax_form_del_establecimiento_admin_validate_est_id()
  {
    var nomeCampo_est_id = "est_id";
    var var_est_id = scAjaxGetFieldHidden(nomeCampo_est_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_id(var_est_id, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_id_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_id

  function do_ajax_form_del_establecimiento_admin_validate_est_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_id_cb

  // ---------- Validate est_logo
  function do_ajax_form_del_establecimiento_admin_validate_est_logo()
  {
    var nomeCampo_est_logo = "est_logo";
    var var_est_logo = scAjaxGetFieldText(nomeCampo_est_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_logo(var_est_logo, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_logo_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_logo

  function do_ajax_form_del_establecimiento_admin_validate_est_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_logo_cb

  // ---------- Validate est_empresa
  function do_ajax_form_del_establecimiento_admin_validate_est_empresa()
  {
    var nomeCampo_est_empresa = "est_empresa";
    var var_est_empresa = scAjaxGetFieldHidden(nomeCampo_est_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_empresa(var_est_empresa, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_empresa_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_empresa

  function do_ajax_form_del_establecimiento_admin_validate_est_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_empresa_cb

  // ---------- Validate est_nombre
  function do_ajax_form_del_establecimiento_admin_validate_est_nombre()
  {
    var nomeCampo_est_nombre = "est_nombre";
    var var_est_nombre = scAjaxGetFieldText(nomeCampo_est_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_nombre(var_est_nombre, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_nombre_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_nombre

  function do_ajax_form_del_establecimiento_admin_validate_est_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_nombre_cb

  // ---------- Validate est_codigo
  function do_ajax_form_del_establecimiento_admin_validate_est_codigo()
  {
    var nomeCampo_est_codigo = "est_codigo";
    var var_est_codigo = scAjaxGetFieldText(nomeCampo_est_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_codigo(var_est_codigo, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_codigo_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_codigo

  function do_ajax_form_del_establecimiento_admin_validate_est_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_codigo_cb

  // ---------- Validate est_padronrimpe
  function do_ajax_form_del_establecimiento_admin_validate_est_padronrimpe()
  {
    var nomeCampo_est_padronrimpe = "est_padronrimpe";
    var var_est_padronrimpe = scAjaxGetFieldCheckbox(nomeCampo_est_padronrimpe, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_padronrimpe(var_est_padronrimpe, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_padronrimpe_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_padronrimpe

  function do_ajax_form_del_establecimiento_admin_validate_est_padronrimpe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_padronrimpe_cb

  // ---------- Validate est_leyenda_rimpe
  function do_ajax_form_del_establecimiento_admin_validate_est_leyenda_rimpe()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_leyenda_rimpe(var_est_leyenda_rimpe, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_leyenda_rimpe_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_leyenda_rimpe

  function do_ajax_form_del_establecimiento_admin_validate_est_leyenda_rimpe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_leyenda_rimpe_cb

  // ---------- Validate est_iva_diferenciado
  function do_ajax_form_del_establecimiento_admin_validate_est_iva_diferenciado()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_iva_diferenciado(var_est_iva_diferenciado, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_iva_diferenciado_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_iva_diferenciado

  function do_ajax_form_del_establecimiento_admin_validate_est_iva_diferenciado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_iva_diferenciado_cb

  // ---------- Validate est_pais
  function do_ajax_form_del_establecimiento_admin_validate_est_pais()
  {
    var nomeCampo_est_pais = "est_pais";
    var var_est_pais = scAjaxGetFieldSelect(nomeCampo_est_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_pais(var_est_pais, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_pais_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_pais

  function do_ajax_form_del_establecimiento_admin_validate_est_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_pais_cb

  // ---------- Validate est_provincia
  function do_ajax_form_del_establecimiento_admin_validate_est_provincia()
  {
    var nomeCampo_est_provincia = "est_provincia";
    var var_est_provincia = scAjaxGetFieldSelect(nomeCampo_est_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_provincia(var_est_provincia, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_provincia_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_provincia

  function do_ajax_form_del_establecimiento_admin_validate_est_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_provincia_cb

  // ---------- Validate est_canton
  function do_ajax_form_del_establecimiento_admin_validate_est_canton()
  {
    var nomeCampo_est_canton = "est_canton";
    var var_est_canton = scAjaxGetFieldSelect(nomeCampo_est_canton);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_canton(var_est_canton, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_canton_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_canton

  function do_ajax_form_del_establecimiento_admin_validate_est_canton_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_canton_cb

  // ---------- Validate est_direccion
  function do_ajax_form_del_establecimiento_admin_validate_est_direccion()
  {
    var nomeCampo_est_direccion = "est_direccion";
    var var_est_direccion = scAjaxGetFieldText(nomeCampo_est_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_direccion(var_est_direccion, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_direccion_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_direccion

  function do_ajax_form_del_establecimiento_admin_validate_est_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_direccion_cb

  // ---------- Validate est_telefono
  function do_ajax_form_del_establecimiento_admin_validate_est_telefono()
  {
    var nomeCampo_est_telefono = "est_telefono";
    var var_est_telefono = scAjaxGetFieldText(nomeCampo_est_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_telefono(var_est_telefono, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_telefono_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_telefono

  function do_ajax_form_del_establecimiento_admin_validate_est_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_telefono_cb

  // ---------- Validate est_estado
  function do_ajax_form_del_establecimiento_admin_validate_est_estado()
  {
    var nomeCampo_est_estado = "est_estado";
    var var_est_estado = scAjaxGetFieldSelect(nomeCampo_est_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_validate_est_estado(var_est_estado, var_script_case_init, do_ajax_form_del_establecimiento_admin_validate_est_estado_cb);
  } // do_ajax_form_del_establecimiento_admin_validate_est_estado

  function do_ajax_form_del_establecimiento_admin_validate_est_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_validate_est_estado_cb

  // ---------- Refresh est_pais
  function do_ajax_form_del_establecimiento_admin_refresh_est_pais()
  {
    var var_est_pais = scAjaxGetFieldSelect("est_pais");
    var var_nmgp_refresh_fields = "est_provincia";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_establecimiento_admin_refresh_est_pais(var_est_pais, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_establecimiento_admin_refresh_est_pais_cb);
  } // do_ajax_form_del_establecimiento_admin_refresh_est_pais

  function do_ajax_form_del_establecimiento_admin_refresh_est_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_del_establecimiento_admin_refresh_est_provincia();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_refresh_est_pais_cb

  // ---------- Refresh est_provincia
  function do_ajax_form_del_establecimiento_admin_refresh_est_provincia()
  {
    var var_est_provincia = scAjaxGetFieldSelect("est_provincia");
    var var_nmgp_refresh_fields = "est_canton";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_establecimiento_admin_refresh_est_provincia(var_est_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_establecimiento_admin_refresh_est_provincia_cb);
  } // do_ajax_form_del_establecimiento_admin_refresh_est_provincia

  function do_ajax_form_del_establecimiento_admin_refresh_est_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_refresh_est_provincia_cb

  // ---------- Event onclick est_padronrimpe
  function do_ajax_form_del_establecimiento_admin_event_est_padronrimpe_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_establecimiento_admin_event_est_padronrimpe_onclick(var_est_padronrimpe, var_est_leyenda_rimpe, var_script_case_init, do_ajax_form_del_establecimiento_admin_event_est_padronrimpe_onclick_cb);
  } // do_ajax_form_del_establecimiento_admin_event_est_padronrimpe_onclick

  function do_ajax_form_del_establecimiento_admin_event_est_padronrimpe_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "est_padronrimpe";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_establecimiento_admin_event_est_padronrimpe_onclick_cb_after_alert);
  } // do_ajax_form_del_establecimiento_admin_event_est_padronrimpe_onclick_cb
  function do_ajax_form_del_establecimiento_admin_event_est_padronrimpe_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_establecimiento_admin_event_est_padronrimpe_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_establecimiento_admin_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_establecimiento_admin_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_establecimiento_admin_submit_form(var_est_id, var_est_logo, var_est_empresa, var_est_nombre, var_est_codigo, var_est_padronrimpe, var_est_leyenda_rimpe, var_est_iva_diferenciado, var_est_pais, var_est_provincia, var_est_canton, var_est_direccion, var_est_telefono, var_est_estado, var_est_logo_ul_name, var_est_logo_ul_type, var_est_logo_salva, var_est_logo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_establecimiento_admin_submit_form_cb);
  } // do_ajax_form_del_establecimiento_admin_submit_form

  function do_ajax_form_del_establecimiento_admin_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_establecimiento_admin_submit_form_cb_after_alert);
  } // do_ajax_form_del_establecimiento_admin_submit_form_cb
  function do_ajax_form_del_establecimiento_admin_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_establecimiento_admin_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_establecimiento_admin_navigate_form()
  {
    perform_ajax_form_del_establecimiento_admin_navigate_form();
  }

  function perform_ajax_form_del_establecimiento_admin_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_establecimiento_admin_navigate_form(var_est_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_establecimiento_admin_navigate_form_cb);
  } // do_ajax_form_del_establecimiento_admin_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_establecimiento_admin']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_establecimiento_admin_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_establecimiento_admin_navigate_form_cb_after_alert);
  } // do_ajax_form_del_establecimiento_admin_navigate_form_cb
  function do_ajax_form_del_establecimiento_admin_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_establecimiento_admin_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_establecimiento_admin_navigate_form_cb_after_alert

  function sc_hide_form_del_establecimiento_admin_form()
  {
