...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_est_id' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_id_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_del_establecimiento_admin_est_id_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_del_establecimiento_admin_est_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_empresa' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_empresa_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_del_establecimiento_admin_est_empresa_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_del_establecimiento_admin_est_empresa_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_nombre' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_nombre_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_establecimiento_admin_est_nombre_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_del_establecimiento_admin_est_nombre_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_codigo' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_codigo_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_establecimiento_admin_est_codigo_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_del_establecimiento_admin_est_codigo_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_pais' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_pais_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_del_establecimiento_admin_est_pais_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_del_establecimiento_admin_est_pais_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_provincia' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_provincia_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_del_establecimiento_admin_est_provincia_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_del_establecimiento_admin_est_provincia_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_canton' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_canton_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_establecimiento_admin_est_canton_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_del_establecimiento_admin_est_canton_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_direccion' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_direccion_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_del_establecimiento_admin_est_direccion_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_del_establecimiento_admin_est_direccion_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_estado' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_estado_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_establecimiento_admin_est_estado_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_del_establecimiento_admin_est_estado_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_logo' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_logo_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_del_establecimiento_admin_est_logo_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_del_establecimiento_admin_est_logo_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_telefono' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_telefono_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_del_establecimiento_admin_est_telefono_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_del_establecimiento_admin_est_telefono_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_padronrimpe' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_padronrimpe_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_del_establecimiento_admin_est_padronrimpe_onchange(this, iSeqRow) })
                                             .bind('click', function() { sc_form_del_establecimiento_admin_est_padronrimpe_onclick(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_del_establecimiento_admin_est_padronrimpe_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_iva_diferenciado' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_iva_diferenciado_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_del_establecimiento_admin_est_iva_diferenciado_onchange(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_del_establecimiento_admin_est_iva_diferenciado_onfocus(this, iSeqRow) });
  $('#id_sc_field_est_leyenda_rimpe' + iSeqRow).bind('blur', function() { sc_form_del_establecimiento_admin_est_leyenda_rimpe_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_establecimiento_admin_est_leyenda_rimpe_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_del_establecimiento_admin_est_leyenda_rimpe_onfocus(this, iSeqRow) });
...
function sc_form_del_establecimiento_admin_est_id_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_id();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_establecimiento_admin_est_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_empresa_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_empresa();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_establecimiento_admin_est_empresa_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_nombre_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_nombre();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_nombre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_establecimiento_admin_est_nombre_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_codigo_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_codigo();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_codigo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_establecimiento_admin_est_codigo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_pais_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_pais();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_pais_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_del_establecimiento_admin_refresh_est_pais();
}

function sc_form_del_establecimiento_admin_est_pais_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_provincia_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_provincia();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_provincia_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_del_establecimiento_admin_refresh_est_provincia();
}

function sc_form_del_establecimiento_admin_est_provincia_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_canton_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_canton();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_canton_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_establecimiento_admin_est_canton_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_direccion_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_direccion();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_direccion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_establecimiento_admin_est_direccion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_estado_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_estado();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_estado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_establecimiento_admin_est_estado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_logo_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_logo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_establecimiento_admin_est_logo_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_telefono_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_telefono();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_telefono_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_establecimiento_admin_est_telefono_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_padronrimpe_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_padronrimpe();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_padronrimpe_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_establecimiento_admin_est_padronrimpe_onclick(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_event_est_padronrimpe_onclick();
}

function sc_form_del_establecimiento_admin_est_padronrimpe_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_iva_diferenciado_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_iva_diferenciado();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_iva_diferenciado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_establecimiento_admin_est_iva_diferenciado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_establecimiento_admin_est_leyenda_rimpe_onblur(oThis, iSeqRow) {
  do_ajax_form_del_establecimiento_admin_validate_est_leyenda_rimpe();
  scCssBlur(oThis);
}

function sc_form_del_establecimiento_admin_est_leyenda_rimpe_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_establecimiento_admin_est_leyenda_rimpe_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_del_establecimiento_admin_form" + pageNo).hide();
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_est_logo" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_del_establecimiento_admin_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
    ...
    drop: function(e, data) {
      ...
      $("#txt_ajax_img_est_logo" + iSeqRow).css("display", "none");
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_del_establecimiento_admin')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
...
function scCheckUploadExtensionSize_est_logo(thisField)
{
    if ("files" in thisField && thisField.files.length > 0) {
        ...
        if (!["jpg"].includes(thisFileExtension)) {
