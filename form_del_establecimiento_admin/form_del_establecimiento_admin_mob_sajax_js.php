  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_establecimiento_admin_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_establecimiento_admin_mob_form();
	}
...
?>
  ...
  // ---------- Validate est_id
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_id()
  {
    var nomeCampo_est_id = "est_id";
    var var_est_id = scAjaxGetFieldHidden(nomeCampo_est_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_id(var_est_id, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_id_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_id

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_id_cb

  // ---------- Validate est_logo
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_logo()
  {
    var nomeCampo_est_logo = "est_logo";
    var var_est_logo = scAjaxGetFieldText(nomeCampo_est_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_logo(var_est_logo, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_logo_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_logo

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_logo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_logo_cb

  // ---------- Validate est_empresa
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_empresa()
  {
    var nomeCampo_est_empresa = "est_empresa";
    var var_est_empresa = scAjaxGetFieldHidden(nomeCampo_est_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_empresa(var_est_empresa, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_empresa_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_empresa

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_empresa_cb

  // ---------- Validate est_nombre
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_nombre()
  {
    var nomeCampo_est_nombre = "est_nombre";
    var var_est_nombre = scAjaxGetFieldText(nomeCampo_est_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_nombre(var_est_nombre, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_nombre_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_nombre

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_nombre_cb

  // ---------- Validate est_codigo
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_codigo()
  {
    var nomeCampo_est_codigo = "est_codigo";
    var var_est_codigo = scAjaxGetFieldText(nomeCampo_est_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_codigo(var_est_codigo, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_codigo_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_codigo

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_codigo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_codigo_cb

  // ---------- Validate est_padronrimpe
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_padronrimpe()
  {
    var nomeCampo_est_padronrimpe = "est_padronrimpe";
    var var_est_padronrimpe = scAjaxGetFieldCheckbox(nomeCampo_est_padronrimpe, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_padronrimpe(var_est_padronrimpe, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_padronrimpe_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_padronrimpe

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_padronrimpe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_padronrimpe";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_padronrimpe_cb

  // ---------- Validate est_leyenda_rimpe
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_leyenda_rimpe()
  {
    var nomeCampo_est_leyenda_rimpe = "est_leyenda_rimpe";
    var var_est_leyenda_rimpe = scAjaxGetFieldSelect(nomeCampo_est_leyenda_rimpe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_leyenda_rimpe(var_est_leyenda_rimpe, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_leyenda_rimpe_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_leyenda_rimpe

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_leyenda_rimpe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_leyenda_rimpe";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_leyenda_rimpe_cb

  // ---------- Validate est_iva_diferenciado
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_iva_diferenciado()
  {
    var nomeCampo_est_iva_diferenciado = "est_iva_diferenciado";
    var var_est_iva_diferenciado = scAjaxGetFieldCheckbox(nomeCampo_est_iva_diferenciado, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_iva_diferenciado(var_est_iva_diferenciado, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_iva_diferenciado_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_iva_diferenciado

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_iva_diferenciado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_iva_diferenciado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_iva_diferenciado_cb

  // ---------- Validate est_pais
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_pais()
  {
    var nomeCampo_est_pais = "est_pais";
    var var_est_pais = scAjaxGetFieldSelect(nomeCampo_est_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_pais(var_est_pais, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_pais_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_pais

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_pais";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_pais_cb

  // ---------- Validate est_provincia
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_provincia()
  {
    var nomeCampo_est_provincia = "est_provincia";
    var var_est_provincia = scAjaxGetFieldSelect(nomeCampo_est_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_provincia(var_est_provincia, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_provincia_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_provincia

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_provincia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_provincia_cb

  // ---------- Validate est_canton
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_canton()
  {
    var nomeCampo_est_canton = "est_canton";
    var var_est_canton = scAjaxGetFieldSelect(nomeCampo_est_canton);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_canton(var_est_canton, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_canton_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_canton

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_canton_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_canton";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_canton_cb

  // ---------- Validate est_direccion
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_direccion()
  {
    var nomeCampo_est_direccion = "est_direccion";
    var var_est_direccion = scAjaxGetFieldText(nomeCampo_est_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_direccion(var_est_direccion, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_direccion_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_direccion

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_direccion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_direccion_cb

  // ---------- Validate est_telefono
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_telefono()
  {
    var nomeCampo_est_telefono = "est_telefono";
    var var_est_telefono = scAjaxGetFieldText(nomeCampo_est_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_telefono(var_est_telefono, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_telefono_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_telefono

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_telefono";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_telefono_cb

  // ---------- Validate est_estado
  function do_ajax_form_del_establecimiento_admin_mob_validate_est_estado()
  {
    var nomeCampo_est_estado = "est_estado";
    var var_est_estado = scAjaxGetFieldSelect(nomeCampo_est_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_establecimiento_admin_mob_validate_est_estado(var_est_estado, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_validate_est_estado_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_estado

  function do_ajax_form_del_establecimiento_admin_mob_validate_est_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "est_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_validate_est_estado_cb

  // ---------- Refresh est_pais
  function do_ajax_form_del_establecimiento_admin_mob_refresh_est_pais()
  {
    var var_est_pais = scAjaxGetFieldSelect("est_pais");
    var var_nmgp_refresh_fields = "est_provincia";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_establecimiento_admin_mob_refresh_est_pais(var_est_pais, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_refresh_est_pais_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_refresh_est_pais

  function do_ajax_form_del_establecimiento_admin_mob_refresh_est_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_del_establecimiento_admin_mob_refresh_est_provincia();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_refresh_est_pais_cb

  // ---------- Refresh est_provincia
  function do_ajax_form_del_establecimiento_admin_mob_refresh_est_provincia()
  {
    var var_est_provincia = scAjaxGetFieldSelect("est_provincia");
    var var_nmgp_refresh_fields = "est_canton";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_establecimiento_admin_mob_refresh_est_provincia(var_est_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_refresh_est_provincia_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_refresh_est_provincia

  function do_ajax_form_del_establecimiento_admin_mob_refresh_est_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_establecimiento_admin_mob_refresh_est_provincia_cb

  // ---------- Event onclick est_padronrimpe
  function do_ajax_form_del_establecimiento_admin_mob_event_est_padronrimpe_onclick()
  {
    var var_est_padronrimpe = scAjaxGetFieldCheckbox("est_padronrimpe", ";");
    var var_est_leyenda_rimpe = scAjaxGetFieldSelect("est_leyenda_rimpe");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_establecimiento_admin_mob_event_est_padronrimpe_onclick(var_est_padronrimpe, var_est_leyenda_rimpe, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_event_est_padronrimpe_onclick_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_event_est_padronrimpe_onclick

  function do_ajax_form_del_establecimiento_admin_mob_event_est_padronrimpe_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "est_padronrimpe";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_establecimiento_admin_mob_event_est_padronrimpe_onclick_cb_after_alert);
  } // do_ajax_form_del_establecimiento_admin_mob_event_est_padronrimpe_onclick_cb
  function do_ajax_form_del_establecimiento_admin_mob_event_est_padronrimpe_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_establecimiento_admin_mob_event_est_padronrimpe_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_establecimiento_admin_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_establecimiento_admin_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_est_id = scAjaxGetFieldHidden("est_id");
    var var_est_logo = scAjaxGetFieldText("est_logo");
    var var_est_empresa = scAjaxGetFieldHidden("est_empresa");
    var var_est_nombre = scAjaxGetFieldText("est_nombre");
    var var_est_codigo = scAjaxGetFieldText("est_codigo");
    var var_est_padronrimpe = scAjaxGetFieldCheckbox("est_padronrimpe", ";");
    var var_est_leyenda_rimpe = scAjaxGetFieldSelect("est_leyenda_rimpe");
    var var_est_iva_diferenciado = scAjaxGetFieldCheckbox("est_iva_diferenciado", ";");
    var var_est_pais = scAjaxGetFieldSelect("est_pais");
    var var_est_provincia = scAjaxGetFieldSelect("est_provincia");
    var var_est_canton = scAjaxGetFieldSelect("est_canton");
    var var_est_direccion = scAjaxGetFieldText("est_direccion");
    var var_est_telefono = scAjaxGetFieldText("est_telefono");
    var var_est_estado = scAjaxGetFieldSelect("est_estado");
    var var_est_logo_ul_name = scAjaxSpecCharProtect(document.F1.est_logo_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_est_logo_ul_type = document.F1.est_logo_ul_type.value;
    var var_est_logo_salva = scAjaxSpecCharProtect(document.F1.est_logo_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_est_logo_limpa = document.F1.est_logo_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_del_establecimiento_admin_mob_submit_form(var_est_id, var_est_logo, var_est_empresa, var_est_nombre, var_est_codigo, var_est_padronrimpe, var_est_leyenda_rimpe, var_est_iva_diferenciado, var_est_pais, var_est_provincia, var_est_canton, var_est_direccion, var_est_telefono, var_est_estado, var_est_logo_ul_name, var_est_logo_ul_type, var_est_logo_salva, var_est_logo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_establecimiento_admin_mob_submit_form_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_submit_form

  function do_ajax_form_del_establecimiento_admin_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("est_id");
      scAjaxHideErrorDisplay("est_logo");
      scAjaxHideErrorDisplay("est_empresa");
      scAjaxHideErrorDisplay("est_nombre");
      scAjaxHideErrorDisplay("est_codigo");
      scAjaxHideErrorDisplay("est_padronrimpe");
      scAjaxHideErrorDisplay("est_leyenda_rimpe");
      scAjaxHideErrorDisplay("est_iva_diferenciado");
      scAjaxHideErrorDisplay("est_pais");
      scAjaxHideErrorDisplay("est_provincia");
      scAjaxHideErrorDisplay("est_canton");
      scAjaxHideErrorDisplay("est_direccion");
      scAjaxHideErrorDisplay("est_telefono");
      scAjaxHideErrorDisplay("est_estado");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.est_logo_limpa && document.F1.est_logo_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("est_logo", oImgTemp, "", "", "", "N");
      }
    document.F1.est_logo_ul_name.value = '';
    document.F1.est_logo_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_establecimiento_admin_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_establecimiento_admin_mob_submit_form_cb
  function do_ajax_form_del_establecimiento_admin_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_establecimiento_admin_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_establecimiento_admin_mob_navigate_form()
  {
    perform_ajax_form_del_establecimiento_admin_mob_navigate_form();
  }

  function perform_ajax_form_del_establecimiento_admin_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("est_telefono");
    scAjaxHideErrorDisplay("est_estado");
    var var_est_id = document.F2.est_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_establecimiento_admin_mob_navigate_form(var_est_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_establecimiento_admin_mob_navigate_form_cb);
  } // do_ajax_form_del_establecimiento_admin_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_establecimiento_admin_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_establecimiento_admin_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.est_id.value = scAjaxGetKeyValue("est_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_establecimiento_admin_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_establecimiento_admin_mob_navigate_form_cb
  function do_ajax_form_del_establecimiento_admin_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_establecimiento_admin_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_establecimiento_admin_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_establecimiento_admin_mob_form()
  {
  ...
  ajax_field_list[0] = "est_id";
  ajax_field_list[1] = "est_logo";
  ajax_field_list[2] = "est_empresa";
  ajax_field_list[3] = "est_nombre";
  ajax_field_list[4] = "est_codigo";
  ajax_field_list[5] = "est_padronrimpe";
  ajax_field_list[6] = "est_leyenda_rimpe";
  ajax_field_list[7] = "est_iva_diferenciado";
  ajax_field_list[8] = "est_pais";
  ajax_field_list[9] = "est_provincia";
  ajax_field_list[10] = "est_canton";
  ajax_field_list[11] = "est_direccion";
  ajax_field_list[12] = "est_telefono";
  ajax_field_list[13] = "est_estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "est_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_logo": {"label": "<?php echo $this->Ini->Nm_lang['lang_logotipo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_nombre_establecimiento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_codigo": {"label": "<?php echo $this->Ini->Nm_lang['lang_serie_sri'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_padronrimpe": {"label": "<?php echo $this->Ini->Nm_lang['lang_rimpe'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_leyenda_rimpe": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_rimpe'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_iva_diferenciado": {"label": "<?php echo $this->Ini->Nm_lang['lang_iva_diferenciado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_pais": {"label": "<?php echo $this->Ini->Nm_lang['lang_pais'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_provincia": {"label": "<?php echo $this->Ini->Nm_lang['lang_provincia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_canton": {"label": "<?php echo $this->Ini->Nm_lang['lang_canton'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_direccion": {"label": "<?php echo $this->Ini->Nm_lang['lang_direccion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_telefono": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_telefono'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "est_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "est_id": new Array(),
    "est_logo": new Array(),
    "est_empresa": new Array(),
    "est_nombre": new Array(),
    "est_codigo": new Array(),
    "est_padronrimpe": new Array(),
    "est_leyenda_rimpe": new Array(),
    "est_iva_diferenciado": new Array(),
    "est_pais": new Array(),
    "est_provincia": new Array(),
    "est_canton": new Array(),
    "est_direccion": new Array(),
    "est_telefono": new Array(),
    "est_estado": new Array()
  };
  ajax_field_mult["est_id"][1] = "est_id";
  ajax_field_mult["est_logo"][1] = "est_logo";
  ajax_field_mult["est_empresa"][1] = "est_empresa";
  ajax_field_mult["est_nombre"][1] = "est_nombre";
  ajax_field_mult["est_codigo"][1] = "est_codigo";
  ajax_field_mult["est_padronrimpe"][1] = "est_padronrimpe";
  ajax_field_mult["est_leyenda_rimpe"][1] = "est_leyenda_rimpe";
  ajax_field_mult["est_iva_diferenciado"][1] = "est_iva_diferenciado";
  ajax_field_mult["est_pais"][1] = "est_pais";
  ajax_field_mult["est_provincia"][1] = "est_provincia";
  ajax_field_mult["est_canton"][1] = "est_canton";
  ajax_field_mult["est_direccion"][1] = "est_direccion";
  ajax_field_mult["est_telefono"][1] = "est_telefono";
  ajax_field_mult["est_estado"][1] = "est_estado";

  var ajax_field_id = {
    "est_logo": new Array("hidden_field_label_est_logo", "hidden_field_data_est_logo"),
    "est_nombre": new Array("hidden_field_label_est_nombre", "hidden_field_data_est_nombre"),
    "est_codigo": new Array("hidden_field_label_est_codigo", "hidden_field_data_est_codigo"),
    "est_padronrimpe": new Array("hidden_field_label_est_padronrimpe", "hidden_field_data_est_padronrimpe"),
    "est_leyenda_rimpe": new Array("hidden_field_label_est_leyenda_rimpe", "hidden_field_data_est_leyenda_rimpe"),
    "est_iva_diferenciado": new Array("hidden_field_label_est_iva_diferenciado", "hidden_field_data_est_iva_diferenciado"),
    "est_pais": new Array("hidden_field_label_est_pais", "hidden_field_data_est_pais"),
    "est_provincia": new Array("hidden_field_label_est_provincia", "hidden_field_data_est_provincia"),
    "est_canton": new Array("hidden_field_label_est_canton", "hidden_field_data_est_canton"),
    "est_direccion": new Array("hidden_field_label_est_direccion", "hidden_field_data_est_direccion"),
    "est_telefono": new Array("hidden_field_label_est_telefono", "hidden_field_data_est_telefono"),
    "est_estado": new Array("hidden_field_label_est_estado", "hidden_field_data_est_estado")
  };
  ...
  var ajax_read_only = {
    ...
    "est_codigo": "off",
    "est_padronrimpe": "off",
    "est_leyenda_rimpe": "off",
    "est_iva_diferenciado": "off",
    "est_pais": "off",
    "est_provincia": "off",
    "est_canton": "off",
    "est_direccion": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("est_iva_diferenciado" == sIndex)
    {
      scAjaxSetFieldCheckbox(sIndex, aValue, null, 1, null, null, "", "", "", false, true);
      updateHeaderFooter(sIndex, aValue);
