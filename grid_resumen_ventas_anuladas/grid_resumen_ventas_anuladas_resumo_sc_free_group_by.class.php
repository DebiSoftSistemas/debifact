...
class grid_resumen_ventas_anuladas_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_resumen_ventas_anuladas'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_resumen_ventas_anuladas'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
           $this->nmgp_botoes[$BTN] = $BTN_opc;
       }
   }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas_anuladas']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas_anuladas']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas_anuladas']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_resumen_ventas_anuladas']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_resumen_ventas_anuladas']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pesq_tab_label'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pesq_tab_label'] .= "fac_fecha?#?" . "" . $this->Ini->Nm_lang['lang_fecha'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pesq_tab_label'] .= "est_codigo?#?" . "" . $this->Ini->Nm_lang['lang_establecimiento'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pesq_tab_label'] .= "pen_serie?#?" . "" . $this->Ini->Nm_lang['lang_punto_emision'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pesq_tab_label'] .= "cl_identificacion?#?" . "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pesq_tab_label'] .= "cl_nombre?#?" . "" . $this->Ini->Nm_lang['lang_cliente'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pesq_tab_label'] .= "fac_usuario?#?" . "" . $this->Ini->Nm_lang['lang_usuario'] . " Factura" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pesq_tab_label'] .= "fac_socio_transportista?#?" . "" . $this->Ini->Nm_lang['lang_socio'] . "" . "?@?";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_search_add']);
          exit;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dyn_search_aut_comp']))
      {
          $Cmp_select2 = array("cl_identificacion","cl_nombre");
          ob_start();
          $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dyn_search_aut_comp']['cmp'];
          ...
          foreach ($nmgp_def_dados as $Ind => $Lista)
          {
             if (is_array($Lista))
             {
                 foreach ($Lista as $Cod => $Valor)
                 {
                     ...
                     if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                     {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dyn_search_aut_comp']);
          exit;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][7];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][8];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][9];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][10];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][3];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][11];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][4];
      $this->array_total_geral[8] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][12];
      $this->array_total_geral[9] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][5];
      $this->array_total_geral[10] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][6];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_total']['fac_fecha'] = $this->array_total_fac_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_total']['fac_tipo_comprobante'] = $this->array_total_fac_tipo_comprobante;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_total']['est_codigo'] = $this->array_total_est_codigo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_total']['pen_serie'] = $this->array_total_pen_serie;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_total']['cl_identificacion'] = $this->array_total_cl_identificacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_total']['cl_nombre'] = $this->array_total_cl_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_total']['fac_usuario'] = $this->array_total_fac_usuario;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_total']['fac_socio_transportista'] = $this->array_total_fac_socio_transportista;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['json_use_label'])
       {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_fecha'] = $Lab_fac_fecha; 
       $prep_field['fac_tipo_comprobante'] = $Lab_fac_tipo_comprobante;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_tipo_comprobante'] = $Lab_fac_tipo_comprobante; 
       $prep_field['est_codigo'] = $Lab_est_codigo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['est_codigo'] = $Lab_est_codigo; 
       $prep_field['pen_serie'] = $Lab_pen_serie;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['pen_serie'] = $Lab_pen_serie; 
       $prep_field['cl_identificacion'] = $Lab_cl_identificacion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_identificacion'] = $Lab_cl_identificacion; 
       $prep_field['cl_nombre'] = $Lab_cl_nombre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_nombre'] = $Lab_cl_nombre; 
       $prep_field['fac_usuario'] = $Lab_fac_usuario;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_usuario'] = $Lab_fac_usuario; 
       $prep_field['fac_socio_transportista'] = $Lab_fac_socio_transportista;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_socio_transportista'] = $Lab_fac_socio_transportista; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_tipo_comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_tipo_comprobante'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_nombre'] = "" . $this->Ini->Nm_lang['lang_cliente'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['est_codigo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['est_codigo'] = "" . $this->Ini->Nm_lang['lang_establecimiento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['pen_serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['pen_serie'] = "" . $this->Ini->Nm_lang['lang_punto_emision'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_secuencial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_secuencial'] = "" . $this->Ini->Nm_lang['lang_secuencial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_subtotal'] = "" . $this->Ini->Nm_lang['lang_subtotal'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_total_descuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_total_descuento'] = "" . $this->Ini->Nm_lang['lang_descuento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_valor_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_valor_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_propina']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_propina'] = "" . $this->Ini->Nm_lang['lang_propina'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_total'] = "" . $this->Ini->Nm_lang['lang_othr_chrt_totl'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_estado_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_estado_sri'] = "" . $this->Ini->Nm_lang['lang_estado_sri'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_subtotal_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_subtotal_iva'] = "" . $this->Ini->Nm_lang['lang_subtotal_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_subtotal_cero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_subtotal_cero'] = "" . $this->Ini->Nm_lang['lang_subtotal_cero'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_subtotal_no_objeto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_subtotal_no_objeto'] = "" . $this->Ini->Nm_lang['lang_subtotal_no_objeto'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_subtotal_excento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_subtotal_excento'] = "" . $this->Ini->Nm_lang['lang_subtotal_exento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_valor_ice']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_valor_ice'] = "" . $this->Ini->Nm_lang['lang_ice'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_valor_irbpnr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_valor_irbpnr'] = "" . $this->Ini->Nm_lang['lang_irbpnr'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_comentario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_comentario'] = "" . $this->Ini->Nm_lang['lang_comentario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_usuario'] = "" . $this->Ini->Nm_lang['lang_usuario'] . " Factura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_autorizacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_autorizacion'] = "" . $this->Ini->Nm_lang['lang_autorizacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_socio_transportista']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_socio_transportista'] = "" . $this->Ini->Nm_lang['lang_socio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_numero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_numero'] = "" . $this->Ini->Nm_lang['lang_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_ambiente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_ambiente'] = "" . $this->Ini->Nm_lang['lang_tipo_ambiente'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['est_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['est_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_tipo_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_tipo_identificacion'] = "" . $this->Ini->Nm_lang['lang_tipo_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_guia_remision']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_guia_remision'] = "" . $this->Ini->Nm_lang['lang_guia_remision'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_error_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_error_sri'] = "" . $this->Ini->Nm_lang['lang_error'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['cl_id'] = "" . $this->Ini->Nm_lang['lang_cliente'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['labels']['fac_estado'] = "" . $this->Ini->Nm_lang['lang_estado'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_resumen_ventas_anuladas@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['proc_pdf_vert'])
   {
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
         ...
         { 
            ...
            { 
                $seq_search = 1;
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_pesq'] as $cmp => $def)
                {
                   $Seq_grid      = $seq_search;
                   $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_resumen_ventas_anuladas']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_resumen_ventas_anuladas']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_resumen_ventas_anuladas']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_resumen_ventas_anuladas']) . "_";
               } 
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_resumen_ventas_anuladas_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['ajax_nav']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_resumen_ventas_anuladas_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_resumen_ventas_anuladas_jquery_2404.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_resumen_ventas_anuladas_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_ventas_anuladas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_resumen_ventas_anuladas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_ventas_anuladas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_resumen_ventas_anuladas/grid_resumen_ventas_anuladas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . " sc-app-grid\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_ventas_anuladas/grid_resumen_ventas_anuladas_config_pdf.php?nm_opc=pdf_res&nm_target=1&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_resumen_ventas_anuladas&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_ventas_anuladas/grid_resumen_ventas_anuladas_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_resumen_ventas_anuladas&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_ventas_anuladas/grid_resumen_ventas_anuladas_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_resumen_ventas_anuladas/grid_resumen_ventas_anuladas_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_resumen_ventas_anuladas/grid_resumen_ventas_anuladas_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_resumen_ventas_anuladas_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_resumen_ventas_anuladas_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_resumen_ventas_anuladas']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_resumen_ventas_anuladas']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_resumen_ventas_anuladas_config_pivot.php?nome_apl=grid_resumen_ventas_anuladas&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_resumen_ventas_anuladas_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_resumen_ventas_anuladas/grid_resumen_ventas_anuladas_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_resumen_ventas_anuladas_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("           document.Fexport.nmgp_password.value = password;\r\n");
      $nm_saida->saida("           document.Fexport.SC_module_export.value = SC_module_export;\r\n");
      $nm_saida->saida("               document.Fexport.action = \"grid_resumen_ventas_anuladas_export_ctrl.php\";\r\n");
      $nm_saida->saida("           document.Fexport.submit() ;\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_resumen_ventas_anuladas_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_resumen_ventas_anuladas@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_ventas_anuladas_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_resumen_ventas_anuladas/grid_resumen_ventas_anuladas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['cond_pesq'], 0, $trab_pos);
   ...
   function adiciona_registro($sum_fac_subtotal, $sum_fac_total_descuento, $sum_fac_valor_iva, $sum_fac_propina, $sum_fac_total, $sum_fac_subtotal_iva, $sum_fac_subtotal_cero, $sum_fac_subtotal_no_objeto, $sum_fac_subtotal_excento, $sum_fac_valor_ice, $sum_fac_valor_irbpnr, $quebra_fac_fecha, $quebra_fac_tipo_comprobante, $quebra_est_codigo, $quebra_pen_serie, $quebra_cl_identificacion, $quebra_cl_nombre, $quebra_fac_usuario, $quebra_fac_socio_transportista, $quebra_fac_fecha_orig, $quebra_fac_tipo_comprobante_orig, $quebra_est_codigo_orig, $quebra_pen_serie_orig, $quebra_cl_identificacion_orig, $quebra_cl_nombre_orig, $quebra_fac_usuario_orig, $quebra_fac_socio_transportista_orig)
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
//
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_pesq']) < 7)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_est_codigo($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['psq_check_ret']['est_codigo'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['psq_check_ret']['est_codigo'][] = trim($rs->fields[0]);
   ...
   function grid_search_pen_serie($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['psq_check_ret']['pen_serie'] = array();
       $pen_serie_look = (is_string($pen_serie) ? substr($this->Db->qstr($pen_serie), 1, -1) : $pen_serie); 
       $nmgp_def_dados  = ""; 
       $est_codigo = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['campos_busca']['est_codigo'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['campos_busca']['est_codigo'] : "";
       $est_codigo_val_str = "''";
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['psq_check_ret']['pen_serie'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_cl_identificacion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fac_estado='N') and #lowerI#cl_identificacion#lowerF# = #lowerI#'$cl_identificacion_look'#lowerF# order by cl_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function grid_search_cl_nombre($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fac_estado='N') and #lowerI#cl_nombre#lowerF# = #lowerI#'$cl_nombre_look'#lowerF# order by cl_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function grid_search_fac_usuario($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['psq_check_ret']['fac_usuario'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['psq_check_ret']['fac_usuario'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_fac_socio_transportista($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['psq_check_ret']['fac_socio_transportista'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['psq_check_ret']['fac_socio_transportista'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function lookup_ajax_cl_identificacion($cl_identificacion)
   {
       ...
       $cl_identificacion_look = (is_string($cl_identificacion) ? substr($this->Db->qstr($cl_identificacion), 1, -1) : $cl_identificacion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fac_estado='N') and  #lowerI#cl_identificacion#lowerF# like #lowerI#'%" . $cl_identificacion . "%'#lowerF# order by cl_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_resumen_ventas_anuladas_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_cl_nombre($cl_nombre)
   {
       ...
       $cl_nombre_look = (is_string($cl_nombre) ? substr($this->Db->qstr($cl_nombre), 1, -1) : $cl_nombre); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fac_estado='N') and  #lowerI#cl_nombre#lowerF# like #lowerI#'%" . $cl_nombre . "%'#lowerF# order by cl_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "debi_doc_electronicos/grid_resumen_ventas_anuladas";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_resumen_ventas_anuladas_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_resumen_ventas_anuladas_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_mes'] =  'sc_grid_resumen_ventas_anuladas_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_dia'] =  'sc_grid_resumen_ventas_anuladas_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_v2__mes'] =  'sc_grid_resumen_ventas_anuladas_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_v2__dia'] =  'sc_grid_resumen_ventas_anuladas_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_anuladas']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_mes']", 'value' => 'sc_grid_resumen_ventas_anuladas_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_dia']", 'value' => 'sc_grid_resumen_ventas_anuladas_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_v2__mes']", 'value' => 'sc_grid_resumen_ventas_anuladas_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_v2__dia']", 'value' => 'sc_grid_resumen_ventas_anuladas_valida_dia(this)');
       } 
