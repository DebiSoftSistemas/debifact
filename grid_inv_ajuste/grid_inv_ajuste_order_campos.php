...
<?php
   ...
   $Ord_Cmp = new grid_inv_ajuste_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_inv_ajuste_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['aj_id'] = "aj_id";
   $tab_labels["aj_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['labels']["aj_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['labels']["aj_id"] : "" . $this->Nm_lang['lang_id'] . "";
   $tab_ger_campos['aj_fecha'] = "on";
   $tab_def_campos['aj_fecha'] = "aj_fecha";
   $tab_labels["aj_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['labels']["aj_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['labels']["aj_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['aj_tipo_ajuste'] = "on";
   $tab_def_campos['aj_tipo_ajuste'] = "aj_tipo_ajuste";
   $tab_labels["aj_tipo_ajuste"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['labels']["aj_tipo_ajuste"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['labels']["aj_tipo_ajuste"] : "" . $this->Nm_lang['lang_tipo_ajuste'] . "";
   $tab_ger_campos['aj_bodega'] = "on";
   $tab_def_campos['aj_bodega'] = "aj_bodega";
   $tab_labels["aj_bodega"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['labels']["aj_bodega"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['labels']["aj_bodega"] : "" . $this->Nm_lang['lang_bodega'] . "";
   $tab_ger_campos['aj_info_adicional'] = "on";
   $tab_def_campos['aj_info_adicional'] = "aj_info_adicional";
   $tab_labels["aj_info_adicional"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['labels']["aj_info_adicional"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['labels']["aj_info_adicional"] : "" . $this->Nm_lang['lang_inf_adicional'] . "";
   $tab_ger_campos['aj_estado'] = "on";
   $tab_def_campos['aj_estado'] = "aj_estado";
   $tab_labels["aj_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['labels']["aj_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['labels']["aj_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_inv_ajuste_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_inv_ajuste']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
