...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_inv_ajuste"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_inv_ajuste"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_inv_ajuste'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inv_ajuste']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_inv_ajuste']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inv_ajuste']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_inv_ajuste']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_inv_ajuste']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_inv_ajuste']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_inv_ajuste']['embutida_filho'] as $ind => $sc_init)
          {
