...
<?php
   ...
   $Ord_Cmp = new grid_inv_unidad_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_inv_unidad_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['uni_codigo'] = "on";
   $tab_def_campos['uni_codigo'] = "uni_codigo";
   $tab_labels["uni_codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['labels']["uni_codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['labels']["uni_codigo"] : "" . $this->Nm_lang['lang_codigo'] . "";
   $tab_ger_campos['uni_nombre'] = "on";
   $tab_def_campos['uni_nombre'] = "uni_nombre";
   $tab_labels["uni_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['labels']["uni_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['labels']["uni_nombre"] : "" . $this->Nm_lang['lang_descripcion'] . "";
   $tab_ger_campos['uni_abreviacion'] = "on";
   $tab_def_campos['uni_abreviacion'] = "uni_abreviacion";
   $tab_labels["uni_abreviacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['labels']["uni_abreviacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['labels']["uni_abreviacion"] : "" . $this->Nm_lang['lang_abreviatura'] . "";
   $tab_ger_campos['uni_tipo'] = "on";
   $tab_def_campos['uni_tipo'] = "uni_tipo";
   $tab_labels["uni_tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['labels']["uni_tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['labels']["uni_tipo"] : "" . $this->Nm_lang['lang_tipo'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_inv_unidad_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_inv_unidad']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
