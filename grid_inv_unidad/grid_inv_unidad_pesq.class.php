...
class grid_inv_unidad_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_inv_unidad_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_inv_unidad_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_inv_unidad_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_uni_nombre')
      {
          $uni_nombre = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_uni_nombre($uni_nombre);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_uni_abreviacion')
      {
          $uni_abreviacion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_uni_abreviacion($uni_abreviacion);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> inv_unidad</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_inv_unidad/grid_inv_unidad_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_inv_unidad_ajax_search.js"></script>
 <script type="text/javascript" src="grid_inv_unidad_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_inv_unidad_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_inv_unidad']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_inv_unidad']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_uni_nombre_cond#NMF#' + search_get_sel_txt('SC_uni_nombre_cond') + '@NMF@';
  str_out += 'SC_uni_nombre#NMF#' + search_get_text('SC_uni_nombre') + '@NMF@';
  str_out += 'id_ac_uni_nombre#NMF#' + search_get_title('select2-id_ac_uni_nombre-container') + '@NMF@';
  str_out += 'SC_uni_abreviacion_cond#NMF#' + search_get_sel_txt('SC_uni_abreviacion_cond') + '@NMF@';
  str_out += 'SC_uni_abreviacion#NMF#' + search_get_text('SC_uni_abreviacion') + '@NMF@';
  str_out += 'id_ac_uni_abreviacion#NMF#' + search_get_title('select2-id_ac_uni_abreviacion-container') + '@NMF@';
  str_out += 'SC_uni_tipo_cond#NMF#' + search_get_sel_txt('SC_uni_tipo_cond') + '@NMF@';
  str_out += 'SC_uni_tipo#NMF#' + search_get_Dselelect('SC_uni_tipo_dest') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-uni_nombre").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_uni_nombre",
      max_itens: "10",
   ...
   $("#SC_uni_nombre").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-uni_abreviacion").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_uni_abreviacion",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_uni_abreviacion").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $uni_nombre_cond, $uni_nombre, $uni_nombre_autocomp,
             $uni_abreviacion_cond, $uni_abreviacion, $uni_abreviacion_autocomp,
             $uni_tipo_cond, $uni_tipo,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $uni_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_nombre']; 
          $uni_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_nombre_cond']; 
          $uni_abreviacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_abreviacion']; 
          $uni_abreviacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_abreviacion_cond']; 
          $uni_tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_tipo']; 
          $uni_tipo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_tipo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['NM_operador']; 
      } 
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_uni_nombre = (in_array($uni_nombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_uni_abreviacion = (in_array($uni_abreviacion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_uni_tipo = (in_array($uni_tipo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      // uni_tipo
      if (is_array($uni_tipo) && !empty($uni_tipo))
      {
         $tmp_array = array();
         $uni_tipo_val_str = "";
         foreach ($uni_tipo as $tmp_val_cmp)
         {
            if ("" != $uni_tipo_val_str)
            {
               $uni_tipo_val_str .= ",";
      ...
      if (!isset($uni_nombre) || $uni_nombre == "")
      {
          $uni_nombre = "";
      }
      if (isset($uni_nombre) && !empty($uni_nombre))
      {
         $tmp_pos = (is_string($uni_nombre)) ? strpos($uni_nombre, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $uni_nombre = substr($uni_nombre, 0, $tmp_pos);
         }
      }
      if (!isset($uni_abreviacion) || $uni_abreviacion == "")
      {
          $uni_abreviacion = "";
      }
      if (isset($uni_abreviacion) && !empty($uni_abreviacion))
      {
         $tmp_pos = (is_string($uni_abreviacion)) ? strpos($uni_abreviacion, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $uni_abreviacion = substr($uni_abreviacion, 0, $tmp_pos);
         }
      }
      if (!isset($uni_tipo) || $uni_tipo == "")
      {
          $uni_tipo = array();
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_uni_nombre_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['uni_nombre'])) ? $this->New_label['uni_nombre'] : "" . $this->Ini->Nm_lang['lang_descripcion'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_uni_nombre_cond" name="uni_nombre_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_uni_nombre" <?php echo $str_hide_uni_nombre?> valign="top">
 ...
 $nmgp_tab_label .= "uni_nombre?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $uni_nombre;
      }
?>
<INPUT  type="text" id="SC_uni_nombre" name="uni_nombre" value="<?php echo NM_encode_input($uni_nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-uni_nombre" id="id_ac_uni_nombre" name="uni_nombre_autocomp"><?php if ('' !=  $uni_nombre) { ?><option value="<?php echo $uni_nombre ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_uni_abreviacion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['uni_abreviacion'])) ? $this->New_label['uni_abreviacion'] : "" . $this->Ini->Nm_lang['lang_abreviatura'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_uni_abreviacion_cond" name="uni_abreviacion_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_uni_abreviacion" <?php echo $str_hide_uni_abreviacion?> valign="top">
 ...
 $nmgp_tab_label .= "uni_abreviacion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $uni_abreviacion;
      }
?>
<INPUT  type="text" id="SC_uni_abreviacion" name="uni_abreviacion" value="<?php echo NM_encode_input($uni_abreviacion) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-uni_abreviacion" id="id_ac_uni_abreviacion" name="uni_abreviacion_autocomp"><?php if ('' !=  $uni_abreviacion) { ?><option value="<?php echo $uni_abreviacion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_uni_tipo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['uni_tipo'])) ? $this->New_label['uni_tipo'] : "" . $this->Ini->Nm_lang['lang_tipo'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_uni_tipo_cond" name="uni_tipo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_uni_tipo" <?php echo $str_hide_uni_tipo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['uni_tipo'])) ? $this->New_label['uni_tipo'] : "" . $this->Ini->Nm_lang['lang_tipo'] . "";
 $nmgp_tab_label .= "uni_tipo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_uni_tipo_orig" name="uni_tipo_orig" size=7 multiple onDblClick="nm_add_sel('uni_tipo_orig', 'uni_tipo_dest', 'N' , '')">
<?php
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $uni_tipo_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('uni_tipo_orig', 'uni_tipo_dest', 'N', '');", "nm_add_all('uni_tipo_orig', 'uni_tipo_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('uni_tipo_orig', 'uni_tipo_dest', 'N', '');", "nm_add_sel('uni_tipo_orig', 'uni_tipo_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('uni_tipo_dest', 'uni_tipo_orig', 'N', '');", "nm_del_sel('uni_tipo_dest', 'uni_tipo_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('uni_tipo_dest', 'uni_tipo_orig', 'N', '');", "nm_del_all('uni_tipo_dest', 'uni_tipo_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_uni_tipo_dest" name="uni_tipo_dest" size=7 multiple  onDblClick="nm_del_sel('uni_tipo_dest', 'uni_tipo_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_uni_tipo" name="uni_tipo" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.uni_tipo_dest.selectedIndex = -1;</script>
<?php
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_inv_unidad_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_inv_unidad']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_inv_unidad']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
   nm_pack('uni_tipo_dest', 'uni_tipo');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_uni_nombre'), document.F1.uni_nombre_cond, 'uni_nombre');
   document.F1.uni_nombre.value = "";
   document.F1.uni_nombre_autocomp.value = "";
   $('#select2-id_ac_uni_nombre-container').html('<?php echo $this->Val_init_uni_nombre['desc'] ?>');;
   nm_campos_between(document.getElementById('id_vis_uni_abreviacion'), document.F1.uni_abreviacion_cond, 'uni_abreviacion');
   document.F1.uni_abreviacion.value = "";
   document.F1.uni_abreviacion_autocomp.value = "";
   $('#select2-id_ac_uni_abreviacion-container').html('<?php echo $this->Val_init_uni_abreviacion['desc'] ?>');;
   nm_campos_between(document.getElementById('id_vis_uni_tipo'), document.F1.uni_tipo_cond, 'uni_tipo');
   nm_del_all('uni_tipo_dest', 'uni_tipo_orig', 'N', '');
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_uni_nombre_cond'] = 'cond';
      $tp_fields['SC_uni_nombre'] = 'text_aut';
      $tp_fields['id_ac_uni_nombre'] = 'select2_aut';
      $tp_fields['SC_uni_abreviacion_cond'] = 'cond';
      $tp_fields['SC_uni_abreviacion'] = 'text_aut';
      $tp_fields['id_ac_uni_abreviacion'] = 'select2_aut';
      $tp_fields['SC_uni_tipo_cond'] = 'cond';
      $tp_fields['SC_uni_tipo'] = 'dselect';
   ...
   {
      global $uni_nombre_cond, $uni_nombre, $uni_nombre_autocomp,
             $uni_abreviacion_cond, $uni_abreviacion, $uni_abreviacion_autocomp,
             $uni_tipo_cond, $uni_tipo, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca'] as $Cmps => $Vals)
          {
              if ($Cmps == 'uni_tipo')
              {
                  $$Cmps = implode("@?@", $Vals);
      ...
      if (!empty($uni_nombre_autocomp) && empty($uni_nombre))
      {
          $uni_nombre = $uni_nombre_autocomp;
      }
      if (!empty($uni_abreviacion_autocomp) && empty($uni_abreviacion))
      {
          $uni_abreviacion = $uni_abreviacion_autocomp;
      }
      if (!empty($uni_tipo))
      {
          $uni_tipo = explode("@?@", $uni_tipo);
      ...
      $uni_nombre_cond_salva = $uni_nombre_cond; 
      if (!isset($uni_nombre_input_2) || $uni_nombre_input_2 == "")
      {
          $uni_nombre_input_2 = $uni_nombre;
      }
      $uni_abreviacion_cond_salva = $uni_abreviacion_cond; 
      if (!isset($uni_abreviacion_input_2) || $uni_abreviacion_input_2 == "")
      {
          $uni_abreviacion_input_2 = $uni_abreviacion;
      }
      $uni_tipo_cond_salva = $uni_tipo_cond; 
      if (!isset($uni_tipo_input_2) || $uni_tipo_input_2 == "")
      {
          $uni_tipo_input_2 = $uni_tipo;
      }
      if (is_array($uni_tipo)) {
          foreach ($uni_tipo as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['psq_check_ret']['uni_tipo'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_tipo'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_nombre'] = $uni_nombre; 
      if (is_array($uni_nombre) && !empty($uni_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid]['val'][0] = $uni_nombre;
      }
      elseif ($uni_nombre_cond_salva == "nu" || $uni_nombre_cond_salva == "nn" || $uni_nombre_cond_salva == "ep" || $uni_nombre_cond_salva == "ne" || !empty($uni_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid]['val'][0][0] = $uni_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_nombre_cond'] = $uni_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid]['cmp'] = "uni_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid]['opc'] = $uni_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq']['uni_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_abreviacion'] = $uni_abreviacion; 
      if (is_array($uni_abreviacion) && !empty($uni_abreviacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid]['val'][0] = $uni_abreviacion;
      }
      elseif ($uni_abreviacion_cond_salva == "nu" || $uni_abreviacion_cond_salva == "nn" || $uni_abreviacion_cond_salva == "ep" || $uni_abreviacion_cond_salva == "ne" || !empty($uni_abreviacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid]['val'][0][0] = $uni_abreviacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_abreviacion_cond'] = $uni_abreviacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid]['cmp'] = "uni_abreviacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid]['opc'] = $uni_abreviacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq']['uni_abreviacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_tipo'] = $uni_tipo; 
      if (is_array($uni_tipo) && !empty($uni_tipo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid]['val'][0] = $uni_tipo;
      }
      elseif ($uni_tipo_cond_salva == "nu" || $uni_tipo_cond_salva == "nn" || $uni_tipo_cond_salva == "ep" || $uni_tipo_cond_salva == "ne" || !empty($uni_tipo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid]['val'][0][0] = $uni_tipo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_tipo_cond'] = $uni_tipo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid]['cmp'] = "uni_tipo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid]['opc'] = $uni_tipo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq']['uni_tipo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($uni_nombre != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['uni_nombre'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['uni_nombre'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['uni_nombre'] = $uni_nombre;
      }
      $nmgp_def_dados = array();
    if ($uni_abreviacion != '') {
      $uni_abreviacion_look = (is_string($uni_abreviacion) ? substr($this->Db->qstr($uni_abreviacion), 1, -1) : $uni_abreviacion); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['uni_abreviacion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['uni_abreviacion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['uni_abreviacion'] = $uni_abreviacion;
      }
      $this->cmp_formatado['uni_tipo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']['uni_tipo'];
      $this->cmp_formatado['uni_tipo_input_2'] = $uni_tipo_input_2;

      //----- $uni_nombre
      $this->Date_part = false;
      if (isset($uni_nombre) || $uni_nombre_cond == "nu" || $uni_nombre_cond == "nn" || $uni_nombre_cond == "ep" || $uni_nombre_cond == "ne")
      {
         $this->monta_condicao("uni_nombre", $uni_nombre_cond, $uni_nombre, "", "uni_nombre", "VARCHAR", false);
      }

      //----- $uni_abreviacion
      $this->Date_part = false;
      if (isset($uni_abreviacion) || $uni_abreviacion_cond == "nu" || $uni_abreviacion_cond == "nn" || $uni_abreviacion_cond == "ep" || $uni_abreviacion_cond == "ne")
      {
         $this->monta_condicao("uni_abreviacion", $uni_abreviacion_cond, $uni_abreviacion, "", "uni_abreviacion", "VARCHAR", false);
      }

      //----- $uni_tipo
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($uni_tipo_cond == "nu" || $uni_tipo_cond == "nn" || $uni_tipo_cond == "ep" || $uni_tipo_cond == "ne")
      {
          $uni_tipo = array();
      }
      if (is_array($uni_tipo) && count($uni_tipo) != 0)
      {
         foreach ($uni_tipo as $i => $dados)
         {
      ...
      if (is_array($uni_tipo) && count($uni_tipo) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($uni_tipo_cond == "df" || $uni_tipo_cond == "np")
         {
             $this->comando        .= " #lowerI#uni_tipo#lowerF# not in (";
             $this->comando_sum    .= " #lowerI#inv_unidad.uni_tipo#lowerF# not in (";
             $this->comando_filtro .= " #lowerI#uni_tipo#lowerF# not in (";
         }
         else
         {
             $this->comando        .= " #lowerI#uni_tipo#lowerF# in (";
             $this->comando_sum    .= " #lowerI#inv_unidad.uni_tipo#lowerF# in (";
             $this->comando_filtro .= " #lowerI#uni_tipo#lowerF# in (";
         }
         $x                     = count($uni_tipo);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($uni_tipo as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($uni_tipo) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr_final = isset($Lang_descr[$uni_tipo_cond]) ? $Lang_descr[$uni_tipo_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $nmgp_tab_label['uni_tipo'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq']['uni_tipo']['label'] = $nmgp_tab_label['uni_tipo'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq']['uni_tipo']['descr'] = $nmgp_tab_label['uni_tipo'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['grid_pesq']['uni_tipo']['hint'] = $nmgp_tab_label['uni_tipo'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($uni_tipo) && ($uni_tipo_cond == "nu" || $uni_tipo_cond == "nn" || $uni_tipo_cond == "ep" || $uni_tipo_cond == "ne"))
      {
         $this->monta_condicao("uni_tipo", $uni_tipo_cond, "", "", "uni_tipo", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_unidad']['cond_pesq'] .= $this->NM_operador;
