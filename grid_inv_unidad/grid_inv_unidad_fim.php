...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_inv_unidad"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_inv_unidad"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_inv_unidad'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inv_unidad']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_inv_unidad']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inv_unidad']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_inv_unidad']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_inv_unidad']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_inv_unidad']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_inv_unidad']['embutida_filho'] as $ind => $sc_init)
          {
