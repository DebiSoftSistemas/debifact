...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "uni_id";$Nm_numeric[] = "uni_id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_uni_nombre"  <?php echo $str_hide_uni_nombre?>><?php
      if ($uni_nombre != "")
      {
      $uni_nombre_look = (is_string($uni_nombre) ? substr($this->Db->qstr($uni_nombre), 1, -1) : $uni_nombre); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_uni_abreviacion"  <?php echo $str_hide_uni_abreviacion?>><?php
      if ($uni_abreviacion != "")
      {
      $uni_abreviacion_look = (is_string($uni_abreviacion) ? substr($this->Db->qstr($uni_abreviacion), 1, -1) : $uni_abreviacion); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_uni_tipo"  <?php echo $str_hide_uni_tipo?>>
<?php
...
?>
   <span id="idAjaxSelect_uni_tipo">
      <SELECT class="scFilterObjectOdd" id="SC_uni_tipo" name="uni_tipo[]"  size="7" multiple>
<?php
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'uni_tipo[]')
      {
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "uni_tipo" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
