...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_imr_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones']['arr_total']['imr_descripcion'];
      }
      else
      {
          $this->array_total_imr_descripcion = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones']['summarizing_fields_order']['imr_descripcion']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones']['summarizing_fields_order']['imr_descripcion'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones']['summarizing_fields_order']['imr_descripcion'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones']['summarizing_fields_display']['imr_descripcion'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones']['summarizing_fields_display']['imr_descripcion'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones']['summarizing_fields_display']['imr_descripcion'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones']['summarizing_fields_display']['imr_descripcion'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones']['summarizing_fields_display']['imr_descripcion'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones']['summarizing_fields_display']['imr_descripcion'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_retenciones']['summarizing_fields_display']['imr_descripcion'] as $i_sum => $d_sum)
           {
