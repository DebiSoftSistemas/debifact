...
<?php
   ...
   $Ord_Cmp = new grid_detalle_compra_libretines_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detalle_compra_libretines_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['cl_punto_emision'] = "cl_punto_emision";
   $tab_labels["cl_punto_emision"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_punto_emision"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_punto_emision"] : "" . $this->Nm_lang['lang_punto_emision'] . "";
   $tab_ger_campos['cl_producto'] = "on";
   $tab_def_campos['cl_producto'] = "cl_producto";
   $tab_labels["cl_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_producto"] : "" . $this->Nm_lang['lang_producto'] . "";
   $tab_ger_campos['cl_cantidad'] = "on";
   $tab_def_campos['cl_cantidad'] = "cl_cantidad";
   $tab_labels["cl_cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_cantidad"] : "" . $this->Nm_lang['lang_lot_cantidad'] . "";
   $tab_ger_campos['cl_valor'] = "on";
   $tab_def_campos['cl_valor'] = "cl_valor";
   $tab_labels["cl_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_valor"] : "" . $this->Nm_lang['lang_valor'] . "";
   $tab_ger_campos['cl_descuento'] = "on";
   $tab_def_campos['cl_descuento'] = "cl_descuento";
   $tab_labels["cl_descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_descuento"] : "" . $this->Nm_lang['lang_descuento'] . "";
   $tab_ger_campos['cl_iva'] = "on";
   $tab_def_campos['cl_iva'] = "cl_iva";
   $tab_labels["cl_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_iva"] : "" . $this->Nm_lang['lang_tarifa_iva'] . "";
   $tab_ger_campos['cl_total'] = "on";
   $tab_def_campos['cl_total'] = "cl_total";
   $tab_labels["cl_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['labels']["cl_total"] : "" . $this->Nm_lang['lang_subtotal'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detalle_compra_libretines_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detalle_compra_libretines']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
