...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_empresa/form_del_empresa_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_empresa_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_empresa_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['recarga'];
}
if ('' != $this->emp_estado)
{
    $this->lookup_emp_estado($look_rpc_emp_estado);
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_del_empresa']['error_buffer']) && '' != $_SESSION['scriptcase']['form_del_empresa']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_del_empresa']['error_buffer'];
}
...
<?php
 include_once("form_del_empresa_mob_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/jsrsClient.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
<form  name="F1" method="post" enctype="multipart/form-data" 
               action="form_del_empresa_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_empresa_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_empresa_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-6';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emp_logo_line" id="hidden_field_data_emp_logo" style="<?php echo $sStyleHidden_emp_logo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_logo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emp_logo_label" style=""><span id="id_label_emp_logo"><?php echo $this->nm_new_label['emp_logo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['php_cmp_required']['emp_logo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['php_cmp_required']['emp_logo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $sStyleHidden_emp_clave_firma_dumb = ('' == $sStyleHidden_emp_clave_firma) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_emp_clave_firma_dumb" style="<?php echo $sStyleHidden_emp_clave_firma_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['Lookup_emp_obligado'][] = 'S'; ?>
<?php  if (in_array("S", $this->emp_obligado_1))  { echo " checked" ;} ?> onClick="do_ajax_form_del_empresa_mob_event_emp_obligado_onclick();" ><span></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emp_estado_line" id="hidden_field_data_emp_estado" style="<?php echo $sStyleHidden_emp_estado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_estado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emp_estado_label" style=""><span id="id_label_emp_estado"><?php echo $this->nm_new_label['emp_estado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['php_cmp_required']['emp_estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['php_cmp_required']['emp_estado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
?> 
    ...
    <TD class="scFormDataOdd css_escontribuyenteespecial_line" id="hidden_field_data_escontribuyenteespecial" style="<?php echo $sStyleHidden_escontribuyenteespecial; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_escontribuyenteespecial_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_escontribuyenteespecial_label" style=""><span id="id_label_escontribuyenteespecial"><?php echo $this->nm_new_label['escontribuyenteespecial']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['Lookup_escontribuyenteespecial'][] = 'S'; ?>
<?php  if (in_array("S", $this->escontribuyenteespecial_1))  { echo " checked" ;} ?> onClick="do_ajax_form_del_empresa_mob_event_escontribuyenteespecial_onclick();" ><span></span>
<label for="<?php echo $tempOptionId ?>"></label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['Lookup_esartesanocalificado'][] = 'S'; ?>
<?php  if (in_array("S", $this->esartesanocalificado_1))  { echo " checked" ;} ?> onClick="do_ajax_form_del_empresa_mob_event_esartesanocalificado_onclick();" ><span></span>
<label for="<?php echo $tempOptionId ?>"></label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
?> 
    ...
    <TD class="scFormDataOdd css_emp_es_op_transporte_line" id="hidden_field_data_emp_es_op_transporte" style="<?php echo $sStyleHidden_emp_es_op_transporte; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_es_op_transporte_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emp_es_op_transporte_label" style=""><span id="id_label_emp_es_op_transporte"><?php echo $this->nm_new_label['emp_es_op_transporte']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['Lookup_emp_es_op_transporte'][] = 'S'; ?>
...
?> 
    ...
    <TD class="scFormDataOdd css_emp_socio_transportista_line" id="hidden_field_data_emp_socio_transportista" style="<?php echo $sStyleHidden_emp_socio_transportista; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_socio_transportista_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emp_socio_transportista_label" style=""><span id="id_label_emp_socio_transportista"><?php echo $this->nm_new_label['emp_socio_transportista']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['Lookup_emp_socio_transportista'][] = 'S'; ?>
...
?> 
    ...
    <TD class="scFormDataOdd css_es_profesionalsalud_line" id="hidden_field_data_es_profesionalsalud" style="<?php echo $sStyleHidden_es_profesionalsalud; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_es_profesionalsalud_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_es_profesionalsalud_label" style=""><span id="id_label_es_profesionalsalud"><?php echo $this->nm_new_label['es_profesionalsalud']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['Lookup_es_profesionalsalud'][] = 'S'; ?>
...
?> 
    ...
    <TD class="scFormDataOdd css_emp_agente_retencion_line" id="hidden_field_data_emp_agente_retencion" style="<?php echo $sStyleHidden_emp_agente_retencion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_agente_retencion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emp_agente_retencion_label" style=""><span id="id_label_emp_agente_retencion"><?php echo $this->nm_new_label['emp_agente_retencion']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['Lookup_emp_agente_retencion'][] = 'S'; ?>
...
?> 
    ...
    <TD class="scFormDataOdd css_emp_autorizacion_inmediata_line" id="hidden_field_data_emp_autorizacion_inmediata" style="<?php echo $sStyleHidden_emp_autorizacion_inmediata; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_autorizacion_inmediata_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emp_autorizacion_inmediata_label" style=""><span id="id_label_emp_autorizacion_inmediata"><?php echo $this->nm_new_label['emp_autorizacion_inmediata']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['php_cmp_required']['emp_autorizacion_inmediata']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['php_cmp_required']['emp_autorizacion_inmediata'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['Lookup_emp_autorizacion_inmediata'][] = 'S'; ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_empresa_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_empresa_mob");
 parent.scAjaxDetailHeight("form_del_empresa_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_empresa_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
