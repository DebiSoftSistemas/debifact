...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_ajuste_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_ajuste_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_inv_ajuste_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_procesar_ok()
{
    ...
    document.F1.action = "form_inv_ajuste_mob.php";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_ajuste_mob']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_form_inv_ajuste_mob_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_inv_ajuste_mob_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
