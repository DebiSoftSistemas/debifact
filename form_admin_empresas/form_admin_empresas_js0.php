<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="emp_ruc" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['emp_ruc']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_admin_empresas"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['where_detal']))
  {
?>  
...
function sc_inline_form(seqRow, keyParams, width, height)
{
  ...
  nm_gp_submit('<?php echo $this->Ini->link_form_admin_empresas_inline ?>', '<?php echo $this->nm_location ?>', 'NM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutNMSC_modal*scinok*scoutsc_redir_atualiz*scinok*scoutsc_inline_call*scinY*scoutsc_seq_row*scin' + seqRow + '*scout' + callParams, '', 'modal', height, width);
}

function sc_inline_form_add(width, height)
{
  nm_gp_submit('<?php echo $this->Ini->link_form_admin_empresas_inline ?>', '<?php echo $this->nm_location ?>', 'NM_btn_insert*scinY*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutNMSC_modal*scinok*scoutsc_redir_atualiz*scinok*scoutsc_inline_call*scinY*scoutnmgp_opcao*scinnovo*scout', '', 'modal', height, width);
}
...
?>
    ...
    {
        do_ajax_form_admin_empresas_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_admin_empresas_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
...
function nm_mostra_doc(campo1, campo2, campo3)
{
    ...
    NovaJanela = window.open ("form_admin_empresas_doc.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nm_cod_doc=" + campo1 + "&nm_nome_doc=" + encodeURIComponent(campo2) + "&nm_cod_apl=" + campo3, "sc_name_download_iframe", "resizable, scrollbars");
}
...
{
    document.getElementById('form_admin_empresas_form0').style.width='1px';
    document.getElementById('form_admin_empresas_form0').style.height='0px';
    document.getElementById('form_admin_empresas_form0').style.display='none';
    document.getElementById('form_admin_empresas_form0').style.overflow='scroll';
    document.getElementById('form_admin_empresas_form1').style.width='1px';
    document.getElementById('form_admin_empresas_form1').style.height='0px';
    document.getElementById('form_admin_empresas_form1').style.display='none';
    document.getElementById('form_admin_empresas_form1').style.overflow='scroll';
    document.getElementById('form_admin_empresas_form2').style.width='1px';
    document.getElementById('form_admin_empresas_form2').style.height='0px';
    document.getElementById('form_admin_empresas_form2').style.display='none';
    document.getElementById('form_admin_empresas_form2').style.overflow='scroll';
    document.getElementById('form_admin_empresas_form3').style.width='1px';
    document.getElementById('form_admin_empresas_form3').style.height='0px';
    document.getElementById('form_admin_empresas_form3').style.display='none';
    document.getElementById('form_admin_empresas_form3').style.overflow='scroll';
    document.getElementById('form_admin_empresas_form4').style.width='1px';
    document.getElementById('form_admin_empresas_form4').style.height='0px';
    document.getElementById('form_admin_empresas_form4').style.display='none';
    document.getElementById('form_admin_empresas_form4').style.overflow='scroll';
    document.getElementById('form_admin_empresas_form5').style.width='1px';
    document.getElementById('form_admin_empresas_form5').style.height='0px';
    document.getElementById('form_admin_empresas_form5').style.display='none';
    document.getElementById('form_admin_empresas_form5').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['pdf_view']) {
?>
...
?>
   ...
   if ("form_admin_empresas_form1" == N_pagina) {
     scAjaxDetailHeight("grid_admin_establecimientos", $($("#nmsc_iframe_liga_grid_admin_establecimientos")[0].contentWindow.document).innerHeight());
    }
   if ("form_admin_empresas_form2" == N_pagina) {
     scAjaxDetailHeight("grid_admin_punto_emision", $($("#nmsc_iframe_liga_grid_admin_punto_emision")[0].contentWindow.document).innerHeight());
    }
   if ("form_admin_empresas_form3" == N_pagina) {
     scAjaxDetailHeight("grid_del_usuario_admin", $($("#nmsc_iframe_liga_grid_del_usuario_admin")[0].contentWindow.document).innerHeight());
    }
   if ("form_admin_empresas_form4" == N_pagina) {
     scAjaxDetailHeight("grid_admin_productos", $($("#nmsc_iframe_liga_grid_admin_productos")[0].contentWindow.document).innerHeight());
    }
   if ("form_admin_empresas_form5" == N_pagina) {
     scAjaxDetailHeight("form_del_config_tienda_config", $($("#nmsc_iframe_liga_form_del_config_tienda_config")[0].contentWindow.document).innerHeight());
    }
}
