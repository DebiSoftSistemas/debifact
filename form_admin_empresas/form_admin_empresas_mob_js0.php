...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_admin_empresas_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas_mob']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_form_admin_empresas_mob_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_admin_empresas_mob_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
...
function nm_mostra_doc(campo1, campo2, campo3)
{
    ...
    NovaJanela = window.open ("form_admin_empresas_mob_doc.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nm_cod_doc=" + campo1 + "&nm_nome_doc=" + encodeURIComponent(campo2) + "&nm_cod_apl=" + campo3, "sc_name_download_iframe", "resizable, scrollbars");
}
...
{
    document.getElementById('form_admin_empresas_mob_form0').style.width='1px';
    document.getElementById('form_admin_empresas_mob_form0').style.height='0px';
    document.getElementById('form_admin_empresas_mob_form0').style.display='none';
    document.getElementById('form_admin_empresas_mob_form0').style.overflow='scroll';
    document.getElementById('form_admin_empresas_mob_form1').style.width='1px';
    document.getElementById('form_admin_empresas_mob_form1').style.height='0px';
    document.getElementById('form_admin_empresas_mob_form1').style.display='none';
    document.getElementById('form_admin_empresas_mob_form1').style.overflow='scroll';
    document.getElementById('form_admin_empresas_mob_form2').style.width='1px';
    document.getElementById('form_admin_empresas_mob_form2').style.height='0px';
    document.getElementById('form_admin_empresas_mob_form2').style.display='none';
    document.getElementById('form_admin_empresas_mob_form2').style.overflow='scroll';
    document.getElementById('form_admin_empresas_mob_form3').style.width='1px';
    document.getElementById('form_admin_empresas_mob_form3').style.height='0px';
    document.getElementById('form_admin_empresas_mob_form3').style.display='none';
    document.getElementById('form_admin_empresas_mob_form3').style.overflow='scroll';
    document.getElementById('form_admin_empresas_mob_form4').style.width='1px';
    document.getElementById('form_admin_empresas_mob_form4').style.height='0px';
    document.getElementById('form_admin_empresas_mob_form4').style.display='none';
    document.getElementById('form_admin_empresas_mob_form4').style.overflow='scroll';
    document.getElementById('form_admin_empresas_mob_form5').style.width='1px';
    document.getElementById('form_admin_empresas_mob_form5').style.height='0px';
    document.getElementById('form_admin_empresas_mob_form5').style.display='none';
    document.getElementById('form_admin_empresas_mob_form5').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas_mob']['pdf_view']) {
?>
...
?>
   ...
   if ("form_admin_empresas_mob_form1" == N_pagina) {
   ...
   if ("form_admin_empresas_mob_form2" == N_pagina) {
