...
if ($this->Db)
{
    $this->Db->Close(); 
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_reporte_individual") . "/?nm_run_menu=1&nm_apl_menu=mnu_cartera&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      }
      if (!$link_url)
      {
