...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['mnu_cartera']['glo_nm_perfil']         = "igtech_conexion";
    $_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo']      = "";
...
class mnu_cartera_class
{
 ...
 function mnu_cartera_menu()
 {
    global $mnu_cartera_menuData, $nm_data_fixa;
...
$path_img_old   = $str_root . $path_link . "mnu_cartera/img";
...
include_once(dirname(__FILE__) . "/mnu_cartera_erro.class.php"); 
$this->Erro = new mnu_cartera_erro();
$str_path = substr($_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['mnu_cartera']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$mnu_cartera_menuData         = array();
$mnu_cartera_menuData['path'] = array();
$mnu_cartera_menuData['url']  = array();
$mnu_cartera_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $mnu_cartera_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $mnu_cartera_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $mnu_cartera_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $mnu_cartera_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$mnu_cartera_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$mnu_cartera_menuData['url']['web']   = str_replace("\\", '/', $mnu_cartera_menuData['url']['web']);
$mnu_cartera_menuData['path']['root'] = substr($mnu_cartera_menuData['path']['sys'],  0, -1 * strlen($mnu_cartera_menuData['url']['web']));
$mnu_cartera_menuData['path']['app']  = substr($mnu_cartera_menuData['path']['sys'],  0, strrpos($mnu_cartera_menuData['path']['sys'],  '/'));
$mnu_cartera_menuData['path']['link'] = substr($mnu_cartera_menuData['path']['app'],  0, strrpos($mnu_cartera_menuData['path']['app'],  '/'));
$mnu_cartera_menuData['path']['link'] = substr($mnu_cartera_menuData['path']['link'], 0, strrpos($mnu_cartera_menuData['path']['link'], '/')) . '/';
$mnu_cartera_menuData['path']['app'] .= '/';
$mnu_cartera_menuData['url']['app']   = substr($mnu_cartera_menuData['url']['web'],  0, strrpos($mnu_cartera_menuData['url']['web'],  '/'));
$mnu_cartera_menuData['url']['link']  = substr($mnu_cartera_menuData['url']['app'],  0, strrpos($mnu_cartera_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] == "S")
{
    $mnu_cartera_menuData['url']['link']  = substr($mnu_cartera_menuData['url']['link'], 0, strrpos($mnu_cartera_menuData['url']['link'], '/'));
}
$mnu_cartera_menuData['url']['link']  .= '/';
$mnu_cartera_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['mnu_cartera']['sc_apl_link'] = $mnu_cartera_menuData['url']['link'];
...
include_once("mnu_cartera_toolbar.php");
...
if ($_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "mnu_cartera";
     $_SESSION['scriptcase']['menu_apls']['mnu_cartera'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['mnu_cartera']['glo_nm_conexao']) && $_SESSION['scriptcase']['mnu_cartera']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['mnu_cartera']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['mnu_cartera']['glo_nm_perfil']) && $_SESSION['scriptcase']['mnu_cartera']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['mnu_cartera']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['mnu_cartera']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['mnu_cartera']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['mnu_cartera']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['mnu_cartera']['init']))
{
    $_SESSION['sc_session'][1]['mnu_cartera']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['mnu_cartera']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['mnu_cartera']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_mnu_cartera'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_mnu_cartera'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_mnu_cartera'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->str_schema_all = $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Debifact/Debifact";
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['mnu_cartera'] = "on";
} 
if (!isset($_SESSION['scriptcase']['mnu_cartera']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_cartera']) || $_SESSION['scriptcase']['sc_apl_seg']['mnu_cartera'] != "on"))
{ 
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
 ...
 <META http <META http <META http <META http <META http      <link rel="shortcut icon" href="../_lib/img/usr__NM__img__NM__favicon.png">
...
{
    db_conect_devel($_SESSION['scriptcase']['mnu_cartera']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_prod'], 'debi_doc_electronicos', 2); 
}
...
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['mnu_cartera']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_prod'], 'debi_doc_electronicos'); 
} 
else 
{ 
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'mnu_cartera'))
{
    $_SESSION['sc_session'][1]['mnu_cartera']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_mnu_cartera'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$mnu_cartera_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_sis_detalle_catalogo_configurador_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_sis_detalle_catalogo_configurador_ini.php');
    ...
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_sis_detalle_catalogo_configurador']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_fac_solicitud_anulacion_deuda_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_fac_solicitud_anulacion_deuda_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_anulacion_deuda']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_anulacion_deuda'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_fac_solicitud_cambio_deudor_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_fac_solicitud_cambio_deudor_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_cambio_deudor']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_cambio_deudor'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_fac_solicitud_convenio_pago_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_fac_solicitud_convenio_pago_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_convenio_pago']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_convenio_pago'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_fac_solicitud_division_deuda_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_fac_solicitud_division_deuda_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_division_deuda']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_division_deuda'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_v_cartera_general_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_v_cartera_general_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_general']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_general'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_v_cartera_por_recuperar_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_v_cartera_por_recuperar_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_por_recuperar']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_por_recuperar'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_v_cartera_recuperada_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_v_cartera_recuperada_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_recuperada']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_recuperada'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_v_cartera_anulada_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_v_cartera_anulada_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_anulada']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_anulada'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/grid_reporte_individual_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_reporte_individual_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_individual']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_individual'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_mnu_cartera'];
$mnu_cartera_menuData['data'] .= "item_1|.|" . $this->Nm_lang['lang_configuracion'] . "||" . $nm_var_hint[0] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_sis_detalle_catalogo_configurador']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_sis_detalle_catalogo_configurador']) == "on")
{
    $mnu_cartera_menuData['data'] .= "item_32|..|" . $this->Nm_lang['lang_tipo_cartera'] . "|mnu_cartera_form_php.php?sc_item_menu=item_32&sc_apl_menu=form_sis_detalle_catalogo_configurador&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->mnu_cartera_target('_self') . "|" . "\n";
}
else
{
    $mnu_cartera_menuData['data'] .= "item_32|..|" . $this->Nm_lang['lang_tipo_cartera'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_sis_detalle_catalogo_configurador']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_sis_detalle_catalogo_configurador']) == "on")
{
    $mnu_cartera_menuData['data'] .= "item_43|..|" . $this->Nm_lang['lang_estado_deudas'] . "|mnu_cartera_form_php.php?sc_item_menu=item_43&sc_apl_menu=form_sis_detalle_catalogo_configurador&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->mnu_cartera_target('_self') . "|" . "\n";
}
else
{
    $mnu_cartera_menuData['data'] .= "item_43|..|" . $this->Nm_lang['lang_estado_deudas'] . "||||_self|disabled\n";
}
$mnu_cartera_menuData['data'] .= "item_11|.|" . $this->Nm_lang['lang_operaciones'] . "||" . $nm_var_hint[3] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_anulacion_deuda']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_anulacion_deuda']) == "on")
{
    $mnu_cartera_menuData['data'] .= "item_39|..|" . $this->Nm_lang['lang_anular_deuda'] . "|mnu_cartera_form_php.php?sc_item_menu=item_39&sc_apl_menu=grid_fac_solicitud_anulacion_deuda&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->mnu_cartera_target('_self') . "|" . "\n";
}
else
{
    $mnu_cartera_menuData['data'] .= "item_39|..|" . $this->Nm_lang['lang_anular_deuda'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_cambio_deudor']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_cambio_deudor']) == "on")
{
    $mnu_cartera_menuData['data'] .= "item_40|..|" . $this->Nm_lang['lang_transferir_deuda'] . "|mnu_cartera_form_php.php?sc_item_menu=item_40&sc_apl_menu=grid_fac_solicitud_cambio_deudor&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->mnu_cartera_target('_self') . "|" . "\n";
}
else
{
    $mnu_cartera_menuData['data'] .= "item_40|..|" . $this->Nm_lang['lang_transferir_deuda'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_convenio_pago']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_convenio_pago']) == "on")
{
    $mnu_cartera_menuData['data'] .= "item_27|..|" . $this->Nm_lang['lang_convenio_pago'] . "|mnu_cartera_form_php.php?sc_item_menu=item_27&sc_apl_menu=grid_fac_solicitud_convenio_pago&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->mnu_cartera_target('_self') . "|" . "\n";
}
else
{
    $mnu_cartera_menuData['data'] .= "item_27|..|" . $this->Nm_lang['lang_convenio_pago'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_division_deuda']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_division_deuda']) == "on")
{
    $mnu_cartera_menuData['data'] .= "item_50|..|" . $this->Nm_lang['lang_subdivision_deuda'] . "|mnu_cartera_form_php.php?sc_item_menu=item_50&sc_apl_menu=grid_fac_solicitud_division_deuda&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->mnu_cartera_target('_self') . "|" . "\n";
}
else
{
    $mnu_cartera_menuData['data'] .= "item_50|..|" . $this->Nm_lang['lang_subdivision_deuda'] . "||||_self|disabled\n";
}
$mnu_cartera_menuData['data'] .= "item_3|.|" . $this->Nm_lang['lang_reporte'] . "||" . $nm_var_hint[8] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_general']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_general']) == "on")
{
    $mnu_cartera_menuData['data'] .= "item_47|..|" . $this->Nm_lang['lang_cartera_general'] . "|mnu_cartera_form_php.php?sc_item_menu=item_47&sc_apl_menu=grid_v_cartera_general&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->mnu_cartera_target('_self') . "|" . "\n";
}
else
{
    $mnu_cartera_menuData['data'] .= "item_47|..|" . $this->Nm_lang['lang_cartera_general'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_por_recuperar']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_por_recuperar']) == "on")
{
    $mnu_cartera_menuData['data'] .= "item_41|..|" . $this->Nm_lang['lang_cartera_recuperar'] . "|mnu_cartera_form_php.php?sc_item_menu=item_41&sc_apl_menu=grid_v_cartera_por_recuperar&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "||" . $this->mnu_cartera_target('_self') . "|" . "\n";
}
else
{
    $mnu_cartera_menuData['data'] .= "item_41|..|" . $this->Nm_lang['lang_cartera_recuperar'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_recuperada']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_recuperada']) == "on")
{
    $mnu_cartera_menuData['data'] .= "item_48|..|" . $this->Nm_lang['lang_cartera_recuperada'] . "|mnu_cartera_form_php.php?sc_item_menu=item_48&sc_apl_menu=grid_v_cartera_recuperada&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->mnu_cartera_target('_self') . "|" . "\n";
}
else
{
    $mnu_cartera_menuData['data'] .= "item_48|..|" . $this->Nm_lang['lang_cartera_recuperada'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_anulada']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_anulada']) == "on")
{
    $mnu_cartera_menuData['data'] .= "item_49|..|" . $this->Nm_lang['lang_cartera_anulada'] . "|mnu_cartera_form_php.php?sc_item_menu=item_49&sc_apl_menu=grid_v_cartera_anulada&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[12] . "||" . $this->mnu_cartera_target('_self') . "|" . "\n";
}
else
{
    $mnu_cartera_menuData['data'] .= "item_49|..|" . $this->Nm_lang['lang_cartera_anulada'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_individual']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_individual']) == "on")
{
    $mnu_cartera_menuData['data'] .= "item_42|..|" . $this->Nm_lang['lang_cartera_por_deudor'] . "|mnu_cartera_form_php.php?sc_item_menu=item_42&sc_apl_menu=grid_reporte_individual&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[13] . "||" . $this->mnu_cartera_target('_self') . "|" . "\n";
}
else
{
    $mnu_cartera_menuData['data'] .= "item_42|..|" . $this->Nm_lang['lang_cartera_por_deudor'] . "||||_self|disabled\n";
}
...
$mnu_cartera_menuData['data'] = array();
$str_disabled = "N";
$str_link = "#";
$str_icon = "";
$icon_aba = "";
...
$str_disabled = "N";
$str_link = "mnu_cartera_form_php.php?sc_item_menu=item_32&sc_apl_menu=form_sis_detalle_catalogo_configurador&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_sis_detalle_catalogo_configurador']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_sis_detalle_catalogo_configurador']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_cartera_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_tipo_cartera'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[1] . "",
        'id'       => "item_32",
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->mnu_cartera_target('_self') . "\"",
        'sc_id'    => "item_32",
        'disabled' => $str_disabled,
        'display'     => "text_img",
        'display_position'=> "text_right",
...
$str_disabled = "N";
$str_link = "mnu_cartera_form_php.php?sc_item_menu=item_43&sc_apl_menu=form_sis_detalle_catalogo_configurador&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_sis_detalle_catalogo_configurador']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_sis_detalle_catalogo_configurador']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_cartera_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_estado_deudas'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[2] . "",
        'id'       => "item_43",
...
$mnu_cartera_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_operaciones'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[3] . "",
    'id'       => "item_11",
    ...
    'display'     => "text_fontawesomeicon",
    'display_position'=> "text_right",
    'icon_fa'     => "fas fa-comment-dollar",
    'icon_color'     => "",
    'icon_color_hover'     => "",
    'icon_color_disabled'     => "",
);
$str_disabled = "N";
$str_link = "mnu_cartera_form_php.php?sc_item_menu=item_39&sc_apl_menu=grid_fac_solicitud_anulacion_deuda&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_anulacion_deuda']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_anulacion_deuda']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_cartera_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_anular_deuda'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[4] . "",
        'id'       => "item_39",
...
$str_disabled = "N";
$str_link = "mnu_cartera_form_php.php?sc_item_menu=item_40&sc_apl_menu=grid_fac_solicitud_cambio_deudor&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_cambio_deudor']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_cambio_deudor']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_cartera_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_transferir_deuda'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[5] . "",
        'id'       => "item_40",
...
$str_disabled = "N";
$str_link = "mnu_cartera_form_php.php?sc_item_menu=item_27&sc_apl_menu=grid_fac_solicitud_convenio_pago&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_convenio_pago']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_convenio_pago']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_cartera_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_convenio_pago'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[6] . "",
        'id'       => "item_27",
...
$str_disabled = "N";
$str_link = "mnu_cartera_form_php.php?sc_item_menu=item_50&sc_apl_menu=grid_fac_solicitud_division_deuda&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_division_deuda']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_fac_solicitud_division_deuda']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_cartera_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_subdivision_deuda'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[7] . "",
        'id'       => "item_50",
...
$str_disabled = "N";
$str_link = "mnu_cartera_form_php.php?sc_item_menu=item_47&sc_apl_menu=grid_v_cartera_general&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_general']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_general']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_cartera_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_cartera_general'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[9] . "",
        'id'       => "item_47",
...
$str_disabled = "N";
$str_link = "mnu_cartera_form_php.php?sc_item_menu=item_41&sc_apl_menu=grid_v_cartera_por_recuperar&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_por_recuperar']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_por_recuperar']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_cartera_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_cartera_recuperar'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[10] . "",
        'id'       => "item_41",
...
$str_disabled = "N";
$str_link = "mnu_cartera_form_php.php?sc_item_menu=item_48&sc_apl_menu=grid_v_cartera_recuperada&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_recuperada']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_recuperada']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_cartera_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_cartera_recuperada'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[11] . "",
        'id'       => "item_48",
...
$str_disabled = "N";
$str_link = "mnu_cartera_form_php.php?sc_item_menu=item_49&sc_apl_menu=grid_v_cartera_anulada&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_anulada']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_v_cartera_anulada']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_cartera_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_cartera_anulada'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[12] . "",
        'id'       => "item_49",
...
$str_disabled = "N";
$str_link = "mnu_cartera_form_php.php?sc_item_menu=item_42&sc_apl_menu=grid_reporte_individual&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_individual']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_individual']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_cartera_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_cartera_por_deudor'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[13] . "",
        'id'       => "item_42",
...
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['mnu_cartera']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'mnu_cartera');
    $mnu_cartera_menuData['data'] = $str_menu_usu;
}
if (is_file("mnu_cartera_help.txt"))
{
    $Arq_WebHelp = file("mnu_cartera_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $mnu_cartera_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->mnu_cartera_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['mnu_cartera']) && !empty($_SESSION['scriptcase']['sc_menu_del']['mnu_cartera']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($mnu_cartera_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['mnu_cartera']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($mnu_cartera_menuData['data'][$i_menu]);
       }
    ...
    $mnu_cartera_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['mnu_cartera']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['mnu_cartera']))
{
    $disable_menu = false;
    foreach ($mnu_cartera_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['mnu_cartera']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $mnu_cartera_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
if($this->force_mobile || ($_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']))
{
    $_SESSION['scriptcase']['menu_mobile'] = "mnu_cartera";
    include('mnu_cartera_mobile.php');
    exit;
}
/* Cabecera HTML */
if ($mnu_cartera_menuData['iframe'])
{
    $mnu_cartera_menuData['height'] = '100%';
    header("X-XSS-Protection: 1; mode=block");
    header("X-Frame-Options: SAMEORIGIN");
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
<head>
 <title><?php echo $this->Nm_lang['lang_cartera'] ?></title>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <?php
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $mnu_cartera_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->str_schema_all ?>_sweetalert.css" />
<script type="text/javascript" src="mnu_cartera_message.js"></script>
...
Iframe_atual = "mnu_cartera_iframe";
...
{
  if (str_id != "iframe_mnu_cartera")
  {
      str_id        = str_id.replace("mnu_cartera_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    ...
    if(str_target != '_blank' && $('#iframe_mnu_cartera').length)
        $('#iframe_mnu_cartera')[0].contentWindow.focus();
  }
}
</script>
<?php
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR valign="middle">
        ...
        <TD align="left" class="scMenuHHeaderFont">
          <?php echo "" . $this->Nm_lang['lang_cartera'] . "" ?>
        </TD>
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $mnu_cartera_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->mnu_cartera_escreveMenu($mnu_cartera_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Control de iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $mnu_cartera_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
?>
    <div id="Iframe_control" style='width:100%; height:100%; margin:0px; padding:0px;'>
      <iframe id="iframe_mnu_cartera" name="mnu_cartera_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "mnu_cartera_pag_ini.php"); ?>"></iframe>
<?php
}
?></div></td>
  </tr>
...
/* Control de Target */
function mnu_cartera_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function mnu_cartera_target($str_target)
{
    global $mnu_cartera_menuData;
    ...
    elseif ($mnu_cartera_menuData['iframe'])
    {
        return 'mnu_cartera_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $mnu_cartera_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "mnu_cartera_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "mnu_cartera_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_cartera_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->mnu_cartera_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['mnu_cartera']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['scriptcase']['mnu_cartera']['SC_sep_date']) && !empty($_SESSION['scriptcase']['mnu_cartera']['SC_sep_date']))
       {
           $delim  = $_SESSION['scriptcase']['mnu_cartera']['SC_sep_date'];
           $delim1 = $_SESSION['scriptcase']['mnu_cartera']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'mnu_cartera', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'mnu_cartera', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'mnu_cartera', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['mnu_cartera']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_debi_doc_electronicos'])) {
            $_SESSION['scriptcase']['mnu_cartera']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_debi_doc_electronicos'];
        }
    }
}
...
$contr_mnu_cartera = new mnu_cartera_class;
$contr_mnu_cartera->mnu_cartera_menu();
