...
<?php
   ...
   $Ord_Cmp = new grid_inv_recibir_transferencia_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_inv_recibir_transferencia_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['inv_transferencias_tr_fecha'] = "inv_transferencias_tr_fecha";
   }
   else
   {
       $tab_def_campos['inv_transferencias_tr_fecha'] = "inv_transferencias.tr_fecha";
   }
   $tab_labels["inv_transferencias_tr_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['labels']["inv_transferencias_tr_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['labels']["inv_transferencias_tr_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['inv_transferencias_tr_bodega_origen'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['inv_transferencias_tr_bodega_origen'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['inv_transferencias_tr_bodega_origen'] = "inv_transferencias.tr_bodega_origen";
   }
   $tab_labels["inv_transferencias_tr_bodega_origen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['labels']["inv_transferencias_tr_bodega_origen"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['labels']["inv_transferencias_tr_bodega_origen"] : "" . $this->Nm_lang['lang_bodega_origen'] . "";
   $tab_ger_campos['inv_transferencias_tr_bodega_destino'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['inv_transferencias_tr_bodega_destino'] = "cmp_maior_30_2";
   }
   else
   {
       $tab_def_campos['inv_transferencias_tr_bodega_destino'] = "inv_transferencias.tr_bodega_destino";
   }
   $tab_labels["inv_transferencias_tr_bodega_destino"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['labels']["inv_transferencias_tr_bodega_destino"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['labels']["inv_transferencias_tr_bodega_destino"] : "" . $this->Nm_lang['lang_bodega_destino'] . "";
   $tab_ger_campos['inv_transferencias_tr_estado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['inv_transferencias_tr_estado'] = "inv_transferencias_tr_estado";
   }
   else
   {
       $tab_def_campos['inv_transferencias_tr_estado'] = "inv_transferencias.tr_estado";
   }
   $tab_labels["inv_transferencias_tr_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['labels']["inv_transferencias_tr_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['labels']["inv_transferencias_tr_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_inv_recibir_transferencia_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_inv_recibir_transferencia']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
