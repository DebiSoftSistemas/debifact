...
class grid_resumen_ventas_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_resumen_ventas_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_resumen_ventas_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_resumen_ventas_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_refresh_field")
      {
          ...
          if (in_array("pen_serie", $NMcmp_refr))
          {
              $list = array();
              $nmgp_def_dados = $this->lookup_ajax_pen_serie($est_codigo);
              ...
              $this->Arr_result['set_dselect'][] = array('field' => 'SC_pen_serie', 'value' => $list);
          }
      }
   ...
   function lookup_ajax_pen_serie($est_codigo)
   {
      $est_codigo_val_str = "''";
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "v_del_datos_factura_sri.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_resumen_ventas'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_resumen_ventas/grid_resumen_ventas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_resumen_ventas_ajax_search.js"></script>
 <script type="text/javascript" src="grid_resumen_ventas_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript"> 
 ...
 function nm_add_sel(sOrig, sDest, Saida, Order)
 {
  ...
  if (sOrig == "est_codigo_orig")
  {
      nm_refresh_est_codigo();
  }
 }
...
<script type="text/javascript" src="grid_resumen_ventas_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_resumen_ventas']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_resumen_ventas']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_est_codigo_cond#NMF#' + search_get_sel_txt('SC_est_codigo_cond') + '@NMF@';
  str_out += 'SC_est_codigo#NMF#' + search_get_Dselelect('SC_est_codigo_dest') + '@NMF@';
  str_out += 'SC_pen_serie_cond#NMF#' + search_get_sel_txt('SC_pen_serie_cond') + '@NMF@';
  str_out += 'SC_pen_serie#NMF#' + search_get_Dselelect('SC_pen_serie_dest') + '@NMF@';
  ...
  str_out += 'SC_fac_socio_transportista_cond#NMF#' + search_get_sel_txt('SC_fac_socio_transportista_cond') + '@NMF@';
  str_out += 'SC_fac_socio_transportista#NMF#' + search_get_Dselelect('SC_fac_socio_transportista_dest') + '@NMF@';
 ...
 function nm_refresh_est_codigo(Proc_on)
 {
   var parms  = "";
   var fields = "pen_serie";
   parms += 'est_codigo#NMF#' + search_get_Dselelect('SC_est_codigo_dest') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $est_codigo_cond, $est_codigo,
             $pen_serie_cond, $pen_serie,
             ...
             $fac_socio_transportista_cond, $fac_socio_transportista,
      ...
      if (isset($bprocessa) && ($bprocessa == "recarga" || $bprocessa == "save_form" || $bprocessa == "filter_delete"))
      {
          if (!empty($fac_socio_transportista))
          {
              $fac_socio_transportista = explode("@?@", $fac_socio_transportista);
          }
          else
          {
              $fac_socio_transportista = array();
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fac_fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_dia']; 
          $fac_fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_mes']; 
          $fac_fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_ano']; 
          $fac_fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_input_2_dia']; 
          $fac_fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_input_2_mes']; 
          $fac_fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_input_2_ano']; 
          $fac_fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_cond']; 
          $est_codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['est_codigo']; 
          $est_codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['est_codigo_cond']; 
          $pen_serie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['pen_serie']; 
          $pen_serie_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['pen_serie_cond']; 
          $cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['cl_identificacion']; 
          $cl_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['cl_identificacion_cond']; 
          $cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['cl_nombre']; 
          $cl_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['cl_nombre_cond']; 
          $fac_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_usuario']; 
          $fac_usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_usuario_cond']; 
          $fac_socio_transportista = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_socio_transportista']; 
          $fac_socio_transportista_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_socio_transportista_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['NM_operador']; 
      } 
      if (!isset($fac_fecha_cond) || empty($fac_fecha_cond))
      {
         $fac_fecha_cond = "eq";
      }
      if (!isset($fac_socio_transportista_cond) || empty($fac_socio_transportista_cond))
      {
         $fac_socio_transportista_cond = "eq";
      }
      ...
      $str_hide_est_codigo = (in_array($est_codigo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pen_serie = (in_array($pen_serie_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_fac_socio_transportista = (in_array($fac_socio_transportista_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_fac_fecha = ('bw' == $fac_fecha_cond) ? $display_aberto : $display_fechado;
      $str_display_est_codigo = ('bw' == $est_codigo_cond) ? $display_aberto : $display_fechado;
      $str_display_pen_serie = ('bw' == $pen_serie_cond) ? $display_aberto : $display_fechado;
      ...
      $str_display_fac_socio_transportista = ('bw' == $fac_socio_transportista_cond) ? $display_aberto : $display_fechado;
      ...
      // pen_serie
      if (is_array($pen_serie) && !empty($pen_serie))
      {
         $tmp_array = array();
         $pen_serie_val_str = "";
         foreach ($pen_serie as $tmp_val_cmp)
         {
            if ("" != $pen_serie_val_str)
            {
               $pen_serie_val_str .= ",";
            }
            $tmp_pos = (is_string($tmp_val_cmp)) ? strpos($tmp_val_cmp, "##@@") : false;
      ...
      if (is_array($fac_socio_transportista) && !empty($fac_socio_transportista))
      {
         $tmp_array = array();
         $fac_socio_transportista_val_str = "";
         foreach ($fac_socio_transportista as $tmp_val_cmp)
         {
            if ("" != $fac_socio_transportista_val_str)
            {
               $fac_socio_transportista_val_str .= ",";
            }
            $tmp_pos = (is_string($tmp_val_cmp)) ? strpos($tmp_val_cmp, "##@@") : false;
            ...
            $fac_socio_transportista_val_str .= "'$tmp_val_cmp'";
         }
         $fac_socio_transportista = $tmp_array;
      }
      else
      {
         $fac_socio_transportista_val_str = "''";
      ...
      if (!isset($est_codigo) || $est_codigo == "")
      {
          $est_codigo = array();
      }
      if (!isset($pen_serie) || $pen_serie == "")
      {
          $pen_serie = array();
      }
      ...
      if (!isset($fac_socio_transportista) || $fac_socio_transportista == "")
      {
          $fac_socio_transportista = array();
      }
?>
...
?>
      ...
      <TD id='SC_est_codigo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['est_codigo'])) ? $this->New_label['est_codigo'] : "" . $this->Ini->Nm_lang['lang_establecimiento'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_est_codigo_cond" name="est_codigo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_est_codigo" <?php echo $str_hide_est_codigo?> valign="top">
 ...
 $nmgp_tab_label .= "est_codigo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_est_codigo_orig" name="est_codigo_orig" size=7 multiple onDblClick="nm_add_sel('est_codigo_orig', 'est_codigo_dest', 'N' , '')">
<?php
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $est_codigo_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('est_codigo_orig', 'est_codigo_dest', 'N', '');", "nm_add_all('est_codigo_orig', 'est_codigo_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('est_codigo_orig', 'est_codigo_dest', 'N', '');", "nm_add_sel('est_codigo_orig', 'est_codigo_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('est_codigo_dest', 'est_codigo_orig', 'N', '');", "nm_del_sel('est_codigo_dest', 'est_codigo_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('est_codigo_dest', 'est_codigo_orig', 'N', '');", "nm_del_all('est_codigo_dest', 'est_codigo_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectEven" id="SC_est_codigo_dest" name="est_codigo_dest" size=7 multiple  onDblClick="nm_del_sel('est_codigo_dest', 'est_codigo_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_est_codigo" name="est_codigo" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.est_codigo_dest.selectedIndex = -1;</script>
<?php
?>
      ...
      <TD id='SC_pen_serie_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pen_serie'])) ? $this->New_label['pen_serie'] : "" . $this->Ini->Nm_lang['lang_punto_emision'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_pen_serie_cond" name="pen_serie_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pen_serie" <?php echo $str_hide_pen_serie?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['pen_serie'])) ? $this->New_label['pen_serie'] : "" . $this->Ini->Nm_lang['lang_punto_emision'] . "";
 $nmgp_tab_label .= "pen_serie?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_pen_serie_orig" name="pen_serie_orig" size=7 multiple onDblClick="nm_add_sel('pen_serie_orig', 'pen_serie_dest', 'N' , '')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $pen_serie_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('pen_serie_orig', 'pen_serie_dest', 'N', '');", "nm_add_all('pen_serie_orig', 'pen_serie_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('pen_serie_orig', 'pen_serie_dest', 'N', '');", "nm_add_sel('pen_serie_orig', 'pen_serie_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('pen_serie_dest', 'pen_serie_orig', 'N', '');", "nm_del_sel('pen_serie_dest', 'pen_serie_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('pen_serie_dest', 'pen_serie_orig', 'N', '');", "nm_del_all('pen_serie_dest', 'pen_serie_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_pen_serie_dest" name="pen_serie_dest" size=7 multiple  onDblClick="nm_del_sel('pen_serie_dest', 'pen_serie_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_pen_serie" name="pen_serie" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.pen_serie_dest.selectedIndex = -1;</script>
<?php
?>
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cl_nombre" id="id_ac_cl_nombre" name="cl_nombre_autocomp"><?php if ('' !=  $cl_nombre) { ?><option value="<?php echo $cl_nombre ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_fac_usuario_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fac_usuario'])) ? $this->New_label['fac_usuario'] : "" . $this->Ini->Nm_lang['lang_usuario'] . " Factura"; ?></TD>
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_fac_usuario_orig" name="fac_usuario_orig" size=7 multiple onDblClick="nm_add_sel('fac_usuario_orig', 'fac_usuario_dest', 'N' , '')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
   ...
   <td>
    <SELECT class="scFilterObjectEven" id="SC_fac_usuario_dest" name="fac_usuario_dest" size=7 multiple  onDblClick="nm_del_sel('fac_usuario_dest', 'fac_usuario_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
      ...
      <TD id='SC_fac_socio_transportista_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fac_socio_transportista'])) ? $this->New_label['fac_socio_transportista'] : "" . $this->Ini->Nm_lang['lang_socio'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_fac_socio_transportista_cond" name="fac_socio_transportista_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fac_socio_transportista" <?php echo $str_hide_fac_socio_transportista?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fac_socio_transportista'])) ? $this->New_label['fac_socio_transportista'] : "" . $this->Ini->Nm_lang['lang_socio'] . "";
 $nmgp_tab_label .= "fac_socio_transportista?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_fac_socio_transportista_orig" name="fac_socio_transportista_orig" size=7 multiple onDblClick="nm_add_sel('fac_socio_transportista_orig', 'fac_socio_transportista_dest', 'N' , '')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($fac_socio_transportista) && !empty($fac_socio_transportista))
            {
               ...
               foreach ($fac_socio_transportista as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $fac_socio_transportista_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('fac_socio_transportista_orig', 'fac_socio_transportista_dest', 'N', '');", "nm_add_all('fac_socio_transportista_orig', 'fac_socio_transportista_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('fac_socio_transportista_orig', 'fac_socio_transportista_dest', 'N', '');", "nm_add_sel('fac_socio_transportista_orig', 'fac_socio_transportista_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('fac_socio_transportista_dest', 'fac_socio_transportista_orig', 'N', '');", "nm_del_sel('fac_socio_transportista_dest', 'fac_socio_transportista_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('fac_socio_transportista_dest', 'fac_socio_transportista_orig', 'N', '');", "nm_del_all('fac_socio_transportista_dest', 'fac_socio_transportista_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_fac_socio_transportista_dest" name="fac_socio_transportista_dest" size=7 multiple  onDblClick="nm_del_sel('fac_socio_transportista_dest', 'fac_socio_transportista_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_fac_socio_transportista" name="fac_socio_transportista" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.fac_socio_transportista_dest.selectedIndex = -1;</script>
<?php
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_resumen_ventas_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
   nm_pack('est_codigo_dest', 'est_codigo');
   nm_pack('pen_serie_dest', 'pen_serie');
   nm_pack('fac_usuario_dest', 'fac_usuario');
   nm_pack('fac_socio_transportista_dest', 'fac_socio_transportista');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_est_codigo'), document.F1.est_codigo_cond, 'est_codigo');
   nm_del_all('est_codigo_dest', 'est_codigo_orig', 'N', '');
   nm_campos_between(document.getElementById('id_vis_pen_serie'), document.F1.pen_serie_cond, 'pen_serie');
   nm_del_all('pen_serie_dest', 'pen_serie_orig', 'N', '');
   ...
   document.F1.fac_socio_transportista_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fac_socio_transportista'), document.F1.fac_socio_transportista_cond, 'fac_socio_transportista');
   nm_del_all('fac_socio_transportista_dest', 'fac_socio_transportista_orig', 'N', '');
   Sc_carga_select2('all');
 }
 ...
 {
    $('#SC_fac_fecha_dia').bind('change', function() {sc_grid_resumen_ventas_valida_dia(this)});
    $('#SC_fac_fecha_input_2_dia').bind('change', function() {sc_grid_resumen_ventas_valida_dia(this)});
    $('#SC_fac_fecha_input_2_mes').bind('change', function() {sc_grid_resumen_ventas_valida_mes(this)});
    $('#SC_fac_fecha_mes').bind('change', function() {sc_grid_resumen_ventas_valida_mes(this)});
 }
 function sc_grid_resumen_ventas_valida_dia(obj)
 {
 ...
 function sc_grid_resumen_ventas_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_est_codigo_cond'] = 'cond';
      $tp_fields['SC_est_codigo'] = 'dselect';
      $tp_fields['SC_pen_serie_cond'] = 'cond';
      $tp_fields['SC_pen_serie'] = 'dselect';
      ...
      $tp_fields['SC_fac_socio_transportista_cond'] = 'cond';
      $tp_fields['SC_fac_socio_transportista'] = 'dselect';
   ...
   function trata_campos()
   {
      global $fac_fecha_cond, $fac_fecha, $fac_fecha_dia, $fac_fecha_mes, $fac_fecha_ano, $fac_fecha_input_2_dia, $fac_fecha_input_2_mes, $fac_fecha_input_2_ano,
             ...
             $cl_nombre_cond, $cl_nombre, $cl_nombre_autocomp,
             $fac_usuario_cond, $fac_usuario,
             $fac_socio_transportista_cond, $fac_socio_transportista, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca'] as $Cmps => $Vals)
          {
              if ($Cmps == 'est_codigo' || $Cmps == 'pen_serie' || $Cmps == 'fac_usuario' || $Cmps == 'fac_socio_transportista')
              {
                  $$Cmps = implode("@?@", $Vals);
              }
              else
      ...
      $est_codigo_cond_salva = $est_codigo_cond; 
      if (!isset($est_codigo_input_2) || $est_codigo_input_2 == "")
      {
          $est_codigo_input_2 = $est_codigo;
      }
      $pen_serie_cond_salva = $pen_serie_cond; 
      if (!isset($pen_serie_input_2) || $pen_serie_input_2 == "")
      {
          $pen_serie_input_2 = $pen_serie;
      }
      ...
      $fac_socio_transportista_cond_salva = $fac_socio_transportista_cond; 
      if (!isset($fac_socio_transportista_input_2) || $fac_socio_transportista_input_2 == "")
      {
          $fac_socio_transportista_input_2 = $fac_socio_transportista;
      }
      if (is_array($est_codigo)) {
          foreach ($est_codigo as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['psq_check_ret']['est_codigo'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_establecimiento'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($pen_serie)) {
          foreach ($pen_serie as $I => $Val) {
              $tmp_pos = (is_string($Val)) ? strpos($Val, "##@@") : false;
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['psq_check_ret']['pen_serie'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_punto_emision'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($fac_usuario)) {
          foreach ($fac_usuario as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['psq_check_ret']['fac_usuario'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_usuario'] . " Factura : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($fac_socio_transportista)) {
          foreach ($fac_socio_transportista as $I => $Val) {
              $tmp_pos = (is_string($Val)) ? strpos($Val, "##@@") : false;
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['psq_check_ret']['fac_socio_transportista'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_socio'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_dia'] = $fac_fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_mes'] = $fac_fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_ano'] = $fac_fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_input_2_dia'] = $fac_fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_input_2_mes'] = $fac_fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_input_2_ano'] = $fac_fecha_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fac_fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fac_fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fac_fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fac_fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fac_fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fac_fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_cond'] = $fac_fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['cmp'] = "fac_fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['opc'] = $fac_fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['fac_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['est_codigo'] = $est_codigo; 
      if (is_array($est_codigo) && !empty($est_codigo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0] = $est_codigo;
      }
      elseif ($est_codigo_cond_salva == "nu" || $est_codigo_cond_salva == "nn" || $est_codigo_cond_salva == "ep" || $est_codigo_cond_salva == "ne" || !empty($est_codigo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0][0] = $est_codigo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['est_codigo_cond'] = $est_codigo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['cmp'] = "est_codigo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['opc'] = $est_codigo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['est_codigo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['pen_serie'] = $pen_serie; 
      if (is_array($pen_serie) && !empty($pen_serie))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0] = $pen_serie;
      }
      elseif ($pen_serie_cond_salva == "nu" || $pen_serie_cond_salva == "nn" || $pen_serie_cond_salva == "ep" || $pen_serie_cond_salva == "ne" || !empty($pen_serie))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0][0] = $pen_serie;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['pen_serie_cond'] = $pen_serie_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['cmp'] = "pen_serie"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['opc'] = $pen_serie_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['pen_serie'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['cl_identificacion'] = $cl_identificacion; 
      if (is_array($cl_identificacion) && !empty($cl_identificacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0] = $cl_identificacion;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0][0] = $cl_identificacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['cl_identificacion_cond'] = $cl_identificacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['cmp'] = "cl_identificacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['opc'] = $cl_identificacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['cl_identificacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['cl_nombre'] = $cl_nombre; 
      if (is_array($cl_nombre) && !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0] = $cl_nombre;
      }
      elseif ($cl_nombre_cond_salva == "nu" || $cl_nombre_cond_salva == "nn" || $cl_nombre_cond_salva == "ep" || $cl_nombre_cond_salva == "ne" || !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0][0] = $cl_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['cl_nombre_cond'] = $cl_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['cmp'] = "cl_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['opc'] = $cl_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['cl_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_usuario'] = $fac_usuario; 
      if (is_array($fac_usuario) && !empty($fac_usuario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0] = $fac_usuario;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0][0] = $fac_usuario;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_usuario_cond'] = $fac_usuario_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['cmp'] = "fac_usuario"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['opc'] = $fac_usuario_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['fac_usuario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_socio_transportista'] = $fac_socio_transportista; 
      if (is_array($fac_socio_transportista) && !empty($fac_socio_transportista))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0] = $fac_socio_transportista;
      }
      elseif ($fac_socio_transportista_cond_salva == "nu" || $fac_socio_transportista_cond_salva == "nn" || $fac_socio_transportista_cond_salva == "ep" || $fac_socio_transportista_cond_salva == "ne" || !empty($fac_socio_transportista))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['val'][0][0] = $fac_socio_transportista;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_socio_transportista_cond'] = $fac_socio_transportista_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['cmp'] = "fac_socio_transportista"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid]['opc'] = $fac_socio_transportista_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['fac_socio_transportista'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['est_codigo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['est_codigo'];
      $this->cmp_formatado['est_codigo_input_2'] = $est_codigo_input_2;
      $this->cmp_formatado['pen_serie'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['pen_serie'];
      $this->cmp_formatado['pen_serie_input_2'] = $pen_serie_input_2;
      $nmgp_def_dados = array();
    if ($cl_identificacion != '') {
      $cl_identificacion_look = (is_string($cl_identificacion) ? substr($this->Db->qstr($cl_identificacion), 1, -1) : $cl_identificacion); 
      $nmgp_def_dados = array(); 
    ...
    if ($cl_nombre != '') {
      ...
      $this->cmp_formatado['fac_usuario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_usuario'];
      $this->cmp_formatado['fac_usuario_input_2'] = $fac_usuario_input_2;
      $this->cmp_formatado['fac_socio_transportista'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_socio_transportista'];
      $this->cmp_formatado['fac_socio_transportista_input_2'] = $fac_socio_transportista_input_2;
      ...
      if ($fac_fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha'] = $val[0];
          ...
          if ($fac_fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']['fac_fecha_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['fac_fecha']['label'] = $nmgp_tab_label['fac_fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['fac_fecha']['descr'] = $nmgp_tab_label['fac_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['fac_fecha']['hint']  = $nmgp_tab_label['fac_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $est_codigo
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($est_codigo_cond == "nu" || $est_codigo_cond == "nn" || $est_codigo_cond == "ep" || $est_codigo_cond == "ne")
      {
          $est_codigo = array();
      }
      if (is_array($est_codigo) && count($est_codigo) != 0)
      {
         foreach ($est_codigo as $i => $dados)
         {
      ...
      if (is_array($est_codigo) && count($est_codigo) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($est_codigo_cond == "df" || $est_codigo_cond == "np")
         {
             $this->comando        .= " #lowerI#est_codigo#lowerF# not in (";
             $this->comando_sum    .= " #lowerI#v_del_datos_factura_sri.est_codigo#lowerF# not in (";
             $this->comando_filtro .= " #lowerI#est_codigo#lowerF# not in (";
         }
         else
         {
             $this->comando        .= " #lowerI#est_codigo#lowerF# in (";
             $this->comando_sum    .= " #lowerI#v_del_datos_factura_sri.est_codigo#lowerF# in (";
             $this->comando_filtro .= " #lowerI#est_codigo#lowerF# in (";
         }
         $x                     = count($est_codigo);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($est_codigo as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($est_codigo) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr_final = isset($Lang_descr[$est_codigo_cond]) ? $Lang_descr[$est_codigo_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label['est_codigo'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['est_codigo']['label'] = $nmgp_tab_label['est_codigo'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['est_codigo']['descr'] = $nmgp_tab_label['est_codigo'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['est_codigo']['hint'] = $nmgp_tab_label['est_codigo'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($est_codigo) && ($est_codigo_cond == "nu" || $est_codigo_cond == "nn" || $est_codigo_cond == "ep" || $est_codigo_cond == "ne"))
      {
         $this->monta_condicao("est_codigo", $est_codigo_cond, "", "", "est_codigo", "VARCHAR", false);
      }

      //----- $pen_serie
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($pen_serie_cond == "nu" || $pen_serie_cond == "nn" || $pen_serie_cond == "ep" || $pen_serie_cond == "ne")
      {
          $pen_serie = array();
      }
      if (is_array($pen_serie) && count($pen_serie) != 0)
      {
         foreach ($pen_serie as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
      ...
      if (is_array($pen_serie) && count($pen_serie) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($pen_serie_cond == "df" || $pen_serie_cond == "np")
         {
             $this->comando        .= " #lowerI#pen_serie#lowerF# not in (";
             $this->comando_sum    .= " #lowerI#v_del_datos_factura_sri.pen_serie#lowerF# not in (";
             $this->comando_filtro .= " #lowerI#pen_serie#lowerF# not in (";
         }
         else
         {
             $this->comando        .= " #lowerI#pen_serie#lowerF# in (";
             $this->comando_sum    .= " #lowerI#v_del_datos_factura_sri.pen_serie#lowerF# in (";
             $this->comando_filtro .= " #lowerI#pen_serie#lowerF# in (";
         }
         $x                     = count($pen_serie);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($pen_serie as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($pen_serie) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr['df'] = $this->Ini->Nm_lang['lang_srch_diff'];
         $Lang_descr['np'] = $this->Ini->Nm_lang['lang_srch_not_like'];
         $Lang_descr_final = isset($Lang_descr[$pen_serie_cond]) ? $Lang_descr[$pen_serie_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label['pen_serie'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['pen_serie']['label'] = $nmgp_tab_label['pen_serie'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['pen_serie']['descr'] = $nmgp_tab_label['pen_serie'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['pen_serie']['hint'] = $nmgp_tab_label['pen_serie'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($pen_serie) && ($pen_serie_cond == "nu" || $pen_serie_cond == "nn" || $pen_serie_cond == "ep" || $pen_serie_cond == "ne"))
      {
         $this->monta_condicao("pen_serie", $pen_serie_cond, "", "", "pen_serie", "VARCHAR", false);
      }
      ...
      if (is_array($fac_usuario) && count($fac_usuario) != 0)
      {
         ...
         {
             $this->comando        .= " #lowerI#fac_usuario#lowerF# not in (";
             $this->comando_sum    .= " #lowerI#v_del_datos_factura_sri.fac_usuario#lowerF# not in (";
             $this->comando_filtro .= " #lowerI#fac_usuario#lowerF# not in (";
         }
         else
         {
             $this->comando        .= " #lowerI#fac_usuario#lowerF# in (";
             $this->comando_sum    .= " #lowerI#v_del_datos_factura_sri.fac_usuario#lowerF# in (";
             $this->comando_filtro .= " #lowerI#fac_usuario#lowerF# in (";
         }
         $x                     = count($fac_usuario);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label['fac_usuario'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['fac_usuario']['label'] = $nmgp_tab_label['fac_usuario'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['fac_usuario']['descr'] = $nmgp_tab_label['fac_usuario'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['fac_usuario']['hint'] = $nmgp_tab_label['fac_usuario'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      ...
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($fac_socio_transportista_cond == "nu" || $fac_socio_transportista_cond == "nn" || $fac_socio_transportista_cond == "ep" || $fac_socio_transportista_cond == "ne")
      {
          $fac_socio_transportista = array();
      }
      if (is_array($fac_socio_transportista) && count($fac_socio_transportista) != 0)
      {
         foreach ($fac_socio_transportista as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
                unset($fac_socio_transportista[$i]);
            }
         }
      }
      if (is_array($fac_socio_transportista) && count($fac_socio_transportista) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($fac_socio_transportista_cond == "df" || $fac_socio_transportista_cond == "np")
         {
             $this->comando        .= " #lowerI#fac_socio_transportista#lowerF# not in (";
             $this->comando_sum    .= " #lowerI#v_del_datos_factura_sri.fac_socio_transportista#lowerF# not in (";
             $this->comando_filtro .= " #lowerI#fac_socio_transportista#lowerF# not in (";
         }
         else
         {
             $this->comando        .= " #lowerI#fac_socio_transportista#lowerF# in (";
             $this->comando_sum    .= " #lowerI#v_del_datos_factura_sri.fac_socio_transportista#lowerF# in (";
             $this->comando_filtro .= " #lowerI#fac_socio_transportista#lowerF# in (";
         }
         $x                     = count($fac_socio_transportista);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($fac_socio_transportista as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($fac_socio_transportista) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr['df'] = $this->Ini->Nm_lang['lang_srch_diff'];
         $Lang_descr['np'] = $this->Ini->Nm_lang['lang_srch_not_like'];
         $Lang_descr_final = isset($Lang_descr[$fac_socio_transportista_cond]) ? $Lang_descr[$fac_socio_transportista_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $nmgp_tab_label['fac_socio_transportista'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['fac_socio_transportista']['label'] = $nmgp_tab_label['fac_socio_transportista'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['fac_socio_transportista']['descr'] = $nmgp_tab_label['fac_socio_transportista'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['grid_pesq']['fac_socio_transportista']['hint'] = $nmgp_tab_label['fac_socio_transportista'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($fac_socio_transportista) && ($fac_socio_transportista_cond == "nu" || $fac_socio_transportista_cond == "nn" || $fac_socio_transportista_cond == "ep" || $fac_socio_transportista_cond == "ne"))
      {
         $this->monta_condicao("fac_socio_transportista", $fac_socio_transportista_cond, "", "", "fac_socio_transportista", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['cond_pesq'] .= $this->NM_operador;
