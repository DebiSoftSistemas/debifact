...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_est_codigo"  <?php echo $str_hide_est_codigo?>>
<?php
...
?>
   <span id="idAjaxSelect_est_codigo">
      <SELECT class="scFilterObjectEven" id="SC_est_codigo" name="est_codigo[]" onChange="nm_refresh_est_codigo();" size="7" multiple>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_pen_serie"  <?php echo $str_hide_pen_serie?>>
<?php
      $pen_serie_look = (is_string($pen_serie) ? substr($this->Db->qstr($pen_serie), 1, -1) : $pen_serie); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT pen_serie,pen_serie  FROM del_punto_emision inner join del_establecimiento on pem_establecimiento=est_id where est_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and est_codigo  IN ($est_codigo_val_str)"; 
...
?>
   <span id="idAjaxSelect_pen_serie">
      <SELECT class="scFilterObjectOdd" id="SC_pen_serie" name="pen_serie[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
   <span id="idAjaxSelect_fac_usuario">
      <SELECT class="scFilterObjectEven" id="SC_fac_usuario" name="fac_usuario[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fac_socio_transportista"  <?php echo $str_hide_fac_socio_transportista?>>
<?php
...
?>
   <span id="idAjaxSelect_fac_socio_transportista">
      <SELECT class="scFilterObjectOdd" id="SC_fac_socio_transportista" name="fac_socio_transportista[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
         ...
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($fac_socio_transportista) && !empty($fac_socio_transportista))
            {
               ...
               foreach ($fac_socio_transportista as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $fac_socio_transportista_sel = "selected";
                       break;
                   }
               }
            }
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'est_codigo[]')
      {
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'pen_serie[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'fac_socio_transportista[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "est_codigo" : return ('class="scFilterObjectEven"'); break;
         case "pen_serie" : return ('class="scFilterObjectOdd"'); break;
         case "fac_usuario" : return ('class="scFilterObjectEven"'); break;
         case "fac_socio_transportista" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
