...
function sc_actionbar_disable($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_resumen_ventas/grid_resumen_ventas_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_resumen_ventas_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_resumen_ventas.zip";
          $this->Arquivo   .= "_grid_resumen_ventas" . $this->Xls_tp;
          $this->Tit_doc    = "grid_resumen_ventas" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_resumen_ventas']['contr_erro'] = 'off';
      ...
      while (!$rs->EOF)
      {
         ...
         $this->fac_numero = $rs->fields[23] ;  
         $this->fac_numero = (string)$this->fac_numero;
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Gb_Free_orig']))
         {
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Gb_Free_orig'] as $Cmp_clone => $Cmp_orig)
             {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Ind_Groupby'] == "sc_free_group_by")
         {
             ...
             {
                 $Cmp_orig = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
         ...
         $this->arg_sum_fac_socio_transportista = " = " . $this->Db->qstr($this->fac_socio_transportista);
          ...
          {  
              $SC_arg_Gby = array();
              $SC_arg_Sql = array();
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Gb_Free_orig'][$cmp] : $cmp;
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Gb_Free_cmp']);
              krsort ($SC_lst_Gby);
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
...
$_SESSION['scriptcase']['grid_resumen_ventas']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida'])
      { 
      ...
      if ($this->groupby_show == "S") {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Ind_Groupby'] == "sc_free_group_by")
       {
          ...
          $this->Xls_col = 0;
          $this->Xls_row++;
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['SC_Ind_Groupby'] . "_bot";
          $this->$Gb_geral();
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida'])
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_res_grid'] = true;
              $this->Res_xls->monta_xls();
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_res_sheet']);
          } 
          if ($this->Use_phpspreadsheet) {
              if ($this->Xls_tp == ".xlsx") {
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['nolabel'])
       {
 ...
 function quebra_fac_tipo_comprobante_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function quebra_fac_socio_transportista_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['field_order'] as $Cada_cmp)
       {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
       $mens_tot_base = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][1] . ")";
       $prim_lin_tot  = true;
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       $mens_tot      = $mens_tot_base . " - " . $Tit_sum;
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['fac_subtotal'][$Tipo_Sum]) && $Cada_cmp == "fac_subtotal" && (!isset($this->NM_cmp_hidden['fac_subtotal']) || $this->NM_cmp_hidden['fac_subtotal'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][$NM_cmp_tot['fac_subtotal'][$Tipo_Sum]];
               $prim_cmp = false;
           ...
           elseif (isset($NM_cmp_tot['fac_total_descuento'][$Tipo_Sum]) && $Cada_cmp == "fac_total_descuento" && (!isset($this->NM_cmp_hidden['fac_total_descuento']) || $this->NM_cmp_hidden['fac_total_descuento'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][$NM_cmp_tot['fac_total_descuento'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['fac_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "fac_valor_iva" && (!isset($this->NM_cmp_hidden['fac_valor_iva']) || $this->NM_cmp_hidden['fac_valor_iva'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][$NM_cmp_tot['fac_valor_iva'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['fac_propina'][$Tipo_Sum]) && $Cada_cmp == "fac_propina" && (!isset($this->NM_cmp_hidden['fac_propina']) || $this->NM_cmp_hidden['fac_propina'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][$NM_cmp_tot['fac_propina'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['fac_total'][$Tipo_Sum]) && $Cada_cmp == "fac_total" && (!isset($this->NM_cmp_hidden['fac_total']) || $this->NM_cmp_hidden['fac_total'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][$NM_cmp_tot['fac_total'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['fac_subtotal_iva'][$Tipo_Sum]) && $Cada_cmp == "fac_subtotal_iva" && (!isset($this->NM_cmp_hidden['fac_subtotal_iva']) || $this->NM_cmp_hidden['fac_subtotal_iva'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][$NM_cmp_tot['fac_subtotal_iva'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['fac_subtotal_cero'][$Tipo_Sum]) && $Cada_cmp == "fac_subtotal_cero" && (!isset($this->NM_cmp_hidden['fac_subtotal_cero']) || $this->NM_cmp_hidden['fac_subtotal_cero'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][$NM_cmp_tot['fac_subtotal_cero'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['fac_subtotal_no_objeto'][$Tipo_Sum]) && $Cada_cmp == "fac_subtotal_no_objeto" && (!isset($this->NM_cmp_hidden['fac_subtotal_no_objeto']) || $this->NM_cmp_hidden['fac_subtotal_no_objeto'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][$NM_cmp_tot['fac_subtotal_no_objeto'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['fac_subtotal_excento'][$Tipo_Sum]) && $Cada_cmp == "fac_subtotal_excento" && (!isset($this->NM_cmp_hidden['fac_subtotal_excento']) || $this->NM_cmp_hidden['fac_subtotal_excento'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][$NM_cmp_tot['fac_subtotal_excento'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['fac_valor_ice'][$Tipo_Sum]) && $Cada_cmp == "fac_valor_ice" && (!isset($this->NM_cmp_hidden['fac_valor_ice']) || $this->NM_cmp_hidden['fac_valor_ice'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][$NM_cmp_tot['fac_valor_ice'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['fac_valor_irbpnr'][$Tipo_Sum]) && $Cada_cmp == "fac_valor_irbpnr" && (!isset($this->NM_cmp_hidden['fac_valor_irbpnr']) || $this->NM_cmp_hidden['fac_valor_irbpnr'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['tot_geral'][$NM_cmp_tot['fac_valor_irbpnr'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas']['xls_file'] = $this->Xls_f;
      }
