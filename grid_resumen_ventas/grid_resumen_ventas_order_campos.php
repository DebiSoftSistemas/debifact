<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_resumen_ventas']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_resumen_ventas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_resumen_ventas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fac_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['fac_tipo_comprobante'] = "on";
   $tab_def_campos['fac_tipo_comprobante'] = "fac_tipo_comprobante";
   $tab_labels["fac_tipo_comprobante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_tipo_comprobante"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_tipo_comprobante"] : "" . $this->Nm_lang['lang_tipo_comprobante'] . "";
   $tab_ger_campos['cl_identificacion'] = "on";
   $tab_def_campos['cl_identificacion'] = "cl_identificacion";
   $tab_labels["cl_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["cl_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["cl_identificacion"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['cl_nombre'] = "on";
   $tab_def_campos['cl_nombre'] = "cl_nombre";
   $tab_labels["cl_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["cl_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["cl_nombre"] : "" . $this->Nm_lang['lang_cliente'] . "";
   $tab_ger_campos['est_codigo'] = "on";
   $tab_def_campos['est_codigo'] = "est_codigo";
   $tab_labels["est_codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["est_codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["est_codigo"] : "" . $this->Nm_lang['lang_establecimiento'] . "";
   $tab_ger_campos['pen_serie'] = "on";
   $tab_def_campos['pen_serie'] = "pen_serie";
   $tab_labels["pen_serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["pen_serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["pen_serie"] : "" . $this->Nm_lang['lang_punto_emision'] . "";
   $tab_ger_campos['fac_secuencial'] = "on";
   $tab_def_campos['fac_secuencial'] = "fac_secuencial";
   $tab_labels["fac_secuencial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_secuencial"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_secuencial"] : "" . $this->Nm_lang['lang_secuencial'] . "";
   $tab_ger_campos['fac_subtotal'] = "on";
   $tab_def_campos['fac_subtotal'] = "fac_subtotal";
   $tab_labels["fac_subtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_subtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_subtotal"] : "" . $this->Nm_lang['lang_subtotal'] . "";
   $tab_ger_campos['fac_total_descuento'] = "on";
   $tab_def_campos['fac_total_descuento'] = "fac_total_descuento";
   $tab_labels["fac_total_descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_total_descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_total_descuento"] : "" . $this->Nm_lang['lang_descuento'] . "";
   $tab_ger_campos['fac_valor_iva'] = "on";
   $tab_def_campos['fac_valor_iva'] = "fac_valor_iva";
   $tab_labels["fac_valor_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_valor_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_valor_iva"] : "" . $this->Nm_lang['lang_iva'] . "";
   $tab_ger_campos['fac_propina'] = "on";
   $tab_def_campos['fac_propina'] = "fac_propina";
   $tab_labels["fac_propina"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_propina"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_propina"] : "" . $this->Nm_lang['lang_propina'] . "";
   $tab_ger_campos['fac_total'] = "on";
   $tab_def_campos['fac_total'] = "fac_total";
   $tab_labels["fac_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_total"] : "" . $this->Nm_lang['lang_othr_chrt_totl'] . "";
   $tab_ger_campos['fac_estado_sri'] = "on";
   $tab_def_campos['fac_estado_sri'] = "fac_estado_sri";
   $tab_labels["fac_estado_sri"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_estado_sri"])) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['labels']["fac_estado_sri"] : "" . $this->Nm_lang['lang_estado_sri'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_resumen_ventas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_resumen_ventas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
