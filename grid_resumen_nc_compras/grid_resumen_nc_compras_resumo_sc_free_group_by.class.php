...
class grid_resumen_nc_compras_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_resumen_nc_compras']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_resumen_nc_compras']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['tot_geral'][6];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['tot_geral'][7];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['tot_geral'][8];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['tot_geral'][9];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['tot_geral'][3];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['tot_geral'][10];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['tot_geral'][4];
      $this->array_total_geral[8] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['tot_geral'][11];
      $this->array_total_geral[9] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['tot_geral'][5];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['arr_total']['nc_fecha'] = $this->array_total_nc_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['arr_total']['nc_serie'] = $this->array_total_nc_serie;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['arr_total']['pr_identificacion'] = $this->array_total_pr_identificacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['arr_total']['pr_nombre'] = $this->array_total_pr_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['json_use_label'])
       {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_fecha'] = $Lab_nc_fecha; 
       $prep_field['nc_serie'] = $Lab_nc_serie;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_serie'] = $Lab_nc_serie; 
       $prep_field['pr_identificacion'] = $Lab_pr_identificacion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_identificacion'] = $Lab_pr_identificacion; 
       $prep_field['pr_nombre'] = $Lab_pr_nombre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_nombre'] = $Lab_pr_nombre; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_serie'] = "" . $this->Ini->Nm_lang['lang_serie_sri'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_secuencial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_secuencial'] = "" . $this->Ini->Nm_lang['lang_secuencial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_nombre'] = "" . $this->Ini->Nm_lang['lang_proveedor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_secuencial_docmod']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_secuencial_docmod'] = "" . $this->Ini->Nm_lang['lang_documento_sustento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_subtotal'] = "" . $this->Ini->Nm_lang['lang_subtotal'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_total_descuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_total_descuento'] = "" . $this->Ini->Nm_lang['lang_descuento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_valor_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_valor_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_total'] = "" . $this->Ini->Nm_lang['lang_total'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_numero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_numero'] = "" . $this->Ini->Nm_lang['lang_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_tipo_comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_tipo_comprobante'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_autorizacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_autorizacion'] = "" . $this->Ini->Nm_lang['lang_autorizacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_motivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_motivo'] = "" . $this->Ini->Nm_lang['lang_motivo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_cod_docmod']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_cod_docmod'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_id'] = "" . $this->Ini->Nm_lang['lang_proveedor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_tipo_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['pr_tipo_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_tipoid'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['fecha_docmod']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['fecha_docmod'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_subtotal_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_subtotal_iva'] = "" . $this->Ini->Nm_lang['lang_subtotal_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_subtotal_cero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_subtotal_cero'] = "" . $this->Ini->Nm_lang['lang_subtotal_cero'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_subtotal_no_objeto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_subtotal_no_objeto'] = "" . $this->Ini->Nm_lang['lang_subtotal_no_objeto'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_subtotal_excento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_subtotal_excento'] = "" . $this->Ini->Nm_lang['lang_subtotal_exento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_valor_ice']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_valor_ice'] = "" . $this->Ini->Nm_lang['lang_ice'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_valor_irbpnr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_valor_irbpnr'] = "" . $this->Ini->Nm_lang['lang_irbpnr'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_estado_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_estado_sri'] = "" . $this->Ini->Nm_lang['lang_estado_sri'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_usuario'] = "" . $this->Ini->Nm_lang['lang_usuario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['labels']['nc_estado'] = "" . $this->Ini->Nm_lang['lang_estado'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       $this->comp_sum = array(
           ...
           7 => "" .  $this->Ini->Nm_lang['lang_descuento'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           8 => "" .  $this->Ini->Nm_lang['lang_ice'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           9 => "" .  $this->Ini->Nm_lang['lang_iva'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           10 => "" .  $this->Ini->Nm_lang['lang_irbpnr'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           11 => "" .  $this->Ini->Nm_lang['lang_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "nc_subtotal", 'show' => true),
           3 => array('field' => "nc_subtotal_iva", 'show' => true),
           4 => array('field' => "nc_subtotal_cero", 'show' => true),
           5 => array('field' => "nc_subtotal_no_objeto", 'show' => true),
           6 => array('field' => "nc_subtotal_excento", 'show' => true),
           7 => array('field' => "nc_total_descuento", 'show' => true),
           8 => array('field' => "nc_valor_ice", 'show' => true),
           9 => array('field' => "nc_valor_iva", 'show' => true),
           10 => array('field' => "nc_valor_irbpnr", 'show' => true),
           11 => array('field' => "nc_total", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_nc_subtotal_sum",
           3 => "css_nc_subtotal_iva_sum",
           4 => "css_nc_subtotal_cero_sum",
           5 => "css_nc_subtotal_no_objeto_sum",
           6 => "css_nc_subtotal_excento_sum",
           7 => "css_nc_total_descuento_sum",
           8 => "css_nc_valor_ice_sum",
           9 => "css_nc_valor_iva_sum",
           10 => "css_nc_valor_irbpnr_sum",
           11 => "css_nc_total_sum",
       );
       ...
       $this->comp_sum_nm = array(
           2 => "nc_subtotal_sum",
           3 => "nc_subtotal_iva_sum",
           4 => "nc_subtotal_cero_sum",
           5 => "nc_subtotal_no_objeto_sum",
           6 => "nc_subtotal_excento_sum",
           7 => "nc_total_descuento_sum",
           8 => "nc_valor_ice_sum",
           9 => "nc_valor_iva_sum",
           10 => "nc_valor_irbpnr_sum",
           11 => "nc_total_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['nc_serie']['order_datatype'] = 'varchar';
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_resumen_nc_compras@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_resumen_nc_compras_total.class.php"); 
      }
      ...
      $this->Total   = new grid_resumen_nc_compras_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['ajax_nav']) {  
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_nc_compras_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_resumen_nc_compras_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_nc_compras_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_resumen_nc_compras/grid_resumen_nc_compras_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_nc_compras/grid_resumen_nc_compras_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_nc_compras/grid_resumen_nc_compras_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_resumen_nc_compras&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_nc_compras/grid_resumen_nc_compras_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_resumen_nc_compras/grid_resumen_nc_compras_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume&nm_all_modules=grid,resume&nm_json_format=N&nm_json_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_resumen_nc_compras/grid_resumen_nc_compras_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_resumen_nc_compras/grid_resumen_nc_compras_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_resumen_nc_compras/grid_resumen_nc_compras_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_resumen_nc_compras_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_resumen_nc_compras']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_resumen_nc_compras']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_resumen_nc_compras_config_pivot.php?nome_apl=grid_resumen_nc_compras&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_resumen_nc_compras_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_resumen_nc_compras_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_resumen_nc_compras/grid_resumen_nc_compras_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $nc_autorizacion = (isset($Busca_temp['nc_autorizacion'])) ? $Busca_temp['nc_autorizacion'] : ""; 
          $tmp_pos = (is_string($nc_autorizacion)) ? strpos($nc_autorizacion, "##@@") : false;
          if ($tmp_pos !== false && !is_array($nc_autorizacion))
          {
              $nc_autorizacion = substr($nc_autorizacion, 0, $tmp_pos);
          }
          $nc_secuencial_docmod = (isset($Busca_temp['nc_secuencial_docmod'])) ? $Busca_temp['nc_secuencial_docmod'] : ""; 
          $tmp_pos = (is_string($nc_secuencial_docmod)) ? strpos($nc_secuencial_docmod, "##@@") : false;
          if ($tmp_pos !== false && !is_array($nc_secuencial_docmod))
          {
   ...
   //---- 
   function adiciona_registro($sum_nc_subtotal, $sum_nc_total_descuento, $sum_nc_valor_iva, $sum_nc_total, $sum_nc_subtotal_iva, $sum_nc_subtotal_cero, $sum_nc_subtotal_no_objeto, $sum_nc_subtotal_excento, $sum_nc_valor_ice, $sum_nc_valor_irbpnr, $quebra_nc_fecha, $quebra_nc_serie, $quebra_pr_identificacion, $quebra_pr_nombre, $quebra_nc_fecha_orig, $quebra_nc_serie_orig, $quebra_pr_identificacion_orig, $quebra_pr_nombre_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_nc_compras']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_nc_subtotal)) {$sum_nc_subtotal = '0';}
          if (empty($sum_nc_total_descuento)) {$sum_nc_total_descuento = '0';}
          if (empty($sum_nc_valor_iva)) {$sum_nc_valor_iva = '0';}
          if (empty($sum_nc_total)) {$sum_nc_total = '0';}
          if (empty($sum_nc_subtotal_iva)) {$sum_nc_subtotal_iva = '0';}
          if (empty($sum_nc_subtotal_cero)) {$sum_nc_subtotal_cero = '0';}
          if (empty($sum_nc_subtotal_no_objeto)) {$sum_nc_subtotal_no_objeto = '0';}
          if (empty($sum_nc_subtotal_excento)) {$sum_nc_subtotal_excento = '0';}
          if (empty($sum_nc_valor_ice)) {$sum_nc_valor_ice = '0';}
          if (empty($sum_nc_valor_irbpnr)) {$sum_nc_valor_irbpnr = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_nc_subtotal . ';
              $this->' . $arr_name . '[2] = ' . $sum_nc_total_descuento . ';
              $this->' . $arr_name . '[3] = ' . $sum_nc_valor_iva . ';
              $this->' . $arr_name . '[4] = ' . $sum_nc_total . ';
              $this->' . $arr_name . '[5] = ' . $sum_nc_subtotal_iva . ';
              $this->' . $arr_name . '[6] = ' . $sum_nc_subtotal_cero . ';
              $this->' . $arr_name . '[7] = ' . $sum_nc_subtotal_no_objeto . ';
              $this->' . $arr_name . '[8] = ' . $sum_nc_subtotal_excento . ';
              $this->' . $arr_name . '[9] = ' . $sum_nc_valor_ice . ';
              $this->' . $arr_name . '[10] = ' . $sum_nc_valor_irbpnr . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_nc_subtotal . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_nc_total_descuento . ', 10);
              $this->' . $arr_name . '[3] = bcadd($this->' . $arr_name . '[3], ' . $sum_nc_valor_iva . ', 10);
              $this->' . $arr_name . '[4] = bcadd($this->' . $arr_name . '[4], ' . $sum_nc_total . ', 10);
              $this->' . $arr_name . '[5] = bcadd($this->' . $arr_name . '[5], ' . $sum_nc_subtotal_iva . ', 10);
              $this->' . $arr_name . '[6] = bcadd($this->' . $arr_name . '[6], ' . $sum_nc_subtotal_cero . ', 10);
              $this->' . $arr_name . '[7] = bcadd($this->' . $arr_name . '[7], ' . $sum_nc_subtotal_no_objeto . ', 10);
              $this->' . $arr_name . '[8] = bcadd($this->' . $arr_name . '[8], ' . $sum_nc_subtotal_excento . ', 10);
              $this->' . $arr_name . '[9] = bcadd($this->' . $arr_name . '[9], ' . $sum_nc_valor_ice . ', 10);
              $this->' . $arr_name . '[10] = bcadd($this->' . $arr_name . '[10], ' . $sum_nc_valor_irbpnr . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->nc_autorizacion = $Busca_temp['nc_autorizacion']; 
       $this->nc_autorizacion = (isset($Busca_temp['nc_autorizacion'])) ? $Busca_temp['nc_autorizacion'] : ""; 
       $tmp_pos = (is_string($this->nc_autorizacion)) ? strpos($this->nc_autorizacion, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->nc_autorizacion))
       {
       ...
       $this->nc_secuencial_docmod = $Busca_temp['nc_secuencial_docmod']; 
       $this->nc_secuencial_docmod = (isset($Busca_temp['nc_secuencial_docmod'])) ? $Busca_temp['nc_secuencial_docmod'] : ""; 
       $tmp_pos = (is_string($this->nc_secuencial_docmod)) ? strpos($this->nc_secuencial_docmod, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->nc_secuencial_docmod))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->nc_secuencial_docmod = $rs_res->fields[5] ;  
            $this->nc_subtotal = $rs_res->fields[6] ;  
            $this->nc_total_descuento = $rs_res->fields[7] ;  
            $this->nc_valor_iva = $rs_res->fields[8] ;  
            $this->nc_total = $rs_res->fields[9] ;  
            $this->nc_numero = $rs_res->fields[10] ;  
            $this->nc_tipo_comprobante = $rs_res->fields[11] ;  
            $this->nc_autorizacion = $rs_res->fields[12] ;  
            $this->pr_direccion = $rs_res->fields[13] ;  
            $this->pr_telefono = $rs_res->fields[14] ;  
            $this->pr_email = $rs_res->fields[15] ;  
            $this->nc_subtotal_iva = $rs_res->fields[16] ;  
            $this->nc_subtotal_cero = $rs_res->fields[17] ;  
            $this->nc_subtotal_no_objeto = $rs_res->fields[18] ;  
            $this->nc_subtotal_excento = $rs_res->fields[19] ;  
            $this->nc_valor_ice = $rs_res->fields[20] ;  
            $this->nc_valor_irbpnr = $rs_res->fields[21] ;  
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->nc_subtotal, $this->nc_total_descuento, $this->nc_valor_iva, $this->nc_total, $this->nc_subtotal_iva, $this->nc_subtotal_cero, $this->nc_subtotal_no_objeto, $this->nc_subtotal_excento, $this->nc_valor_ice, $this->nc_valor_irbpnr, $this->nc_fecha, $this->nc_serie, $this->pr_identificacion, $this->pr_nombre, $this->nc_fecha_orig,  $this->nc_serie_orig,  $this->pr_identificacion_orig,  $this->pr_nombre_orig);
            }
   }
//
