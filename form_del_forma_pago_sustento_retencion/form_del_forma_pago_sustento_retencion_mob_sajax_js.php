  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_forma_pago_sustento_retencion_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_forma_pago_sustento_retencion_mob_form();
	}
...
?>
  ...
  // ---------- Validate psr_id
  function do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_id()
  {
    var nomeCampo_psr_id = "psr_id";
    var var_psr_id = scAjaxGetFieldHidden(nomeCampo_psr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_id(var_psr_id, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_id_cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_id

  function do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_id_cb

  // ---------- Validate psr_sustento_retencion
  function do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_sustento_retencion()
  {
    var nomeCampo_psr_sustento_retencion = "psr_sustento_retencion";
    var var_psr_sustento_retencion = scAjaxGetFieldText(nomeCampo_psr_sustento_retencion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_sustento_retencion(var_psr_sustento_retencion, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_sustento_retencion_cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_sustento_retencion

  function do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_sustento_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "psr_sustento_retencion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_sustento_retencion_cb

  // ---------- Validate psr_forma_pago
  function do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_forma_pago()
  {
    var nomeCampo_psr_forma_pago = "psr_forma_pago";
    var var_psr_forma_pago = scAjaxGetFieldSelect(nomeCampo_psr_forma_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_forma_pago(var_psr_forma_pago, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_forma_pago_cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_forma_pago

  function do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_forma_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "psr_forma_pago";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_forma_pago_cb

  // ---------- Validate psr_valor_pago
  function do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_valor_pago()
  {
    var nomeCampo_psr_valor_pago = "psr_valor_pago";
    var var_psr_valor_pago = scAjaxGetFieldText(nomeCampo_psr_valor_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_valor_pago(var_psr_valor_pago, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_valor_pago_cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_valor_pago

  function do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_valor_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "psr_valor_pago";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_valor_pago_cb

  // ---------- Validate psr_estado
  function do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_estado()
  {
    var nomeCampo_psr_estado = "psr_estado";
    var var_psr_estado = scAjaxGetFieldSelect(nomeCampo_psr_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_estado(var_psr_estado, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_estado_cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_estado

  function do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "psr_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_validate_psr_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_forma_pago_sustento_retencion_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_forma_pago_sustento_retencion_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_psr_id = scAjaxGetFieldHidden("psr_id");
    var var_psr_sustento_retencion = scAjaxGetFieldText("psr_sustento_retencion");
    var var_psr_forma_pago = scAjaxGetFieldSelect("psr_forma_pago");
    var var_psr_valor_pago = scAjaxGetFieldText("psr_valor_pago");
    var var_psr_estado = scAjaxGetFieldSelect("psr_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_sustento_retencion_mob_submit_form(var_psr_id, var_psr_sustento_retencion, var_psr_forma_pago, var_psr_valor_pago, var_psr_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_forma_pago_sustento_retencion_mob_submit_form_cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_submit_form

  function do_ajax_form_del_forma_pago_sustento_retencion_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("psr_id");
      scAjaxHideErrorDisplay("psr_sustento_retencion");
      scAjaxHideErrorDisplay("psr_forma_pago");
      scAjaxHideErrorDisplay("psr_valor_pago");
      scAjaxHideErrorDisplay("psr_estado");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_forma_pago_sustento_retencion_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_submit_form_cb
  function do_ajax_form_del_forma_pago_sustento_retencion_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_forma_pago_sustento_retencion_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_del_forma_pago_sustento_retencion_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_del_forma_pago_sustento_retencion_mob_navigate_form();
    }
  }

  function perform_ajax_form_del_forma_pago_sustento_retencion_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("psr_valor_pago");
    scAjaxHideErrorDisplay("psr_estado");
    var var_psr_id = document.F2.psr_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_sustento_retencion_mob_navigate_form(var_psr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_mob_navigate_form_cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_forma_pago_sustento_retencion_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_forma_pago_sustento_retencion_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.psr_id.value = scAjaxGetKeyValue("psr_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_forma_pago_sustento_retencion_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_navigate_form_cb
  function do_ajax_form_del_forma_pago_sustento_retencion_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_forma_pago_sustento_retencion_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_forma_pago_sustento_retencion_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_forma_pago_sustento_retencion_mob_form()
  {
  ...
  ajax_field_list[0] = "psr_id";
  ajax_field_list[1] = "psr_sustento_retencion";
  ajax_field_list[2] = "psr_forma_pago";
  ajax_field_list[3] = "psr_valor_pago";
  ajax_field_list[4] = "psr_estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "psr_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "psr_sustento_retencion": {"label": "<?php echo $this->Ini->Nm_lang['lang_sustento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "psr_forma_pago": {"label": "<?php echo $this->Ini->Nm_lang['lang_forma_pago'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "psr_valor_pago": {"label": "<?php echo $this->Ini->Nm_lang['lang_valor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "psr_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "psr_id": new Array(),
    "psr_sustento_retencion": new Array(),
    "psr_forma_pago": new Array(),
    "psr_valor_pago": new Array(),
    "psr_estado": new Array()
  };
  ajax_field_mult["psr_id"][1] = "psr_id";
  ajax_field_mult["psr_sustento_retencion"][1] = "psr_sustento_retencion";
  ajax_field_mult["psr_forma_pago"][1] = "psr_forma_pago";
  ajax_field_mult["psr_valor_pago"][1] = "psr_valor_pago";
  ajax_field_mult["psr_estado"][1] = "psr_estado";

  var ajax_field_id = {
    "psr_forma_pago": new Array("hidden_field_label_psr_forma_pago", "hidden_field_data_psr_forma_pago"),
    "psr_valor_pago": new Array("hidden_field_label_psr_valor_pago", "hidden_field_data_psr_valor_pago"),
    "psr_estado": new Array("hidden_field_label_psr_estado", "hidden_field_data_psr_estado")
  };

  var ajax_read_only = {
    "psr_id": "on",
    "psr_sustento_retencion": "off",
    "psr_forma_pago": "off",
    "psr_valor_pago": "off",
    "psr_estado": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("psr_sustento_retencion" == sIndex)
    {
