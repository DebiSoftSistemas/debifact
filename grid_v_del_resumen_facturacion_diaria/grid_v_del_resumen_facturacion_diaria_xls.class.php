...
class grid_v_del_resumen_facturacion_diaria_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->SC_bot[] = "sc_field_0";
      $this->SC_top[] = "sc_field_0";
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_v_del_resumen_facturacion_diaria/grid_v_del_resumen_facturacion_diaria_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_v_del_resumen_facturacion_diaria_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_v_del_resumen_facturacion_diaria.zip";
          $this->Arquivo   .= "_grid_v_del_resumen_facturacion_diaria" . $this->Xls_tp;
          $this->Tit_doc    = "grid_v_del_resumen_facturacion_diaria" . $this->Xls_tp;
          $this->Tit_zip    = "grid_v_del_resumen_facturacion_diaria.zip";
      ...
      $this->Tot = new grid_v_del_resumen_facturacion_diaria_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Ind_Groupby'];
      $this->Tot->$Gb_geral();
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][1];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          $this->sum_df_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][2];
          $this->sum_df_descuento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][3];
          $this->sum_df_base_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][4];
          $this->sum_df_valor_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][5];
          $this->sum_df_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][6];
          $this->sum_df_valor_ice = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][7];
          $this->sum_df_valor_irbpnr = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][8];
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_resumen_facturacion_diaria']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_resumen_facturacion_diaria']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_resumen_facturacion_diaria']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['usr_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['php_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['where_pesq'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['where_resumo'])) 
      { 
          if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['where_pesq'])) 
          { 
              $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['where_resumo']; 
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['order_grid'];
      ...
      if (!$rs->EOF)
      {
         ...
         $this->fac_secuencial = $rs->fields[13] ;  
         $this->cl_identificacion = $rs->fields[14] ;  
         $this->cl_direccion = $rs->fields[15] ;  
         $this->cl_telefono = $rs->fields[16] ;  
         $this->cl_celular = $rs->fields[17] ;  
         $this->cl_email = $rs->fields[18] ;  
         $this->fac_comentario = $rs->fields[19] ;  
         $this->df_cantidad = $rs->fields[20] ;  
         $this->df_cantidad = (string)$this->df_cantidad;
         $this->df_precio_unitario = $rs->fields[21] ;  
         $this->df_precio_unitario = (string)$this->df_precio_unitario;
         $this->df_valor_ice = $rs->fields[22] ;  
         $this->df_valor_ice = (string)$this->df_valor_ice;
         $this->df_valor_irbpnr = $rs->fields[23] ;  
         $this->df_valor_irbpnr = (string)$this->df_valor_irbpnr;
         $this->mes = $rs->fields[24] ;  
         $this->anio = $rs->fields[25] ;  
         $this->fac_asiento = $rs->fields[26] ;  
         $this->fac_usuario = $rs->fields[27] ;  
   $_SESSION['scriptcase']['grid_v_del_resumen_facturacion_diaria']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_v_del_resumen_facturacion_diaria']['contr_erro'] = 'off';
      ...
      while (!$rs->EOF)
      {
         ...
         $this->fac_asiento = $rs->fields[26] ;  
         $this->fac_usuario = $rs->fields[27] ;  
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_orig']))
         {
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_orig'] as $Cmp_clone => $Cmp_orig)
             {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Ind_Groupby'] == "sc_free_group_by")
         {
             ...
             {
                 $Cmp_orig = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
         ...
         $this->arg_sum_mes = " = " . $this->Db->qstr($this->mes);
         $this->arg_sum_anio = " = " . $this->Db->qstr($this->anio);
         $this->arg_sum_fac_usuario = " = " . $this->Db->qstr($this->fac_usuario);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Ind_Groupby'] == "sc_free_group_by") 
          {  
              $SC_arg_Gby = array();
              $SC_arg_Sql = array();
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_orig'][$cmp] : $cmp;
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_cmp']);
              krsort ($SC_lst_Gby);
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
     ...
     $nm_houve_quebra = "N";
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida'])
      { 
      ...
      if ($this->groupby_show == "S") {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Ind_Groupby'] == "sc_free_group_by")
       {
          ...
          $this->Xls_col = 0;
          $this->Xls_row++;
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Ind_Groupby'] . "_bot";
          $this->$Gb_geral();
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida'])
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_df_subtotal()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->df_subtotal = NM_charset_to_utf8($this->df_subtotal);
         if (is_numeric($this->df_subtotal))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->df_subtotal);
         $this->Xls_col++;
   }
   //----- df_descuento
   function NM_export_df_descuento()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->df_descuento = NM_charset_to_utf8($this->df_descuento);
         if (is_numeric($this->df_descuento))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->df_descuento);
         $this->Xls_col++;
   }
   //----- df_base_iva
   function NM_export_df_base_iva()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->df_base_iva = NM_charset_to_utf8($this->df_base_iva);
         if (is_numeric($this->df_base_iva))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->df_base_iva);
         $this->Xls_col++;
   }
   //----- df_valor_iva
   function NM_export_df_valor_iva()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->df_valor_iva = NM_charset_to_utf8($this->df_valor_iva);
         if (is_numeric($this->df_valor_iva))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->df_valor_iva);
         $this->Xls_col++;
   }
   //----- df_total
   function NM_export_df_total()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->df_total = NM_charset_to_utf8($this->df_total);
         if (is_numeric($this->df_total))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->df_total);
         $this->Xls_col++;
   }
   //----- sc_field_0
   ...
   function NM_export_fac_numero()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fac_numero = NM_charset_to_utf8($this->fac_numero);
         if (is_numeric($this->fac_numero))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->fac_numero);
         $this->Xls_col++;
   }
   ...
   function NM_export_fac_empresa()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fac_empresa = html_entity_decode($this->fac_empresa, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fac_empresa = strip_tags($this->fac_empresa);
         $this->fac_empresa = NM_charset_to_utf8($this->fac_empresa);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fac_empresa, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fac_empresa, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fac_secuencial
   ...
   function NM_export_cl_celular()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->cl_celular = html_entity_decode($this->cl_celular, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->cl_celular = strip_tags($this->cl_celular);
         $this->cl_celular = NM_charset_to_utf8($this->cl_celular);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cl_celular, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cl_celular, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- cl_email
   ...
   function NM_export_df_cantidad()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->df_cantidad = NM_charset_to_utf8($this->df_cantidad);
         if (is_numeric($this->df_cantidad))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.000000';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->df_cantidad);
         $this->Xls_col++;
   }
   //----- df_precio_unitario
   function NM_export_df_precio_unitario()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->df_precio_unitario = NM_charset_to_utf8($this->df_precio_unitario);
         if (is_numeric($this->df_precio_unitario))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.000000';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->df_precio_unitario);
         $this->Xls_col++;
   }
   //----- df_valor_ice
   function NM_export_df_valor_ice()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->df_valor_ice = NM_charset_to_utf8($this->df_valor_ice);
         if (is_numeric($this->df_valor_ice))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->df_valor_ice);
         $this->Xls_col++;
   }
   //----- df_valor_irbpnr
   function NM_export_df_valor_irbpnr()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->df_valor_irbpnr = NM_charset_to_utf8($this->df_valor_irbpnr);
         if (is_numeric($this->df_valor_irbpnr))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->df_valor_irbpnr);
         $this->Xls_col++;
   }
   //----- mes
   function NM_export_mes()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->look_mes = html_entity_decode($this->look_mes, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_mes = strip_tags($this->look_mes);
   ...
   function NM_export_anio()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anio, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anio, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fac_asiento
   function NM_export_fac_asiento()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fac_asiento = html_entity_decode($this->fac_asiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fac_asiento = strip_tags($this->fac_asiento);
         $this->fac_asiento = NM_charset_to_utf8($this->fac_asiento);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fac_asiento, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fac_asiento, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fac_fecha
   ...
   //----- df_subtotal
   function NM_sub_cons_df_subtotal()
   {
         $this->df_subtotal = NM_charset_to_utf8($this->df_subtotal);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->df_subtotal;
   ...
   //----- df_descuento
   function NM_sub_cons_df_descuento()
   {
         $this->df_descuento = NM_charset_to_utf8($this->df_descuento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->df_descuento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- df_base_iva
   function NM_sub_cons_df_base_iva()
   {
         $this->df_base_iva = NM_charset_to_utf8($this->df_base_iva);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->df_base_iva;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- df_valor_iva
   function NM_sub_cons_df_valor_iva()
   {
         $this->df_valor_iva = NM_charset_to_utf8($this->df_valor_iva);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->df_valor_iva;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- df_total
   function NM_sub_cons_df_total()
   {
         $this->df_total = NM_charset_to_utf8($this->df_total);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->df_total;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- fac_numero
   function NM_sub_cons_fac_numero()
   {
         $this->fac_numero = NM_charset_to_utf8($this->fac_numero);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fac_numero;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   //----- fac_empresa
   function NM_sub_cons_fac_empresa()
   {
         $this->fac_empresa = html_entity_decode($this->fac_empresa, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fac_empresa = strip_tags($this->fac_empresa);
         $this->fac_empresa = NM_charset_to_utf8($this->fac_empresa);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fac_empresa;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- cl_celular
   function NM_sub_cons_cl_celular()
   {
         $this->cl_celular = html_entity_decode($this->cl_celular, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->cl_celular = strip_tags($this->cl_celular);
         $this->cl_celular = NM_charset_to_utf8($this->cl_celular);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cl_celular;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- df_cantidad
   function NM_sub_cons_df_cantidad()
   {
         $this->df_cantidad = NM_charset_to_utf8($this->df_cantidad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->df_cantidad;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   //----- df_precio_unitario
   function NM_sub_cons_df_precio_unitario()
   {
         $this->df_precio_unitario = NM_charset_to_utf8($this->df_precio_unitario);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->df_precio_unitario;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.000000";
         $this->Xls_col++;
   ...
   //----- df_valor_ice
   function NM_sub_cons_df_valor_ice()
   {
         $this->df_valor_ice = NM_charset_to_utf8($this->df_valor_ice);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->df_valor_ice;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- df_valor_irbpnr
   function NM_sub_cons_df_valor_irbpnr()
   {
         $this->df_valor_irbpnr = NM_charset_to_utf8($this->df_valor_irbpnr);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->df_valor_irbpnr;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- fac_asiento
   function NM_sub_cons_fac_asiento()
   {
         $this->fac_asiento = html_entity_decode($this->fac_asiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fac_asiento = strip_tags($this->fac_asiento);
         $this->fac_asiento = NM_charset_to_utf8($this->fac_asiento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fac_asiento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['nolabel'])
       {
 ...
 function quebra_anio_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_anio_df_subtotal = $tot_anio[2];
   $this->sum_anio_df_descuento = $tot_anio[3];
   $this->sum_anio_df_base_iva = $tot_anio[4];
   $this->sum_anio_df_valor_iva = $tot_anio[5];
   $this->sum_anio_df_total = $tot_anio[6];
   $this->sum_anio_df_valor_ice = $tot_anio[7];
   $this->sum_anio_df_valor_irbpnr = $tot_anio[8];
   ...
   {
       $Temp_cmp_quebra[0]['lab'] = "" . $this->Ini->Nm_lang['lang_srch_year'] . ""; 
   }
 ...
 function quebra_mes_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_mes_df_subtotal = $tot_mes[2];
   $this->sum_mes_df_descuento = $tot_mes[3];
   $this->sum_mes_df_base_iva = $tot_mes[4];
   $this->sum_mes_df_valor_iva = $tot_mes[5];
   $this->sum_mes_df_total = $tot_mes[6];
   $this->sum_mes_df_valor_ice = $tot_mes[7];
   $this->sum_mes_df_valor_irbpnr = $tot_mes[8];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function quebra_fac_fecha_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_fac_fecha_df_subtotal = $tot_fac_fecha[2];
   $this->sum_fac_fecha_df_descuento = $tot_fac_fecha[3];
   $this->sum_fac_fecha_df_base_iva = $tot_fac_fecha[4];
   $this->sum_fac_fecha_df_valor_iva = $tot_fac_fecha[5];
   $this->sum_fac_fecha_df_total = $tot_fac_fecha[6];
   $this->sum_fac_fecha_df_valor_ice = $tot_fac_fecha[7];
   $this->sum_fac_fecha_df_valor_irbpnr = $tot_fac_fecha[8];
   $Temp_cmp_quebra = array(); 
   ...
   else
   {
       ...
       $Temp_cmp_quebra[0]['lab'] = sprintf("" . $this->Ini->Nm_lang['lang_fecha'] . "", $Tmp_lab); 
   }
   $this->$Cmps_Gb_Free = $Temp_cmp_quebra;
   $this->sc_proc_quebra_fac_fecha = false; 
 } 
 function quebra_fac_tipo_comprobante_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_fac_tipo_comprobante_df_subtotal = $tot_fac_tipo_comprobante[2];
   $this->sum_fac_tipo_comprobante_df_descuento = $tot_fac_tipo_comprobante[3];
   $this->sum_fac_tipo_comprobante_df_base_iva = $tot_fac_tipo_comprobante[4];
   $this->sum_fac_tipo_comprobante_df_valor_iva = $tot_fac_tipo_comprobante[5];
   $this->sum_fac_tipo_comprobante_df_total = $tot_fac_tipo_comprobante[6];
   $this->sum_fac_tipo_comprobante_df_valor_ice = $tot_fac_tipo_comprobante[7];
   $this->sum_fac_tipo_comprobante_df_valor_irbpnr = $tot_fac_tipo_comprobante[8];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function quebra_fac_serie_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_fac_serie_df_subtotal = $tot_fac_serie[2];
   $this->sum_fac_serie_df_descuento = $tot_fac_serie[3];
   $this->sum_fac_serie_df_base_iva = $tot_fac_serie[4];
   $this->sum_fac_serie_df_valor_iva = $tot_fac_serie[5];
   $this->sum_fac_serie_df_total = $tot_fac_serie[6];
   $this->sum_fac_serie_df_valor_ice = $tot_fac_serie[7];
   $this->sum_fac_serie_df_valor_irbpnr = $tot_fac_serie[8];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function quebra_sc_field_0_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $this->Tot->quebra_sc_field_0_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name);
   $tot_sc_field_0 = $$Var_name_gb;
   $conteudo = $tot_sc_field_0[0] ;  
   $this->count_sc_field_0 = $tot_sc_field_0[1];
   $this->sum_sc_field_0_df_subtotal = $tot_sc_field_0[2];
   $this->sum_sc_field_0_df_descuento = $tot_sc_field_0[3];
   $this->sum_sc_field_0_df_base_iva = $tot_sc_field_0[4];
   $this->sum_sc_field_0_df_valor_iva = $tot_sc_field_0[5];
   $this->sum_sc_field_0_df_total = $tot_sc_field_0[6];
   $this->sum_sc_field_0_df_valor_ice = $tot_sc_field_0[7];
   $this->sum_sc_field_0_df_valor_irbpnr = $tot_sc_field_0[8];
   $Temp_cmp_quebra = array(); 
   $conteudo = NM_encode_input(sc_strip_script($this->sc_field_0)); 
   $Temp_cmp_quebra[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['sc_field_0']))
   {
       $Temp_cmp_quebra[0]['lab'] = $this->nmgp_label_quebras['sc_field_0']; 
   }
   else
   {
 ...
 function quebra_pro_descripcion_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_pro_descripcion_df_subtotal = $tot_pro_descripcion[2];
   $this->sum_pro_descripcion_df_descuento = $tot_pro_descripcion[3];
   $this->sum_pro_descripcion_df_base_iva = $tot_pro_descripcion[4];
   $this->sum_pro_descripcion_df_valor_iva = $tot_pro_descripcion[5];
   $this->sum_pro_descripcion_df_total = $tot_pro_descripcion[6];
   $this->sum_pro_descripcion_df_valor_ice = $tot_pro_descripcion[7];
   $this->sum_pro_descripcion_df_valor_irbpnr = $tot_pro_descripcion[8];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function quebra_fac_usuario_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_fac_usuario_df_subtotal = $tot_fac_usuario[2];
   $this->sum_fac_usuario_df_descuento = $tot_fac_usuario[3];
   $this->sum_fac_usuario_df_base_iva = $tot_fac_usuario[4];
   $this->sum_fac_usuario_df_valor_iva = $tot_fac_usuario[5];
   $this->sum_fac_usuario_df_total = $tot_fac_usuario[6];
   $this->sum_fac_usuario_df_valor_ice = $tot_fac_usuario[7];
   $this->sum_fac_usuario_df_valor_irbpnr = $tot_fac_usuario[8];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
   ...
   function quebra_anio_sc_free_group_by_bot()
   {
       ...
       $this->xls_set_style();
       $prim_cmp = true;
       $NM_cmp_tot['df_subtotal']['S'] = "sum_";
       $NM_cmp_tot['df_descuento']['S'] = "sum_";
       $NM_cmp_tot['df_base_iva']['S'] = "sum_";
       $NM_cmp_tot['df_valor_iva']['S'] = "sum_";
       $NM_cmp_tot['df_total']['S'] = "sum_";
       $NM_cmp_tot['df_valor_ice']['S'] = "sum_";
       $NM_cmp_tot['df_valor_irbpnr']['S'] = "sum_";
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['df_subtotal'][$Tipo_Sum]) && $Cada_cmp == "df_subtotal" && (!isset($this->NM_cmp_hidden['df_subtotal']) || $this->NM_cmp_hidden['df_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_subtotal'][$Tipo_Sum] . "anio_df_subtotal";
           ...
           elseif (isset($NM_cmp_tot['df_descuento'][$Tipo_Sum]) && $Cada_cmp == "df_descuento" && (!isset($this->NM_cmp_hidden['df_descuento']) || $this->NM_cmp_hidden['df_descuento'] != "off"))
           {
               if ($Tipo_Sum == "C" || $Tipo_Sum == "D") {
                   $Format_Num = "#,##0";
               }
               ...
               $Prep_Tot = $NM_cmp_tot['df_descuento'][$Tipo_Sum] . "anio_df_descuento";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_base_iva'][$Tipo_Sum]) && $Cada_cmp == "df_base_iva" && (!isset($this->NM_cmp_hidden['df_base_iva']) || $this->NM_cmp_hidden['df_base_iva'] != "off"))
           {
               if ($Tipo_Sum == "C" || $Tipo_Sum == "D") {
                   $Format_Num = "#,##0";
               }
               ...
               $Prep_Tot = $NM_cmp_tot['df_base_iva'][$Tipo_Sum] . "anio_df_base_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "df_valor_iva" && (!isset($this->NM_cmp_hidden['df_valor_iva']) || $this->NM_cmp_hidden['df_valor_iva'] != "off"))
           {
               if ($Tipo_Sum == "C" || $Tipo_Sum == "D") {
                   $Format_Num = "#,##0";
               }
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_iva'][$Tipo_Sum] . "anio_df_valor_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_total'][$Tipo_Sum]) && $Cada_cmp == "df_total" && (!isset($this->NM_cmp_hidden['df_total']) || $this->NM_cmp_hidden['df_total'] != "off"))
           {
               if ($Tipo_Sum == "C" || $Tipo_Sum == "D") {
                   $Format_Num = "#,##0";
               }
               ...
               $Prep_Tot = $NM_cmp_tot['df_total'][$Tipo_Sum] . "anio_df_total";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_ice'][$Tipo_Sum]) && $Cada_cmp == "df_valor_ice" && (!isset($this->NM_cmp_hidden['df_valor_ice']) || $this->NM_cmp_hidden['df_valor_ice'] != "off"))
           {
               if ($Tipo_Sum == "C" || $Tipo_Sum == "D") {
                   $Format_Num = "#,##0";
               }
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_ice'][$Tipo_Sum] . "anio_df_valor_ice";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]) && $Cada_cmp == "df_valor_irbpnr" && (!isset($this->NM_cmp_hidden['df_valor_irbpnr']) || $this->NM_cmp_hidden['df_valor_irbpnr'] != "off"))
           {
               if ($Tipo_Sum == "C" || $Tipo_Sum == "D") {
                   $Format_Num = "#,##0";
               }
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum] . "anio_df_valor_irbpnr";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_mes_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_mes as $cada_campo) {
           if ($cont_col == $lim_col) {
               $temp_cmp = html_entity_decode($temp_cmp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
               $temp_cmp = strip_tags($temp_cmp);
               $temp_cmp = NM_charset_to_utf8($temp_cmp);
   ...
   function quebra_mes_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['df_subtotal'][$Tipo_Sum]) && $Cada_cmp == "df_subtotal" && (!isset($this->NM_cmp_hidden['df_subtotal']) || $this->NM_cmp_hidden['df_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_subtotal'][$Tipo_Sum] . "mes_df_subtotal";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_descuento'][$Tipo_Sum]) && $Cada_cmp == "df_descuento" && (!isset($this->NM_cmp_hidden['df_descuento']) || $this->NM_cmp_hidden['df_descuento'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_descuento'][$Tipo_Sum] . "mes_df_descuento";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_base_iva'][$Tipo_Sum]) && $Cada_cmp == "df_base_iva" && (!isset($this->NM_cmp_hidden['df_base_iva']) || $this->NM_cmp_hidden['df_base_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_base_iva'][$Tipo_Sum] . "mes_df_base_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "df_valor_iva" && (!isset($this->NM_cmp_hidden['df_valor_iva']) || $this->NM_cmp_hidden['df_valor_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_iva'][$Tipo_Sum] . "mes_df_valor_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_total'][$Tipo_Sum]) && $Cada_cmp == "df_total" && (!isset($this->NM_cmp_hidden['df_total']) || $this->NM_cmp_hidden['df_total'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_total'][$Tipo_Sum] . "mes_df_total";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_ice'][$Tipo_Sum]) && $Cada_cmp == "df_valor_ice" && (!isset($this->NM_cmp_hidden['df_valor_ice']) || $this->NM_cmp_hidden['df_valor_ice'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_ice'][$Tipo_Sum] . "mes_df_valor_ice";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]) && $Cada_cmp == "df_valor_irbpnr" && (!isset($this->NM_cmp_hidden['df_valor_irbpnr']) || $this->NM_cmp_hidden['df_valor_irbpnr'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum] . "mes_df_valor_irbpnr";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['df_subtotal'][$Tipo_Sum]) && $Cada_cmp == "df_subtotal" && (!isset($this->NM_cmp_hidden['df_subtotal']) || $this->NM_cmp_hidden['df_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_subtotal'][$Tipo_Sum] . "fac_fecha_df_subtotal";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_descuento'][$Tipo_Sum]) && $Cada_cmp == "df_descuento" && (!isset($this->NM_cmp_hidden['df_descuento']) || $this->NM_cmp_hidden['df_descuento'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_descuento'][$Tipo_Sum] . "fac_fecha_df_descuento";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_base_iva'][$Tipo_Sum]) && $Cada_cmp == "df_base_iva" && (!isset($this->NM_cmp_hidden['df_base_iva']) || $this->NM_cmp_hidden['df_base_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_base_iva'][$Tipo_Sum] . "fac_fecha_df_base_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "df_valor_iva" && (!isset($this->NM_cmp_hidden['df_valor_iva']) || $this->NM_cmp_hidden['df_valor_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_iva'][$Tipo_Sum] . "fac_fecha_df_valor_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_total'][$Tipo_Sum]) && $Cada_cmp == "df_total" && (!isset($this->NM_cmp_hidden['df_total']) || $this->NM_cmp_hidden['df_total'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_total'][$Tipo_Sum] . "fac_fecha_df_total";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_ice'][$Tipo_Sum]) && $Cada_cmp == "df_valor_ice" && (!isset($this->NM_cmp_hidden['df_valor_ice']) || $this->NM_cmp_hidden['df_valor_ice'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_ice'][$Tipo_Sum] . "fac_fecha_df_valor_ice";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]) && $Cada_cmp == "df_valor_irbpnr" && (!isset($this->NM_cmp_hidden['df_valor_irbpnr']) || $this->NM_cmp_hidden['df_valor_irbpnr'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum] . "fac_fecha_df_valor_irbpnr";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['df_subtotal'][$Tipo_Sum]) && $Cada_cmp == "df_subtotal" && (!isset($this->NM_cmp_hidden['df_subtotal']) || $this->NM_cmp_hidden['df_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_subtotal'][$Tipo_Sum] . "fac_tipo_comprobante_df_subtotal";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_descuento'][$Tipo_Sum]) && $Cada_cmp == "df_descuento" && (!isset($this->NM_cmp_hidden['df_descuento']) || $this->NM_cmp_hidden['df_descuento'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_descuento'][$Tipo_Sum] . "fac_tipo_comprobante_df_descuento";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_base_iva'][$Tipo_Sum]) && $Cada_cmp == "df_base_iva" && (!isset($this->NM_cmp_hidden['df_base_iva']) || $this->NM_cmp_hidden['df_base_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_base_iva'][$Tipo_Sum] . "fac_tipo_comprobante_df_base_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "df_valor_iva" && (!isset($this->NM_cmp_hidden['df_valor_iva']) || $this->NM_cmp_hidden['df_valor_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_iva'][$Tipo_Sum] . "fac_tipo_comprobante_df_valor_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_total'][$Tipo_Sum]) && $Cada_cmp == "df_total" && (!isset($this->NM_cmp_hidden['df_total']) || $this->NM_cmp_hidden['df_total'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_total'][$Tipo_Sum] . "fac_tipo_comprobante_df_total";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_ice'][$Tipo_Sum]) && $Cada_cmp == "df_valor_ice" && (!isset($this->NM_cmp_hidden['df_valor_ice']) || $this->NM_cmp_hidden['df_valor_ice'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_ice'][$Tipo_Sum] . "fac_tipo_comprobante_df_valor_ice";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]) && $Cada_cmp == "df_valor_irbpnr" && (!isset($this->NM_cmp_hidden['df_valor_irbpnr']) || $this->NM_cmp_hidden['df_valor_irbpnr'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum] . "fac_tipo_comprobante_df_valor_irbpnr";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['df_subtotal'][$Tipo_Sum]) && $Cada_cmp == "df_subtotal" && (!isset($this->NM_cmp_hidden['df_subtotal']) || $this->NM_cmp_hidden['df_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_subtotal'][$Tipo_Sum] . "fac_serie_df_subtotal";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_descuento'][$Tipo_Sum]) && $Cada_cmp == "df_descuento" && (!isset($this->NM_cmp_hidden['df_descuento']) || $this->NM_cmp_hidden['df_descuento'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_descuento'][$Tipo_Sum] . "fac_serie_df_descuento";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_base_iva'][$Tipo_Sum]) && $Cada_cmp == "df_base_iva" && (!isset($this->NM_cmp_hidden['df_base_iva']) || $this->NM_cmp_hidden['df_base_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_base_iva'][$Tipo_Sum] . "fac_serie_df_base_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "df_valor_iva" && (!isset($this->NM_cmp_hidden['df_valor_iva']) || $this->NM_cmp_hidden['df_valor_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_iva'][$Tipo_Sum] . "fac_serie_df_valor_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_total'][$Tipo_Sum]) && $Cada_cmp == "df_total" && (!isset($this->NM_cmp_hidden['df_total']) || $this->NM_cmp_hidden['df_total'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_total'][$Tipo_Sum] . "fac_serie_df_total";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_ice'][$Tipo_Sum]) && $Cada_cmp == "df_valor_ice" && (!isset($this->NM_cmp_hidden['df_valor_ice']) || $this->NM_cmp_hidden['df_valor_ice'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_ice'][$Tipo_Sum] . "fac_serie_df_valor_ice";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]) && $Cada_cmp == "df_valor_irbpnr" && (!isset($this->NM_cmp_hidden['df_valor_irbpnr']) || $this->NM_cmp_hidden['df_valor_irbpnr'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum] . "fac_serie_df_valor_irbpnr";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
   ...
   function quebra_sc_field_0_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_sc_field_0_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['df_subtotal'][$Tipo_Sum]) && $Cada_cmp == "df_subtotal" && (!isset($this->NM_cmp_hidden['df_subtotal']) || $this->NM_cmp_hidden['df_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_subtotal'][$Tipo_Sum] . "sc_field_0_df_subtotal";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_descuento'][$Tipo_Sum]) && $Cada_cmp == "df_descuento" && (!isset($this->NM_cmp_hidden['df_descuento']) || $this->NM_cmp_hidden['df_descuento'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_descuento'][$Tipo_Sum] . "sc_field_0_df_descuento";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_base_iva'][$Tipo_Sum]) && $Cada_cmp == "df_base_iva" && (!isset($this->NM_cmp_hidden['df_base_iva']) || $this->NM_cmp_hidden['df_base_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_base_iva'][$Tipo_Sum] . "sc_field_0_df_base_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "df_valor_iva" && (!isset($this->NM_cmp_hidden['df_valor_iva']) || $this->NM_cmp_hidden['df_valor_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_iva'][$Tipo_Sum] . "sc_field_0_df_valor_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_total'][$Tipo_Sum]) && $Cada_cmp == "df_total" && (!isset($this->NM_cmp_hidden['df_total']) || $this->NM_cmp_hidden['df_total'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_total'][$Tipo_Sum] . "sc_field_0_df_total";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_ice'][$Tipo_Sum]) && $Cada_cmp == "df_valor_ice" && (!isset($this->NM_cmp_hidden['df_valor_ice']) || $this->NM_cmp_hidden['df_valor_ice'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_ice'][$Tipo_Sum] . "sc_field_0_df_valor_ice";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]) && $Cada_cmp == "df_valor_irbpnr" && (!isset($this->NM_cmp_hidden['df_valor_irbpnr']) || $this->NM_cmp_hidden['df_valor_irbpnr'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum] . "sc_field_0_df_valor_irbpnr";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['df_subtotal'][$Tipo_Sum]) && $Cada_cmp == "df_subtotal" && (!isset($this->NM_cmp_hidden['df_subtotal']) || $this->NM_cmp_hidden['df_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_subtotal'][$Tipo_Sum] . "pro_descripcion_df_subtotal";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_descuento'][$Tipo_Sum]) && $Cada_cmp == "df_descuento" && (!isset($this->NM_cmp_hidden['df_descuento']) || $this->NM_cmp_hidden['df_descuento'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_descuento'][$Tipo_Sum] . "pro_descripcion_df_descuento";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_base_iva'][$Tipo_Sum]) && $Cada_cmp == "df_base_iva" && (!isset($this->NM_cmp_hidden['df_base_iva']) || $this->NM_cmp_hidden['df_base_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_base_iva'][$Tipo_Sum] . "pro_descripcion_df_base_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "df_valor_iva" && (!isset($this->NM_cmp_hidden['df_valor_iva']) || $this->NM_cmp_hidden['df_valor_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_iva'][$Tipo_Sum] . "pro_descripcion_df_valor_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_total'][$Tipo_Sum]) && $Cada_cmp == "df_total" && (!isset($this->NM_cmp_hidden['df_total']) || $this->NM_cmp_hidden['df_total'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_total'][$Tipo_Sum] . "pro_descripcion_df_total";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_ice'][$Tipo_Sum]) && $Cada_cmp == "df_valor_ice" && (!isset($this->NM_cmp_hidden['df_valor_ice']) || $this->NM_cmp_hidden['df_valor_ice'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_ice'][$Tipo_Sum] . "pro_descripcion_df_valor_ice";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]) && $Cada_cmp == "df_valor_irbpnr" && (!isset($this->NM_cmp_hidden['df_valor_irbpnr']) || $this->NM_cmp_hidden['df_valor_irbpnr'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum] . "pro_descripcion_df_valor_irbpnr";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['df_subtotal'][$Tipo_Sum]) && $Cada_cmp == "df_subtotal" && (!isset($this->NM_cmp_hidden['df_subtotal']) || $this->NM_cmp_hidden['df_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_subtotal'][$Tipo_Sum] . "fac_usuario_df_subtotal";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_descuento'][$Tipo_Sum]) && $Cada_cmp == "df_descuento" && (!isset($this->NM_cmp_hidden['df_descuento']) || $this->NM_cmp_hidden['df_descuento'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_descuento'][$Tipo_Sum] . "fac_usuario_df_descuento";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_base_iva'][$Tipo_Sum]) && $Cada_cmp == "df_base_iva" && (!isset($this->NM_cmp_hidden['df_base_iva']) || $this->NM_cmp_hidden['df_base_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_base_iva'][$Tipo_Sum] . "fac_usuario_df_base_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "df_valor_iva" && (!isset($this->NM_cmp_hidden['df_valor_iva']) || $this->NM_cmp_hidden['df_valor_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_iva'][$Tipo_Sum] . "fac_usuario_df_valor_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_total'][$Tipo_Sum]) && $Cada_cmp == "df_total" && (!isset($this->NM_cmp_hidden['df_total']) || $this->NM_cmp_hidden['df_total'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_total'][$Tipo_Sum] . "fac_usuario_df_total";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_ice'][$Tipo_Sum]) && $Cada_cmp == "df_valor_ice" && (!isset($this->NM_cmp_hidden['df_valor_ice']) || $this->NM_cmp_hidden['df_valor_ice'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_ice'][$Tipo_Sum] . "fac_usuario_df_valor_ice";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]) && $Cada_cmp == "df_valor_irbpnr" && (!isset($this->NM_cmp_hidden['df_valor_irbpnr']) || $this->NM_cmp_hidden['df_valor_irbpnr'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum] . "fac_usuario_df_valor_irbpnr";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $prim_cmp = true;
       $NM_cmp_tot['df_subtotal']['S'] = 2;
       $NM_cmp_tot['df_descuento']['S'] = 3;
       $NM_cmp_tot['df_base_iva']['S'] = 4;
       $NM_cmp_tot['df_valor_iva']['S'] = 5;
       $NM_cmp_tot['df_total']['S'] = 6;
       $NM_cmp_tot['df_valor_ice']['S'] = 7;
       $NM_cmp_tot['df_valor_irbpnr']['S'] = 8;
       $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
       $mens_tot_base = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][1] . ")";
       $prim_lin_tot  = true;
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       $mens_tot      = $mens_tot_base . " - " . $Tit_sum;
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['df_subtotal'][$Tipo_Sum]) && $Cada_cmp == "df_subtotal" && (!isset($this->NM_cmp_hidden['df_subtotal']) || $this->NM_cmp_hidden['df_subtotal'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][$NM_cmp_tot['df_subtotal'][$Tipo_Sum]];
               $prim_cmp = false;
           ...
           elseif (isset($NM_cmp_tot['df_descuento'][$Tipo_Sum]) && $Cada_cmp == "df_descuento" && (!isset($this->NM_cmp_hidden['df_descuento']) || $this->NM_cmp_hidden['df_descuento'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][$NM_cmp_tot['df_descuento'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['df_base_iva'][$Tipo_Sum]) && $Cada_cmp == "df_base_iva" && (!isset($this->NM_cmp_hidden['df_base_iva']) || $this->NM_cmp_hidden['df_base_iva'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][$NM_cmp_tot['df_base_iva'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['df_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "df_valor_iva" && (!isset($this->NM_cmp_hidden['df_valor_iva']) || $this->NM_cmp_hidden['df_valor_iva'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][$NM_cmp_tot['df_valor_iva'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['df_total'][$Tipo_Sum]) && $Cada_cmp == "df_total" && (!isset($this->NM_cmp_hidden['df_total']) || $this->NM_cmp_hidden['df_total'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][$NM_cmp_tot['df_total'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['df_valor_ice'][$Tipo_Sum]) && $Cada_cmp == "df_valor_ice" && (!isset($this->NM_cmp_hidden['df_valor_ice']) || $this->NM_cmp_hidden['df_valor_ice'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][$NM_cmp_tot['df_valor_ice'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]) && $Cada_cmp == "df_valor_irbpnr" && (!isset($this->NM_cmp_hidden['df_valor_irbpnr']) || $this->NM_cmp_hidden['df_valor_irbpnr'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][$NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_detalle_ventas'] ?> :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
