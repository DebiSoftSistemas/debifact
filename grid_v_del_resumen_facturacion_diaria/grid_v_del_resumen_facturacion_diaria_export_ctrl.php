<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_del_resumen_facturacion_diaria']['sc_process_barr'] = true;
require_once('../grid_v_del_resumen_facturacion_diaria/index.php');
unset($_SESSION['scriptcase']['grid_v_del_resumen_facturacion_diaria']['sc_process_barr']);
$ExportCtrl = new grid_v_del_resumen_facturacion_diaria_export_control;
$ExportCtrl->Export_barr();

class grid_v_del_resumen_facturacion_diaria_export_control
{
