<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_v_del_resumen_facturacion_diaria']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"))
       {
?>
...
<?php
   ...
   $Sel_Groupby = new grid_v_del_resumen_facturacion_diaria_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_v_del_resumen_facturacion_diaria_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   if ($this->restore) {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['all']['SC_Ind_Groupby'];
   }
   else {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Ind_Groupby'];
   }
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['Page_break_PDF']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_order_start']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_tabular']);
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['anio'] = array('cmp' => "anio", 'ind' => 0, 'format' => "");
           $tab_arr_groubby_cmp['mes'] = array('cmp' => "mes", 'ind' => 1, 'format' => "");
           $tab_arr_groubby_cmp['fac_fecha'] = array('cmp' => "fac_fecha", 'ind' => 2, 'format' => "YYYYMMDD2");
           $tab_arr_groubby_cmp['fac_tipo_comprobante'] = array('cmp' => "fac_tipo_comprobante", 'ind' => 3, 'format' => "");
           $tab_arr_groubby_cmp['fac_serie'] = array('cmp' => "fac_serie", 'ind' => 4, 'format' => "");
           $tab_arr_groubby_cmp['sc_field_0'] = array('cmp' => "fac_secuencial|| ' - ' || fac_comentario", 'ind' => 5, 'format' => "");
           $tab_arr_groubby_cmp['pro_descripcion'] = array('cmp' => "pro_descripcion", 'ind' => 6, 'format' => "");
           $tab_arr_groubby_cmp['fac_usuario'] = array('cmp' => "fac_usuario", 'ind' => 7, 'format' => "");
           $tab_arr_groubby_sql[0] = array('cmp' => "anio", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "mes", 'ord' => 'asc');
           $tab_arr_groubby_sql[2] = array('cmp' => "fac_fecha", 'ord' => 'asc');
           $tab_arr_groubby_sql[3] = array('cmp' => "fac_tipo_comprobante", 'ord' => 'asc');
           $tab_arr_groubby_sql[4] = array('cmp' => "fac_serie", 'ord' => 'asc');
           $tab_arr_groubby_sql[5] = array('cmp' => "fac_secuencial|| ' - ' || fac_comentario", 'ord' => 'asc');
           $tab_arr_groubby_sql[6] = array('cmp' => "pro_descripcion", 'ord' => 'asc');
           $tab_arr_groubby_sql[7] = array('cmp' => "fac_usuario", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_cmp']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_sql']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_date_format']['sc_free_group_by'] = array();
           $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_orig'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_sql'][$cada_cmp][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
                   $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_date_format']['sc_free_group_by'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['format'];
               }
           }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo" && !empty($this->summ_fields))
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       if(isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display'][ $sel_groupby ]))
       {
           foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display'][ $sel_groupby ] as $i_sum => $d_sum)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display'][ $sel_groupby ][$i_sum]['display'] = in_array($i_sum, $summ_fields);
           }
       }
       $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_order'][ $sel_groupby ] = $summ_fields;
       $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_drill_down'] = $this->drill_down;
   }
?>
    <script language="javascript"> 
<?php
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['anio'] = "" . $this->Nm_lang['lang_srch_year'] . "";
   $arr_campos_free['mes'] = "" . $this->Nm_lang['lang_srch_mnth'] . "";
   $arr_campos_free['fac_fecha'] = "" . sprintf("" . $this->Nm_lang['lang_fecha'] . "", "" . $this->Nm_lang['lang_fecha'] . "") . "";
   $arr_campos_free['fac_tipo_comprobante'] = "" . $this->Nm_lang['lang_tipo_comprobante'] . "";
   $arr_campos_free['fac_serie'] = "" . $this->Nm_lang['lang_serie_sri'] . "";
   $arr_campos_free['sc_field_0'] = "" . $this->Nm_lang['lang_secuencial'] . "";
   $arr_campos_free['pro_descripcion'] = "" . $this->Nm_lang['lang_producto'] . "";
   $arr_campos_free['fac_usuario'] = "" . $this->Nm_lang['lang_usuario'] . "";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_detalle_ventas'] ?></TITLE>
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_v_del_resumen_facturacion_diaria_sel_groupby.php",
    data: {
...
<?php
if ($this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['res']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['res']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
elseif (!$this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
        if(is_array($_arr_fields))
        {
            foreach ($_arr_fields as $_key_total => $d_field)
...
{
  $max_height = 1;
  if ($this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['res']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['res']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
  ...
  elseif (!$this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
      if (count($_i_sum) > $max_height)
      {
          $max_height = count($_i_sum);
...
<?php
if ($bSummaryPage && $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Ind_Groupby'] == "sc_free_group_by") {
?>
   if (fieldList == "") {
...
?>
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Groupby_hide']))
     {
...
<?php
        ...
        $arr_tmp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Gb_Free_cmp'];
...
<?php
        ...
        {
            if ($this->restore) {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['res']['pivot_x_axys']);
            }
            else {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_x_axys']);
            }
        }
...
<?php
        if ($bSummaryPage)
        {
            ...
            {
                $arr_pivot_x_axys = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['res']['pivot_x_axys'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['pivot_x_axys'];
...
<?php
   ...
   if ($bSummaryPage)
   {
       ...
       if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_control'])) {
           $arr_filds = array();
       }
       else {
           $arr_filds = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['res']['summarizing_fields_control'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_control'];
       }
    if (isset($arr_filds))
    {
?>
...
<?php
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display'])) {
              $arr_disp = array();
          }
          else {
                 $arr_disp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['res']['summarizing_fields_display'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display'];
          }
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_order'])) {
              $arr_ord = array();
          }
          else {
              $arr_ord  = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['res']['summarizing_fields_order']   : $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_order'];
          }
...
<script type="text/javascript">
   ...
   if ($this->restore) {
       $oJson = new Services_JSON();
        ob_end_clean();
        if ($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['all']['SC_Ind_Groupby'] == "sc_free_group_by") {
           $this->Arr_result['run_js'][] = "scShowFree()";
        } else {
           $this->Arr_result['set_var'][] = array('var' => 'actual_static_gb', 'value' => $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb']['all']['SC_Ind_Groupby']);
...
<?php
   $disp_rest = "none";
   foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['dados_orig_gb'] as $tp => $fields) {
       foreach ($fields as $name => $data) {
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria'][$name])) {
               if ($tp == "all" && ($name != "SC_Gb_Free_cmp" || $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['SC_Ind_Groupby'] == "sc_free_group_by")) {
                   if ($data != $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria'][$name]) {
                       $disp_rest = "";
                       break;
                   }
               }
               elseif ($tp == "res" && $bSummaryPage && $data != $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria'][$name]) {
                   $disp_rest = "";
                   break;
               }
           }
