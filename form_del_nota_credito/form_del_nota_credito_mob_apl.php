<?php
//
class form_del_nota_credito_mob_apl
{
   ...
   var $nc_libretin;
   var $nc_libretin_1;
   var $nc_tipo_libretin;
   var $nc_establecimiento;
   var $nc_punto_emision;
   var $nc_secuencial;
   var $nc_ambiente;
   var $nc_fecha;
   var $nc_iddocmod;
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['nc_ambiente']))
          {
              $this->nc_ambiente = $this->NM_ajax_info['param']['nc_ambiente'];
          }
          if (isset($this->NM_ajax_info['param']['nc_cliente']))
          {
              $this->nc_cliente = $this->NM_ajax_info['param']['nc_cliente'];
          }
          if (isset($this->NM_ajax_info['param']['nc_cod_docmod']))
          {
              $this->nc_cod_docmod = $this->NM_ajax_info['param']['nc_cod_docmod'];
          }
          if (isset($this->NM_ajax_info['param']['nc_error_sri']))
          {
              $this->nc_error_sri = $this->NM_ajax_info['param']['nc_error_sri'];
          }
          if (isset($this->NM_ajax_info['param']['nc_establecimiento']))
          {
              $this->nc_establecimiento = $this->NM_ajax_info['param']['nc_establecimiento'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['nc_libretin']))
          {
              $this->nc_libretin = $this->NM_ajax_info['param']['nc_libretin'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['nc_punto_emision']))
          {
              $this->nc_punto_emision = $this->NM_ajax_info['param']['nc_punto_emision'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['nc_tipo_libretin']))
          {
              $this->nc_tipo_libretin = $this->NM_ajax_info['param']['nc_tipo_libretin'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_del_nota_credito_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['form_del_detalle_nota_credito_mob_script_case_init'] ]['form_del_detalle_nota_credito_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['form_del_detalle_nota_credito_mob_script_case_init'] ]['form_del_detalle_nota_credito_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['form_del_forma_pago_nota_credito_mob_script_case_init'] ]['form_del_forma_pago_nota_credito_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['form_del_forma_pago_nota_credito_mob_script_case_init'] ]['form_del_forma_pago_nota_credito_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->var_id_nota_credito)) 
          {
              $_SESSION['var_id_nota_credito'] = $this->var_id_nota_credito;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_del_nota_credito_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_nota_credito_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_nota_credito_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_nota_credito_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_nota_credito_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_del_nota_credito_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_nota_credito_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " del_nota_credito";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_del_nota_credito_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->arr_buttons['contabilizar']['hint']             = "";
      $this->arr_buttons['contabilizar']['type']             = "button";
      $this->arr_buttons['contabilizar']['value']            = "" . $this->Ini->Nm_lang['lang_contabilizar'] . "";
      $this->arr_buttons['contabilizar']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['contabilizar']['display_position'] = "text_right";
      $this->arr_buttons['contabilizar']['style']            = "default";
      $this->arr_buttons['contabilizar']['image']            = "";
      $this->arr_buttons['contabilizar']['has_fa']            = "true";
      $this->arr_buttons['contabilizar']['fontawesomeicon']            = "fas fa-calculator";


      $_SESSION['scriptcase']['error_icon']['form_del_nota_credito_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_del_nota_credito_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['goto']      = 'on';
          }
      }
      ...
      $this->nmgp_botoes['contabilizar'] = "on";
      if (isset($this->NM_btn_cancel) && 'N' == $this->NM_btn_cancel)
      {
          $this->nmgp_botoes['cancel'] = "off";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_orig'] = " where (nc_numero=" . $_SESSION['var_id_nota_credito'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_pesq'] = " where (nc_numero=" . $_SESSION['var_id_nota_credito'] . ")";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_credito_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_nota_credito_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_nota_credito_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_form'];
          ...
          if (!isset($this->nc_autorizacion)){$this->nc_autorizacion = $this->nmgp_dados_form['nc_autorizacion'];} 
          if (!isset($this->nc_clave)){$this->nc_clave = $this->nmgp_dados_form['nc_clave'];} 
          if (!isset($this->nc_usuario)){$this->nc_usuario = $this->nmgp_dados_form['nc_usuario'];} 
          if (!isset($this->nc_correo_enviado)){$this->nc_correo_enviado = $this->nmgp_dados_form['nc_correo_enviado'];} 
          if (!isset($this->nc_archivo)){$this->nc_archivo = $this->nmgp_dados_form['nc_archivo'];} 
          if (!isset($this->nc_asiento)){$this->nc_asiento = $this->nmgp_dados_form['nc_asiento'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_del_nota_credito_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      { 
          include_once($this->Ini->path_embutida . 'form_del_nota_credito/Igtech.DebiConta.Clases.php');
      }
      else
      { 
      ...
      if ($this->Embutida_proc)
      { 
          include_once($this->Ini->path_embutida . 'form_del_nota_credito/Igtech.Log.php');
      }
      else
      { 
      ...
      if ($this->Embutida_proc)
      { 
          include_once($this->Ini->path_embutida . 'form_del_nota_credito/igtech.PocesarDocumentosElectronicos.php');
      }
      else
      { 
      ...
      if (isset($_GET['nm_cal_display']))
      {
          if ($this->Embutida_proc)
          { 
              include_once($this->Ini->path_embutida . 'form_del_nota_credito/form_del_nota_credito_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_del_nota_credito_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_del_nota_credito_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_del_nota_credito_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_del_nota_credito/form_del_nota_credito_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_del_nota_credito_mob_erro.class.php"); 
      }
      $this->Erro      = new form_del_nota_credito_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opcao']))
         { 
             if ($this->nc_numero != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_credito_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "novo")  
      {
          ...
          $this->nmgp_botoes['contabilizar'] = "off";
      }
      elseif ($this->nmgp_opcao == "incluir")  
      {
          $this->nmgp_botoes['enviar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['botoes']['enviar'];
          $this->nmgp_botoes['Nuevo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['botoes']['Nuevo'];
          $this->nmgp_botoes['ride'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['botoes']['ride'];
          $this->nmgp_botoes['Anular'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['botoes']['Anular'];
          $this->nmgp_botoes['contabilizar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['botoes']['contabilizar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_detalle_nota_credito_mob_script_case_init'] ]['form_del_detalle_nota_credito_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_detalle_nota_credito_mob_script_case_init'] ]['form_del_detalle_nota_credito_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_detalle_nota_credito_mob_script_case_init'] ]['form_del_detalle_nota_credito_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_detalle_nota_credito_mob_script_case_init'] ]['form_del_detalle_nota_credito']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_detalle_nota_credito_mob_script_case_init'] ]['form_del_detalle_nota_credito']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_detalle_nota_credito_mob_script_case_init'] ]['form_del_detalle_nota_credito']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_detalle_nota_credito_mob_script_case_init'] ]['form_del_detalle_nota_credito_mob']['total']);
          $detailAppName = 'form_del_detalle_nota_credito_mob';
          $detailAppObject = "form_del_detalle_nota_credito_mob";
          ...
          $this->form_del_detalle_nota_credito_mob = new $detailAppObject;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_forma_pago_nota_credito_mob_script_case_init'] ]['form_del_forma_pago_nota_credito_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_forma_pago_nota_credito_mob_script_case_init'] ]['form_del_forma_pago_nota_credito_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_forma_pago_nota_credito_mob_script_case_init'] ]['form_del_forma_pago_nota_credito_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_forma_pago_nota_credito_mob_script_case_init'] ]['form_del_forma_pago_nota_credito']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_forma_pago_nota_credito_mob_script_case_init'] ]['form_del_forma_pago_nota_credito']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_forma_pago_nota_credito_mob_script_case_init'] ]['form_del_forma_pago_nota_credito']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_forma_pago_nota_credito_mob_script_case_init'] ]['form_del_forma_pago_nota_credito_mob']['total']);
          $detailAppName = 'form_del_forma_pago_nota_credito_mob';
          $detailAppObject = "form_del_forma_pago_nota_credito_mob";
          $detailAppFolder = $this->Ini->root . $this->Ini->path_link  . SC_dir_app_name($detailAppName);
          if (!@is_dir($detailAppFolder)) {
              $detailAppName = substr($detailAppName, 0, -4);
              $detailAppObject = substr($detailAppObject, 0, -4);
          ...
          require_once($detailAppFolder . "/index.php");
          require_once($detailAppFolder . "/{$detailAppName}_apl.php");
          $this->form_del_forma_pago_nota_credito_mob = new $detailAppObject;
      }
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_del_nota_credito_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_del_nota_credito_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      if (isset($this->nc_libretin)) { $this->nm_limpa_alfa($this->nc_libretin); }
      if (isset($this->nc_tipo_libretin)) { $this->nm_limpa_alfa($this->nc_tipo_libretin); }
      if (isset($this->nc_establecimiento)) { $this->nm_limpa_alfa($this->nc_establecimiento); }
      if (isset($this->nc_punto_emision)) { $this->nm_limpa_alfa($this->nc_punto_emision); }
      if (isset($this->nc_secuencial)) { $this->nm_limpa_alfa($this->nc_secuencial); }
      if (isset($this->nc_ambiente)) { $this->nm_limpa_alfa($this->nc_ambiente); }
      if (isset($this->nc_iddocmod)) { $this->nm_limpa_alfa($this->nc_iddocmod); }
      if (isset($this->nc_cliente)) { $this->nm_limpa_alfa($this->nc_cliente); }
      ...
      if (isset($this->nc_error_sri)) { $this->nm_limpa_alfa($this->nc_error_sri); }
      ...
      { 
          ...
          if ($nm_call_php == "contabilizar")
          { 
              $this->sc_btn_contabilizar();
          } 
          $this->NM_close_db(); 
          exit;
      } 
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- nc_establecimiento
      $this->field_config['nc_establecimiento']               = array();
      $this->field_config['nc_establecimiento']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['nc_establecimiento']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['nc_establecimiento']['symbol_dec'] = '';
      $this->field_config['nc_establecimiento']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['nc_establecimiento']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- nc_punto_emision
      $this->field_config['nc_punto_emision']               = array();
      $this->field_config['nc_punto_emision']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['nc_punto_emision']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['nc_punto_emision']['symbol_dec'] = '';
      $this->field_config['nc_punto_emision']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['nc_punto_emision']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- nc_secuencial
      $this->field_config['nc_secuencial']               = array();
      $this->field_config['nc_secuencial']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['nc_secuencial']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['nc_secuencial']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- nc_ambiente
      $this->field_config['nc_ambiente']               = array();
      $this->field_config['nc_ambiente']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['nc_ambiente']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['nc_ambiente']['symbol_dec'] = '';
      $this->field_config['nc_ambiente']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['nc_ambiente']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- nc_iddocmod
      ...
      //-- nc_cliente
      $this->field_config['nc_cliente']               = array();
      $this->field_config['nc_cliente']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['nc_cliente']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['nc_cliente']['symbol_dec'] = '';
      $this->field_config['nc_cliente']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['nc_cliente']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['Gera_log_access'] = false;
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_nc_error_sri' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nc_error_sri');
          }
          if ('validate_nc_fecha' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nc_fecha');
          }
          if ('validate_nc_libretin' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nc_libretin');
          }
          ...
          if ('validate_nc_tipo_libretin' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nc_tipo_libretin');
          }
          if ('validate_nc_establecimiento' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nc_establecimiento');
          }
          if ('validate_nc_punto_emision' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nc_punto_emision');
          }
          if ('validate_nc_secuencial' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nc_secuencial');
          }
          if ('validate_nc_ambiente' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nc_ambiente');
          }
          ...
          if ('validate_nc_cliente' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nc_cliente');
          }
          ...
          form_del_nota_credito_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_nc_libretin_onblur' == $this->NM_ajax_opcao)
          {
              $this->nc_libretin_onBlur();
          }
          if ('event_nc_libretin_onchange' == $this->NM_ajax_opcao)
          {
              $this->nc_libretin_onChange();
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['secuencial']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->secuencial = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['secuencial'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['tipo_libretin']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tipo_libretin = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['tipo_libretin'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['ambiente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->ambiente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['ambiente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['tipo_doc_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tipo_doc_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['tipo_doc_sustento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['serie_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->serie_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['serie_sustento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['secuencial_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->secuencial_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['secuencial_sustento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['fecha_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fecha_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['fecha_sustento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['fac_ruc_cliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_ruc_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['fac_ruc_cliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['fac_nombre_cliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_nombre_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['fac_nombre_cliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['fac_direccion_cliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_direccion_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['fac_direccion_cliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['fac_email_cliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_email_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['fac_email_cliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_subtotal']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nc_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_subtotal'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_subtotal_iva']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nc_subtotal_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_subtotal_iva'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_subtotal_cero']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nc_subtotal_cero = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_subtotal_cero'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_subtotal_no_objeto']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nc_subtotal_no_objeto = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_subtotal_no_objeto'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_subtotal_excento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nc_subtotal_excento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_subtotal_excento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_total_descuento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nc_total_descuento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_total_descuento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_valor_ice']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nc_valor_ice = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_valor_ice'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_valor_iva']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nc_valor_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_valor_iva'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_valor_irbpnr']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nc_valor_irbpnr = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_valor_irbpnr'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_total']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nc_total = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']['nc_total'];
          } 
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_del_nota_credito_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_del_nota_credito_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_del_nota_credito_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_del_nota_credito_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_del_nota_credito_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_nota_credito_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_del_nota_credito_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_nota_credito_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->nc_numero) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_form']['nc_numero']))
          {
              $varloc_btn_php['nc_numero'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_form']['nc_numero'];
          }
          if (!isset($this->nc_empresa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_form']['nc_empresa']))
          {
              $varloc_btn_php['nc_empresa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_form']['nc_empresa'];
          }
      }
      $nm_f_saida = "form_del_nota_credito_mob.php";
      nm_limpa_data($this->nc_fecha, $this->field_config['nc_fecha']['date_sep']) ; 
      nm_limpa_numero($this->nc_establecimiento, $this->field_config['nc_establecimiento']['symbol_grp']) ; 
      nm_limpa_numero($this->nc_punto_emision, $this->field_config['nc_punto_emision']['symbol_grp']) ; 
      nm_limpa_numero($this->nc_secuencial, $this->field_config['nc_secuencial']['symbol_grp']) ; 
      nm_limpa_numero($this->nc_ambiente, $this->field_config['nc_ambiente']['symbol_grp']) ; 
      ...
      nm_limpa_numero($this->nc_cliente, $this->field_config['nc_cliente']['symbol_grp']) ; 
      ...
      $_SESSION['scriptcase']['form_del_nota_credito_mob']['contr_erro'] = 'on';
  $w_respuesta=$this->enviaNotaCredito($this->nc_numero ,$this->nc_empresa );
$_SESSION['scriptcase']['form_del_nota_credito_mob']['contr_erro'] = 'off'; 
    echo ob_get_clean();
?>
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'ambiente':
               ...
               break;
           case 'nc_tipo_libretin':
               return "" . $this->Ini->Nm_lang['lang_tipo_libretin'] . "";
               break;
           case 'nc_establecimiento':
               return "" . $this->Ini->Nm_lang['lang_establecimiento'] . "";
               break;
           case 'nc_punto_emision':
           ...
           case 'fecha_sustento':
               ...
               break;
           case 'nc_cliente':
               return "" . $this->Ini->Nm_lang['lang_clientes'] . "";
               break;
           case 'nc_cod_docmod':
               return "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . "";
               break;
           ...
           case 'nc_usuario':
               return "Nc Usuario";
               break;
           case 'nc_correo_enviado':
               return "Nc Correo Enviado";
               break;
           case 'nc_archivo':
               return "Nc Archivo";
               break;
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_del_nota_credito_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_del_nota_credito_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_del_nota_credito_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_del_nota_credito_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'nc_error_sri' == $filtro)) || (is_array($filtro) && in_array('nc_error_sri', $filtro)))
        $this->ValidateField_nc_error_sri($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'nc_libretin' == $filtro)) || (is_array($filtro) && in_array('nc_libretin', $filtro)))
        $this->ValidateField_nc_libretin($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'nc_tipo_libretin' == $filtro)) || (is_array($filtro) && in_array('nc_tipo_libretin', $filtro)))
        $this->ValidateField_nc_tipo_libretin($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'nc_establecimiento' == $filtro)) || (is_array($filtro) && in_array('nc_establecimiento', $filtro)))
        $this->ValidateField_nc_establecimiento($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'nc_punto_emision' == $filtro)) || (is_array($filtro) && in_array('nc_punto_emision', $filtro)))
        $this->ValidateField_nc_punto_emision($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'nc_ambiente' == $filtro)) || (is_array($filtro) && in_array('nc_ambiente', $filtro)))
        $this->ValidateField_nc_ambiente($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'nc_cliente' == $filtro)) || (is_array($filtro) && in_array('nc_cliente', $filtro)))
        $this->ValidateField_nc_cliente($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
//---
    ...
    function ValidateField_nc_error_sri(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['nc_error_sri'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->nc_error_sri) > 300) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_mensaje'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['nc_error_sri']))
              {
                  $Campos_Erros['nc_error_sri'] = array();
              }
              $Campos_Erros['nc_error_sri'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['nc_error_sri']) || !is_array($this->NM_ajax_info['errList']['nc_error_sri']))
              {
                  $this->NM_ajax_info['errList']['nc_error_sri'] = array();
              }
              $this->NM_ajax_info['errList']['nc_error_sri'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'nc_error_sri';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_nc_error_sri
    ...
    function ValidateField_nc_libretin(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['nc_libretin'])) {
       return;
   }
               if (!empty($this->nc_libretin) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['Lookup_nc_libretin']) && !in_array($this->nc_libretin, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['Lookup_nc_libretin']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['nc_libretin']))
                   {
                       $Campos_Erros['nc_libretin'] = array();
                   }
                   $Campos_Erros['nc_libretin'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['nc_libretin']) || !is_array($this->NM_ajax_info['errList']['nc_libretin']))
                   {
                       $this->NM_ajax_info['errList']['nc_libretin'] = array();
                   }
                   $this->NM_ajax_info['errList']['nc_libretin'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'nc_libretin';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_nc_libretin
    ...
    function ValidateField_secuencial(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->secuencial) > 10) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_secuencial'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 10 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['secuencial']))
              {
                  $Campos_Erros['secuencial'] = array();
              }
              $Campos_Erros['secuencial'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 10 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['secuencial'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 10 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_nc_tipo_libretin(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['nc_tipo_libretin'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->nc_tipo_libretin) > 1) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_tipo_libretin'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 1 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['nc_tipo_libretin']))
              {
                  $Campos_Erros['nc_tipo_libretin'] = array();
              }
              $Campos_Erros['nc_tipo_libretin'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 1 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['nc_tipo_libretin']) || !is_array($this->NM_ajax_info['errList']['nc_tipo_libretin']))
              {
                  $this->NM_ajax_info['errList']['nc_tipo_libretin'] = array();
              }
              $this->NM_ajax_info['errList']['nc_tipo_libretin'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 1 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'nc_tipo_libretin';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_nc_tipo_libretin

    function ValidateField_nc_establecimiento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['nc_establecimiento'])) {
          nm_limpa_numero($this->nc_establecimiento, $this->field_config['nc_establecimiento']['symbol_grp']) ; 
          return;
      }
      if ($this->nc_establecimiento === "" || is_null($this->nc_establecimiento))  
      { 
          $this->nc_establecimiento = 0;
          $this->sc_force_zero[] = 'nc_establecimiento';
      } 
      nm_limpa_numero($this->nc_establecimiento, $this->field_config['nc_establecimiento']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->nc_establecimiento != '')  
          { 
              $iTestSize = 9;
              if (strlen($this->nc_establecimiento) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_establecimiento'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['nc_establecimiento']))
                  {
                      $Campos_Erros['nc_establecimiento'] = array();
                  }
                  $Campos_Erros['nc_establecimiento'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['nc_establecimiento']) || !is_array($this->NM_ajax_info['errList']['nc_establecimiento']))
                  {
                      $this->NM_ajax_info['errList']['nc_establecimiento'] = array();
                  }
                  $this->NM_ajax_info['errList']['nc_establecimiento'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->nc_establecimiento, 9, 0, -0, 999999999, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['nc_establecimiento'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['nc_establecimiento']) || !is_array($this->NM_ajax_info['errList']['nc_establecimiento']))
                  {
                      $this->NM_ajax_info['errList']['nc_establecimiento'] = array();
                  }
                  $this->NM_ajax_info['errList']['nc_establecimiento'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'nc_establecimiento';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_nc_establecimiento

    function ValidateField_nc_punto_emision(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['nc_punto_emision'])) {
          nm_limpa_numero($this->nc_punto_emision, $this->field_config['nc_punto_emision']['symbol_grp']) ; 
          return;
      }
      if ($this->nc_punto_emision === "" || is_null($this->nc_punto_emision))  
      { 
          $this->nc_punto_emision = 0;
          $this->sc_force_zero[] = 'nc_punto_emision';
      } 
      nm_limpa_numero($this->nc_punto_emision, $this->field_config['nc_punto_emision']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->nc_punto_emision != '')  
          { 
              $iTestSize = 9;
              if (strlen($this->nc_punto_emision) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_punto_emision'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['nc_punto_emision']))
                  {
                      $Campos_Erros['nc_punto_emision'] = array();
                  }
                  $Campos_Erros['nc_punto_emision'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['nc_punto_emision']) || !is_array($this->NM_ajax_info['errList']['nc_punto_emision']))
                  {
                      $this->NM_ajax_info['errList']['nc_punto_emision'] = array();
                  }
                  $this->NM_ajax_info['errList']['nc_punto_emision'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->nc_punto_emision, 9, 0, -0, 999999999, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['nc_punto_emision'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['nc_punto_emision']) || !is_array($this->NM_ajax_info['errList']['nc_punto_emision']))
                  {
                      $this->NM_ajax_info['errList']['nc_punto_emision'] = array();
                  }
                  $this->NM_ajax_info['errList']['nc_punto_emision'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'nc_punto_emision';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_nc_punto_emision
    ...
    function ValidateField_nc_ambiente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['nc_ambiente'])) {
          nm_limpa_numero($this->nc_ambiente, $this->field_config['nc_ambiente']['symbol_grp']) ; 
          return;
      }
      if ($this->nc_ambiente === "" || is_null($this->nc_ambiente))  
      { 
          $this->nc_ambiente = 0;
          $this->sc_force_zero[] = 'nc_ambiente';
      } 
      nm_limpa_numero($this->nc_ambiente, $this->field_config['nc_ambiente']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 9;
              if (strlen($this->nc_ambiente) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_tipo_ambiente'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['nc_ambiente']))
                  {
                      $Campos_Erros['nc_ambiente'] = array();
                  }
                  $Campos_Erros['nc_ambiente'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['nc_ambiente']) || !is_array($this->NM_ajax_info['errList']['nc_ambiente']))
                  {
                      $this->NM_ajax_info['errList']['nc_ambiente'] = array();
                  }
                  $this->NM_ajax_info['errList']['nc_ambiente'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->nc_ambiente, 9, 0, -0, 999999999, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['nc_ambiente'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['nc_ambiente']) || !is_array($this->NM_ajax_info['errList']['nc_ambiente']))
                  {
                      $this->NM_ajax_info['errList']['nc_ambiente'] = array();
                  }
                  $this->NM_ajax_info['errList']['nc_ambiente'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'nc_ambiente';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_nc_ambiente
    ...
    function ValidateField_tipo_doc_sustento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->tipo_doc_sustento) > 50) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 50 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['tipo_doc_sustento']))
              {
                  $Campos_Erros['tipo_doc_sustento'] = array();
              }
              $Campos_Erros['tipo_doc_sustento'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 50 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['tipo_doc_sustento'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 50 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_nc_cliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['nc_cliente'])) {
          nm_limpa_numero($this->nc_cliente, $this->field_config['nc_cliente']['symbol_grp']) ; 
          return;
      }
      if ($this->nc_cliente === "" || is_null($this->nc_cliente))  
      { 
          $this->nc_cliente = 0;
          $this->sc_force_zero[] = 'nc_cliente';
      } 
      nm_limpa_numero($this->nc_cliente, $this->field_config['nc_cliente']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 9;
              if (strlen($this->nc_cliente) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_clientes'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['nc_cliente']))
                  {
                      $Campos_Erros['nc_cliente'] = array();
                  }
                  $Campos_Erros['nc_cliente'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['nc_cliente']) || !is_array($this->NM_ajax_info['errList']['nc_cliente']))
                  {
                      $this->NM_ajax_info['errList']['nc_cliente'] = array();
                  }
                  $this->NM_ajax_info['errList']['nc_cliente'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->nc_cliente, 9, 0, -0, 999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_clientes'] . "; " ; 
                  if (!isset($Campos_Erros['nc_cliente']))
                  {
                      $Campos_Erros['nc_cliente'] = array();
                  }
                  $Campos_Erros['nc_cliente'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['nc_cliente']) || !is_array($this->NM_ajax_info['errList']['nc_cliente']))
                  {
                      $this->NM_ajax_info['errList']['nc_cliente'] = array();
                  }
                  $this->NM_ajax_info['errList']['nc_cliente'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'nc_cliente';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_nc_cliente
    ...
    function ValidateField_nc_motivo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['php_cmp_required']['nc_motivo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['php_cmp_required']['nc_motivo'] == "on")) 
      { 
          if ($this->nc_motivo == "")  
          { 
              $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['nc_tipo_libretin'] = $this->nc_tipo_libretin;
    $this->nmgp_dados_form['nc_establecimiento'] = $this->nc_establecimiento;
    $this->nmgp_dados_form['nc_punto_emision'] = $this->nc_punto_emision;
    $this->nmgp_dados_form['nc_secuencial'] = $this->nc_secuencial;
    $this->nmgp_dados_form['nc_ambiente'] = $this->nc_ambiente;
    ...
    $this->nmgp_dados_form['nc_cliente'] = $this->nc_cliente;
    ...
    $this->nmgp_dados_form['nc_clave'] = $this->nc_clave;
    $this->nmgp_dados_form['nc_usuario'] = $this->nc_usuario;
    $this->nmgp_dados_form['nc_correo_enviado'] = $this->nc_correo_enviado;
    $this->nmgp_dados_form['nc_archivo'] = $this->nc_archivo;
    $this->nmgp_dados_form['nc_asiento'] = $this->nc_asiento;
    $this->nmgp_dados_form['establecimiento'] = $this->establecimiento;
    $this->nmgp_dados_form['punto_emision'] = $this->punto_emision;
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_data($this->nc_fecha, $this->field_config['nc_fecha']['date_sep']) ; 
      $this->Before_unformat['nc_establecimiento'] = $this->nc_establecimiento;
      nm_limpa_numero($this->nc_establecimiento, $this->field_config['nc_establecimiento']['symbol_grp']) ; 
      $this->Before_unformat['nc_punto_emision'] = $this->nc_punto_emision;
      nm_limpa_numero($this->nc_punto_emision, $this->field_config['nc_punto_emision']['symbol_grp']) ; 
      $this->Before_unformat['nc_secuencial'] = $this->nc_secuencial;
      nm_limpa_numero($this->nc_secuencial, $this->field_config['nc_secuencial']['symbol_grp']) ; 
      $this->Before_unformat['nc_ambiente'] = $this->nc_ambiente;
      nm_limpa_numero($this->nc_ambiente, $this->field_config['nc_ambiente']['symbol_grp']) ; 
      $this->Before_unformat['nc_iddocmod'] = $this->nc_iddocmod;
      nm_limpa_numero($this->nc_iddocmod, $this->field_config['nc_iddocmod']['symbol_grp']) ; 
      $this->Before_unformat['fecha_sustento'] = $this->fecha_sustento;
      nm_limpa_data($this->fecha_sustento, $this->field_config['fecha_sustento']['date_sep']) ; 
      $this->Before_unformat['nc_cliente'] = $this->nc_cliente;
      nm_limpa_numero($this->nc_cliente, $this->field_config['nc_cliente']['symbol_grp']) ; 
   ...
   {
      if ($Nome_Campo == "nc_establecimiento")
      {
          nm_limpa_numero($this->nc_establecimiento, $this->field_config['nc_establecimiento']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "nc_punto_emision")
      {
          nm_limpa_numero($this->nc_punto_emision, $this->field_config['nc_punto_emision']['symbol_grp']) ; 
      }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if ('' !== $this->nc_establecimiento || (!empty($format_fields) && isset($format_fields['nc_establecimiento'])))
      {
          nmgp_Form_Num_Val($this->nc_establecimiento, $this->field_config['nc_establecimiento']['symbol_grp'], $this->field_config['nc_establecimiento']['symbol_dec'], "0", "S", $this->field_config['nc_establecimiento']['format_neg'], "", "", "-", $this->field_config['nc_establecimiento']['symbol_fmt']) ; 
      }
      if ('' !== $this->nc_punto_emision || (!empty($format_fields) && isset($format_fields['nc_punto_emision'])))
      {
          nmgp_Form_Num_Val($this->nc_punto_emision, $this->field_config['nc_punto_emision']['symbol_grp'], $this->field_config['nc_punto_emision']['symbol_dec'], "0", "S", $this->field_config['nc_punto_emision']['format_neg'], "", "", "-", $this->field_config['nc_punto_emision']['symbol_fmt']) ; 
      }
      ...
      if ('' !== $this->nc_ambiente || (!empty($format_fields) && isset($format_fields['nc_ambiente'])))
      {
          nmgp_Form_Num_Val($this->nc_ambiente, $this->field_config['nc_ambiente']['symbol_grp'], $this->field_config['nc_ambiente']['symbol_dec'], "0", "S", $this->field_config['nc_ambiente']['format_neg'], "", "", "-", $this->field_config['nc_ambiente']['symbol_fmt']) ; 
      }
      ...
      if ('' !== $this->nc_cliente || (!empty($format_fields) && isset($format_fields['nc_cliente'])))
      {
          nmgp_Form_Num_Val($this->nc_cliente, $this->field_config['nc_cliente']['symbol_grp'], $this->field_config['nc_cliente']['symbol_dec'], "0", "S", $this->field_config['nc_cliente']['format_neg'], "", "", "-", $this->field_config['nc_cliente']['symbol_fmt']) ; 
      }
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_nc_error_sri();
          $this->ajax_return_values_nc_fecha();
          $this->ajax_return_values_nc_libretin();
          $this->ajax_return_values_secuencial();
          $this->ajax_return_values_tipo_libretin();
          $this->ajax_return_values_ambiente();
          $this->ajax_return_values_nc_tipo_libretin();
          $this->ajax_return_values_nc_establecimiento();
          $this->ajax_return_values_nc_punto_emision();
          $this->ajax_return_values_nc_secuencial();
          $this->ajax_return_values_nc_ambiente();
          ...
          $this->ajax_return_values_nc_cliente();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['nc_numero']['keyVal'] = form_del_nota_credito_mob_pack_protect_string($this->nmgp_dados_form['nc_numero']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['total'] < 0)
              {
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_detalle_nota_credito_mob_script_case_init'] ]['form_del_detalle_nota_credito_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_detalle_nota_credito_mob_script_case_init'] ]['form_del_detalle_nota_credito_mob']['total']);
              }
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_forma_pago_nota_credito_mob_script_case_init'] ]['form_del_forma_pago_nota_credito_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['form_del_forma_pago_nota_credito_mob_script_case_init'] ]['form_del_forma_pago_nota_credito_mob']['total']);
              }
          }
   ...
   function ajax_return_values_titulo($bForce = false)
   {
          ...
          //----- nc_error_sri
   function ajax_return_values_nc_error_sri($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nc_error_sri", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->nc_error_sri);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['nc_error_sri'] = array(
                       'row'    => '',
               'type'    => 'text',
   ...
   function ajax_return_values_nc_fecha($bForce = false)
   {
          ...
          //----- nc_libretin
   function ajax_return_values_nc_libretin($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nc_libretin", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->nc_libretin);
              $aLookup = array();
              $this->_tmp_lookup_nc_libretin = $this->nc_libretin;
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_del_nota_credito_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_del_nota_credito_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"nc_libretin\"";
          if (isset($this->NM_ajax_info['select_html']['nc_libretin']) && !empty($this->NM_ajax_info['select_html']['nc_libretin']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['nc_libretin']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->nc_libretin == $sValue)
                  {
                      $this->_tmp_lookup_nc_libretin = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['nc_libretin'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['nc_libretin']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['nc_libretin']['valList'][$i] = form_del_nota_credito_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['nc_libretin']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['nc_libretin']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['nc_libretin']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_ambiente($bForce = false)
   {
          ...
          //----- nc_tipo_libretin
   function ajax_return_values_nc_tipo_libretin($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nc_tipo_libretin", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->nc_tipo_libretin);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['nc_tipo_libretin'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- nc_establecimiento
   function ajax_return_values_nc_establecimiento($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nc_establecimiento", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->nc_establecimiento);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['nc_establecimiento'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- nc_punto_emision
   function ajax_return_values_nc_punto_emision($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nc_punto_emision", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->nc_punto_emision);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['nc_punto_emision'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_nc_secuencial($bForce = false)
   {
          ...
          //----- nc_ambiente
   function ajax_return_values_nc_ambiente($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nc_ambiente", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->nc_ambiente);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['nc_ambiente'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_fecha_sustento($bForce = false)
   {
          ...
          //----- nc_cliente
   function ajax_return_values_nc_cliente($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nc_cliente", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->nc_cliente);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['nc_cliente'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_nc_numero($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   {
       $this->NM_ajax_info['btnVars']['var_btn_ride_var_tipo_documento'] = $this->form_encode_input($this->nmgp_dados_form['nc_tipo_comprobante']);
       $this->NM_ajax_info['btnVars']['var_btn_ride_var_id_documento'] = $this->form_encode_input($this->nmgp_dados_form['nc_numero']);
   } // ajax_add_parameters
  function nm_proc_onload($bFormat = true)
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['Field_no_validate'] = array();
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_nc_ambiente = $this->nc_ambiente;
    $original_nc_establecimiento = $this->nc_establecimiento;
    $original_nc_iddocmod = $this->nc_iddocmod;
    $original_nc_libretin = $this->nc_libretin;
    $original_nc_punto_emision = $this->nc_punto_emision;
    $original_nc_secuencial = $this->nc_secuencial;
    $original_nc_tipo_libretin = $this->nc_tipo_libretin;
...
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
  $this->titulo = $this->Ini->Nm_lang['lang_emitir_nc'] ;
...
if ($this->rs[0][0]=="SI" and $this->nc_asiento ==''){
    $this->NM_ajax_info['buttonDisplay']['contabilizar'] = $this->nmgp_botoes["contabilizar"] = 'on';;
}else{
	$this->NM_ajax_info['buttonDisplay']['contabilizar'] = $this->nmgp_botoes["contabilizar"] = 'off';;
}


if ($this->nc_estado =='R'){
	$this->sc_field_readonly("nc_libretin", 'off');
	
}else{
	$this->sc_field_readonly("nc_libretin", 'on');
}

if($this->nc_libretin <>''){
	$check_sql = "SELECT est_codigo,
						 pen_serie,
						 right('000000000'||nc_secuencial,9),
						 tl_descripcion,
						 ta_nombre 
					FROM del_nota_credito 
					join del_establecimiento on nc_establecimiento=est_id
					join del_punto_emision on nc_punto_emision=pem_id
					join sri_tipo_libretin on nc_tipo_libretin = tl_codigo
					join sri_tipo_ambiente on nc_ambiente=ta_id
	...
	$check_sql = "SELECT est_id,
      ...
      { 
          ...
          $this->rs_erro = $this->Db->ErrorMsg();
			...
			if (isset($this->rs[0][0])){
				$this->nc_establecimiento  = $this->rs[0][0];
				$this->nc_punto_emision  = $this->rs[0][1];
				$this->nc_secuencial = $this->rs[0][2];
				$this->nc_ambiente =$this->rs[0][3];
				$this->nc_tipo_libretin =$this->rs[0][4];
				...
				$this->nc_autorizacion =$this->rs[0][10];
				$this->nc_estado_sri =$this->rs[0][11];
			}
}	
if ($this->nc_iddocmod <>''){
	$check_sql = "SELECT 
	...
	$delete_sql="DELETE FROM del_detalle_nota_credito WHERE dnc_nota_credito=".$this->nc_numero ;
...
}elseif($this->nc_estado =='V'){
	$this->sc_field_readonly("nc_libretin", 'on');
	$this->NM_ajax_info['buttonDisplay']['Anular'] = $this->nmgp_botoes["Anular"] = 'on';;
	$this->NM_ajax_info['buttonDisplay']['update'] = $this->nmgp_botoes["update"] = 'off';;
	if($this->nc_tipo_libretin =='E'){
		if($this->nc_estado_sri  == 'AUTORIZADO'){
			$this->NM_ajax_info['buttonDisplay']['enviar'] = $this->nmgp_botoes["enviar"] = 'off';;
		}else{
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_nc_ambiente != $this->nc_ambiente || (isset($bFlagRead_nc_ambiente) && $bFlagRead_nc_ambiente)))
    {
        $this->ajax_return_values_nc_ambiente(true);
    }
    if (($original_nc_establecimiento != $this->nc_establecimiento || (isset($bFlagRead_nc_establecimiento) && $bFlagRead_nc_establecimiento)))
    {
        $this->ajax_return_values_nc_establecimiento(true);
    }
    ...
    if (($original_nc_libretin != $this->nc_libretin || (isset($bFlagRead_nc_libretin) && $bFlagRead_nc_libretin)))
    {
        $this->ajax_return_values_nc_libretin(true);
    }
    if (($original_nc_punto_emision != $this->nc_punto_emision || (isset($bFlagRead_nc_punto_emision) && $bFlagRead_nc_punto_emision)))
    {
        $this->ajax_return_values_nc_punto_emision(true);
    }
    if (($original_nc_secuencial != $this->nc_secuencial || (isset($bFlagRead_nc_secuencial) && $bFlagRead_nc_secuencial)))
    {
        $this->ajax_return_values_nc_secuencial(true);
    }
    if (($original_nc_tipo_libretin != $this->nc_tipo_libretin || (isset($bFlagRead_nc_tipo_libretin) && $bFlagRead_nc_tipo_libretin)))
    {
        $this->ajax_return_values_nc_tipo_libretin(true);
    }
...
if($this->nc_libretin ==''){
	...
	$this->sc_temp_var_mensaje='No ha seleccionado una Serie para la nota de crédito <br>';
}
if ($this->nc_total ==0){
		$this->sc_temp_var_procesar=false;
		$this->sc_temp_var_mensaje='El valor de la nota de crédito no debe ser 0<br>';
}else{	
	$check_sql = "SELECT coalesce(sum(fp_valor),0) 
				  FROM del_forma_pago_nota_credito 
				  WHERE fp_nota_credito=".$this->nc_numero ;
	...
	if ($this->rs[0][0]>0){
		if ($this->rs[0][0]<>$this->nc_total ){
 			$this->sc_temp_var_procesar=false;
			$this->sc_temp_var_mensaje='La forma de Pago y el Total de la Nota de crédito no son iguales<br>';
		}
	}else{
		$this->sc_temp_var_procesar=false;
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_nc_total != $this->nc_total || (isset($bFlagRead_nc_total) && $bFlagRead_nc_total)))
    {
...
$_SESSION['scriptcase']['form_del_nota_credito_mob']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['nc_error_sri'] = $this->nc_error_sri;
      $NM_val_form['nc_fecha'] = $this->nc_fecha;
      $NM_val_form['nc_libretin'] = $this->nc_libretin;
      $NM_val_form['secuencial'] = $this->secuencial;
      $NM_val_form['tipo_libretin'] = $this->tipo_libretin;
      $NM_val_form['ambiente'] = $this->ambiente;
      $NM_val_form['nc_tipo_libretin'] = $this->nc_tipo_libretin;
      $NM_val_form['nc_establecimiento'] = $this->nc_establecimiento;
      $NM_val_form['nc_punto_emision'] = $this->nc_punto_emision;
      $NM_val_form['nc_secuencial'] = $this->nc_secuencial;
      $NM_val_form['nc_ambiente'] = $this->nc_ambiente;
      ...
      $NM_val_form['nc_cliente'] = $this->nc_cliente;
      ...
      $NM_val_form['nc_clave'] = $this->nc_clave;
      $NM_val_form['nc_usuario'] = $this->nc_usuario;
      $NM_val_form['nc_correo_enviado'] = $this->nc_correo_enviado;
      $NM_val_form['nc_archivo'] = $this->nc_archivo;
      $NM_val_form['nc_asiento'] = $this->nc_asiento;
      ...
      if ($this->nc_libretin === "" || is_null($this->nc_libretin))  
      { 
          $this->nc_libretin = 0;
          $this->sc_force_zero[] = 'nc_libretin';
      } 
      if ($this->nc_establecimiento === "" || is_null($this->nc_establecimiento))  
      { 
          $this->nc_establecimiento = 0;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          $this->nc_tipo_libretin_before_qstr = $this->nc_tipo_libretin;
          $this->nc_tipo_libretin = substr($this->Db->qstr($this->nc_tipo_libretin), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->nc_tipo_libretin = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->nc_tipo_libretin);
          }
          if ($this->nc_tipo_libretin == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->nc_tipo_libretin = "null"; 
              $NM_val_null[] = "nc_tipo_libretin";
          } 
          if ($this->nc_fecha == "")  
          { 
              $this->nc_fecha = "null"; 
          ...
          $this->nc_error_sri_before_qstr = $this->nc_error_sri;
          $this->nc_error_sri = substr($this->Db->qstr($this->nc_error_sri), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->nc_error_sri = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->nc_error_sri);
          }
          if ($this->nc_error_sri == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->nc_error_sri = "null"; 
              $NM_val_null[] = "nc_error_sri";
          } 
          $this->nc_fecha_autorizacion_before_qstr = $this->nc_fecha_autorizacion;
          $this->nc_fecha_autorizacion = substr($this->Db->qstr($this->nc_fecha_autorizacion), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->nc_fecha_autorizacion = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->nc_fecha_autorizacion);
          }
          if ($this->nc_fecha_autorizacion == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
          ...
          $this->nc_clave_before_qstr = $this->nc_clave;
          $this->nc_clave = substr($this->Db->qstr($this->nc_clave), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->nc_clave = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->nc_clave);
          }
          if ($this->nc_clave == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->nc_clave = "null"; 
              $NM_val_null[] = "nc_clave";
          } 
          ...
          $this->nc_correo_enviado_before_qstr = $this->nc_correo_enviado;
          $this->nc_correo_enviado = substr($this->Db->qstr($this->nc_correo_enviado), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->nc_correo_enviado = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->nc_correo_enviado);
          }
          if ($this->nc_correo_enviado == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->nc_correo_enviado = "null"; 
              $NM_val_null[] = "nc_correo_enviado";
          } 
          $this->nc_archivo_before_qstr = $this->nc_archivo;
          $this->nc_archivo = substr($this->Db->qstr($this->nc_archivo), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->nc_archivo = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->nc_archivo);
          }
          if ($this->nc_archivo == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->nc_archivo = "null"; 
              $NM_val_null[] = "nc_archivo";
          } 
          $this->nc_asiento_before_qstr = $this->nc_asiento;
          $this->nc_asiento = substr($this->Db->qstr($this->nc_asiento), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->nc_asiento = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->nc_asiento);
          }
          if ($this->nc_asiento == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->nc_asiento = "null"; 
              $NM_val_null[] = "nc_asiento";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "nc_libretin = $this->nc_libretin, nc_tipo_libretin = '$this->nc_tipo_libretin', nc_establecimiento = $this->nc_establecimiento, nc_punto_emision = $this->nc_punto_emision, nc_secuencial = $this->nc_secuencial, nc_ambiente = $this->nc_ambiente, nc_fecha = #$this->nc_fecha#, nc_iddocmod = $this->nc_iddocmod, nc_cliente = $this->nc_cliente, nc_cod_docmod = '$this->nc_cod_docmod', nc_serie_docmod = '$this->nc_serie_docmod', nc_secuencial_docmod = $this->nc_secuencial_docmod, nc_fecha_emison_docmod = #$this->nc_fecha_emison_docmod#, nc_motivo = '$this->nc_motivo', nc_subtotal_iva = $this->nc_subtotal_iva, nc_subtotal_cero = $this->nc_subtotal_cero, nc_subtotal_no_objeto = $this->nc_subtotal_no_objeto, nc_subtotal_excento = $this->nc_subtotal_excento, nc_subtotal = $this->nc_subtotal, nc_total_descuento = $this->nc_total_descuento, nc_valor_ice = $this->nc_valor_ice, nc_valor_iva = $this->nc_valor_iva, nc_valor_irbpnr = $this->nc_valor_irbpnr, nc_total = $this->nc_total, nc_error_sri = '$this->nc_error_sri'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "nc_libretin = $this->nc_libretin, nc_tipo_libretin = '$this->nc_tipo_libretin', nc_establecimiento = $this->nc_establecimiento, nc_punto_emision = $this->nc_punto_emision, nc_secuencial = $this->nc_secuencial, nc_ambiente = $this->nc_ambiente, nc_fecha = " . $this->Ini->date_delim . $this->nc_fecha . $this->Ini->date_delim1 . ", nc_iddocmod = $this->nc_iddocmod, nc_cliente = $this->nc_cliente, nc_cod_docmod = '$this->nc_cod_docmod', nc_serie_docmod = '$this->nc_serie_docmod', nc_secuencial_docmod = $this->nc_secuencial_docmod, nc_fecha_emison_docmod = " . $this->Ini->date_delim . $this->nc_fecha_emison_docmod . $this->Ini->date_delim1 . ", nc_motivo = '$this->nc_motivo', nc_subtotal_iva = $this->nc_subtotal_iva, nc_subtotal_cero = $this->nc_subtotal_cero, nc_subtotal_no_objeto = $this->nc_subtotal_no_objeto, nc_subtotal_excento = $this->nc_subtotal_excento, nc_subtotal = $this->nc_subtotal, nc_total_descuento = $this->nc_total_descuento, nc_valor_ice = $this->nc_valor_ice, nc_valor_iva = $this->nc_valor_iva, nc_valor_irbpnr = $this->nc_valor_irbpnr, nc_total = $this->nc_total, nc_error_sri = '$this->nc_error_sri'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "nc_libretin = $this->nc_libretin, nc_tipo_libretin = '$this->nc_tipo_libretin', nc_establecimiento = $this->nc_establecimiento, nc_punto_emision = $this->nc_punto_emision, nc_secuencial = $this->nc_secuencial, nc_ambiente = $this->nc_ambiente, nc_fecha = EXTEND('$this->nc_fecha', YEAR TO DAY), nc_iddocmod = $this->nc_iddocmod, nc_cliente = $this->nc_cliente, nc_cod_docmod = '$this->nc_cod_docmod', nc_serie_docmod = '$this->nc_serie_docmod', nc_secuencial_docmod = $this->nc_secuencial_docmod, nc_fecha_emison_docmod = EXTEND('$this->nc_fecha_emison_docmod', YEAR TO DAY), nc_motivo = '$this->nc_motivo', nc_subtotal_iva = $this->nc_subtotal_iva, nc_subtotal_cero = $this->nc_subtotal_cero, nc_subtotal_no_objeto = $this->nc_subtotal_no_objeto, nc_subtotal_excento = $this->nc_subtotal_excento, nc_subtotal = $this->nc_subtotal, nc_total_descuento = $this->nc_total_descuento, nc_valor_ice = $this->nc_valor_ice, nc_valor_iva = $this->nc_valor_iva, nc_valor_irbpnr = $this->nc_valor_irbpnr, nc_total = $this->nc_total, nc_error_sri = '$this->nc_error_sri'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['nc_autorizacion']) && $NM_val_form['nc_autorizacion'] != $this->nmgp_dados_select['nc_autorizacion']) 
              { 
                  $SC_fields_update[] = "nc_autorizacion = '$this->nc_autorizacion'"; 
              } 
              if (isset($NM_val_form['nc_clave']) && $NM_val_form['nc_clave'] != $this->nmgp_dados_select['nc_clave']) 
              { 
                  $SC_fields_update[] = "nc_clave = '$this->nc_clave'"; 
              } 
              ...
              if (isset($NM_val_form['nc_correo_enviado']) && $NM_val_form['nc_correo_enviado'] != $this->nmgp_dados_select['nc_correo_enviado']) 
              { 
                  $SC_fields_update[] = "nc_correo_enviado = '$this->nc_correo_enviado'"; 
              } 
              if (isset($NM_val_form['nc_archivo']) && $NM_val_form['nc_archivo'] != $this->nmgp_dados_select['nc_archivo']) 
              { 
                  $SC_fields_update[] = "nc_archivo = '$this->nc_archivo'"; 
              } 
              if (isset($NM_val_form['nc_asiento']) && $NM_val_form['nc_asiento'] != $this->nmgp_dados_select['nc_asiento']) 
              { 
                  $SC_fields_update[] = "nc_asiento = '$this->nc_asiento'"; 
              } 
              ...
              $this->nc_tipo_libretin = $this->nc_tipo_libretin_before_qstr;
              ...
              $this->nc_error_sri = $this->nc_error_sri_before_qstr;
              $this->nc_fecha_autorizacion = $this->nc_fecha_autorizacion_before_qstr;
              $this->nc_autorizacion = $this->nc_autorizacion_before_qstr;
              $this->nc_clave = $this->nc_clave_before_qstr;
              $this->nc_usuario = $this->nc_usuario_before_qstr;
              $this->nc_correo_enviado = $this->nc_correo_enviado_before_qstr;
              $this->nc_archivo = $this->nc_archivo_before_qstr;
              $this->nc_asiento = $this->nc_asiento_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['nc_libretin'])) { $this->nc_libretin = $NM_val_form['nc_libretin']; }
              elseif (isset($this->nc_libretin)) { $this->nm_limpa_alfa($this->nc_libretin); }
              if     (isset($NM_val_form) && isset($NM_val_form['nc_tipo_libretin'])) { $this->nc_tipo_libretin = $NM_val_form['nc_tipo_libretin']; }
              elseif (isset($this->nc_tipo_libretin)) { $this->nm_limpa_alfa($this->nc_tipo_libretin); }
              if     (isset($NM_val_form) && isset($NM_val_form['nc_establecimiento'])) { $this->nc_establecimiento = $NM_val_form['nc_establecimiento']; }
              elseif (isset($this->nc_establecimiento)) { $this->nm_limpa_alfa($this->nc_establecimiento); }
              if     (isset($NM_val_form) && isset($NM_val_form['nc_punto_emision'])) { $this->nc_punto_emision = $NM_val_form['nc_punto_emision']; }
              elseif (isset($this->nc_punto_emision)) { $this->nm_limpa_alfa($this->nc_punto_emision); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['nc_ambiente'])) { $this->nc_ambiente = $NM_val_form['nc_ambiente']; }
              elseif (isset($this->nc_ambiente)) { $this->nm_limpa_alfa($this->nc_ambiente); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['nc_cliente'])) { $this->nc_cliente = $NM_val_form['nc_cliente']; }
              elseif (isset($this->nc_cliente)) { $this->nm_limpa_alfa($this->nc_cliente); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['nc_error_sri'])) { $this->nc_error_sri = $NM_val_form['nc_error_sri']; }
              elseif (isset($this->nc_error_sri)) { $this->nm_limpa_alfa($this->nc_error_sri); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('titulo', 'nc_error_sri', 'nc_fecha', 'nc_libretin', 'secuencial', 'tipo_libretin', 'ambiente', 'nc_tipo_libretin', 'nc_establecimiento', 'nc_punto_emision', 'nc_secuencial', 'nc_ambiente', 'nc_iddocmod', 'tipo_doc_sustento', 'serie_sustento', 'secuencial_sustento', 'fecha_sustento', 'nc_cliente', 'nc_cod_docmod', 'nc_serie_docmod', 'nc_secuencial_docmod', 'nc_fecha_emison_docmod', 'fac_ruc_cliente', 'fac_nombre_cliente', 'fac_direccion_cliente', 'fac_email_cliente', 'nc_motivo', 'detalles', 'nc_subtotal', 'nc_subtotal_iva', 'nc_subtotal_cero', 'nc_subtotal_no_objeto', 'nc_subtotal_excento', 'nc_total_descuento', 'nc_valor_ice', 'nc_valor_iva', 'nc_valor_irbpnr', 'nc_total', 'forma_pago'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (nc_numero, nc_tipo_comprobante, nc_empresa, nc_libretin, nc_tipo_libretin, nc_establecimiento, nc_punto_emision, nc_secuencial, nc_ambiente, nc_fecha, nc_iddocmod, nc_cliente, nc_cod_docmod, nc_serie_docmod, nc_secuencial_docmod, nc_fecha_emison_docmod, nc_motivo, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_subtotal, nc_total_descuento, nc_valor_ice, nc_valor_iva, nc_valor_irbpnr, nc_total, nc_estado, nc_estado_sri, nc_error_sri, nc_fecha_autorizacion, nc_autorizacion, nc_clave, nc_usuario, nc_correo_enviado, nc_archivo, nc_asiento) VALUES ($this->nc_numero, '$this->nc_tipo_comprobante', '$this->nc_empresa', $this->nc_libretin, '$this->nc_tipo_libretin', $this->nc_establecimiento, $this->nc_punto_emision, $this->nc_secuencial, $this->nc_ambiente, #$this->nc_fecha#, $this->nc_iddocmod, $this->nc_cliente, '$this->nc_cod_docmod', '$this->nc_serie_docmod', $this->nc_secuencial_docmod, #$this->nc_fecha_emison_docmod#, '$this->nc_motivo', $this->nc_subtotal_iva, $this->nc_subtotal_cero, $this->nc_subtotal_no_objeto, $this->nc_subtotal_excento, $this->nc_subtotal, $this->nc_total_descuento, $this->nc_valor_ice, $this->nc_valor_iva, $this->nc_valor_irbpnr, $this->nc_total, '$this->nc_estado', '$this->nc_estado_sri', '$this->nc_error_sri', '$this->nc_fecha_autorizacion', '$this->nc_autorizacion', '$this->nc_clave', '$this->nc_usuario', '$this->nc_correo_enviado', '$this->nc_archivo', '$this->nc_asiento')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "nc_numero, nc_tipo_comprobante, nc_empresa, nc_libretin, nc_tipo_libretin, nc_establecimiento, nc_punto_emision, nc_secuencial, nc_ambiente, nc_fecha, nc_iddocmod, nc_cliente, nc_cod_docmod, nc_serie_docmod, nc_secuencial_docmod, nc_fecha_emison_docmod, nc_motivo, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_subtotal, nc_total_descuento, nc_valor_ice, nc_valor_iva, nc_valor_irbpnr, nc_total, nc_estado, nc_estado_sri, nc_error_sri, nc_fecha_autorizacion, nc_autorizacion, nc_clave, nc_usuario, nc_correo_enviado, nc_archivo, nc_asiento) VALUES (" . $NM_seq_auto . "$this->nc_numero, '$this->nc_tipo_comprobante', '$this->nc_empresa', $this->nc_libretin, '$this->nc_tipo_libretin', $this->nc_establecimiento, $this->nc_punto_emision, $this->nc_secuencial, $this->nc_ambiente, " . $this->Ini->date_delim . $this->nc_fecha . $this->Ini->date_delim1 . ", $this->nc_iddocmod, $this->nc_cliente, '$this->nc_cod_docmod', '$this->nc_serie_docmod', $this->nc_secuencial_docmod, " . $this->Ini->date_delim . $this->nc_fecha_emison_docmod . $this->Ini->date_delim1 . ", '$this->nc_motivo', $this->nc_subtotal_iva, $this->nc_subtotal_cero, $this->nc_subtotal_no_objeto, $this->nc_subtotal_excento, $this->nc_subtotal, $this->nc_total_descuento, $this->nc_valor_ice, $this->nc_valor_iva, $this->nc_valor_irbpnr, $this->nc_total, '$this->nc_estado', '$this->nc_estado_sri', '$this->nc_error_sri', '$this->nc_fecha_autorizacion', '$this->nc_autorizacion', '$this->nc_clave', '$this->nc_usuario', '$this->nc_correo_enviado', '$this->nc_archivo', '$this->nc_asiento')"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "nc_numero, nc_tipo_comprobante, nc_empresa, nc_libretin, nc_tipo_libretin, nc_establecimiento, nc_punto_emision, nc_secuencial, nc_ambiente, nc_fecha, nc_iddocmod, nc_cliente, nc_cod_docmod, nc_serie_docmod, nc_secuencial_docmod, nc_fecha_emison_docmod, nc_motivo, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_subtotal, nc_total_descuento, nc_valor_ice, nc_valor_iva, nc_valor_irbpnr, nc_total, nc_estado, nc_estado_sri, nc_error_sri, nc_fecha_autorizacion, nc_autorizacion, nc_clave, nc_usuario, nc_correo_enviado, nc_archivo, nc_asiento) VALUES (" . $NM_seq_auto . "$this->nc_numero, '$this->nc_tipo_comprobante', '$this->nc_empresa', $this->nc_libretin, '$this->nc_tipo_libretin', $this->nc_establecimiento, $this->nc_punto_emision, $this->nc_secuencial, $this->nc_ambiente, EXTEND('$this->nc_fecha', YEAR TO DAY), $this->nc_iddocmod, $this->nc_cliente, '$this->nc_cod_docmod', '$this->nc_serie_docmod', $this->nc_secuencial_docmod, EXTEND('$this->nc_fecha_emison_docmod', YEAR TO DAY), '$this->nc_motivo', $this->nc_subtotal_iva, $this->nc_subtotal_cero, $this->nc_subtotal_no_objeto, $this->nc_subtotal_excento, $this->nc_subtotal, $this->nc_total_descuento, $this->nc_valor_ice, $this->nc_valor_iva, $this->nc_valor_irbpnr, $this->nc_total, '$this->nc_estado', '$this->nc_estado_sri', '$this->nc_error_sri', '$this->nc_fecha_autorizacion', '$this->nc_autorizacion', '$this->nc_clave', '$this->nc_usuario', '$this->nc_correo_enviado', '$this->nc_archivo', '$this->nc_asiento')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "nc_numero, nc_tipo_comprobante, nc_empresa, nc_libretin, nc_tipo_libretin, nc_establecimiento, nc_punto_emision, nc_secuencial, nc_ambiente, nc_fecha, nc_iddocmod, nc_cliente, nc_cod_docmod, nc_serie_docmod, nc_secuencial_docmod, nc_fecha_emison_docmod, nc_motivo, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_subtotal, nc_total_descuento, nc_valor_ice, nc_valor_iva, nc_valor_irbpnr, nc_total, nc_estado, nc_estado_sri, nc_error_sri, nc_fecha_autorizacion, nc_autorizacion, nc_clave, nc_usuario, nc_correo_enviado, nc_archivo, nc_asiento) VALUES (" . $NM_seq_auto . "$this->nc_numero, '$this->nc_tipo_comprobante', '$this->nc_empresa', $this->nc_libretin, '$this->nc_tipo_libretin', $this->nc_establecimiento, $this->nc_punto_emision, $this->nc_secuencial, $this->nc_ambiente, " . $this->Ini->date_delim . $this->nc_fecha . $this->Ini->date_delim1 . ", $this->nc_iddocmod, $this->nc_cliente, '$this->nc_cod_docmod', '$this->nc_serie_docmod', $this->nc_secuencial_docmod, " . $this->Ini->date_delim . $this->nc_fecha_emison_docmod . $this->Ini->date_delim1 . ", '$this->nc_motivo', $this->nc_subtotal_iva, $this->nc_subtotal_cero, $this->nc_subtotal_no_objeto, $this->nc_subtotal_excento, $this->nc_subtotal, $this->nc_total_descuento, $this->nc_valor_ice, $this->nc_valor_iva, $this->nc_valor_irbpnr, $this->nc_total, '$this->nc_estado', '$this->nc_estado_sri', '$this->nc_error_sri', '$this->nc_fecha_autorizacion', '$this->nc_autorizacion', '$this->nc_clave', '$this->nc_usuario', '$this->nc_correo_enviado', '$this->nc_archivo', '$this->nc_asiento')"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              $sDetailWhere = "dnc_nota_credito = " . $this->nc_numero . " AND dnc_empresa = '" . $this->nc_empresa . "'";
              $this->form_del_detalle_nota_credito_mob->ini_controle();
              if ($this->form_del_detalle_nota_credito_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          if ($bDelecaoOk)
          {
              $sDetailWhere = "fp_nota_credito = " . $this->nc_numero . "";
              $this->form_del_forma_pago_nota_credito_mob->ini_controle();
              if ($this->form_del_forma_pago_nota_credito_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
                  $sMsgErro   = $this->Ini->Nm_lang['lang_errm_fkvi'];
              }
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['reg_start'] = 0; 
              }
...
if (!isset($this->sc_temp_var_procesar)) {$this->sc_temp_var_procesar = (isset($_SESSION['var_procesar'])) ? $_SESSION['var_procesar'] : "";}
  if($this->sc_temp_var_procesar==true){
	...
	if($this->nc_estado =='R'){
		$check_sql = "SELECT sp_del_secuencial_documento (".$this->nc_libretin .",'04',".$this->nc_numero .")";
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_del_nota_credito_mob';
				...
				if (isset($this->Campos_Mens_erro) && !empty($this->Campos_Mens_erro))
{
 ...
 if (isset($this->sc_temp_Igtech_AutorizacionInmediata)) { $_SESSION['Igtech_AutorizacionInmediata'] = $this->sc_temp_Igtech_AutorizacionInmediata;}
    if ($this->NM_ajax_flag)
    {
        $this->NM_ajax_info['redirExit']['action'] = "form_del_nota_credito_mob_fim.php?script_case_init=" . $this->form_encode_input($this->Ini->sc_page);
        $this->NM_ajax_info['redirExit']['metodo'] = 'location';
        $this->NM_ajax_info['redirExit']['target'] = "_self";
        $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $this->Ini->path_link . "" . SC_dir_app_name('form_del_nota_credito') . "/";
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['sc_outra_jan'])
        {
            $_SESSION['scriptcase']['sc_outra_jan'] = "form_del_nota_credito_mob";
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['sc_outra_jan'] = false;
        }
        $_SESSION['scriptcase']['form_del_nota_credito_mob']['contr_erro'] = 'off';
        form_del_nota_credito_mob_pack_ajax_response();
        exit;
...
<table align="center"><tr><td>
  <form name="Fexit" method=post
        action="form_del_nota_credito_mob_fim.php"
        target="_self">
    <input type=hidden name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page) ?>">
...
<?php
   exit;
	...
	$update_sql = "UPDATE del_detalle_factura
				   SET  df_cantidad_nc=cantidad_nc
				   from v_del_cantidad_desde_factura
				   where df_id=dnc_factura";
	...
	$registra_kardex="SELECT sp_ncv_al_kardex(".$this->nc_numero .");";
	...
	$insert_sql="INSERT INTO del_cuentas_por_pagar(
							cxp_fecha,
							cxp_empresa, 
							cxp_cliente, 
							cxp_documento, 
							...
							SELECT 
								...
								nc_empresa, 
								nc_cliente,
								est_codigo||pen_serie||'-'||nc_secuencial,
								nc_total,
								'V',
								nc_tipo_comprobante
	...
	if($this->nc_tipo_libretin =='E' and $this->nc_estado_sri <>'AUTORIZADO'){
		$this->sc_temp_var_mensaje=$this->autorizar_nc($this->nc_numero ,$this->sc_temp_Igtech_AutorizacionInmediata);
...
$_SESSION['scriptcase']['form_del_nota_credito_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['parms'] = "nc_numero?#?$this->nc_numero?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          { 
              $nmgp_select = "SELECT nc_numero, nc_tipo_comprobante, nc_empresa, nc_libretin, nc_tipo_libretin, nc_establecimiento, nc_punto_emision, nc_secuencial, nc_ambiente, str_replace (convert(char(10),nc_fecha,102), '.', '-') + ' ' + convert(char(8),nc_fecha,20), nc_iddocmod, nc_cliente, nc_cod_docmod, nc_serie_docmod, nc_secuencial_docmod, str_replace (convert(char(10),nc_fecha_emison_docmod,102), '.', '-') + ' ' + convert(char(8),nc_fecha_emison_docmod,20), nc_motivo, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_subtotal, nc_total_descuento, nc_valor_ice, nc_valor_iva, nc_valor_irbpnr, nc_total, nc_estado, nc_estado_sri, nc_error_sri, nc_fecha_autorizacion, nc_autorizacion, nc_clave, nc_usuario, nc_correo_enviado, nc_archivo, nc_asiento from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT nc_numero, nc_tipo_comprobante, nc_empresa, nc_libretin, nc_tipo_libretin, nc_establecimiento, nc_punto_emision, nc_secuencial, nc_ambiente, convert(char(23),nc_fecha,121), nc_iddocmod, nc_cliente, nc_cod_docmod, nc_serie_docmod, nc_secuencial_docmod, convert(char(23),nc_fecha_emison_docmod,121), nc_motivo, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_subtotal, nc_total_descuento, nc_valor_ice, nc_valor_iva, nc_valor_irbpnr, nc_total, nc_estado, nc_estado_sri, nc_error_sri, nc_fecha_autorizacion, nc_autorizacion, nc_clave, nc_usuario, nc_correo_enviado, nc_archivo, nc_asiento from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT nc_numero, nc_tipo_comprobante, nc_empresa, nc_libretin, nc_tipo_libretin, nc_establecimiento, nc_punto_emision, nc_secuencial, nc_ambiente, nc_fecha, nc_iddocmod, nc_cliente, nc_cod_docmod, nc_serie_docmod, nc_secuencial_docmod, nc_fecha_emison_docmod, nc_motivo, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_subtotal, nc_total_descuento, nc_valor_ice, nc_valor_iva, nc_valor_irbpnr, nc_total, nc_estado, nc_estado_sri, nc_error_sri, nc_fecha_autorizacion, nc_autorizacion, nc_clave, nc_usuario, nc_correo_enviado, nc_archivo, nc_asiento from " . $this->Ini->nm_tabela ; 
          ...
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT nc_numero, nc_tipo_comprobante, nc_empresa, nc_libretin, nc_tipo_libretin, nc_establecimiento, nc_punto_emision, nc_secuencial, nc_ambiente, EXTEND(nc_fecha, YEAR TO DAY), nc_iddocmod, nc_cliente, nc_cod_docmod, nc_serie_docmod, nc_secuencial_docmod, EXTEND(nc_fecha_emison_docmod, YEAR TO DAY), nc_motivo, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_subtotal, nc_total_descuento, nc_valor_ice, nc_valor_iva, nc_valor_irbpnr, nc_total, nc_estado, nc_estado_sri, nc_error_sri, nc_fecha_autorizacion, nc_autorizacion, nc_clave, nc_usuario, nc_correo_enviado, nc_archivo, nc_asiento from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT nc_numero, nc_tipo_comprobante, nc_empresa, nc_libretin, nc_tipo_libretin, nc_establecimiento, nc_punto_emision, nc_secuencial, nc_ambiente, nc_fecha, nc_iddocmod, nc_cliente, nc_cod_docmod, nc_serie_docmod, nc_secuencial_docmod, nc_fecha_emison_docmod, nc_motivo, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_subtotal, nc_total_descuento, nc_valor_ice, nc_valor_iva, nc_valor_irbpnr, nc_total, nc_estado, nc_estado_sri, nc_error_sri, nc_fecha_autorizacion, nc_autorizacion, nc_clave, nc_usuario, nc_correo_enviado, nc_archivo, nc_asiento from " . $this->Ini->nm_tabela ; 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (!empty($sc_where))
              {
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['reg_start']) ;  
              } 
          } 
          ...
          { 
              ...
              $this->nc_libretin = $rs->fields[3] ; 
              $this->nmgp_dados_select['nc_libretin'] = $this->nc_libretin;
              $this->nc_tipo_libretin = $rs->fields[4] ; 
              $this->nmgp_dados_select['nc_tipo_libretin'] = $this->nc_tipo_libretin;
              $this->nc_establecimiento = $rs->fields[5] ; 
              $this->nmgp_dados_select['nc_establecimiento'] = $this->nc_establecimiento;
              $this->nc_punto_emision = $rs->fields[6] ; 
              $this->nmgp_dados_select['nc_punto_emision'] = $this->nc_punto_emision;
              $this->nc_secuencial = $rs->fields[7] ; 
              $this->nmgp_dados_select['nc_secuencial'] = $this->nc_secuencial;
              $this->nc_ambiente = $rs->fields[8] ; 
              $this->nmgp_dados_select['nc_ambiente'] = $this->nc_ambiente;
              $this->nc_fecha = $rs->fields[9] ; 
              $this->nmgp_dados_select['nc_fecha'] = $this->nc_fecha;
              $this->nc_iddocmod = $rs->fields[10] ; 
              $this->nmgp_dados_select['nc_iddocmod'] = $this->nc_iddocmod;
              $this->nc_cliente = $rs->fields[11] ; 
              $this->nmgp_dados_select['nc_cliente'] = $this->nc_cliente;
              $this->nc_cod_docmod = $rs->fields[12] ; 
              $this->nmgp_dados_select['nc_cod_docmod'] = $this->nc_cod_docmod;
              $this->nc_serie_docmod = $rs->fields[13] ; 
              $this->nmgp_dados_select['nc_serie_docmod'] = $this->nc_serie_docmod;
              $this->nc_secuencial_docmod = $rs->fields[14] ; 
              $this->nmgp_dados_select['nc_secuencial_docmod'] = $this->nc_secuencial_docmod;
              $this->nc_fecha_emison_docmod = $rs->fields[15] ; 
              $this->nmgp_dados_select['nc_fecha_emison_docmod'] = $this->nc_fecha_emison_docmod;
              $this->nc_motivo = $rs->fields[16] ; 
              $this->nmgp_dados_select['nc_motivo'] = $this->nc_motivo;
              $this->nc_subtotal_iva = $rs->fields[17] ; 
              $this->nmgp_dados_select['nc_subtotal_iva'] = $this->nc_subtotal_iva;
              $this->nc_subtotal_cero = $rs->fields[18] ; 
              $this->nmgp_dados_select['nc_subtotal_cero'] = $this->nc_subtotal_cero;
              $this->nc_subtotal_no_objeto = $rs->fields[19] ; 
              $this->nmgp_dados_select['nc_subtotal_no_objeto'] = $this->nc_subtotal_no_objeto;
              $this->nc_subtotal_excento = $rs->fields[20] ; 
              $this->nmgp_dados_select['nc_subtotal_excento'] = $this->nc_subtotal_excento;
              $this->nc_subtotal = $rs->fields[21] ; 
              $this->nmgp_dados_select['nc_subtotal'] = $this->nc_subtotal;
              $this->nc_total_descuento = $rs->fields[22] ; 
              $this->nmgp_dados_select['nc_total_descuento'] = $this->nc_total_descuento;
              $this->nc_valor_ice = $rs->fields[23] ; 
              $this->nmgp_dados_select['nc_valor_ice'] = $this->nc_valor_ice;
              $this->nc_valor_iva = $rs->fields[24] ; 
              $this->nmgp_dados_select['nc_valor_iva'] = $this->nc_valor_iva;
              $this->nc_valor_irbpnr = $rs->fields[25] ; 
              $this->nmgp_dados_select['nc_valor_irbpnr'] = $this->nc_valor_irbpnr;
              $this->nc_total = $rs->fields[26] ; 
              $this->nmgp_dados_select['nc_total'] = $this->nc_total;
              $this->nc_estado = $rs->fields[27] ; 
              $this->nmgp_dados_select['nc_estado'] = $this->nc_estado;
              $this->nc_estado_sri = $rs->fields[28] ; 
              $this->nmgp_dados_select['nc_estado_sri'] = $this->nc_estado_sri;
              $this->nc_error_sri = $rs->fields[29] ; 
              $this->nmgp_dados_select['nc_error_sri'] = $this->nc_error_sri;
              $this->nc_fecha_autorizacion = $rs->fields[30] ; 
              $this->nmgp_dados_select['nc_fecha_autorizacion'] = $this->nc_fecha_autorizacion;
              $this->nc_autorizacion = $rs->fields[31] ; 
              $this->nmgp_dados_select['nc_autorizacion'] = $this->nc_autorizacion;
              $this->nc_clave = $rs->fields[32] ; 
              $this->nmgp_dados_select['nc_clave'] = $this->nc_clave;
              $this->nc_usuario = $rs->fields[33] ; 
              $this->nmgp_dados_select['nc_usuario'] = $this->nc_usuario;
              $this->nc_correo_enviado = $rs->fields[34] ; 
              $this->nmgp_dados_select['nc_correo_enviado'] = $this->nc_correo_enviado;
              $this->nc_archivo = $rs->fields[35] ; 
              $this->nmgp_dados_select['nc_archivo'] = $this->nc_archivo;
              $this->nc_asiento = $rs->fields[36] ; 
              $this->nmgp_dados_select['nc_asiento'] = $this->nc_asiento;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->nm_troca_decimal(",", ".");
              $this->nc_numero = (string)$this->nc_numero; 
              $this->nc_libretin = (string)$this->nc_libretin; 
              $this->nc_establecimiento = (string)$this->nc_establecimiento; 
              $this->nc_punto_emision = (string)$this->nc_punto_emision; 
              $this->nc_secuencial = (string)$this->nc_secuencial; 
              $this->nc_ambiente = (string)$this->nc_ambiente; 
              $this->nc_iddocmod = (string)$this->nc_iddocmod; 
              $this->nc_cliente = (string)$this->nc_cliente; 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['reg_start'] < $qt_geral_reg_form_del_nota_credito_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              $this->nc_tipo_libretin = "";  
              $this->nmgp_dados_form["nc_tipo_libretin"] = $this->nc_tipo_libretin;
              $this->nc_establecimiento = "";  
              $this->nmgp_dados_form["nc_establecimiento"] = $this->nc_establecimiento;
              $this->nc_punto_emision = "";  
              $this->nmgp_dados_form["nc_punto_emision"] = $this->nc_punto_emision;
              $this->nc_secuencial = "";  
              $this->nmgp_dados_form["nc_secuencial"] = $this->nc_secuencial;
              $this->nc_ambiente = "";  
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito_mob']['embutida_parms'] = "var_nota_credito*scin" . $this->nmgp_dados_form['nc_numero'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_forma_pago_nota_credito_mob']['embutida_parms'] = "var_nota_credito*scin" . $this->nmgp_dados_form['nc_numero'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
// 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['dados_select'];
           ...
           $this->SC_log_arr['fields']['nc_libretin']['0'] =  $nmgp_dados_select['nc_libretin'];
           $this->SC_log_arr['fields']['nc_tipo_libretin']['0'] =  $nmgp_dados_select['nc_tipo_libretin'];
           $this->SC_log_arr['fields']['nc_establecimiento']['0'] =  $nmgp_dados_select['nc_establecimiento'];
           $this->SC_log_arr['fields']['nc_punto_emision']['0'] =  $nmgp_dados_select['nc_punto_emision'];
           $this->SC_log_arr['fields']['nc_secuencial']['0'] =  $nmgp_dados_select['nc_secuencial'];
           $this->SC_log_arr['fields']['nc_ambiente']['0'] =  $nmgp_dados_select['nc_ambiente'];
           ...
           $this->SC_log_arr['fields']['nc_cliente']['0'] =  $nmgp_dados_select['nc_cliente'];
           ...
           $this->SC_log_arr['fields']['nc_error_sri']['0'] =  $nmgp_dados_select['nc_error_sri'];
           ...
           $this->SC_log_arr['fields']['nc_clave']['0'] =  $nmgp_dados_select['nc_clave'];
           $this->SC_log_arr['fields']['nc_usuario']['0'] =  $nmgp_dados_select['nc_usuario'];
           $this->SC_log_arr['fields']['nc_correo_enviado']['0'] =  $nmgp_dados_select['nc_correo_enviado'];
           $this->SC_log_arr['fields']['nc_archivo']['0'] =  $nmgp_dados_select['nc_archivo'];
           $this->SC_log_arr['fields']['nc_asiento']['0'] =  $nmgp_dados_select['nc_asiento'];
...
// 
   function NM_gera_log_new() 
   {
       ...
       $this->SC_log_arr['fields']['nc_libretin']['1'] =  $this->nc_libretin;
       $this->SC_log_arr['fields']['nc_tipo_libretin']['1'] =  $this->nc_tipo_libretin;
       $this->SC_log_arr['fields']['nc_establecimiento']['1'] =  $this->nc_establecimiento;
       $this->SC_log_arr['fields']['nc_punto_emision']['1'] =  $this->nc_punto_emision;
       $this->SC_log_arr['fields']['nc_secuencial']['1'] =  $this->nc_secuencial;
       $this->SC_log_arr['fields']['nc_ambiente']['1'] =  $this->nc_ambiente;
       $this->SC_log_arr['fields']['nc_fecha']['1'] =  $this->nc_fecha;
       $this->SC_log_arr['fields']['nc_iddocmod']['1'] =  $this->nc_iddocmod;
       $this->SC_log_arr['fields']['nc_cliente']['1'] =  $this->nc_cliente;
       ...
       $this->SC_log_arr['fields']['nc_error_sri']['1'] =  $this->nc_error_sri;
       ...
       $this->SC_log_arr['fields']['nc_clave']['1'] =  $this->nc_clave;
       $this->SC_log_arr['fields']['nc_usuario']['1'] =  $this->nc_usuario;
       $this->SC_log_arr['fields']['nc_correo_enviado']['1'] =  $this->nc_correo_enviado;
       $this->SC_log_arr['fields']['nc_archivo']['1'] =  $this->nc_archivo;
       $this->SC_log_arr['fields']['nc_asiento']['1'] =  $this->nc_asiento;
...
// 
   function NM_gera_log_output() 
   {
       ...
       $Log_labels['nc_libretin'] =  "{lang_libretin}";
       $Log_labels['nc_tipo_libretin'] =  "{lang_tipo_libretin}";
       $Log_labels['nc_establecimiento'] =  "{lang_establecimiento}";
       $Log_labels['nc_punto_emision'] =  "{lang_punto_emision}";
       $Log_labels['nc_secuencial'] =  "{lang_secuencial}";
       $Log_labels['nc_ambiente'] =  "{lang_tipo_ambiente}";
       $Log_labels['nc_fecha'] =  "{lang_fecha}";
       $Log_labels['nc_iddocmod'] =  "{lang_lot_documento}";
       $Log_labels['nc_cliente'] =  "{lang_clientes}";
       ...
       $Log_labels['nc_error_sri'] =  "{lang_mensaje}";
       $Log_labels['nc_fecha_autorizacion'] =  "Nc Fecha Autorizacion";
       $Log_labels['nc_autorizacion'] =  "Nc Autorizacion";
       $Log_labels['nc_clave'] =  "Nc Clave";
       $Log_labels['nc_usuario'] =  "Nc Usuario";
       $Log_labels['nc_correo_enviado'] =  "Nc Correo Enviado";
       $Log_labels['nc_archivo'] =  "Nc Archivo";
       $Log_labels['nc_asiento'] =  "Nc Asiento";
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$original_fac_direccion_cliente = $this->fac_direccion_cliente;
$original_fac_email_cliente = $this->fac_email_cliente;
$original_nc_cliente = $this->nc_cliente;
...
if (isset($this->rs[0][0])){
	...
	$this->fac_direccion_cliente 	=$this->rs[0][7];
	$this->fac_email_cliente 		=$this->rs[0][8];
	$this->nc_cliente 			=$this->rs[0][9];
}

$exec_sql = "SELECT sp_carga_factura_nc(".$this->nc_numero .", ".$this->nc_iddocmod .")";
...
$exec_sql = "SELECT sp_del_actualiza_nc(".$this->nc_numero .")";
...
$modificado_nc_cliente = $this->nc_cliente;
...
$this->nm_formatar_campos('nc_iddocmod', 'nc_cod_docmod', 'tipo_doc_sustento', 'nc_serie_docmod', 'serie_sustento', 'nc_secuencial_docmod', 'secuencial_sustento', 'nc_fecha_emison_docmod', 'fecha_sustento', 'fac_nombre_cliente', 'fac_ruc_cliente', 'fac_direccion_cliente', 'fac_email_cliente', 'nc_cliente', 'nc_subtotal', 'nc_subtotal_iva', 'nc_subtotal_cero', 'nc_subtotal_no_objeto', 'nc_subtotal_excento', 'nc_total_descuento', 'nc_valor_ice', 'nc_valor_iva', 'nc_valor_irbpnr', 'nc_total');
...
if ($original_nc_cliente !== $modificado_nc_cliente || isset($this->nmgp_cmp_readonly['nc_cliente']) || (isset($bFlagRead_nc_cliente) && $bFlagRead_nc_cliente))
{
    $this->ajax_return_values_nc_cliente(true);
}
...
$modificado_nc_libretin = $this->nc_libretin;
$modificado_nc_establecimiento = $this->nc_establecimiento;
$modificado_nc_punto_emision = $this->nc_punto_emision;
$modificado_nc_secuencial = $this->nc_secuencial;
$modificado_nc_ambiente = $this->nc_ambiente;
$modificado_nc_tipo_libretin = $this->nc_tipo_libretin;
$modificado_secuencial = $this->secuencial;
$modificado_ambiente = $this->ambiente;
$modificado_tipo_libretin = $this->tipo_libretin;
$this->nm_formatar_campos('nc_libretin', 'nc_establecimiento', 'nc_punto_emision', 'nc_secuencial', 'nc_ambiente', 'nc_tipo_libretin', 'secuencial', 'ambiente', 'tipo_libretin');
if ($original_nc_libretin !== $modificado_nc_libretin || isset($this->nmgp_cmp_readonly['nc_libretin']) || (isset($bFlagRead_nc_libretin) && $bFlagRead_nc_libretin))
{
    $this->ajax_return_values_nc_libretin(true);
}
if ($original_nc_establecimiento !== $modificado_nc_establecimiento || isset($this->nmgp_cmp_readonly['nc_establecimiento']) || (isset($bFlagRead_nc_establecimiento) && $bFlagRead_nc_establecimiento))
{
    $this->ajax_return_values_nc_establecimiento(true);
}
if ($original_nc_punto_emision !== $modificado_nc_punto_emision || isset($this->nmgp_cmp_readonly['nc_punto_emision']) || (isset($bFlagRead_nc_punto_emision) && $bFlagRead_nc_punto_emision))
{
    $this->ajax_return_values_nc_punto_emision(true);
}
if ($original_nc_secuencial !== $modificado_nc_secuencial || isset($this->nmgp_cmp_readonly['nc_secuencial']) || (isset($bFlagRead_nc_secuencial) && $bFlagRead_nc_secuencial))
{
    $this->ajax_return_values_nc_secuencial(true);
}
if ($original_nc_ambiente !== $modificado_nc_ambiente || isset($this->nmgp_cmp_readonly['nc_ambiente']) || (isset($bFlagRead_nc_ambiente) && $bFlagRead_nc_ambiente))
{
    $this->ajax_return_values_nc_ambiente(true);
}
if ($original_nc_tipo_libretin !== $modificado_nc_tipo_libretin || isset($this->nmgp_cmp_readonly['nc_tipo_libretin']) || (isset($bFlagRead_nc_tipo_libretin) && $bFlagRead_nc_tipo_libretin))
{
    $this->ajax_return_values_nc_tipo_libretin(true);
}
...
$this->sc_ajax_message ($this->autorizar_nc($this->nc_numero ,'S'), "Aviso", "modal = Y & button = Y & button_label = Ok & body_icon = Y & redir = form_del_nota_credito.php", "toast=Y&toasto_pos=center-start&type=success");
...
$update_sql = "UPDATE del_detalle_nota_credito
					SET  
					   dnc_estado='N'
					WHERE
...
function solicitarPago($cliente,$url="https://pay.payphonetodoesposible.com/api/sale"){
$_SESSION['scriptcase']['form_del_nota_credito_mob']['contr_erro'] = 'on';
    ...
    curl_setopt_array($curl, array(
                                ...
                                CURLOPT_HTTPHEADER => array(
                                                        ...
                                                        'Authorization: Bearer sDT59zPuWbEAVMn3hgPdEtdIJ-xdMQ95B6seDq16XR0kSWmv7uVPnlD_iwSffAn2h7BrHOAZEajcOBsMSm5ziqtzlj74oYA5pMJzkjTiFaeUYv9EAcY7QyxTDuLwU3HK4Y-T5kaDeDmXU7UM4UblpOdC_iRIWzgeJhOodI6zwL1im9Rw_OPHuxOpNxugwsHmdEFNXhVRCHBjQaXxkY3TJjNVriz7qp0oUMLmRF3Thpti3Wy64XSokxoiRDacaUWV_IDdpFARvSK06ooTl5bjE8UVrLWwZWVyBUjQqyDMPYn1Ox4Lj7hK4IH4dO9UQChevCwXqw',
                                                        'Cookie: ARRAffinity=2118c1b94788c9bbf269f66dcb86786bb4b694d7068de7ddbb30add8e9606b6f; ARRAffinitySameSite=2118c1b94788c9bbf269f66dcb86786bb4b694d7068de7ddbb30add8e9606b6f'
                                                    ),
                            )
                    );
...
function verificarPago($id_transaccion,$url="https://pay.payphonetodoesposible.com/api/sale"){
$_SESSION['scriptcase']['form_del_nota_credito_mob']['contr_erro'] = 'on';
    ...
    curl_setopt_array($curl, array(
                                    CURLOPT_URL => $url.'/'.$id_transaccion,
                                    CURLOPT_RETURNTRANSFER => true,
                                    CURLOPT_ENCODING => '',
                                    CURLOPT_MAXREDIRS => 10,
                                    CURLOPT_TIMEOUT => 0,
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_del_nota_credito_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function Form_lookup_nc_libretin()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['Lookup_nc_libretin']))
{
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['empty_filter']);
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "nc_establecimiento", $arg_search, str_replace(",", ".", $data_search), "INT4", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "nc_punto_emision", $arg_search, str_replace(",", ".", $data_search), "INT4", false);
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "nc_cliente", $arg_search, str_replace(",", ".", $data_search), "INT4", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "nc_ambiente", $arg_search, str_replace(",", ".", $data_search), "INT4", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "nc_tipo_libretin", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $data_lookup = $this->SC_lookup_nc_libretin($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "nc_libretin", $arg_search, $data_lookup, "INT4", false);
              }
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "nc_error_sri", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "nc_clave", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter_form'] . " and ((nc_numero=" . $_SESSION['var_id_nota_credito'] . ")) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_del_nota_credito_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['total'] = $qt_geral_reg_form_del_nota_credito_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_del_nota_credito_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "nc_numero";$nm_numeric[] = "nc_libretin";$nm_numeric[] = "nc_establecimiento";$nm_numeric[] = "nc_punto_emision";$nm_numeric[] = "nc_secuencial";$nm_numeric[] = "nc_ambiente";$nm_numeric[] = "nc_iddocmod";$nm_numeric[] = "nc_cliente";$nm_numeric[] = "nc_secuencial_docmod";$nm_numeric[] = "nc_subtotal_iva";$nm_numeric[] = "nc_subtotal_cero";$nm_numeric[] = "nc_subtotal_no_objeto";$nm_numeric[] = "nc_subtotal_excento";$nm_numeric[] = "nc_subtotal";$nm_numeric[] = "nc_total_descuento";$nm_numeric[] = "nc_valor_ice";$nm_numeric[] = "nc_valor_iva";$nm_numeric[] = "nc_valor_irbpnr";$nm_numeric[] = "nc_total";
      ...
      $Nm_datas["nc_fecha"] = "date";$Nm_datas["nc_fecha_emison_docmod"] = "date";$Nm_datas[""] = "date";
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_nc_libretin($condicao, $campo)
   {
       $result = array();
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       ...
       {
           $nm_comando = "SELECT est_codigo||' - '||pen_serie, lib_id FROM v_del_libretin WHERE (CAST (lib_id AS TEXT) LIKE '%$campo%') AND (lib_estado='A') AND (est_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') AND (pem_usuario='" . $_SESSION['Igtech_SesionLogin'] . "') AND (lib_tipo_comprobante='04)" ; 
       }
       else
       {
           $nm_comando = "SELECT est_codigo||' - '||pen_serie, lib_id FROM v_del_libretin WHERE (#cmp_iest_codigo||' - '||pen_serie#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos) AND (lib_estado='A') AND (est_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') AND (pem_usuario='" . $_SESSION['Igtech_SesionLogin'] . "') AND (lib_tipo_comprobante='04)" ; 
       }
       if ($condicao == "ii")
       {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_del_nota_credito_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_del_nota_credito_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['masterValue']))
{
...
<?php
  exit;
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "enviar":
                ...
                break;
            case "ride":
                return array("sc_ride_top.", "sc_ride_bot.", "sc_ride_top.", "sc_ride_bot.");
                break;
            case "contabilizar":
                return array("sc_contabilizar_top.", "sc_contabilizar_top.");
                break;
        }
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_credito_mob']['ordem_ord'] == " desc") {
