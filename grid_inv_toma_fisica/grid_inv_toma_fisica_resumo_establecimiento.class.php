...
class grid_inv_toma_fisica_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_inv_bodega_bo_establecimiento;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_inv_bodega_bo_establecimiento = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_inv_toma_fisica']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_inv_toma_fisica']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['contr_total_geral'] == "OK")
      {
          $this->array_total_inv_bodega_bo_establecimiento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['arr_total']['inv_bodega_bo_establecimiento'];
      }
      else
      {
          $this->array_total_inv_bodega_bo_establecimiento = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['arr_total']['inv_bodega_bo_establecimiento'] = $this->array_total_inv_bodega_bo_establecimiento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['json_use_label'])
       {
          $Lab_inv_bodega_bo_establecimiento = "inv_bodega.bo_establecimiento";
       }
       else
       {
       $Lab_inv_bodega_bo_establecimiento = "" . $this->Ini->Nm_lang['lang_establecimiento'] . "";
       }
       $this->comp_field = array(
           $Lab_inv_bodega_bo_establecimiento,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_toma_fisica_tf_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_toma_fisica_tf_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_bodega_bo_establecimiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_bodega_bo_establecimiento'] = "" . $this->Ini->Nm_lang['lang_establecimiento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_toma_fisica_tf_bodega']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_toma_fisica_tf_bodega'] = "" . $this->Ini->Nm_lang['lang_bodega'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_toma_fisica_tf_comentario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_toma_fisica_tf_comentario'] = "" . $this->Ini->Nm_lang['lang_comentario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_toma_fisica_tf_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_toma_fisica_tf_estado'] = "" . $this->Ini->Nm_lang['lang_estado'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_toma_fisica_tf_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_toma_fisica_tf_id'] = "Tf Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_toma_fisica_tf_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['labels']['inv_toma_fisica_tf_usuario'] = "Tf Usuario"; 
       }
       //-----
       $this->comp_field_nm = array(
           'inv_bodega_bo_establecimiento' => 0,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['summarizing_fields_order']['establecimiento']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['summarizing_fields_order']['establecimiento'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['summarizing_fields_order']['establecimiento'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['summarizing_fields_display']['establecimiento'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['summarizing_fields_display']['establecimiento'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['summarizing_fields_display']['establecimiento'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['summarizing_fields_display']['establecimiento'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['summarizing_fields_display']['establecimiento'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['summarizing_fields_display']['establecimiento'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['summarizing_fields_display']['establecimiento'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_inv_bodega_bo_establecimiento as $i_inv_bodega_bo_establecimiento => $d_inv_bodega_bo_establecimiento) {
           if (!isset($i_inv_bodega_bo_establecimiento, $this->comp_label[0]) || !in_array($i_inv_bodega_bo_establecimiento, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_inv_bodega_bo_establecimiento[2] ] = $d_inv_bodega_bo_establecimiento[1];
               $this->comp_label[0][ $d_inv_bodega_bo_establecimiento[2] ] = $d_inv_bodega_bo_establecimiento[1];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'inv_bodega_bo_establecimiento', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_inv_bodega_bo_establecimiento => $l_inv_bodega_bo_establecimiento) {
           if (isset($this->array_total_inv_bodega_bo_establecimiento[$i_inv_bodega_bo_establecimiento])) {
               $this->comp_group[$i_inv_bodega_bo_establecimiento] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_inv_bodega_bo_establecimiento;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_inv_toma_fisica@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_inv_toma_fisica_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_establecimiento("res", $this->NM_export);
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_inv_bodega_bo_establecimiento)) {
          ksort($this->array_total_inv_bodega_bo_establecimiento);
      }
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['ajax_nav']) {  
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_inv_toma_fisica_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_inv_toma_fisica_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_inv_toma_fisica_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_inv_toma_fisica/grid_inv_toma_fisica_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_inv_toma_fisica/grid_inv_toma_fisica_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_inv_toma_fisica/grid_inv_toma_fisica_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_inv_toma_fisica&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_inv_toma_fisica/grid_inv_toma_fisica_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_inv_toma_fisica/grid_inv_toma_fisica_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid&nm_all_modules=grid&nm_json_format=N&nm_json_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_inv_toma_fisica/grid_inv_toma_fisica_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_inv_toma_fisica_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_inv_toma_fisica/grid_inv_toma_fisica_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_inv_toma_fisica/grid_inv_toma_fisica_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_inv_toma_fisica/grid_inv_toma_fisica_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_inv_toma_fisica']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_inv_toma_fisica']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_inv_toma_fisica_config_pivot.php?nome_apl=grid_inv_toma_fisica&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_inv_toma_fisica_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_inv_toma_fisica_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_inv_toma_fisica/grid_inv_toma_fisica_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inv_toma_fisica']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $inv_toma_fisica_tf_fecha = (isset($Busca_temp['inv_toma_fisica_tf_fecha'])) ? $Busca_temp['inv_toma_fisica_tf_fecha'] : ""; 
          $tmp_pos = (is_string($inv_toma_fisica_tf_fecha)) ? strpos($inv_toma_fisica_tf_fecha, "##@@") : false;
          if ($tmp_pos !== false && !is_array($inv_toma_fisica_tf_fecha))
          {
              $inv_toma_fisica_tf_fecha = substr($inv_toma_fisica_tf_fecha, 0, $tmp_pos);
          }
          $inv_toma_fisica_tf_fecha_2 = (isset($Busca_temp['inv_toma_fisica_tf_fecha_input_2'])) ? $Busca_temp['inv_toma_fisica_tf_fecha_input_2'] : ""; 
          $inv_bodega_bo_establecimiento = (isset($Busca_temp['inv_bodega_bo_establecimiento'])) ? $Busca_temp['inv_bodega_bo_establecimiento'] : ""; 
          $tmp_pos = (is_string($inv_bodega_bo_establecimiento)) ? strpos($inv_bodega_bo_establecimiento, "##@@") : false;
          if ($tmp_pos !== false && !is_array($inv_bodega_bo_establecimiento))
          {
              $inv_bodega_bo_establecimiento = substr($inv_bodega_bo_establecimiento, 0, $tmp_pos);
          }
          $inv_toma_fisica_tf_bodega = (isset($Busca_temp['inv_toma_fisica_tf_bodega'])) ? $Busca_temp['inv_toma_fisica_tf_bodega'] : ""; 
          $tmp_pos = (is_string($inv_toma_fisica_tf_bodega)) ? strpos($inv_toma_fisica_tf_bodega, "##@@") : false;
          if ($tmp_pos !== false && !is_array($inv_toma_fisica_tf_bodega))
          {
              $inv_toma_fisica_tf_bodega = substr($inv_toma_fisica_tf_bodega, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($quebra_inv_bodega_bo_establecimiento, $quebra_inv_bodega_bo_establecimiento_orig)
   {
      //----- inv_bodega_bo_establecimiento
      if (!isset($this->array_total_inv_bodega_bo_establecimiento[$quebra_inv_bodega_bo_establecimiento_orig]))
      {
         $this->array_total_inv_bodega_bo_establecimiento[$quebra_inv_bodega_bo_establecimiento_orig][0] = 1;
         $this->array_total_inv_bodega_bo_establecimiento[$quebra_inv_bodega_bo_establecimiento_orig][1] = $quebra_inv_bodega_bo_establecimiento;
         $this->array_total_inv_bodega_bo_establecimiento[$quebra_inv_bodega_bo_establecimiento_orig][2] = $quebra_inv_bodega_bo_establecimiento_orig;
      }
      else
      {
         $this->array_total_inv_bodega_bo_establecimiento[$quebra_inv_bodega_bo_establecimiento_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->inv_toma_fisica_tf_fecha = $Busca_temp['inv_toma_fisica_tf_fecha']; 
       $this->inv_toma_fisica_tf_fecha = (isset($Busca_temp['inv_toma_fisica_tf_fecha'])) ? $Busca_temp['inv_toma_fisica_tf_fecha'] : ""; 
       $tmp_pos = (is_string($this->inv_toma_fisica_tf_fecha)) ? strpos($this->inv_toma_fisica_tf_fecha, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->inv_toma_fisica_tf_fecha))
       {
       ...
       $inv_toma_fisica_tf_fecha_2 = (isset($Busca_temp['inv_toma_fisica_tf_fecha_input_2'])) ? $Busca_temp['inv_toma_fisica_tf_fecha_input_2'] : ""; 
       $this->inv_toma_fisica_tf_fecha_2 = $inv_toma_fisica_tf_fecha_2; 
       $this->inv_bodega_bo_establecimiento = $Busca_temp['inv_bodega_bo_establecimiento']; 
       $this->inv_bodega_bo_establecimiento = (isset($Busca_temp['inv_bodega_bo_establecimiento'])) ? $Busca_temp['inv_bodega_bo_establecimiento'] : ""; 
       $tmp_pos = (is_string($this->inv_bodega_bo_establecimiento)) ? strpos($this->inv_bodega_bo_establecimiento, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->inv_bodega_bo_establecimiento))
       {
       ...
       $this->inv_toma_fisica_tf_bodega = $Busca_temp['inv_toma_fisica_tf_bodega']; 
       $this->inv_toma_fisica_tf_bodega = (isset($Busca_temp['inv_toma_fisica_tf_bodega'])) ? $Busca_temp['inv_toma_fisica_tf_bodega'] : ""; 
       $tmp_pos = (is_string($this->inv_toma_fisica_tf_bodega)) ? strpos($this->inv_toma_fisica_tf_bodega, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->inv_toma_fisica_tf_bodega))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('establecimiento', 'inv_bodega_bo_establecimiento');
     $campos_order = $this->Ini->Get_date_order_groupby("inv_bodega.bo_establecimiento", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->inv_toma_fisica_tf_fecha = $rs_res->fields[0] ;  
            $this->inv_bodega_bo_establecimiento = $rs_res->fields[1] ;  
            $this->inv_toma_fisica_tf_bodega = $rs_res->fields[2] ;  
            $this->inv_toma_fisica_tf_comentario = $rs_res->fields[3] ;  
            $this->inv_toma_fisica_tf_estado = $rs_res->fields[4] ;  
            $this->inv_toma_fisica_tf_id = $rs_res->fields[5] ;  
            $this->look_inv_bodega_bo_establecimiento = $this->inv_bodega_bo_establecimiento; 
            $this->Lookup->lookup_inv_bodega_bo_establecimiento($this->look_inv_bodega_bo_establecimiento, $this->inv_bodega_bo_establecimiento) ; 
            $this->inv_bodega_bo_establecimiento_orig = $this->inv_bodega_bo_establecimiento;
            $this->inv_bodega_bo_establecimiento = $this->look_inv_bodega_bo_establecimiento ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->inv_bodega_bo_establecimiento, $this->inv_bodega_bo_establecimiento_orig);
            }
   }
//
