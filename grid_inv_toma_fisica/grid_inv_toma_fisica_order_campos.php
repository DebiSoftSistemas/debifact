...
<?php
   ...
   $Ord_Cmp = new grid_inv_toma_fisica_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_inv_toma_fisica_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['inv_toma_fisica_tf_fecha'] = "inv_toma_fisica_tf_fecha";
   }
   else
   {
       $tab_def_campos['inv_toma_fisica_tf_fecha'] = "inv_toma_fisica.tf_fecha";
   }
   $tab_labels["inv_toma_fisica_tf_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['labels']["inv_toma_fisica_tf_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['labels']["inv_toma_fisica_tf_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['inv_bodega_bo_establecimiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['inv_bodega_bo_establecimiento'] = "inv_bodega_bo_establecimiento";
   }
   else
   {
       $tab_def_campos['inv_bodega_bo_establecimiento'] = "inv_bodega.bo_establecimiento";
   }
   $tab_labels["inv_bodega_bo_establecimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['labels']["inv_bodega_bo_establecimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['labels']["inv_bodega_bo_establecimiento"] : "" . $this->Nm_lang['lang_establecimiento'] . "";
   $tab_ger_campos['inv_toma_fisica_tf_bodega'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['inv_toma_fisica_tf_bodega'] = "inv_toma_fisica_tf_bodega";
   }
   else
   {
       $tab_def_campos['inv_toma_fisica_tf_bodega'] = "inv_toma_fisica.tf_bodega";
   }
   $tab_labels["inv_toma_fisica_tf_bodega"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['labels']["inv_toma_fisica_tf_bodega"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['labels']["inv_toma_fisica_tf_bodega"] : "" . $this->Nm_lang['lang_bodega'] . "";
   $tab_ger_campos['inv_toma_fisica_tf_comentario'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['inv_toma_fisica_tf_comentario'] = "inv_toma_fisica_tf_comentario";
   }
   else
   {
       $tab_def_campos['inv_toma_fisica_tf_comentario'] = "inv_toma_fisica.tf_comentario";
   }
   $tab_labels["inv_toma_fisica_tf_comentario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['labels']["inv_toma_fisica_tf_comentario"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['labels']["inv_toma_fisica_tf_comentario"] : "" . $this->Nm_lang['lang_comentario'] . "";
   $tab_ger_campos['inv_toma_fisica_tf_estado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['inv_toma_fisica_tf_estado'] = "inv_toma_fisica_tf_estado";
   }
   else
   {
       $tab_def_campos['inv_toma_fisica_tf_estado'] = "inv_toma_fisica.tf_estado";
   }
   $tab_labels["inv_toma_fisica_tf_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['labels']["inv_toma_fisica_tf_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['labels']["inv_toma_fisica_tf_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_inv_toma_fisica_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_inv_toma_fisica']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
