...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_inv_toma_fisica"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_inv_toma_fisica"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_inv_toma_fisica'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inv_toma_fisica']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_inv_toma_fisica']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inv_toma_fisica']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_inv_toma_fisica']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_inv_toma_fisica']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_inv_toma_fisica</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_inv_toma_fisica']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_inv_toma_fisica']['embutida_filho'] as $ind => $sc_init)
          {
