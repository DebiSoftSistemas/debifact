...
$old_error_handler = set_error_handler("form_fac_pagos_libretines_deuna_scriptcase_error_handler");

function form_fac_pagos_libretines_deuna_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_fac_pagos_libretines_deuna']['contr_erro']) && $_SESSION['scriptcase']['form_fac_pagos_libretines_deuna']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_fac_pagos_libretines_deuna->contr_form_fac_pagos_libretines_deuna->Apl_com_erro = true;
            if ($inicial_form_fac_pagos_libretines_deuna->contr_form_fac_pagos_libretines_deuna->NM_ajax_flag)
            {
                $inicial_form_fac_pagos_libretines_deuna->contr_form_fac_pagos_libretines_deuna->NM_ajax_info['errList']['geral_form_fac_pagos_libretines_deuna'][] = $msg;
                return;
            }
            form_fac_pagos_libretines_deuna_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_fac_pagos_libretines_deuna_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_fac_pagos_libretines_deuna'])  && '' != $_SESSION['scriptcase']['error_icon']['form_fac_pagos_libretines_deuna'])  ? $_SESSION['scriptcase']['error_icon']['form_fac_pagos_libretines_deuna']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_fac_pagos_libretines_deuna']) && '' != $_SESSION['scriptcase']['error_span_title']['form_fac_pagos_libretines_deuna']) ? $_SESSION['scriptcase']['error_span_title']['form_fac_pagos_libretines_deuna'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_fac_pagos_libretines_deuna']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_fac_pagos_libretines_deuna']) ? $_SESSION['scriptcase']['error_icon_title']['form_fac_pagos_libretines_deuna'] : '';
?>
