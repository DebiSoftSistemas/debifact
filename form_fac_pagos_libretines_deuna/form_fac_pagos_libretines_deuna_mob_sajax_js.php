  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_pagos_libretines_deuna_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_pagos_libretines_deuna_mob_form();
	}
...
?>
  ...
  // ---------- Validate pag_id
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_id()
  {
    var nomeCampo_pag_id = "pag_id";
    var var_pag_id = scAjaxGetFieldHidden(nomeCampo_pag_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_id(var_pag_id, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_id_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_id

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_id_cb

  // ---------- Validate pag_empresa
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_empresa()
  {
    var nomeCampo_pag_empresa = "pag_empresa";
    var var_pag_empresa = scAjaxGetFieldText(nomeCampo_pag_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_empresa(var_pag_empresa, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_empresa_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_empresa

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_empresa_cb

  // ---------- Validate pag_mensaje
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_mensaje()
  {
    var nomeCampo_pag_mensaje = "pag_mensaje";
    var var_pag_mensaje = scAjaxGetFieldHidden(nomeCampo_pag_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_mensaje(var_pag_mensaje, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_mensaje_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_mensaje

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_mensaje";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_mensaje_cb

  // ---------- Validate pag_qr
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_qr()
  {
    var nomeCampo_pag_qr = "pag_qr";
    var var_pag_qr = scAjaxGetFieldText(nomeCampo_pag_qr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_qr(var_pag_qr, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_qr_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_qr

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_qr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_qr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_qr_cb

  // ---------- Validate pag_metodo_pago
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_metodo_pago()
  {
    var nomeCampo_pag_metodo_pago = "pag_metodo_pago";
    var var_pag_metodo_pago = scAjaxGetFieldSelect(nomeCampo_pag_metodo_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_metodo_pago(var_pag_metodo_pago, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_metodo_pago_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_metodo_pago

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_metodo_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_metodo_pago";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_metodo_pago_cb

  // ---------- Validate pag_fecha
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_fecha()
  {
    var nomeCampo_pag_fecha = "pag_fecha";
    var var_pag_fecha = scAjaxGetFieldText(nomeCampo_pag_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_fecha(var_pag_fecha, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_fecha_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_fecha

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_fecha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_fecha_cb

  // ---------- Validate pag_banco_origen
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_banco_origen()
  {
    var nomeCampo_pag_banco_origen = "pag_banco_origen";
    var var_pag_banco_origen = scAjaxGetFieldText(nomeCampo_pag_banco_origen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_banco_origen(var_pag_banco_origen, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_banco_origen_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_banco_origen

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_banco_origen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_banco_origen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_banco_origen_cb

  // ---------- Validate pag_cuenta_origen
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_cuenta_origen()
  {
    var nomeCampo_pag_cuenta_origen = "pag_cuenta_origen";
    var var_pag_cuenta_origen = scAjaxGetFieldText(nomeCampo_pag_cuenta_origen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_cuenta_origen(var_pag_cuenta_origen, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_cuenta_origen_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_cuenta_origen

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_cuenta_origen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_cuenta_origen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_cuenta_origen_cb

  // ---------- Validate pag_documento
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_documento()
  {
    var nomeCampo_pag_documento = "pag_documento";
    var var_pag_documento = scAjaxGetFieldText(nomeCampo_pag_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_documento(var_pag_documento, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_documento_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_documento

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_documento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_documento_cb

  // ---------- Validate pag_monto
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_monto()
  {
    var nomeCampo_pag_monto = "pag_monto";
    var var_pag_monto = scAjaxGetFieldHidden(nomeCampo_pag_monto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_monto(var_pag_monto, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_monto_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_monto

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_monto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_monto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_monto_cb

  // ---------- Validate pag_cuenta_destino
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_cuenta_destino()
  {
    var nomeCampo_pag_cuenta_destino = "pag_cuenta_destino";
    var var_pag_cuenta_destino = scAjaxGetFieldSelect(nomeCampo_pag_cuenta_destino);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_cuenta_destino(var_pag_cuenta_destino, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_cuenta_destino_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_cuenta_destino

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_cuenta_destino_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_cuenta_destino";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_cuenta_destino_cb

  // ---------- Validate pag_usuario_paga
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_usuario_paga()
  {
    var nomeCampo_pag_usuario_paga = "pag_usuario_paga";
    var var_pag_usuario_paga = scAjaxGetFieldText(nomeCampo_pag_usuario_paga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_usuario_paga(var_pag_usuario_paga, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_usuario_paga_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_usuario_paga

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_usuario_paga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_usuario_paga";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_usuario_paga_cb

  // ---------- Validate pag_estado
  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_estado()
  {
    var nomeCampo_pag_estado = "pag_estado";
    var var_pag_estado = scAjaxGetFieldHidden(nomeCampo_pag_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_estado(var_pag_estado, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_estado_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_estado

  function do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_estado_cb

  // ---------- Event onchange pag_metodo_pago
  function do_ajax_form_fac_pagos_libretines_deuna_mob_event_pag_metodo_pago_onchange()
  {
    var var_pag_metodo_pago = scAjaxGetFieldSelect("pag_metodo_pago");
    var var_pag_banco_origen = scAjaxGetFieldText("pag_banco_origen");
    var var_pag_cuenta_origen = scAjaxGetFieldText("pag_cuenta_origen");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_pagos_libretines_deuna_mob_event_pag_metodo_pago_onchange(var_pag_metodo_pago, var_pag_banco_origen, var_pag_cuenta_origen, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_event_pag_metodo_pago_onchange_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_event_pag_metodo_pago_onchange

  function do_ajax_form_fac_pagos_libretines_deuna_mob_event_pag_metodo_pago_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pag_metodo_pago";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_pagos_libretines_deuna_mob_event_pag_metodo_pago_onchange_cb_after_alert);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_event_pag_metodo_pago_onchange_cb
  function do_ajax_form_fac_pagos_libretines_deuna_mob_event_pag_metodo_pago_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_event_pag_metodo_pago_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_pagos_libretines_deuna_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_pagos_libretines_deuna_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pag_id = scAjaxGetFieldHidden("pag_id");
    var var_pag_empresa = scAjaxGetFieldText("pag_empresa");
    var var_pag_mensaje = scAjaxGetFieldHidden("pag_mensaje");
    var var_pag_qr = "";
    var var_pag_metodo_pago = scAjaxGetFieldSelect("pag_metodo_pago");
    var var_pag_fecha = scAjaxGetFieldText("pag_fecha");
    var var_pag_banco_origen = scAjaxGetFieldText("pag_banco_origen");
    var var_pag_cuenta_origen = scAjaxGetFieldText("pag_cuenta_origen");
    var var_pag_documento = scAjaxGetFieldText("pag_documento");
    var var_pag_monto = scAjaxGetFieldHidden("pag_monto");
    var var_pag_cuenta_destino = scAjaxGetFieldSelect("pag_cuenta_destino");
    var var_pag_usuario_paga = scAjaxGetFieldText("pag_usuario_paga");
    var var_pag_estado = scAjaxGetFieldHidden("pag_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_fac_pagos_libretines_deuna_mob_submit_form(var_pag_id, var_pag_empresa, var_pag_mensaje, var_pag_qr, var_pag_metodo_pago, var_pag_fecha, var_pag_banco_origen, var_pag_cuenta_origen, var_pag_documento, var_pag_monto, var_pag_cuenta_destino, var_pag_usuario_paga, var_pag_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_pagos_libretines_deuna_mob_submit_form_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_submit_form

  function do_ajax_form_fac_pagos_libretines_deuna_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pag_id");
      scAjaxHideErrorDisplay("pag_empresa");
      scAjaxHideErrorDisplay("pag_mensaje");
      scAjaxHideErrorDisplay("pag_qr");
      scAjaxHideErrorDisplay("pag_metodo_pago");
      scAjaxHideErrorDisplay("pag_fecha");
      scAjaxHideErrorDisplay("pag_banco_origen");
      scAjaxHideErrorDisplay("pag_cuenta_origen");
      scAjaxHideErrorDisplay("pag_documento");
      scAjaxHideErrorDisplay("pag_monto");
      scAjaxHideErrorDisplay("pag_cuenta_destino");
      scAjaxHideErrorDisplay("pag_usuario_paga");
      scAjaxHideErrorDisplay("pag_estado");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_pagos_libretines_deuna_mob_submit_form_cb_after_alert);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_submit_form_cb
  function do_ajax_form_fac_pagos_libretines_deuna_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_pagos_libretines_deuna_mob_navigate_form()
  {
    perform_ajax_form_fac_pagos_libretines_deuna_mob_navigate_form();
  }

  function perform_ajax_form_fac_pagos_libretines_deuna_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("pag_usuario_paga");
    scAjaxHideErrorDisplay("pag_estado");
    var var_pag_id = document.F2.pag_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_pagos_libretines_deuna_mob_navigate_form(var_pag_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_mob_navigate_form_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_pagos_libretines_deuna_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.pag_id.value = scAjaxGetKeyValue("pag_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_pagos_libretines_deuna_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_navigate_form_cb
  function do_ajax_form_fac_pagos_libretines_deuna_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_fac_pagos_libretines_deuna_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_pagos_libretines_deuna_mob_navigate_form_cb_after_alert

  function sc_hide_form_fac_pagos_libretines_deuna_mob_form()
  {
  ...
  ajax_field_list[0] = "pag_id";
  ajax_field_list[1] = "pag_empresa";
  ajax_field_list[2] = "pag_mensaje";
  ajax_field_list[3] = "pag_qr";
  ajax_field_list[4] = "pag_metodo_pago";
  ajax_field_list[5] = "pag_fecha";
  ajax_field_list[6] = "pag_banco_origen";
  ajax_field_list[7] = "pag_cuenta_origen";
  ajax_field_list[8] = "pag_documento";
  ajax_field_list[9] = "pag_monto";
  ajax_field_list[10] = "pag_cuenta_destino";
  ajax_field_list[11] = "pag_usuario_paga";
  ajax_field_list[12] = "pag_estado";
  ...
  var ajax_error_list = {
    "pag_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pag_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pag_mensaje": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pag_qr": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pag_metodo_pago": {"label": "<?php echo $this->Ini->Nm_lang['lang_metodo_pago'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pag_fecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pag_banco_origen": {"label": "<?php echo $this->Ini->Nm_lang['lang_banco_origen'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pag_cuenta_origen": {"label": "<?php echo $this->Ini->Nm_lang['lang_cuenta_origen'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pag_documento": {"label": "<?php echo $this->Ini->Nm_lang['lang_numero_documento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pag_monto": {"label": "<?php echo $this->Ini->Nm_lang['lang_valor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pag_cuenta_destino": {"label": "<?php echo $this->Ini->Nm_lang['lang_cuenta_destino'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pag_usuario_paga": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario_paga'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pag_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "pag_id": new Array(),
    "pag_empresa": new Array(),
    "pag_mensaje": new Array(),
    "pag_qr": new Array(),
    "pag_metodo_pago": new Array(),
    "pag_fecha": new Array(),
    "pag_banco_origen": new Array(),
    "pag_cuenta_origen": new Array(),
    "pag_documento": new Array(),
    "pag_monto": new Array(),
    "pag_cuenta_destino": new Array(),
    "pag_usuario_paga": new Array(),
    "pag_estado": new Array()
  };
  ajax_field_mult["pag_id"][1] = "pag_id";
  ajax_field_mult["pag_empresa"][1] = "pag_empresa";
  ajax_field_mult["pag_mensaje"][1] = "pag_mensaje";
  ajax_field_mult["pag_qr"][1] = "pag_qr";
  ajax_field_mult["pag_metodo_pago"][1] = "pag_metodo_pago";
  ajax_field_mult["pag_fecha"][1] = "pag_fecha";
  ajax_field_mult["pag_banco_origen"][1] = "pag_banco_origen";
  ajax_field_mult["pag_cuenta_origen"][1] = "pag_cuenta_origen";
  ajax_field_mult["pag_documento"][1] = "pag_documento";
  ajax_field_mult["pag_monto"][1] = "pag_monto";
  ajax_field_mult["pag_cuenta_destino"][1] = "pag_cuenta_destino";
  ajax_field_mult["pag_usuario_paga"][1] = "pag_usuario_paga";
  ajax_field_mult["pag_estado"][1] = "pag_estado";

  var ajax_field_id = {
    "pag_mensaje": new Array("hidden_field_label_pag_mensaje", "hidden_field_data_pag_mensaje"),
    "pag_qr": new Array("hidden_field_label_pag_qr", "hidden_field_data_pag_qr"),
    "pag_fecha": new Array("hidden_field_label_pag_fecha", "hidden_field_data_pag_fecha"),
    "pag_banco_origen": new Array("hidden_field_label_pag_banco_origen", "hidden_field_data_pag_banco_origen"),
    "pag_cuenta_origen": new Array("hidden_field_label_pag_cuenta_origen", "hidden_field_data_pag_cuenta_origen"),
    "pag_documento": new Array("hidden_field_label_pag_documento", "hidden_field_data_pag_documento"),
    "pag_monto": new Array("hidden_field_label_pag_monto", "hidden_field_data_pag_monto")
  };
  ...
  var ajax_read_only = {
    ...
    "pag_metodo_pago": "off",
    "pag_fecha": "off",
    "pag_banco_origen": "off",
    "pag_cuenta_origen": "off",
    "pag_documento": "off",
    "pag_monto": "off",
    "pag_cuenta_destino": "off",
    "pag_usuario_paga": "off",
    "pag_estado": "off"
  };
