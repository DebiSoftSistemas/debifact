...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_fac_pagos_libretines_deuna/form_fac_pagos_libretines_deuna_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_fac_pagos_libretines_deuna_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_fac_pagos_libretines_deuna_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['link_info']['remove_border']) {
...
<?php
 include_once("form_fac_pagos_libretines_deuna_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_fac_pagos_libretines_deuna'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_fac_pagos_libretines_deuna'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-1';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
   ...
   if (!isset($this->nmgp_cmp_hidden['pag_metodo_pago']))
   {
       $this->nmgp_cmp_hidden['pag_metodo_pago'] = 'off';
   }
   ...
   if (!isset($this->nmgp_cmp_hidden['pag_cuenta_destino']))
   {
       $this->nmgp_cmp_hidden['pag_cuenta_destino'] = 'off';
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pag_empresa_label" id="hidden_field_label_pag_empresa" style="<?php echo $sStyleHidden_pag_empresa; ?>"><span id="id_label_pag_empresa"><?php echo $this->nm_new_label['pag_empresa']; ?></span></TD>
    <TD class="scFormDataOdd css_pag_empresa_line" id="hidden_field_data_pag_empresa" style="<?php echo $sStyleHidden_pag_empresa; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pag_empresa_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pag_mensaje_label" id="hidden_field_label_pag_mensaje" style="<?php echo $sStyleHidden_pag_mensaje; ?>"><span id="id_label_pag_mensaje"><?php echo $this->nm_new_label['pag_mensaje']; ?></span></TD>
    <TD class="scFormDataOdd css_pag_mensaje_line" id="hidden_field_data_pag_mensaje" style="<?php echo $sStyleHidden_pag_mensaje; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pag_mensaje_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="pag_mensaje" value="<?php echo $this->form_encode_input($pag_mensaje); ?>"><span id="id_ajax_label_pag_mensaje"><?php echo nl2br($pag_mensaje); ?></span>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['pag_qr']))
    {
        $this->nm_new_label['pag_qr'] = "";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $pag_qr = $this->pag_qr;
   $sStyleHidden_pag_qr = '';
   if (isset($this->nmgp_cmp_hidden['pag_qr']) && $this->nmgp_cmp_hidden['pag_qr'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['pag_qr']);
       $sStyleHidden_pag_qr = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_pag_qr = 'display: none;';
   $sStyleReadInp_pag_qr = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['pag_qr']) && $this->nmgp_cmp_readonly['pag_qr'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['pag_qr']);
       $sStyleReadLab_pag_qr = '';
       $sStyleReadInp_pag_qr = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['pag_qr']) && $this->nmgp_cmp_hidden['pag_qr'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="pag_qr" value="<?php echo $this->form_encode_input($pag_qr) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_pag_qr_label" id="hidden_field_label_pag_qr" style="<?php echo $sStyleHidden_pag_qr; ?>"><span id="id_label_pag_qr"><?php echo $this->nm_new_label['pag_qr']; ?></span></TD>
    <TD class="scFormDataOdd css_pag_qr_line" id="hidden_field_data_pag_qr" style="<?php echo $sStyleHidden_pag_qr; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pag_qr_line" style="vertical-align: top;padding: 0px"><?php
          ...
          { 
              if ($this->Ini->Export_img_zip) {
                  $this->Ini->Img_export_zip[] = $this->Ini->root . $this->Ini->path_imag_cab . "/grp__NM__img__NM__deuna.jpg";
                  $pag_qr = "<img border=\"0\" src=\"grp__NM__img__NM__deuna.jpg\"/>" ; 
              }
              else {
...
?>
<span id="id_imghtml_pag_qr"><?php echo $pag_qr; ?>
</span>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["pag_qr"]) &&  $this->nmgp_cmp_readonly["pag_qr"] == "on") { 

 ?>
<input type="hidden" name="pag_qr" value="<?php echo $this->form_encode_input($pag_qr) . "\">" . $pag_qr . ""; ?>
<?php } else { ?>
<span id="id_read_on_pag_qr" class="sc-ui-readonly-pag_qr css_pag_qr_line" style="<?php echo $sStyleReadLab_pag_qr; ?>"><?php echo $this->form_format_readonly("pag_qr", $this->form_encode_input($this->pag_qr)); ?></span><span id="id_read_off_pag_qr" class="css_read_off_pag_qr<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_pag_qr; ?>"></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_pag_qr_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_pag_qr_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pag_metodo_pago_label" id="hidden_field_label_pag_metodo_pago" style="<?php echo $sStyleHidden_pag_metodo_pago; ?>"><span id="id_label_pag_metodo_pago"><?php echo $this->nm_new_label['pag_metodo_pago']; ?></span></TD>
    <TD class="scFormDataOdd css_pag_metodo_pago_line" id="hidden_field_data_pag_metodo_pago" style="<?php echo $sStyleHidden_pag_metodo_pago; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pag_metodo_pago_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pag_fecha_label" id="hidden_field_label_pag_fecha" style="<?php echo $sStyleHidden_pag_fecha; ?>"><span id="id_label_pag_fecha"><?php echo $this->nm_new_label['pag_fecha']; ?></span></TD>
    <TD class="scFormDataOdd css_pag_fecha_line" id="hidden_field_data_pag_fecha" style="<?php echo $sStyleHidden_pag_fecha; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pag_fecha_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pag_banco_origen_label" id="hidden_field_label_pag_banco_origen" style="<?php echo $sStyleHidden_pag_banco_origen; ?>"><span id="id_label_pag_banco_origen"><?php echo $this->nm_new_label['pag_banco_origen']; ?></span></TD>
    <TD class="scFormDataOdd css_pag_banco_origen_line" id="hidden_field_data_pag_banco_origen" style="<?php echo $sStyleHidden_pag_banco_origen; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pag_banco_origen_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pag_cuenta_origen_label" id="hidden_field_label_pag_cuenta_origen" style="<?php echo $sStyleHidden_pag_cuenta_origen; ?>"><span id="id_label_pag_cuenta_origen"><?php echo $this->nm_new_label['pag_cuenta_origen']; ?></span></TD>
    <TD class="scFormDataOdd css_pag_cuenta_origen_line" id="hidden_field_data_pag_cuenta_origen" style="<?php echo $sStyleHidden_pag_cuenta_origen; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pag_cuenta_origen_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pag_documento_label" id="hidden_field_label_pag_documento" style="<?php echo $sStyleHidden_pag_documento; ?>"><span id="id_label_pag_documento"><?php echo $this->nm_new_label['pag_documento']; ?></span></TD>
    <TD class="scFormDataOdd css_pag_documento_line" id="hidden_field_data_pag_documento" style="<?php echo $sStyleHidden_pag_documento; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pag_documento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pag_monto_label" id="hidden_field_label_pag_monto" style="<?php echo $sStyleHidden_pag_monto; ?>"><span id="id_label_pag_monto"><?php echo $this->nm_new_label['pag_monto']; ?></span></TD>
    <TD class="scFormDataOdd css_pag_monto_line" id="hidden_field_data_pag_monto" style="<?php echo $sStyleHidden_pag_monto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pag_monto_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="pag_monto" value="<?php echo $this->form_encode_input($pag_monto); ?>"><span id="id_ajax_label_pag_monto"><?php echo nl2br($pag_monto); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pag_cuenta_destino_label" id="hidden_field_label_pag_cuenta_destino" style="<?php echo $sStyleHidden_pag_cuenta_destino; ?>"><span id="id_label_pag_cuenta_destino"><?php echo $this->nm_new_label['pag_cuenta_destino']; ?></span></TD>
    <TD class="scFormDataOdd css_pag_cuenta_destino_line" id="hidden_field_data_pag_cuenta_destino" style="<?php echo $sStyleHidden_pag_cuenta_destino; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pag_cuenta_destino_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pag_usuario_paga_label" id="hidden_field_label_pag_usuario_paga" style="<?php echo $sStyleHidden_pag_usuario_paga; ?>"><span id="id_label_pag_usuario_paga"><?php echo $this->nm_new_label['pag_usuario_paga']; ?></span></TD>
    <TD class="scFormDataOdd css_pag_usuario_paga_line" id="hidden_field_data_pag_usuario_paga" style="<?php echo $sStyleHidden_pag_usuario_paga; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pag_usuario_paga_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pag_estado_label" id="hidden_field_label_pag_estado" style="<?php echo $sStyleHidden_pag_estado; ?>"><span id="id_label_pag_estado"><?php echo $this->nm_new_label['pag_estado']; ?></span></TD>
    <TD class="scFormDataOdd css_pag_estado_line" id="hidden_field_data_pag_estado" style="<?php echo $sStyleHidden_pag_estado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pag_estado_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="pag_estado" value="<?php echo $this->form_encode_input($pag_estado); ?>"><span id="id_ajax_label_pag_estado"><?php echo nl2br($pag_estado); ?></span>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['btn_label']['delete'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_fac_pagos_libretines_deuna");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_fac_pagos_libretines_deuna");
 parent.scAjaxDetailHeight("form_fac_pagos_libretines_deuna", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
