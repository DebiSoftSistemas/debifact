<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="pag_id" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['pag_id']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_fac_pagos_libretines_deuna"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['where_detal']))
  {
?>  
