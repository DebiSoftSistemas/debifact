...
function scHidePage(pageNo) {
	$("#id_form_fac_pagos_libretines_deuna_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_pag_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  $("#id_sc_field_pag_fecha_procesa" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_fac_pagos_libretines_deuna_mob_validate_pag_fecha_procesa(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_fac_pagos_libretines_deuna_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
