  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_pagos_libretines_deuna" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_pagos_libretines_deuna_form();
	}
...
?>
  ...
  // ---------- Validate pag_id
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_id()
  {
    var nomeCampo_pag_id = "pag_id";
    var var_pag_id = scAjaxGetFieldHidden(nomeCampo_pag_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_id(var_pag_id, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_id_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_id

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_id_cb

  // ---------- Validate pag_empresa
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_empresa()
  {
    var nomeCampo_pag_empresa = "pag_empresa";
    var var_pag_empresa = scAjaxGetFieldText(nomeCampo_pag_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_empresa(var_pag_empresa, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_empresa_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_empresa

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_empresa_cb

  // ---------- Validate pag_mensaje
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_mensaje()
  {
    var nomeCampo_pag_mensaje = "pag_mensaje";
    var var_pag_mensaje = scAjaxGetFieldHidden(nomeCampo_pag_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_mensaje(var_pag_mensaje, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_mensaje_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_mensaje

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_mensaje_cb

  // ---------- Validate pag_qr
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_qr()
  {
    var nomeCampo_pag_qr = "pag_qr";
    var var_pag_qr = scAjaxGetFieldText(nomeCampo_pag_qr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_qr(var_pag_qr, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_qr_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_qr

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_qr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pag_qr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_qr_cb

  // ---------- Validate pag_metodo_pago
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_metodo_pago()
  {
    var nomeCampo_pag_metodo_pago = "pag_metodo_pago";
    var var_pag_metodo_pago = scAjaxGetFieldSelect(nomeCampo_pag_metodo_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_metodo_pago(var_pag_metodo_pago, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_metodo_pago_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_metodo_pago

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_metodo_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_metodo_pago_cb

  // ---------- Validate pag_fecha
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_fecha()
  {
    var nomeCampo_pag_fecha = "pag_fecha";
    var var_pag_fecha = scAjaxGetFieldText(nomeCampo_pag_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_fecha(var_pag_fecha, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_fecha_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_fecha

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_fecha_cb

  // ---------- Validate pag_banco_origen
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_banco_origen()
  {
    var nomeCampo_pag_banco_origen = "pag_banco_origen";
    var var_pag_banco_origen = scAjaxGetFieldText(nomeCampo_pag_banco_origen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_banco_origen(var_pag_banco_origen, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_banco_origen_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_banco_origen

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_banco_origen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_banco_origen_cb

  // ---------- Validate pag_cuenta_origen
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_cuenta_origen()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_cuenta_origen(var_pag_cuenta_origen, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_cuenta_origen_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_cuenta_origen

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_cuenta_origen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_cuenta_origen_cb

  // ---------- Validate pag_documento
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_documento()
  {
    var nomeCampo_pag_documento = "pag_documento";
    var var_pag_documento = scAjaxGetFieldText(nomeCampo_pag_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_documento(var_pag_documento, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_documento_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_documento

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_documento_cb

  // ---------- Validate pag_monto
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_monto()
  {
    var nomeCampo_pag_monto = "pag_monto";
    var var_pag_monto = scAjaxGetFieldHidden(nomeCampo_pag_monto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_monto(var_pag_monto, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_monto_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_monto

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_monto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_monto_cb

  // ---------- Validate pag_cuenta_destino
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_cuenta_destino()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_cuenta_destino(var_pag_cuenta_destino, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_cuenta_destino_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_cuenta_destino

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_cuenta_destino_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_cuenta_destino_cb

  // ---------- Validate pag_usuario_paga
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_usuario_paga()
  {
    var nomeCampo_pag_usuario_paga = "pag_usuario_paga";
    var var_pag_usuario_paga = scAjaxGetFieldText(nomeCampo_pag_usuario_paga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_usuario_paga(var_pag_usuario_paga, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_usuario_paga_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_usuario_paga

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_usuario_paga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_usuario_paga_cb

  // ---------- Validate pag_estado
  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_estado()
  {
    var nomeCampo_pag_estado = "pag_estado";
    var var_pag_estado = scAjaxGetFieldHidden(nomeCampo_pag_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_pagos_libretines_deuna_validate_pag_estado(var_pag_estado, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_validate_pag_estado_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_estado

  function do_ajax_form_fac_pagos_libretines_deuna_validate_pag_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_pagos_libretines_deuna_validate_pag_estado_cb

  // ---------- Event onchange pag_metodo_pago
  function do_ajax_form_fac_pagos_libretines_deuna_event_pag_metodo_pago_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_fac_pagos_libretines_deuna_event_pag_metodo_pago_onchange(var_pag_metodo_pago, var_pag_banco_origen, var_pag_cuenta_origen, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_event_pag_metodo_pago_onchange_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_event_pag_metodo_pago_onchange

  function do_ajax_form_fac_pagos_libretines_deuna_event_pag_metodo_pago_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pag_metodo_pago";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_pagos_libretines_deuna_event_pag_metodo_pago_onchange_cb_after_alert);
  } // do_ajax_form_fac_pagos_libretines_deuna_event_pag_metodo_pago_onchange_cb
  function do_ajax_form_fac_pagos_libretines_deuna_event_pag_metodo_pago_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_fac_pagos_libretines_deuna_event_pag_metodo_pago_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_pagos_libretines_deuna_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_pagos_libretines_deuna_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_fac_pagos_libretines_deuna_submit_form(var_pag_id, var_pag_empresa, var_pag_mensaje, var_pag_qr, var_pag_metodo_pago, var_pag_fecha, var_pag_banco_origen, var_pag_cuenta_origen, var_pag_documento, var_pag_monto, var_pag_cuenta_destino, var_pag_usuario_paga, var_pag_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_pagos_libretines_deuna_submit_form_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_submit_form

  function do_ajax_form_fac_pagos_libretines_deuna_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_pagos_libretines_deuna_submit_form_cb_after_alert);
  } // do_ajax_form_fac_pagos_libretines_deuna_submit_form_cb
  function do_ajax_form_fac_pagos_libretines_deuna_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_pagos_libretines_deuna_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_pagos_libretines_deuna_navigate_form()
  {
    perform_ajax_form_fac_pagos_libretines_deuna_navigate_form();
  }

  function perform_ajax_form_fac_pagos_libretines_deuna_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_pagos_libretines_deuna_navigate_form(var_pag_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_pagos_libretines_deuna_navigate_form_cb);
  } // do_ajax_form_fac_pagos_libretines_deuna_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_pagos_libretines_deuna']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_pagos_libretines_deuna_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_pagos_libretines_deuna_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_pagos_libretines_deuna_navigate_form_cb
  function do_ajax_form_fac_pagos_libretines_deuna_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_fac_pagos_libretines_deuna_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_pagos_libretines_deuna_navigate_form_cb_after_alert

  function sc_hide_form_fac_pagos_libretines_deuna_form()
  {
