<?php
class busca_cliente_proforma_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'])
   { 
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['busca_cliente_proforma'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_bot();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "busca_cliente_proforma/busca_cliente_proforma_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['pesq_tab_label'] .= "cl_id?#?" . "Cl Id" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['pesq_tab_label'] .= "cl_empresa?#?" . "Cl Empresa" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['pesq_tab_label'] .= "cl_nombre?#?" . "" . $this->Ini->Nm_lang['lang_nombre'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['pesq_tab_label'] .= "cl_tipo_identificacion?#?" . "" . $this->Ini->Nm_lang['lang_lot_tipoid'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("cl_empresa","cl_nombre","cl_tipo_identificacion");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("busca_cliente_proforma", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $this->Cmps_ord_def['cl_tipo_identificacion'] = " asc";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca'];
       ...
       $this->cl_tipo_identificacion = (isset($Busca_temp['cl_tipo_identificacion'])) ? $Busca_temp['cl_tipo_identificacion'] : ""; 
       $tmp_pos = (is_string($this->cl_tipo_identificacion)) ? strpos($this->cl_tipo_identificacion, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->cl_tipo_identificacion))
       {
           $this->cl_tipo_identificacion = substr($this->cl_tipo_identificacion, 0, $tmp_pos);
       }
   } 
   $this->nm_field_dinamico = array();
   $this->nm_order_dinamico = array();
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] = "muda_qt_linhas";
   } 
   $this->New_label['cl_tipo_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_tipoid'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['busca_cliente_proforma'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['busca_cliente_proforma'];
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['insert'] != '')
   {
       $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['insert'];
       $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['insert'];
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['update'] != '')
   {
       $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['update'];
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['delete'] != '')
   {
       $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['delete'];
   }
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "busca_cliente_proforma/busca_cliente_proforma_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "busca_cliente_proforma_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new busca_cliente_proforma_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_orig'] = " where (cl_empresa in ('0000000000000','" . $_SESSION['Igtech_RucEmpresa'] . "'))";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid'];
   }
//----- 
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
   { 
       $nmgp_select = "SELECT cl_id, cl_tipo_identificacion, cl_identificacion, cl_nombre, cl_direccion, cl_telefono, cl_email, cl_empresa, cl_pais from " . $this->Ini->nm_tabela; 
   } 
   ...
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       $this->cl_id = $this->rs_grid->fields[0] ;  
       $this->cl_id = (string)$this->cl_id;
       $this->cl_tipo_identificacion = $this->rs_grid->fields[1] ;  
       $this->cl_identificacion = $this->rs_grid->fields[2] ;  
       $this->cl_nombre = $this->rs_grid->fields[3] ;  
       $this->cl_direccion = $this->rs_grid->fields[4] ;  
       $this->cl_telefono = $this->rs_grid->fields[5] ;  
       $this->cl_email = $this->rs_grid->fields[6] ;  
       $this->cl_empresa = $this->rs_grid->fields[7] ;  
       $this->cl_pais = $this->rs_grid->fields[8] ;  
       $this->cl_pais = (string)$this->cl_pais;
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
           $this->pb = new scProgressBar();
           $this->pb->setRoot($this->Ini->root);
           $this->pb->setDir($_SESSION['scriptcase']['busca_cliente_proforma']['glo_nm_path_imag_temp'] . "/");
           $this->pb->setProgressbarMd5($_GET['pbmd5']);
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_clientes'] ?> :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               busca_cliente_proforma_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               busca_cliente_proforma_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               busca_cliente_proforma_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               busca_cliente_proforma_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               busca_cliente_proforma_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_clientes'] . "</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"busca_cliente_proforma_jquery_9139.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"busca_cliente_proforma_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"busca_cliente_proforma_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida']) {  
...
$nm_saida->saida("    </style>\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-busca_cliente_proforma-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-busca_cliente_proforma-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-busca_cliente_proforma-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-029339ab\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_busca_cliente_proforma_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_busca_cliente_proforma_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_busca_cliente_proforma_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "busca_cliente_proforma/busca_cliente_proforma_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".busca_cliente_proforma_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .busca_cliente_proforma_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".busca_cliente_proforma_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'])
   { 
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['doc_word'])
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf_vert'])
   {
   }
   else
   {
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != "print") 
       { 
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_busca_cliente_proforma\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_busca_cliente_proforma\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
       }
           $nm_saida->saida("    <TR>\r\n");
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_busca_cliente_proforma\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_busca_cliente_proforma\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_busca_cliente_proforma\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_busca_cliente_proforma\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['busca_cliente_proforma']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['busca_cliente_proforma']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['busca_cliente_proforma']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['busca_cliente_proforma']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida']) ? "busca_cliente_proforma_" : "";
   $this->css_sep = " ";
   $this->css_cl_id_label = $compl_css_emb . "css_cl_id_label";
   $this->css_cl_id_grid_line = $compl_css_emb . "css_cl_id_grid_line";
   $this->css_cl_tipo_identificacion_label = $compl_css_emb . "css_cl_tipo_identificacion_label";
   $this->css_cl_tipo_identificacion_grid_line = $compl_css_emb . "css_cl_tipo_identificacion_grid_line";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'], 0, $trab_pos);
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida("          " . $this->Ini->Nm_lang['lang_clientes'] . "\r\n");
   $nm_saida->saida("        </TD>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_label'])
   { 
       $this->New_label['cl_tipo_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_tipoid'] . "";
       $this->New_label['cl_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "";
       $this->New_label['cl_nombre'] = "" . $this->Ini->Nm_lang['lang_nombre'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_busca_cliente_proforma__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-busca_cliente_proforma-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_cl_pais_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_cl_pais_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf") {
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . " sc-col-actionbar-left \"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_cl_pais_label'] . "\" ><style>\r\n");
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['field_order'] as $Cada_label)
   { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".busca_cliente_proforma_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
 ...
 function NM_label_cl_tipo_identificacion()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['cl_tipo_identificacion'])) ? $this->New_label['cl_tipo_identificacion'] : "" . $this->Ini->Nm_lang['lang_lot_tipoid'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['cl_tipo_identificacion']) || $this->NM_cmp_hidden['cl_tipo_identificacion'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_cl_tipo_identificacion_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_cl_tipo_identificacion_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('cl_tipo_identificacion');
        $fieldSortIcon = $this->scGetColumnOrderIcon('cl_tipo_identificacion', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_cl_tipo_identificacion_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_cl_tipo_identificacion_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('cl_tipo_identificacion')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['cl_pais'])) ? $this->New_label['cl_pais'] : "Cl Pais";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ini_cor_grid']);
       }
   }
   ...
   $this->sc_where_atual   = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq'];
   $this->sc_where_filtro  = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_filtro'];
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_busca_cliente_proforma#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['lig_iframe_modal'] = "nmsc_iframe_liga_busca_cliente_proforma";
           }
           $nm_saida->saida(" <TR> \r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && 
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != "print") 
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_busca_cliente_proforma\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_busca_cliente_proforma\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_busca_cliente_proforma', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_busca_cliente_proforma', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_busca_cliente_proforma', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" &&
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_busca_cliente_proforma\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_busca_cliente_proforma\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               if (!$_SESSION['scriptcase']['proc_mobile']) {
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_busca_cliente_proforma\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_busca_cliente_proforma\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               }
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
...
else
{
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_busca_cliente_proforma\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_busca_cliente_proforma\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_busca_cliente_proforma#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-029339ab\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Page_break_PDF'] = array();
       }
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  busca_cliente_proforma_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->cl_pais = (string)$this->cl_pais;
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['rows_emb']++;
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_cl_pais_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_cl_pais_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['mostra_edit'] != "N"){ 
              if ($this->grid_emb_form_full)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['lig_iframe_modal'] = "nmsc_iframe_liga_busca_cliente_proforma";
              }
              $Sc_parent = ($this->grid_emb_form_full) ? "S" : "";
              $linkTarget = isset($this->Ini->sc_lig_target['A_@scinf__@scinf_form_del_cliente']) ? $this->Ini->sc_lig_target['A_@scinf__@scinf_form_del_cliente'] : (isset($this->Ini->sc_lig_target['A_@scinf_']) ? $this->Ini->sc_lig_target['A_@scinf_'] : null);
              if (isset($this->Ini->sc_lig_md5["form_del_cliente"]) && $this->Ini->sc_lig_md5["form_del_cliente"] == "S")
              {
                  $Parms_Edt  = "cl_id*scin" . str_replace('"', "@aspasd@", $this->cl_id) . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinS*scoutnmgp_opcao*scinigual*scoutNMSC_modal*scinok*scout";
                  if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['under_dashboard'] && isset($linkTarget))
                  {
                      if ('' != $Parms_Edt && '?@?' != substr($Parms_Edt, -3) && '*scout' != substr($Parms_Edt, -6))
                      {
                          $Parms_Edt .= '*scout';
                      }
                      $Parms_Edt .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $linkTarget . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['compact_mode'] ? '1' : '0') . '*scoutremove_margin*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['remove_margin'] ? '1' : '0') . '*scoutremove_border*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['remove_border'] ? '1' : '0');
                  }
                  $Md5_Edt    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@busca_cliente_proforma@SC_par@" . md5($Parms_Edt);
                  $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Lig_Md5'][md5($Parms_Edt)] = $Parms_Edt;
              }
              else
              {
                  $Md5_Edt  = "cl_id*scin" . str_replace('"', "@aspasd@", $this->cl_id) . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinS*scoutnmgp_opcao*scinigual*scoutNMSC_modal*scinok*scout";
              }
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_form_del_cliente . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'form_del_cliente', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_form_del_cliente . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'form_del_cliente', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['mostra_edit'] == "N"){ 
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_cl_tipo_identificacion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['cl_tipo_identificacion']) || $this->NM_cmp_hidden['cl_tipo_identificacion'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->cl_tipo_identificacion));
              $conteudo_original = NM_encode_input(sc_strip_script($this->cl_tipo_identificacion));
          }
          else {
              $conteudo = sc_strip_script($this->cl_tipo_identificacion); 
              $conteudo_original = sc_strip_script($this->cl_tipo_identificacion); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_cl_tipo_identificacion_grid_line . "\"  style=\"" . $this->Css_Cmp['css_cl_tipo_identificacion_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_cl_tipo_identificacion_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ajax_nav'])
          {
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
        ...
        if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['new'] == "on" && $this->nmgp_botoes['insert'] == "on" && !$this->grid_emb_form)
        {
           ...
           $Sc_parent = ($this->grid_emb_form_full) ? "S" : "";
           if (isset($this->Ini->sc_lig_md5["form_del_cliente"]) && $this->Ini->sc_lig_md5["form_del_cliente"] == "S") {
               $Parms_Lig  = "NM_cancel_insert_new*scin1*scoutNM_cancel_return_new*scin1*scoutnmgp_opcao*scinnovo*scoutNM_btn_insert*scinS*scoutNM_btn_new*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinS*scout";
               $Md5_Lig    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@busca_cliente_proforma@SC_par@" . md5($Parms_Lig);
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
           } else {
               $Md5_Lig  = "NM_cancel_insert_new*scin1*scoutNM_cancel_return_new*scin1*scoutnmgp_opcao*scinnovo*scoutNM_btn_insert*scinS*scoutNM_btn_new*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinS*scout";
           }
         $this->nm_btn_exist['new'][] = "sc_b_new_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bnovo", "nm_gp_submit1('" .  $this->Ini->link_form_del_cliente . "', '$this->nm_location', '$Md5_Lig', '_self', 'form_del_cliente'); return false;;", "nm_gp_submit1('" .  $this->Ini->link_form_del_cliente . "', '$this->nm_location', '$Md5_Lig', '_self', 'form_del_cliente'); return false;;", "sc_b_new_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
         $NM_btn = true;
        }
          if (is_file("busca_cliente_proforma_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("busca_cliente_proforma_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "cl_id")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "cl_id";
                           $lin_obj = $this->grid_search_cl_id($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "cl_empresa")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "cl_empresa";
                           $lin_obj = $this->grid_search_cl_empresa($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "cl_nombre")
                        {
                        ...
                        if ($cmp == "cl_tipo_identificacion")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "cl_tipo_identificacion";
                           $lin_obj = $this->grid_search_cl_tipo_identificacion($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('cl_id','cl_empresa','cl_nombre','cl_tipo_identificacion');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq']) < 4)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_cl_id($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_cl_id_" . $ind . "' style='display:none; z-index: 10'>";
       ...
       $lin_obj .= "       <select id='grid_search_cl_id_cond_" . $ind . "' name='cond_grid_search_cl_id_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"cl_id\", $ind)'>";
       ...
       $lin_obj .= "       <span id=\"grid_cl_id_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       ...
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_cl_id_val_" . $ind . "' name='val_grid_search_cl_id_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=9 alt=\"{datatype: 'decimal', maxLength: 9, precision: 0, decimalSep: '" . $_SESSION['scriptcase']['reg_conf']['dec_num'] . "', thousandsSep: '" . $_SESSION['scriptcase']['reg_conf']['grup_num'] . "', allowNegative: false, onlyNegative: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   function grid_search_cl_empresa($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_cl_empresa_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_cl_empresa_cond_" . $ind . "' name='cond_grid_search_cl_empresa_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"cl_empresa\", $ind)'>";
       ...
       $lin_obj .= "       <span id=\"grid_cl_empresa_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $cl_empresa = $val_cmp;
       if ($cl_empresa != "")
       {
       $cl_empresa_look = (is_string($cl_empresa) ? substr($this->Db->qstr($cl_empresa), 1, -1) : $cl_empresa); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_empresa from " . $this->Ini->nm_tabela . " where (cl_empresa in ('0000000000000','" . $_SESSION['Igtech_RucEmpresa'] . "')) and #lowerI#cl_empresa#lowerF# = #lowerI#'$cl_empresa_look'#lowerF# order by cl_empresa"; 
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       if (isset($nmgp_def_dados[0][$cl_empresa]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$cl_empresa];
       }
       else
       {
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_cl_empresa_val_" . $ind . "' name='val_grid_search_cl_empresa_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=13 alt=\"{datatype: 'text', maxLength: 13, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       ...
       $lin_obj .= "     <select class='sc-ui-autocomp-cl_empresa " . $this->css_scAppDivToolbarInput . "' id='id_ac_grid_cl_empresa" . $ind . "' name='val_grid_search_cl_empresa_autocomp" . $ind . "'>";
       if ('' !=  $cl_empresa) {
           $lin_obj .= "     <option value='" . $cl_empresa . "'  selected>" . $sAutocompValue . "</option>";
       }
       $lin_obj .= "     </select>";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   function grid_search_cl_nombre($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $lin_obj .= "       <select id='grid_search_cl_nombre_cond_" . $ind . "' name='cond_grid_search_cl_nombre_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"cl_nombre\", $ind)'>";
       $selected = ($opc == "qp") ? " selected" : "";
       $lin_obj .= "        <option value='qp'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_like'] . "</option>";
       $selected = ($opc == "np") ? " selected" : "";
       $lin_obj .= "        <option value='np'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_not_like'] . "</option>";
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (cl_empresa in ('0000000000000','" . $_SESSION['Igtech_RucEmpresa'] . "')) and #lowerI#cl_nombre#lowerF# = #lowerI#'$cl_nombre_look'#lowerF# order by cl_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function grid_search_cl_tipo_identificacion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_cl_tipo_identificacion_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_cl_tipo_identificacion_cond_" . $ind . "' name='cond_grid_search_cl_tipo_identificacion_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"cl_tipo_identificacion\", $ind)'>";
       $selected = ($opc == "qp") ? " selected" : "";
       $lin_obj .= "        <option value='qp'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_like'] . "</option>";
       $selected = ($opc == "np") ? " selected" : "";
       $lin_obj .= "        <option value='np'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_not_like'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_cl_tipo_identificacion_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $cl_tipo_identificacion = $val_cmp;
       if ($cl_tipo_identificacion != "")
       {
       $cl_tipo_identificacion_look = (is_string($cl_tipo_identificacion) ? substr($this->Db->qstr($cl_tipo_identificacion), 1, -1) : $cl_tipo_identificacion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_tipo_identificacion from " . $this->Ini->nm_tabela . " where (cl_empresa in ('0000000000000','" . $_SESSION['Igtech_RucEmpresa'] . "')) and #lowerI#cl_tipo_identificacion#lowerF# = #lowerI#'$cl_tipo_identificacion_look'#lowerF# order by cl_tipo_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       if (isset($nmgp_def_dados[0][$cl_tipo_identificacion]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$cl_tipo_identificacion];
       }
       else
       {
           $sAutocompValue = $val_cmp;
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_cl_tipo_identificacion_val_" . $ind . "' name='val_grid_search_cl_tipo_identificacion_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       $tmp_pos = (is_string($val_cmp)) ? strpos($val_cmp, "##@@") : false;
       if ($tmp_pos !== false) {
           $val_cmp = substr($val_cmp, ($tmp_pos + 4));
           $sAutocompValue = substr($sAutocompValue, ($tmp_pos + 4));
       }
       $lin_obj .= "     <select class='sc-ui-autocomp-cl_tipo_identificacion " . $this->css_scAppDivToolbarInput . "' id='id_ac_grid_cl_tipo_identificacion" . $ind . "' name='val_grid_search_cl_tipo_identificacion_autocomp" . $ind . "'>";
       if ('' !=  $cl_tipo_identificacion) {
           $lin_obj .= "     <option value='" . $cl_tipo_identificacion . "'  selected>" . $sAutocompValue . "</option>";
       }
       $lin_obj .= "     </select>";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   function lookup_ajax_cl_empresa($cl_empresa)
   {
       $cl_empresa = substr($this->Db->qstr($cl_empresa), 1, -1);
       $this->NM_case_insensitive = true;
       $cl_empresa_look = (is_string($cl_empresa) ? substr($this->Db->qstr($cl_empresa), 1, -1) : $cl_empresa); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_empresa from " . $this->Ini->nm_tabela . " where (cl_empresa in ('0000000000000','" . $_SESSION['Igtech_RucEmpresa'] . "')) and  #lowerI#cl_empresa#lowerF# like #lowerI#'%" . $cl_empresa . "%'#lowerF# order by cl_empresa"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = busca_cliente_proforma_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_cl_nombre($cl_nombre)
   {
       ...
       $cl_nombre_look = (is_string($cl_nombre) ? substr($this->Db->qstr($cl_nombre), 1, -1) : $cl_nombre); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (cl_empresa in ('0000000000000','" . $_SESSION['Igtech_RucEmpresa'] . "')) and  #lowerI#cl_nombre#lowerF# like #lowerI#'%" . $cl_nombre . "%'#lowerF# order by cl_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function lookup_ajax_cl_tipo_identificacion($cl_tipo_identificacion)
   {
       $cl_tipo_identificacion = substr($this->Db->qstr($cl_tipo_identificacion), 1, -1);
       $this->NM_case_insensitive = true;
       $cl_tipo_identificacion_look = (is_string($cl_tipo_identificacion) ? substr($this->Db->qstr($cl_tipo_identificacion), 1, -1) : $cl_tipo_identificacion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_tipo_identificacion from " . $this->Ini->nm_tabela . " where (cl_empresa in ('0000000000000','" . $_SESSION['Igtech_RucEmpresa'] . "')) and  #lowerI#cl_tipo_identificacion#lowerF# like #lowerI#'%" . $cl_tipo_identificacion . "%'#lowerF# order by cl_tipo_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "debi_doc_electronicos/busca_cliente_proforma";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("             {\r\n");
       $nm_saida->saida("                 tmp = Tab_obj_grid_search[i];\r\n");
       $nm_saida->saida("                 if (tmp == 'cl_empresa')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_cl_empresa = i;\r\n");
       $nm_saida->saida("                        $(\".sc-ui-autocomp-cl_empresa\").on(\"focus\", function() {\r\n");
       ...
       $nm_saida->saida("                            field: \"cl_empresa\",\r\n");
       ...
       $nm_saida->saida("                         $(\"#grid_search_cl_empresa_val_\" + x_cl_empresa).val(e.params.data.id);\r\n");
       $nm_saida->saida("                        });\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("                        });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'cl_tipo_identificacion')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_cl_tipo_identificacion = i;\r\n");
       $nm_saida->saida("                        $(\".sc-ui-autocomp-cl_tipo_identificacion\").on(\"focus\", function() {\r\n");
       $nm_saida->saida("                        }).on(\"blur\", function() {\r\n");
       $nm_saida->saida("                        }).on(\"keydown\", function(e) {\r\n");
       $nm_saida->saida("                         if(e.keyCode == $.ui.keyCode.TAB && $(\".ui-autocomplete\").filter(\":visible\").length) {\r\n");
       $nm_saida->saida("                          e.keyCode = $.ui.keyCode.DOWN;\r\n");
       ...
       $nm_saida->saida("                            nmgp_opcao: \"ajax_aut_comp_dyn_search\",\r\n");
       $nm_saida->saida("                            origem: \"grid\",\r\n");
       $nm_saida->saida("                            field: \"cl_tipo_identificacion\",\r\n");
       $nm_saida->saida("                            max_itens: \"10\",\r\n");
       $nm_saida->saida("                            cod_desc: \"N\",\r\n");
       $nm_saida->saida("                            script_case_init: " . $this->Ini->sc_page . "\r\n");
       $nm_saida->saida("                           }\r\n");
       ...
       $nm_saida->saida("                         }\r\n");
       $nm_saida->saida("                        }).on(\"select2:select\", function(e) {;\r\n");
       $nm_saida->saida("                         $(\"#grid_search_cl_tipo_identificacion_val_\" + x_cl_tipo_identificacion).val(e.params.data.id);\r\n");
       $nm_saida->saida("                        });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("             }\r\n");
       $nm_saida->saida("         }\r\n");
       ...
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'cl_id')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, '');\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'cl_empresa')\r\n");
       $nm_saida->saida("                 {\r\n");
       ...
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, obj_ac);\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'cl_tipo_identificacion')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     obj_ac  = 'id_ac_grid_' + Tab_obj_grid_search[i] + i;\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, obj_ac);\r\n");
       $nm_saida->saida("                 }\r\n");
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_busca_cliente_proforma\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_busca_cliente_proforma\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('busca_cliente_proforma', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"busca_cliente_proforma\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"busca_cliente_proforma_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"busca_cliente_proforma_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=busca_cliente_proforma';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_busca_cliente_proforma');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_busca_cliente_proforma');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_busca_cliente_proforma');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_busca_cliente_proforma');} \r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['busca_cliente_proforma_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@busca_cliente_proforma@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"busca_cliente_proforma_iframe.php\";\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"busca_cliente_proforma_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['busca_cliente_proforma']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"busca_cliente_proforma_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('busca_cliente_proforma')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('busca_cliente_proforma', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
