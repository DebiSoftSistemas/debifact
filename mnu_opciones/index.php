<?php
include_once('mnu_opciones_session.php');
...
$_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod']      = "";
$_SESSION['scriptcase']['mnu_opciones']['glo_nm_perfil']         = "igtech_conexion";
$_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_imag_temp'] = "";
$_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo']      = "";
...
//check prod
if(empty($_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod']))
{
   /*check prod*/$_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check tmp
if(empty($_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_imag_temp']))
{
   /*check tmp*/$_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
...
class mnu_opciones_class
{
 ...
 function mnu_opciones_menu()
 {
    global $mnu_opciones_menuData;
...
$nm_versao_sc  = "" ; 
$_SESSION['scriptcase']['mnu_opciones']['contr_erro'] = 'off';
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_mnu_opciones'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_mnu_opciones'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_mnu_opciones'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod'] . "/third";
$url_third      = $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "mnu_opciones/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$path_lib_php   = $str_root . $path_link . "_lib/lib/php";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_imag_temp'];
$menu_largura   = '220';
$menu_mobile_hide          = 'N';
...
if(function_exists('set_php_timezone')) set_php_timezone('mnu_opciones');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/mnu_opciones_erro.php");
}
include_once(dirname(__FILE__) . "/mnu_opciones_erro.class.php"); 
$this->Erro = new mnu_opciones_erro();
$str_path = substr($_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['mnu_opciones']['glo_nm_conexao']);
}
/* Definiciones de las rutas */
$mnu_opciones_menuData          = array();
$mnu_opciones_menuData['path']  = array();
$mnu_opciones_menuData['url']   = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $mnu_opciones_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $mnu_opciones_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $mnu_opciones_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $mnu_opciones_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$mnu_opciones_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$mnu_opciones_menuData['url']['web']   = str_replace("\\", '/', $mnu_opciones_menuData['url']['web']);
$mnu_opciones_menuData['path']['root'] = substr($mnu_opciones_menuData['path']['sys'],  0, -1 * strlen($mnu_opciones_menuData['url']['web']));
$mnu_opciones_menuData['path']['app']  = substr($mnu_opciones_menuData['path']['sys'],  0, strrpos($mnu_opciones_menuData['path']['sys'],  '/'));
$mnu_opciones_menuData['path']['link'] = substr($mnu_opciones_menuData['path']['app'],  0, strrpos($mnu_opciones_menuData['path']['app'],  '/'));
$mnu_opciones_menuData['path']['link'] = substr($mnu_opciones_menuData['path']['link'], 0, strrpos($mnu_opciones_menuData['path']['link'], '/')) . '/';
$mnu_opciones_menuData['path']['app'] .= '/';
$mnu_opciones_menuData['url']['app']   = substr($mnu_opciones_menuData['url']['web'],  0, strrpos($mnu_opciones_menuData['url']['web'],  '/'));
$mnu_opciones_menuData['url']['link']  = substr($mnu_opciones_menuData['url']['app'],  0, strrpos($mnu_opciones_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] == "S")
{
    $mnu_opciones_menuData['url']['link']  = substr($mnu_opciones_menuData['url']['link'], 0, strrpos($mnu_opciones_menuData['url']['link'], '/'));
}
$mnu_opciones_menuData['url']['link']  .= '/';
$mnu_opciones_menuData['url']['app']   .= '/';

$_SESSION['scriptcase']['mnu_opciones']['sc_apl_link'] = $mnu_opciones_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['mnu_opciones']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['mnu_opciones']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['mnu_opciones']['actual_lang']) || $_SESSION['scriptcase']['mnu_opciones']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['mnu_opciones']['actual_lang'] = $this->str_lang;
...
if ($_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] != "S")
{
    ...
    $_SESSION['scriptcase']['menu_atual'] = "mnu_opciones";
    $_SESSION['scriptcase']['menu_apls']['mnu_opciones'] = array();
    if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
    {
        foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
        {
            if (isset($_SESSION['scriptcase']['mnu_opciones']['glo_nm_conexao']) && $_SESSION['scriptcase']['mnu_opciones']['glo_nm_conexao'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['mnu_opciones']['glo_nm_conexao'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['mnu_opciones']['glo_nm_perfil']) && $_SESSION['scriptcase']['mnu_opciones']['glo_nm_perfil'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['mnu_opciones']['glo_nm_perfil'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['mnu_opciones']['glo_con_' . $NM_con_orig]))
            {
                $_SESSION['scriptcase']['mnu_opciones']['glo_con_' . $NM_con_orig] = $NM_con_dest;
            }
        }
    }
...
if (isset($_SESSION['scriptcase']['mnu_opciones']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['mnu_opciones']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['mnu_opciones']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['mnu_opciones']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['mnu_opciones']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['mnu_opciones']['session_timeout']);
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['mnu_opciones']['session_timeout']['redir']))
{
...
if (isset($script_case_init))
{
    $_SESSION['sc_session'][1]['mnu_opciones']['init'] = $script_case_init;
}
elseif (!isset($_SESSION['sc_session'][1]['mnu_opciones']['init']))
{
    $_SESSION['sc_session'][1]['mnu_opciones']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['mnu_opciones']['init'];
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['mnu_opciones']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['mnu_opciones']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['mnu_opciones']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod'], 'debi_doc_electronicos', 2); 
}
if (isset($_SESSION['scriptcase']['mnu_opciones']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['mnu_opciones']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['mnu_opciones']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['mnu_opciones']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['mnu_opciones']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['mnu_opciones']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['mnu_opciones']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['mnu_opciones']['sc_outra_jan']) && $_SESSION['sc_session'][1]['mnu_opciones']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['mnu_opciones']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['mnu_opciones']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['mnu_opciones']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod'], 'debi_doc_electronicos'); 
} 
else 
{ 
...
if (in_array(strtolower($nm_tpbanco), $this->nm_bases_oracle))
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['mnu_opciones']['decimal_db'] = ".";
} 
//
$this->NM_gera_log_insert("Scriptcase", "access");
if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'mnu_opciones'))
{
    $_SESSION['sc_session'][1]['mnu_opciones']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_mnu_opciones'] = "javascript:window.close()";
}

/* Menú de configuración de las variables */
$mnu_opciones_menuData['iframe'] = TRUE;

$mnu_opciones_menuData['height'] = '100%';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
if(is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/blank_menu_sistema_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] . '_lib/_app_data/blank_menu_sistema_ini.php');
    ...
    {
      if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_menu_sistema']))
      {
        $_SESSION['scriptcase']['sc_apl_seg']['blank_menu_sistema'] = "on";
      }
    }
}
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/dash_inicial_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/dash_inicial_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['dash_inicial']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['dash_inicial'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_administracion_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_administracion_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_administracion']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['mnu_administracion'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_inventario_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_inventario_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_inventario']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['mnu_inventario'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_compras_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_compras_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_compras']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['mnu_compras'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_ventas_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_ventas_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_ventas']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['mnu_ventas'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_pedidos_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/mnu_pedidos_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_pedidos']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['mnu_pedidos'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/blank_servicios_rapidos_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/blank_servicios_rapidos_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_servicios_rapidos']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['blank_servicios_rapidos'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_salir_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_salir_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_salir']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_salir'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="mnu_opciones_message.js"></script>
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_mnu_opciones'];
$mnu_opciones_menuData['data'] = array();
$nextLevelToBeWrite = false;
$str_disabled = "N";
$str_link = "mnu_opciones_form_php.php?sc_item_menu=item_107&sc_apl_menu=blank_menu_sistema&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_menu_sistema']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_menu_sistema']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $mnu_opciones_menuData['data'][] = array(
        ...
        'target'   => " target=\"" . $this->mnu_opciones_target('_self') . "\"",
        'sc_id'    => "item_107",
...
$str_disabled = "N";
$str_link = "mnu_opciones_form_php.php?sc_item_menu=item_104&sc_apl_menu=dash_inicial&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['dash_inicial']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['dash_inicial']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $mnu_opciones_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_estadisticas'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[1] . "",
        'id'       => "item_104",
...
$str_disabled = "N";
$str_link = "mnu_opciones_form_php.php?sc_item_menu=item_59&sc_apl_menu=mnu_administracion&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_administracion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_administracion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $mnu_opciones_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_administracion'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[2] . "",
        'id'       => "item_59",
...
$str_disabled = "N";
$str_link = "mnu_opciones_form_php.php?sc_item_menu=item_108&sc_apl_menu=https://recargasypagos.com/Login.aspx&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "";
$str_icon = "";
$icon_aba = "";
$icon_aba_inactive = "";
...
$mnu_opciones_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_recargas_pagos'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[3] . "",
    'id'       => "item_108",
    ...
    'icon_aba' => $icon_aba,
    'icon_aba_inactive' => $icon_aba_inactive,
    'target'   => " target=\"" . $this->mnu_opciones_target('_blank') . "\"",
    'sc_id'    => "item_108",
    'disabled' => $str_disabled,
    'display'  => "text_fontawesomeicon",
    'display_position'    => "text_right",
...
$str_disabled = "N";
$str_link = "mnu_opciones_form_php.php?sc_item_menu=item_41&sc_apl_menu=mnu_inventario&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_inventario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_inventario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $mnu_opciones_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_inventario'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[4] . "",
        'id'       => "item_41",
...
$str_disabled = "N";
$str_link = "mnu_opciones_form_php.php?sc_item_menu=item_73&sc_apl_menu=mnu_compras&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_compras']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_compras']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "mnu_opciones_form_php.php?sc_item_menu=item_72&sc_apl_menu=mnu_ventas&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_ventas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_ventas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "mnu_opciones_form_php.php?sc_item_menu=item_105&sc_apl_menu=mnu_pedidos&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['mnu_pedidos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['mnu_pedidos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $mnu_opciones_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_pedidos_convenios'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[7] . "",
        'id'       => "item_105",
...
$str_disabled = "N";
$str_link = "mnu_opciones_form_php.php?sc_item_menu=item_106&sc_apl_menu=blank_servicios_rapidos&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_servicios_rapidos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_servicios_rapidos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "mnu_opciones_form_php.php?sc_item_menu=item_109&sc_apl_menu=https://debifact.debisoft.technology/form_ayuda/index.html&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "";
$str_icon = "";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
...
$str_disabled = "N";
$str_link = "mnu_opciones_form_php.php?sc_item_menu=item_58&sc_apl_menu=form_salir&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_salir']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_salir']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $mnu_opciones_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " target=\"" . $this->mnu_opciones_target('_parent') . "\"",
        'sc_id'    => "item_58",
        'disabled' => $str_disabled,
        'display'  => "text_fontawesomeicon",
        'display_position'    => "text_right",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['mnu_opciones']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['mnu_opciones']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'mnu_opciones');
    $mnu_opciones_menuData['data'] = $str_menu_usu;
}
if (is_file("mnu_opciones_help.txt"))
{
    $Arq_WebHelp = file("mnu_opciones_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $mnu_opciones_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->mnu_opciones_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'  => "text",
                    'display_position'    => "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['mnu_opciones']) && !empty($_SESSION['scriptcase']['sc_menu_del']['mnu_opciones']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($mnu_opciones_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['mnu_opciones']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($mnu_opciones_menuData['data'][$i_menu]);
       }
    ...
    $mnu_opciones_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['mnu_opciones']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['mnu_opciones']))
{
    $disable_menu = false;
    foreach ($mnu_opciones_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['mnu_opciones']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $mnu_opciones_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
<?php
    $link_default = "";
    if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_menu_sistema']) && $_SESSION['scriptcase']['sc_apl_seg']['blank_menu_sistema'] == "on") 
    { 
    $_SESSION['scriptcase']['mnu_opciones']['apl_inicial'] = "";
    $link_default = " onclick=\"openMenuItem('iframe_mnu_opciones');\" item-href=\"mnu_opciones_form_php.php?sc_item_menu=mnu_opciones&sc_apl_menu=blank_menu_sistema&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "\"  item-target=\"mnu_opciones_iframe\"";
    } 
    else
    { 
        $_SESSION['scriptcase']['mnu_opciones']['apl_inicial'] = ($NM_scr_iframe != "") ? $NM_scr_iframe : "mnu_opciones_pag_ini.php";
    } 
    $_SESSION['scriptcase']['mnu_opciones']['path_link'] = $path_link;
?>
        ...
        <td class="scMenuTTableM" valign="top">
                <table cellpadding=0 cellspacing=0>
                    <tr>
                       <td>
                      <?php
                      echo $this->mnu_opciones_escreveMenu($mnu_opciones_menuData['data']);
                      ?>
                            </td>
                    </tr>
                </table>
...
<div class="ui-layout-center">
  <table cellspacing=0 cellpadding=0 style="height: 100%; width: 100%" cellpadding=0 cellspacing=0>
    <tr>
        ...
        <iframe name="mnu_opciones_iframe" id="iframe_mnu_opciones" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $_SESSION['scriptcase']['mnu_opciones']['apl_inicial']?>"<?php echo $link_default ?>></iframe>
      </tr>
    </table>
</div>
<script type="text/javascript">
...
Iframe_atual = "mnu_opciones_iframe";
Tab_links = new Array();
<?php
echo "Tab_links['mnu_opciones']   = \"\";\r\n";
 if(isset($mnu_opciones_menuData['data']) && !empty($mnu_opciones_menuData['data']))
 {
   foreach ($mnu_opciones_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($mnu_opciones_menuData['data_vertical']) && !empty($mnu_opciones_menuData['data_vertical']))
 {
   foreach ($mnu_opciones_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         echo "Tab_links['" . $dados_menu['id'] . "']   = \"\";\r\n";
...
{
  if (str_id != "iframe_mnu_opciones")
  {
      str_id        = str_id.replace("mnu_opciones_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_mnu_opciones', 'mnu_opciones');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_mnu_opciones').length)
        $('#iframe_mnu_opciones')[0].contentWindow.focus();
  }
}
...
{
    echo "   document.getElementById('iframe_mnu_opciones').click();\r\n";
}
?>
</script>
</body>
...
/* Control de Target */
function mnu_opciones_escreveMenu($arr_menu)
{
    $aMenuItemList = array();
            ...
            <?php
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    ?>
                    <li <?php echo $iconHtml; ?> class="scMenuTItems scMenuTItem" style="<?php echo $li_style; ?>"><a href="<?php echo $aMenuItemList[$i]['link']; ?>" onclick="<?php echo $focusFrame; ?> " id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>"<?php echo $aMenuItemList[$i]['target']; ?> class="scMenuTItem"><?php echo $aMenuItemList[$i]['label']; ?></a>
                    <?php
                  }
                }
                if ($aMenuItemList[$i + 1] && $aMenuItemList[$i]['level'] == $aMenuItemList[$i + 1]['level']) {
...
/* Control de Target */
   function mnu_opciones_target($str_target)
   {
       global $mnu_opciones_menuData;
       ...
       elseif ($mnu_opciones_menuData['iframe'])
       {
           return 'mnu_opciones_iframe';
       }
       else
       {
           return $str_target;
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "javascript:parent.nm_out_menu('mnu_opciones_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . "')";  
               }
               else
               {
                    $str_line['link'] = "mnu_opciones_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($mnu_opciones_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_usa_grupo'] . ""; 
               }
           }
           elseif ($arr_item['target'] == '_parent')
           {
               $str_line['link'] = "javascript:parent.nm_out_menu('" . $_SESSION['scriptcase']['sc_saida_mnu_opciones'] . "')"; 
           }
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->mnu_opciones_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['mnu_opciones']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['scriptcase']['mnu_opciones']['SC_sep_date']) && !empty($_SESSION['scriptcase']['mnu_opciones']['SC_sep_date']))
       {
           $delim  = $_SESSION['scriptcase']['mnu_opciones']['SC_sep_date'];
           $delim1 = $_SESSION['scriptcase']['mnu_opciones']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'mnu_opciones', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'mnu_opciones', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'mnu_opciones', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['mnu_opciones']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "mnu_opciones") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['mnu_opciones']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['mnu_opciones']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['mnu_opciones']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_debi_doc_electronicos'])) {
            $_SESSION['scriptcase']['mnu_opciones']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_debi_doc_electronicos'];
        }
    }
}
...
$contr_mnu_opciones = new mnu_opciones_class;
$contr_mnu_opciones->mnu_opciones_menu();
