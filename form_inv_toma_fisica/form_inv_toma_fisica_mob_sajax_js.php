  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_toma_fisica_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inv_toma_fisica_mob_form();
	}
...
?>
  ...
  // ---------- Validate tf_fecha
  function do_ajax_form_inv_toma_fisica_mob_validate_tf_fecha()
  {
    var nomeCampo_tf_fecha = "tf_fecha";
    var var_tf_fecha = scAjaxGetFieldText(nomeCampo_tf_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_toma_fisica_mob_validate_tf_fecha(var_tf_fecha, var_script_case_init, do_ajax_form_inv_toma_fisica_mob_validate_tf_fecha_cb);
  } // do_ajax_form_inv_toma_fisica_mob_validate_tf_fecha

  function do_ajax_form_inv_toma_fisica_mob_validate_tf_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf_fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_toma_fisica_mob_validate_tf_fecha_cb

  // ---------- Validate establecimiento
  function do_ajax_form_inv_toma_fisica_mob_validate_establecimiento()
  {
    var nomeCampo_establecimiento = "establecimiento";
    var var_establecimiento = scAjaxGetFieldSelect(nomeCampo_establecimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_toma_fisica_mob_validate_establecimiento(var_establecimiento, var_script_case_init, do_ajax_form_inv_toma_fisica_mob_validate_establecimiento_cb);
  } // do_ajax_form_inv_toma_fisica_mob_validate_establecimiento

  function do_ajax_form_inv_toma_fisica_mob_validate_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_toma_fisica_mob_validate_establecimiento_cb

  // ---------- Validate tf_bodega
  function do_ajax_form_inv_toma_fisica_mob_validate_tf_bodega()
  {
    var nomeCampo_tf_bodega = "tf_bodega";
    var var_tf_bodega = scAjaxGetFieldSelect(nomeCampo_tf_bodega);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_toma_fisica_mob_validate_tf_bodega(var_tf_bodega, var_script_case_init, do_ajax_form_inv_toma_fisica_mob_validate_tf_bodega_cb);
  } // do_ajax_form_inv_toma_fisica_mob_validate_tf_bodega

  function do_ajax_form_inv_toma_fisica_mob_validate_tf_bodega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf_bodega";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_toma_fisica_mob_validate_tf_bodega_cb

  // ---------- Validate tf_id
  function do_ajax_form_inv_toma_fisica_mob_validate_tf_id()
  {
    var nomeCampo_tf_id = "tf_id";
    var var_tf_id = scAjaxGetFieldHidden(nomeCampo_tf_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_toma_fisica_mob_validate_tf_id(var_tf_id, var_script_case_init, do_ajax_form_inv_toma_fisica_mob_validate_tf_id_cb);
  } // do_ajax_form_inv_toma_fisica_mob_validate_tf_id

  function do_ajax_form_inv_toma_fisica_mob_validate_tf_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_toma_fisica_mob_validate_tf_id_cb

  // ---------- Validate tf_estado
  function do_ajax_form_inv_toma_fisica_mob_validate_tf_estado()
  {
    var nomeCampo_tf_estado = "tf_estado";
    var var_tf_estado = scAjaxGetFieldSelect(nomeCampo_tf_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_toma_fisica_mob_validate_tf_estado(var_tf_estado, var_script_case_init, do_ajax_form_inv_toma_fisica_mob_validate_tf_estado_cb);
  } // do_ajax_form_inv_toma_fisica_mob_validate_tf_estado

  function do_ajax_form_inv_toma_fisica_mob_validate_tf_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_toma_fisica_mob_validate_tf_estado_cb

  // ---------- Validate productos
  function do_ajax_form_inv_toma_fisica_mob_validate_productos()
  {
    var nomeCampo_productos = "productos";
    var var_productos = scAjaxGetFieldText(nomeCampo_productos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_toma_fisica_mob_validate_productos(var_productos, var_script_case_init, do_ajax_form_inv_toma_fisica_mob_validate_productos_cb);
  } // do_ajax_form_inv_toma_fisica_mob_validate_productos

  function do_ajax_form_inv_toma_fisica_mob_validate_productos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_toma_fisica_mob_validate_productos_cb

  // ---------- Refresh establecimiento
  function do_ajax_form_inv_toma_fisica_mob_refresh_establecimiento()
  {
    var var_establecimiento = scAjaxGetFieldSelect("establecimiento");
    var var_nmgp_refresh_fields = "tf_bodega";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_toma_fisica_mob_refresh_establecimiento(var_establecimiento, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_inv_toma_fisica_mob_refresh_establecimiento_cb);
  } // do_ajax_form_inv_toma_fisica_mob_refresh_establecimiento

  function do_ajax_form_inv_toma_fisica_mob_refresh_establecimiento_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_toma_fisica_mob_refresh_establecimiento_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_inv_toma_fisica_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_inv_toma_fisica_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tf_fecha = scAjaxGetFieldText("tf_fecha");
    var var_establecimiento = scAjaxGetFieldSelect("establecimiento");
    var var_tf_bodega = scAjaxGetFieldSelect("tf_bodega");
    var var_tf_id = scAjaxGetFieldHidden("tf_id");
    var var_tf_estado = scAjaxGetFieldSelect("tf_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_inv_toma_fisica_mob_submit_form(var_tf_fecha, var_establecimiento, var_tf_bodega, var_tf_id, var_tf_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_toma_fisica_mob_submit_form_cb);
  } // do_ajax_form_inv_toma_fisica_mob_submit_form

  function do_ajax_form_inv_toma_fisica_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tf_fecha");
      scAjaxHideErrorDisplay("establecimiento");
      scAjaxHideErrorDisplay("tf_bodega");
      scAjaxHideErrorDisplay("tf_id");
      scAjaxHideErrorDisplay("tf_estado");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_inv_toma_fisica_mob_submit_form_cb_after_alert);
  } // do_ajax_form_inv_toma_fisica_mob_submit_form_cb
  function do_ajax_form_inv_toma_fisica_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_toma_fisica_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_inv_productos_toma_fisica_mob"] = "off";

  function do_ajax_form_inv_toma_fisica_mob_navigate_form()
  {
    perform_ajax_form_inv_toma_fisica_mob_navigate_form();
  }

  function perform_ajax_form_inv_toma_fisica_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tf_estado");
    scAjaxHideErrorDisplay("productos");
    var var_tf_id = document.F2.tf_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_inv_productos_toma_fisica_mob"] = "on";
    x_ajax_form_inv_toma_fisica_mob_navigate_form(var_tf_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_toma_fisica_mob_navigate_form_cb);
  } // do_ajax_form_inv_toma_fisica_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_toma_fisica_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_toma_fisica_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.tf_id.value = scAjaxGetKeyValue("tf_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_inv_productos_toma_fisica_mob"] && "nmsc_iframe_liga_form_inv_productos_toma_fisica_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_inv_productos_toma_fisica_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_inv_productos_toma_fisica_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_inv_productos_toma_fisica_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_inv_productos_toma_fisica_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_inv_productos_toma_fisica_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_toma_fisica_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_toma_fisica_mob_navigate_form_cb
  function do_ajax_form_inv_toma_fisica_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_inv_toma_fisica_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_inv_toma_fisica_mob_navigate_form_cb_after_alert

  function sc_hide_form_inv_toma_fisica_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_inv_productos_toma_fisica_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "tf_fecha";
  ajax_field_list[1] = "establecimiento";
  ajax_field_list[2] = "tf_bodega";
  ajax_field_list[3] = "tf_id";
  ajax_field_list[4] = "tf_estado";
  ajax_field_list[5] = "productos";
  ...
  var ajax_error_list = {
    "tf_fecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tf_bodega": {"label": "<?php echo $this->Ini->Nm_lang['lang_bodega'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tf_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tf_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["tf_fecha"][1] = "tf_fecha";
  ajax_field_mult["establecimiento"][1] = "establecimiento";
  ajax_field_mult["tf_bodega"][1] = "tf_bodega";
  ajax_field_mult["tf_id"][1] = "tf_id";
  ajax_field_mult["tf_estado"][1] = "tf_estado";
  ajax_field_mult["productos"][1] = "productos";

  var ajax_field_id = {
    "tf_fecha": new Array("hidden_field_label_tf_fecha", "hidden_field_data_tf_fecha"),
    "establecimiento": new Array("hidden_field_label_establecimiento", "hidden_field_data_establecimiento"),
    "tf_bodega": new Array("hidden_field_label_tf_bodega", "hidden_field_data_tf_bodega"),
