...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pro_total_inventario_line" id="hidden_field_data_pro_total_inventario" style="<?php echo $sStyleHidden_pro_total_inventario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pro_total_inventario_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="pro_total_inventario" value="<?php echo $this->form_encode_input($pro_total_inventario); ?>"><span id="id_ajax_label_pro_total_inventario"><?php echo nl2br($pro_total_inventario); ?></span>
