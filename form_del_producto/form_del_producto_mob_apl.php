<?php
//
class form_del_producto_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_del_producto_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_del_producto_mob']['upload_field_info']['pro_imagen'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_del_producto_mob',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_producto_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_producto_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_producto_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_producto_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_del_producto_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_producto_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " del_producto";
      ...
      $_SESSION['scriptcase']['error_icon']['form_del_producto_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_del_producto_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['upload_field_ul_name'][$this->pro_imagen_ul_name]))
          {
              $this->NM_ajax_info['param']['pro_imagen_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['upload_field_ul_name'][$this->pro_imagen_ul_name];
          }
      ...
      elseif (isset($this->pro_imagen_ul_name) && '' != $this->pro_imagen_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['upload_field_ul_name'][$this->pro_imagen_ul_name]))
          {
              $this->pro_imagen_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['upload_field_ul_name'][$this->pro_imagen_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_producto_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_producto_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_producto_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_form'];
          ...
          if (!isset($this->pro_cta_cartera_vencida)){$this->pro_cta_cartera_vencida = $this->nmgp_dados_form['pro_cta_cartera_vencida'];} 
          if (!isset($this->pro_cta_cobrar)){$this->pro_cta_cobrar = $this->nmgp_dados_form['pro_cta_cobrar'];} 
          if (!isset($this->pro_cta_ingreso)){$this->pro_cta_ingreso = $this->nmgp_dados_form['pro_cta_ingreso'];} 
          if (!isset($this->pro_cta_puente)){$this->pro_cta_puente = $this->nmgp_dados_form['pro_cta_puente'];} 
          if (!isset($this->pro_producto_debi)){$this->pro_producto_debi = $this->nmgp_dados_form['pro_producto_debi'];} 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_del_producto_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_del_producto_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_del_producto/form_del_producto_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_del_producto_mob_erro.class.php"); 
      }
      $this->Erro      = new form_del_producto_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opcao']))
         { 
             if ($this->pro_codigo != "" || $this->pro_empresa != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_del_producto_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_del_producto_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_del_producto_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['pro_valor_subsidio']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->pro_valor_subsidio = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['pro_valor_subsidio'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['tarifa_ice']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tarifa_ice = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['tarifa_ice'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['total_ice']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->total_ice = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['total_ice'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['tarifa_iva']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tarifa_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['tarifa_iva'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['base_iva']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->base_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['base_iva'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['total_iva']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->total_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['total_iva'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['tarifa_irbpnr']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tarifa_irbpnr = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['tarifa_irbpnr'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['total_irbpnr']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->total_irbpnr = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['total_irbpnr'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['pro_iva']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->pro_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['pro_iva'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['precio_con_impuesto']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->precio_con_impuesto = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['precio_con_impuesto'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['pro_ice']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->pro_ice = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['pro_ice'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['pro_irbpnr']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->pro_irbpnr = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']['pro_irbpnr'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_del_producto_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_del_producto_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_del_producto_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_del_producto_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_producto_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_del_producto_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_producto_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_del_producto_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_del_producto_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_del_producto_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_del_producto_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->pro_imagen && "S" != $this->pro_imagen_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_del_producto_mob_doc_name.php';
                }
    ...
    function ValidateField_pro_empresa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['php_cmp_required']['pro_empresa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['php_cmp_required']['pro_empresa'] == "on")) 
      { 
          if ($this->pro_empresa == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_pro_codigo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['php_cmp_required']['pro_codigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['php_cmp_required']['pro_codigo'] == "on")) 
      { 
          if ($this->pro_codigo == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_pro_codigo_aux(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['php_cmp_required']['pro_codigo_aux']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['php_cmp_required']['pro_codigo_aux'] == "on")) 
      { 
    ...
    function ValidateField_pro_descripcion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['php_cmp_required']['pro_descripcion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['php_cmp_required']['pro_descripcion'] == "on")) 
      { 
   ...
   if (isset($this->Field_no_validate['pro_categoria_producto'])) {
       return;
               ...
               if (!empty($this->pro_categoria_producto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_categoria_producto']) && !in_array($this->pro_categoria_producto, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_categoria_producto']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['pro_familia_producto'])) {
       return;
               ...
               if (!empty($this->pro_familia_producto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_familia_producto']) && !in_array($this->pro_familia_producto, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_familia_producto']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['pro_grupo_compras'])) {
       return;
               ...
               if (!empty($this->pro_grupo_compras) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_compras']) && !in_array($this->pro_grupo_compras, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_compras']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['pro_grupo_ventas'])) {
       return;
               ...
               if (!empty($this->pro_grupo_ventas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_ventas']) && !in_array($this->pro_grupo_ventas, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_ventas']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['pro_estado'])) {
       return;
               ...
               if (!empty($this->pro_estado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_estado']) && !in_array($this->pro_estado, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_estado']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_pro_precio_sin_subsidio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->pro_precio_sin_subsidio, 13, 2, -0, 1.0E+15, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_pro_precio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->pro_precio, 9, 6, -0, 1.0E+15, "N") == false)  
              { 
                  $hasError = true;
   ...
   if (isset($this->Field_no_validate['pro_por_ice'])) {
       return;
               ...
               if (!empty($this->pro_por_ice) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_ice']) && !in_array($this->pro_por_ice, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_ice']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_pro_base_ice(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->pro_base_ice, 9, 6, -0, 1.0E+15, "N") == false)  
              { 
                  $hasError = true;
   ...
   if (isset($this->Field_no_validate['pro_por_iva'])) {
       return;
               ...
               if (!empty($this->pro_por_iva) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_iva']) && !in_array($this->pro_por_iva, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_iva']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['pro_por_irbpnr'])) {
       return;
               ...
               if (!empty($this->pro_por_irbpnr) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_irbpnr']) && !in_array($this->pro_por_irbpnr, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_irbpnr']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_pro_base_irbpnr(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->pro_base_irbpnr, 10, 5, -0, 1.0E+15, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_precio_con_impuesto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->precio_con_impuesto, 18, 2, -0, 1.0E+20, "N") == false)  
              { 
                  $hasError = true;
   ...
   if (isset($this->Field_no_validate['pro_unidad'])) {
       return;
               ...
               if (!empty($this->pro_unidad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_unidad']) && !in_array($this->pro_unidad, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_unidad']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_pro_costo_promedio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->pro_costo_promedio, 11, 4, -0, 1.0E+15, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_pro_total_inventario(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->pro_total_inventario, 13, 2, -0, 1.0E+15, "N") == false)  
              { 
                  $hasError = true;
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['pro_codigo']['keyVal'] = form_del_producto_mob_pack_protect_string($this->nmgp_dados_form['pro_codigo']);
              $this->NM_ajax_info['fldList']['pro_empresa']['keyVal'] = form_del_producto_mob_pack_protect_string($this->nmgp_dados_form['pro_empresa']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_categoria_producto']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_categoria_producto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_categoria_producto']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_categoria_producto'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_del_producto_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_del_producto_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_categoria_producto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_categoria_producto']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_familia_producto']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_familia_producto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_familia_producto']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_familia_producto'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_familia_producto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_familia_producto']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_compras']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_compras'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_compras']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_compras'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_compras'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_grupo_compras']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_ventas']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_ventas'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_ventas']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_ventas'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_grupo_ventas'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_grupo_ventas']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_estado']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_estado'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_estado']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_estado'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_estado'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_estado']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_del_producto_mob_pack_protect_string('S') => str_replace('<', '&lt;',form_del_producto_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_aplica_subsidio'][] = 'S';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['pro_aplica_subsidio']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_ice']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_ice'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_ice']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_ice'] = array(); 
}
$aLookup[] = array(form_del_producto_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_del_producto_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_ice'][] = '0';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_ice'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_por_ice']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_iva']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_iva'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_iva']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_iva'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_iva'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_por_iva']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_irbpnr']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_irbpnr'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_irbpnr']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_irbpnr'] = array(); 
}
$aLookup[] = array(form_del_producto_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_del_producto_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_irbpnr'][] = '0';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_por_irbpnr'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_por_irbpnr']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_pro_iva($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['pro_iva'] = array(
              ...
              $this->NM_ajax_info['fldList']['pro_iva']['lookupCons'] = form_del_producto_mob_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
   ...
   function ajax_return_values_pro_ice($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['pro_ice'] = array(
              ...
              $this->NM_ajax_info['fldList']['pro_ice']['lookupCons'] = form_del_producto_mob_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
   ...
   function ajax_return_values_pro_irbpnr($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['pro_irbpnr'] = array(
              ...
              $this->NM_ajax_info['fldList']['pro_irbpnr']['lookupCons'] = form_del_producto_mob_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
...
$aLookup[] = array(form_del_producto_mob_pack_protect_string('S') => str_replace('<', '&lt;',form_del_producto_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_compra'][] = 'S';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['pro_compra']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_del_producto_mob_pack_protect_string('S') => str_replace('<', '&lt;',form_del_producto_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_venta'][] = 'S';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['pro_venta']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_del_producto_mob_pack_protect_string('S') => str_replace('<', '&lt;',form_del_producto_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_stock'][] = 'S';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['pro_stock']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_unidad']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_unidad'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_unidad']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_unidad'] = array(); 
}
$aLookup[] = array(form_del_producto_mob_pack_protect_string('') => str_replace('<', '&lt;',form_del_producto_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_unidad'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_unidad'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_unidad']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_pro_total_inventario($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Field_no_validate'] = array();
      if (!$this->NM_ajax_flag || !isset($this->nmgp_refresh_fields)) {
      $_SESSION['scriptcase']['form_del_producto_mob']['contr_erro'] = 'on';
...
if($this->pro_aplica_subsidio =='S'){
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_del_producto_mob';
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] = $rsc->fields[0];
      $rsc->Close();
   }
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              if (isset($NM_val_form['pro_cta_cartera_vencida']) && $NM_val_form['pro_cta_cartera_vencida'] != $this->nmgp_dados_select['pro_cta_cartera_vencida']) 
              { 
                  $SC_fields_update[] = "pro_cta_cartera_vencida = $this->pro_cta_cartera_vencida"; 
              } 
              if (isset($NM_val_form['pro_cta_cobrar']) && $NM_val_form['pro_cta_cobrar'] != $this->nmgp_dados_select['pro_cta_cobrar']) 
              { 
                  $SC_fields_update[] = "pro_cta_cobrar = $this->pro_cta_cobrar"; 
              } 
              if (isset($NM_val_form['pro_cta_ingreso']) && $NM_val_form['pro_cta_ingreso'] != $this->nmgp_dados_select['pro_cta_ingreso']) 
              { 
                  $SC_fields_update[] = "pro_cta_ingreso = $this->pro_cta_ingreso"; 
              } 
              if (isset($NM_val_form['pro_cta_puente']) && $NM_val_form['pro_cta_puente'] != $this->nmgp_dados_select['pro_cta_puente']) 
              { 
                  $SC_fields_update[] = "pro_cta_puente = $this->pro_cta_puente"; 
              } 
              if (isset($NM_val_form['pro_producto_debi']) && $NM_val_form['pro_producto_debi'] != $this->nmgp_dados_select['pro_producto_debi']) 
              { 
                  $SC_fields_update[] = "pro_producto_debi = $this->pro_producto_debi"; 
              } 
              $temp_cmd_sql = "";
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['pro_imagen_salva'] = array(
                      'row'     => '',
              ...
              $this->nmgp_refresh_fields = array_diff(array('pro_imagen', 'pro_empresa', 'pro_codigo', 'pro_codigo_aux', 'pro_descripcion', 'pro_categoria_producto', 'pro_familia_producto', 'pro_grupo_compras', 'pro_grupo_ventas', 'pro_estado', 'pro_aplica_subsidio', 'pro_precio_sin_subsidio', 'pro_valor_subsidio', 'pro_precio', 'pro_por_ice', 'tarifa_ice', 'pro_base_ice', 'total_ice', 'pro_por_iva', 'tarifa_iva', 'base_iva', 'total_iva', 'pro_por_irbpnr', 'tarifa_irbpnr', 'pro_base_irbpnr', 'total_irbpnr', 'pro_iva', 'precio_con_impuesto', 'pro_ice', 'pro_irbpnr', 'pro_compra', 'pro_venta', 'pro_stock', 'pro_unidad', 'pro_cantidad_inventario', 'pro_costo_promedio', 'pro_total_inventario'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (pro_codigo, pro_codigo_aux, pro_empresa, pro_descripcion, pro_iva, pro_por_iva, pro_ice, pro_por_ice, pro_irbpnr, pro_por_irbpnr, pro_precio, pro_descuento, pro_estado, pro_familia_producto, pro_grupo_compras, pro_grupo_ventas, pro_categoria_producto, pro_cantidad_inventario, pro_costo_promedio, pro_total_inventario, pro_imagen, pro_compra, pro_venta, pro_stock, pro_base_ice, pro_base_irbpnr, pro_aplica_subsidio, pro_precio_sin_subsidio, pro_cta_cartera_vencida, pro_cta_cobrar, pro_cta_ingreso, pro_cta_puente, pro_producto_debi, pro_unidad) VALUES ('$this->pro_codigo', '$this->pro_codigo_aux', '$this->pro_empresa', '$this->pro_descripcion', '$this->pro_iva', $this->pro_por_iva, '$this->pro_ice', $this->pro_por_ice, '$this->pro_irbpnr', '$this->pro_por_irbpnr', $this->pro_precio, $this->pro_descuento, '$this->pro_estado', $this->pro_familia_producto, $this->pro_grupo_compras, $this->pro_grupo_ventas, '$this->pro_categoria_producto', $this->pro_cantidad_inventario, $this->pro_costo_promedio, $this->pro_total_inventario, '$this->pro_imagen', '$this->pro_compra', '$this->pro_venta', '$this->pro_stock', $this->pro_base_ice, $this->pro_base_irbpnr, '$this->pro_aplica_subsidio', $this->pro_precio_sin_subsidio, $this->pro_cta_cartera_vencida, $this->pro_cta_cobrar, $this->pro_cta_ingreso, $this->pro_cta_puente, $this->pro_producto_debi, $this->pro_unidad)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] = 0; 
              }
...
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
  $insert_sql = "INSERT INTO del_kardex(
			...
			VALUES
				(
					'".$this->sc_temp_Igtech_RucEmpresa."',
					getdate(),
					'".$this->pro_codigo ."',
					'KI',
					0,
...
$_SESSION['scriptcase']['form_del_producto_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['parms'] = "pro_codigo?#?$this->pro_codigo?@?pro_empresa?#?$this->pro_empresa?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
      ...
      { 
          ...
          $qt_geral_reg_form_del_producto_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['total'] = $qt_geral_reg_form_del_producto_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->pro_codigo) && !empty($this->pro_empresa))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_del_producto_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] > $qt_geral_reg_form_del_producto_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] = $qt_geral_reg_form_del_producto_mob; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_del_producto_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          { 
              $nmgp_select = "SELECT pro_codigo, pro_codigo_aux, pro_empresa, pro_descripcion, pro_iva, pro_por_iva, pro_ice, pro_por_ice, pro_irbpnr, pro_por_irbpnr, pro_precio, pro_descuento, pro_estado, pro_familia_producto, pro_grupo_compras, pro_grupo_ventas, pro_categoria_producto, pro_cantidad_inventario, pro_costo_promedio, pro_total_inventario, pro_imagen, pro_compra, pro_venta, pro_stock, pro_base_ice, pro_base_irbpnr, pro_aplica_subsidio, pro_precio_sin_subsidio, pro_cta_cartera_vencida, pro_cta_cobrar, pro_cta_ingreso, pro_cta_puente, pro_producto_debi, pro_unidad from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT pro_codigo, pro_codigo_aux, pro_empresa, pro_descripcion, pro_iva, pro_por_iva, pro_ice, pro_por_ice, pro_irbpnr, pro_por_irbpnr, pro_precio, pro_descuento, pro_estado, pro_familia_producto, pro_grupo_compras, pro_grupo_ventas, pro_categoria_producto, pro_cantidad_inventario, pro_costo_promedio, pro_total_inventario, pro_imagen, pro_compra, pro_venta, pro_stock, pro_base_ice, pro_base_irbpnr, pro_aplica_subsidio, pro_precio_sin_subsidio, pro_cta_cartera_vencida, pro_cta_cobrar, pro_cta_ingreso, pro_cta_puente, pro_producto_debi, pro_unidad from " . $this->Ini->nm_tabela ; 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->pro_cta_cartera_vencida = $rs->fields[28] ; 
              ...
              $this->pro_cta_ingreso = $rs->fields[30] ; 
              $this->nmgp_dados_select['pro_cta_ingreso'] = $this->pro_cta_ingreso;
              $this->pro_cta_puente = $rs->fields[31] ; 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] < $qt_geral_reg_form_del_producto_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opcao']   = '';
          }
      } 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dados_select'];
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_pro_imagen))
       {
        ...
        $this->initFormPages();
    include_once("form_del_producto_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_del_producto_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['total'] = $qt_geral_reg_form_del_producto_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_del_producto_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "pro_por_iva";$nm_numeric[] = "pro_por_ice";$nm_numeric[] = "pro_precio";$nm_numeric[] = "pro_descuento";$nm_numeric[] = "pro_familia_producto";$nm_numeric[] = "pro_grupo_compras";$nm_numeric[] = "pro_grupo_ventas";$nm_numeric[] = "pro_cantidad_inventario";$nm_numeric[] = "pro_costo_promedio";$nm_numeric[] = "pro_total_inventario";$nm_numeric[] = "pro_base_ice";$nm_numeric[] = "pro_base_irbpnr";$nm_numeric[] = "pro_precio_sin_subsidio";$nm_numeric[] = "pro_cta_cartera_vencida";$nm_numeric[] = "pro_cta_cobrar";$nm_numeric[] = "pro_cta_ingreso";$nm_numeric[] = "pro_cta_puente";$nm_numeric[] = "pro_producto_debi";$nm_numeric[] = "pro_unidad";$nm_numeric[] = "";
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_del_producto_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_del_producto_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['ordem_ord'] == " desc") {
