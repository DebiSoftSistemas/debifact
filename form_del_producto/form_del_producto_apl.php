   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('pro_empresa', 'pro_codigo', 'pro_codigo_aux', 'pro_descripcion', 'pro_categoria_producto', 'pro_familia_producto', 'pro_grupo_compras', 'pro_grupo_ventas', 'pro_estado', 'pro_aplica_subsidio', 'pro_precio_sin_subsidio', 'pro_valor_subsidio', 'pro_precio', 'pro_por_ice', 'tarifa_ice', 'pro_base_ice', 'total_ice', 'pro_por_iva', 'tarifa_iva', 'base_iva', 'total_iva', 'pro_por_irbpnr', 'tarifa_irbpnr', 'pro_base_irbpnr', 'total_irbpnr', 'pro_iva', 'precio_con_impuesto', 'pro_ice', 'pro_irbpnr', 'pro_compra', 'pro_venta', 'pro_stock', 'pro_unidad', 'pro_cantidad_inventario', 'pro_costo_promedio', 'pro_total_inventario'), $aDoNotUpdate);
              $this->ajax_return_values();
