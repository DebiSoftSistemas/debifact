...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_pro_codigo' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_codigo_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_producto_pro_codigo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_codigo_aux' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_codigo_aux_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_del_producto_pro_codigo_aux_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_empresa' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_empresa_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_del_producto_pro_empresa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_descripcion' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_descripcion_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_del_producto_pro_descripcion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_precio' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_precio_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_producto_pro_precio_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_del_producto_pro_precio_onfocus(this, iSeqRow) });
  $('#id_sc_field_pro_descuento' + iSeqRow).bind('change', function() { sc_form_del_producto_pro_descuento_onchange(this, iSeqRow) });
  $('#id_sc_field_pro_estado' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_estado_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_producto_pro_estado_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_grupo_compras' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_grupo_compras_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_producto_pro_grupo_compras_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_grupo_ventas' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_grupo_ventas_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_del_producto_pro_grupo_ventas_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_categoria_producto' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_categoria_producto_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_form_del_producto_pro_categoria_producto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_total_inventario' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_total_inventario_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_del_producto_pro_total_inventario_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_imagen' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_imagen_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_producto_pro_imagen_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_compra' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_compra_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_producto_pro_compra_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_venta' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_venta_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_del_producto_pro_venta_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_stock' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_stock_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_del_producto_pro_stock_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_base_ice' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_base_ice_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_del_producto_pro_base_ice_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_base_irbpnr' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_base_irbpnr_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_del_producto_pro_base_irbpnr_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_aplica_subsidio' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_aplica_subsidio_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_del_producto_pro_aplica_subsidio_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_cta_cartera_vencida' + iSeqRow).bind('change', function() { sc_form_del_producto_pro_cta_cartera_vencida_onchange(this, iSeqRow) });
  $('#id_sc_field_pro_cta_cobrar' + iSeqRow).bind('change', function() { sc_form_del_producto_pro_cta_cobrar_onchange(this, iSeqRow) });
  $('#id_sc_field_pro_cta_ingreso' + iSeqRow).bind('change', function() { sc_form_del_producto_pro_cta_ingreso_onchange(this, iSeqRow) });
  $('#id_sc_field_pro_cta_puente' + iSeqRow).bind('change', function() { sc_form_del_producto_pro_cta_puente_onchange(this, iSeqRow) });
  $('#id_sc_field_pro_producto_debi' + iSeqRow).bind('change', function() { sc_form_del_producto_pro_producto_debi_onchange(this, iSeqRow) });
  $('#id_sc_field_pro_unidad' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_unidad_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_producto_pro_unidad_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_valor_subsidio' + iSeqRow).bind('blur', function() { sc_form_del_producto_pro_valor_subsidio_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_del_producto_pro_valor_subsidio_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tarifa_ice' + iSeqRow).bind('blur', function() { sc_form_del_producto_tarifa_ice_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_producto_tarifa_ice_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tarifa_irbpnr' + iSeqRow).bind('blur', function() { sc_form_del_producto_tarifa_irbpnr_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_del_producto_tarifa_irbpnr_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_base_iva' + iSeqRow).bind('blur', function() { sc_form_del_producto_base_iva_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_del_producto_base_iva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_total_iva' + iSeqRow).bind('blur', function() { sc_form_del_producto_total_iva_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_del_producto_total_iva_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_del_producto_total_iva_onfocus(this, iSeqRow) });
  $('#id_sc_field_valor_iva' + iSeqRow).bind('change', function() { sc_form_del_producto_valor_iva_onchange(this, iSeqRow) });
  $('#id_sc_field_total_irbpnr' + iSeqRow).bind('blur', function() { sc_form_del_producto_total_irbpnr_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_del_producto_total_irbpnr_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_total_ice' + iSeqRow).bind('blur', function() { sc_form_del_producto_total_ice_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_del_producto_total_ice_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_del_producto_total_ice_onfocus(this, iSeqRow) });
  $('#id_sc_field_valor_irbpnr' + iSeqRow).bind('change', function() { sc_form_del_producto_valor_irbpnr_onchange(this, iSeqRow) });
  $('#id_sc_field_valor_ice' + iSeqRow).bind('change', function() { sc_form_del_producto_valor_ice_onchange(this, iSeqRow) });
  $('#id_sc_field_precio_con_impuesto' + iSeqRow).bind('blur', function() { sc_form_del_producto_precio_con_impuesto_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_del_producto_precio_con_impuesto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tarifa_iva' + iSeqRow).bind('blur', function() { sc_form_del_producto_tarifa_iva_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_producto_tarifa_iva_onchange(this, iSeqRow) })
...
function sc_form_del_producto_pro_codigo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_codigo_aux_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_descripcion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_precio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_descuento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_estado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_grupo_compras_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_grupo_ventas_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_categoria_producto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_total_inventario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_imagen_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_compra_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_venta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_stock_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_base_ice_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_base_irbpnr_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_aplica_subsidio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_cta_cartera_vencida_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_producto_pro_cta_cobrar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_producto_pro_cta_ingreso_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_producto_pro_cta_puente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_producto_pro_producto_debi_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_unidad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_pro_valor_subsidio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_tarifa_ice_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_tarifa_irbpnr_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_base_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_total_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_valor_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_total_irbpnr_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_total_ice_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_valor_irbpnr_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_producto_valor_ice_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_precio_con_impuesto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_producto_tarifa_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_del_producto_form" + pageNo).hide();
}
...
function scJQCalculatorAdd(iSeqRow) {
  _scCalculatorBlurOk["id_sc_field_tarifa_iva" + iSeqRow] = true;
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_pro_imagen" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_del_producto_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_del_producto')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
