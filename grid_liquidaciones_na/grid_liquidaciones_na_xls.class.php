...
class grid_liquidaciones_na_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function sc_actionbar_disable($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_liquidaciones_na/grid_liquidaciones_na_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_liquidaciones_na_res_xls.class.php");
              $this->Res_xls = new grid_liquidaciones_na_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_liquidaciones_na.zip";
          $this->Arquivo   .= "_grid_liquidaciones_na" . $this->Xls_tp;
          $this->Tit_doc    = "grid_liquidaciones_na" . $this->Xls_tp;
          $this->Tit_zip    = "grid_liquidaciones_na.zip";
      ...
      require_once($this->Ini->path_aplicacao . "grid_liquidaciones_na_total.class.php"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->fc_fecha = $rs->fields[1] ;  
         $this->pr_nombre = $rs->fields[2] ;  
         $this->pr_identificacion = $rs->fields[3] ;  
         $this->fc_total = $rs->fields[4] ;  
         $this->fc_total = (string)$this->fc_total;
         $this->liq_estado_sri = $rs->fields[5] ;  
         $this->fc_autorizacion = $rs->fields[6] ;  
         $this->liq_error_sri = $rs->fields[7] ;  
         $this->fc_id = $rs->fields[8] ;  
         $this->fc_id = (string)$this->fc_id;
         $this->fc_estado = $rs->fields[9] ;  
...
$_SESSION['scriptcase']['grid_liquidaciones_na']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liquidaciones_na']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
