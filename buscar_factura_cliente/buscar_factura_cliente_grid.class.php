<?php
class buscar_factura_cliente_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['charts_html'] = '';
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['buscar_factura_cliente'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_bot();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'];
 }
...
//
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "buscar_factura_cliente/buscar_factura_cliente_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['pesq_tab_label'] .= "fac_fecha?#?" . "" . $this->Ini->Nm_lang['lang_fecha'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['pesq_tab_label'] .= "sc_field_0?#?" . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['pesq_tab_label'] .= "fac_secuencial?#?" . "" . $this->Ini->Nm_lang['lang_secuencial'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("sc_field_0");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['print_all'];
   if ($this->Print_All)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] = "muda_qt_linhas";
   } 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['buscar_factura_cliente'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['buscar_factura_cliente'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "buscar_factura_cliente/buscar_factura_cliente_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "buscar_factura_cliente_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new buscar_factura_cliente_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_select']['fac_numero'] = 'desc'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid'];
   }
//----- 
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
   { 
       $nmgp_select = "SELECT fac_numero, est_codigo||'-'||pen_serie as sc_field_0, fac_secuencial, str_replace (convert(char(10),fac_fecha,102), '.', '-') + ' ' + convert(char(8),fac_fecha,20), fac_comentario, cl_identificacion, cl_nombre, fac_total from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT fac_numero, est_codigo||'-'||pen_serie as sc_field_0, fac_secuencial, fac_fecha, fac_comentario, cl_identificacion, cl_nombre, fac_total from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT fac_numero, est_codigo||'-'||pen_serie as sc_field_0, fac_secuencial, convert(char(23),fac_fecha,121), fac_comentario, cl_identificacion, cl_nombre, fac_total from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT fac_numero, est_codigo||'-'||pen_serie as sc_field_0, fac_secuencial, EXTEND(fac_fecha, YEAR TO DAY), fac_comentario, cl_identificacion, cl_nombre, fac_total from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT fac_numero, est_codigo||'-'||pen_serie as sc_field_0, fac_secuencial, fac_fecha, fac_comentario, cl_identificacion, cl_nombre, fac_total from " . $this->Ini->nm_tabela; 
   } 
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->fac_fecha = $this->rs_grid->fields[3] ;  
       $this->fac_comentario = $this->rs_grid->fields[4] ;  
       $this->cl_identificacion = $this->rs_grid->fields[5] ;  
       $this->cl_nombre = $this->rs_grid->fields[6] ;  
       $this->fac_total = $this->rs_grid->fields[7] ;  
       $this->fac_total = (string)$this->fac_total;
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               buscar_factura_cliente_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               buscar_factura_cliente_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               buscar_factura_cliente_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               buscar_factura_cliente_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               buscar_factura_cliente_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"buscar_factura_cliente_jquery_4250.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"buscar_factura_cliente_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"buscar_factura_cliente_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida']) {  
...
$nm_saida->saida("    </style>\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-buscar_factura_cliente-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-buscar_factura_cliente-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-buscar_factura_cliente-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-983a1d59\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_buscar_factura_cliente_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_buscar_factura_cliente_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_buscar_factura_cliente_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "buscar_factura_cliente/buscar_factura_cliente_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".buscar_factura_cliente_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .buscar_factura_cliente_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".buscar_factura_cliente_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'])
   { 
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf" && !$this->Print_All)
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['buscar_factura_cliente']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['buscar_factura_cliente']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['buscar_factura_cliente']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['buscar_factura_cliente']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida']) ? "buscar_factura_cliente_" : "";
   $this->css_sep = " ";
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_label'])
   { 
       $this->New_label['fac_secuencial'] = "" . $this->Ini->Nm_lang['lang_secuencial'] . "";
       $this->New_label['fac_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . "";
       $this->New_label['fac_comentario'] = "" . $this->Ini->Nm_lang['lang_comentario'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_buscar_factura_cliente__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-buscar_factura_cliente-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_total_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fac_total_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['field_order'] as $Cada_label)
   { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".buscar_factura_cliente_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
 ...
 function NM_label_fac_numero()
 {
   ...
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != 'pdf') {
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ini_cor_grid']);
       }
   }
   ...
   $this->sc_where_atual   = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_pesq'];
   $this->sc_where_filtro  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['where_pesq_filtro'];
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_cliente']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_buscar_factura_cliente#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['force_toolbar'] = true;
           } 
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_buscar_factura_cliente#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-983a1d59\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['Page_break_PDF'] = array();
       }
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  buscar_factura_cliente_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->fac_total = (string)$this->fac_total;
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['rows_emb']++;
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_fac_total_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_fac_total_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_fac_secuencial()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['fac_secuencial']) || $this->NM_cmp_hidden['fac_secuencial'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['print_navigator'] == "Netscape")
            {
        ...
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ajax_nav'])
          {
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if (is_file("buscar_factura_cliente_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("buscar_factura_cliente_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['cond_pesq'];
       $pos = strrpos($tmp, "##*@@");
       if ($pos !== false)
       {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('fac_fecha','sc_field_0','fac_secuencial');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq']) < 3)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_sc_field_0($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nm_comando = "select distinct est_codigo||'-'||pen_serie from " . $this->Ini->nm_tabela . " where (fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and cl_id=" . $_SESSION['var_cliente'] . " and fac_estado='V' and cl_identificacion<>'9999999999999') and #lowerI#est_codigo||'-'||pen_serie#lowerF# = #lowerI#'$sc_field_0_look'#lowerF# order by est_codigo||'-'||pen_serie"; 
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       $lin_obj .= "     <select class='sc-ui-autocomp-sc_field_0 " . $this->css_scAppDivToolbarInput . "' id='id_ac_grid_sc_field_0" . $ind . "' name='val_grid_search_sc_field_0_autocomp" . $ind . "'>";
       if ('' !=  $sc_field_0) {
           $lin_obj .= "     <option value='" . $sc_field_0 . "'  selected>" . $sAutocompValue . "</option>";
       }
       $lin_obj .= "     </select>";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   function lookup_ajax_sc_field_0($sc_field_0)
   {
       ...
       $sc_field_0_look = (is_string($sc_field_0) ? substr($this->Db->qstr($sc_field_0), 1, -1) : $sc_field_0); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct est_codigo||'-'||pen_serie from " . $this->Ini->nm_tabela . " where (fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and cl_id=" . $_SESSION['var_cliente'] . " and fac_estado='V' and cl_identificacion<>'9999999999999') and  #lowerI#est_codigo||'-'||pen_serie#lowerF# like #lowerI#'%" . $sc_field_0 . "%'#lowerF# order by est_codigo||'-'||pen_serie"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = buscar_factura_cliente_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "debi_doc_electronicos/buscar_factura_cliente";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_buscar_factura_cliente_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_buscar_factura_cliente_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_mes'] =  'sc_buscar_factura_cliente_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_dia'] =  'sc_buscar_factura_cliente_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_v2__mes'] =  'sc_buscar_factura_cliente_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_v2__dia'] =  'sc_buscar_factura_cliente_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_mes']", 'value' => 'sc_buscar_factura_cliente_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_dia']", 'value' => 'sc_buscar_factura_cliente_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_v2__mes']", 'value' => 'sc_buscar_factura_cliente_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_v2__dia']", 'value' => 'sc_buscar_factura_cliente_valida_dia(this)');
       } 
       ...
       $nm_saida->saida("                        $(\".sc-ui-autocomp-sc_field_0\").on(\"focus\", function() {\r\n");
       ...
       $nm_saida->saida("                         $(\"#grid_search_sc_field_0_val_\" + x_sc_field_0).val(e.params.data.id);\r\n");
       $nm_saida->saida("                        });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("             }\r\n");
       $nm_saida->saida("         }\r\n");
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('buscar_factura_cliente', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"buscar_factura_cliente\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"buscar_factura_cliente_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"buscar_factura_cliente_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['buscar_factura_cliente_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@buscar_factura_cliente@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"buscar_factura_cliente_iframe.php\";\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"buscar_factura_cliente_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['buscar_factura_cliente']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"buscar_factura_cliente_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_cliente']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('buscar_factura_cliente')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('buscar_factura_cliente', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
