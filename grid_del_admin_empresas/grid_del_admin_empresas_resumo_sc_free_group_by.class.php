...
class grid_del_admin_empresas_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_emp_tipo_suscripcion;
   var $array_total_emp_fecha_crea;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_emp_tipo_suscripcion = array();
      $this->array_total_emp_fecha_crea       = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_del_admin_empresas']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_del_admin_empresas']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['arr_total']['emp_tipo_suscripcion'] = $this->array_total_emp_tipo_suscripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['arr_total']['emp_fecha_crea'] = $this->array_total_emp_fecha_crea;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['json_use_label'])
       {
          $Lab_emp_tipo_suscripcion = "emp_tipo_suscripcion";
          $Lab_emp_fecha_crea = "emp_fecha_crea";
       }
       else
       {
       $Lab_emp_tipo_suscripcion = "" . $this->Ini->Nm_lang['lang_tipo_suscripcion'] . "";
       $Lab_emp_fecha_crea = "" . $this->Ini->Nm_lang['lang_fecha_crea'] . "";
       $Lab_emp_fecha_crea =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_emp_fecha_crea);
       }
       $prep_field = array();
       $prep_field['emp_tipo_suscripcion'] = $Lab_emp_tipo_suscripcion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_tipo_suscripcion'] = $Lab_emp_tipo_suscripcion; 
       $prep_field['emp_fecha_crea'] = $Lab_emp_fecha_crea;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_fecha_crea'] = $Lab_emp_fecha_crea; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_logo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_logo'] = "" . $this->Ini->Nm_lang['lang_logotipo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_ruc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_ruc'] = "" . $this->Ini->Nm_lang['lang_ruc'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_razon_social']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_razon_social'] = "" . $this->Ini->Nm_lang['lang_razon_social'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_nombre_comercial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_nombre_comercial'] = "" . $this->Ini->Nm_lang['lang_nombre_comercial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_representante_legal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_representante_legal'] = "" . $this->Ini->Nm_lang['lang_nombre_representante'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_direccion_matriz']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_direccion_matriz'] = "" . $this->Ini->Nm_lang['lang_direccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_tipo_suscripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_tipo_suscripcion'] = "" . $this->Ini->Nm_lang['lang_tipo_suscripcion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_obligado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_obligado'] = "" . $this->Ini->Nm_lang['lang_obligado_contabilidad'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_contribuyente_especial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_contribuyente_especial'] = "" . $this->Ini->Nm_lang['lang_contribuyente_especial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_estado'] = "" . $this->Ini->Nm_lang['lang_estado'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_ambiente_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_ambiente_sri'] = "" . $this->Ini->Nm_lang['lang_tipo_ambiente'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_autorizacion_inmediata']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_autorizacion_inmediata'] = "" . $this->Ini->Nm_lang['lang_autorizacion_inmediata'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_es_op_transporte']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_es_op_transporte'] = "" . $this->Ini->Nm_lang['lang_es_op_transporte'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_fecha_crea']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_fecha_crea'] = "" . $this->Ini->Nm_lang['lang_fecha_crea'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_calificacion_artesanal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_calificacion_artesanal'] = "" . $this->Ini->Nm_lang['lang_calificacion_artesanal'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_agente_retencion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_agente_retencion'] = "" . $this->Ini->Nm_lang['lang_agente_retencion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_firma']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_firma'] = "" . $this->Ini->Nm_lang['lang_firma'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_clave_firma']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_clave_firma'] = "" . $this->Ini->Nm_lang['lang_clave_firma'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_regimen_especial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['labels']['emp_regimen_especial'] = "" . $this->Ini->Nm_lang['lang_regimen_especial'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['emp_tipo_suscripcion']['alin'] = "''";
       $Arr_parms['emp_tipo_suscripcion']['link'] = "S";
       $Arr_parms['emp_fecha_crea']['alin'] = "''";
       $Arr_parms['emp_fecha_crea']['link'] = "S";
       $Arr_parms['emp_tipo_suscripcion']['fill'] = "true";
       $Arr_parms['emp_tipo_suscripcion']['order'] = "label";
       $Arr_parms['emp_tipo_suscripcion']['order_start'] = 'asc';
       $Arr_parms['emp_tipo_suscripcion']['order_invert'] = 'false';
       $Arr_parms['emp_tipo_suscripcion']['order_enabled'] = 'true';
       $Arr_parms['emp_tipo_suscripcion']['order_datatype'] = 'varchar';
       $Arr_parms['emp_tipo_suscripcion']['rating_function'] = '';
       $Arr_parms['emp_fecha_crea']['fill'] = "true";
       $Arr_parms['emp_fecha_crea']['order'] = "value";
       $Arr_parms['emp_fecha_crea']['order_start'] = 'asc';
       $Arr_parms['emp_fecha_crea']['order_invert'] = 'false';
       $Arr_parms['emp_fecha_crea']['order_enabled'] = 'true';
       $Arr_parms['emp_fecha_crea']['order_datatype'] = 'datetime';
       $Arr_parms['emp_fecha_crea']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['emp_tipo_suscripcion'] = array(0 => 'emp_tipo_suscripcion', 1 => '@aspass@');
       $prep_links_fl['emp_fecha_crea'] = array(0 => 'emp_fecha_crea', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_del_admin_empresas@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_del_admin_empresas_total.class.php"); 
      }
      ...
      $this->Total   = new grid_del_admin_empresas_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['ajax_nav']) {  
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_del_admin_empresas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_del_admin_empresas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_del_admin_empresas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_del_admin_empresas/grid_del_admin_empresas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_del_admin_empresas/grid_del_admin_empresas_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_del_admin_empresas/grid_del_admin_empresas_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_del_admin_empresas&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_del_admin_empresas/grid_del_admin_empresas_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_del_admin_empresas/grid_del_admin_empresas_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume&nm_all_modules=grid,resume&nm_json_format=N&nm_json_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_del_admin_empresas/grid_del_admin_empresas_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_del_admin_empresas/grid_del_admin_empresas_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_del_admin_empresas/grid_del_admin_empresas_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_del_admin_empresas/grid_del_admin_empresas_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_del_admin_empresas_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_del_admin_empresas']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_del_admin_empresas']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_del_admin_empresas_config_pivot.php?nome_apl=grid_del_admin_empresas&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_del_admin_empresas_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_del_admin_empresas_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_del_admin_empresas/grid_del_admin_empresas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $emp_ruc = (isset($Busca_temp['emp_ruc'])) ? $Busca_temp['emp_ruc'] : ""; 
          $tmp_pos = (is_string($emp_ruc)) ? strpos($emp_ruc, "##@@") : false;
          if ($tmp_pos !== false && !is_array($emp_ruc))
          {
              $emp_ruc = substr($emp_ruc, 0, $tmp_pos);
          }
          $emp_razon_social = (isset($Busca_temp['emp_razon_social'])) ? $Busca_temp['emp_razon_social'] : ""; 
          $tmp_pos = (is_string($emp_razon_social)) ? strpos($emp_razon_social, "##@@") : false;
          if ($tmp_pos !== false && !is_array($emp_razon_social))
          {
              $emp_razon_social = substr($emp_razon_social, 0, $tmp_pos);
          }
          $emp_nombre_comercial = (isset($Busca_temp['emp_nombre_comercial'])) ? $Busca_temp['emp_nombre_comercial'] : ""; 
          $tmp_pos = (is_string($emp_nombre_comercial)) ? strpos($emp_nombre_comercial, "##@@") : false;
          if ($tmp_pos !== false && !is_array($emp_nombre_comercial))
          {
              $emp_nombre_comercial = substr($emp_nombre_comercial, 0, $tmp_pos);
          }
          $emp_logo = (isset($Busca_temp['emp_logo'])) ? $Busca_temp['emp_logo'] : ""; 
          $tmp_pos = (is_string($emp_logo)) ? strpos($emp_logo, "##@@") : false;
          if ($tmp_pos !== false && !is_array($emp_logo))
          {
              $emp_logo = substr($emp_logo, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($quebra_emp_tipo_suscripcion, $quebra_emp_fecha_crea, $quebra_emp_tipo_suscripcion_orig, $quebra_emp_fecha_crea_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_admin_empresas']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->emp_ruc = $Busca_temp['emp_ruc']; 
       $this->emp_ruc = (isset($Busca_temp['emp_ruc'])) ? $Busca_temp['emp_ruc'] : ""; 
       $tmp_pos = (is_string($this->emp_ruc)) ? strpos($this->emp_ruc, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->emp_ruc))
       {
       ...
       $this->emp_razon_social = $Busca_temp['emp_razon_social']; 
       $this->emp_razon_social = (isset($Busca_temp['emp_razon_social'])) ? $Busca_temp['emp_razon_social'] : ""; 
       $tmp_pos = (is_string($this->emp_razon_social)) ? strpos($this->emp_razon_social, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->emp_razon_social))
       {
       ...
       $this->emp_nombre_comercial = $Busca_temp['emp_nombre_comercial']; 
       $this->emp_nombre_comercial = (isset($Busca_temp['emp_nombre_comercial'])) ? $Busca_temp['emp_nombre_comercial'] : ""; 
       $tmp_pos = (is_string($this->emp_nombre_comercial)) ? strpos($this->emp_nombre_comercial, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->emp_nombre_comercial))
       {
       ...
       $this->emp_logo = $Busca_temp['emp_logo']; 
       $this->emp_logo = (isset($Busca_temp['emp_logo'])) ? $Busca_temp['emp_logo'] : ""; 
       $tmp_pos = (is_string($this->emp_logo)) ? strpos($this->emp_logo, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->emp_logo))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->emp_logo = $rs_res->fields[0] ;  
            $this->emp_ruc = $rs_res->fields[1] ;  
            $this->emp_razon_social = $rs_res->fields[2] ;  
            $this->emp_nombre_comercial = $rs_res->fields[3] ;  
            $this->emp_representante_legal = $rs_res->fields[4] ;  
            $this->emp_direccion_matriz = $rs_res->fields[5] ;  
            $this->emp_telefono = $rs_res->fields[6] ;  
            $this->emp_email = $rs_res->fields[7] ;  
            $this->emp_tipo_suscripcion = $rs_res->fields[8] ;  
            $this->emp_obligado = $rs_res->fields[9] ;  
            $this->emp_contribuyente_especial = $rs_res->fields[10] ;  
            $this->emp_estado = $rs_res->fields[11] ;  
            $this->emp_ambiente_sri = $rs_res->fields[12] ;  
            $this->emp_autorizacion_inmediata = $rs_res->fields[13] ;  
            $this->emp_es_op_transporte = $rs_res->fields[14] ;  
            $this->emp_fecha_crea = $rs_res->fields[15] ;  
            $this->emp_calificacion_artesanal = $rs_res->fields[16] ;  
            $this->emp_agente_retencion = $rs_res->fields[17] ;  
            $this->emp_tipo_suscripcion_orig = $this->emp_tipo_suscripcion;
            $this->emp_fecha_crea_orig = $this->emp_fecha_crea;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->emp_tipo_suscripcion, $this->emp_fecha_crea, $this->emp_tipo_suscripcion_orig,  $this->emp_fecha_crea_orig);
            }
   }
//
