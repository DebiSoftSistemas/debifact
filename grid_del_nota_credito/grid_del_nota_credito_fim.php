...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_nota_credito"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_nota_credito"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_nota_credito'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_nota_credito']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_nota_credito']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_nota_credito']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_nota_credito']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_nota_credito']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_nota_credito</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_nota_credito']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_nota_credito']['embutida_filho'] as $ind => $sc_init)
          {
