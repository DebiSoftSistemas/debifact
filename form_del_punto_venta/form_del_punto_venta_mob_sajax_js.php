  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_punto_venta_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_punto_venta_mob_form();
	}
...
?>
  ...
  // ---------- Validate titulo
  function do_ajax_form_del_punto_venta_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldHidden(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_titulo_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_titulo

  function do_ajax_form_del_punto_venta_mob_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_titulo_cb

  // ---------- Validate fac_estado_sri
  function do_ajax_form_del_punto_venta_mob_validate_fac_estado_sri()
  {
    var nomeCampo_fac_estado_sri = "fac_estado_sri";
    var var_fac_estado_sri = scAjaxGetFieldHidden(nomeCampo_fac_estado_sri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_estado_sri(var_fac_estado_sri, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_estado_sri_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_estado_sri

  function do_ajax_form_del_punto_venta_mob_validate_fac_estado_sri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_estado_sri_cb

  // ---------- Validate fac_error_sri
  function do_ajax_form_del_punto_venta_mob_validate_fac_error_sri()
  {
    var nomeCampo_fac_error_sri = "fac_error_sri";
    var var_fac_error_sri = scAjaxGetFieldText(nomeCampo_fac_error_sri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_error_sri(var_fac_error_sri, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_error_sri_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_error_sri

  function do_ajax_form_del_punto_venta_mob_validate_fac_error_sri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_error_sri_cb

  // ---------- Validate fac_numero
  function do_ajax_form_del_punto_venta_mob_validate_fac_numero()
  {
    var nomeCampo_fac_numero = "fac_numero";
    var var_fac_numero = scAjaxGetFieldHidden(nomeCampo_fac_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_numero(var_fac_numero, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_numero_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_numero

  function do_ajax_form_del_punto_venta_mob_validate_fac_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_numero_cb

  // ---------- Validate fac_tipo_comprobante
  function do_ajax_form_del_punto_venta_mob_validate_fac_tipo_comprobante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_tipo_comprobante(var_fac_tipo_comprobante, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_tipo_comprobante_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_tipo_comprobante

  function do_ajax_form_del_punto_venta_mob_validate_fac_tipo_comprobante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_tipo_comprobante_cb

  // ---------- Validate fac_empresa
  function do_ajax_form_del_punto_venta_mob_validate_fac_empresa()
  {
    var nomeCampo_fac_empresa = "fac_empresa";
    var var_fac_empresa = scAjaxGetFieldHidden(nomeCampo_fac_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_empresa(var_fac_empresa, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_empresa_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_empresa

  function do_ajax_form_del_punto_venta_mob_validate_fac_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_empresa_cb

  // ---------- Validate fac_establecimiento
  function do_ajax_form_del_punto_venta_mob_validate_fac_establecimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_establecimiento(var_fac_establecimiento, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_establecimiento_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_establecimiento

  function do_ajax_form_del_punto_venta_mob_validate_fac_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_establecimiento_cb

  // ---------- Validate fac_punto_emision
  function do_ajax_form_del_punto_venta_mob_validate_fac_punto_emision()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_punto_emision(var_fac_punto_emision, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_punto_emision_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_punto_emision

  function do_ajax_form_del_punto_venta_mob_validate_fac_punto_emision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_punto_emision_cb

  // ---------- Validate fac_ambiente
  function do_ajax_form_del_punto_venta_mob_validate_fac_ambiente()
  {
    var nomeCampo_fac_ambiente = "fac_ambiente";
    var var_fac_ambiente = scAjaxGetFieldHidden(nomeCampo_fac_ambiente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_ambiente(var_fac_ambiente, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_ambiente_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_ambiente

  function do_ajax_form_del_punto_venta_mob_validate_fac_ambiente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_ambiente_cb

  // ---------- Validate fac_tipo_libretin
  function do_ajax_form_del_punto_venta_mob_validate_fac_tipo_libretin()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_tipo_libretin(var_fac_tipo_libretin, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_tipo_libretin_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_tipo_libretin

  function do_ajax_form_del_punto_venta_mob_validate_fac_tipo_libretin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_tipo_libretin_cb

  // ---------- Validate fac_subtotal_iva
  function do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_iva()
  {
    var nomeCampo_fac_subtotal_iva = "fac_subtotal_iva";
    var var_fac_subtotal_iva = scAjaxGetFieldText(nomeCampo_fac_subtotal_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_subtotal_iva(var_fac_subtotal_iva, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_iva_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_iva

  function do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_iva_cb

  // ---------- Validate fac_subtotal_cero
  function do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_cero()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_subtotal_cero(var_fac_subtotal_cero, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_cero_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_cero

  function do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_cero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_cero_cb

  // ---------- Validate fac_subtotal_no_objeto
  function do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_no_objeto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_subtotal_no_objeto(var_fac_subtotal_no_objeto, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_no_objeto_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_no_objeto

  function do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_no_objeto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_no_objeto_cb

  // ---------- Validate fac_subtotal_excento
  function do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_excento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_subtotal_excento(var_fac_subtotal_excento, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_excento_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_excento

  function do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_excento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_excento_cb

  // ---------- Validate fac_subtotal
  function do_ajax_form_del_punto_venta_mob_validate_fac_subtotal()
  {
    var nomeCampo_fac_subtotal = "fac_subtotal";
    var var_fac_subtotal = scAjaxGetFieldText(nomeCampo_fac_subtotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_subtotal(var_fac_subtotal, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_subtotal

  function do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_subtotal_cb

  // ---------- Validate fac_total_descuento
  function do_ajax_form_del_punto_venta_mob_validate_fac_total_descuento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_total_descuento(var_fac_total_descuento, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_total_descuento_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_total_descuento

  function do_ajax_form_del_punto_venta_mob_validate_fac_total_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_total_descuento_cb

  // ---------- Validate fac_valor_ice
  function do_ajax_form_del_punto_venta_mob_validate_fac_valor_ice()
  {
    var nomeCampo_fac_valor_ice = "fac_valor_ice";
    var var_fac_valor_ice = scAjaxGetFieldText(nomeCampo_fac_valor_ice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_valor_ice(var_fac_valor_ice, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_valor_ice_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_valor_ice

  function do_ajax_form_del_punto_venta_mob_validate_fac_valor_ice_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_valor_ice_cb

  // ---------- Validate fac_valor_iva
  function do_ajax_form_del_punto_venta_mob_validate_fac_valor_iva()
  {
    var nomeCampo_fac_valor_iva = "fac_valor_iva";
    var var_fac_valor_iva = scAjaxGetFieldText(nomeCampo_fac_valor_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_valor_iva(var_fac_valor_iva, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_valor_iva_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_valor_iva

  function do_ajax_form_del_punto_venta_mob_validate_fac_valor_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_valor_iva_cb

  // ---------- Validate fac_valor_irbpnr
  function do_ajax_form_del_punto_venta_mob_validate_fac_valor_irbpnr()
  {
    var nomeCampo_fac_valor_irbpnr = "fac_valor_irbpnr";
    var var_fac_valor_irbpnr = scAjaxGetFieldText(nomeCampo_fac_valor_irbpnr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_valor_irbpnr(var_fac_valor_irbpnr, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_valor_irbpnr_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_valor_irbpnr

  function do_ajax_form_del_punto_venta_mob_validate_fac_valor_irbpnr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_valor_irbpnr_cb

  // ---------- Validate fac_propina
  function do_ajax_form_del_punto_venta_mob_validate_fac_propina()
  {
    var nomeCampo_fac_propina = "fac_propina";
    var var_fac_propina = scAjaxGetFieldText(nomeCampo_fac_propina);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_propina(var_fac_propina, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_propina_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_propina

  function do_ajax_form_del_punto_venta_mob_validate_fac_propina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_propina_cb

  // ---------- Validate fac_total
  function do_ajax_form_del_punto_venta_mob_validate_fac_total()
  {
    var nomeCampo_fac_total = "fac_total";
    var var_fac_total = scAjaxGetFieldText(nomeCampo_fac_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_total(var_fac_total, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_total_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_total

  function do_ajax_form_del_punto_venta_mob_validate_fac_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_total_cb

  // ---------- Validate fac_estado
  function do_ajax_form_del_punto_venta_mob_validate_fac_estado()
  {
    var nomeCampo_fac_estado = "fac_estado";
    var var_fac_estado = scAjaxGetFieldText(nomeCampo_fac_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_estado(var_fac_estado, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_estado_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_estado

  function do_ajax_form_del_punto_venta_mob_validate_fac_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_estado_cb

  // ---------- Validate fac_fecha_autorizacion
  function do_ajax_form_del_punto_venta_mob_validate_fac_fecha_autorizacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_fecha_autorizacion(var_fac_fecha_autorizacion, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_fecha_autorizacion_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_fecha_autorizacion

  function do_ajax_form_del_punto_venta_mob_validate_fac_fecha_autorizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_fecha_autorizacion_cb

  // ---------- Validate fac_autorizacion
  function do_ajax_form_del_punto_venta_mob_validate_fac_autorizacion()
  {
    var nomeCampo_fac_autorizacion = "fac_autorizacion";
    var var_fac_autorizacion = scAjaxGetFieldText(nomeCampo_fac_autorizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_autorizacion(var_fac_autorizacion, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_autorizacion_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_autorizacion

  function do_ajax_form_del_punto_venta_mob_validate_fac_autorizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_autorizacion_cb

  // ---------- Validate fac_usuario
  function do_ajax_form_del_punto_venta_mob_validate_fac_usuario()
  {
    var nomeCampo_fac_usuario = "fac_usuario";
    var var_fac_usuario = scAjaxGetFieldText(nomeCampo_fac_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_usuario(var_fac_usuario, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_usuario_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_usuario

  function do_ajax_form_del_punto_venta_mob_validate_fac_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_usuario_cb

  // ---------- Validate fac_clave
  function do_ajax_form_del_punto_venta_mob_validate_fac_clave()
  {
    var nomeCampo_fac_clave = "fac_clave";
    var var_fac_clave = scAjaxGetFieldText(nomeCampo_fac_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_clave(var_fac_clave, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_clave_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_clave

  function do_ajax_form_del_punto_venta_mob_validate_fac_clave_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_clave_cb

  // ---------- Validate fac_retencion
  function do_ajax_form_del_punto_venta_mob_validate_fac_retencion()
  {
    var nomeCampo_fac_retencion = "fac_retencion";
    var var_fac_retencion = scAjaxGetFieldText(nomeCampo_fac_retencion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_retencion(var_fac_retencion, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_retencion_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_retencion

  function do_ajax_form_del_punto_venta_mob_validate_fac_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_retencion_cb

  // ---------- Validate fac_fecha
  function do_ajax_form_del_punto_venta_mob_validate_fac_fecha()
  {
    var nomeCampo_fac_fecha = "fac_fecha";
    var var_fac_fecha = scAjaxGetFieldText(nomeCampo_fac_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_fecha(var_fac_fecha, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_fecha_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_fecha

  function do_ajax_form_del_punto_venta_mob_validate_fac_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_fecha_cb

  // ---------- Validate fac_libretin
  function do_ajax_form_del_punto_venta_mob_validate_fac_libretin()
  {
    var nomeCampo_fac_libretin = "fac_libretin";
    var var_fac_libretin = scAjaxGetFieldSelect(nomeCampo_fac_libretin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_libretin(var_fac_libretin, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_libretin_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_libretin

  function do_ajax_form_del_punto_venta_mob_validate_fac_libretin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_libretin_cb

  // ---------- Validate secuencial
  function do_ajax_form_del_punto_venta_mob_validate_secuencial()
  {
    var nomeCampo_secuencial = "secuencial";
    var var_secuencial = scAjaxGetFieldText(nomeCampo_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_secuencial(var_secuencial, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_secuencial_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_secuencial

  function do_ajax_form_del_punto_venta_mob_validate_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_secuencial_cb

  // ---------- Validate fac_moneda
  function do_ajax_form_del_punto_venta_mob_validate_fac_moneda()
  {
    var nomeCampo_fac_moneda = "fac_moneda";
    var var_fac_moneda = scAjaxGetFieldSelect(nomeCampo_fac_moneda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_moneda(var_fac_moneda, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_moneda_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_moneda

  function do_ajax_form_del_punto_venta_mob_validate_fac_moneda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_moneda_cb

  // ---------- Validate fac_serie_guia
  function do_ajax_form_del_punto_venta_mob_validate_fac_serie_guia()
  {
    var nomeCampo_fac_serie_guia = "fac_serie_guia";
    var var_fac_serie_guia = scAjaxGetFieldText(nomeCampo_fac_serie_guia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_serie_guia(var_fac_serie_guia, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_serie_guia_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_serie_guia

  function do_ajax_form_del_punto_venta_mob_validate_fac_serie_guia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_serie_guia_cb

  // ---------- Validate fac_secuencial
  function do_ajax_form_del_punto_venta_mob_validate_fac_secuencial()
  {
    var nomeCampo_fac_secuencial = "fac_secuencial";
    var var_fac_secuencial = scAjaxGetFieldHidden(nomeCampo_fac_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_secuencial(var_fac_secuencial, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_secuencial_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_secuencial

  function do_ajax_form_del_punto_venta_mob_validate_fac_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_secuencial_cb

  // ---------- Validate productos
  function do_ajax_form_del_punto_venta_mob_validate_productos()
  {
    var nomeCampo_productos = "productos";
    var var_productos = scAjaxGetFieldText(nomeCampo_productos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_productos(var_productos, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_productos_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_productos

  function do_ajax_form_del_punto_venta_mob_validate_productos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_productos_cb

  // ---------- Validate detalle
  function do_ajax_form_del_punto_venta_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_detalle_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_detalle

  function do_ajax_form_del_punto_venta_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_detalle_cb

  // ---------- Validate fac_cliente
  function do_ajax_form_del_punto_venta_mob_validate_fac_cliente()
  {
    var nomeCampo_fac_cliente = "fac_cliente";
    var var_fac_cliente = scAjaxGetFieldHidden(nomeCampo_fac_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_cliente(var_fac_cliente, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_cliente_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_cliente

  function do_ajax_form_del_punto_venta_mob_validate_fac_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_cliente_cb

  // ---------- Validate ruc
  function do_ajax_form_del_punto_venta_mob_validate_ruc()
  {
    var nomeCampo_ruc = "ruc";
    var var_ruc = scAjaxGetFieldText(nomeCampo_ruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_ruc(var_ruc, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_ruc_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_ruc

  function do_ajax_form_del_punto_venta_mob_validate_ruc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ruc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_ruc_cb

  // ---------- Validate fac_tipo_identificacion
  function do_ajax_form_del_punto_venta_mob_validate_fac_tipo_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_tipo_identificacion(var_fac_tipo_identificacion, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_tipo_identificacion_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_tipo_identificacion

  function do_ajax_form_del_punto_venta_mob_validate_fac_tipo_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_tipo_identificacion_cb

  // ---------- Validate fac_nombre_cliente
  function do_ajax_form_del_punto_venta_mob_validate_fac_nombre_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_nombre_cliente(var_fac_nombre_cliente, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_nombre_cliente_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_nombre_cliente

  function do_ajax_form_del_punto_venta_mob_validate_fac_nombre_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_nombre_cliente_cb

  // ---------- Validate fac_provincia_cliente
  function do_ajax_form_del_punto_venta_mob_validate_fac_provincia_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_provincia_cliente(var_fac_provincia_cliente, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_provincia_cliente_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_provincia_cliente

  function do_ajax_form_del_punto_venta_mob_validate_fac_provincia_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_provincia_cliente_cb

  // ---------- Validate fac_canton_cliente
  function do_ajax_form_del_punto_venta_mob_validate_fac_canton_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_canton_cliente(var_fac_canton_cliente, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_canton_cliente_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_canton_cliente

  function do_ajax_form_del_punto_venta_mob_validate_fac_canton_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_canton_cliente_cb

  // ---------- Validate fac_direccion_cliente
  function do_ajax_form_del_punto_venta_mob_validate_fac_direccion_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_direccion_cliente(var_fac_direccion_cliente, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_direccion_cliente_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_direccion_cliente

  function do_ajax_form_del_punto_venta_mob_validate_fac_direccion_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_direccion_cliente_cb

  // ---------- Validate fac_email_cliente
  function do_ajax_form_del_punto_venta_mob_validate_fac_email_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_email_cliente(var_fac_email_cliente, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_email_cliente_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_email_cliente

  function do_ajax_form_del_punto_venta_mob_validate_fac_email_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_email_cliente_cb

  // ---------- Validate fac_telefono_cliente
  function do_ajax_form_del_punto_venta_mob_validate_fac_telefono_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_telefono_cliente(var_fac_telefono_cliente, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_telefono_cliente_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_telefono_cliente

  function do_ajax_form_del_punto_venta_mob_validate_fac_telefono_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_telefono_cliente_cb

  // ---------- Validate fac_aplica_propina
  function do_ajax_form_del_punto_venta_mob_validate_fac_aplica_propina()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_aplica_propina(var_fac_aplica_propina, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_aplica_propina_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_aplica_propina

  function do_ajax_form_del_punto_venta_mob_validate_fac_aplica_propina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_aplica_propina_cb

  // ---------- Validate fac_diagnostico
  function do_ajax_form_del_punto_venta_mob_validate_fac_diagnostico()
  {
    var nomeCampo_fac_diagnostico = "fac_diagnostico";
    var var_fac_diagnostico = scAjaxGetFieldSelect(nomeCampo_fac_diagnostico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_diagnostico(var_fac_diagnostico, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_diagnostico_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_diagnostico

  function do_ajax_form_del_punto_venta_mob_validate_fac_diagnostico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_diagnostico_cb

  // ---------- Validate fac_comentario
  function do_ajax_form_del_punto_venta_mob_validate_fac_comentario()
  {
    var nomeCampo_fac_comentario = "fac_comentario";
    var var_fac_comentario = scAjaxGetFieldText(nomeCampo_fac_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_fac_comentario(var_fac_comentario, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_fac_comentario_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_fac_comentario

  function do_ajax_form_del_punto_venta_mob_validate_fac_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_fac_comentario_cb

  // ---------- Validate forma_pago
  function do_ajax_form_del_punto_venta_mob_validate_forma_pago()
  {
    var nomeCampo_forma_pago = "forma_pago";
    var var_forma_pago = scAjaxGetFieldText(nomeCampo_forma_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_venta_mob_validate_forma_pago(var_forma_pago, var_script_case_init, do_ajax_form_del_punto_venta_mob_validate_forma_pago_cb);
  } // do_ajax_form_del_punto_venta_mob_validate_forma_pago

  function do_ajax_form_del_punto_venta_mob_validate_forma_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_validate_forma_pago_cb

  // ---------- Refresh fac_provincia_cliente
  function do_ajax_form_del_punto_venta_mob_refresh_fac_provincia_cliente()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_del_punto_venta_mob_refresh_fac_provincia_cliente(var_fac_provincia_cliente, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_punto_venta_mob_refresh_fac_provincia_cliente_cb);
  } // do_ajax_form_del_punto_venta_mob_refresh_fac_provincia_cliente

  function do_ajax_form_del_punto_venta_mob_refresh_fac_provincia_cliente_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_venta_mob_refresh_fac_provincia_cliente_cb

  // ---------- Event onchange fac_aplica_propina
  function do_ajax_form_del_punto_venta_mob_event_fac_aplica_propina_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_punto_venta_mob_event_fac_aplica_propina_onchange(var_fac_numero, var_fac_aplica_propina, var_fac_subtotal, var_fac_subtotal_iva, var_fac_subtotal_cero, var_fac_subtotal_no_objeto, var_fac_subtotal_excento, var_fac_total_descuento, var_fac_valor_ice, var_fac_valor_iva, var_fac_valor_irbpnr, var_fac_propina, var_fac_total, var_script_case_init, do_ajax_form_del_punto_venta_mob_event_fac_aplica_propina_onchange_cb);
  } // do_ajax_form_del_punto_venta_mob_event_fac_aplica_propina_onchange

  function do_ajax_form_del_punto_venta_mob_event_fac_aplica_propina_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_aplica_propina";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_punto_venta_mob_event_fac_aplica_propina_onchange_cb_after_alert);
  } // do_ajax_form_del_punto_venta_mob_event_fac_aplica_propina_onchange_cb
  function do_ajax_form_del_punto_venta_mob_event_fac_aplica_propina_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_punto_venta_mob_event_fac_aplica_propina_onchange_cb_after_alert

  // ---------- Event onblur fac_fecha
  function do_ajax_form_del_punto_venta_mob_event_fac_fecha_onblur()
  {
  ...
  function do_ajax_form_del_punto_venta_mob_event_fac_fecha_onblur_cb(sResp)
  {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_punto_venta_mob_event_fac_fecha_onblur_cb_after_alert);
  } // do_ajax_form_del_punto_venta_mob_event_fac_fecha_onblur_cb
  function do_ajax_form_del_punto_venta_mob_event_fac_fecha_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_punto_venta_mob_event_fac_fecha_onblur_cb_after_alert

  // ---------- Event onchange fac_fecha
  function do_ajax_form_del_punto_venta_mob_event_fac_fecha_onchange()
  {
    var var_fac_fecha = scAjaxGetFieldText("fac_fecha");
    var var_fac_numero = scAjaxGetFieldHidden("fac_numero");
    var var_fac_subtotal = scAjaxGetFieldText("fac_subtotal");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_punto_venta_mob_event_fac_fecha_onchange(var_fac_fecha, var_fac_numero, var_fac_subtotal, var_fac_subtotal_iva, var_fac_subtotal_cero, var_fac_subtotal_no_objeto, var_fac_subtotal_excento, var_fac_total_descuento, var_fac_valor_ice, var_fac_valor_iva, var_fac_valor_irbpnr, var_fac_propina, var_fac_total, var_script_case_init, do_ajax_form_del_punto_venta_mob_event_fac_fecha_onchange_cb);
  } // do_ajax_form_del_punto_venta_mob_event_fac_fecha_onchange

  function do_ajax_form_del_punto_venta_mob_event_fac_fecha_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_fecha";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_punto_venta_mob_event_fac_fecha_onchange_cb_after_alert);
  } // do_ajax_form_del_punto_venta_mob_event_fac_fecha_onchange_cb
  function do_ajax_form_del_punto_venta_mob_event_fac_fecha_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_punto_venta_mob_event_fac_fecha_onchange_cb_after_alert

  // ---------- Event onchange fac_libretin
  function do_ajax_form_del_punto_venta_mob_event_fac_libretin_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_punto_venta_mob_event_fac_libretin_onchange(var_fac_libretin, var_fac_establecimiento, var_fac_punto_emision, var_fac_secuencial, var_fac_ambiente, var_fac_tipo_libretin, var_secuencial, var_fac_autorizacion, var_fac_estado_sri, var_fac_numero, var_script_case_init, do_ajax_form_del_punto_venta_mob_event_fac_libretin_onchange_cb);
  } // do_ajax_form_del_punto_venta_mob_event_fac_libretin_onchange

  function do_ajax_form_del_punto_venta_mob_event_fac_libretin_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_libretin";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_punto_venta_mob_event_fac_libretin_onchange_cb_after_alert);
  } // do_ajax_form_del_punto_venta_mob_event_fac_libretin_onchange_cb
  function do_ajax_form_del_punto_venta_mob_event_fac_libretin_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_punto_venta_mob_event_fac_libretin_onchange_cb_after_alert

  // ---------- Event onblur fac_valor_entrega
  function do_ajax_form_del_punto_venta_mob_event_fac_valor_entrega_onblur()
  {
    var var_fac_total = scAjaxGetFieldText("fac_total");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_punto_venta_mob_event_fac_valor_entrega_onblur(var_fac_total, var_script_case_init, do_ajax_form_del_punto_venta_mob_event_fac_valor_entrega_onblur_cb);
  } // do_ajax_form_del_punto_venta_mob_event_fac_valor_entrega_onblur

  function do_ajax_form_del_punto_venta_mob_event_fac_valor_entrega_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_punto_venta_mob_event_fac_valor_entrega_onblur_cb_after_alert);
  } // do_ajax_form_del_punto_venta_mob_event_fac_valor_entrega_onblur_cb
  function do_ajax_form_del_punto_venta_mob_event_fac_valor_entrega_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_punto_venta_mob_event_fac_valor_entrega_onblur_cb_after_alert

  // ---------- Event onchange ruc
  function do_ajax_form_del_punto_venta_mob_event_ruc_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_punto_venta_mob_event_ruc_onchange(var_ruc, var_fac_tipo_identificacion, var_fac_nombre_cliente, var_fac_provincia_cliente, var_fac_canton_cliente, var_fac_direccion_cliente, var_fac_email_cliente, var_fac_telefono_cliente, var_script_case_init, do_ajax_form_del_punto_venta_mob_event_ruc_onchange_cb);
  } // do_ajax_form_del_punto_venta_mob_event_ruc_onchange

  function do_ajax_form_del_punto_venta_mob_event_ruc_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "ruc";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_punto_venta_mob_event_ruc_onchange_cb_after_alert);
  } // do_ajax_form_del_punto_venta_mob_event_ruc_onchange_cb
  function do_ajax_form_del_punto_venta_mob_event_ruc_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_punto_venta_mob_event_ruc_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_enviar
  function do_ajax_form_del_punto_venta_mob_event_scajaxbutton_enviar_onclick()
  {
    var var_fac_numero = scAjaxGetFieldHidden("fac_numero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_punto_venta_mob_event_scajaxbutton_enviar_onclick(var_fac_numero, var_script_case_init, do_ajax_form_del_punto_venta_mob_event_scajaxbutton_enviar_onclick_cb);
  } // do_ajax_form_del_punto_venta_mob_event_scajaxbutton_enviar_onclick

  function do_ajax_form_del_punto_venta_mob_event_scajaxbutton_enviar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_punto_venta_mob_event_scajaxbutton_enviar_onclick_cb_after_alert);
  } // do_ajax_form_del_punto_venta_mob_event_scajaxbutton_enviar_onclick_cb
  function do_ajax_form_del_punto_venta_mob_event_scajaxbutton_enviar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_punto_venta_mob_event_scajaxbutton_enviar_onclick_cb_after_alert

  // ---------- Event onclick scajaxbutton_anular
  function do_ajax_form_del_punto_venta_mob_event_scajaxbutton_anular_onclick()
  {
    var var_fac_numero = scAjaxGetFieldHidden("fac_numero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_punto_venta_mob_event_scajaxbutton_anular_onclick(var_fac_numero, var_script_case_init, do_ajax_form_del_punto_venta_mob_event_scajaxbutton_anular_onclick_cb);
  } // do_ajax_form_del_punto_venta_mob_event_scajaxbutton_anular_onclick

  function do_ajax_form_del_punto_venta_mob_event_scajaxbutton_anular_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_punto_venta_mob_event_scajaxbutton_anular_onclick_cb_after_alert);
  } // do_ajax_form_del_punto_venta_mob_event_scajaxbutton_anular_onclick_cb
  function do_ajax_form_del_punto_venta_mob_event_scajaxbutton_anular_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_punto_venta_mob_event_scajaxbutton_anular_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_punto_venta_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_punto_venta_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_punto_venta_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_punto_venta_mob_submit_form_cb
  function do_ajax_form_del_punto_venta_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_punto_venta_mob_submit_form_cb_after_alert
  ...
  function do_ajax_form_del_punto_venta_mob_navigate_form()
  {
    perform_ajax_form_del_punto_venta_mob_navigate_form();
  }

  function perform_ajax_form_del_punto_venta_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_del_punto_venta_mob_navigate_form(var_fac_numero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_punto_venta_mob_navigate_form_cb);
  } // do_ajax_form_del_punto_venta_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_punto_venta_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_punto_venta_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_punto_venta_mob_navigate_form_cb
  function do_ajax_form_del_punto_venta_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_punto_venta_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
    scAjaxProcOff();
  } // do_ajax_form_del_punto_venta_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_punto_venta_mob_form()
  {
  ...
  function do_ajax_form_del_punto_venta_mob_lkpedt_refresh_fac_cliente()
  {
    var var_fac_cliente = scAjaxGetFieldHidden("fac_cliente");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "fac_cliente";
    x_ajax_form_del_punto_venta_mob_lkpedt_refresh_fac_cliente(var_fac_cliente, nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_punto_venta_mob_lkpedt_refresh_fac_cliente_cb);
  } // do_ajax_form_del_punto_venta_mob_lkpedt_refresh_fac_cliente

  function do_ajax_form_del_punto_venta_mob_lkpedt_refresh_fac_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_del_punto_venta_mob_lkpedt_refresh_fac_cliente_cb

  function do_ajax_form_del_punto_venta_mob_lkpedt_refresh_fac_diagnostico()
  {
    var var_fac_diagnostico = scAjaxGetFieldSelect("fac_diagnostico");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "fac_diagnostico";
    x_ajax_form_del_punto_venta_mob_lkpedt_refresh_fac_diagnostico(var_fac_diagnostico, nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_punto_venta_mob_lkpedt_refresh_fac_diagnostico_cb);
  } // do_ajax_form_del_punto_venta_mob_lkpedt_refresh_fac_diagnostico

  function do_ajax_form_del_punto_venta_mob_lkpedt_refresh_fac_diagnostico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_del_punto_venta_mob_lkpedt_refresh_fac_diagnostico_cb
  ...
  {
    if ("off" == scStatusDetail["productos_venta_empresas"] && "off" == scStatusDetail["grid_detalle_factura"] && "off" == scStatusDetail["form_del_forma_pago_factura_mob"])
    {
      return true;
    }
    return false;
