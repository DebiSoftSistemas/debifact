<?php
//
class form_del_punto_venta_apl
{
   ...
   var $fac_empresa;
   var $fac_establecimiento;
   var $fac_punto_emision;
   var $fac_secuencial;
   var $fac_cliente;
   var $fac_fecha;
   var $fac_ambiente;
   ...
   var $fac_estado_sri;
   var $fac_error_sri;
   var $fac_fecha_autorizacion;
   var $fac_autorizacion;
   var $fac_usuario;
   var $fac_serie_guia;
   var $fac_comentario;
   var $fac_aplica_propina;
   var $fac_aplica_propina_1;
   var $fac_libretin;
   var $fac_libretin_1;
   var $fac_clave;
   var $fac_retencion;
   var $fac_diagnostico;
   var $fac_diagnostico_1;
   var $fac_moneda;
   var $fac_moneda_1;
   var $fac_tomado;
   var $fac_total_subsidio;
   var $titulo;
   ...
   var $ruc;
   var $detalle;
   var $fac_tipo_identificacion;
   var $secuencial;
   var $productos;
   var $fac_telefono_cliente;
   var $fac_provincia_cliente;
   var $fac_provincia_cliente_1;
   var $fac_canton_cliente;
   var $fac_canton_cliente_1;
   var $nm_data;
   var $nmgp_opcao;
   var $nmgp_opc_ant;
   var $sc_evento;
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['fac_ambiente']))
          {
              $this->fac_ambiente = $this->NM_ajax_info['param']['fac_ambiente'];
          }
          if (isset($this->NM_ajax_info['param']['fac_aplica_propina']))
          {
              $this->fac_aplica_propina = $this->NM_ajax_info['param']['fac_aplica_propina'];
          }
          if (isset($this->NM_ajax_info['param']['fac_autorizacion']))
          {
              $this->fac_autorizacion = $this->NM_ajax_info['param']['fac_autorizacion'];
          }
          if (isset($this->NM_ajax_info['param']['fac_canton_cliente']))
          {
              $this->fac_canton_cliente = $this->NM_ajax_info['param']['fac_canton_cliente'];
          }
          if (isset($this->NM_ajax_info['param']['fac_clave']))
          {
              $this->fac_clave = $this->NM_ajax_info['param']['fac_clave'];
          }
          if (isset($this->NM_ajax_info['param']['fac_cliente']))
          {
              $this->fac_cliente = $this->NM_ajax_info['param']['fac_cliente'];
          }
          if (isset($this->NM_ajax_info['param']['fac_comentario']))
          {
              $this->fac_comentario = $this->NM_ajax_info['param']['fac_comentario'];
          }
          if (isset($this->NM_ajax_info['param']['fac_diagnostico']))
          {
              $this->fac_diagnostico = $this->NM_ajax_info['param']['fac_diagnostico'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['fac_empresa']))
          {
              $this->fac_empresa = $this->NM_ajax_info['param']['fac_empresa'];
          }
          if (isset($this->NM_ajax_info['param']['fac_error_sri']))
          {
              $this->fac_error_sri = $this->NM_ajax_info['param']['fac_error_sri'];
          }
          if (isset($this->NM_ajax_info['param']['fac_establecimiento']))
          {
              $this->fac_establecimiento = $this->NM_ajax_info['param']['fac_establecimiento'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['fac_fecha_autorizacion']))
          {
              $this->fac_fecha_autorizacion = $this->NM_ajax_info['param']['fac_fecha_autorizacion'];
          }
          if (isset($this->NM_ajax_info['param']['fac_libretin']))
          {
              $this->fac_libretin = $this->NM_ajax_info['param']['fac_libretin'];
          }
          if (isset($this->NM_ajax_info['param']['fac_moneda']))
          {
              $this->fac_moneda = $this->NM_ajax_info['param']['fac_moneda'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['fac_propina']))
          {
              $this->fac_propina = $this->NM_ajax_info['param']['fac_propina'];
          }
          if (isset($this->NM_ajax_info['param']['fac_provincia_cliente']))
          {
              $this->fac_provincia_cliente = $this->NM_ajax_info['param']['fac_provincia_cliente'];
          }
          if (isset($this->NM_ajax_info['param']['fac_punto_emision']))
          {
              $this->fac_punto_emision = $this->NM_ajax_info['param']['fac_punto_emision'];
          }
          if (isset($this->NM_ajax_info['param']['fac_retencion']))
          {
              $this->fac_retencion = $this->NM_ajax_info['param']['fac_retencion'];
          }
          if (isset($this->NM_ajax_info['param']['fac_secuencial']))
          {
              $this->fac_secuencial = $this->NM_ajax_info['param']['fac_secuencial'];
          }
          if (isset($this->NM_ajax_info['param']['fac_serie_guia']))
          {
              $this->fac_serie_guia = $this->NM_ajax_info['param']['fac_serie_guia'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['fac_telefono_cliente']))
          {
              $this->fac_telefono_cliente = $this->NM_ajax_info['param']['fac_telefono_cliente'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['fac_tipo_identificacion']))
          {
              $this->fac_tipo_identificacion = $this->NM_ajax_info['param']['fac_tipo_identificacion'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['fac_usuario']))
          {
              $this->fac_usuario = $this->NM_ajax_info['param']['fac_usuario'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_del_punto_venta($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['form_del_forma_pago_factura_script_case_init'] ]['form_del_forma_pago_factura']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['form_del_forma_pago_factura_script_case_init'] ]['form_del_forma_pago_factura']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->var_id_factura)) 
          {
              $_SESSION['var_id_factura'] = $this->var_id_factura;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_del_punto_venta_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_punto_venta']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_punto_venta'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_punto_venta']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_punto_venta']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_del_punto_venta') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_punto_venta']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " del_factura";
      ...
      $this->arr_buttons['retencion']['value']            = "" . $this->Ini->Nm_lang['lang_retencion_ventas'] . "";
      ...
      $this->arr_buttons['bauchert']['hint']             = "";
      $this->arr_buttons['bauchert']['type']             = "button";
      $this->arr_buttons['bauchert']['value']            = "" . $this->Ini->Nm_lang['lang_baucher'] . "";
      $this->arr_buttons['bauchert']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['bauchert']['display_position'] = "text_right";
      $this->arr_buttons['bauchert']['style']            = "default";
      $this->arr_buttons['bauchert']['image']            = "";
      $this->arr_buttons['bauchert']['has_fa']            = "true";
      $this->arr_buttons['bauchert']['fontawesomeicon']            = "fas fa-print";
      ...
      $_SESSION['scriptcase']['error_icon']['form_del_punto_venta']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_del_punto_venta'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['goto']      = 'on';
          }
      }
      ...
      $this->nmgp_botoes['bauchert'] = "on";
      if (isset($this->NM_btn_cancel) && 'N' == $this->NM_btn_cancel)
      {
          $this->nmgp_botoes['cancel'] = "off";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_orig'] = " where (fac_numero=" . $_SESSION['var_id_factura'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_pesq'] = " where (fac_numero=" . $_SESSION['var_id_factura'] . ")";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_punto_venta']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_punto_venta'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_punto_venta'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_form'];
          ...
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['fac_propina'] != "null"){$this->fac_propina = $this->nmgp_dados_form['fac_propina'];} 
          ...
          if (!isset($this->fac_tomado)){$this->fac_tomado = $this->nmgp_dados_form['fac_tomado'];} 
          if (!isset($this->fac_total_subsidio)){$this->fac_total_subsidio = $this->nmgp_dados_form['fac_total_subsidio'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_del_punto_venta", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      { 
          include_once($this->Ini->path_embutida . 'form_del_punto_venta/Igtech.ApiCiudadanos.php');
      }
      else
      { 
      ...
      if ($this->Embutida_proc)
      { 
          include_once($this->Ini->path_embutida . 'form_del_punto_venta/igtech.PocesarDocumentosElectronicos.php');
      }
      else
      { 
      ...
      if (isset($_GET['nm_cal_display']))
      {
          if ($this->Embutida_proc)
          { 
              include_once($this->Ini->path_embutida . 'form_del_punto_venta/form_del_punto_venta_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_del_punto_venta_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_del_punto_venta_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_del_punto_venta_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_del_punto_venta/form_del_punto_venta_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_del_punto_venta_erro.class.php"); 
      }
      $this->Erro      = new form_del_punto_venta_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opcao']))
         { 
             if ($this->fac_numero != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_del_punto_venta']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "novo")  
      {
          ...
          $this->nmgp_botoes['bauchert'] = "off";
      }
      elseif ($this->nmgp_opcao == "incluir")  
      {
          $this->nmgp_botoes['enviar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['botoes']['enviar'];
          $this->nmgp_botoes['Nuevo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['botoes']['Nuevo'];
          $this->nmgp_botoes['ride'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['botoes']['ride'];
          $this->nmgp_botoes['Anular'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['botoes']['Anular'];
          $this->nmgp_botoes['retencion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['botoes']['retencion'];
          $this->nmgp_botoes['bauchert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['botoes']['bauchert'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['form_del_forma_pago_factura_script_case_init'] ]['form_del_forma_pago_factura']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['form_del_forma_pago_factura_script_case_init'] ]['form_del_forma_pago_factura']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['form_del_forma_pago_factura_script_case_init'] ]['form_del_forma_pago_factura']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['form_del_forma_pago_factura_script_case_init'] ]['form_del_forma_pago_factura']['total']);
          $detailAppObject = "form_del_forma_pago_factura_apl";
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_del_forma_pago_factura') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_del_forma_pago_factura') . "/form_del_forma_pago_factura_apl.php");
          $this->form_del_forma_pago_factura = new $detailAppObject;
      }
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_del_punto_venta']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_del_punto_venta']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      if (isset($this->fac_empresa)) { $this->nm_limpa_alfa($this->fac_empresa); }
      if (isset($this->fac_establecimiento)) { $this->nm_limpa_alfa($this->fac_establecimiento); }
      if (isset($this->fac_punto_emision)) { $this->nm_limpa_alfa($this->fac_punto_emision); }
      if (isset($this->fac_secuencial)) { $this->nm_limpa_alfa($this->fac_secuencial); }
      if (isset($this->fac_cliente)) { $this->nm_limpa_alfa($this->fac_cliente); }
      if (isset($this->fac_ambiente)) { $this->nm_limpa_alfa($this->fac_ambiente); }
      if (isset($this->fac_tipo_libretin)) { $this->nm_limpa_alfa($this->fac_tipo_libretin); }
      ...
      if (isset($this->fac_propina)) { $this->nm_limpa_alfa($this->fac_propina); }
      if (isset($this->fac_total)) { $this->nm_limpa_alfa($this->fac_total); }
      if (isset($this->fac_estado)) { $this->nm_limpa_alfa($this->fac_estado); }
      if (isset($this->fac_estado_sri)) { $this->nm_limpa_alfa($this->fac_estado_sri); }
      if (isset($this->fac_error_sri)) { $this->nm_limpa_alfa($this->fac_error_sri); }
      if (isset($this->fac_fecha_autorizacion)) { $this->nm_limpa_alfa($this->fac_fecha_autorizacion); }
      if (isset($this->fac_autorizacion)) { $this->nm_limpa_alfa($this->fac_autorizacion); }
      if (isset($this->fac_usuario)) { $this->nm_limpa_alfa($this->fac_usuario); }
      if (isset($this->fac_serie_guia)) { $this->nm_limpa_alfa($this->fac_serie_guia); }
      if (isset($this->fac_comentario)) { $this->nm_limpa_alfa($this->fac_comentario); }
      if (isset($this->fac_aplica_propina)) { $this->nm_limpa_alfa($this->fac_aplica_propina); }
      if (isset($this->fac_libretin)) { $this->nm_limpa_alfa($this->fac_libretin); }
      if (isset($this->fac_clave)) { $this->nm_limpa_alfa($this->fac_clave); }
      if (isset($this->fac_retencion)) { $this->nm_limpa_alfa($this->fac_retencion); }
      if (isset($this->fac_diagnostico)) { $this->nm_limpa_alfa($this->fac_diagnostico); }
      if (isset($this->fac_moneda)) { $this->nm_limpa_alfa($this->fac_moneda); }
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- fac_establecimiento
      $this->field_config['fac_establecimiento']               = array();
      $this->field_config['fac_establecimiento']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['fac_establecimiento']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['fac_establecimiento']['symbol_dec'] = '';
      $this->field_config['fac_establecimiento']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['fac_establecimiento']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- fac_punto_emision
      $this->field_config['fac_punto_emision']               = array();
      $this->field_config['fac_punto_emision']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['fac_punto_emision']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['fac_punto_emision']['symbol_dec'] = '';
      $this->field_config['fac_punto_emision']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['fac_punto_emision']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- fac_ambiente
      $this->field_config['fac_ambiente']               = array();
      $this->field_config['fac_ambiente']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['fac_ambiente']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['fac_ambiente']['symbol_dec'] = '';
      $this->field_config['fac_ambiente']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['fac_ambiente']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- fac_subtotal_iva
      ...
      //-- fac_propina
      $this->field_config['fac_propina']               = array();
      $this->field_config['fac_propina']['symbol_grp'] = '';
      $this->field_config['fac_propina']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['fac_propina']['symbol_dec'] = '.';
      $this->field_config['fac_propina']['symbol_neg'] = '-';
      $this->field_config['fac_propina']['format_neg'] = '2';
      //-- fac_total
      ...
      //-- fac_fecha_autorizacion
      $this->field_config['fac_fecha_autorizacion']                 = array();
      $this->field_config['fac_fecha_autorizacion']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'];
      $this->field_config['fac_fecha_autorizacion']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['fac_fecha_autorizacion']['date_display'] = "ddmmaaaa";
      $this->new_date_format('DT', 'fac_fecha_autorizacion');
      //-- fac_retencion
      $this->field_config['fac_retencion']               = array();
      $this->field_config['fac_retencion']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['fac_retencion']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['fac_retencion']['symbol_dec'] = '';
      $this->field_config['fac_retencion']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['fac_retencion']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- fac_fecha
      ...
      //-- fac_secuencial
      $this->field_config['fac_secuencial']               = array();
      $this->field_config['fac_secuencial']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['fac_secuencial']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['fac_secuencial']['symbol_dec'] = '';
      $this->field_config['fac_secuencial']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['fac_secuencial']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- fac_total_subsidio
      $this->field_config['fac_total_subsidio']               = array();
      $this->field_config['fac_total_subsidio']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['fac_total_subsidio']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['fac_total_subsidio']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['fac_total_subsidio']['symbol_mon'] = '';
      $this->field_config['fac_total_subsidio']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['fac_total_subsidio']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Gera_log_access'] = false;
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_fac_error_sri' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_error_sri');
          }
          ...
          if ('validate_fac_empresa' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_empresa');
          }
          if ('validate_fac_establecimiento' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_establecimiento');
          }
          if ('validate_fac_punto_emision' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_punto_emision');
          }
          if ('validate_fac_ambiente' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_ambiente');
          }
          ...
          if ('validate_fac_propina' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_propina');
          }
          ...
          if ('validate_fac_fecha_autorizacion' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_fecha_autorizacion');
          }
          if ('validate_fac_autorizacion' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_autorizacion');
          }
          if ('validate_fac_usuario' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_usuario');
          }
          if ('validate_fac_clave' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_clave');
          }
          if ('validate_fac_retencion' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_retencion');
          }
          ...
          if ('validate_fac_moneda' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_moneda');
          }
          if ('validate_fac_serie_guia' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_serie_guia');
          }
          ...
          if ('validate_fac_cliente' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_cliente');
          }
          if ('validate_ruc' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'ruc');
          }
          if ('validate_fac_tipo_identificacion' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_tipo_identificacion');
          }
          ...
          if ('validate_fac_provincia_cliente' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_provincia_cliente');
          }
          if ('validate_fac_canton_cliente' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_canton_cliente');
          }
          ...
          if ('validate_fac_telefono_cliente' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_telefono_cliente');
          }
          if ('validate_fac_aplica_propina' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_aplica_propina');
          }
          if ('validate_fac_diagnostico' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fac_diagnostico');
          }
          ...
          form_del_punto_venta_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_fac_fecha_onblur' == $this->NM_ajax_opcao)
          {
              $this->fac_fecha_onBlur();
          }
          if ('event_fac_fecha_onchange' == $this->NM_ajax_opcao)
          {
              $this->fac_fecha_onChange();
          }
          ...
          if ('event_ruc_onchange' == $this->NM_ajax_opcao)
          {
              $this->ruc_onChange();
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_subtotal_iva']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_subtotal_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_subtotal_iva'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_subtotal_cero']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_subtotal_cero = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_subtotal_cero'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_subtotal_no_objeto']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_subtotal_no_objeto = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_subtotal_no_objeto'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_subtotal_excento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_subtotal_excento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_subtotal_excento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_subtotal']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_subtotal'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_total_descuento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_total_descuento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_total_descuento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_valor_ice']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_valor_ice = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_valor_ice'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_valor_iva']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_valor_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_valor_iva'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_valor_irbpnr']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_valor_irbpnr = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_valor_irbpnr'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_propina']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_propina = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_propina'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_total']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_total = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_total'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_estado']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_estado = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['fac_estado'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['secuencial']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->secuencial = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']['secuencial'];
          } 
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_del_punto_venta']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_del_punto_venta.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_del_punto_venta_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_del_punto_venta"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_punto_venta', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_del_punto_venta', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_punto_venta', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'fac_estado':
               ...
               break;
           case 'fac_fecha_autorizacion':
               return "" . $this->Ini->Nm_lang['lang_fecha_autorizacion'] . "";
               break;
           case 'fac_autorizacion':
           ...
           case 'secuencial':
               ...
               break;
           case 'fac_moneda':
               return "" . $this->Ini->Nm_lang['lang_moneda'] . "";
               break;
           case 'fac_serie_guia':
           ...
           case 'ruc':
               ...
               break;
           case 'fac_tipo_identificacion':
               return "fac_tipo_identificacion";
               break;
           case 'fac_nombre_cliente':
               return "" . $this->Ini->Nm_lang['lang_nombre'] . "";
               break;
           case 'fac_provincia_cliente':
               return "" . $this->Ini->Nm_lang['lang_provincia'] . "";
               break;
           case 'fac_canton_cliente':
           ...
           case 'fac_email_cliente':
               ...
               break;
           case 'fac_telefono_cliente':
               return "" . $this->Ini->Nm_lang['lang_lot_telefono'] . "";
               break;
           case 'fac_aplica_propina':
               return "" . $this->Ini->Nm_lang['lang_dar_propina'] . "";
               break;
           case 'fac_diagnostico':
               return "" . $this->Ini->Nm_lang['lang_diagnostico'] . "";
               break;
           case 'fac_comentario':
           ...
           case 'fac_tomado':
               return "Fac Tomado";
               break;
           case 'fac_total_subsidio':
               return "Fac Total Subsidio";
               break;
       }
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_del_punto_venta']) || !is_array($this->NM_ajax_info['errList']['geral_form_del_punto_venta']))
              {
                  $this->NM_ajax_info['errList']['geral_form_del_punto_venta'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_del_punto_venta'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fac_error_sri' == $filtro)) || (is_array($filtro) && in_array('fac_error_sri', $filtro)))
        $this->ValidateField_fac_error_sri($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fac_empresa' == $filtro)) || (is_array($filtro) && in_array('fac_empresa', $filtro)))
        $this->ValidateField_fac_empresa($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fac_establecimiento' == $filtro)) || (is_array($filtro) && in_array('fac_establecimiento', $filtro)))
        $this->ValidateField_fac_establecimiento($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fac_punto_emision' == $filtro)) || (is_array($filtro) && in_array('fac_punto_emision', $filtro)))
        $this->ValidateField_fac_punto_emision($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fac_ambiente' == $filtro)) || (is_array($filtro) && in_array('fac_ambiente', $filtro)))
        $this->ValidateField_fac_ambiente($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fac_propina' == $filtro)) || (is_array($filtro) && in_array('fac_propina', $filtro)))
        $this->ValidateField_fac_propina($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fac_fecha_autorizacion' == $filtro)) || (is_array($filtro) && in_array('fac_fecha_autorizacion', $filtro)))
        $this->ValidateField_fac_fecha_autorizacion($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fac_autorizacion' == $filtro)) || (is_array($filtro) && in_array('fac_autorizacion', $filtro)))
        $this->ValidateField_fac_autorizacion($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fac_usuario' == $filtro)) || (is_array($filtro) && in_array('fac_usuario', $filtro)))
        $this->ValidateField_fac_usuario($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fac_clave' == $filtro)) || (is_array($filtro) && in_array('fac_clave', $filtro)))
        $this->ValidateField_fac_clave($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fac_retencion' == $filtro)) || (is_array($filtro) && in_array('fac_retencion', $filtro)))
        $this->ValidateField_fac_retencion($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fac_moneda' == $filtro)) || (is_array($filtro) && in_array('fac_moneda', $filtro)))
        $this->ValidateField_fac_moneda($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fac_serie_guia' == $filtro)) || (is_array($filtro) && in_array('fac_serie_guia', $filtro)))
        $this->ValidateField_fac_serie_guia($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fac_cliente' == $filtro)) || (is_array($filtro) && in_array('fac_cliente', $filtro)))
        $this->ValidateField_fac_cliente($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fac_tipo_identificacion' == $filtro)) || (is_array($filtro) && in_array('fac_tipo_identificacion', $filtro)))
        $this->ValidateField_fac_tipo_identificacion($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fac_provincia_cliente' == $filtro)) || (is_array($filtro) && in_array('fac_provincia_cliente', $filtro)))
        $this->ValidateField_fac_provincia_cliente($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fac_canton_cliente' == $filtro)) || (is_array($filtro) && in_array('fac_canton_cliente', $filtro)))
        $this->ValidateField_fac_canton_cliente($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fac_telefono_cliente' == $filtro)) || (is_array($filtro) && in_array('fac_telefono_cliente', $filtro)))
        $this->ValidateField_fac_telefono_cliente($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fac_aplica_propina' == $filtro)) || (is_array($filtro) && in_array('fac_aplica_propina', $filtro)))
        $this->ValidateField_fac_aplica_propina($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'fac_diagnostico' == $filtro)) || (is_array($filtro) && in_array('fac_diagnostico', $filtro)))
        $this->ValidateField_fac_diagnostico($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
//---
    ...
    function ValidateField_fac_estado_sri(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fac_estado_sri) > 25) 
          { 
              $hasError = true;
              ...
              $Campos_Erros['fac_estado_sri'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 25 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['fac_estado_sri'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 25 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_fac_error_sri(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_error_sri'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fac_error_sri) > 300) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_mensaje'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['fac_error_sri']))
              {
                  $Campos_Erros['fac_error_sri'] = array();
              }
              $Campos_Erros['fac_error_sri'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['fac_error_sri']) || !is_array($this->NM_ajax_info['errList']['fac_error_sri']))
              {
                  $this->NM_ajax_info['errList']['fac_error_sri'] = array();
              }
              $this->NM_ajax_info['errList']['fac_error_sri'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_error_sri';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_error_sri
    ...
    function ValidateField_fac_tipo_comprobante(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fac_tipo_comprobante) > 2) 
          { 
              $hasError = true;
              ...
              $Campos_Erros['fac_tipo_comprobante'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['fac_tipo_comprobante'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_fac_empresa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_empresa'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fac_empresa) > 13) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_empresa'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 13 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['fac_empresa']))
              {
                  $Campos_Erros['fac_empresa'] = array();
              }
              $Campos_Erros['fac_empresa'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 13 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['fac_empresa']) || !is_array($this->NM_ajax_info['errList']['fac_empresa']))
              {
                  $this->NM_ajax_info['errList']['fac_empresa'] = array();
              }
              $this->NM_ajax_info['errList']['fac_empresa'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 13 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_empresa';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_empresa

    function ValidateField_fac_establecimiento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_establecimiento'])) {
          nm_limpa_numero($this->fac_establecimiento, $this->field_config['fac_establecimiento']['symbol_grp']) ; 
          return;
      }
      if ($this->fac_establecimiento === "" || is_null($this->fac_establecimiento))  
      { 
          $this->fac_establecimiento = 0;
          $this->sc_force_zero[] = 'fac_establecimiento';
      } 
      nm_limpa_numero($this->fac_establecimiento, $this->field_config['fac_establecimiento']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->fac_establecimiento != '')  
          { 
              $iTestSize = 9;
              if (strlen($this->fac_establecimiento) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_establecimiento'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['fac_establecimiento']))
                  {
                      $Campos_Erros['fac_establecimiento'] = array();
                  }
                  $Campos_Erros['fac_establecimiento'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['fac_establecimiento']) || !is_array($this->NM_ajax_info['errList']['fac_establecimiento']))
                  {
                      $this->NM_ajax_info['errList']['fac_establecimiento'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_establecimiento'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->fac_establecimiento, 9, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['fac_establecimiento'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['fac_establecimiento']) || !is_array($this->NM_ajax_info['errList']['fac_establecimiento']))
                  {
                      $this->NM_ajax_info['errList']['fac_establecimiento'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_establecimiento'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_establecimiento';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_establecimiento

    function ValidateField_fac_punto_emision(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_punto_emision'])) {
          nm_limpa_numero($this->fac_punto_emision, $this->field_config['fac_punto_emision']['symbol_grp']) ; 
          return;
      }
      if ($this->fac_punto_emision === "" || is_null($this->fac_punto_emision))  
      { 
          $this->fac_punto_emision = 0;
          $this->sc_force_zero[] = 'fac_punto_emision';
      } 
      nm_limpa_numero($this->fac_punto_emision, $this->field_config['fac_punto_emision']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->fac_punto_emision != '')  
          { 
              $iTestSize = 9;
              if (strlen($this->fac_punto_emision) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_punto_emision'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['fac_punto_emision']))
                  {
                      $Campos_Erros['fac_punto_emision'] = array();
                  }
                  $Campos_Erros['fac_punto_emision'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['fac_punto_emision']) || !is_array($this->NM_ajax_info['errList']['fac_punto_emision']))
                  {
                      $this->NM_ajax_info['errList']['fac_punto_emision'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_punto_emision'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->fac_punto_emision, 9, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['fac_punto_emision'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['fac_punto_emision']) || !is_array($this->NM_ajax_info['errList']['fac_punto_emision']))
                  {
                      $this->NM_ajax_info['errList']['fac_punto_emision'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_punto_emision'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_punto_emision';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_punto_emision

    function ValidateField_fac_ambiente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_ambiente'])) {
          nm_limpa_numero($this->fac_ambiente, $this->field_config['fac_ambiente']['symbol_grp']) ; 
          return;
      }
      if ($this->fac_ambiente === "" || is_null($this->fac_ambiente))  
      { 
          $this->fac_ambiente = 0;
          $this->sc_force_zero[] = 'fac_ambiente';
      } 
      nm_limpa_numero($this->fac_ambiente, $this->field_config['fac_ambiente']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->fac_ambiente != '')  
          { 
              $iTestSize = 9;
              if (strlen($this->fac_ambiente) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_tipo_ambiente'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['fac_ambiente']))
                  {
                      $Campos_Erros['fac_ambiente'] = array();
                  }
                  $Campos_Erros['fac_ambiente'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['fac_ambiente']) || !is_array($this->NM_ajax_info['errList']['fac_ambiente']))
                  {
                      $this->NM_ajax_info['errList']['fac_ambiente'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_ambiente'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->fac_ambiente, 9, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['fac_ambiente'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['fac_ambiente']) || !is_array($this->NM_ajax_info['errList']['fac_ambiente']))
                  {
                      $this->NM_ajax_info['errList']['fac_ambiente'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_ambiente'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_ambiente';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_ambiente
    ...
    function ValidateField_fac_tipo_libretin(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fac_tipo_libretin) > 1) 
          { 
              $hasError = true;
              ...
              $Campos_Erros['fac_tipo_libretin'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 1 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['fac_tipo_libretin'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 1 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_fac_propina(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_propina'])) {
          if (!empty($this->field_config['fac_propina']['symbol_dec'])) {
              nm_limpa_valor($this->fac_propina, $this->field_config['fac_propina']['symbol_dec'], $this->field_config['fac_propina']['symbol_grp']) ; 
          }
          return;
      }
      if ($this->fac_propina === "" || is_null($this->fac_propina))  
      { 
          $this->fac_propina = 0;
          $this->sc_force_zero[] = 'fac_propina';
      } 
      if (!empty($this->field_config['fac_propina']['symbol_dec']))
      {
          nm_limpa_valor($this->fac_propina, $this->field_config['fac_propina']['symbol_dec'], $this->field_config['fac_propina']['symbol_grp']) ; 
          if ('.' == substr($this->fac_propina, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->fac_propina, 1)))
              {
                  $this->fac_propina = '';
              }
              else
              {
                  $this->fac_propina = '0' . $this->fac_propina;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 16;
              if (strlen($this->fac_propina) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_propina'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['fac_propina']))
                  {
                      $Campos_Erros['fac_propina'] = array();
                  }
                  $Campos_Erros['fac_propina'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['fac_propina']) || !is_array($this->NM_ajax_info['errList']['fac_propina']))
                  {
                      $this->NM_ajax_info['errList']['fac_propina'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_propina'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->fac_propina, 13, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['fac_propina'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['fac_propina']) || !is_array($this->NM_ajax_info['errList']['fac_propina']))
                  {
                      $this->NM_ajax_info['errList']['fac_propina'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_propina'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
    ...
    function ValidateField_fac_fecha_autorizacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      nm_limpa_data($this->fac_fecha_autorizacion, $this->field_config['fac_fecha_autorizacion']['date_sep']) ; 
      if (isset($this->Field_no_validate['fac_fecha_autorizacion'])) {
          return;
      }
      $trab_dt_min = ""; 
      $trab_dt_max = ""; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $guarda_datahora = $this->field_config['fac_fecha_autorizacion']['date_format']; 
          if (false !== strpos($guarda_datahora, ';')) $this->field_config['fac_fecha_autorizacion']['date_format'] = substr($guarda_datahora, 0, strpos($guarda_datahora, ';'));
          $Format_Data = $this->field_config['fac_fecha_autorizacion']['date_format']; 
          nm_limpa_data($Format_Data, $this->field_config['fac_fecha_autorizacion']['date_sep']) ; 
          if (trim($this->fac_fecha_autorizacion) != "")  
          { 
              if ($teste_validade->Data($this->fac_fecha_autorizacion, $Format_Data, $trab_dt_min, $trab_dt_max) == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_fecha_autorizacion'] . "; " ; 
                  if (!isset($Campos_Erros['fac_fecha_autorizacion']))
                  {
                      $Campos_Erros['fac_fecha_autorizacion'] = array();
                  }
                  $Campos_Erros['fac_fecha_autorizacion'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['fac_fecha_autorizacion']) || !is_array($this->NM_ajax_info['errList']['fac_fecha_autorizacion']))
                  {
                      $this->NM_ajax_info['errList']['fac_fecha_autorizacion'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_fecha_autorizacion'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
          $this->field_config['fac_fecha_autorizacion']['date_format'] = $guarda_datahora; 
       } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_fecha_autorizacion';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_fecha_autorizacion

    function ValidateField_fac_autorizacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_autorizacion'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fac_autorizacion) > 50) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_autorizacion'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 50 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['fac_autorizacion']))
              {
                  $Campos_Erros['fac_autorizacion'] = array();
              }
              $Campos_Erros['fac_autorizacion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 50 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['fac_autorizacion']) || !is_array($this->NM_ajax_info['errList']['fac_autorizacion']))
              {
                  $this->NM_ajax_info['errList']['fac_autorizacion'] = array();
              }
              $this->NM_ajax_info['errList']['fac_autorizacion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 50 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_autorizacion';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_autorizacion

    function ValidateField_fac_usuario(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_usuario'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fac_usuario) > 35) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_usuario'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 35 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['fac_usuario']))
              {
                  $Campos_Erros['fac_usuario'] = array();
              }
              $Campos_Erros['fac_usuario'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 35 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['fac_usuario']) || !is_array($this->NM_ajax_info['errList']['fac_usuario']))
              {
                  $this->NM_ajax_info['errList']['fac_usuario'] = array();
              }
              $this->NM_ajax_info['errList']['fac_usuario'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 35 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_usuario';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_usuario

    function ValidateField_fac_clave(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_clave'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fac_clave) > 50) 
          { 
              $hasError = true;
              $Campos_Crit .= "Fac Clave " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 50 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['fac_clave']))
              {
                  $Campos_Erros['fac_clave'] = array();
              }
              $Campos_Erros['fac_clave'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 50 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['fac_clave']) || !is_array($this->NM_ajax_info['errList']['fac_clave']))
              {
                  $this->NM_ajax_info['errList']['fac_clave'] = array();
              }
              $this->NM_ajax_info['errList']['fac_clave'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 50 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    } // ValidateField_fac_clave

    function ValidateField_fac_retencion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_retencion'])) {
          nm_limpa_numero($this->fac_retencion, $this->field_config['fac_retencion']['symbol_grp']) ; 
          return;
      }
      if ($this->fac_retencion === "" || is_null($this->fac_retencion))  
      { 
          $this->fac_retencion = 0;
          $this->sc_force_zero[] = 'fac_retencion';
      } 
      nm_limpa_numero($this->fac_retencion, $this->field_config['fac_retencion']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->fac_retencion != '')  
          { 
              $iTestSize = 9;
              if (strlen($this->fac_retencion) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Fac Retencion: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['fac_retencion']))
                  {
                      $Campos_Erros['fac_retencion'] = array();
                  }
                  $Campos_Erros['fac_retencion'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['fac_retencion']) || !is_array($this->NM_ajax_info['errList']['fac_retencion']))
                  {
                      $this->NM_ajax_info['errList']['fac_retencion'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_retencion'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->fac_retencion, 9, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Fac Retencion; " ; 
                  if (!isset($Campos_Erros['fac_retencion']))
                  {
                      $Campos_Erros['fac_retencion'] = array();
                  }
                  $Campos_Erros['fac_retencion'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['fac_retencion']) || !is_array($this->NM_ajax_info['errList']['fac_retencion']))
                  {
                      $this->NM_ajax_info['errList']['fac_retencion'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_retencion'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
   ...
   if (isset($this->Field_no_validate['fac_libretin'])) {
      ...
      if ($this->fac_libretin == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['php_cmp_required']['fac_libretin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['php_cmp_required']['fac_libretin'] == "on"))
      {
          $hasError = true;
          ...
          $Campos_Erros['fac_libretin'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['fac_libretin'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->fac_libretin) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_libretin']) && !in_array($this->fac_libretin, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_libretin']))
          {
              $hasError = true;
              ...
              $Campos_Erros['fac_libretin'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($this->NM_ajax_info['errList']['fac_libretin']) || !is_array($this->NM_ajax_info['errList']['fac_libretin']))
              {
                  $this->NM_ajax_info['errList']['fac_libretin'] = array();
              }
              $this->NM_ajax_info['errList']['fac_libretin'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
          }
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_fac_moneda(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['fac_moneda'])) {
       return;
   }
               if (!empty($this->fac_moneda) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_moneda']) && !in_array($this->fac_moneda, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_moneda']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['fac_moneda']))
                   {
                       $Campos_Erros['fac_moneda'] = array();
                   }
                   $Campos_Erros['fac_moneda'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['fac_moneda']) || !is_array($this->NM_ajax_info['errList']['fac_moneda']))
                   {
                       $this->NM_ajax_info['errList']['fac_moneda'] = array();
                   }
                   $this->NM_ajax_info['errList']['fac_moneda'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_moneda';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_moneda

    function ValidateField_fac_serie_guia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_serie_guia'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fac_serie_guia) > 17) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_guia_remision'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 17 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['fac_serie_guia']))
              {
                  $Campos_Erros['fac_serie_guia'] = array();
              }
              $Campos_Erros['fac_serie_guia'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 17 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['fac_serie_guia']) || !is_array($this->NM_ajax_info['errList']['fac_serie_guia']))
              {
                  $this->NM_ajax_info['errList']['fac_serie_guia'] = array();
              }
              $this->NM_ajax_info['errList']['fac_serie_guia'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 17 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
...
;
      ...
      $Teste_compara = $this->fac_serie_guia ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $Teste_critica = 0 ; 
          for ($x = 0; $x < mb_strlen($this->fac_serie_guia, $_SESSION['scriptcase']['charset']); $x++) 
          { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_guia_remision'] . " " . $this->Ini->Nm_lang['lang_errm_ivch']; 
              if (!isset($Campos_Erros['fac_serie_guia']))
              {
                  $Campos_Erros['fac_serie_guia'] = array();
              }
              $Campos_Erros['fac_serie_guia'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
              if (!isset($this->NM_ajax_info['errList']['fac_serie_guia']) || !is_array($this->NM_ajax_info['errList']['fac_serie_guia']))
              {
                  $this->NM_ajax_info['errList']['fac_serie_guia'] = array();
              }
              $this->NM_ajax_info['errList']['fac_serie_guia'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_serie_guia';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_serie_guia
    ...
    function ValidateField_fac_secuencial(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (isset($this->Field_no_validate['fac_secuencial'])) {
          nm_limpa_numero($this->fac_secuencial, $this->field_config['fac_secuencial']['symbol_grp']) ; 
          return;
      }
      if ($this->fac_secuencial === "" || is_null($this->fac_secuencial))  
      { 
          $this->fac_secuencial = 0;
          $this->sc_force_zero[] = 'fac_secuencial';
      } 
      nm_limpa_numero($this->fac_secuencial, $this->field_config['fac_secuencial']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->fac_secuencial != '')  
          { 
              $iTestSize = 9;
              if (strlen($this->fac_secuencial) > $iTestSize)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['fac_secuencial'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  ...
                  $this->NM_ajax_info['errList']['fac_secuencial'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->fac_secuencial, 9, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['fac_secuencial'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['fac_secuencial']) || !is_array($this->NM_ajax_info['errList']['fac_secuencial']))
                  {
                      $this->NM_ajax_info['errList']['fac_secuencial'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_secuencial'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
    ...
    function ValidateField_fac_cliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_cliente'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['php_cmp_required']['fac_cliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['php_cmp_required']['fac_cliente'] == "on")) 
      { 
          if ($this->fac_cliente == "")  
          { 
              $hasError = true;
              $Campos_Falta[] =  "" . $this->Ini->Nm_lang['lang_cliente'] . "" ; 
              if (!isset($Campos_Erros['fac_cliente']))
              {
                  $Campos_Erros['fac_cliente'] = array();
              }
              $Campos_Erros['fac_cliente'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['fac_cliente']) || !is_array($this->NM_ajax_info['errList']['fac_cliente']))
                  {
                      $this->NM_ajax_info['errList']['fac_cliente'] = array();
                  }
                  $this->NM_ajax_info['errList']['fac_cliente'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          } 
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fac_cliente) > 9) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cliente'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 9 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['fac_cliente']))
              {
                  $Campos_Erros['fac_cliente'] = array();
              }
              $Campos_Erros['fac_cliente'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 9 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['fac_cliente']) || !is_array($this->NM_ajax_info['errList']['fac_cliente']))
              {
                  $this->NM_ajax_info['errList']['fac_cliente'] = array();
              }
              $this->NM_ajax_info['errList']['fac_cliente'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 9 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_cliente';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_cliente

    function ValidateField_ruc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['ruc'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->ruc) > 20) 
          { 
              $hasError = true;
              ...
              $Campos_Erros['ruc'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['ruc']) || !is_array($this->NM_ajax_info['errList']['ruc']))
              {
                  $this->NM_ajax_info['errList']['ruc'] = array();
              }
              $this->NM_ajax_info['errList']['ruc'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_fac_tipo_identificacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_tipo_identificacion'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fac_tipo_identificacion) > 20) 
          { 
              $hasError = true;
              $Campos_Crit .= "fac_tipo_identificacion " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['fac_tipo_identificacion']))
              {
                  $Campos_Erros['fac_tipo_identificacion'] = array();
              }
              $Campos_Erros['fac_tipo_identificacion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['fac_tipo_identificacion']) || !is_array($this->NM_ajax_info['errList']['fac_tipo_identificacion']))
              {
                  $this->NM_ajax_info['errList']['fac_tipo_identificacion'] = array();
              }
              $this->NM_ajax_info['errList']['fac_tipo_identificacion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_tipo_identificacion';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_tipo_identificacion
    ...
    function ValidateField_fac_provincia_cliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['fac_provincia_cliente'])) {
       return;
   }
               if (!empty($this->fac_provincia_cliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_provincia_cliente']) && !in_array($this->fac_provincia_cliente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_provincia_cliente']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['fac_provincia_cliente']))
                   {
                       $Campos_Erros['fac_provincia_cliente'] = array();
                   }
                   $Campos_Erros['fac_provincia_cliente'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['fac_provincia_cliente']) || !is_array($this->NM_ajax_info['errList']['fac_provincia_cliente']))
                   {
                       $this->NM_ajax_info['errList']['fac_provincia_cliente'] = array();
                   }
                   $this->NM_ajax_info['errList']['fac_provincia_cliente'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_provincia_cliente';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_provincia_cliente

    function ValidateField_fac_canton_cliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['fac_canton_cliente'])) {
       return;
   }
               if (!empty($this->fac_canton_cliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_canton_cliente']) && !in_array($this->fac_canton_cliente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_canton_cliente']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['fac_canton_cliente']))
                   {
                       $Campos_Erros['fac_canton_cliente'] = array();
                   }
                   $Campos_Erros['fac_canton_cliente'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['fac_canton_cliente']) || !is_array($this->NM_ajax_info['errList']['fac_canton_cliente']))
                   {
                       $this->NM_ajax_info['errList']['fac_canton_cliente'] = array();
                   }
                   $this->NM_ajax_info['errList']['fac_canton_cliente'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_canton_cliente';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_canton_cliente
    ...
    function ValidateField_fac_telefono_cliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['fac_telefono_cliente'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->fac_telefono_cliente) > 20) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_lot_telefono'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['fac_telefono_cliente']))
              {
                  $Campos_Erros['fac_telefono_cliente'] = array();
              }
              $Campos_Erros['fac_telefono_cliente'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['fac_telefono_cliente']) || !is_array($this->NM_ajax_info['errList']['fac_telefono_cliente']))
              {
                  $this->NM_ajax_info['errList']['fac_telefono_cliente'] = array();
              }
              $this->NM_ajax_info['errList']['fac_telefono_cliente'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_telefono_cliente';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_telefono_cliente

    function ValidateField_fac_aplica_propina(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['fac_aplica_propina'])) {
       return;
   }
               if (!empty($this->fac_aplica_propina) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_aplica_propina']) && !in_array($this->fac_aplica_propina, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_aplica_propina']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['fac_aplica_propina']))
                   {
                       $Campos_Erros['fac_aplica_propina'] = array();
                   }
                   $Campos_Erros['fac_aplica_propina'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['fac_aplica_propina']) || !is_array($this->NM_ajax_info['errList']['fac_aplica_propina']))
                   {
                       $this->NM_ajax_info['errList']['fac_aplica_propina'] = array();
                   }
                   $this->NM_ajax_info['errList']['fac_aplica_propina'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_aplica_propina';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_aplica_propina

    function ValidateField_fac_diagnostico(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['fac_diagnostico'])) {
       return;
   }
               if (!empty($this->fac_diagnostico) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_diagnostico']) && !in_array($this->fac_diagnostico, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_diagnostico']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['fac_diagnostico']))
                   {
                       $Campos_Erros['fac_diagnostico'] = array();
                   }
                   $Campos_Erros['fac_diagnostico'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['fac_diagnostico']) || !is_array($this->NM_ajax_info['errList']['fac_diagnostico']))
                   {
                       $this->NM_ajax_info['errList']['fac_diagnostico'] = array();
                   }
                   $this->NM_ajax_info['errList']['fac_diagnostico'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fac_diagnostico';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fac_diagnostico
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['fac_error_sri'] = $this->fac_error_sri;
    ...
    $this->nmgp_dados_form['fac_establecimiento'] = $this->fac_establecimiento;
    $this->nmgp_dados_form['fac_punto_emision'] = $this->fac_punto_emision;
    $this->nmgp_dados_form['fac_ambiente'] = $this->fac_ambiente;
    ...
    $this->nmgp_dados_form['fac_propina'] = $this->fac_propina;
    $this->nmgp_dados_form['fac_total'] = $this->fac_total;
    $this->nmgp_dados_form['fac_estado'] = $this->fac_estado;
    $this->nmgp_dados_form['fac_fecha_autorizacion'] = $this->fac_fecha_autorizacion;
    $this->nmgp_dados_form['fac_autorizacion'] = $this->fac_autorizacion;
    $this->nmgp_dados_form['fac_usuario'] = $this->fac_usuario;
    $this->nmgp_dados_form['fac_clave'] = $this->fac_clave;
    $this->nmgp_dados_form['fac_retencion'] = $this->fac_retencion;
    ...
    $this->nmgp_dados_form['fac_moneda'] = $this->fac_moneda;
    $this->nmgp_dados_form['fac_serie_guia'] = $this->fac_serie_guia;
    ...
    $this->nmgp_dados_form['fac_cliente'] = $this->fac_cliente;
    $this->nmgp_dados_form['ruc'] = $this->ruc;
    $this->nmgp_dados_form['fac_tipo_identificacion'] = $this->fac_tipo_identificacion;
    $this->nmgp_dados_form['fac_nombre_cliente'] = $this->fac_nombre_cliente;
    $this->nmgp_dados_form['fac_provincia_cliente'] = $this->fac_provincia_cliente;
    $this->nmgp_dados_form['fac_canton_cliente'] = $this->fac_canton_cliente;
    ...
    $this->nmgp_dados_form['fac_telefono_cliente'] = $this->fac_telefono_cliente;
    $this->nmgp_dados_form['fac_aplica_propina'] = $this->fac_aplica_propina;
    $this->nmgp_dados_form['fac_diagnostico'] = $this->fac_diagnostico;
    $this->nmgp_dados_form['fac_comentario'] = $this->fac_comentario;
    $this->nmgp_dados_form['forma_pago'] = $this->forma_pago;
    $this->nmgp_dados_form['fac_tomado'] = $this->fac_tomado;
    $this->nmgp_dados_form['fac_total_subsidio'] = $this->fac_total_subsidio;
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_numero($this->fac_numero, $this->field_config['fac_numero']['symbol_grp']) ; 
      $this->Before_unformat['fac_establecimiento'] = $this->fac_establecimiento;
      nm_limpa_numero($this->fac_establecimiento, $this->field_config['fac_establecimiento']['symbol_grp']) ; 
      $this->Before_unformat['fac_punto_emision'] = $this->fac_punto_emision;
      nm_limpa_numero($this->fac_punto_emision, $this->field_config['fac_punto_emision']['symbol_grp']) ; 
      $this->Before_unformat['fac_ambiente'] = $this->fac_ambiente;
      nm_limpa_numero($this->fac_ambiente, $this->field_config['fac_ambiente']['symbol_grp']) ; 
      ...
      $this->Before_unformat['fac_propina'] = $this->fac_propina;
      if (!empty($this->field_config['fac_propina']['symbol_dec']))
      {
         nm_limpa_valor($this->fac_propina, $this->field_config['fac_propina']['symbol_dec'], $this->field_config['fac_propina']['symbol_grp']);
      }
      ...
      $this->Before_unformat['fac_fecha_autorizacion'] = $this->fac_fecha_autorizacion;
      nm_limpa_data($this->fac_fecha_autorizacion, $this->field_config['fac_fecha_autorizacion']['date_sep']) ; 
      $this->Before_unformat['fac_retencion'] = $this->fac_retencion;
      nm_limpa_numero($this->fac_retencion, $this->field_config['fac_retencion']['symbol_grp']) ; 
      $this->Before_unformat['fac_fecha'] = $this->fac_fecha;
      nm_limpa_data($this->fac_fecha, $this->field_config['fac_fecha']['date_sep']) ; 
      $this->Before_unformat['fac_secuencial'] = $this->fac_secuencial;
      nm_limpa_numero($this->fac_secuencial, $this->field_config['fac_secuencial']['symbol_grp']) ; 
      $this->Before_unformat['fac_total_subsidio'] = $this->fac_total_subsidio;
      if (!empty($this->field_config['fac_total_subsidio']['symbol_dec']))
      {
         $this->sc_remove_currency($this->fac_total_subsidio, $this->field_config['fac_total_subsidio']['symbol_dec'], $this->field_config['fac_total_subsidio']['symbol_grp'], $this->field_config['fac_total_subsidio']['symbol_mon']);
         nm_limpa_valor($this->fac_total_subsidio, $this->field_config['fac_total_subsidio']['symbol_dec'], $this->field_config['fac_total_subsidio']['symbol_grp']);
      }
   }
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "fac_establecimiento")
      {
          nm_limpa_numero($this->fac_establecimiento, $this->field_config['fac_establecimiento']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "fac_punto_emision")
      {
          nm_limpa_numero($this->fac_punto_emision, $this->field_config['fac_punto_emision']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "fac_ambiente")
      {
          nm_limpa_numero($this->fac_ambiente, $this->field_config['fac_ambiente']['symbol_grp']) ; 
      }
      ...
      if ($Nome_Campo == "fac_retencion")
      {
          nm_limpa_numero($this->fac_retencion, $this->field_config['fac_retencion']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "fac_secuencial")
      {
          nm_limpa_numero($this->fac_secuencial, $this->field_config['fac_secuencial']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "fac_total_subsidio")
      {
          if (!empty($this->field_config['fac_total_subsidio']['symbol_dec']))
          {
             $this->sc_remove_currency($this->fac_total_subsidio, $this->field_config['fac_total_subsidio']['symbol_dec'], $this->field_config['fac_total_subsidio']['symbol_grp'], $this->field_config['fac_total_subsidio']['symbol_mon']);
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if ('' !== $this->fac_establecimiento || (!empty($format_fields) && isset($format_fields['fac_establecimiento'])))
      {
          nmgp_Form_Num_Val($this->fac_establecimiento, $this->field_config['fac_establecimiento']['symbol_grp'], $this->field_config['fac_establecimiento']['symbol_dec'], "0", "S", $this->field_config['fac_establecimiento']['format_neg'], "", "", "-", $this->field_config['fac_establecimiento']['symbol_fmt']) ; 
      }
      if ('' !== $this->fac_punto_emision || (!empty($format_fields) && isset($format_fields['fac_punto_emision'])))
      {
          nmgp_Form_Num_Val($this->fac_punto_emision, $this->field_config['fac_punto_emision']['symbol_grp'], $this->field_config['fac_punto_emision']['symbol_dec'], "0", "S", $this->field_config['fac_punto_emision']['format_neg'], "", "", "-", $this->field_config['fac_punto_emision']['symbol_fmt']) ; 
      }
      if ('' !== $this->fac_ambiente || (!empty($format_fields) && isset($format_fields['fac_ambiente'])))
      {
          nmgp_Form_Num_Val($this->fac_ambiente, $this->field_config['fac_ambiente']['symbol_grp'], $this->field_config['fac_ambiente']['symbol_dec'], "0", "S", $this->field_config['fac_ambiente']['format_neg'], "", "", "-", $this->field_config['fac_ambiente']['symbol_fmt']) ; 
      }
      ...
      if ('' !== $this->fac_propina || (!empty($format_fields) && isset($format_fields['fac_propina'])))
      {
          nmgp_Form_Num_Val($this->fac_propina, $this->field_config['fac_propina']['symbol_grp'], $this->field_config['fac_propina']['symbol_dec'], "2", "S", $this->field_config['fac_propina']['format_neg'], "", "", "-", $this->field_config['fac_propina']['symbol_fmt']) ; 
      }
      ...
      $this->fac_fecha_autorizacion = trim($this->fac_fecha_autorizacion);
      if ($this->fac_fecha_autorizacion == "")
      {
          $this->fac_fecha_autorizacion = "";
      }
      if (!empty($this->fac_fecha_autorizacion) || (!empty($format_fields) && isset($format_fields['fac_fecha_autorizacion'])))
      {
          nm_conv_form_data($this->fac_fecha_autorizacion, "", $this->field_config['fac_fecha_autorizacion']['date_format'], array($this->field_config['fac_fecha_autorizacion']['date_sep'])) ;  
      }
      if ('' !== $this->fac_retencion || (!empty($format_fields) && isset($format_fields['fac_retencion'])))
      {
          nmgp_Form_Num_Val($this->fac_retencion, $this->field_config['fac_retencion']['symbol_grp'], $this->field_config['fac_retencion']['symbol_dec'], "0", "S", $this->field_config['fac_retencion']['format_neg'], "", "", "-", $this->field_config['fac_retencion']['symbol_fmt']) ; 
      }
      ...
      if ('' !== $this->fac_secuencial || (!empty($format_fields) && isset($format_fields['fac_secuencial'])))
      {
          nmgp_Form_Num_Val($this->fac_secuencial, $this->field_config['fac_secuencial']['symbol_grp'], $this->field_config['fac_secuencial']['symbol_dec'], "0", "S", $this->field_config['fac_secuencial']['format_neg'], "", "", "-", $this->field_config['fac_secuencial']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_fac_error_sri();
          $this->ajax_return_values_fac_numero();
          $this->ajax_return_values_fac_tipo_comprobante();
          $this->ajax_return_values_fac_empresa();
          $this->ajax_return_values_fac_establecimiento();
          $this->ajax_return_values_fac_punto_emision();
          $this->ajax_return_values_fac_ambiente();
          ...
          $this->ajax_return_values_fac_propina();
          $this->ajax_return_values_fac_total();
          $this->ajax_return_values_fac_estado();
          $this->ajax_return_values_fac_fecha_autorizacion();
          $this->ajax_return_values_fac_autorizacion();
          $this->ajax_return_values_fac_usuario();
          $this->ajax_return_values_fac_clave();
          $this->ajax_return_values_fac_retencion();
          $this->ajax_return_values_fac_fecha();
          $this->ajax_return_values_fac_libretin();
          $this->ajax_return_values_secuencial();
          $this->ajax_return_values_fac_moneda();
          $this->ajax_return_values_fac_serie_guia();
          $this->ajax_return_values_fac_secuencial();
          $this->ajax_return_values_productos();
          $this->ajax_return_values_detalle();
          $this->ajax_return_values_fac_cliente();
          $this->ajax_return_values_ruc();
          $this->ajax_return_values_fac_tipo_identificacion();
          $this->ajax_return_values_fac_nombre_cliente();
          $this->ajax_return_values_fac_provincia_cliente();
          $this->ajax_return_values_fac_canton_cliente();
          $this->ajax_return_values_fac_direccion_cliente();
          $this->ajax_return_values_fac_email_cliente();
          $this->ajax_return_values_fac_telefono_cliente();
          $this->ajax_return_values_fac_aplica_propina();
          $this->ajax_return_values_fac_diagnostico();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['fac_numero']['keyVal'] = form_del_punto_venta_pack_protect_string($this->nmgp_dados_form['fac_numero']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['form_del_forma_pago_factura_script_case_init'] ]['form_del_forma_pago_factura']['foreign_key']['fp_factura'] = $this->nmgp_dados_form['fac_numero'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['form_del_forma_pago_factura_script_case_init'] ]['form_del_forma_pago_factura']['where_filter'] = "fp_factura = " . $this->nmgp_dados_form['fac_numero'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['form_del_forma_pago_factura_script_case_init'] ]['form_del_forma_pago_factura']['where_detal']  = "fp_factura = " . $this->nmgp_dados_form['fac_numero'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['form_del_forma_pago_factura_script_case_init'] ]['form_del_forma_pago_factura']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['form_del_forma_pago_factura_script_case_init'] ]['form_del_forma_pago_factura']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['form_del_forma_pago_factura_script_case_init'] ]['form_del_forma_pago_factura']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['grid_detalle_factura_script_case_init'] ]['grid_detalle_factura']['embutida_form_full'] = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['grid_detalle_factura_script_case_init'] ]['grid_detalle_factura']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['grid_detalle_factura_script_case_init'] ]['grid_detalle_factura']['embutida_pai']        = "form_del_punto_venta";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['grid_detalle_factura_script_case_init'] ]['grid_detalle_factura']['embutida_form_parms'] = "var_factura*scin" . $this->nmgp_dados_form['fac_numero'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['grid_detalle_factura_script_case_init'] ]['grid_detalle_factura']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['grid_detalle_factura_script_case_init'] ]['grid_detalle_factura']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['productos_venta_empresas_script_case_init'] ]['productos_venta_empresas']['embutida_form_full'] = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['productos_venta_empresas_script_case_init'] ]['productos_venta_empresas']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['productos_venta_empresas_script_case_init'] ]['productos_venta_empresas']['embutida_pai']        = "form_del_punto_venta";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['productos_venta_empresas_script_case_init'] ]['productos_venta_empresas']['embutida_form_parms'] = "NMSC_inicial*scininicio*scoutNMSC_paginacao*scinPARCIAL*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['productos_venta_empresas_script_case_init'] ]['productos_venta_empresas']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['productos_venta_empresas_script_case_init'] ]['productos_venta_empresas']['total']);
          }
   } // ajax_return_values
   ...
   function ajax_return_values_fac_estado_sri($bForce = false)
   {
          ...
          //----- fac_error_sri
   function ajax_return_values_fac_error_sri($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_error_sri", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_error_sri);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_error_sri'] = array(
                       'row'    => '',
               'type'    => 'text',
   ...
   function ajax_return_values_fac_tipo_comprobante($bForce = false)
   {
          ...
          //----- fac_empresa
   function ajax_return_values_fac_empresa($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_empresa", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_empresa);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_empresa'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
          ...
          //----- fac_establecimiento
   function ajax_return_values_fac_establecimiento($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_establecimiento", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_establecimiento);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_establecimiento'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
          ...
          //----- fac_punto_emision
   function ajax_return_values_fac_punto_emision($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_punto_emision", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_punto_emision);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_punto_emision'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
          ...
          //----- fac_ambiente
   function ajax_return_values_fac_ambiente($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_ambiente", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_ambiente);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_ambiente'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_fac_valor_irbpnr($bForce = false)
   {
          ...
          //----- fac_propina
   function ajax_return_values_fac_propina($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_propina", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_propina);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_propina'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_fac_estado($bForce = false)
   {
          ...
          //----- fac_fecha_autorizacion
   function ajax_return_values_fac_fecha_autorizacion($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_fecha_autorizacion", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_fecha_autorizacion);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_fecha_autorizacion'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
          ...
          //----- fac_autorizacion
   function ajax_return_values_fac_autorizacion($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_autorizacion", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_autorizacion);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_autorizacion'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- fac_usuario
   function ajax_return_values_fac_usuario($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_usuario", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_usuario);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_usuario'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- fac_clave
   function ajax_return_values_fac_clave($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_clave", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_clave);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_clave'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- fac_retencion
   function ajax_return_values_fac_retencion($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_retencion", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_retencion);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_retencion'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_fac_libretin($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_libretin", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              $aLookup = array();
              $this->_tmp_lookup_fac_libretin = $this->fac_libretin;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_libretin']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_libretin'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_libretin']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_libretin'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_del_punto_venta_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_del_punto_venta_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_libretin'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"fac_libretin\"";
          if (isset($this->NM_ajax_info['select_html']['fac_libretin']) && !empty($this->NM_ajax_info['select_html']['fac_libretin']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['fac_libretin']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->fac_libretin == $sValue)
                  {
                      $this->_tmp_lookup_fac_libretin = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['fac_libretin']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['fac_libretin']['valList'][$i] = form_del_punto_venta_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['fac_libretin']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['fac_libretin']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['fac_libretin']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_secuencial($bForce = false)
   {
          ...
          //----- fac_moneda
   function ajax_return_values_fac_moneda($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_moneda", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_moneda);
              $aLookup = array();
              $this->_tmp_lookup_fac_moneda = $this->fac_moneda;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_moneda']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_moneda'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_moneda']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_moneda'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_moneda'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"fac_moneda\"";
          if (isset($this->NM_ajax_info['select_html']['fac_moneda']) && !empty($this->NM_ajax_info['select_html']['fac_moneda']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['fac_moneda']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->fac_moneda == $sValue)
                  {
                      $this->_tmp_lookup_fac_moneda = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['fac_moneda'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['fac_moneda']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['fac_moneda']['valList'][$i] = form_del_punto_venta_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['fac_moneda']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['fac_moneda']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['fac_moneda']['labList'] = $aLabel;
          }
   }

          //----- fac_serie_guia
   function ajax_return_values_fac_serie_guia($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_serie_guia", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_serie_guia);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_serie_guia'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
   ...
   function ajax_return_values_detalle($bForce = false)
   {
          ...
          //----- fac_cliente
   function ajax_return_values_fac_cliente($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_cliente", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_cliente);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_cliente'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_ruc($bForce = false)
   {
          ...
          //----- fac_tipo_identificacion
   function ajax_return_values_fac_tipo_identificacion($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_tipo_identificacion", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_tipo_identificacion);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_tipo_identificacion'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
   ...
   function ajax_return_values_fac_nombre_cliente($bForce = false)
   {
          ...
          //----- fac_provincia_cliente
   function ajax_return_values_fac_provincia_cliente($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_provincia_cliente", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_provincia_cliente);
              $aLookup = array();
              $this->_tmp_lookup_fac_provincia_cliente = $this->fac_provincia_cliente;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_provincia_cliente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_provincia_cliente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_provincia_cliente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_provincia_cliente'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_provincia_cliente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"fac_provincia_cliente\"";
          if (isset($this->NM_ajax_info['select_html']['fac_provincia_cliente']) && !empty($this->NM_ajax_info['select_html']['fac_provincia_cliente']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['fac_provincia_cliente']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->fac_provincia_cliente == $sValue)
                  {
                      $this->_tmp_lookup_fac_provincia_cliente = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['fac_provincia_cliente'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['fac_provincia_cliente']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['fac_provincia_cliente']['valList'][$i] = form_del_punto_venta_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['fac_provincia_cliente']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['fac_provincia_cliente']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['fac_provincia_cliente']['labList'] = $aLabel;
          }
   }

          //----- fac_canton_cliente
   function ajax_return_values_fac_canton_cliente($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_canton_cliente", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_canton_cliente);
              $aLookup = array();
              $this->_tmp_lookup_fac_canton_cliente = $this->fac_canton_cliente;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_canton_cliente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_canton_cliente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_canton_cliente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_canton_cliente'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_canton_cliente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"fac_canton_cliente\"";
          if (isset($this->NM_ajax_info['select_html']['fac_canton_cliente']) && !empty($this->NM_ajax_info['select_html']['fac_canton_cliente']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['fac_canton_cliente']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->fac_canton_cliente == $sValue)
                  {
                      $this->_tmp_lookup_fac_canton_cliente = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['fac_canton_cliente'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['fac_canton_cliente']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['fac_canton_cliente']['valList'][$i] = form_del_punto_venta_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['fac_canton_cliente']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['fac_canton_cliente']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['fac_canton_cliente']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_fac_email_cliente($bForce = false)
   {
          ...
          //----- fac_telefono_cliente
   function ajax_return_values_fac_telefono_cliente($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_telefono_cliente", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_telefono_cliente);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fac_telefono_cliente'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- fac_aplica_propina
   function ajax_return_values_fac_aplica_propina($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_aplica_propina", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_aplica_propina);
              $aLookup = array();
              $this->_tmp_lookup_fac_aplica_propina = $this->fac_aplica_propina;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_aplica_propina']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_aplica_propina'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_aplica_propina']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_aplica_propina'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_aplica_propina'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"fac_aplica_propina\"";
          if (isset($this->NM_ajax_info['select_html']['fac_aplica_propina']) && !empty($this->NM_ajax_info['select_html']['fac_aplica_propina']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['fac_aplica_propina']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->fac_aplica_propina == $sValue)
                  {
                      $this->_tmp_lookup_fac_aplica_propina = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['fac_aplica_propina'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['fac_aplica_propina']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['fac_aplica_propina']['valList'][$i] = form_del_punto_venta_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['fac_aplica_propina']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['fac_aplica_propina']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['fac_aplica_propina']['labList'] = $aLabel;
          }
   }

          //----- fac_diagnostico
   function ajax_return_values_fac_diagnostico($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fac_diagnostico", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fac_diagnostico);
              $aLookup = array();
              $this->_tmp_lookup_fac_diagnostico = $this->fac_diagnostico;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_diagnostico']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_diagnostico'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_diagnostico']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_diagnostico'] = array(); 
}
$aLookup[] = array(form_del_punto_venta_pack_protect_string('') => str_replace('<', '&lt;',form_del_punto_venta_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_diagnostico'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_diagnostico'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"fac_diagnostico\"";
          if (isset($this->NM_ajax_info['select_html']['fac_diagnostico']) && !empty($this->NM_ajax_info['select_html']['fac_diagnostico']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['fac_diagnostico']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->fac_diagnostico == $sValue)
                  {
                      $this->_tmp_lookup_fac_diagnostico = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['fac_diagnostico'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['fac_diagnostico']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['fac_diagnostico']['valList'][$i] = form_del_punto_venta_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['fac_diagnostico']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['fac_diagnostico']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['fac_diagnostico']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_forma_pago($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   {
       $this->NM_ajax_info['btnVars']['var_btn_ride_var_tipo_documento'] = $this->form_encode_input($this->nmgp_dados_form['fac_tipo_comprobante']);
       $this->NM_ajax_info['btnVars']['var_btn_ride_var_id_documento'] = $this->form_encode_input($this->nmgp_dados_form['fac_numero']);
       $this->NM_ajax_info['btnVars']['var_btn_retencion_var_id_factura_venta'] = $this->form_encode_input($this->nmgp_dados_form['fac_numero']);
       $this->NM_ajax_info['btnVars']['var_btn_bauchert_var_documento'] = $this->form_encode_input($this->nmgp_dados_form['fac_numero']);
   } // ajax_add_parameters
  function nm_proc_onload($bFormat = true)
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Field_no_validate'] = array();
      if (!$this->NM_ajax_flag || !isset($this->nmgp_refresh_fields)) {
      $_SESSION['scriptcase']['form_del_punto_venta']['contr_erro'] = 'on';
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_fac_ambiente = $this->fac_ambiente;
    $original_fac_autorizacion = $this->fac_autorizacion;
    $original_fac_canton_cliente = $this->fac_canton_cliente;
    $original_fac_cliente = $this->fac_cliente;
    $original_fac_diagnostico = $this->fac_diagnostico;
    $original_fac_direccion_cliente = $this->fac_direccion_cliente;
    $original_fac_email_cliente = $this->fac_email_cliente;
    $original_fac_establecimiento = $this->fac_establecimiento;
    $original_fac_estado = $this->fac_estado;
    $original_fac_estado_sri = $this->fac_estado_sri;
    $original_fac_fecha = $this->fac_fecha;
    ...
    $original_fac_provincia_cliente = $this->fac_provincia_cliente;
    $original_fac_punto_emision = $this->fac_punto_emision;
...
$check_sql = "SELECT es_profesionalsalud 
			  FROM del_empresa 
...
if (isset($this->rs[0][0])){
	if($this->rs[0][0]=='S'){
		 $this->nmgp_cmp_hidden["fac_diagnostico"] = 'on'; $this->NM_ajax_info['fieldDisplay']['fac_diagnostico'] = 'on';
   	}else{
		 $this->nmgp_cmp_hidden["fac_diagnostico"] = 'off'; $this->NM_ajax_info['fieldDisplay']['fac_diagnostico'] = 'off';
	}
}
if($this->fac_cliente <>''){
	$check_sql = "SELECT
						...
						cl_email,
						cl_identificacion,
						COALESCE(pro_nombre,'IMBABURA'),
						COALESCE(can_nombre,'IBARRA') 
					FROM
						del_cliente 
					LEFT JOIN sis_provincia	ON cl_provincia=pro_id 
					LEFT JOIN sis_canton	ON cl_ciudad = can_id 
				  where cl_id = " . $this->fac_cliente  ;
	...
	if (isset($this->rs[0][0])){
		...
		$this->ruc =$this->rs[0][3];
		$this->fac_provincia_cliente =$this->rs[0][4];
		$this->fac_canton_cliente =$this->rs[0][5];
	}
}

if($this->fac_libretin <>''){
	$check_sql = "SELECT est_codigo,
						 pen_serie,
						 right('000000000'||fac_secuencial,9),
						 tl_descripcion,
						 ta_nombre 
				  FROM del_factura 
				  join del_establecimiento on fac_establecimiento=est_id
				  join del_punto_emision on fac_punto_emision=pem_id
				  join sri_tipo_libretin on fac_tipo_libretin = tl_codigo
				  join sri_tipo_ambiente on fac_ambiente=ta_id
	...
	if (isset($this->rs[0][0])){
		...
		$establecimiento  = $this->rs[0][0];
		$punto_emision  = $this->rs[0][1];
		$this->secuencial = $this->rs[0][2];
		$tipo_libretin =$this->rs[0][3];
		$ambiente =$this->rs[0][4];
	...
	$check_sql = "SELECT est_id,
         			...
         			estado_sri
			 FROM v_del_libretin
			 WHERE lib_id=".$this->fac_libretin ;
      ...
      { 
          ...
          $this->rs_erro = $this->Db->ErrorMsg();
			...
			if (isset($this->rs[0][0])){
				$this->fac_establecimiento  = $this->rs[0][0];
				$this->fac_punto_emision  = $this->rs[0][1];
				$this->fac_secuencial = $this->rs[0][2];
				$this->fac_ambiente =$this->rs[0][3];
				...
				$this->fac_autorizacion =$this->rs[0][10];
				$this->fac_estado_sri =$this->rs[0][11];
			}
...
if ($this->fac_estado =='R'){
	$this->sc_field_readonly("fac_libretin", 'off');
...
}elseif($this->fac_estado =='V'){
	$this->sc_field_readonly("fac_libretin", 'on');
	$this->sc_field_readonly("fac_fecha", 'on');
	$this->NM_ajax_info['buttonDisplay']['Anular'] = $this->nmgp_botoes["Anular"] = 'on';;
	$this->NM_ajax_info['buttonDisplay']['update'] = $this->nmgp_botoes["update"] = 'off';;
	if($this->fac_tipo_libretin =='E'){
		if($this->fac_estado_sri  == 'AUTORIZADO'){
			$this->NM_ajax_info['buttonDisplay']['enviar'] = $this->nmgp_botoes["enviar"] = 'off';;
		}else{
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_fac_ambiente != $this->fac_ambiente || (isset($bFlagRead_fac_ambiente) && $bFlagRead_fac_ambiente)))
    {
        $this->ajax_return_values_fac_ambiente(true);
    }
    if (($original_fac_autorizacion != $this->fac_autorizacion || (isset($bFlagRead_fac_autorizacion) && $bFlagRead_fac_autorizacion)))
    {
        $this->ajax_return_values_fac_autorizacion(true);
    }
    if (($original_fac_canton_cliente != $this->fac_canton_cliente || (isset($bFlagRead_fac_canton_cliente) && $bFlagRead_fac_canton_cliente)))
    {
        $this->ajax_return_values_fac_canton_cliente(true);
    }
    if (($original_fac_cliente != $this->fac_cliente || (isset($bFlagRead_fac_cliente) && $bFlagRead_fac_cliente)))
    {
        $this->ajax_return_values_fac_cliente(true);
    }
    if (($original_fac_diagnostico != $this->fac_diagnostico || (isset($bFlagRead_fac_diagnostico) && $bFlagRead_fac_diagnostico)))
    {
        $this->ajax_return_values_fac_diagnostico(true);
    }
    ...
    if (($original_fac_establecimiento != $this->fac_establecimiento || (isset($bFlagRead_fac_establecimiento) && $bFlagRead_fac_establecimiento)))
    {
        $this->ajax_return_values_fac_establecimiento(true);
    }
    ...
    if (($original_fac_fecha != $this->fac_fecha || (isset($bFlagRead_fac_fecha) && $bFlagRead_fac_fecha)))
    {
        $this->ajax_return_values_fac_fecha(true);
    }
    ...
    if (($original_fac_provincia_cliente != $this->fac_provincia_cliente || (isset($bFlagRead_fac_provincia_cliente) && $bFlagRead_fac_provincia_cliente)))
    {
        $this->ajax_return_values_fac_provincia_cliente(true);
    }
    if (($original_fac_punto_emision != $this->fac_punto_emision || (isset($bFlagRead_fac_punto_emision) && $bFlagRead_fac_punto_emision)))
    {
        $this->ajax_return_values_fac_punto_emision(true);
    }
...
//
   ...
   { 
      ...
      $this->fac_propina = str_replace($sc_parm1, $sc_parm2, $this->fac_propina); 
      $this->fac_total = str_replace($sc_parm1, $sc_parm2, $this->fac_total); 
      $this->fac_total_subsidio = str_replace($sc_parm1, $sc_parm2, $this->fac_total_subsidio); 
   } 
   ...
   { 
      ...
      $this->fac_propina = "'" . $this->fac_propina . "'";
      $this->fac_total = "'" . $this->fac_total . "'";
      $this->fac_total_subsidio = "'" . $this->fac_total_subsidio . "'";
   } 
   ...
   { 
      ...
      $this->fac_propina = str_replace("'", "", $this->fac_propina); 
      $this->fac_total = str_replace("'", "", $this->fac_total); 
      $this->fac_total_subsidio = str_replace("'", "", $this->fac_total_subsidio); 
   } 
//----------- 
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_fac_nombre_cliente = $this->fac_nombre_cliente;
    $original_fac_numero = $this->fac_numero;
    $original_fac_propina = $this->fac_propina;
    $original_fac_provincia_cliente = $this->fac_provincia_cliente;
    $original_fac_serie_guia = $this->fac_serie_guia;
    ...
    $original_fac_telefono_cliente = $this->fac_telefono_cliente;
    $original_fac_tipo_identificacion = $this->fac_tipo_identificacion;
...
if (isset($this->rs[0][0])){
	...
	$this->fac_propina = $this->rs[0][9];
	$this->fac_total = $this->rs[0][10];
}

if($this->fac_estado =='R'){
	$ciudadano=array(
		'identificacion'=>$this->ruc ,
		'nombre'=>$this->fac_nombre_cliente ,
		'nombre_comercial'=>'',
		'obligado_contabilidad'=>'N',
		'tipo_contribuyente'=>"PERSONAS NATURALES",
		'provincia'=>$this->fac_provincia_cliente ,
		'canton'=>$this->fac_canton_cliente ,
		'direccion'=>$this->fac_direccion_cliente ,
		'correo'=>$this->fac_email_cliente ,
		'telefono'=>$this->fac_telefono_cliente 
	);
	$respuesta=insertUpdateCiudadano($ciudadano);
	if ($this->ruc <>'9999999999999'){
				$w_cliente= array(
					'empresa'=> $this->sc_temp_Igtech_RucEmpresa,
					'nombre'=> $this->fac_nombre_cliente ,
					'tipo_identificacion'=> $this->fac_tipo_identificacion ,
					'identificacion'=> $this->ruc ,
					'pais'=> 'ECUADOR',
					'provincia'=> $this->fac_provincia_cliente ,
					'ciudad'=> $this->fac_canton_cliente ,
					'direccion'=> $this->fac_direccion_cliente ,
					'telefono'=> $this->fac_telefono_cliente ,
					'email'=> $this->fac_email_cliente 
				);
...
if ($this->verficar_guia($this->fac_serie_guia )==false){
	$this->sc_temp_var_procesar=false;
	$this->sc_temp_var_mensaje='El dato de guía de remisión no tiene el formato adecuado<br>';
}
if ($this->fac_total ==0){
		$this->sc_temp_var_procesar=false;
	...
	if($this->fac_total >50 and $this->fac_cliente ==1){
		$this->sc_temp_var_procesar=false;
		$this->sc_temp_var_mensaje='Ventas a Consumidor Final no deben exceder los 50.00USD <br>';
	}
}
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_fac_propina != $this->fac_propina || (isset($bFlagRead_fac_propina) && $bFlagRead_fac_propina)))
    {
        $this->ajax_return_values_fac_propina(true);
    }
    if (($original_fac_provincia_cliente != $this->fac_provincia_cliente || (isset($bFlagRead_fac_provincia_cliente) && $bFlagRead_fac_provincia_cliente)))
    {
        $this->ajax_return_values_fac_provincia_cliente(true);
    }
    if (($original_fac_serie_guia != $this->fac_serie_guia || (isset($bFlagRead_fac_serie_guia) && $bFlagRead_fac_serie_guia)))
    {
        $this->ajax_return_values_fac_serie_guia(true);
    }
    if (($original_fac_subtotal != $this->fac_subtotal || (isset($bFlagRead_fac_subtotal) && $bFlagRead_fac_subtotal)))
    {
        $this->ajax_return_values_fac_subtotal(true);
    }
    if (($original_fac_subtotal_cero != $this->fac_subtotal_cero || (isset($bFlagRead_fac_subtotal_cero) && $bFlagRead_fac_subtotal_cero)))
    {
        $this->ajax_return_values_fac_subtotal_cero(true);
    }
    if (($original_fac_subtotal_excento != $this->fac_subtotal_excento || (isset($bFlagRead_fac_subtotal_excento) && $bFlagRead_fac_subtotal_excento)))
    {
        $this->ajax_return_values_fac_subtotal_excento(true);
    }
    if (($original_fac_subtotal_iva != $this->fac_subtotal_iva || (isset($bFlagRead_fac_subtotal_iva) && $bFlagRead_fac_subtotal_iva)))
    {
        $this->ajax_return_values_fac_subtotal_iva(true);
    }
    if (($original_fac_subtotal_no_objeto != $this->fac_subtotal_no_objeto || (isset($bFlagRead_fac_subtotal_no_objeto) && $bFlagRead_fac_subtotal_no_objeto)))
    {
        $this->ajax_return_values_fac_subtotal_no_objeto(true);
    }
    if (($original_fac_telefono_cliente != $this->fac_telefono_cliente || (isset($bFlagRead_fac_telefono_cliente) && $bFlagRead_fac_telefono_cliente)))
    {
        $this->ajax_return_values_fac_telefono_cliente(true);
    }
    if (($original_fac_tipo_identificacion != $this->fac_tipo_identificacion || (isset($bFlagRead_fac_tipo_identificacion) && $bFlagRead_fac_tipo_identificacion)))
    {
        $this->ajax_return_values_fac_tipo_identificacion(true);
    }
    if (($original_fac_total != $this->fac_total || (isset($bFlagRead_fac_total) && $bFlagRead_fac_total)))
    {
        $this->ajax_return_values_fac_total(true);
    }
    if (($original_fac_total_descuento != $this->fac_total_descuento || (isset($bFlagRead_fac_total_descuento) && $bFlagRead_fac_total_descuento)))
    {
        $this->ajax_return_values_fac_total_descuento(true);
    }
    if (($original_fac_valor_ice != $this->fac_valor_ice || (isset($bFlagRead_fac_valor_ice) && $bFlagRead_fac_valor_ice)))
    {
        $this->ajax_return_values_fac_valor_ice(true);
    }
    if (($original_fac_valor_irbpnr != $this->fac_valor_irbpnr || (isset($bFlagRead_fac_valor_irbpnr) && $bFlagRead_fac_valor_irbpnr)))
    {
        $this->ajax_return_values_fac_valor_irbpnr(true);
    }
    if (($original_fac_valor_iva != $this->fac_valor_iva || (isset($bFlagRead_fac_valor_iva) && $bFlagRead_fac_valor_iva)))
    {
...
$_SESSION['scriptcase']['form_del_punto_venta']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['fac_estado_sri'] = $this->fac_estado_sri;
      $NM_val_form['fac_error_sri'] = $this->fac_error_sri;
      ...
      $NM_val_form['fac_establecimiento'] = $this->fac_establecimiento;
      $NM_val_form['fac_punto_emision'] = $this->fac_punto_emision;
      $NM_val_form['fac_ambiente'] = $this->fac_ambiente;
      ...
      $NM_val_form['fac_propina'] = $this->fac_propina;
      $NM_val_form['fac_total'] = $this->fac_total;
      $NM_val_form['fac_estado'] = $this->fac_estado;
      $NM_val_form['fac_fecha_autorizacion'] = $this->fac_fecha_autorizacion;
      $NM_val_form['fac_autorizacion'] = $this->fac_autorizacion;
      $NM_val_form['fac_usuario'] = $this->fac_usuario;
      $NM_val_form['fac_clave'] = $this->fac_clave;
      $NM_val_form['fac_retencion'] = $this->fac_retencion;
      $NM_val_form['fac_fecha'] = $this->fac_fecha;
      $NM_val_form['fac_libretin'] = $this->fac_libretin;
      $NM_val_form['secuencial'] = $this->secuencial;
      $NM_val_form['fac_moneda'] = $this->fac_moneda;
      $NM_val_form['fac_serie_guia'] = $this->fac_serie_guia;
      $NM_val_form['fac_secuencial'] = $this->fac_secuencial;
      $NM_val_form['productos'] = $this->productos;
      $NM_val_form['detalle'] = $this->detalle;
      $NM_val_form['fac_cliente'] = $this->fac_cliente;
      $NM_val_form['ruc'] = $this->ruc;
      $NM_val_form['fac_tipo_identificacion'] = $this->fac_tipo_identificacion;
      $NM_val_form['fac_nombre_cliente'] = $this->fac_nombre_cliente;
      $NM_val_form['fac_provincia_cliente'] = $this->fac_provincia_cliente;
      $NM_val_form['fac_canton_cliente'] = $this->fac_canton_cliente;
      $NM_val_form['fac_direccion_cliente'] = $this->fac_direccion_cliente;
      $NM_val_form['fac_email_cliente'] = $this->fac_email_cliente;
      $NM_val_form['fac_telefono_cliente'] = $this->fac_telefono_cliente;
      $NM_val_form['fac_aplica_propina'] = $this->fac_aplica_propina;
      $NM_val_form['fac_diagnostico'] = $this->fac_diagnostico;
      $NM_val_form['fac_comentario'] = $this->fac_comentario;
      $NM_val_form['forma_pago'] = $this->forma_pago;
      $NM_val_form['fac_tomado'] = $this->fac_tomado;
      $NM_val_form['fac_total_subsidio'] = $this->fac_total_subsidio;
      if ($this->fac_numero === "" || is_null($this->fac_numero))  
      { 
          $this->fac_numero = 0;
      } 
      ...
      if ($this->fac_cliente === "" || is_null($this->fac_cliente))  
      { 
          $this->fac_cliente = 0;
          $this->sc_force_zero[] = 'fac_cliente';
      } 
      if ($this->fac_ambiente === "" || is_null($this->fac_ambiente))  
      { 
          $this->fac_ambiente = 0;
      ...
      if ($this->fac_libretin === "" || is_null($this->fac_libretin))  
      { 
          $this->fac_libretin = 0;
          $this->sc_force_zero[] = 'fac_libretin';
      } 
      if ($this->fac_retencion === "" || is_null($this->fac_retencion))  
      { 
          $this->fac_retencion = 0;
      ...
      if ($this->fac_diagnostico === "" || is_null($this->fac_diagnostico))  
      { 
          $this->fac_diagnostico = 0;
          $this->sc_force_zero[] = 'fac_diagnostico';
      } 
      if ($this->fac_total_subsidio === "" || is_null($this->fac_total_subsidio))  
      { 
          $this->fac_total_subsidio = 0;
          $this->sc_force_zero[] = 'fac_total_subsidio';
      } 
      $nm_bases_lob_geral = array_merge($this->Ini->nm_bases_oracle, $this->Ini->nm_bases_ibase, $this->Ini->nm_bases_informix, $this->Ini->nm_bases_mysql, $this->Ini->nm_bases_access, $this->Ini->nm_bases_sqlite, array('pdo_ibm'), array('pdo_sqlsrv'));
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          $this->fac_tipo_libretin_before_qstr = $this->fac_tipo_libretin;
          $this->fac_tipo_libretin = substr($this->Db->qstr($this->fac_tipo_libretin), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->fac_tipo_libretin = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->fac_tipo_libretin);
          }
          if ($this->fac_tipo_libretin == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->fac_tipo_libretin = "null"; 
              $NM_val_null[] = "fac_tipo_libretin";
          } 
          ...
          $this->fac_estado_sri_before_qstr = $this->fac_estado_sri;
          $this->fac_estado_sri = substr($this->Db->qstr($this->fac_estado_sri), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->fac_estado_sri = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->fac_estado_sri);
          }
          if ($this->fac_estado_sri == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->fac_estado_sri = "null"; 
              $NM_val_null[] = "fac_estado_sri";
          } 
          $this->fac_error_sri_before_qstr = $this->fac_error_sri;
          $this->fac_error_sri = substr($this->Db->qstr($this->fac_error_sri), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->fac_error_sri = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->fac_error_sri);
          }
          if ($this->fac_error_sri == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->fac_error_sri = "null"; 
              $NM_val_null[] = "fac_error_sri";
          } 
          $this->fac_fecha_autorizacion_before_qstr = $this->fac_fecha_autorizacion;
          $this->fac_fecha_autorizacion = substr($this->Db->qstr($this->fac_fecha_autorizacion), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->fac_fecha_autorizacion = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->fac_fecha_autorizacion);
          }
          if ($this->fac_fecha_autorizacion == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->fac_fecha_autorizacion = "null"; 
              $NM_val_null[] = "fac_fecha_autorizacion";
          } 
          $this->fac_autorizacion_before_qstr = $this->fac_autorizacion;
          $this->fac_autorizacion = substr($this->Db->qstr($this->fac_autorizacion), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->fac_autorizacion = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->fac_autorizacion);
          }
          if ($this->fac_autorizacion == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->fac_autorizacion = "null"; 
              $NM_val_null[] = "fac_autorizacion";
          } 
          ...
          $this->fac_serie_guia_before_qstr = $this->fac_serie_guia;
          $this->fac_serie_guia = substr($this->Db->qstr($this->fac_serie_guia), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->fac_serie_guia = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->fac_serie_guia);
          }
          if ($this->fac_serie_guia == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->fac_serie_guia = "null"; 
              $NM_val_null[] = "fac_serie_guia";
          } 
          ...
          $this->fac_aplica_propina_before_qstr = $this->fac_aplica_propina;
          $this->fac_aplica_propina = substr($this->Db->qstr($this->fac_aplica_propina), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->fac_aplica_propina = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->fac_aplica_propina);
          }
          if ($this->fac_aplica_propina == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->fac_aplica_propina = "null"; 
              $NM_val_null[] = "fac_aplica_propina";
          } 
          $this->fac_clave_before_qstr = $this->fac_clave;
          $this->fac_clave = substr($this->Db->qstr($this->fac_clave), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->fac_clave = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->fac_clave);
          }
          if ($this->fac_clave == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->fac_clave = "null"; 
              $NM_val_null[] = "fac_clave";
          } 
          $this->fac_moneda_before_qstr = $this->fac_moneda;
          $this->fac_moneda = substr($this->Db->qstr($this->fac_moneda), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->fac_moneda = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->fac_moneda);
          }
          if ($this->fac_moneda == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->fac_moneda = "null"; 
              $NM_val_null[] = "fac_moneda";
          } 
          $this->fac_tomado_before_qstr = $this->fac_tomado;
          $this->fac_tomado = substr($this->Db->qstr($this->fac_tomado), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->fac_tomado = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->fac_tomado);
          }
          if ($this->fac_tomado == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->fac_tomado = "null"; 
              $NM_val_null[] = "fac_tomado";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "fac_tipo_comprobante = '$this->fac_tipo_comprobante', fac_empresa = '$this->fac_empresa', fac_establecimiento = $this->fac_establecimiento, fac_punto_emision = $this->fac_punto_emision, fac_secuencial = $this->fac_secuencial, fac_cliente = $this->fac_cliente, fac_fecha = #$this->fac_fecha#, fac_ambiente = $this->fac_ambiente, fac_tipo_libretin = '$this->fac_tipo_libretin', fac_subtotal_iva = $this->fac_subtotal_iva, fac_subtotal_cero = $this->fac_subtotal_cero, fac_subtotal_no_objeto = $this->fac_subtotal_no_objeto, fac_subtotal_excento = $this->fac_subtotal_excento, fac_subtotal = $this->fac_subtotal, fac_total_descuento = $this->fac_total_descuento, fac_valor_ice = $this->fac_valor_ice, fac_valor_iva = $this->fac_valor_iva, fac_valor_irbpnr = $this->fac_valor_irbpnr, fac_propina = $this->fac_propina, fac_total = $this->fac_total, fac_estado = '$this->fac_estado', fac_estado_sri = '$this->fac_estado_sri', fac_error_sri = '$this->fac_error_sri', fac_fecha_autorizacion = '$this->fac_fecha_autorizacion', fac_autorizacion = '$this->fac_autorizacion', fac_usuario = '$this->fac_usuario', fac_serie_guia = '$this->fac_serie_guia', fac_comentario = '$this->fac_comentario', fac_aplica_propina = '$this->fac_aplica_propina', fac_libretin = $this->fac_libretin, fac_clave = '$this->fac_clave', fac_retencion = $this->fac_retencion, fac_diagnostico = $this->fac_diagnostico, fac_moneda = '$this->fac_moneda'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "fac_tipo_comprobante = '$this->fac_tipo_comprobante', fac_empresa = '$this->fac_empresa', fac_establecimiento = $this->fac_establecimiento, fac_punto_emision = $this->fac_punto_emision, fac_secuencial = $this->fac_secuencial, fac_cliente = $this->fac_cliente, fac_fecha = " . $this->Ini->date_delim . $this->fac_fecha . $this->Ini->date_delim1 . ", fac_ambiente = $this->fac_ambiente, fac_tipo_libretin = '$this->fac_tipo_libretin', fac_subtotal_iva = $this->fac_subtotal_iva, fac_subtotal_cero = $this->fac_subtotal_cero, fac_subtotal_no_objeto = $this->fac_subtotal_no_objeto, fac_subtotal_excento = $this->fac_subtotal_excento, fac_subtotal = $this->fac_subtotal, fac_total_descuento = $this->fac_total_descuento, fac_valor_ice = $this->fac_valor_ice, fac_valor_iva = $this->fac_valor_iva, fac_valor_irbpnr = $this->fac_valor_irbpnr, fac_propina = $this->fac_propina, fac_total = $this->fac_total, fac_estado = '$this->fac_estado', fac_estado_sri = '$this->fac_estado_sri', fac_error_sri = '$this->fac_error_sri', fac_fecha_autorizacion = '$this->fac_fecha_autorizacion', fac_autorizacion = '$this->fac_autorizacion', fac_usuario = '$this->fac_usuario', fac_serie_guia = '$this->fac_serie_guia', fac_comentario = '$this->fac_comentario', fac_aplica_propina = '$this->fac_aplica_propina', fac_libretin = $this->fac_libretin, fac_clave = '$this->fac_clave', fac_retencion = $this->fac_retencion, fac_diagnostico = $this->fac_diagnostico, fac_moneda = '$this->fac_moneda'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "fac_tipo_comprobante = '$this->fac_tipo_comprobante', fac_empresa = '$this->fac_empresa', fac_establecimiento = $this->fac_establecimiento, fac_punto_emision = $this->fac_punto_emision, fac_secuencial = $this->fac_secuencial, fac_cliente = $this->fac_cliente, fac_fecha = EXTEND('$this->fac_fecha', YEAR TO DAY), fac_ambiente = $this->fac_ambiente, fac_tipo_libretin = '$this->fac_tipo_libretin', fac_subtotal_iva = $this->fac_subtotal_iva, fac_subtotal_cero = $this->fac_subtotal_cero, fac_subtotal_no_objeto = $this->fac_subtotal_no_objeto, fac_subtotal_excento = $this->fac_subtotal_excento, fac_subtotal = $this->fac_subtotal, fac_total_descuento = $this->fac_total_descuento, fac_valor_ice = $this->fac_valor_ice, fac_valor_iva = $this->fac_valor_iva, fac_valor_irbpnr = $this->fac_valor_irbpnr, fac_propina = $this->fac_propina, fac_total = $this->fac_total, fac_estado = '$this->fac_estado', fac_estado_sri = '$this->fac_estado_sri', fac_error_sri = '$this->fac_error_sri', fac_fecha_autorizacion = '$this->fac_fecha_autorizacion', fac_autorizacion = '$this->fac_autorizacion', fac_usuario = '$this->fac_usuario', fac_serie_guia = '$this->fac_serie_guia', fac_comentario = '$this->fac_comentario', fac_aplica_propina = '$this->fac_aplica_propina', fac_libretin = $this->fac_libretin, fac_clave = '$this->fac_clave', fac_retencion = $this->fac_retencion, fac_diagnostico = $this->fac_diagnostico, fac_moneda = '$this->fac_moneda'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['fac_tomado']) && $NM_val_form['fac_tomado'] != $this->nmgp_dados_select['fac_tomado']) 
              { 
                  $SC_fields_update[] = "fac_tomado = '$this->fac_tomado'"; 
              } 
              if (isset($NM_val_form['fac_total_subsidio']) && $NM_val_form['fac_total_subsidio'] != $this->nmgp_dados_select['fac_total_subsidio']) 
              { 
                  $SC_fields_update[] = "fac_total_subsidio = $this->fac_total_subsidio"; 
              } 
              ...
              $this->fac_tipo_libretin = $this->fac_tipo_libretin_before_qstr;
              $this->fac_estado = $this->fac_estado_before_qstr;
              $this->fac_estado_sri = $this->fac_estado_sri_before_qstr;
              $this->fac_error_sri = $this->fac_error_sri_before_qstr;
              $this->fac_fecha_autorizacion = $this->fac_fecha_autorizacion_before_qstr;
              $this->fac_autorizacion = $this->fac_autorizacion_before_qstr;
              $this->fac_usuario = $this->fac_usuario_before_qstr;
              $this->fac_serie_guia = $this->fac_serie_guia_before_qstr;
              $this->fac_comentario = $this->fac_comentario_before_qstr;
              $this->fac_aplica_propina = $this->fac_aplica_propina_before_qstr;
              $this->fac_clave = $this->fac_clave_before_qstr;
              $this->fac_moneda = $this->fac_moneda_before_qstr;
              $this->fac_tomado = $this->fac_tomado_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['fac_empresa'])) { $this->fac_empresa = $NM_val_form['fac_empresa']; }
              elseif (isset($this->fac_empresa)) { $this->nm_limpa_alfa($this->fac_empresa); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_establecimiento'])) { $this->fac_establecimiento = $NM_val_form['fac_establecimiento']; }
              elseif (isset($this->fac_establecimiento)) { $this->nm_limpa_alfa($this->fac_establecimiento); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_punto_emision'])) { $this->fac_punto_emision = $NM_val_form['fac_punto_emision']; }
              elseif (isset($this->fac_punto_emision)) { $this->nm_limpa_alfa($this->fac_punto_emision); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_secuencial'])) { $this->fac_secuencial = $NM_val_form['fac_secuencial']; }
              elseif (isset($this->fac_secuencial)) { $this->nm_limpa_alfa($this->fac_secuencial); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_cliente'])) { $this->fac_cliente = $NM_val_form['fac_cliente']; }
              elseif (isset($this->fac_cliente)) { $this->nm_limpa_alfa($this->fac_cliente); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_ambiente'])) { $this->fac_ambiente = $NM_val_form['fac_ambiente']; }
              elseif (isset($this->fac_ambiente)) { $this->nm_limpa_alfa($this->fac_ambiente); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_tipo_libretin'])) { $this->fac_tipo_libretin = $NM_val_form['fac_tipo_libretin']; }
              elseif (isset($this->fac_tipo_libretin)) { $this->nm_limpa_alfa($this->fac_tipo_libretin); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['fac_propina'])) { $this->fac_propina = $NM_val_form['fac_propina']; }
              elseif (isset($this->fac_propina)) { $this->nm_limpa_alfa($this->fac_propina); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['fac_estado_sri'])) { $this->fac_estado_sri = $NM_val_form['fac_estado_sri']; }
              elseif (isset($this->fac_estado_sri)) { $this->nm_limpa_alfa($this->fac_estado_sri); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_error_sri'])) { $this->fac_error_sri = $NM_val_form['fac_error_sri']; }
              elseif (isset($this->fac_error_sri)) { $this->nm_limpa_alfa($this->fac_error_sri); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_fecha_autorizacion'])) { $this->fac_fecha_autorizacion = $NM_val_form['fac_fecha_autorizacion']; }
              elseif (isset($this->fac_fecha_autorizacion)) { $this->nm_limpa_alfa($this->fac_fecha_autorizacion); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_autorizacion'])) { $this->fac_autorizacion = $NM_val_form['fac_autorizacion']; }
              elseif (isset($this->fac_autorizacion)) { $this->nm_limpa_alfa($this->fac_autorizacion); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_usuario'])) { $this->fac_usuario = $NM_val_form['fac_usuario']; }
              elseif (isset($this->fac_usuario)) { $this->nm_limpa_alfa($this->fac_usuario); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_serie_guia'])) { $this->fac_serie_guia = $NM_val_form['fac_serie_guia']; }
              elseif (isset($this->fac_serie_guia)) { $this->nm_limpa_alfa($this->fac_serie_guia); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['fac_aplica_propina'])) { $this->fac_aplica_propina = $NM_val_form['fac_aplica_propina']; }
              elseif (isset($this->fac_aplica_propina)) { $this->nm_limpa_alfa($this->fac_aplica_propina); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_libretin'])) { $this->fac_libretin = $NM_val_form['fac_libretin']; }
              elseif (isset($this->fac_libretin)) { $this->nm_limpa_alfa($this->fac_libretin); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_clave'])) { $this->fac_clave = $NM_val_form['fac_clave']; }
              elseif (isset($this->fac_clave)) { $this->nm_limpa_alfa($this->fac_clave); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_retencion'])) { $this->fac_retencion = $NM_val_form['fac_retencion']; }
              elseif (isset($this->fac_retencion)) { $this->nm_limpa_alfa($this->fac_retencion); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_diagnostico'])) { $this->fac_diagnostico = $NM_val_form['fac_diagnostico']; }
              elseif (isset($this->fac_diagnostico)) { $this->nm_limpa_alfa($this->fac_diagnostico); }
              if     (isset($NM_val_form) && isset($NM_val_form['fac_moneda'])) { $this->fac_moneda = $NM_val_form['fac_moneda']; }
              elseif (isset($this->fac_moneda)) { $this->nm_limpa_alfa($this->fac_moneda); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('titulo', 'fac_estado_sri', 'fac_error_sri', 'fac_numero', 'fac_tipo_comprobante', 'fac_empresa', 'fac_establecimiento', 'fac_punto_emision', 'fac_ambiente', 'fac_tipo_libretin', 'fac_subtotal_iva', 'fac_subtotal_cero', 'fac_subtotal_no_objeto', 'fac_subtotal_excento', 'fac_subtotal', 'fac_total_descuento', 'fac_valor_ice', 'fac_valor_iva', 'fac_valor_irbpnr', 'fac_propina', 'fac_total', 'fac_estado', 'fac_fecha_autorizacion', 'fac_autorizacion', 'fac_usuario', 'fac_clave', 'fac_retencion', 'fac_fecha', 'fac_libretin', 'secuencial', 'fac_moneda', 'fac_serie_guia', 'fac_secuencial', 'productos', 'detalle', 'fac_cliente', 'ruc', 'fac_tipo_identificacion', 'fac_nombre_cliente', 'fac_provincia_cliente', 'fac_canton_cliente', 'fac_direccion_cliente', 'fac_email_cliente', 'fac_telefono_cliente', 'fac_aplica_propina', 'fac_diagnostico', 'fac_comentario', 'forma_pago'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_secuencial, fac_cliente, fac_fecha, fac_ambiente, fac_tipo_libretin, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_estado_sri, fac_error_sri, fac_fecha_autorizacion, fac_autorizacion, fac_usuario, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_libretin, fac_clave, fac_retencion, fac_diagnostico, fac_moneda, fac_tomado, fac_total_subsidio) VALUES ($this->fac_numero, '$this->fac_tipo_comprobante', '$this->fac_empresa', $this->fac_establecimiento, $this->fac_punto_emision, $this->fac_secuencial, $this->fac_cliente, #$this->fac_fecha#, $this->fac_ambiente, '$this->fac_tipo_libretin', $this->fac_subtotal_iva, $this->fac_subtotal_cero, $this->fac_subtotal_no_objeto, $this->fac_subtotal_excento, $this->fac_subtotal, $this->fac_total_descuento, $this->fac_valor_ice, $this->fac_valor_iva, $this->fac_valor_irbpnr, $this->fac_propina, $this->fac_total, '$this->fac_estado', '$this->fac_estado_sri', '$this->fac_error_sri', '$this->fac_fecha_autorizacion', '$this->fac_autorizacion', '$this->fac_usuario', '$this->fac_serie_guia', '$this->fac_comentario', '$this->fac_aplica_propina', $this->fac_libretin, '$this->fac_clave', $this->fac_retencion, $this->fac_diagnostico, '$this->fac_moneda', '$this->fac_tomado', $this->fac_total_subsidio)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_secuencial, fac_cliente, fac_fecha, fac_ambiente, fac_tipo_libretin, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_estado_sri, fac_error_sri, fac_fecha_autorizacion, fac_autorizacion, fac_usuario, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_libretin, fac_clave, fac_retencion, fac_diagnostico, fac_moneda, fac_tomado, fac_total_subsidio) VALUES (" . $NM_seq_auto . "$this->fac_numero, '$this->fac_tipo_comprobante', '$this->fac_empresa', $this->fac_establecimiento, $this->fac_punto_emision, $this->fac_secuencial, $this->fac_cliente, " . $this->Ini->date_delim . $this->fac_fecha . $this->Ini->date_delim1 . ", $this->fac_ambiente, '$this->fac_tipo_libretin', $this->fac_subtotal_iva, $this->fac_subtotal_cero, $this->fac_subtotal_no_objeto, $this->fac_subtotal_excento, $this->fac_subtotal, $this->fac_total_descuento, $this->fac_valor_ice, $this->fac_valor_iva, $this->fac_valor_irbpnr, $this->fac_propina, $this->fac_total, '$this->fac_estado', '$this->fac_estado_sri', '$this->fac_error_sri', '$this->fac_fecha_autorizacion', '$this->fac_autorizacion', '$this->fac_usuario', '$this->fac_serie_guia', '$this->fac_comentario', '$this->fac_aplica_propina', $this->fac_libretin, '$this->fac_clave', $this->fac_retencion, $this->fac_diagnostico, '$this->fac_moneda', '$this->fac_tomado', $this->fac_total_subsidio)"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_secuencial, fac_cliente, fac_fecha, fac_ambiente, fac_tipo_libretin, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_estado_sri, fac_error_sri, fac_fecha_autorizacion, fac_autorizacion, fac_usuario, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_libretin, fac_clave, fac_retencion, fac_diagnostico, fac_moneda, fac_tomado, fac_total_subsidio) VALUES (" . $NM_seq_auto . "$this->fac_numero, '$this->fac_tipo_comprobante', '$this->fac_empresa', $this->fac_establecimiento, $this->fac_punto_emision, $this->fac_secuencial, $this->fac_cliente, EXTEND('$this->fac_fecha', YEAR TO DAY), $this->fac_ambiente, '$this->fac_tipo_libretin', $this->fac_subtotal_iva, $this->fac_subtotal_cero, $this->fac_subtotal_no_objeto, $this->fac_subtotal_excento, $this->fac_subtotal, $this->fac_total_descuento, $this->fac_valor_ice, $this->fac_valor_iva, $this->fac_valor_irbpnr, $this->fac_propina, $this->fac_total, '$this->fac_estado', '$this->fac_estado_sri', '$this->fac_error_sri', '$this->fac_fecha_autorizacion', '$this->fac_autorizacion', '$this->fac_usuario', '$this->fac_serie_guia', '$this->fac_comentario', '$this->fac_aplica_propina', $this->fac_libretin, '$this->fac_clave', $this->fac_retencion, $this->fac_diagnostico, '$this->fac_moneda', '$this->fac_tomado', $this->fac_total_subsidio)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_secuencial, fac_cliente, fac_fecha, fac_ambiente, fac_tipo_libretin, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_estado_sri, fac_error_sri, fac_fecha_autorizacion, fac_autorizacion, fac_usuario, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_libretin, fac_clave, fac_retencion, fac_diagnostico, fac_moneda, fac_tomado, fac_total_subsidio) VALUES (" . $NM_seq_auto . "$this->fac_numero, '$this->fac_tipo_comprobante', '$this->fac_empresa', $this->fac_establecimiento, $this->fac_punto_emision, $this->fac_secuencial, $this->fac_cliente, " . $this->Ini->date_delim . $this->fac_fecha . $this->Ini->date_delim1 . ", $this->fac_ambiente, '$this->fac_tipo_libretin', $this->fac_subtotal_iva, $this->fac_subtotal_cero, $this->fac_subtotal_no_objeto, $this->fac_subtotal_excento, $this->fac_subtotal, $this->fac_total_descuento, $this->fac_valor_ice, $this->fac_valor_iva, $this->fac_valor_irbpnr, $this->fac_propina, $this->fac_total, '$this->fac_estado', '$this->fac_estado_sri', '$this->fac_error_sri', '$this->fac_fecha_autorizacion', '$this->fac_autorizacion', '$this->fac_usuario', '$this->fac_serie_guia', '$this->fac_comentario', '$this->fac_aplica_propina', $this->fac_libretin, '$this->fac_clave', $this->fac_retencion, $this->fac_diagnostico, '$this->fac_moneda', '$this->fac_tomado', $this->fac_total_subsidio)"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              $sDetailWhere = "fp_factura = " . $this->fac_numero . "";
              $this->form_del_forma_pago_factura->ini_controle();
              if ($this->form_del_forma_pago_factura->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['reg_start'] = 0; 
              }
...
if (!isset($this->sc_temp_var_procesar)) {$this->sc_temp_var_procesar = (isset($_SESSION['var_procesar'])) ? $_SESSION['var_procesar'] : "";}
  if($this->sc_temp_var_procesar==true){
	if($this->fac_estado =='R'){
		$check_sql = "SELECT sp_del_secuencial_documento (".$this->fac_libretin .",'01',".$this->fac_numero .")";
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_del_punto_venta';
				...
				if (isset($this->Campos_Mens_erro) && !empty($this->Campos_Mens_erro))
{
 ...
 if (isset($this->sc_temp_Igtech_AutorizacionInmediata)) { $_SESSION['Igtech_AutorizacionInmediata'] = $this->sc_temp_Igtech_AutorizacionInmediata;}
    if ($this->NM_ajax_flag)
    {
        $this->NM_ajax_info['redirExit']['action'] = "form_del_punto_venta_fim.php?script_case_init=" . $this->form_encode_input($this->Ini->sc_page);
        $this->NM_ajax_info['redirExit']['metodo'] = 'location';
        $this->NM_ajax_info['redirExit']['target'] = "_self";
        $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $this->Ini->path_link . "" . SC_dir_app_name('form_del_factura') . "/";
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_outra_jan'])
        {
            $_SESSION['scriptcase']['sc_outra_jan'] = "form_del_punto_venta";
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_outra_jan'] = false;
        }
        $_SESSION['scriptcase']['form_del_punto_venta']['contr_erro'] = 'off';
        form_del_punto_venta_pack_ajax_response();
        exit;
...
<table align="center"><tr><td>
  <form name="Fexit" method=post
        action="form_del_punto_venta_fim.php"
        target="_self">
    <input type=hidden name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page) ?>">
...
<?php
   exit;
		...
		$registra_kardex="SELECT sp_ventas_al_kardex(".$this->fac_numero .");";
	...
	if($this->fac_tipo_libretin =='E' and $this->fac_estado_sri <>'AUTORIZADO'){
		$this->sc_temp_var_mensaje=$this->autorizar_factura($this->fac_numero ,$this->sc_temp_Igtech_AutorizacionInmediata);
...
$_SESSION['scriptcase']['form_del_punto_venta']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['parms'] = "fac_numero?#?$this->fac_numero?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          { 
              $nmgp_select = "SELECT fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_secuencial, fac_cliente, str_replace (convert(char(10),fac_fecha,102), '.', '-') + ' ' + convert(char(8),fac_fecha,20), fac_ambiente, fac_tipo_libretin, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_estado_sri, fac_error_sri, fac_fecha_autorizacion, fac_autorizacion, fac_usuario, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_libretin, fac_clave, fac_retencion, fac_diagnostico, fac_moneda, fac_tomado, fac_total_subsidio from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_secuencial, fac_cliente, convert(char(23),fac_fecha,121), fac_ambiente, fac_tipo_libretin, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_estado_sri, fac_error_sri, fac_fecha_autorizacion, fac_autorizacion, fac_usuario, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_libretin, fac_clave, fac_retencion, fac_diagnostico, fac_moneda, fac_tomado, fac_total_subsidio from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_secuencial, fac_cliente, fac_fecha, fac_ambiente, fac_tipo_libretin, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_estado_sri, fac_error_sri, fac_fecha_autorizacion, fac_autorizacion, fac_usuario, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_libretin, fac_clave, fac_retencion, fac_diagnostico, fac_moneda, fac_tomado, fac_total_subsidio from " . $this->Ini->nm_tabela ; 
          ...
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_secuencial, fac_cliente, EXTEND(fac_fecha, YEAR TO DAY), fac_ambiente, fac_tipo_libretin, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_estado_sri, fac_error_sri, fac_fecha_autorizacion, fac_autorizacion, fac_usuario, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_libretin, fac_clave, fac_retencion, fac_diagnostico, fac_moneda, fac_tomado, fac_total_subsidio from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_secuencial, fac_cliente, fac_fecha, fac_ambiente, fac_tipo_libretin, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_estado_sri, fac_error_sri, fac_fecha_autorizacion, fac_autorizacion, fac_usuario, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_libretin, fac_clave, fac_retencion, fac_diagnostico, fac_moneda, fac_tomado, fac_total_subsidio from " . $this->Ini->nm_tabela ; 
          ...
          $aWhere = array();
          $aWhere[] = "(fac_numero=" . $_SESSION['var_id_factura'] . ")";
          $aWhere[] = $sc_where_filter;
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (!empty($sc_where))
              {
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['bauchert'] = $this->nmgp_botoes['bauchert'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->fac_empresa = $rs->fields[2] ; 
              $this->nmgp_dados_select['fac_empresa'] = $this->fac_empresa;
              $this->fac_establecimiento = $rs->fields[3] ; 
              $this->nmgp_dados_select['fac_establecimiento'] = $this->fac_establecimiento;
              $this->fac_punto_emision = $rs->fields[4] ; 
              $this->nmgp_dados_select['fac_punto_emision'] = $this->fac_punto_emision;
              $this->fac_secuencial = $rs->fields[5] ; 
              $this->nmgp_dados_select['fac_secuencial'] = $this->fac_secuencial;
              $this->fac_cliente = $rs->fields[6] ; 
              $this->nmgp_dados_select['fac_cliente'] = $this->fac_cliente;
              $this->fac_fecha = $rs->fields[7] ; 
              $this->nmgp_dados_select['fac_fecha'] = $this->fac_fecha;
              $this->fac_ambiente = $rs->fields[8] ; 
              $this->nmgp_dados_select['fac_ambiente'] = $this->fac_ambiente;
              $this->fac_tipo_libretin = $rs->fields[9] ; 
              $this->nmgp_dados_select['fac_tipo_libretin'] = $this->fac_tipo_libretin;
              $this->fac_subtotal_iva = $rs->fields[10] ; 
              $this->nmgp_dados_select['fac_subtotal_iva'] = $this->fac_subtotal_iva;
              $this->fac_subtotal_cero = $rs->fields[11] ; 
              $this->nmgp_dados_select['fac_subtotal_cero'] = $this->fac_subtotal_cero;
              $this->fac_subtotal_no_objeto = $rs->fields[12] ; 
              $this->nmgp_dados_select['fac_subtotal_no_objeto'] = $this->fac_subtotal_no_objeto;
              $this->fac_subtotal_excento = $rs->fields[13] ; 
              $this->nmgp_dados_select['fac_subtotal_excento'] = $this->fac_subtotal_excento;
              $this->fac_subtotal = $rs->fields[14] ; 
              $this->nmgp_dados_select['fac_subtotal'] = $this->fac_subtotal;
              $this->fac_total_descuento = $rs->fields[15] ; 
              ...
              $this->fac_valor_iva = $rs->fields[17] ; 
              ...
              $this->fac_propina = $rs->fields[19] ; 
              $this->nmgp_dados_select['fac_propina'] = $this->fac_propina;
              $this->fac_total = $rs->fields[20] ; 
              $this->nmgp_dados_select['fac_total'] = $this->fac_total;
              $this->fac_estado = $rs->fields[21] ; 
              $this->nmgp_dados_select['fac_estado'] = $this->fac_estado;
              $this->fac_estado_sri = $rs->fields[22] ; 
              $this->nmgp_dados_select['fac_estado_sri'] = $this->fac_estado_sri;
              $this->fac_error_sri = $rs->fields[23] ; 
              $this->nmgp_dados_select['fac_error_sri'] = $this->fac_error_sri;
              $this->fac_fecha_autorizacion = $rs->fields[24] ; 
              $this->nmgp_dados_select['fac_fecha_autorizacion'] = $this->fac_fecha_autorizacion;
              $this->fac_autorizacion = $rs->fields[25] ; 
              $this->nmgp_dados_select['fac_autorizacion'] = $this->fac_autorizacion;
              $this->fac_usuario = $rs->fields[26] ; 
              $this->nmgp_dados_select['fac_usuario'] = $this->fac_usuario;
              $this->fac_serie_guia = $rs->fields[27] ; 
              $this->nmgp_dados_select['fac_serie_guia'] = $this->fac_serie_guia;
              $this->fac_comentario = $rs->fields[28] ; 
              $this->nmgp_dados_select['fac_comentario'] = $this->fac_comentario;
              $this->fac_aplica_propina = $rs->fields[29] ; 
              $this->nmgp_dados_select['fac_aplica_propina'] = $this->fac_aplica_propina;
              $this->fac_libretin = $rs->fields[30] ; 
              $this->nmgp_dados_select['fac_libretin'] = $this->fac_libretin;
              $this->fac_clave = $rs->fields[31] ; 
              $this->nmgp_dados_select['fac_clave'] = $this->fac_clave;
              $this->fac_retencion = $rs->fields[32] ; 
              $this->nmgp_dados_select['fac_retencion'] = $this->fac_retencion;
              $this->fac_diagnostico = $rs->fields[33] ; 
              $this->nmgp_dados_select['fac_diagnostico'] = $this->fac_diagnostico;
              $this->fac_moneda = $rs->fields[34] ; 
              $this->nmgp_dados_select['fac_moneda'] = $this->fac_moneda;
              $this->fac_tomado = $rs->fields[35] ; 
              $this->nmgp_dados_select['fac_tomado'] = $this->fac_tomado;
              $this->fac_total_subsidio = $rs->fields[36] ; 
              $this->nmgp_dados_select['fac_total_subsidio'] = $this->fac_total_subsidio;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->nm_troca_decimal(",", ".");
              $this->fac_numero = (string)$this->fac_numero; 
              $this->fac_establecimiento = (string)$this->fac_establecimiento; 
              $this->fac_punto_emision = (string)$this->fac_punto_emision; 
              $this->fac_secuencial = (string)$this->fac_secuencial; 
              $this->fac_cliente = (string)$this->fac_cliente; 
              $this->fac_ambiente = (string)$this->fac_ambiente; 
              ...
              $this->fac_libretin = (string)$this->fac_libretin; 
              $this->fac_retencion = (string)$this->fac_retencion; 
              $this->fac_diagnostico = (string)$this->fac_diagnostico; 
              $this->fac_total_subsidio = (string)$this->fac_total_subsidio; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['parms'] = "fac_numero?#?$this->fac_numero?@?";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['reg_start'] < $qt_geral_reg_form_del_punto_venta;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              $this->fac_numero = "";  
              $this->nmgp_dados_form["fac_numero"] = $this->fac_numero;
              $this->fac_tipo_comprobante = "01";  
              $this->nmgp_dados_form["fac_tipo_comprobante"] = $this->fac_tipo_comprobante;
              $this->fac_empresa = "" . $_SESSION['Igtech_RucEmpresa'] . "";  
              $this->nmgp_dados_form["fac_empresa"] = $this->fac_empresa;
              $this->fac_establecimiento = "";  
              $this->nmgp_dados_form["fac_establecimiento"] = $this->fac_establecimiento;
              $this->fac_punto_emision = "";  
              $this->nmgp_dados_form["fac_punto_emision"] = $this->fac_punto_emision;
              $this->fac_secuencial = "";  
              $this->nmgp_dados_form["fac_secuencial"] = $this->fac_secuencial;
              $this->fac_cliente = "";  
              ...
              $this->fac_retencion = "";  
              $this->nmgp_dados_form["fac_retencion"] = $this->fac_retencion;
              $this->fac_diagnostico = "";  
              $this->nmgp_dados_form["fac_diagnostico"] = $this->fac_diagnostico;
              $this->fac_moneda = "DOLAR";  
              $this->nmgp_dados_form["fac_moneda"] = $this->fac_moneda;
              $this->fac_tomado = "";  
              $this->nmgp_dados_form["fac_tomado"] = $this->fac_tomado;
              $this->fac_total_subsidio = "";  
              $this->nmgp_dados_form["fac_total_subsidio"] = $this->fac_total_subsidio;
              $this->titulo = "";  
              $this->nmgp_dados_form["titulo"] = $this->titulo;
              ...
              $this->detalle = "";  
              $this->nmgp_dados_form["detalle"] = $this->detalle;
              $this->fac_tipo_identificacion = "";  
              $this->nmgp_dados_form["fac_tipo_identificacion"] = $this->fac_tipo_identificacion;
              $this->secuencial = "";  
              $this->nmgp_dados_form["secuencial"] = $this->secuencial;
              $this->productos = "";  
              $this->nmgp_dados_form["productos"] = $this->productos;
              $this->fac_telefono_cliente = "";  
              $this->nmgp_dados_form["fac_telefono_cliente"] = $this->fac_telefono_cliente;
              $this->fac_provincia_cliente = "IMBABURA";  
              $this->nmgp_dados_form["fac_provincia_cliente"] = $this->fac_provincia_cliente;
              $this->fac_canton_cliente = "IBARRA";  
              $this->nmgp_dados_form["fac_canton_cliente"] = $this->fac_canton_cliente;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_form'] = $this->nmgp_dados_form;
              $this->formatado = false;
          }
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['productos_venta_empresas']['embutida_parms'] = "NMSC_inicial*scininicio*scoutNMSC_paginacao*scinPARCIAL*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalle_factura']['embutida_parms'] = "var_factura*scin" . $this->nmgp_dados_form['fac_numero'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_forma_pago_factura']['embutida_parms'] = "var_factura*scin" . $this->nmgp_dados_form['fac_numero'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
// 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['dados_select'];
           ...
           $this->SC_log_arr['fields']['fac_establecimiento']['0'] =  $nmgp_dados_select['fac_establecimiento'];
           $this->SC_log_arr['fields']['fac_punto_emision']['0'] =  $nmgp_dados_select['fac_punto_emision'];
           $this->SC_log_arr['fields']['fac_secuencial']['0'] =  $nmgp_dados_select['fac_secuencial'];
           $this->SC_log_arr['fields']['fac_cliente']['0'] =  $nmgp_dados_select['fac_cliente'];
           $this->SC_log_arr['fields']['fac_fecha']['0'] =  $nmgp_dados_select['fac_fecha'];
           $this->SC_log_arr['fields']['fac_ambiente']['0'] =  $nmgp_dados_select['fac_ambiente'];
           $this->SC_log_arr['fields']['fac_tipo_libretin']['0'] =  $nmgp_dados_select['fac_tipo_libretin'];
           ...
           $this->SC_log_arr['fields']['fac_propina']['0'] =  $nmgp_dados_select['fac_propina'];
           ...
           $this->SC_log_arr['fields']['fac_estado_sri']['0'] =  $nmgp_dados_select['fac_estado_sri'];
           $this->SC_log_arr['fields']['fac_error_sri']['0'] =  $nmgp_dados_select['fac_error_sri'];
           $this->SC_log_arr['fields']['fac_fecha_autorizacion']['0'] =  $nmgp_dados_select['fac_fecha_autorizacion'];
           $this->SC_log_arr['fields']['fac_autorizacion']['0'] =  $nmgp_dados_select['fac_autorizacion'];
           $this->SC_log_arr['fields']['fac_usuario']['0'] =  $nmgp_dados_select['fac_usuario'];
           $this->SC_log_arr['fields']['fac_serie_guia']['0'] =  $nmgp_dados_select['fac_serie_guia'];
           $this->SC_log_arr['fields']['fac_comentario']['0'] =  $nmgp_dados_select['fac_comentario'];
           $this->SC_log_arr['fields']['fac_aplica_propina']['0'] =  $nmgp_dados_select['fac_aplica_propina'];
           $this->SC_log_arr['fields']['fac_libretin']['0'] =  $nmgp_dados_select['fac_libretin'];
           $this->SC_log_arr['fields']['fac_clave']['0'] =  $nmgp_dados_select['fac_clave'];
           $this->SC_log_arr['fields']['fac_retencion']['0'] =  $nmgp_dados_select['fac_retencion'];
           $this->SC_log_arr['fields']['fac_diagnostico']['0'] =  $nmgp_dados_select['fac_diagnostico'];
           $this->SC_log_arr['fields']['fac_moneda']['0'] =  $nmgp_dados_select['fac_moneda'];
           $this->SC_log_arr['fields']['fac_tomado']['0'] =  $nmgp_dados_select['fac_tomado'];
           $this->SC_log_arr['fields']['fac_total_subsidio']['0'] =  $nmgp_dados_select['fac_total_subsidio'];
...
// 
   function NM_gera_log_new() 
   {
       ...
       $this->SC_log_arr['fields']['fac_establecimiento']['1'] =  $this->fac_establecimiento;
       $this->SC_log_arr['fields']['fac_punto_emision']['1'] =  $this->fac_punto_emision;
       $this->SC_log_arr['fields']['fac_secuencial']['1'] =  $this->fac_secuencial;
       $this->SC_log_arr['fields']['fac_cliente']['1'] =  $this->fac_cliente;
       $this->SC_log_arr['fields']['fac_fecha']['1'] =  $this->fac_fecha;
       $this->SC_log_arr['fields']['fac_ambiente']['1'] =  $this->fac_ambiente;
       $this->SC_log_arr['fields']['fac_tipo_libretin']['1'] =  $this->fac_tipo_libretin;
       ...
       $this->SC_log_arr['fields']['fac_propina']['1'] =  $this->fac_propina;
       $this->SC_log_arr['fields']['fac_total']['1'] =  $this->fac_total;
       $this->SC_log_arr['fields']['fac_estado']['1'] =  $this->fac_estado;
       $this->SC_log_arr['fields']['fac_estado_sri']['1'] =  $this->fac_estado_sri;
       $this->SC_log_arr['fields']['fac_error_sri']['1'] =  $this->fac_error_sri;
       $this->SC_log_arr['fields']['fac_fecha_autorizacion']['1'] =  $this->fac_fecha_autorizacion;
       $this->SC_log_arr['fields']['fac_autorizacion']['1'] =  $this->fac_autorizacion;
       $this->SC_log_arr['fields']['fac_usuario']['1'] =  $this->fac_usuario;
       $this->SC_log_arr['fields']['fac_serie_guia']['1'] =  $this->fac_serie_guia;
       $this->SC_log_arr['fields']['fac_comentario']['1'] =  $this->fac_comentario;
       $this->SC_log_arr['fields']['fac_aplica_propina']['1'] =  $this->fac_aplica_propina;
       $this->SC_log_arr['fields']['fac_libretin']['1'] =  $this->fac_libretin;
       $this->SC_log_arr['fields']['fac_clave']['1'] =  $this->fac_clave;
       $this->SC_log_arr['fields']['fac_retencion']['1'] =  $this->fac_retencion;
       $this->SC_log_arr['fields']['fac_diagnostico']['1'] =  $this->fac_diagnostico;
       $this->SC_log_arr['fields']['fac_moneda']['1'] =  $this->fac_moneda;
       $this->SC_log_arr['fields']['fac_tomado']['1'] =  $this->fac_tomado;
       $this->SC_log_arr['fields']['fac_total_subsidio']['1'] =  $this->fac_total_subsidio;
...
// 
   function NM_gera_log_output() 
   {
       ...
       $Log_labels['fac_establecimiento'] =  "{lang_establecimiento}";
       $Log_labels['fac_punto_emision'] =  "{lang_punto_emision}";
       $Log_labels['fac_secuencial'] =  "{lang_secuencial}";
       $Log_labels['fac_cliente'] =  "{lang_cliente}";
       $Log_labels['fac_fecha'] =  "{lang_fecha}";
       $Log_labels['fac_ambiente'] =  "{lang_tipo_ambiente}";
       $Log_labels['fac_tipo_libretin'] =  "{lang_tipo_libretin}";
       ...
       $Log_labels['fac_propina'] =  "{lang_propina}";
       $Log_labels['fac_total'] =  "{lang_othr_chrt_totl}";
       $Log_labels['fac_estado'] =  "{lang_estado}";
       $Log_labels['fac_estado_sri'] =  "{lang_estado_sri}";
       $Log_labels['fac_error_sri'] =  "{lang_mensaje}";
       $Log_labels['fac_fecha_autorizacion'] =  "{lang_fecha_autorizacion}";
       $Log_labels['fac_autorizacion'] =  "{lang_autorizacion}";
       $Log_labels['fac_usuario'] =  "{lang_usuario}";
       $Log_labels['fac_serie_guia'] =  "{lang_guia_remision}";
       $Log_labels['fac_comentario'] =  "{lang_comentario}";
       $Log_labels['fac_aplica_propina'] =  "{lang_dar_propina}";
       $Log_labels['fac_libretin'] =  "{lang_serie_sri}";
       $Log_labels['fac_clave'] =  "Fac Clave";
       $Log_labels['fac_retencion'] =  "Fac Retencion";
       $Log_labels['fac_diagnostico'] =  "{lang_diagnostico}";
       $Log_labels['fac_moneda'] =  "{lang_moneda}";
       $Log_labels['fac_tomado'] =  "Fac Tomado";
       $Log_labels['fac_total_subsidio'] =  "Fac Total Subsidio";
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$original_fac_numero = $this->fac_numero;
$original_fac_aplica_propina = $this->fac_aplica_propina;
$original_fac_subtotal = $this->fac_subtotal;
$original_fac_subtotal_iva = $this->fac_subtotal_iva;
$original_fac_subtotal_cero = $this->fac_subtotal_cero;
$original_fac_subtotal_no_objeto = $this->fac_subtotal_no_objeto;
...
if(isset($this->fac_numero )){
	$update_sql = "UPDATE del_factura 
					SET fac_aplica_propina='".$this->fac_aplica_propina ."'  
					WHERE
...
$modificado_fac_aplica_propina = $this->fac_aplica_propina;
...
$modificado_fac_propina = $this->fac_propina;
$modificado_fac_total = $this->fac_total;
$this->nm_formatar_campos('fac_numero', 'fac_aplica_propina', 'fac_subtotal', 'fac_subtotal_iva', 'fac_subtotal_cero', 'fac_subtotal_no_objeto', 'fac_subtotal_excento', 'fac_total_descuento', 'fac_valor_ice', 'fac_valor_iva', 'fac_valor_irbpnr', 'fac_propina', 'fac_total');
...
if ($original_fac_aplica_propina !== $modificado_fac_aplica_propina || isset($this->nmgp_cmp_readonly['fac_aplica_propina']) || (isset($bFlagRead_fac_aplica_propina) && $bFlagRead_fac_aplica_propina))
{
    $this->ajax_return_values_fac_aplica_propina(true);
}
...
if ($original_fac_propina !== $modificado_fac_propina || isset($this->nmgp_cmp_readonly['fac_propina']) || (isset($bFlagRead_fac_propina) && $bFlagRead_fac_propina))
{
    $this->ajax_return_values_fac_propina(true);
}
...
$update_sql="delete from  del_detalle_factura 
			 WHERE df_factura=".$this->fac_numero ;
...
$modificado_fac_fecha = $this->fac_fecha;
$modificado_fac_numero = $this->fac_numero;
$modificado_fac_subtotal = $this->fac_subtotal;
$modificado_fac_subtotal_iva = $this->fac_subtotal_iva;
$modificado_fac_subtotal_cero = $this->fac_subtotal_cero;
...
$modificado_fac_propina = $this->fac_propina;
$modificado_fac_total = $this->fac_total;
$this->nm_formatar_campos('fac_fecha', 'fac_numero', 'fac_subtotal', 'fac_subtotal_iva', 'fac_subtotal_cero', 'fac_subtotal_no_objeto', 'fac_subtotal_excento', 'fac_total_descuento', 'fac_valor_ice', 'fac_valor_iva', 'fac_valor_irbpnr', 'fac_propina', 'fac_total');
if ($original_fac_fecha !== $modificado_fac_fecha || isset($this->nmgp_cmp_readonly['fac_fecha']) || (isset($bFlagRead_fac_fecha) && $bFlagRead_fac_fecha))
{
    $this->ajax_return_values_fac_fecha(true);
}
if ($original_fac_numero !== $modificado_fac_numero || isset($this->nmgp_cmp_readonly['fac_numero']) || (isset($bFlagRead_fac_numero) && $bFlagRead_fac_numero))
...
$update_sql="UPDATE del_factura 
				SET fac_establecimiento= ".$this->rs[0][0]." 
			WHERE fac_numero=".$this->fac_numero ;
...
$modificado_fac_libretin = $this->fac_libretin;
$modificado_fac_establecimiento = $this->fac_establecimiento;
$modificado_fac_punto_emision = $this->fac_punto_emision;
$modificado_fac_secuencial = $this->fac_secuencial;
$modificado_fac_ambiente = $this->fac_ambiente;
$modificado_fac_tipo_libretin = $this->fac_tipo_libretin;
$modificado_secuencial = $this->secuencial;
$modificado_fac_autorizacion = $this->fac_autorizacion;
$modificado_fac_estado_sri = $this->fac_estado_sri;
$modificado_fac_numero = $this->fac_numero;
$this->nm_formatar_campos('fac_libretin', 'fac_establecimiento', 'fac_punto_emision', 'fac_secuencial', 'fac_ambiente', 'fac_tipo_libretin', 'secuencial', 'fac_autorizacion', 'fac_estado_sri', 'fac_numero');
if ($original_fac_libretin !== $modificado_fac_libretin || isset($this->nmgp_cmp_readonly['fac_libretin']) || (isset($bFlagRead_fac_libretin) && $bFlagRead_fac_libretin))
{
    $this->ajax_return_values_fac_libretin(true);
}
if ($original_fac_establecimiento !== $modificado_fac_establecimiento || isset($this->nmgp_cmp_readonly['fac_establecimiento']) || (isset($bFlagRead_fac_establecimiento) && $bFlagRead_fac_establecimiento))
{
    $this->ajax_return_values_fac_establecimiento(true);
}
if ($original_fac_punto_emision !== $modificado_fac_punto_emision || isset($this->nmgp_cmp_readonly['fac_punto_emision']) || (isset($bFlagRead_fac_punto_emision) && $bFlagRead_fac_punto_emision))
{
    $this->ajax_return_values_fac_punto_emision(true);
}
...
if ($original_fac_ambiente !== $modificado_fac_ambiente || isset($this->nmgp_cmp_readonly['fac_ambiente']) || (isset($bFlagRead_fac_ambiente) && $bFlagRead_fac_ambiente))
{
    $this->ajax_return_values_fac_ambiente(true);
}
...
if ($original_fac_autorizacion !== $modificado_fac_autorizacion || isset($this->nmgp_cmp_readonly['fac_autorizacion']) || (isset($bFlagRead_fac_autorizacion) && $bFlagRead_fac_autorizacion))
{
    $this->ajax_return_values_fac_autorizacion(true);
}
if ($original_fac_estado_sri !== $modificado_fac_estado_sri || isset($this->nmgp_cmp_readonly['fac_estado_sri']) || (isset($bFlagRead_fac_estado_sri) && $bFlagRead_fac_estado_sri))
{
    $this->ajax_return_values_fac_estado_sri(true);
}
if ($original_fac_numero !== $modificado_fac_numero || isset($this->nmgp_cmp_readonly['fac_numero']) || (isset($bFlagRead_fac_numero) && $bFlagRead_fac_numero))
...
if (strlen($this->ruc )==13){
	if ($this->validar_esRuc($this->ruc )==0 and $this->ruc <>'9999999999999'){
		$this->fac_tipo_identificacion ='PASAPORTE';
		$this->sc_ajax_message( $this->Ini->Nm_lang['lang_ruc_invalido'] , "Error","toast=Y&toasto_pos=center-start&type=error");
	}else{
		if($this->ruc =='9999999999999'){
			$this->fac_tipo_identificacion ='VENTA CONSUMIDOR FINAL';
		}else{
			$this->fac_tipo_identificacion ='RUC';
		}	
	}
}elseif (strlen($this->ruc )==10){
	if ($this->esCedula($this->ruc )==0){
		$this->fac_tipo_identificacion ='PASAPORTE';
		$this->sc_ajax_message( $this->Ini->Nm_lang['lang_cedula_invalida'] , "Error","toast=Y&toasto_pos=center-start&type=error");
	}else{
		$this->fac_tipo_identificacion ='CEDULA';
	}
}else{
	$this->fac_tipo_identificacion ='PASAPORTE';	
	$this->sc_ajax_message("Se usará la identificación como pasaporte", "Error","toast=Y&toasto_pos=center-start&type=error");
}

$respuesta=consultaNombres($this->ruc );
if($respuesta['error']=='0'){
	$ciudadano=$respuesta['datos'];
	$this->fac_nombre_cliente =		$ciudadano['nombre'];
	$this->fac_provincia_cliente =	$ciudadano['provincia'];
	$this->fac_canton_cliente =		$ciudadano['canton'];
	$this->fac_direccion_cliente =	$ciudadano['direccion'];
	$this->fac_email_cliente =		$ciudadano['correo'];
	$this->fac_telefono_cliente =		$ciudadano['telefono'];
}


$modificado_ruc = $this->ruc;
$modificado_fac_tipo_identificacion = $this->fac_tipo_identificacion;
$modificado_fac_nombre_cliente = $this->fac_nombre_cliente;
$modificado_fac_provincia_cliente = $this->fac_provincia_cliente;
$modificado_fac_canton_cliente = $this->fac_canton_cliente;
$modificado_fac_direccion_cliente = $this->fac_direccion_cliente;
$modificado_fac_email_cliente = $this->fac_email_cliente;
$modificado_fac_telefono_cliente = $this->fac_telefono_cliente;
$this->nm_formatar_campos('ruc', 'fac_tipo_identificacion', 'fac_nombre_cliente', 'fac_provincia_cliente', 'fac_canton_cliente', 'fac_direccion_cliente', 'fac_email_cliente', 'fac_telefono_cliente');
if ($original_ruc !== $modificado_ruc || isset($this->nmgp_cmp_readonly['ruc']) || (isset($bFlagRead_ruc) && $bFlagRead_ruc))
{
    $this->ajax_return_values_ruc(true);
}
if ($original_fac_tipo_identificacion !== $modificado_fac_tipo_identificacion || isset($this->nmgp_cmp_readonly['fac_tipo_identificacion']) || (isset($bFlagRead_fac_tipo_identificacion) && $bFlagRead_fac_tipo_identificacion))
{
    $this->ajax_return_values_fac_tipo_identificacion(true);
}
...
if ($original_fac_provincia_cliente !== $modificado_fac_provincia_cliente || isset($this->nmgp_cmp_readonly['fac_provincia_cliente']) || (isset($bFlagRead_fac_provincia_cliente) && $bFlagRead_fac_provincia_cliente))
{
    $this->ajax_return_values_fac_provincia_cliente(true);
}
if ($original_fac_canton_cliente !== $modificado_fac_canton_cliente || isset($this->nmgp_cmp_readonly['fac_canton_cliente']) || (isset($bFlagRead_fac_canton_cliente) && $bFlagRead_fac_canton_cliente))
{
    $this->ajax_return_values_fac_canton_cliente(true);
}
...
if ($original_fac_telefono_cliente !== $modificado_fac_telefono_cliente || isset($this->nmgp_cmp_readonly['fac_telefono_cliente']) || (isset($bFlagRead_fac_telefono_cliente) && $bFlagRead_fac_telefono_cliente))
{
    $this->ajax_return_values_fac_telefono_cliente(true);
}
$this->NM_ajax_info['event_field'] = 'ruc';
form_del_punto_venta_pack_ajax_response();
exit;
...
function verficar_guia($serie_guia)
{
$_SESSION['scriptcase']['form_del_punto_venta']['contr_erro'] = 'on';
...
$this->sc_ajax_message ($this->autorizar_factura($this->fac_numero ,'S'), "Aviso", "modal = Y & button = Y & button_label = Ok & body_icon = Y & redir = form_del_factura.php", "toast=Y&toasto_pos=center-start&type=success");


$modificado_fac_numero = $this->fac_numero;
$this->nm_formatar_campos('fac_numero');
if ($original_fac_numero !== $modificado_fac_numero || isset($this->nmgp_cmp_readonly['fac_numero']) || (isset($bFlagRead_fac_numero) && $bFlagRead_fac_numero))
{
    $this->ajax_return_values_fac_numero(true);
}
...
$update_sql = "UPDATE del_detalle_factura
					SET  
					   df_estado='N'
					WHERE
						df_factura=".$this->fac_numero .";";
...
$this->nm_mens_alert[] = $this->Ini->Nm_lang['lang_doc_anulado']; $this->nm_params_alert[] = array(); if ($this->NM_ajax_flag) { $this->sc_ajax_alert($this->Ini->Nm_lang['lang_doc_anulado']); }$modificado_fac_numero = $this->fac_numero;
$this->nm_formatar_campos('fac_numero');
if ($original_fac_numero !== $modificado_fac_numero || isset($this->nmgp_cmp_readonly['fac_numero']) || (isset($bFlagRead_fac_numero) && $bFlagRead_fac_numero))
{
    $this->ajax_return_values_fac_numero(true);
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_del_punto_venta_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function Form_lookup_fac_libretin()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_libretin']))
{
...
else
{
   ...
   function Form_lookup_fac_moneda()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_moneda']))
{
...
else
{
   ...
   function Form_lookup_fac_provincia_cliente()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_provincia_cliente']))
{
...
else
{
   ...
   function Form_lookup_fac_canton_cliente()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_canton_cliente']))
{
...
else
{
   ...
   function Form_lookup_fac_aplica_propina()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_aplica_propina']))
{
...
else
{
   ...
   function Form_lookup_fac_diagnostico()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['Lookup_fac_diagnostico']))
{
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['empty_filter']);
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "fac_tipo_comprobante", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "fac_establecimiento", $arg_search, str_replace(",", ".", $data_search), "INT4", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "fac_punto_emision", $arg_search, str_replace(",", ".", $data_search), "INT4", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "fac_secuencial", $arg_search, str_replace(",", ".", $data_search), "INT4", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "fac_cliente", $arg_search, str_replace(",", ".", $data_search), "INT4", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "fac_ambiente", $arg_search, str_replace(",", ".", $data_search), "INT4", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "fac_tipo_libretin", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "fac_propina", $arg_search, str_replace(",", ".", $data_search), "NUMERIC", false);
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "fac_estado_sri", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "fac_error_sri", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "fac_autorizacion", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter_form'] . " and ((fac_numero=" . $_SESSION['var_id_factura'] . ")) and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where (fac_numero=" . $_SESSION['var_id_factura'] . ") and (" . $comando . ")";
      }
      ...
      $qt_geral_reg_form_del_punto_venta = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['total'] = $qt_geral_reg_form_del_punto_venta;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_del_punto_venta_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "fac_numero";$nm_numeric[] = "fac_establecimiento";$nm_numeric[] = "fac_punto_emision";$nm_numeric[] = "fac_secuencial";$nm_numeric[] = "fac_cliente";$nm_numeric[] = "fac_ambiente";$nm_numeric[] = "fac_subtotal_iva";$nm_numeric[] = "fac_subtotal_cero";$nm_numeric[] = "fac_subtotal_no_objeto";$nm_numeric[] = "fac_subtotal_excento";$nm_numeric[] = "fac_subtotal";$nm_numeric[] = "fac_total_descuento";$nm_numeric[] = "fac_valor_ice";$nm_numeric[] = "fac_valor_iva";$nm_numeric[] = "fac_valor_irbpnr";$nm_numeric[] = "fac_propina";$nm_numeric[] = "fac_total";$nm_numeric[] = "fac_libretin";$nm_numeric[] = "fac_retencion";$nm_numeric[] = "fac_diagnostico";$nm_numeric[] = "fac_total_subsidio";
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_del_punto_venta_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_del_punto_venta_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['masterValue']))
{
...
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "retencion":
                ...
                break;
            case "ride":
                return array("sc_ride_bot.");
                break;
            case "bauchert":
                return array("sc_bauchert_bot.");
                break;
        }
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_venta']['ordem_ord'] == " desc") {
