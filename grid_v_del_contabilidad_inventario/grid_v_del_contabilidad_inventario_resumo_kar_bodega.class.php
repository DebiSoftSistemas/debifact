...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_kar_bodega = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['arr_total']['kar_bodega'];
      }
      else
      {
          $this->array_total_kar_bodega = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_order']['kar_bodega']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_order']['kar_bodega'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_order']['kar_bodega'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['kar_bodega'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_kar_bodega as $i_kar_bodega => $d_kar_bodega) {
           if (!isset($i_kar_bodega, $this->comp_label[0]) || !in_array($i_kar_bodega, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_kar_bodega[4] ] = $d_kar_bodega[3];
               $this->comp_label[0][ $d_kar_bodega[4] ] = $d_kar_bodega[3];
           }
       }
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_kar_bodega => $l_kar_bodega) {
           if (isset($this->array_total_kar_bodega[$i_kar_bodega])) {
               $this->comp_group[$i_kar_bodega] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_kar_bodega;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_kar_bodega("res", $this->NM_export);
      ...
      if (is_array($this->array_total_kar_bodega)) {
          ksort($this->array_total_kar_bodega);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_Ind_Groupby'];
...
{ 
   ...
   //---- 
   function adiciona_registro($sum_total_ingreso, $sum_total_salida, $quebra_kar_bodega, $quebra_kar_bodega_orig)
   {
      //----- kar_bodega
      if (!isset($this->array_total_kar_bodega[$quebra_kar_bodega_orig]))
      {
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][0] = 1;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][1] = $sum_total_ingreso;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][2] = $sum_total_salida;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][3] = $quebra_kar_bodega;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][4] = $quebra_kar_bodega_orig;
      }
      else
      {
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][0]++;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][1] = bcadd($this->array_total_kar_bodega[$quebra_kar_bodega_orig][1], $sum_total_ingreso, 10);
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][2] = bcadd($this->array_total_kar_bodega[$quebra_kar_bodega_orig][2], $sum_total_salida, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('kar_bodega', 'kar_bodega');
     $campos_order = $this->Ini->Get_date_order_groupby("kar_bodega", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->look_kar_tipo_movimiento = $this->kar_tipo_movimiento; 
            $this->Lookup->lookup_kar_tipo_movimiento($this->look_kar_tipo_movimiento, $this->kar_tipo_movimiento) ; 
            $this->look_kar_tipo_documento = $this->kar_tipo_documento; 
            $this->Lookup->lookup_kar_tipo_documento($this->look_kar_tipo_documento, $this->kar_tipo_documento) ; 
            $this->look_kar_bodega = $this->kar_bodega; 
            $this->Lookup->lookup_kar_bodega($this->look_kar_bodega, $this->kar_bodega, $_SESSION['Igtech_RucEmpresa']) ; 
            $this->kar_bodega_orig = $this->kar_bodega;
            $this->kar_tipo_movimiento = $this->look_kar_tipo_movimiento ;
            $this->kar_tipo_documento = $this->look_kar_tipo_documento ;
            $this->kar_bodega = $this->look_kar_bodega ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total_ingreso, $this->total_salida, $this->kar_bodega, $this->kar_bodega_orig);
            }
   }
//
