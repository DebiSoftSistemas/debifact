...
class grid_v_del_contabilidad_inventario_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_v_del_contabilidad_inventario_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_v_del_contabilidad_inventario_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_v_del_contabilidad_inventario_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "v_del_contabilidad_inventario.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_movimientos_costo'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_v_del_contabilidad_inventario/grid_v_del_contabilidad_inventario_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_v_del_contabilidad_inventario_ajax_search.js"></script>
 <script type="text/javascript" src="grid_v_del_contabilidad_inventario_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_v_del_contabilidad_inventario_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_v_del_contabilidad_inventario']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_v_del_contabilidad_inventario']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_kar_fecha_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_kar_fecha_dia').value + '/';
          var_dt_ini += document.getElementById('SC_kar_fecha_mes').value + '/';
          var_dt_ini += document.getElementById('SC_kar_fecha_ano').value;
          document.getElementById('sc_kar_fecha_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_kar_fecha_dia').value = aParts[0];
          document.getElementById('SC_kar_fecha_mes').value = aParts[1];
          document.getElementById('SC_kar_fecha_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_kar_fecha_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_kar_fecha_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_kar_fecha_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_kar_fecha_input_2_ano').value;
          document.getElementById('sc_kar_fecha_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_kar_fecha_input_2_dia').value = aParts[0];
          document.getElementById('SC_kar_fecha_input_2_mes').value = aParts[1];
          document.getElementById('SC_kar_fecha_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_kar_fecha_cond#NMF#' + search_get_sel_txt('SC_kar_fecha_cond') + '@NMF@';
  str_out += 'SC_kar_fecha_dia#NMF#' + search_get_sel_txt('SC_kar_fecha_dia') + '@NMF@';
  str_out += 'SC_kar_fecha_mes#NMF#' + search_get_sel_txt('SC_kar_fecha_mes') + '@NMF@';
  str_out += 'SC_kar_fecha_ano#NMF#' + search_get_sel_txt('SC_kar_fecha_ano') + '@NMF@';
  str_out += 'SC_kar_fecha_input_2_dia#NMF#' + search_get_sel_txt('SC_kar_fecha_input_2_dia') + '@NMF@';
  str_out += 'SC_kar_fecha_input_2_mes#NMF#' + search_get_sel_txt('SC_kar_fecha_input_2_mes') + '@NMF@';
  str_out += 'SC_kar_fecha_input_2_ano#NMF#' + search_get_sel_txt('SC_kar_fecha_input_2_ano') + '@NMF@';
  str_out += 'SC_kar_bodega_cond#NMF#' + search_get_sel_txt('SC_kar_bodega_cond') + '@NMF@';
  str_out += 'SC_kar_bodega#NMF#' + search_get_select('SC_kar_bodega') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $kar_fecha_cond, $kar_fecha, $kar_fecha_dia, $kar_fecha_mes, $kar_fecha_ano, $kar_fecha_input_2_dia, $kar_fecha_input_2_mes, $kar_fecha_input_2_ano,
             $kar_bodega_cond, $kar_bodega,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $kar_fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_dia']; 
          $kar_fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_mes']; 
          $kar_fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_ano']; 
          $kar_fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_input_2_dia']; 
          $kar_fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_input_2_mes']; 
          $kar_fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_input_2_ano']; 
          $kar_fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_cond']; 
          $kar_bodega = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_bodega']; 
          $kar_bodega_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_bodega_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['NM_operador']; 
      } 
      if (!isset($kar_fecha_cond) || empty($kar_fecha_cond))
      {
         $kar_fecha_cond = "eq";
      }
      ...
      $str_hide_kar_fecha = (in_array($kar_fecha_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_kar_bodega = (in_array($kar_bodega_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_kar_fecha = ('bw' == $kar_fecha_cond) ? $display_aberto : $display_fechado;
      $str_display_kar_bodega = ('bw' == $kar_bodega_cond) ? $display_aberto : $display_fechado;

      if (!isset($kar_fecha) || $kar_fecha == "")
      {
          $kar_fecha = "";
      }
      if (isset($kar_fecha) && !empty($kar_fecha))
      {
      ...
      if (!isset($kar_bodega) || $kar_bodega == "")
      {
          $kar_bodega = "";
      }
      if (isset($kar_bodega) && !empty($kar_bodega))
      {
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_kar_fecha_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['kar_fecha'])) ? $this->New_label['kar_fecha'] : "" . $this->Ini->Nm_lang['lang_fecha'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_kar_fecha_cond" name="kar_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_kar_fecha'), this, 'kar_fecha')">
       <OPTION value="eq" <?php if ("eq" == $kar_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $kar_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_kar_fecha" <?php echo $str_hide_kar_fecha?> valign="top">
 ...
 $nmgp_tab_label .= "kar_fecha?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_kar_fecha_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_kar_fecha_dia" name="kar_fecha_dia" value="<?php echo NM_encode_input($kar_fecha_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
<INPUT type="hidden" id="sc_kar_fecha_jq">
<?php
}
?>
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_kar_fecha_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_kar_fecha_mes" name="kar_fecha_mes" value="<?php echo NM_encode_input($kar_fecha_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_kar_fecha_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_kar_fecha_ano" name="kar_fecha_ano" value="<?php echo NM_encode_input($kar_fecha_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
        <SPAN id="id_css_kar_fecha"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_kar_fecha"  <?php echo $str_display_kar_fecha; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_kar_fecha_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_kar_fecha_input_2_dia" name="kar_fecha_input_2_dia" value="<?php echo NM_encode_input($kar_fecha_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
<INPUT type="hidden" id="sc_kar_fecha_jq2">
<?php
}
?>
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_kar_fecha_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_kar_fecha_input_2_mes" name="kar_fecha_input_2_mes" value="<?php echo NM_encode_input($kar_fecha_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_kar_fecha_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_kar_fecha_input_2_ano" name="kar_fecha_input_2_ano" value="<?php echo NM_encode_input($kar_fecha_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
      ...
      <TD id='SC_kar_bodega_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['kar_bodega'])) ? $this->New_label['kar_bodega'] : "" . $this->Ini->Nm_lang['lang_bodega'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_kar_bodega_cond" name="kar_bodega_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_kar_bodega" <?php echo $str_hide_kar_bodega?> valign="top">
 ...
 $nmgp_tab_label .= "kar_bodega?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <span id="idAjaxSelect_kar_bodega">
      <SELECT class="scFilterObjectEven" id="SC_kar_bodega" name="kar_bodega"  size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $kar_bodega)
            {
                    $kar_bodega_sel = ($nm_opc_cod === $kar_bodega) ? "selected" : "";
            }
            else
            {
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $kar_bodega_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_v_del_contabilidad_inventario_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_contabilidad_inventario']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_contabilidad_inventario']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.kar_fecha_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_kar_fecha'), document.F1.kar_fecha_cond, 'kar_fecha');
   document.F1.kar_fecha_dia.value = "";
   document.F1.kar_fecha_mes.value = "";
   document.F1.kar_fecha_ano.value = "";
   document.F1.kar_fecha_input_2_dia.value = "";
   document.F1.kar_fecha_input_2_mes.value = "";
   document.F1.kar_fecha_input_2_ano.value = "";
   nm_campos_between(document.getElementById('id_vis_kar_bodega'), document.F1.kar_bodega_cond, 'kar_bodega');
   document.F1.kar_bodega.value = "";
   Sc_carga_select2('all');
   Sc_carga_slider('all');
 }
 function Sc_carga_select2(Field)
 {
    if (Field == 'all' || Field == 'kar_bodega') {
       Sc_carga_select2_kar_bodega();
    }
 }
 function Sc_carga_select2_kar_bodega()
 {
  $("#SC_kar_bodega").select2(
    {
 ...
 {
    $('#SC_kar_fecha_dia').bind('change', function() {sc_grid_v_del_contabilidad_inventario_valida_dia(this)});
    $('#SC_kar_fecha_input_2_dia').bind('change', function() {sc_grid_v_del_contabilidad_inventario_valida_dia(this)});
    $('#SC_kar_fecha_input_2_mes').bind('change', function() {sc_grid_v_del_contabilidad_inventario_valida_mes(this)});
    $('#SC_kar_fecha_mes').bind('change', function() {sc_grid_v_del_contabilidad_inventario_valida_mes(this)});
 }
 function sc_grid_v_del_contabilidad_inventario_valida_dia(obj)
 {
 ...
 function sc_grid_v_del_contabilidad_inventario_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_v_del_contabilidad_inventario/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_kar_fecha_cond'] = 'cond';
      $tp_fields['SC_kar_fecha_dia'] = 'text';
      $tp_fields['SC_kar_fecha_mes'] = 'text';
      $tp_fields['SC_kar_fecha_ano'] = 'text';
      $tp_fields['SC_kar_fecha_input_2_dia'] = 'text';
      $tp_fields['SC_kar_fecha_input_2_mes'] = 'text';
      $tp_fields['SC_kar_fecha_input_2_ano'] = 'text';
      $tp_fields['SC_kar_bodega_cond'] = 'cond';
      $tp_fields['SC_kar_bodega'] = 'select';
   ...
   {
      global $kar_fecha_cond, $kar_fecha, $kar_fecha_dia, $kar_fecha_mes, $kar_fecha_ano, $kar_fecha_input_2_dia, $kar_fecha_input_2_mes, $kar_fecha_input_2_ano,
             $kar_bodega_cond, $kar_bodega, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $kar_fecha_cond_salva = $kar_fecha_cond; 
      if (!isset($kar_fecha_input_2_dia) || $kar_fecha_input_2_dia == "")
      {
          $kar_fecha_input_2_dia = $kar_fecha_dia;
      }
      if (!isset($kar_fecha_input_2_mes) || $kar_fecha_input_2_mes == "")
      {
          $kar_fecha_input_2_mes = $kar_fecha_mes;
      }
      if (!isset($kar_fecha_input_2_ano) || $kar_fecha_input_2_ano == "")
      {
          $kar_fecha_input_2_ano = $kar_fecha_ano;
      }
      $kar_bodega_cond_salva = $kar_bodega_cond; 
      if (!isset($kar_bodega_input_2) || $kar_bodega_input_2 == "")
      {
          $kar_bodega_input_2 = $kar_bodega;
      }
      $tmp_pos = (is_string($kar_bodega)) ? strpos($kar_bodega, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $kar_bodega;
          ...
          $L_lookup = substr($kar_bodega, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['psq_check_ret']['kar_bodega'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_bodega'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_dia'] = $kar_fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_mes'] = $kar_fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_ano'] = $kar_fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_input_2_dia'] = $kar_fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_input_2_mes'] = $kar_fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_input_2_ano'] = $kar_fecha_input_2_ano; 
      if (!empty($kar_fecha_dia) || !empty($kar_fecha_mes) || !empty($kar_fecha_ano) || $kar_fecha_cond_salva == "nu" || $kar_fecha_cond_salva == "nn" || $kar_fecha_cond_salva == "ep" || $kar_fecha_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $kar_fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $kar_fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $kar_fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $kar_fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $kar_fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $kar_fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_cond'] = $kar_fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid]['cmp'] = "kar_fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid]['opc'] = $kar_fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq']['kar_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_bodega'] = $kar_bodega; 
      if (is_array($kar_bodega) && !empty($kar_bodega))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid]['val'][0] = $kar_bodega;
      }
      elseif ($kar_bodega_cond_salva == "nu" || $kar_bodega_cond_salva == "nn" || $kar_bodega_cond_salva == "ep" || $kar_bodega_cond_salva == "ne" || !empty($kar_bodega))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid]['val'][0][0] = $kar_bodega;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_bodega_cond'] = $kar_bodega_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid]['cmp'] = "kar_bodega"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid]['opc'] = $kar_bodega_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq']['kar_bodega'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['kar_bodega'] = $Conteudo;

      //----- $kar_fecha
      $this->Date_part = false;
      if ($kar_fecha_cond != "bi_TP")
      {
          $kar_fecha_cond = strtoupper($kar_fecha_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $kar_fecha_ano;
          $Dtxt .= $kar_fecha_mes;
          $Dtxt .= $kar_fecha_dia;
          $val[0]['ano'] = $kar_fecha_ano;
          $val[0]['mes'] = $kar_fecha_mes;
          $val[0]['dia'] = $kar_fecha_dia;
          if ($kar_fecha_cond == "BW")
          {
              $val[1]['ano'] = $kar_fecha_input_2_ano;
              $val[1]['mes'] = $kar_fecha_input_2_mes;
              $val[1]['dia'] = $kar_fecha_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $kar_fecha_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $kar_fecha_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $kar_fecha = $val[0];
          $this->cmp_formatado['kar_fecha'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['kar_fecha'], "YYYY-MM-DD");
          $this->cmp_formatado['kar_fecha'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($kar_fecha_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $kar_fecha_input_2     = $val[1];
              $this->cmp_formatado['kar_fecha_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']['kar_fecha_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['kar_fecha_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['kar_fecha_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $kar_fecha_cond == "NU" || $kar_fecha_cond == "NN"|| $kar_fecha_cond == "EP"|| $kar_fecha_cond == "NE")
          {
              $this->monta_condicao("kar_fecha", $kar_fecha_cond, $kar_fecha, $kar_fecha_input_2, 'kar_fecha', 'DATE');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq']['kar_fecha']['label'] = $nmgp_tab_label['kar_fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq']['kar_fecha']['descr'] = $nmgp_tab_label['kar_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq']['kar_fecha']['hint']  = $nmgp_tab_label['kar_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      if (isset($kar_bodega))
      {
         $this->monta_condicao("kar_bodega", $kar_bodega_cond, $kar_bodega, "", "kar_bodega", "INT4", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "kar_bodega" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
