...
class grid_v_del_contabilidad_inventario_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_kar_bodega;
   var $array_total_kar_tipo_movimiento;
   var $array_total_kar_tipo_documento;
   var $array_total_kar_fecha;
   var $array_total_kar_fecha_scgb_16;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_kar_bodega          = array();
      $this->array_total_kar_tipo_movimiento = array();
      $this->array_total_kar_tipo_documento  = array();
      $this->array_total_kar_fecha           = array();
      $this->array_total_kar_fecha_scgb_16   = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_v_del_contabilidad_inventario']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_v_del_contabilidad_inventario']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['tot_geral'][3];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['arr_total']['kar_bodega'] = $this->array_total_kar_bodega;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['arr_total']['kar_tipo_movimiento'] = $this->array_total_kar_tipo_movimiento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['arr_total']['kar_tipo_documento'] = $this->array_total_kar_tipo_documento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['arr_total']['kar_fecha'] = $this->array_total_kar_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['arr_total']['kar_fecha_scgb_16'] = $this->array_total_kar_fecha_scgb_16;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['json_use_label'])
       {
          $Lab_kar_bodega = "kar_bodega";
          $Lab_kar_tipo_movimiento = "kar_tipo_movimiento";
          $Lab_kar_tipo_documento = "kar_tipo_documento";
          $Lab_kar_fecha = "kar_fecha";
          $Lab_kar_fecha_scgb_16 = "kar_fecha_scgb_16";
       }
       else
       {
       $Lab_kar_bodega = "" . $this->Ini->Nm_lang['lang_bodega'] . "";
       $Lab_kar_tipo_movimiento = "" . $this->Ini->Nm_lang['lang_movimiento_kardex'] . "";
       $Lab_kar_tipo_documento = "" . $this->Ini->Nm_lang['lang_modulo'] . "";
       $Lab_kar_fecha = "" . $this->Ini->Nm_lang['lang_fecha'] . "";
       $Lab_kar_fecha =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYY'] . "", $Lab_kar_fecha);
       $Lab_kar_fecha_scgb_16 = "" . $this->Ini->Nm_lang['lang_fecha'] . "";
       $Lab_kar_fecha_scgb_16 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_MM'] . "", $Lab_kar_fecha_scgb_16);
       }
       $prep_field = array();
       $prep_field['kar_bodega'] = $Lab_kar_bodega;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_bodega'] = $Lab_kar_bodega; 
       $prep_field['kar_tipo_movimiento'] = $Lab_kar_tipo_movimiento;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_tipo_movimiento'] = $Lab_kar_tipo_movimiento; 
       $prep_field['kar_tipo_documento'] = $Lab_kar_tipo_documento;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_tipo_documento'] = $Lab_kar_tipo_documento; 
       $prep_field['kar_fecha'] = $Lab_kar_fecha;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_fecha'] = $Lab_kar_fecha; 
       $prep_field['kar_fecha_scgb_16'] = $Lab_kar_fecha_scgb_16;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_fecha_scgb_16'] = $Lab_kar_fecha_scgb_16; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_tipo_movimiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_tipo_movimiento'] = "" . $this->Ini->Nm_lang['lang_movimiento_kardex'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_tipo_documento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_tipo_documento'] = "" . $this->Ini->Nm_lang['lang_modulo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['descripcion'] = "" . $this->Ini->Nm_lang['lang_descripcion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['total_ingreso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['total_ingreso'] = "Total Ingreso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['total_salida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['total_salida'] = "Total Salida"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['id'] = "Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_bodega']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_bodega'] = "" . $this->Ini->Nm_lang['lang_bodega'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_documento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_documento'] = "" . $this->Ini->Nm_lang['lang_lot_documento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_asiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_asiento'] = "" . $this->Ini->Nm_lang['lang_asiento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_fecha_scgb_16']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['labels']['kar_fecha_scgb_16'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "Total Ingreso (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "Total Salida (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "total_ingreso", 'show' => true),
           3 => array('field' => "total_salida", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_total_ingreso_sum",
           3 => "css_total_salida_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['kar_bodega']['alin'] = "''";
       $Arr_parms['kar_bodega']['link'] = "S";
       $Arr_parms['kar_tipo_movimiento']['alin'] = "''";
       $Arr_parms['kar_tipo_movimiento']['link'] = "S";
       $Arr_parms['kar_tipo_documento']['alin'] = "''";
       $Arr_parms['kar_tipo_documento']['link'] = "S";
       $Arr_parms['kar_fecha']['alin'] = "''";
       $Arr_parms['kar_fecha']['link'] = "S";
       $Arr_parms['kar_fecha_scgb_16']['alin'] = "''";
       $Arr_parms['kar_fecha_scgb_16']['link'] = "S";
       $Arr_parms['kar_bodega']['fill'] = "true";
       $Arr_parms['kar_bodega']['order'] = "label";
       $Arr_parms['kar_bodega']['order_start'] = 'asc';
       $Arr_parms['kar_bodega']['order_invert'] = 'false';
       $Arr_parms['kar_bodega']['order_enabled'] = 'true';
       $Arr_parms['kar_bodega']['order_datatype'] = 'int4';
       $Arr_parms['kar_bodega']['rating_function'] = '';
       $Arr_parms['kar_tipo_movimiento']['fill'] = "true";
       $Arr_parms['kar_tipo_movimiento']['order'] = "label";
       $Arr_parms['kar_tipo_movimiento']['order_start'] = 'asc';
       $Arr_parms['kar_tipo_movimiento']['order_invert'] = 'false';
       $Arr_parms['kar_tipo_movimiento']['order_enabled'] = 'true';
       $Arr_parms['kar_tipo_movimiento']['order_datatype'] = 'varchar';
       $Arr_parms['kar_tipo_movimiento']['rating_function'] = '';
       $Arr_parms['kar_tipo_documento']['fill'] = "true";
       $Arr_parms['kar_tipo_documento']['order'] = "label";
       $Arr_parms['kar_tipo_documento']['order_start'] = 'asc';
       $Arr_parms['kar_tipo_documento']['order_invert'] = 'false';
       $Arr_parms['kar_tipo_documento']['order_enabled'] = 'true';
       $Arr_parms['kar_tipo_documento']['order_datatype'] = 'varchar';
       $Arr_parms['kar_tipo_documento']['rating_function'] = '';
       $Arr_parms['kar_fecha']['fill'] = "true";
       $Arr_parms['kar_fecha']['order'] = "value";
       $Arr_parms['kar_fecha']['order_start'] = 'asc';
       $Arr_parms['kar_fecha']['order_invert'] = 'false';
       $Arr_parms['kar_fecha']['order_enabled'] = 'true';
       $Arr_parms['kar_fecha']['order_datatype'] = 'date';
       $Arr_parms['kar_fecha']['rating_function'] = '';
       $Arr_parms['kar_fecha_scgb_16']['fill'] = "true";
       $Arr_parms['kar_fecha_scgb_16']['order'] = "value";
       $Arr_parms['kar_fecha_scgb_16']['order_start'] = 'asc';
       $Arr_parms['kar_fecha_scgb_16']['order_invert'] = 'false';
       $Arr_parms['kar_fecha_scgb_16']['order_enabled'] = 'true';
       $Arr_parms['kar_fecha_scgb_16']['order_datatype'] = 'date';
       $Arr_parms['kar_fecha_scgb_16']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['kar_bodega'] = array(0 => 'kar_bodega', 1 => '');
       $prep_links_fl['kar_tipo_movimiento'] = array(0 => 'kar_tipo_movimiento', 1 => '@aspass@');
       $prep_links_fl['kar_tipo_documento'] = array(0 => 'kar_tipo_documento', 1 => '@aspass@');
       $prep_links_fl['kar_fecha'] = array(0 => 'kar_fecha', 1 => '@aspass@');
       $prep_links_fl['kar_fecha_scgb_16'] = array(0 => 'kar_fecha_scgb_16', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_del_contabilidad_inventario@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_v_del_contabilidad_inventario_total.class.php"); 
      }
      ...
      $this->Total   = new grid_v_del_contabilidad_inventario_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['ajax_nav']) {  
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_contabilidad_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_v_del_contabilidad_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_contabilidad_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_del_contabilidad_inventario/grid_v_del_contabilidad_inventario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_contabilidad_inventario/grid_v_del_contabilidad_inventario_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_del_contabilidad_inventario&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_contabilidad_inventario/grid_v_del_contabilidad_inventario_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_del_contabilidad_inventario/grid_v_del_contabilidad_inventario_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume&nm_all_modules=grid,resume&nm_json_format=N&nm_json_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_contabilidad_inventario/grid_v_del_contabilidad_inventario_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_del_contabilidad_inventario/grid_v_del_contabilidad_inventario_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_del_contabilidad_inventario/grid_v_del_contabilidad_inventario_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_v_del_contabilidad_inventario_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_del_contabilidad_inventario']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_del_contabilidad_inventario']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_v_del_contabilidad_inventario_config_pivot.php?nome_apl=grid_v_del_contabilidad_inventario&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_v_del_contabilidad_inventario_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_contabilidad_inventario_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_v_del_contabilidad_inventario/grid_v_del_contabilidad_inventario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $kar_fecha = (isset($Busca_temp['kar_fecha'])) ? $Busca_temp['kar_fecha'] : ""; 
          $tmp_pos = (is_string($kar_fecha)) ? strpos($kar_fecha, "##@@") : false;
          if ($tmp_pos !== false && !is_array($kar_fecha))
          {
              $kar_fecha = substr($kar_fecha, 0, $tmp_pos);
          }
          $kar_fecha_2 = (isset($Busca_temp['kar_fecha_input_2'])) ? $Busca_temp['kar_fecha_input_2'] : ""; 
          $kar_bodega = (isset($Busca_temp['kar_bodega'])) ? $Busca_temp['kar_bodega'] : ""; 
          $tmp_pos = (is_string($kar_bodega)) ? strpos($kar_bodega, "##@@") : false;
          if ($tmp_pos !== false && !is_array($kar_bodega))
          {
              $kar_bodega = substr($kar_bodega, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($sum_total_ingreso, $sum_total_salida, $quebra_kar_bodega, $quebra_kar_tipo_movimiento, $quebra_kar_tipo_documento, $quebra_kar_fecha, $quebra_kar_fecha_scgb_16, $quebra_kar_bodega_orig, $quebra_kar_tipo_movimiento_orig, $quebra_kar_tipo_documento_orig, $quebra_kar_fecha_orig, $quebra_kar_fecha_scgb_16_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_contabilidad_inventario']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_total_ingreso)) {$sum_total_ingreso = '0';}
          if (empty($sum_total_salida)) {$sum_total_salida = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_total_ingreso . ';
              $this->' . $arr_name . '[2] = ' . $sum_total_salida . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_total_ingreso . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_total_salida . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->kar_fecha = $Busca_temp['kar_fecha']; 
       $this->kar_fecha = (isset($Busca_temp['kar_fecha'])) ? $Busca_temp['kar_fecha'] : ""; 
       $tmp_pos = (is_string($this->kar_fecha)) ? strpos($this->kar_fecha, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->kar_fecha))
       {
       ...
       $kar_fecha_2 = (isset($Busca_temp['kar_fecha_input_2'])) ? $Busca_temp['kar_fecha_input_2'] : ""; 
       $this->kar_fecha_2 = $kar_fecha_2; 
       $this->kar_bodega = $Busca_temp['kar_bodega']; 
       $this->kar_bodega = (isset($Busca_temp['kar_bodega'])) ? $Busca_temp['kar_bodega'] : ""; 
       $tmp_pos = (is_string($this->kar_bodega)) ? strpos($this->kar_bodega, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->kar_bodega))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->kar_fecha = $rs_res->fields[0] ;  
            $this->kar_tipo_movimiento = $rs_res->fields[1] ;  
            $this->kar_tipo_documento = $rs_res->fields[2] ;  
            $this->descripcion = $rs_res->fields[3] ;  
            $this->total_ingreso = $rs_res->fields[4] ;  
            $this->total_salida = $rs_res->fields[5] ;  
            $this->id = $rs_res->fields[6] ;  
            $this->kar_empresa = $rs_res->fields[7] ;  
            $this->kar_bodega = $rs_res->fields[8] ;  
            $this->kar_documento = $rs_res->fields[9] ;  
            $this->kar_asiento = $rs_res->fields[10] ;  
            $this->kar_bodega_orig = $this->kar_bodega;
            $this->kar_tipo_movimiento_orig = $this->kar_tipo_movimiento;
            $this->kar_tipo_documento_orig = $this->kar_tipo_documento;
            $this->kar_fecha_orig = $this->kar_fecha;
            $this->kar_fecha_scgb_16_orig = $this->kar_fecha_scgb_16;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total_ingreso, $this->total_salida, $this->kar_bodega, $this->kar_tipo_movimiento, $this->kar_tipo_documento, $this->kar_fecha, $this->kar_fecha_scgb_16, $this->kar_bodega_orig,  $this->kar_tipo_movimiento_orig,  $this->kar_tipo_documento_orig,  $this->kar_fecha_orig,  $this->kar_fecha_scgb_16_orig);
            }
   }
//
