...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "kar_fecha";$Nm_numeric[] = "id";$Nm_numeric[] = "kar_bodega";$Nm_numeric[] = "kar_documento";$Nm_numeric[] = "total_ingreso";$Nm_numeric[] = "total_salida";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_kar_fecha_cond" name="kar_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_kar_fecha'), this, 'kar_fecha')">
      ...
      <br><span id="id_hide_kar_fecha"  <?php echo $str_hide_kar_fecha?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_kar_fecha"  <?php echo $str_display_kar_fecha; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_kar_bodega"  <?php echo $str_hide_kar_bodega?>>
<?php
