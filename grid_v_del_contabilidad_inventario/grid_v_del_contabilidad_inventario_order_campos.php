...
<?php
   ...
   $Ord_Cmp = new grid_v_del_contabilidad_inventario_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_del_contabilidad_inventario_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['kar_fecha'] = "kar_fecha";
   $tab_labels["kar_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['labels']["kar_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['labels']["kar_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['kar_tipo_movimiento'] = "on";
   $tab_def_campos['kar_tipo_movimiento'] = "kar_tipo_movimiento";
   $tab_labels["kar_tipo_movimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['labels']["kar_tipo_movimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['labels']["kar_tipo_movimiento"] : "" . $this->Nm_lang['lang_movimiento_kardex'] . "";
   $tab_ger_campos['kar_tipo_documento'] = "on";
   $tab_def_campos['kar_tipo_documento'] = "kar_tipo_documento";
   $tab_labels["kar_tipo_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['labels']["kar_tipo_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['labels']["kar_tipo_documento"] : "" . $this->Nm_lang['lang_modulo'] . "";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['labels']["descripcion"] : "" . $this->Nm_lang['lang_descripcion'] . "";
   $tab_ger_campos['total_ingreso'] = "on";
   $tab_def_campos['total_ingreso'] = "total_ingreso";
   $tab_labels["total_ingreso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['labels']["total_ingreso"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['labels']["total_ingreso"] : "Total Ingreso";
   $tab_ger_campos['total_salida'] = "on";
   $tab_def_campos['total_salida'] = "total_salida";
   $tab_labels["total_salida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['labels']["total_salida"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['labels']["total_salida"] : "Total Salida";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_del_contabilidad_inventario_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_del_contabilidad_inventario']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
