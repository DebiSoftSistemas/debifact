...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____buscar_cliente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____buscar_cliente"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_cliente'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_cliente']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['buscar_cliente']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_cliente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['buscar_cliente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['buscar_cliente']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['buscar_cliente']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['buscar_cliente']['embutida_filho'] as $ind => $sc_init)
          {
