...
class grid_resumen_ventas_usuario_xml
{
   var $Db;
   var $Erro;
   var $Ini;
...
function sc_actionbar_disable($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['SC_Gb_Free_cmp']))
      {
          $this->Tem_xml_res  = false;
      }
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_resumen_ventas_usuario/grid_resumen_ventas_usuario_res_xml.class.php"))
      {
          $this->Tem_xml_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_label']))
      {
          $this->Xml_tag_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_label'];
          $this->New_Format    = true;
      }
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      require_once($this->Ini->path_aplicacao . "grid_resumen_ventas_usuario_total.class.php"); 
      $this->Tot      = new grid_resumen_ventas_usuario_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['SC_Ind_Groupby'];
      if (method_exists($this->Tot,$Gb_geral))
      {
          $this->Tot->$Gb_geral();
          $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['tot_geral'][1];
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['SC_Ind_Groupby'] == "sc_free_group_by")
          {
              $this->sum_fac_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['tot_geral'][2];
              $this->sum_fac_total_descuento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['tot_geral'][3];
              $this->sum_fac_valor_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['tot_geral'][4];
              $this->sum_fac_propina = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['tot_geral'][5];
              $this->sum_fac_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['tot_geral'][6];
              $this->sum_fac_subtotal_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['tot_geral'][7];
              $this->sum_fac_subtotal_cero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['tot_geral'][8];
              $this->sum_fac_subtotal_no_objeto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['tot_geral'][9];
              $this->sum_fac_subtotal_excento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['tot_geral'][10];
              $this->sum_fac_valor_ice = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['tot_geral'][11];
              $this->sum_fac_valor_irbpnr = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['tot_geral'][12];
          }
      }
      $this->nm_data    = new nm_data("es");
      $this->Arquivo      = "sc_xml";
      $this->Arquivo     .= "_" . date("YmdHis") . "_" . rand(0, 1000);
      $this->Arq_zip      = $this->Arquivo . "_grid_resumen_ventas_usuario.zip";
      $this->Arquivo     .= "_grid_resumen_ventas_usuario";
      $this->Arquivo_view = $this->Arquivo . "_view.xml";
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_resumen_ventas_usuario.xml";
      $this->Tit_zip      = "grid_resumen_ventas_usuario.zip";
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas_usuario']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas_usuario']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas_usuario']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['usr_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['php_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_name'] .= ".xml";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_resumo'])) 
      { 
          if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq'])) 
          { 
              $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_resumo']; 
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['order_grid'];
   ...
   $_SESSION['scriptcase']['grid_resumen_ventas_usuario']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_resumen_ventas_usuario']['contr_erro'] = 'off';
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<grid_resumen_ventas_usuario>\r\n";
         }
         else
         {
             $this->xml_registro = "<grid_resumen_ventas_usuario";
...
$_SESSION['scriptcase']['grid_resumen_ventas_usuario']['contr_erro'] = 'off'; 
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['field_order'] as $Cada_col)
         { 
      ...
      { 
          ...
          { 
              ...
              $this->Res = new grid_resumen_ventas_usuario_res_xml();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_res_grid'] = true;
              $this->Res->monta_xml();
          } 
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_res_file']['xml'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_res_file']['xml']);
              }
              if ($this->Grava_view)
              {
                  $str_zip    = "";
                  ...
                  { 
                      $str_zip   = "";
                      $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_res_file']['view'];
                      $Arq_input = (FALSE !== strpos($Arq_res, ' ')) ? " \"" . $Arq_res . "\"" :  $Arq_res;
                      if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                      {
                          $str_zip = "zip.exe " . strtoupper($Parm_pass) . " -j -u " . $this->Xml_password . " " . $Zip_f . " " . $Arq_input;
                      ...
                      unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_res_file']['view']);
                  }
              } 
              else 
              {
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_res_grid']);
          } 
      }
   ...
   function NM_export_fac_total_descuento()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->fac_total_descuento) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->fac_total_descuento) . "\"";
         }
   }
   //----- fac_valor_iva
   function NM_export_fac_valor_iva()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->fac_valor_iva) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->fac_valor_iva) . "\"";
         }
   }
   //----- fac_propina
   function NM_export_fac_propina()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->fac_propina) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->fac_propina) . "\"";
         }
   }
   //----- fac_total
   ...
   function NM_export_fac_subtotal_iva()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->fac_subtotal_iva) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->fac_subtotal_iva) . "\"";
         }
   }
   //----- fac_subtotal_cero
   function NM_export_fac_subtotal_cero()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->fac_subtotal_cero) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->fac_subtotal_cero) . "\"";
         }
   }
   ...
   function NM_export_fac_subtotal_no_objeto()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->fac_subtotal_no_objeto) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->fac_subtotal_no_objeto) . "\"";
         }
   }
   ...
   function NM_export_fac_subtotal_excento()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->fac_subtotal_excento) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->fac_subtotal_excento) . "\"";
         }
   }
   //----- fac_valor_ice
   function NM_export_fac_valor_ice()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->fac_valor_ice) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->fac_valor_ice) . "\"";
         }
   }
   //----- fac_valor_irbpnr
   function NM_export_fac_valor_irbpnr()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->fac_valor_irbpnr) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->fac_valor_irbpnr) . "\"";
         }
   }
   //----- fac_comentario
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_fac_usuario))
         {
             $this->look_fac_usuario = sc_convert_encoding($this->look_fac_usuario, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->look_fac_usuario) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->look_fac_usuario) . "\"";
         }
   }
   //----- fac_autorizacion
   function NM_export_fac_autorizacion()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->fac_autorizacion))
         {
             $this->fac_autorizacion = sc_convert_encoding($this->fac_autorizacion, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->fac_autorizacion) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->fac_autorizacion) . "\"";
         }
   }
   //----- fac_socio_transportista
   function NM_export_fac_socio_transportista()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_fac_socio_transportista))
         {
             $this->look_fac_socio_transportista = sc_convert_encoding($this->look_fac_socio_transportista, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->look_fac_socio_transportista) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->look_fac_socio_transportista) . "\"";
         }
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario'][$path_doc_md5][1] = $this->Tit_doc;
?>
...
<BODY>
<SCRIPT>
    window.location='<?php echo $this->Ini->path_imag_temp . "/" . $this->Arquivo_view; ?>';
</SCRIPT>
</BODY>
</HTML>
<?php
