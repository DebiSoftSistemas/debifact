...
class grid_resumen_ventas_usuario_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_resumen_ventas_usuario_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_resumen_ventas_usuario_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_resumen_ventas_usuario_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_pen_serie($est_codigo)
   {
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['psq_check_ret']['pen_serie'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['psq_check_ret']['pen_serie'][] = trim($rs->fields[0]);
   ...
   function lookup_ajax_cl_identificacion($cl_identificacion)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fac_estado='V' and fac_usuario='" . $_SESSION['Igtech_SesionLogin'] . "') and  #lowerI#cl_identificacion#lowerF# like #lowerI#'%" . $cl_identificacion . "%'#lowerF# order by cl_identificacion"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_cl_nombre($cl_nombre)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fac_estado='V' and fac_usuario='" . $_SESSION['Igtech_SesionLogin'] . "') and  #lowerI#cl_nombre#lowerF# like #lowerI#'%" . $cl_nombre . "%'#lowerF# order by cl_nombre"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_resumen_ventas_usuario/grid_resumen_ventas_usuario_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_resumen_ventas_usuario_ajax_search.js"></script>
 <script type="text/javascript" src="grid_resumen_ventas_usuario_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_resumen_ventas_usuario_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_resumen_ventas_usuario']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_resumen_ventas_usuario']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas_usuario']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas_usuario']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas_usuario']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fac_fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_dia']; 
          $fac_fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_mes']; 
          $fac_fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_ano']; 
          $fac_fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_input_2_dia']; 
          $fac_fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_input_2_mes']; 
          $fac_fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_input_2_ano']; 
          $fac_fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_cond']; 
          $est_codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['est_codigo']; 
          $est_codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['est_codigo_cond']; 
          $pen_serie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['pen_serie']; 
          $pen_serie_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['pen_serie_cond']; 
          $cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['cl_identificacion']; 
          $cl_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['cl_identificacion_cond']; 
          $cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['cl_nombre']; 
          $cl_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['cl_nombre_cond']; 
          $fac_socio_transportista = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_socio_transportista']; 
          $fac_socio_transportista_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_socio_transportista_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['NM_operador']; 
      } 
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['psq_check_ret']['est_codigo'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['psq_check_ret']['est_codigo'][] = trim($rs->fields[0]);
...
<?php
      ...
      $cl_identificacion_look = (is_string($cl_identificacion) ? substr($this->Db->qstr($cl_identificacion), 1, -1) : $cl_identificacion); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fac_estado='V' and fac_usuario='" . $_SESSION['Igtech_SesionLogin'] . "') and #lowerI#cl_identificacion#lowerF# = #lowerI#'$cl_identificacion_look'#lowerF# order by cl_identificacion"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
<?php
      ...
      $cl_nombre_look = (is_string($cl_nombre) ? substr($this->Db->qstr($cl_nombre), 1, -1) : $cl_nombre); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (fac_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fac_estado='V' and fac_usuario='" . $_SESSION['Igtech_SesionLogin'] . "') and #lowerI#cl_nombre#lowerF# = #lowerI#'$cl_nombre_look'#lowerF# order by cl_nombre"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cl_nombre" id="id_ac_cl_nombre" name="cl_nombre_autocomp"><?php if ('' !=  $cl_nombre) { ?><option value="<?php echo $cl_nombre ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_fac_socio_transportista_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fac_socio_transportista'])) ? $this->New_label['fac_socio_transportista'] : "" . $this->Ini->Nm_lang['lang_socio'] . ""; ?></TD>
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['psq_check_ret']['fac_socio_transportista'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['psq_check_ret']['fac_socio_transportista'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_fac_socio_transportista_orig" name="fac_socio_transportista_orig" size=7 multiple onDblClick="nm_add_sel('fac_socio_transportista_orig', 'fac_socio_transportista_dest', 'N' , '')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
   ...
   <td>
    <SELECT class="scFilterObjectEven" id="SC_fac_socio_transportista_dest" name="fac_socio_transportista_dest" size=7 multiple  onDblClick="nm_del_sel('fac_socio_transportista_dest', 'fac_socio_transportista_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_resumen_ventas_usuario_help.txt"))
   {
      $Arq_WebHelp = file("grid_resumen_ventas_usuario_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas_usuario']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_resumen_ventas_usuario']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_fac_fecha_dia').bind('change', function() {sc_grid_resumen_ventas_usuario_valida_dia(this)});
    $('#SC_fac_fecha_input_2_dia').bind('change', function() {sc_grid_resumen_ventas_usuario_valida_dia(this)});
    $('#SC_fac_fecha_input_2_mes').bind('change', function() {sc_grid_resumen_ventas_usuario_valida_mes(this)});
    $('#SC_fac_fecha_mes').bind('change', function() {sc_grid_resumen_ventas_usuario_valida_mes(this)});
 }
 function sc_grid_resumen_ventas_usuario_valida_dia(obj)
 {
 ...
 function sc_grid_resumen_ventas_usuario_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "debi_doc_electronicos/grid_resumen_ventas_usuario";
   ...
   function inicializa_vars()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['pesq_tab_label'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_resumen_ventas_usuario/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca'] as $Cmps => $Vals)
          {
              if ($Cmps == 'est_codigo' || $Cmps == 'pen_serie' || $Cmps == 'fac_socio_transportista')
              {
                  $$Cmps = implode("@?@", $Vals);
              }
              else
      ...
      if (is_array($est_codigo)) {
          foreach ($est_codigo as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['psq_check_ret']['est_codigo'])) {
      ...
      if (is_array($pen_serie)) {
          foreach ($pen_serie as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['psq_check_ret']['pen_serie'])) {
      ...
      if (is_array($fac_socio_transportista)) {
          foreach ($fac_socio_transportista as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['psq_check_ret']['fac_socio_transportista'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_dia'] = $fac_fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_mes'] = $fac_fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_ano'] = $fac_fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_input_2_dia'] = $fac_fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_input_2_mes'] = $fac_fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_input_2_ano'] = $fac_fecha_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fac_fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fac_fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fac_fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fac_fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fac_fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fac_fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_cond'] = $fac_fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['cmp'] = "fac_fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['opc'] = $fac_fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['fac_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['est_codigo'] = $est_codigo; 
      if (is_array($est_codigo) && !empty($est_codigo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0] = $est_codigo;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0][0] = $est_codigo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['est_codigo_cond'] = $est_codigo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['cmp'] = "est_codigo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['opc'] = $est_codigo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['est_codigo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['pen_serie'] = $pen_serie; 
      if (is_array($pen_serie) && !empty($pen_serie))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0] = $pen_serie;
      }
      elseif ($pen_serie_cond_salva == "nu" || $pen_serie_cond_salva == "nn" || $pen_serie_cond_salva == "ep" || $pen_serie_cond_salva == "ne" || !empty($pen_serie))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0][0] = $pen_serie;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['pen_serie_cond'] = $pen_serie_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['cmp'] = "pen_serie"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['opc'] = $pen_serie_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['pen_serie'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['cl_identificacion'] = $cl_identificacion; 
      if (is_array($cl_identificacion) && !empty($cl_identificacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0] = $cl_identificacion;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0][0] = $cl_identificacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['cl_identificacion_cond'] = $cl_identificacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['cmp'] = "cl_identificacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['opc'] = $cl_identificacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['cl_identificacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['cl_nombre'] = $cl_nombre; 
      if (is_array($cl_nombre) && !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0] = $cl_nombre;
      }
      elseif ($cl_nombre_cond_salva == "nu" || $cl_nombre_cond_salva == "nn" || $cl_nombre_cond_salva == "ep" || $cl_nombre_cond_salva == "ne" || !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0][0] = $cl_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['cl_nombre_cond'] = $cl_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['cmp'] = "cl_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['opc'] = $cl_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['cl_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_socio_transportista'] = $fac_socio_transportista; 
      if (is_array($fac_socio_transportista) && !empty($fac_socio_transportista))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0] = $fac_socio_transportista;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['val'][0][0] = $fac_socio_transportista;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_socio_transportista_cond'] = $fac_socio_transportista_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['cmp'] = "fac_socio_transportista"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid]['opc'] = $fac_socio_transportista_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['fac_socio_transportista'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['est_codigo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['est_codigo'];
      $this->cmp_formatado['est_codigo_input_2'] = $est_codigo_input_2;
      $this->cmp_formatado['pen_serie'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['pen_serie'];
    ...
    if ($cl_nombre != '') {
      ...
      $this->cmp_formatado['fac_socio_transportista'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_socio_transportista'];
      ...
      if ($fac_fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha'] = $val[0];
          ...
          if ($fac_fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']['fac_fecha_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['fac_fecha']['label'] = $nmgp_tab_label['fac_fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['fac_fecha']['descr'] = $nmgp_tab_label['fac_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['fac_fecha']['hint']  = $nmgp_tab_label['fac_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      if (is_array($est_codigo) && count($est_codigo) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label['est_codigo'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['est_codigo']['label'] = $nmgp_tab_label['est_codigo'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['est_codigo']['descr'] = $nmgp_tab_label['est_codigo'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['est_codigo']['hint'] = $nmgp_tab_label['est_codigo'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      ...
      if (is_array($pen_serie) && count($pen_serie) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label['pen_serie'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['pen_serie']['label'] = $nmgp_tab_label['pen_serie'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['pen_serie']['descr'] = $nmgp_tab_label['pen_serie'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['pen_serie']['hint'] = $nmgp_tab_label['pen_serie'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      ...
      if (is_array($fac_socio_transportista) && count($fac_socio_transportista) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $nmgp_tab_label['fac_socio_transportista'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['fac_socio_transportista']['label'] = $nmgp_tab_label['fac_socio_transportista'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['fac_socio_transportista']['descr'] = $nmgp_tab_label['fac_socio_transportista'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['grid_pesq']['fac_socio_transportista']['hint'] = $nmgp_tab_label['fac_socio_transportista'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['cond_pesq'] .= $this->NM_operador;
