...
?>
   <span id="idAjaxSelect_fac_socio_transportista">
      <SELECT class="scFilterObjectEven" id="SC_fac_socio_transportista" name="fac_socio_transportista[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "fac_socio_transportista" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
