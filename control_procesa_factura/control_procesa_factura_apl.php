<?php
//
class control_procesa_factura_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new control_procesa_factura_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['control_procesa_factura']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_procesa_factura']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_procesa_factura'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_procesa_factura']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_procesa_factura']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('control_procesa_factura') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_procesa_factura']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "control_procesa_factura")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['control_procesa_factura']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['control_procesa_factura'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_procesa_factura']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_procesa_factura'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_procesa_factura'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'control_procesa_factura_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'control_procesa_factura_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'control_procesa_factura/control_procesa_factura_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "control_procesa_factura_erro.class.php"); 
      }
      $this->Erro      = new control_procesa_factura_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['control_procesa_factura']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['control_procesa_factura']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['control_procesa_factura']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->fac_estado_sri = "" ;  
          $this->fac_estado = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos']))
              { 
                  $fr_total = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][0]; 
                  $fr_cedula = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][1]; 
                  $fac_tipo_libretin = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][2]; 
                  $fr_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][3]; 
                  $fac_libretin = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][4]; 
                  $fr_provincia = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][5]; 
                  $fr_canton = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][6]; 
                  $fr_direccion = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][7]; 
                  $fr_tipo_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][8]; 
                  $fr_correo = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][9]; 
                  $fac_estado_sri = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][10]; 
                  $fr_telefono = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][11]; 
                  $fr_forma_pago = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][12]; 
                  $fr_valor = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][13]; 
                  $fr_forma_pago2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][14]; 
                  $fr_valor2 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][15]; 
                  $fr_forma_pago3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][16]; 
                  $fr_valor3 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][17]; 
                  $fr_comentario = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][18]; 
                  $total_pago = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][19]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][0] = $this->fr_total; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][1] = $this->fr_cedula; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][2] = $this->fac_tipo_libretin; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][3] = $this->fr_nombre; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][4] = $this->fac_libretin; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][5] = $this->fr_provincia; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][6] = $this->fr_canton; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][7] = $this->fr_direccion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][8] = $this->fr_tipo_identificacion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][9] = $this->fr_correo; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][10] = $this->fac_estado_sri; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][11] = $this->fr_telefono; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][12] = $this->fr_forma_pago; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][13] = $this->fr_valor; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][14] = $this->fr_forma_pago2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][15] = $this->fr_valor2; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][16] = $this->fr_forma_pago3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][17] = $this->fr_valor3; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][18] = $this->fr_comentario; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['campos'][19] = $this->total_pago; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("control_procesa_factura", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("control_procesa_factura_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "control_procesa_factura.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="control_procesa_factura_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="control_procesa_factura"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'control_procesa_factura', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'control_procesa_factura', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'control_procesa_factura', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_control_procesa_factura']) || !is_array($this->NM_ajax_info['errList']['geral_control_procesa_factura']))
              {
                  $this->NM_ajax_info['errList']['geral_control_procesa_factura'] = array();
              }
              $this->NM_ajax_info['errList']['geral_control_procesa_factura'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      {
      $_SESSION['scriptcase']['control_procesa_factura']['contr_erro'] = 'on';
...
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_control_procesa_factura';
...
$_SESSION['scriptcase']['control_procesa_factura']['contr_erro'] = 'off'; 
    ...
    function ValidateField_fr_cedula(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_cedula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_cedula'] == "on")) 
      { 
          if ($this->fr_cedula == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_fr_nombre(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_nombre'] == "on")) 
      { 
          if ($this->fr_nombre == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['fr_provincia'])) {
      ...
      if ($this->fr_provincia == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_provincia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_provincia'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->fr_provincia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_provincia']) && !in_array($this->fr_provincia, $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_provincia']))
          {
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['fr_canton'])) {
      ...
      if ($this->fr_canton == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_canton']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_canton'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->fr_canton) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_canton']) && !in_array($this->fr_canton, $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_canton']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['fr_canton']))
    ...
    function ValidateField_fr_direccion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_direccion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_direccion'] == "on")) 
      { 
    ...
    function ValidateField_fr_tipo_identificacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_tipo_identificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_tipo_identificacion'] == "on")) 
      { 
    ...
    function ValidateField_fr_correo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_correo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_correo'] == "on")) 
      { 
          if ($this->fr_correo == "")  
          { 
              $hasError = true;
...
;
   ...
   if (isset($this->Field_no_validate['fr_forma_pago'])) {
      ...
      if ($this->fr_forma_pago == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_forma_pago']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_forma_pago'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->fr_forma_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago']) && !in_array($this->fr_forma_pago, $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['fr_forma_pago']))
    ...
    function ValidateField_fr_valor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_valor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_valor'] == "on") 
           { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['fr_forma_pago2'])) {
       return;
               ...
               if (!empty($this->fr_forma_pago2) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago2']) && !in_array($this->fr_forma_pago2, $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago2']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['fr_forma_pago3'])) {
       return;
               ...
               if (!empty($this->fr_forma_pago3) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago3']) && !in_array($this->fr_forma_pago3, $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago3']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dados_form'] = $this->nmgp_dados_form;
   }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_provincia']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_provincia'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_provincia']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_provincia'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(control_procesa_factura_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', control_procesa_factura_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_provincia'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fr_provincia']['valList'][$i] = control_procesa_factura_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_canton']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_canton'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_canton']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_canton'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_canton'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fr_canton']['valList'][$i] = control_procesa_factura_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fr_forma_pago']['valList'][$i] = control_procesa_factura_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago2']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago2'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago2']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago2'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago2'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fr_forma_pago2']['valList'][$i] = control_procesa_factura_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago3']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago3'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago3']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago3'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['Lookup_fr_forma_pago3'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fr_forma_pago3']['valList'][$i] = control_procesa_factura_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_total_pago($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
$_SESSION['scriptcase']['control_procesa_factura']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("control_procesa_factura_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "control_procesa_factura_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['nm_run_menu'] = 2;
       $nmgp_saida_form = "control_procesa_factura_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['ordem_ord'] == " desc") {
