<form name="F2" method=post 
               action="form_del_retencion_mob.php" 
               target="_self"> 
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_retencion_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_retencion_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_del_retencion_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
    do_ajax_form_del_retencion_mob_event_scajaxbutton_enviar_onclick();
}
...
{
    do_ajax_form_del_retencion_mob_event_scajaxbutton_anular_onclick();
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_retencion_mob']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_form_del_retencion_mob_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_del_retencion_mob_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
