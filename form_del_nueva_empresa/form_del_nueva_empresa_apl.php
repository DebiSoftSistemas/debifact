...
;
   ...
   if (isset($this->Field_no_validate['emp_obligado'])) {
    ...
    function ValidateField_emp_usuario(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_usuario'] == "on")) 
      { 
          if ($this->emp_usuario == "")  
          { 
              $hasError = true;
...
;
    ...
    function ValidateField_emp_clave(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_clave']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_clave'] == "on")) 
      { 
          if ($this->emp_clave == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_emp_clave_reingreso(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_clave_reingreso']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_clave_reingreso'] == "on")) 
      { 
