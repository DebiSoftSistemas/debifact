  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_nueva_empresa" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_nueva_empresa_form();
	}
...
?>
  ...
  function do_ajax_form_del_nueva_empresa_validate_emp_comisionista()
  {
    ...
    x_ajax_form_del_nueva_empresa_validate_emp_comisionista(var_emp_comisionista, var_script_case_init, do_ajax_form_del_nueva_empresa_validate_emp_comisionista_cb);
  } // do_ajax_form_del_nueva_empresa_validate_emp_comisionista

  function do_ajax_form_del_nueva_empresa_validate_emp_comisionista_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_validate_emp_comisionista_cb

  // ---------- Validate emp_ruc
  function do_ajax_form_del_nueva_empresa_validate_emp_ruc()
  {
    var nomeCampo_emp_ruc = "emp_ruc";
    var var_emp_ruc = scAjaxGetFieldText(nomeCampo_emp_ruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_validate_emp_ruc(var_emp_ruc, var_script_case_init, do_ajax_form_del_nueva_empresa_validate_emp_ruc_cb);
  } // do_ajax_form_del_nueva_empresa_validate_emp_ruc

  function do_ajax_form_del_nueva_empresa_validate_emp_ruc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emp_ruc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_validate_emp_ruc_cb

  // ---------- Validate emp_razon_social
  function do_ajax_form_del_nueva_empresa_validate_emp_razon_social()
  {
    var nomeCampo_emp_razon_social = "emp_razon_social";
    var var_emp_razon_social = scAjaxGetFieldText(nomeCampo_emp_razon_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_validate_emp_razon_social(var_emp_razon_social, var_script_case_init, do_ajax_form_del_nueva_empresa_validate_emp_razon_social_cb);
  } // do_ajax_form_del_nueva_empresa_validate_emp_razon_social

  function do_ajax_form_del_nueva_empresa_validate_emp_razon_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_validate_emp_razon_social_cb

  // ---------- Validate emp_nombre_comercial
  function do_ajax_form_del_nueva_empresa_validate_emp_nombre_comercial()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_validate_emp_nombre_comercial(var_emp_nombre_comercial, var_script_case_init, do_ajax_form_del_nueva_empresa_validate_emp_nombre_comercial_cb);
  } // do_ajax_form_del_nueva_empresa_validate_emp_nombre_comercial

  function do_ajax_form_del_nueva_empresa_validate_emp_nombre_comercial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_validate_emp_nombre_comercial_cb

  // ---------- Validate emp_email
  function do_ajax_form_del_nueva_empresa_validate_emp_email()
  {
    var nomeCampo_emp_email = "emp_email";
    var var_emp_email = scAjaxGetFieldText(nomeCampo_emp_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_validate_emp_email(var_emp_email, var_script_case_init, do_ajax_form_del_nueva_empresa_validate_emp_email_cb);
  } // do_ajax_form_del_nueva_empresa_validate_emp_email

  function do_ajax_form_del_nueva_empresa_validate_emp_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_validate_emp_email_cb

  // ---------- Validate emp_obligado
  function do_ajax_form_del_nueva_empresa_validate_emp_obligado()
  {
    var nomeCampo_emp_obligado = "emp_obligado";
    var var_emp_obligado = scAjaxGetFieldCheckbox(nomeCampo_emp_obligado, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_validate_emp_obligado(var_emp_obligado, var_script_case_init, do_ajax_form_del_nueva_empresa_validate_emp_obligado_cb);
  } // do_ajax_form_del_nueva_empresa_validate_emp_obligado

  function do_ajax_form_del_nueva_empresa_validate_emp_obligado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_validate_emp_obligado_cb

  // ---------- Validate emp_contribuyente_especial
  function do_ajax_form_del_nueva_empresa_validate_emp_contribuyente_especial()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_validate_emp_contribuyente_especial(var_emp_contribuyente_especial, var_script_case_init, do_ajax_form_del_nueva_empresa_validate_emp_contribuyente_especial_cb);
  } // do_ajax_form_del_nueva_empresa_validate_emp_contribuyente_especial

  function do_ajax_form_del_nueva_empresa_validate_emp_contribuyente_especial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_validate_emp_contribuyente_especial_cb

  // ---------- Validate emp_ambiente_sri
  function do_ajax_form_del_nueva_empresa_validate_emp_ambiente_sri()
  {
    var nomeCampo_emp_ambiente_sri = "emp_ambiente_sri";
    var var_emp_ambiente_sri = scAjaxGetFieldText(nomeCampo_emp_ambiente_sri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_validate_emp_ambiente_sri(var_emp_ambiente_sri, var_script_case_init, do_ajax_form_del_nueva_empresa_validate_emp_ambiente_sri_cb);
  } // do_ajax_form_del_nueva_empresa_validate_emp_ambiente_sri

  function do_ajax_form_del_nueva_empresa_validate_emp_ambiente_sri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_validate_emp_ambiente_sri_cb

  // ---------- Validate emp_usuario
  function do_ajax_form_del_nueva_empresa_validate_emp_usuario()
  {
    var nomeCampo_emp_usuario = "emp_usuario";
    var var_emp_usuario = scAjaxGetFieldText(nomeCampo_emp_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_validate_emp_usuario(var_emp_usuario, var_script_case_init, do_ajax_form_del_nueva_empresa_validate_emp_usuario_cb);
  } // do_ajax_form_del_nueva_empresa_validate_emp_usuario

  function do_ajax_form_del_nueva_empresa_validate_emp_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_validate_emp_usuario_cb

  // ---------- Validate emp_clave
  function do_ajax_form_del_nueva_empresa_validate_emp_clave()
  {
    var nomeCampo_emp_clave = "emp_clave";
    var var_emp_clave = scAjaxGetFieldText(nomeCampo_emp_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_validate_emp_clave(var_emp_clave, var_script_case_init, do_ajax_form_del_nueva_empresa_validate_emp_clave_cb);
  } // do_ajax_form_del_nueva_empresa_validate_emp_clave

  function do_ajax_form_del_nueva_empresa_validate_emp_clave_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_validate_emp_clave_cb

  // ---------- Validate emp_clave_reingreso
  function do_ajax_form_del_nueva_empresa_validate_emp_clave_reingreso()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_validate_emp_clave_reingreso(var_emp_clave_reingreso, var_script_case_init, do_ajax_form_del_nueva_empresa_validate_emp_clave_reingreso_cb);
  } // do_ajax_form_del_nueva_empresa_validate_emp_clave_reingreso

  function do_ajax_form_del_nueva_empresa_validate_emp_clave_reingreso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_validate_emp_clave_reingreso_cb

  // ---------- Validate mensaje
  function do_ajax_form_del_nueva_empresa_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldHidden(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_form_del_nueva_empresa_validate_mensaje_cb);
  } // do_ajax_form_del_nueva_empresa_validate_mensaje

  function do_ajax_form_del_nueva_empresa_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_validate_mensaje_cb

  // ---------- Event onchange emp_obligado
  function do_ajax_form_del_nueva_empresa_event_emp_obligado_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_del_nueva_empresa_event_emp_obligado_onchange(var_emp_obligado, var_emp_contribuyente_especial, var_script_case_init, do_ajax_form_del_nueva_empresa_event_emp_obligado_onchange_cb);
  } // do_ajax_form_del_nueva_empresa_event_emp_obligado_onchange

  function do_ajax_form_del_nueva_empresa_event_emp_obligado_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "emp_obligado";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_nueva_empresa_event_emp_obligado_onchange_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_event_emp_obligado_onchange_cb
  function do_ajax_form_del_nueva_empresa_event_emp_obligado_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_nueva_empresa_event_emp_obligado_onchange_cb_after_alert

  // ---------- Event onblur emp_usuario
  function do_ajax_form_del_nueva_empresa_event_emp_usuario_onblur()
  {
    var var_emp_usuario = scAjaxGetFieldText("emp_usuario");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_nueva_empresa_event_emp_usuario_onblur(var_emp_usuario, var_script_case_init, do_ajax_form_del_nueva_empresa_event_emp_usuario_onblur_cb);
  } // do_ajax_form_del_nueva_empresa_event_emp_usuario_onblur

  function do_ajax_form_del_nueva_empresa_event_emp_usuario_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "emp_usuario";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_nueva_empresa_event_emp_usuario_onblur_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_event_emp_usuario_onblur_cb
  function do_ajax_form_del_nueva_empresa_event_emp_usuario_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_nueva_empresa_event_emp_usuario_onblur_cb_after_alert

  // ---------- Event onblur emp_clave
  function do_ajax_form_del_nueva_empresa_event_emp_clave_onblur()
  {
    var var_emp_clave = scAjaxGetFieldText("emp_clave");
    var var_emp_usuario = scAjaxGetFieldText("emp_usuario");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_nueva_empresa_event_emp_clave_onblur(var_emp_clave, var_emp_usuario, var_script_case_init, do_ajax_form_del_nueva_empresa_event_emp_clave_onblur_cb);
  } // do_ajax_form_del_nueva_empresa_event_emp_clave_onblur

  function do_ajax_form_del_nueva_empresa_event_emp_clave_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "emp_clave";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_nueva_empresa_event_emp_clave_onblur_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_event_emp_clave_onblur_cb
  function do_ajax_form_del_nueva_empresa_event_emp_clave_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_nueva_empresa_event_emp_clave_onblur_cb_after_alert

  // ---------- Event onblur emp_clave_reingreso
  function do_ajax_form_del_nueva_empresa_event_emp_clave_reingreso_onblur()
  {
    var var_emp_clave = scAjaxGetFieldText("emp_clave");
    var var_emp_clave_reingreso = scAjaxGetFieldText("emp_clave_reingreso");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_nueva_empresa_event_emp_clave_reingreso_onblur(var_emp_clave, var_emp_clave_reingreso, var_script_case_init, do_ajax_form_del_nueva_empresa_event_emp_clave_reingreso_onblur_cb);
  } // do_ajax_form_del_nueva_empresa_event_emp_clave_reingreso_onblur

  function do_ajax_form_del_nueva_empresa_event_emp_clave_reingreso_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "emp_clave_reingreso";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_nueva_empresa_event_emp_clave_reingreso_onblur_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_event_emp_clave_reingreso_onblur_cb
  function do_ajax_form_del_nueva_empresa_event_emp_clave_reingreso_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_nueva_empresa_event_emp_clave_reingreso_onblur_cb_after_alert

  // ---------- Event onblur emp_ruc
  function do_ajax_form_del_nueva_empresa_event_emp_ruc_onblur()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_nueva_empresa_event_emp_ruc_onblur(var_emp_ruc, var_emp_razon_social, var_emp_nombre_comercial, var_emp_obligado, var_emp_email, var_script_case_init, do_ajax_form_del_nueva_empresa_event_emp_ruc_onblur_cb);
  } // do_ajax_form_del_nueva_empresa_event_emp_ruc_onblur

  function do_ajax_form_del_nueva_empresa_event_emp_ruc_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "emp_ruc";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_nueva_empresa_event_emp_ruc_onblur_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_event_emp_ruc_onblur_cb
  function do_ajax_form_del_nueva_empresa_event_emp_ruc_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_nueva_empresa_event_emp_ruc_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_nueva_empresa_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_nueva_empresa_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_nueva_empresa_submit_form(var_emp_comisionista, var_emp_ruc, var_emp_razon_social, var_emp_nombre_comercial, var_emp_email, var_emp_obligado, var_emp_contribuyente_especial, var_emp_ambiente_sri, var_emp_usuario, var_emp_clave, var_emp_clave_reingreso, var_mensaje, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_nueva_empresa_submit_form_cb);
  } // do_ajax_form_del_nueva_empresa_submit_form

  function do_ajax_form_del_nueva_empresa_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_nueva_empresa_submit_form_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_submit_form_cb
  function do_ajax_form_del_nueva_empresa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_nueva_empresa_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_nueva_empresa_navigate_form()
  {
    perform_ajax_form_del_nueva_empresa_navigate_form();
  }

  function perform_ajax_form_del_nueva_empresa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_nueva_empresa_navigate_form(var_emp_ruc, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_nueva_empresa_navigate_form_cb);
  } // do_ajax_form_del_nueva_empresa_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_nueva_empresa_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_nueva_empresa_navigate_form_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_navigate_form_cb
  function do_ajax_form_del_nueva_empresa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_nueva_empresa_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_nueva_empresa_navigate_form_cb_after_alert

  function sc_hide_form_del_nueva_empresa_form()
  {
