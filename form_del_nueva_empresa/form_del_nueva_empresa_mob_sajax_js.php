  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_nueva_empresa_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_nueva_empresa_mob_form();
	}
...
?>
  ...
  // ---------- Validate emp_comisionista
  function do_ajax_form_del_nueva_empresa_mob_validate_emp_comisionista()
  {
    var nomeCampo_emp_comisionista = "emp_comisionista";
    var var_emp_comisionista = scAjaxGetFieldSelect(nomeCampo_emp_comisionista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_mob_validate_emp_comisionista(var_emp_comisionista, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_validate_emp_comisionista_cb);
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_comisionista

  function do_ajax_form_del_nueva_empresa_mob_validate_emp_comisionista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emp_comisionista";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_comisionista_cb

  // ---------- Validate emp_ruc
  function do_ajax_form_del_nueva_empresa_mob_validate_emp_ruc()
  {
    var nomeCampo_emp_ruc = "emp_ruc";
    var var_emp_ruc = scAjaxGetFieldText(nomeCampo_emp_ruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_mob_validate_emp_ruc(var_emp_ruc, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_validate_emp_ruc_cb);
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_ruc

  function do_ajax_form_del_nueva_empresa_mob_validate_emp_ruc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emp_ruc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_ruc_cb

  // ---------- Validate emp_razon_social
  function do_ajax_form_del_nueva_empresa_mob_validate_emp_razon_social()
  {
    var nomeCampo_emp_razon_social = "emp_razon_social";
    var var_emp_razon_social = scAjaxGetFieldText(nomeCampo_emp_razon_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_mob_validate_emp_razon_social(var_emp_razon_social, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_validate_emp_razon_social_cb);
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_razon_social

  function do_ajax_form_del_nueva_empresa_mob_validate_emp_razon_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_razon_social_cb

  // ---------- Validate emp_nombre_comercial
  function do_ajax_form_del_nueva_empresa_mob_validate_emp_nombre_comercial()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_mob_validate_emp_nombre_comercial(var_emp_nombre_comercial, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_validate_emp_nombre_comercial_cb);
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_nombre_comercial

  function do_ajax_form_del_nueva_empresa_mob_validate_emp_nombre_comercial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_nombre_comercial_cb

  // ---------- Validate emp_email
  function do_ajax_form_del_nueva_empresa_mob_validate_emp_email()
  {
    var nomeCampo_emp_email = "emp_email";
    var var_emp_email = scAjaxGetFieldText(nomeCampo_emp_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_mob_validate_emp_email(var_emp_email, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_validate_emp_email_cb);
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_email

  function do_ajax_form_del_nueva_empresa_mob_validate_emp_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_email_cb

  // ---------- Validate emp_obligado
  function do_ajax_form_del_nueva_empresa_mob_validate_emp_obligado()
  {
    var nomeCampo_emp_obligado = "emp_obligado";
    var var_emp_obligado = scAjaxGetFieldCheckbox(nomeCampo_emp_obligado, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_mob_validate_emp_obligado(var_emp_obligado, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_validate_emp_obligado_cb);
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_obligado

  function do_ajax_form_del_nueva_empresa_mob_validate_emp_obligado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_obligado_cb

  // ---------- Validate emp_contribuyente_especial
  function do_ajax_form_del_nueva_empresa_mob_validate_emp_contribuyente_especial()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_mob_validate_emp_contribuyente_especial(var_emp_contribuyente_especial, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_validate_emp_contribuyente_especial_cb);
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_contribuyente_especial

  function do_ajax_form_del_nueva_empresa_mob_validate_emp_contribuyente_especial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_contribuyente_especial_cb

  // ---------- Validate emp_ambiente_sri
  function do_ajax_form_del_nueva_empresa_mob_validate_emp_ambiente_sri()
  {
    var nomeCampo_emp_ambiente_sri = "emp_ambiente_sri";
    var var_emp_ambiente_sri = scAjaxGetFieldText(nomeCampo_emp_ambiente_sri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_mob_validate_emp_ambiente_sri(var_emp_ambiente_sri, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_validate_emp_ambiente_sri_cb);
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_ambiente_sri

  function do_ajax_form_del_nueva_empresa_mob_validate_emp_ambiente_sri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_ambiente_sri_cb

  // ---------- Validate emp_usuario
  function do_ajax_form_del_nueva_empresa_mob_validate_emp_usuario()
  {
    var nomeCampo_emp_usuario = "emp_usuario";
    var var_emp_usuario = scAjaxGetFieldText(nomeCampo_emp_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_mob_validate_emp_usuario(var_emp_usuario, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_validate_emp_usuario_cb);
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_usuario

  function do_ajax_form_del_nueva_empresa_mob_validate_emp_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emp_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_usuario_cb

  // ---------- Validate emp_clave
  function do_ajax_form_del_nueva_empresa_mob_validate_emp_clave()
  {
    var nomeCampo_emp_clave = "emp_clave";
    var var_emp_clave = scAjaxGetFieldText(nomeCampo_emp_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_mob_validate_emp_clave(var_emp_clave, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_validate_emp_clave_cb);
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_clave

  function do_ajax_form_del_nueva_empresa_mob_validate_emp_clave_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emp_clave";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_clave_cb

  // ---------- Validate emp_clave_reingreso
  function do_ajax_form_del_nueva_empresa_mob_validate_emp_clave_reingreso()
  {
    var nomeCampo_emp_clave_reingreso = "emp_clave_reingreso";
    var var_emp_clave_reingreso = scAjaxGetFieldText(nomeCampo_emp_clave_reingreso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_mob_validate_emp_clave_reingreso(var_emp_clave_reingreso, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_validate_emp_clave_reingreso_cb);
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_clave_reingreso

  function do_ajax_form_del_nueva_empresa_mob_validate_emp_clave_reingreso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emp_clave_reingreso";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_mob_validate_emp_clave_reingreso_cb

  // ---------- Validate mensaje
  function do_ajax_form_del_nueva_empresa_mob_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldHidden(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_nueva_empresa_mob_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_validate_mensaje_cb);
  } // do_ajax_form_del_nueva_empresa_mob_validate_mensaje

  function do_ajax_form_del_nueva_empresa_mob_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_nueva_empresa_mob_validate_mensaje_cb

  // ---------- Event onchange emp_obligado
  function do_ajax_form_del_nueva_empresa_mob_event_emp_obligado_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_del_nueva_empresa_mob_event_emp_obligado_onchange(var_emp_obligado, var_emp_contribuyente_especial, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_event_emp_obligado_onchange_cb);
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_obligado_onchange

  function do_ajax_form_del_nueva_empresa_mob_event_emp_obligado_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "emp_obligado";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_nueva_empresa_mob_event_emp_obligado_onchange_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_obligado_onchange_cb
  function do_ajax_form_del_nueva_empresa_mob_event_emp_obligado_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_obligado_onchange_cb_after_alert

  // ---------- Event onblur emp_usuario
  function do_ajax_form_del_nueva_empresa_mob_event_emp_usuario_onblur()
  {
    var var_emp_usuario = scAjaxGetFieldText("emp_usuario");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_nueva_empresa_mob_event_emp_usuario_onblur(var_emp_usuario, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_event_emp_usuario_onblur_cb);
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_usuario_onblur

  function do_ajax_form_del_nueva_empresa_mob_event_emp_usuario_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "emp_usuario";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_nueva_empresa_mob_event_emp_usuario_onblur_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_usuario_onblur_cb
  function do_ajax_form_del_nueva_empresa_mob_event_emp_usuario_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_usuario_onblur_cb_after_alert

  // ---------- Event onblur emp_clave
  function do_ajax_form_del_nueva_empresa_mob_event_emp_clave_onblur()
  {
    var var_emp_clave = scAjaxGetFieldText("emp_clave");
    var var_emp_usuario = scAjaxGetFieldText("emp_usuario");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_nueva_empresa_mob_event_emp_clave_onblur(var_emp_clave, var_emp_usuario, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_event_emp_clave_onblur_cb);
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_clave_onblur

  function do_ajax_form_del_nueva_empresa_mob_event_emp_clave_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "emp_clave";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_nueva_empresa_mob_event_emp_clave_onblur_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_clave_onblur_cb
  function do_ajax_form_del_nueva_empresa_mob_event_emp_clave_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_clave_onblur_cb_after_alert

  // ---------- Event onblur emp_clave_reingreso
  function do_ajax_form_del_nueva_empresa_mob_event_emp_clave_reingreso_onblur()
  {
    var var_emp_clave = scAjaxGetFieldText("emp_clave");
    var var_emp_clave_reingreso = scAjaxGetFieldText("emp_clave_reingreso");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_nueva_empresa_mob_event_emp_clave_reingreso_onblur(var_emp_clave, var_emp_clave_reingreso, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_event_emp_clave_reingreso_onblur_cb);
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_clave_reingreso_onblur

  function do_ajax_form_del_nueva_empresa_mob_event_emp_clave_reingreso_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "emp_clave_reingreso";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_nueva_empresa_mob_event_emp_clave_reingreso_onblur_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_clave_reingreso_onblur_cb
  function do_ajax_form_del_nueva_empresa_mob_event_emp_clave_reingreso_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_clave_reingreso_onblur_cb_after_alert

  // ---------- Event onblur emp_ruc
  function do_ajax_form_del_nueva_empresa_mob_event_emp_ruc_onblur()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_nueva_empresa_mob_event_emp_ruc_onblur(var_emp_ruc, var_emp_razon_social, var_emp_nombre_comercial, var_emp_obligado, var_emp_email, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_event_emp_ruc_onblur_cb);
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_ruc_onblur

  function do_ajax_form_del_nueva_empresa_mob_event_emp_ruc_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "emp_ruc";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_nueva_empresa_mob_event_emp_ruc_onblur_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_ruc_onblur_cb
  function do_ajax_form_del_nueva_empresa_mob_event_emp_ruc_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_nueva_empresa_mob_event_emp_ruc_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_nueva_empresa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_nueva_empresa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_emp_comisionista = scAjaxGetFieldSelect("emp_comisionista");
    var var_emp_ruc = scAjaxGetFieldText("emp_ruc");
    var var_emp_razon_social = scAjaxGetFieldText("emp_razon_social");
    var var_emp_nombre_comercial = scAjaxGetFieldText("emp_nombre_comercial");
    var var_emp_email = scAjaxGetFieldText("emp_email");
    var var_emp_obligado = scAjaxGetFieldCheckbox("emp_obligado", ";");
    var var_emp_contribuyente_especial = scAjaxGetFieldText("emp_contribuyente_especial");
    var var_emp_ambiente_sri = scAjaxGetFieldText("emp_ambiente_sri");
    var var_emp_usuario = scAjaxGetFieldText("emp_usuario");
    var var_emp_clave = scAjaxGetFieldText("emp_clave");
    var var_emp_clave_reingreso = scAjaxGetFieldText("emp_clave_reingreso");
    ...
    scAjaxProcOn();
    x_ajax_form_del_nueva_empresa_mob_submit_form(var_emp_comisionista, var_emp_ruc, var_emp_razon_social, var_emp_nombre_comercial, var_emp_email, var_emp_obligado, var_emp_contribuyente_especial, var_emp_ambiente_sri, var_emp_usuario, var_emp_clave, var_emp_clave_reingreso, var_mensaje, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_nueva_empresa_mob_submit_form_cb);
  } // do_ajax_form_del_nueva_empresa_mob_submit_form

  function do_ajax_form_del_nueva_empresa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("emp_comisionista");
      ...
      scAjaxHideErrorDisplay("emp_usuario");
      scAjaxHideErrorDisplay("emp_clave");
      scAjaxHideErrorDisplay("emp_clave_reingreso");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_nueva_empresa_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_mob_submit_form_cb
  function do_ajax_form_del_nueva_empresa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_nueva_empresa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_nueva_empresa_mob_navigate_form()
  {
    perform_ajax_form_del_nueva_empresa_mob_navigate_form();
  }

  function perform_ajax_form_del_nueva_empresa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_nueva_empresa_mob_navigate_form(var_emp_ruc, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_navigate_form_cb);
  } // do_ajax_form_del_nueva_empresa_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_nueva_empresa_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_nueva_empresa_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_nueva_empresa_mob_navigate_form_cb
  function do_ajax_form_del_nueva_empresa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_nueva_empresa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_nueva_empresa_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_nueva_empresa_mob_form()
  {
  ...
  ajax_field_list[0] = "emp_comisionista";
  ajax_field_list[1] = "emp_ruc";
  ajax_field_list[2] = "emp_razon_social";
  ajax_field_list[3] = "emp_nombre_comercial";
  ajax_field_list[4] = "emp_email";
  ajax_field_list[5] = "emp_obligado";
  ajax_field_list[6] = "emp_contribuyente_especial";
  ajax_field_list[7] = "emp_ambiente_sri";
  ajax_field_list[8] = "emp_usuario";
  ajax_field_list[9] = "emp_clave";
  ajax_field_list[10] = "emp_clave_reingreso";
  ajax_field_list[11] = "mensaje";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "emp_comisionista": {"label": "<?php echo $this->Ini->Nm_lang['lang_referido_por'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "emp_contribuyente_especial": {"label": "<?php echo $this->Ini->Nm_lang['lang_contribuyente_especial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "emp_ambiente_sri": {"label": "Emp Ambiente Sri", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "emp_usuario": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "emp_clave": {"label": "<?php echo $this->Ini->Nm_lang['lang_contrasenia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "emp_clave_reingreso": {"label": "<?php echo $this->Ini->Nm_lang['lang_contrasenia_confirma'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "emp_usuario": new Array(),
    "emp_clave": new Array(),
    "emp_clave_reingreso": new Array(),
    "mensaje": new Array()
  };
  ajax_field_mult["emp_comisionista"][1] = "emp_comisionista";
  ...
  ajax_field_mult["emp_usuario"][1] = "emp_usuario";
  ajax_field_mult["emp_clave"][1] = "emp_clave";
  ajax_field_mult["emp_clave_reingreso"][1] = "emp_clave_reingreso";
  ajax_field_mult["mensaje"][1] = "mensaje";

  var ajax_field_id = {
    "emp_comisionista": new Array("hidden_field_label_emp_comisionista", "hidden_field_data_emp_comisionista"),
    ...
    "emp_usuario": new Array("hidden_field_label_emp_usuario", "hidden_field_data_emp_usuario"),
    "emp_clave": new Array("hidden_field_label_emp_clave", "hidden_field_data_emp_clave"),
    "emp_clave_reingreso": new Array("hidden_field_label_emp_clave_reingreso", "hidden_field_data_emp_clave_reingreso"),
    "mensaje": new Array("hidden_field_label_mensaje", "hidden_field_data_mensaje")
  };

  var ajax_read_only = {
    "emp_comisionista": "off",
    "emp_ruc": "on",
