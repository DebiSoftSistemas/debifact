...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_nueva_empresa/form_del_nueva_empresa_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_nueva_empresa_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_nueva_empresa_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['link_info']['remove_border']) {
...
<?php
 include_once("form_del_nueva_empresa_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_nueva_empresa'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_nueva_empresa'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_comisionista_label" id="hidden_field_label_emp_comisionista" style="<?php echo $sStyleHidden_emp_comisionista; ?>"><span id="id_label_emp_comisionista"><?php echo $this->nm_new_label['emp_comisionista']; ?></span></TD>
    <TD class="scFormDataOdd css_emp_comisionista_line" id="hidden_field_data_emp_comisionista" style="<?php echo $sStyleHidden_emp_comisionista; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_comisionista_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_ruc_label" id="hidden_field_label_emp_ruc" style="<?php echo $sStyleHidden_emp_ruc; ?>"><span id="id_label_emp_ruc"><?php echo $this->nm_new_label['emp_ruc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_ruc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_ruc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emp_ruc_line" id="hidden_field_data_emp_ruc" style="<?php echo $sStyleHidden_emp_ruc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_ruc_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_razon_social_label" id="hidden_field_label_emp_razon_social" style="<?php echo $sStyleHidden_emp_razon_social; ?>"><span id="id_label_emp_razon_social"><?php echo $this->nm_new_label['emp_razon_social']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_razon_social']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_razon_social'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emp_razon_social_line" id="hidden_field_data_emp_razon_social" style="<?php echo $sStyleHidden_emp_razon_social; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_razon_social_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_nombre_comercial_label" id="hidden_field_label_emp_nombre_comercial" style="<?php echo $sStyleHidden_emp_nombre_comercial; ?>"><span id="id_label_emp_nombre_comercial"><?php echo $this->nm_new_label['emp_nombre_comercial']; ?></span></TD>
    <TD class="scFormDataOdd css_emp_nombre_comercial_line" id="hidden_field_data_emp_nombre_comercial" style="<?php echo $sStyleHidden_emp_nombre_comercial; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_nombre_comercial_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_email_label" id="hidden_field_label_emp_email" style="<?php echo $sStyleHidden_emp_email; ?>"><span id="id_label_emp_email"><?php echo $this->nm_new_label['emp_email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emp_email_line" id="hidden_field_data_emp_email" style="<?php echo $sStyleHidden_emp_email; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_email_line" style="vertical-align: top;padding: 0px">
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_obligado_label" id="hidden_field_label_emp_obligado" style="<?php echo $sStyleHidden_emp_obligado; ?>"><span id="id_label_emp_obligado"><?php echo $this->nm_new_label['emp_obligado']; ?></span></TD>
...
<span id="id_read_on_emp_obligado" class="css_emp_obligado_line" style="<?php echo $sStyleReadLab_emp_obligado; ?>"><?php echo $this->form_format_readonly("emp_obligado", $this->form_encode_input($emp_obligado_look)); ?></span><span id="id_read_off_emp_obligado" class="css_read_off_emp_obligado css_emp_obligado_line" style="<?php echo $sStyleReadInp_emp_obligado; ?>"><?php echo "<div id=\"idAjaxCheckbox_emp_obligado\" style=\"display: inline-block\" class=\"css_emp_obligado_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['Lookup_emp_obligado'][] = 'S'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_ambiente_sri_label" id="hidden_field_label_emp_ambiente_sri" style="<?php echo $sStyleHidden_emp_ambiente_sri; ?>"><span id="id_label_emp_ambiente_sri"><?php echo $this->nm_new_label['emp_ambiente_sri']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_usuario_label" id="hidden_field_label_emp_usuario" style="<?php echo $sStyleHidden_emp_usuario; ?>"><span id="id_label_emp_usuario"><?php echo $this->nm_new_label['emp_usuario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_usuario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emp_usuario_line" id="hidden_field_data_emp_usuario" style="<?php echo $sStyleHidden_emp_usuario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_usuario_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_clave_label" id="hidden_field_label_emp_clave" style="<?php echo $sStyleHidden_emp_clave; ?>"><span id="id_label_emp_clave"><?php echo $this->nm_new_label['emp_clave']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_clave']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_clave'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emp_clave_line" id="hidden_field_data_emp_clave" style="<?php echo $sStyleHidden_emp_clave; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_clave_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_clave_reingreso_label" id="hidden_field_label_emp_clave_reingreso" style="<?php echo $sStyleHidden_emp_clave_reingreso; ?>"><span id="id_label_emp_clave_reingreso"><?php echo $this->nm_new_label['emp_clave_reingreso']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_clave_reingreso']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['php_cmp_required']['emp_clave_reingreso'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emp_clave_reingreso_line" id="hidden_field_data_emp_clave_reingreso" style="<?php echo $sStyleHidden_emp_clave_reingreso; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_clave_reingreso_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_mensaje_line" id="hidden_field_data_mensaje" style="<?php echo $sStyleHidden_mensaje; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mensaje_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="mensaje" value="<?php echo $this->form_encode_input($mensaje); ?>"><span id="id_ajax_label_mensaje"><?php echo nl2br($mensaje); ?></span>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-5';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_nueva_empresa");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_nueva_empresa");
 parent.scAjaxDetailHeight("form_del_nueva_empresa", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nueva_empresa']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
