  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_cliente" == sTestField)
        {
...
?>
  ...
  // ---------- Validate cl_id
  function do_ajax_form_del_cliente_validate_cl_id()
  {
    var nomeCampo_cl_id = "cl_id";
    var var_cl_id = scAjaxGetFieldHidden(nomeCampo_cl_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_id(var_cl_id, var_script_case_init, do_ajax_form_del_cliente_validate_cl_id_cb);
  } // do_ajax_form_del_cliente_validate_cl_id

  function do_ajax_form_del_cliente_validate_cl_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_id_cb

  // ---------- Validate cl_empresa
  function do_ajax_form_del_cliente_validate_cl_empresa()
  {
    var nomeCampo_cl_empresa = "cl_empresa";
    var var_cl_empresa = scAjaxGetFieldText(nomeCampo_cl_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_empresa(var_cl_empresa, var_script_case_init, do_ajax_form_del_cliente_validate_cl_empresa_cb);
  } // do_ajax_form_del_cliente_validate_cl_empresa

  function do_ajax_form_del_cliente_validate_cl_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_empresa_cb

  // ---------- Validate cl_tipo_identificacion
  function do_ajax_form_del_cliente_validate_cl_tipo_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_tipo_identificacion(var_cl_tipo_identificacion, var_script_case_init, do_ajax_form_del_cliente_validate_cl_tipo_identificacion_cb);
  } // do_ajax_form_del_cliente_validate_cl_tipo_identificacion

  function do_ajax_form_del_cliente_validate_cl_tipo_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_tipo_identificacion_cb

  // ---------- Validate cl_identificacion
  function do_ajax_form_del_cliente_validate_cl_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_identificacion(var_cl_identificacion, var_script_case_init, do_ajax_form_del_cliente_validate_cl_identificacion_cb);
  } // do_ajax_form_del_cliente_validate_cl_identificacion

  function do_ajax_form_del_cliente_validate_cl_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_identificacion_cb

  // ---------- Validate cl_nombre
  function do_ajax_form_del_cliente_validate_cl_nombre()
  {
    var nomeCampo_cl_nombre = "cl_nombre";
    var var_cl_nombre = scAjaxGetFieldText(nomeCampo_cl_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_nombre(var_cl_nombre, var_script_case_init, do_ajax_form_del_cliente_validate_cl_nombre_cb);
  } // do_ajax_form_del_cliente_validate_cl_nombre

  function do_ajax_form_del_cliente_validate_cl_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_nombre_cb

  // ---------- Validate cl_email
  function do_ajax_form_del_cliente_validate_cl_email()
  {
    var nomeCampo_cl_email = "cl_email";
    var var_cl_email = scAjaxGetFieldText(nomeCampo_cl_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_email(var_cl_email, var_script_case_init, do_ajax_form_del_cliente_validate_cl_email_cb);
  } // do_ajax_form_del_cliente_validate_cl_email

  function do_ajax_form_del_cliente_validate_cl_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_email_cb

  // ---------- Validate cl_telefono
  function do_ajax_form_del_cliente_validate_cl_telefono()
  {
    var nomeCampo_cl_telefono = "cl_telefono";
    var var_cl_telefono = scAjaxGetFieldText(nomeCampo_cl_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_telefono(var_cl_telefono, var_script_case_init, do_ajax_form_del_cliente_validate_cl_telefono_cb);
  } // do_ajax_form_del_cliente_validate_cl_telefono

  function do_ajax_form_del_cliente_validate_cl_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_telefono_cb

  // ---------- Validate cl_celular
  function do_ajax_form_del_cliente_validate_cl_celular()
  {
    var nomeCampo_cl_celular = "cl_celular";
    var var_cl_celular = scAjaxGetFieldText(nomeCampo_cl_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_celular(var_cl_celular, var_script_case_init, do_ajax_form_del_cliente_validate_cl_celular_cb);
  } // do_ajax_form_del_cliente_validate_cl_celular

  function do_ajax_form_del_cliente_validate_cl_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_celular_cb

  // ---------- Validate cl_fecha_nacimientos
  function do_ajax_form_del_cliente_validate_cl_fecha_nacimientos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_fecha_nacimientos(var_cl_fecha_nacimientos, var_script_case_init, do_ajax_form_del_cliente_validate_cl_fecha_nacimientos_cb);
  } // do_ajax_form_del_cliente_validate_cl_fecha_nacimientos

  function do_ajax_form_del_cliente_validate_cl_fecha_nacimientos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_fecha_nacimientos_cb

  // ---------- Validate cl_reteoncion_iva
  function do_ajax_form_del_cliente_validate_cl_reteoncion_iva()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_reteoncion_iva(var_cl_reteoncion_iva, var_script_case_init, do_ajax_form_del_cliente_validate_cl_reteoncion_iva_cb);
  } // do_ajax_form_del_cliente_validate_cl_reteoncion_iva

  function do_ajax_form_del_cliente_validate_cl_reteoncion_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_reteoncion_iva_cb

  // ---------- Validate cl_pais
  function do_ajax_form_del_cliente_validate_cl_pais()
  {
    var nomeCampo_cl_pais = "cl_pais";
    var var_cl_pais = scAjaxGetFieldSelect(nomeCampo_cl_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_pais(var_cl_pais, var_script_case_init, do_ajax_form_del_cliente_validate_cl_pais_cb);
  } // do_ajax_form_del_cliente_validate_cl_pais

  function do_ajax_form_del_cliente_validate_cl_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_pais";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_pais_cb

  // ---------- Validate cl_provincia
  function do_ajax_form_del_cliente_validate_cl_provincia()
  {
    var nomeCampo_cl_provincia = "cl_provincia";
    var var_cl_provincia = scAjaxGetFieldSelect(nomeCampo_cl_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_provincia(var_cl_provincia, var_script_case_init, do_ajax_form_del_cliente_validate_cl_provincia_cb);
  } // do_ajax_form_del_cliente_validate_cl_provincia

  function do_ajax_form_del_cliente_validate_cl_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_provincia_cb

  // ---------- Validate cl_ciudad
  function do_ajax_form_del_cliente_validate_cl_ciudad()
  {
    var nomeCampo_cl_ciudad = "cl_ciudad";
    var var_cl_ciudad = scAjaxGetFieldSelect(nomeCampo_cl_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_ciudad(var_cl_ciudad, var_script_case_init, do_ajax_form_del_cliente_validate_cl_ciudad_cb);
  } // do_ajax_form_del_cliente_validate_cl_ciudad

  function do_ajax_form_del_cliente_validate_cl_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_ciudad_cb

  // ---------- Validate cl_direccion
  function do_ajax_form_del_cliente_validate_cl_direccion()
  {
    var nomeCampo_cl_direccion = "cl_direccion";
    var var_cl_direccion = scAjaxGetFieldText(nomeCampo_cl_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_direccion(var_cl_direccion, var_script_case_init, do_ajax_form_del_cliente_validate_cl_direccion_cb);
  } // do_ajax_form_del_cliente_validate_cl_direccion

  function do_ajax_form_del_cliente_validate_cl_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_direccion_cb

  // ---------- Validate cl_estado
  function do_ajax_form_del_cliente_validate_cl_estado()
  {
    var nomeCampo_cl_estado = "cl_estado";
    var var_cl_estado = scAjaxGetFieldText(nomeCampo_cl_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_validate_cl_estado(var_cl_estado, var_script_case_init, do_ajax_form_del_cliente_validate_cl_estado_cb);
  } // do_ajax_form_del_cliente_validate_cl_estado

  function do_ajax_form_del_cliente_validate_cl_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_validate_cl_estado_cb

  // ---------- Refresh cl_pais
  function do_ajax_form_del_cliente_refresh_cl_pais()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_del_cliente_refresh_cl_pais(var_cl_pais, var_cl_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_cliente_refresh_cl_pais_cb);
  } // do_ajax_form_del_cliente_refresh_cl_pais

  function do_ajax_form_del_cliente_refresh_cl_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_del_cliente_refresh_cl_provincia();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_refresh_cl_pais_cb

  // ---------- Refresh cl_provincia
  function do_ajax_form_del_cliente_refresh_cl_provincia()
  {
    var var_cl_provincia = scAjaxGetFieldSelect("cl_provincia");
    var var_nmgp_refresh_fields = "cl_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_cliente_refresh_cl_provincia(var_cl_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_cliente_refresh_cl_provincia_cb);
  } // do_ajax_form_del_cliente_refresh_cl_provincia

  function do_ajax_form_del_cliente_refresh_cl_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_refresh_cl_provincia_cb

  // ---------- Event onchange cl_tipo_identificacion
  function do_ajax_form_del_cliente_event_cl_tipo_identificacion_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_cliente_event_cl_tipo_identificacion_onchange(var_cl_identificacion, var_cl_tipo_identificacion, var_cl_nombre, var_cl_direccion, var_cl_email, var_cl_telefono, var_cl_pais, var_cl_provincia, var_cl_ciudad, var_script_case_init, do_ajax_form_del_cliente_event_cl_tipo_identificacion_onchange_cb);
  } // do_ajax_form_del_cliente_event_cl_tipo_identificacion_onchange

  function do_ajax_form_del_cliente_event_cl_tipo_identificacion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cl_tipo_identificacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_cliente_event_cl_tipo_identificacion_onchange_cb_after_alert);
  } // do_ajax_form_del_cliente_event_cl_tipo_identificacion_onchange_cb
  function do_ajax_form_del_cliente_event_cl_tipo_identificacion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_cliente_event_cl_tipo_identificacion_onchange_cb_after_alert

  // ---------- Event onblur cl_identificacion
  function do_ajax_form_del_cliente_event_cl_identificacion_onblur()
  {
    var var_cl_tipo_identificacion = scAjaxGetFieldSelect("cl_tipo_identificacion");
    var var_cl_identificacion = scAjaxGetFieldText("cl_identificacion");
    var var_cl_nombre = scAjaxGetFieldText("cl_nombre");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_cliente_event_cl_identificacion_onblur(var_cl_tipo_identificacion, var_cl_identificacion, var_cl_nombre, var_cl_direccion, var_cl_email, var_cl_telefono, var_cl_pais, var_cl_provincia, var_cl_ciudad, var_script_case_init, do_ajax_form_del_cliente_event_cl_identificacion_onblur_cb);
  } // do_ajax_form_del_cliente_event_cl_identificacion_onblur

  function do_ajax_form_del_cliente_event_cl_identificacion_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cl_identificacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_cliente_event_cl_identificacion_onblur_cb_after_alert);
  } // do_ajax_form_del_cliente_event_cl_identificacion_onblur_cb
  function do_ajax_form_del_cliente_event_cl_identificacion_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_cliente_event_cl_identificacion_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_cliente_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_cliente_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_cliente_submit_form(var_cl_id, var_cl_empresa, var_cl_tipo_identificacion, var_cl_identificacion, var_cl_nombre, var_cl_email, var_cl_telefono, var_cl_celular, var_cl_fecha_nacimientos, var_cl_reteoncion_iva, var_cl_pais, var_cl_provincia, var_cl_ciudad, var_cl_direccion, var_cl_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_cliente_submit_form_cb);
  } // do_ajax_form_del_cliente_submit_form

  function do_ajax_form_del_cliente_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_cliente_submit_form_cb_after_alert);
  } // do_ajax_form_del_cliente_submit_form_cb
  function do_ajax_form_del_cliente_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_cliente_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_cliente_navigate_form()
  {
    perform_ajax_form_del_cliente_navigate_form();
  }

  function perform_ajax_form_del_cliente_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_cliente_navigate_form(var_cl_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_cliente_navigate_form_cb);
  } // do_ajax_form_del_cliente_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_cliente_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_cliente_navigate_form_cb_after_alert);
  } // do_ajax_form_del_cliente_navigate_form_cb
  function do_ajax_form_del_cliente_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_cliente_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_cliente_navigate_form_cb_after_alert

  function sc_hide_form_del_cliente_form()
  {
