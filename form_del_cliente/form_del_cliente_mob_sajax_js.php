  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_cliente_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_cliente_mob_form();
	}
...
?>
  ...
  // ---------- Validate cl_id
  function do_ajax_form_del_cliente_mob_validate_cl_id()
  {
    var nomeCampo_cl_id = "cl_id";
    var var_cl_id = scAjaxGetFieldHidden(nomeCampo_cl_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_id(var_cl_id, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_id_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_id

  function do_ajax_form_del_cliente_mob_validate_cl_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_id_cb

  // ---------- Validate cl_empresa
  function do_ajax_form_del_cliente_mob_validate_cl_empresa()
  {
    var nomeCampo_cl_empresa = "cl_empresa";
    var var_cl_empresa = scAjaxGetFieldText(nomeCampo_cl_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_empresa(var_cl_empresa, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_empresa_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_empresa

  function do_ajax_form_del_cliente_mob_validate_cl_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_empresa_cb

  // ---------- Validate cl_tipo_identificacion
  function do_ajax_form_del_cliente_mob_validate_cl_tipo_identificacion()
  {
    var nomeCampo_cl_tipo_identificacion = "cl_tipo_identificacion";
    var var_cl_tipo_identificacion = scAjaxGetFieldSelect(nomeCampo_cl_tipo_identificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_tipo_identificacion(var_cl_tipo_identificacion, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_tipo_identificacion_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_tipo_identificacion

  function do_ajax_form_del_cliente_mob_validate_cl_tipo_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_tipo_identificacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_tipo_identificacion_cb

  // ---------- Validate cl_identificacion
  function do_ajax_form_del_cliente_mob_validate_cl_identificacion()
  {
    var nomeCampo_cl_identificacion = "cl_identificacion";
    var var_cl_identificacion = scAjaxGetFieldText(nomeCampo_cl_identificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_identificacion(var_cl_identificacion, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_identificacion_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_identificacion

  function do_ajax_form_del_cliente_mob_validate_cl_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_identificacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_identificacion_cb

  // ---------- Validate cl_nombre
  function do_ajax_form_del_cliente_mob_validate_cl_nombre()
  {
    var nomeCampo_cl_nombre = "cl_nombre";
    var var_cl_nombre = scAjaxGetFieldText(nomeCampo_cl_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_nombre(var_cl_nombre, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_nombre_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_nombre

  function do_ajax_form_del_cliente_mob_validate_cl_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_nombre_cb

  // ---------- Validate cl_email
  function do_ajax_form_del_cliente_mob_validate_cl_email()
  {
    var nomeCampo_cl_email = "cl_email";
    var var_cl_email = scAjaxGetFieldText(nomeCampo_cl_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_email(var_cl_email, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_email_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_email

  function do_ajax_form_del_cliente_mob_validate_cl_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_email_cb

  // ---------- Validate cl_telefono
  function do_ajax_form_del_cliente_mob_validate_cl_telefono()
  {
    var nomeCampo_cl_telefono = "cl_telefono";
    var var_cl_telefono = scAjaxGetFieldText(nomeCampo_cl_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_telefono(var_cl_telefono, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_telefono_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_telefono

  function do_ajax_form_del_cliente_mob_validate_cl_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_telefono";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_telefono_cb

  // ---------- Validate cl_celular
  function do_ajax_form_del_cliente_mob_validate_cl_celular()
  {
    var nomeCampo_cl_celular = "cl_celular";
    var var_cl_celular = scAjaxGetFieldText(nomeCampo_cl_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_celular(var_cl_celular, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_celular_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_celular

  function do_ajax_form_del_cliente_mob_validate_cl_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_celular";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_celular_cb

  // ---------- Validate cl_fecha_nacimientos
  function do_ajax_form_del_cliente_mob_validate_cl_fecha_nacimientos()
  {
    var nomeCampo_cl_fecha_nacimientos = "cl_fecha_nacimientos";
    var var_cl_fecha_nacimientos = scAjaxGetFieldText(nomeCampo_cl_fecha_nacimientos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_fecha_nacimientos(var_cl_fecha_nacimientos, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_fecha_nacimientos_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_fecha_nacimientos

  function do_ajax_form_del_cliente_mob_validate_cl_fecha_nacimientos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_fecha_nacimientos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_fecha_nacimientos_cb

  // ---------- Validate cl_reteoncion_iva
  function do_ajax_form_del_cliente_mob_validate_cl_reteoncion_iva()
  {
    var nomeCampo_cl_reteoncion_iva = "cl_reteoncion_iva";
    var var_cl_reteoncion_iva = scAjaxGetFieldSelect(nomeCampo_cl_reteoncion_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_reteoncion_iva(var_cl_reteoncion_iva, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_reteoncion_iva_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_reteoncion_iva

  function do_ajax_form_del_cliente_mob_validate_cl_reteoncion_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_reteoncion_iva";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_reteoncion_iva_cb

  // ---------- Validate cl_pais
  function do_ajax_form_del_cliente_mob_validate_cl_pais()
  {
    var nomeCampo_cl_pais = "cl_pais";
    var var_cl_pais = scAjaxGetFieldSelect(nomeCampo_cl_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_pais(var_cl_pais, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_pais_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_pais

  function do_ajax_form_del_cliente_mob_validate_cl_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_pais";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_pais_cb

  // ---------- Validate cl_provincia
  function do_ajax_form_del_cliente_mob_validate_cl_provincia()
  {
    var nomeCampo_cl_provincia = "cl_provincia";
    var var_cl_provincia = scAjaxGetFieldSelect(nomeCampo_cl_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_provincia(var_cl_provincia, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_provincia_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_provincia

  function do_ajax_form_del_cliente_mob_validate_cl_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_provincia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_provincia_cb

  // ---------- Validate cl_ciudad
  function do_ajax_form_del_cliente_mob_validate_cl_ciudad()
  {
    var nomeCampo_cl_ciudad = "cl_ciudad";
    var var_cl_ciudad = scAjaxGetFieldSelect(nomeCampo_cl_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_ciudad(var_cl_ciudad, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_ciudad_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_ciudad

  function do_ajax_form_del_cliente_mob_validate_cl_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_ciudad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_ciudad_cb

  // ---------- Validate cl_direccion
  function do_ajax_form_del_cliente_mob_validate_cl_direccion()
  {
    var nomeCampo_cl_direccion = "cl_direccion";
    var var_cl_direccion = scAjaxGetFieldText(nomeCampo_cl_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_direccion(var_cl_direccion, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_direccion_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_direccion

  function do_ajax_form_del_cliente_mob_validate_cl_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_direccion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_direccion_cb

  // ---------- Validate cl_estado
  function do_ajax_form_del_cliente_mob_validate_cl_estado()
  {
    var nomeCampo_cl_estado = "cl_estado";
    var var_cl_estado = scAjaxGetFieldText(nomeCampo_cl_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cliente_mob_validate_cl_estado(var_cl_estado, var_script_case_init, do_ajax_form_del_cliente_mob_validate_cl_estado_cb);
  } // do_ajax_form_del_cliente_mob_validate_cl_estado

  function do_ajax_form_del_cliente_mob_validate_cl_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cl_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_validate_cl_estado_cb

  // ---------- Refresh cl_pais
  function do_ajax_form_del_cliente_mob_refresh_cl_pais()
  {
    var var_cl_pais = scAjaxGetFieldSelect("cl_pais");
    var var_cl_provincia = scAjaxGetFieldSelect("cl_provincia");
    var var_nmgp_refresh_fields = "cl_provincia_#fld#_cl_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_cliente_mob_refresh_cl_pais(var_cl_pais, var_cl_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_cliente_mob_refresh_cl_pais_cb);
  } // do_ajax_form_del_cliente_mob_refresh_cl_pais

  function do_ajax_form_del_cliente_mob_refresh_cl_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_del_cliente_mob_refresh_cl_provincia();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_refresh_cl_pais_cb

  // ---------- Refresh cl_provincia
  function do_ajax_form_del_cliente_mob_refresh_cl_provincia()
  {
    var var_cl_provincia = scAjaxGetFieldSelect("cl_provincia");
    var var_nmgp_refresh_fields = "cl_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_cliente_mob_refresh_cl_provincia(var_cl_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_cliente_mob_refresh_cl_provincia_cb);
  } // do_ajax_form_del_cliente_mob_refresh_cl_provincia

  function do_ajax_form_del_cliente_mob_refresh_cl_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cliente_mob_refresh_cl_provincia_cb

  // ---------- Event onchange cl_tipo_identificacion
  function do_ajax_form_del_cliente_mob_event_cl_tipo_identificacion_onchange()
  {
    var var_cl_identificacion = scAjaxGetFieldText("cl_identificacion");
    var var_cl_tipo_identificacion = scAjaxGetFieldSelect("cl_tipo_identificacion");
    var var_cl_nombre = scAjaxGetFieldText("cl_nombre");
    var var_cl_direccion = scAjaxGetFieldText("cl_direccion");
    var var_cl_email = scAjaxGetFieldText("cl_email");
    var var_cl_telefono = scAjaxGetFieldText("cl_telefono");
    var var_cl_pais = scAjaxGetFieldSelect("cl_pais");
    var var_cl_provincia = scAjaxGetFieldSelect("cl_provincia");
    var var_cl_ciudad = scAjaxGetFieldSelect("cl_ciudad");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_cliente_mob_event_cl_tipo_identificacion_onchange(var_cl_identificacion, var_cl_tipo_identificacion, var_cl_nombre, var_cl_direccion, var_cl_email, var_cl_telefono, var_cl_pais, var_cl_provincia, var_cl_ciudad, var_script_case_init, do_ajax_form_del_cliente_mob_event_cl_tipo_identificacion_onchange_cb);
  } // do_ajax_form_del_cliente_mob_event_cl_tipo_identificacion_onchange

  function do_ajax_form_del_cliente_mob_event_cl_tipo_identificacion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cl_tipo_identificacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_cliente_mob_event_cl_tipo_identificacion_onchange_cb_after_alert);
  } // do_ajax_form_del_cliente_mob_event_cl_tipo_identificacion_onchange_cb
  function do_ajax_form_del_cliente_mob_event_cl_tipo_identificacion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_cliente_mob_event_cl_tipo_identificacion_onchange_cb_after_alert

  // ---------- Event onblur cl_identificacion
  function do_ajax_form_del_cliente_mob_event_cl_identificacion_onblur()
  {
    var var_cl_tipo_identificacion = scAjaxGetFieldSelect("cl_tipo_identificacion");
    var var_cl_identificacion = scAjaxGetFieldText("cl_identificacion");
    var var_cl_nombre = scAjaxGetFieldText("cl_nombre");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_cliente_mob_event_cl_identificacion_onblur(var_cl_tipo_identificacion, var_cl_identificacion, var_cl_nombre, var_cl_direccion, var_cl_email, var_cl_telefono, var_cl_pais, var_cl_provincia, var_cl_ciudad, var_script_case_init, do_ajax_form_del_cliente_mob_event_cl_identificacion_onblur_cb);
  } // do_ajax_form_del_cliente_mob_event_cl_identificacion_onblur

  function do_ajax_form_del_cliente_mob_event_cl_identificacion_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cl_identificacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_cliente_mob_event_cl_identificacion_onblur_cb_after_alert);
  } // do_ajax_form_del_cliente_mob_event_cl_identificacion_onblur_cb
  function do_ajax_form_del_cliente_mob_event_cl_identificacion_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_cliente_mob_event_cl_identificacion_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_cliente_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_cliente_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cl_id = scAjaxGetFieldHidden("cl_id");
    var var_cl_empresa = scAjaxGetFieldText("cl_empresa");
    var var_cl_tipo_identificacion = scAjaxGetFieldSelect("cl_tipo_identificacion");
    var var_cl_identificacion = scAjaxGetFieldText("cl_identificacion");
    var var_cl_nombre = scAjaxGetFieldText("cl_nombre");
    var var_cl_email = scAjaxGetFieldText("cl_email");
    var var_cl_telefono = scAjaxGetFieldText("cl_telefono");
    var var_cl_celular = scAjaxGetFieldText("cl_celular");
    var var_cl_fecha_nacimientos = scAjaxGetFieldText("cl_fecha_nacimientos");
    var var_cl_reteoncion_iva = scAjaxGetFieldSelect("cl_reteoncion_iva");
    var var_cl_pais = scAjaxGetFieldSelect("cl_pais");
    var var_cl_provincia = scAjaxGetFieldSelect("cl_provincia");
    var var_cl_ciudad = scAjaxGetFieldSelect("cl_ciudad");
    var var_cl_direccion = scAjaxGetFieldText("cl_direccion");
    var var_cl_estado = scAjaxGetFieldText("cl_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_del_cliente_mob_submit_form(var_cl_id, var_cl_empresa, var_cl_tipo_identificacion, var_cl_identificacion, var_cl_nombre, var_cl_email, var_cl_telefono, var_cl_celular, var_cl_fecha_nacimientos, var_cl_reteoncion_iva, var_cl_pais, var_cl_provincia, var_cl_ciudad, var_cl_direccion, var_cl_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_cliente_mob_submit_form_cb);
  } // do_ajax_form_del_cliente_mob_submit_form

  function do_ajax_form_del_cliente_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cl_id");
      scAjaxHideErrorDisplay("cl_empresa");
      scAjaxHideErrorDisplay("cl_tipo_identificacion");
      scAjaxHideErrorDisplay("cl_identificacion");
      scAjaxHideErrorDisplay("cl_nombre");
      scAjaxHideErrorDisplay("cl_email");
      scAjaxHideErrorDisplay("cl_telefono");
      scAjaxHideErrorDisplay("cl_celular");
      scAjaxHideErrorDisplay("cl_fecha_nacimientos");
      scAjaxHideErrorDisplay("cl_reteoncion_iva");
      scAjaxHideErrorDisplay("cl_pais");
      scAjaxHideErrorDisplay("cl_provincia");
      scAjaxHideErrorDisplay("cl_ciudad");
      scAjaxHideErrorDisplay("cl_direccion");
      scAjaxHideErrorDisplay("cl_estado");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_cliente_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_cliente_mob_submit_form_cb
  function do_ajax_form_del_cliente_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_cliente_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_cliente_mob_navigate_form()
  {
    perform_ajax_form_del_cliente_mob_navigate_form();
  }

  function perform_ajax_form_del_cliente_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("cl_direccion");
    scAjaxHideErrorDisplay("cl_estado");
    var var_cl_id = document.F2.cl_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_cliente_mob_navigate_form(var_cl_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_cliente_mob_navigate_form_cb);
  } // do_ajax_form_del_cliente_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_cliente_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.cl_id.value = scAjaxGetKeyValue("cl_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_cliente_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_cliente_mob_navigate_form_cb
  function do_ajax_form_del_cliente_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_cliente_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_cliente_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_cliente_mob_form()
  {
  ...
  ajax_field_list[0] = "cl_id";
  ajax_field_list[1] = "cl_empresa";
  ajax_field_list[2] = "cl_tipo_identificacion";
  ajax_field_list[3] = "cl_identificacion";
  ajax_field_list[4] = "cl_nombre";
  ajax_field_list[5] = "cl_email";
  ajax_field_list[6] = "cl_telefono";
  ajax_field_list[7] = "cl_celular";
  ajax_field_list[8] = "cl_fecha_nacimientos";
  ajax_field_list[9] = "cl_reteoncion_iva";
  ajax_field_list[10] = "cl_pais";
  ajax_field_list[11] = "cl_provincia";
  ajax_field_list[12] = "cl_ciudad";
  ajax_field_list[13] = "cl_direccion";
  ajax_field_list[14] = "cl_estado";
  ...
  var ajax_error_list = {
    "cl_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_tipo_identificacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_identificacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_identificacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_identificacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_nombre'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_telefono": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_telefono'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_celular": {"label": "<?php echo $this->Ini->Nm_lang['lang_celular'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_fecha_nacimientos": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_fecha_nacimiento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_reteoncion_iva": {"label": "<?php echo $this->Ini->Nm_lang['lang_porcentaje_ret_iva'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_pais": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_pais'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_provincia": {"label": "<?php echo $this->Ini->Nm_lang['lang_provincia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_ciudad": {"label": "<?php echo $this->Ini->Nm_lang['lang_ciudad'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_direccion": {"label": "<?php echo $this->Ini->Nm_lang['lang_direccion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cl_estado": {"label": "Cl Estado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "cl_id": new Array(),
    "cl_empresa": new Array(),
    "cl_tipo_identificacion": new Array(),
    "cl_identificacion": new Array(),
    "cl_nombre": new Array(),
    "cl_email": new Array(),
    "cl_telefono": new Array(),
    "cl_celular": new Array(),
    "cl_fecha_nacimientos": new Array(),
    "cl_reteoncion_iva": new Array(),
    "cl_pais": new Array(),
    "cl_provincia": new Array(),
    "cl_ciudad": new Array(),
    "cl_direccion": new Array(),
    "cl_estado": new Array()
  };
  ajax_field_mult["cl_id"][1] = "cl_id";
  ajax_field_mult["cl_empresa"][1] = "cl_empresa";
  ajax_field_mult["cl_tipo_identificacion"][1] = "cl_tipo_identificacion";
  ajax_field_mult["cl_identificacion"][1] = "cl_identificacion";
  ajax_field_mult["cl_nombre"][1] = "cl_nombre";
  ajax_field_mult["cl_email"][1] = "cl_email";
  ajax_field_mult["cl_telefono"][1] = "cl_telefono";
  ajax_field_mult["cl_celular"][1] = "cl_celular";
  ajax_field_mult["cl_fecha_nacimientos"][1] = "cl_fecha_nacimientos";
  ajax_field_mult["cl_reteoncion_iva"][1] = "cl_reteoncion_iva";
  ajax_field_mult["cl_pais"][1] = "cl_pais";
  ajax_field_mult["cl_provincia"][1] = "cl_provincia";
  ajax_field_mult["cl_ciudad"][1] = "cl_ciudad";
  ajax_field_mult["cl_direccion"][1] = "cl_direccion";
  ajax_field_mult["cl_estado"][1] = "cl_estado";

  var ajax_field_id = {
    "cl_tipo_identificacion": new Array("hidden_field_label_cl_tipo_identificacion", "hidden_field_data_cl_tipo_identificacion"),
    "cl_identificacion": new Array("hidden_field_label_cl_identificacion", "hidden_field_data_cl_identificacion"),
    "cl_nombre": new Array("hidden_field_label_cl_nombre", "hidden_field_data_cl_nombre"),
    "cl_email": new Array("hidden_field_label_cl_email", "hidden_field_data_cl_email"),
    "cl_telefono": new Array("hidden_field_label_cl_telefono", "hidden_field_data_cl_telefono"),
    "cl_celular": new Array("hidden_field_label_cl_celular", "hidden_field_data_cl_celular"),
    "cl_fecha_nacimientos": new Array("hidden_field_label_cl_fecha_nacimientos", "hidden_field_data_cl_fecha_nacimientos"),
    "cl_reteoncion_iva": new Array("hidden_field_label_cl_reteoncion_iva", "hidden_field_data_cl_reteoncion_iva"),
    "cl_pais": new Array("hidden_field_label_cl_pais", "hidden_field_data_cl_pais"),
    "cl_provincia": new Array("hidden_field_label_cl_provincia", "hidden_field_data_cl_provincia"),
    "cl_ciudad": new Array("hidden_field_label_cl_ciudad", "hidden_field_data_cl_ciudad"),
    "cl_direccion": new Array("hidden_field_label_cl_direccion", "hidden_field_data_cl_direccion"),
    "cl_estado": new Array("hidden_field_label_cl_estado", "hidden_field_data_cl_estado")
  };

  var ajax_read_only = {
    "cl_id": "on",
    "cl_empresa": "off",
    "cl_tipo_identificacion": "off",
    "cl_identificacion": "off",
    "cl_nombre": "off",
    "cl_email": "off",
    "cl_telefono": "off",
    "cl_celular": "off",
    "cl_fecha_nacimientos": "off",
    "cl_reteoncion_iva": "off",
    "cl_pais": "off",
    "cl_provincia": "off",
    "cl_ciudad": "off",
    "cl_direccion": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("cl_tipo_identificacion" == sIndex)
    {
    ...
    if ("cl_fecha_nacimientos" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
