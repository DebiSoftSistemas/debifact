...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_cliente']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_del_cliente']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_del_cliente']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_cliente']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_del_cliente_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_del_cliente']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_cliente']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_cliente'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_cliente']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_cliente']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_del_cliente') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_cliente']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " del_cliente";
      ...
      $_SESSION['scriptcase']['error_icon']['form_del_cliente']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_del_cliente'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_orig'] = " where (cl_identificacion<>'9999999999999')";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_pesq'] = " where (cl_identificacion<>'9999999999999')";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_cliente']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_cliente'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_cliente'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_del_cliente", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          if ($this->Embutida_proc)
          { 
              include_once($this->Ini->path_embutida . 'form_del_cliente/form_del_cliente_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_del_cliente_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_del_cliente_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_del_cliente_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_del_cliente/form_del_cliente_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_del_cliente_erro.class.php"); 
      }
      $this->Erro      = new form_del_cliente_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opcao']))
         { 
             if ($this->cl_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_del_cliente']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_del_cliente']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_del_cliente']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_del_cliente.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_del_cliente_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_del_cliente"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_cliente', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_del_cliente', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_cliente', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_del_cliente']) || !is_array($this->NM_ajax_info['errList']['geral_form_del_cliente']))
              {
                  $this->NM_ajax_info['errList']['geral_form_del_cliente'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_del_cliente'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_cl_empresa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_empresa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_empresa'] == "on")) 
      { 
          if ($this->cl_empresa == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['cl_tipo_identificacion'])) {
      ...
      if ($this->cl_tipo_identificacion == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_tipo_identificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_tipo_identificacion'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->cl_tipo_identificacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_tipo_identificacion']) && !in_array($this->cl_tipo_identificacion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_tipo_identificacion']))
          {
              $hasError = true;
    ...
    function ValidateField_cl_identificacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_identificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_identificacion'] == "on")) 
      { 
...
;
    ...
    function ValidateField_cl_nombre(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_nombre'] == "on")) 
      { 
          if ($this->cl_nombre == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_cl_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_email'] == "on")) 
      { 
          if ($this->cl_email == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_cl_telefono(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_telefono']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_telefono'] == "on")) 
      { 
          if ($this->cl_telefono == "")  
          { 
              $hasError = true;
...
;
   ...
   if (isset($this->Field_no_validate['cl_reteoncion_iva'])) {
       return;
               ...
               if (!empty($this->cl_reteoncion_iva) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_reteoncion_iva']) && !in_array($this->cl_reteoncion_iva, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_reteoncion_iva']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['cl_pais'])) {
       return;
               ...
               if (!empty($this->cl_pais) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_pais']) && !in_array($this->cl_pais, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_pais']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['cl_provincia'])) {
       return;
               ...
               if (!empty($this->cl_provincia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_provincia']) && !in_array($this->cl_provincia, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_provincia']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['cl_ciudad'])) {
       return;
               ...
               if (!empty($this->cl_ciudad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_ciudad']) && !in_array($this->cl_ciudad, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_ciudad']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cl_direccion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_direccion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['php_cmp_required']['cl_direccion'] == "on")) 
      { 
    ...
    function ValidateField_cl_estado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->cl_estado) > 2) 
          { 
              $hasError = true;
              ...
              $Campos_Erros['cl_estado'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['cl_estado'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['cl_id']['keyVal'] = form_del_cliente_pack_protect_string($this->nmgp_dados_form['cl_id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_tipo_identificacion']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_tipo_identificacion'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_tipo_identificacion']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_tipo_identificacion'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_del_cliente_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_del_cliente_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_tipo_identificacion'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cl_tipo_identificacion']['valList'][$i] = form_del_cliente_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_reteoncion_iva']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_reteoncion_iva'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_reteoncion_iva']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_reteoncion_iva'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_reteoncion_iva'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cl_reteoncion_iva']['valList'][$i] = form_del_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_pais']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_pais'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_pais']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_pais'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_pais'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cl_pais']['valList'][$i] = form_del_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_provincia']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_provincia'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_provincia']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_provincia'] = array(); 
}
if ($this->cl_pais != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_provincia'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cl_provincia']['valList'][$i] = form_del_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_ciudad']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_ciudad'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_ciudad']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_ciudad'] = array(); 
}
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_ciudad'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cl_ciudad']['valList'][$i] = form_del_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_cl_estado($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Field_no_validate'] = array();
      if (!$this->NM_ajax_flag || !isset($this->nmgp_refresh_fields)) {
      $_SESSION['scriptcase']['form_del_cliente']['contr_erro'] = 'on';
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->cl_id)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
if (!isset($this->sc_temp_permite_procesar)) {$this->sc_temp_permite_procesar = (isset($_SESSION['permite_procesar'])) ? $_SESSION['permite_procesar'] : "";}
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_del_cliente';
...
$_SESSION['scriptcase']['form_del_cliente']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('cl_id', 'cl_empresa', 'cl_tipo_identificacion', 'cl_identificacion', 'cl_nombre', 'cl_email', 'cl_telefono', 'cl_celular', 'cl_fecha_nacimientos', 'cl_reteoncion_iva', 'cl_pais', 'cl_provincia', 'cl_ciudad', 'cl_direccion', 'cl_estado'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (cl_id, cl_empresa, cl_nombre, cl_tipo_identificacion, cl_identificacion, cl_pais, cl_provincia, cl_ciudad, cl_direccion, cl_telefono, cl_celular, cl_email, cl_reteoncion_iva, cl_estado, cl_fecha_nacimientos) VALUES ($this->cl_id, '$this->cl_empresa', '$this->cl_nombre', '$this->cl_tipo_identificacion', '$this->cl_identificacion', $this->cl_pais, $this->cl_provincia, $this->cl_ciudad, '$this->cl_direccion', '$this->cl_telefono', '$this->cl_celular', '$this->cl_email', $this->cl_reteoncion_iva, '$this->cl_estado', #$this->cl_fecha_nacimientos#)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "cl_id, cl_empresa, cl_nombre, cl_tipo_identificacion, cl_identificacion, cl_pais, cl_provincia, cl_ciudad, cl_direccion, cl_telefono, cl_celular, cl_email, cl_reteoncion_iva, cl_estado, cl_fecha_nacimientos) VALUES (" . $NM_seq_auto . "$this->cl_id, '$this->cl_empresa', '$this->cl_nombre', '$this->cl_tipo_identificacion', '$this->cl_identificacion', $this->cl_pais, $this->cl_provincia, $this->cl_ciudad, '$this->cl_direccion', '$this->cl_telefono', '$this->cl_celular', '$this->cl_email', $this->cl_reteoncion_iva, '$this->cl_estado', " . $this->Ini->date_delim . $this->cl_fecha_nacimientos . $this->Ini->date_delim1 . ")"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "cl_id, cl_empresa, cl_nombre, cl_tipo_identificacion, cl_identificacion, cl_pais, cl_provincia, cl_ciudad, cl_direccion, cl_telefono, cl_celular, cl_email, cl_reteoncion_iva, cl_estado, cl_fecha_nacimientos) VALUES (" . $NM_seq_auto . "$this->cl_id, '$this->cl_empresa', '$this->cl_nombre', '$this->cl_tipo_identificacion', '$this->cl_identificacion', $this->cl_pais, $this->cl_provincia, $this->cl_ciudad, '$this->cl_direccion', '$this->cl_telefono', '$this->cl_celular', '$this->cl_email', $this->cl_reteoncion_iva, '$this->cl_estado', EXTEND('$this->cl_fecha_nacimientos', YEAR TO DAY))"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "cl_id, cl_empresa, cl_nombre, cl_tipo_identificacion, cl_identificacion, cl_pais, cl_provincia, cl_ciudad, cl_direccion, cl_telefono, cl_celular, cl_email, cl_reteoncion_iva, cl_estado, cl_fecha_nacimientos) VALUES (" . $NM_seq_auto . "$this->cl_id, '$this->cl_empresa', '$this->cl_nombre', '$this->cl_tipo_identificacion', '$this->cl_identificacion', $this->cl_pais, $this->cl_provincia, $this->cl_ciudad, '$this->cl_direccion', '$this->cl_telefono', '$this->cl_celular', '$this->cl_email', $this->cl_reteoncion_iva, '$this->cl_estado', " . $this->Ini->date_delim . $this->cl_fecha_nacimientos . $this->Ini->date_delim1 . ")"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_del_cliente']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['parms'] = "cl_id?#?$this->cl_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_form_del_cliente = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['total'] = $qt_geral_reg_form_del_cliente;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->cl_id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_del_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] > $qt_geral_reg_form_del_cliente)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] = $qt_geral_reg_form_del_cliente; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_del_cliente) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          { 
              $nmgp_select = "SELECT cl_id, cl_empresa, cl_nombre, cl_tipo_identificacion, cl_identificacion, cl_pais, cl_provincia, cl_ciudad, cl_direccion, cl_telefono, cl_celular, cl_email, cl_reteoncion_iva, cl_estado, str_replace (convert(char(10),cl_fecha_nacimientos,102), '.', '-') + ' ' + convert(char(8),cl_fecha_nacimientos,20) from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT cl_id, cl_empresa, cl_nombre, cl_tipo_identificacion, cl_identificacion, cl_pais, cl_provincia, cl_ciudad, cl_direccion, cl_telefono, cl_celular, cl_email, cl_reteoncion_iva, cl_estado, convert(char(23),cl_fecha_nacimientos,121) from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT cl_id, cl_empresa, cl_nombre, cl_tipo_identificacion, cl_identificacion, cl_pais, cl_provincia, cl_ciudad, cl_direccion, cl_telefono, cl_celular, cl_email, cl_reteoncion_iva, cl_estado, cl_fecha_nacimientos from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT cl_id, cl_empresa, cl_nombre, cl_tipo_identificacion, cl_identificacion, cl_pais, cl_provincia, cl_ciudad, cl_direccion, cl_telefono, cl_celular, cl_email, cl_reteoncion_iva, cl_estado, EXTEND(cl_fecha_nacimientos, YEAR TO DAY) from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT cl_id, cl_empresa, cl_nombre, cl_tipo_identificacion, cl_identificacion, cl_pais, cl_provincia, cl_ciudad, cl_direccion, cl_telefono, cl_celular, cl_email, cl_reteoncion_iva, cl_estado, cl_fecha_nacimientos from " . $this->Ini->nm_tabela ; 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (!empty($sc_where))
              {
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->cl_fecha_nacimientos = $rs->fields[14] ; 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] < $qt_geral_reg_form_del_cliente;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opcao']   = '';
          }
      } 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dados_select'];
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['reg_start'] + 1;
...
$modificado_cl_provincia = $this->cl_provincia;
$modificado_cl_ciudad = $this->cl_ciudad;
$this->nm_formatar_campos('cl_tipo_identificacion', 'cl_identificacion', 'cl_nombre', 'cl_direccion', 'cl_email', 'cl_telefono', 'cl_pais', 'cl_provincia', 'cl_ciudad');
if ($original_cl_tipo_identificacion !== $modificado_cl_tipo_identificacion || isset($this->nmgp_cmp_readonly['cl_tipo_identificacion']) || (isset($bFlagRead_cl_tipo_identificacion) && $bFlagRead_cl_tipo_identificacion))
{
    $this->ajax_return_values_cl_tipo_identificacion(true);
}
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_del_cliente_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter_form'] . " and ((cl_identificacion<>'9999999999999')) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_del_cliente = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['total'] = $qt_geral_reg_form_del_cliente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_del_cliente_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_del_cliente_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_del_cliente_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['ordem_ord'] == " desc") {
