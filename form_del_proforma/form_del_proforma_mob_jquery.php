...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["prof_empresa" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["prof_empresa" + iSeqRow] && scEventControl_data["prof_empresa" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["prof_empresa" + iSeqRow] && scEventControl_data["prof_empresa" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_prof_numero' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_numero_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_del_proforma_prof_numero_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_empresa' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_empresa_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_del_proforma_prof_empresa_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_secuencial' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_secuencial_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_del_proforma_prof_secuencial_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_fecha' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_fecha_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_del_proforma_prof_fecha_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_cliente' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_cliente_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_del_proforma_prof_cliente_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_del_proforma_prof_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_descripcion' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_descripcion_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_del_proforma_prof_descripcion_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_subtotal_iva' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_subtotal_iva_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_del_proforma_prof_subtotal_iva_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_subtotal_cero' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_subtotal_cero_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_del_proforma_prof_subtotal_cero_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_subtotal_no_objeto' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_subtotal_no_objeto_onblur(this, iSeqRow) })
                                                     .bind('focus', function() { sc_form_del_proforma_prof_subtotal_no_objeto_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_subtotal_excento' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_subtotal_excento_onblur(this, iSeqRow) })
                                                   .bind('focus', function() { sc_form_del_proforma_prof_subtotal_excento_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_subtotal' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_subtotal_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_del_proforma_prof_subtotal_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_total_descuento' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_total_descuento_onblur(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_del_proforma_prof_total_descuento_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_valor_ice' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_valor_ice_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_del_proforma_prof_valor_ice_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_valor_iva' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_valor_iva_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_del_proforma_prof_valor_iva_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_valor_irbpnr' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_valor_irbpnr_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_del_proforma_prof_valor_irbpnr_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_propina' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_propina_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_del_proforma_prof_propina_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_total' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_total_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_del_proforma_prof_total_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_estado' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_estado_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_del_proforma_prof_estado_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_usuario' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_usuario_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_del_proforma_prof_usuario_onfocus(this, iSeqRow) });
  $('#id_sc_field_detalles' + iSeqRow).bind('blur', function() { sc_form_del_proforma_detalles_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_del_proforma_detalles_onfocus(this, iSeqRow) });
  $('#id_sc_field_titulo' + iSeqRow).bind('blur', function() { sc_form_del_proforma_titulo_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_del_proforma_titulo_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_ruc' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_ruc_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_del_proforma_prof_ruc_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_nombre' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_nombre_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_del_proforma_prof_nombre_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_direccion' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_direccion_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_del_proforma_prof_direccion_onfocus(this, iSeqRow) });
  $('#id_sc_field_prof_email' + iSeqRow).bind('blur', function() { sc_form_del_proforma_prof_email_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_del_proforma_prof_email_onfocus(this, iSeqRow) });
  $('#id_sc_field_secuencial' + iSeqRow).bind('blur', function() { sc_form_del_proforma_secuencial_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_del_proforma_secuencial_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_del_proforma_prof_numero_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_numero();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_numero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_empresa_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_empresa();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_empresa_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_secuencial_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_secuencial();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_secuencial_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_fecha_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_fecha();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_fecha_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_cliente();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_cliente_onchange(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_event_prof_cliente_onchange();
}

function sc_form_del_proforma_prof_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_descripcion_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_descripcion();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_descripcion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_subtotal_iva_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_subtotal_iva();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_subtotal_iva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_subtotal_cero_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_subtotal_cero();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_subtotal_cero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_subtotal_no_objeto_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_subtotal_no_objeto();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_subtotal_no_objeto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_subtotal_excento_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_subtotal_excento();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_subtotal_excento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_subtotal_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_subtotal();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_subtotal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_total_descuento_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_total_descuento();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_total_descuento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_valor_ice_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_valor_ice();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_valor_ice_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_valor_iva_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_valor_iva();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_valor_iva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_valor_irbpnr_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_valor_irbpnr();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_valor_irbpnr_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_propina_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_propina();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_propina_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_total_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_total();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_total_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_estado_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_estado();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_estado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_usuario_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_usuario();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_usuario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_detalles_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_detalles();
  scCssBlur(oThis);
}

function sc_form_del_proforma_detalles_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_titulo_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_titulo();
  scCssBlur(oThis);
}

function sc_form_del_proforma_titulo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_ruc_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_ruc();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_ruc_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_nombre_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_nombre();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_nombre_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_direccion_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_direccion();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_direccion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_prof_email_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_prof_email();
  scCssBlur(oThis);
}

function sc_form_del_proforma_prof_email_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_proforma_secuencial_onblur(oThis, iSeqRow) {
  do_ajax_form_del_proforma_mob_validate_secuencial();
  scCssBlur(oThis);
}

function sc_form_del_proforma_secuencial_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_1(status) {
	...
	displayChange_field("prof_empresa", "", status);
...
function displayChange_row(row, status) {
	...
	displayChange_field_prof_empresa(row, status);
...
function displayChange_field_prof_empresa(row, status) {
    var fieldId;
}
...
function displayChange_field_detalles(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_del_detalle_proforma_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_del_detalle_proforma_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_del_proforma_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_prof_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_del_proforma_mob_validate_prof_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_del_proforma_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
