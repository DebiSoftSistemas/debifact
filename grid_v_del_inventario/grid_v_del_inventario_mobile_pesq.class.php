...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "pro_cantidad_inventario";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "costo_promedio";$Nm_numeric[] = "total";$Nm_numeric[] = "pro_cantidad_inventario";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "costo_promedio";$Nm_numeric[] = "total";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_cat_descripcion"  <?php echo $str_hide_cat_descripcion?>>
<?php
