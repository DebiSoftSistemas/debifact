...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['tot_geral'][3];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['tot_geral'][2];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['arr_total']['pro_descripcion'] = $this->array_total_pro_descripcion;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['pro_descripcion'] = $Lab_pro_descripcion; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       //-----
       $this->comp_sum = array(
           2 => "" .  $this->Ini->Nm_lang['lang_inventario'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "" .  $this->Ini->Nm_lang['lang_valor'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "pro_cantidad_inventario", 'show' => true),
           3 => array('field' => "total", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_pro_cantidad_inventario_sum",
           3 => "css_total_sum",
       );

       //-----
       $this->comp_sum_nm = array(
           2 => "pro_cantidad_inventario_sum",
           3 => "total_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['proc_pdf_vert']){ 
   ...
   public static function formatValue($total, $valor_campo)
   {
       ...
       if ($total == 1)
       {
           nmgp_Form_Num_Val($valor_campo, "", ".", "5", "S", "2", "", "N:2", "-");
       }
       if ($total == 2)
       {
...
{ 
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['SC_Gb_Free_cmp']))
      {
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_pro_cantidad_inventario, $quebra_pro_descripcion, $quebra_pro_descripcion_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          if (empty($sum_pro_cantidad_inventario)) {$sum_pro_cantidad_inventario = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_total . ';
              $this->' . $arr_name . '[2] = ' . $sum_pro_cantidad_inventario . ';
          ...
          else
          {
              ...
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_pro_cantidad_inventario . ', 10);
          }
          ');
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->pro_descripcion = $rs_res->fields[0] ;  
            $this->cat_descripcion = $rs_res->fields[1] ;  
            $this->cantidad = $rs_res->fields[2] ;  
            $this->costo_promedio = $rs_res->fields[3] ;  
            $this->total = $rs_res->fields[4] ;  
            $this->kar_empresa = $rs_res->fields[5] ;  
            $this->pro_cantidad_inventario = $rs_res->fields[6] ;  
            $this->kar_producto = $rs_res->fields[7] ;  
            $this->pro_descripcion_orig = $this->pro_descripcion;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->pro_cantidad_inventario, $this->pro_descripcion, $this->pro_descripcion_orig);
            }
   }
//
