...
class grid_v_del_inventario_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_bo_establecimiento;
   var $array_total_bodega;
   ...
   var $sum_bo_establecimiento_total;
   var $sc_proc_quebra_bodega;
   var $count_bodega;
   var $sum_bodega_total;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_bo_establecimiento = array();
      $this->array_total_bodega             = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_v_del_inventario']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_v_del_inventario']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pesq_tab_label']))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pesq_tab_label'] .= "kar_bodega?#?" . "" . $this->Ini->Nm_lang['lang_bodega'] . "" . "?@?";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pesq_tab_label'] .= "pro_codigo?#?" . "" . $this->Ini->Nm_lang['lang_codigo'] . "" . "?@?";
      }
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['contr_total_geral'] == "OK")
      {
          $this->array_total_bo_establecimiento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['arr_total']['bo_establecimiento'];
          $this->array_total_bodega = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['arr_total']['bodega'];
      }
      else
      {
          $this->array_total_bo_establecimiento = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['arr_total']['bo_establecimiento'] = $this->array_total_bo_establecimiento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['arr_total']['bodega'] = $this->array_total_bodega;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['json_use_label'])
       {
          $Lab_bo_establecimiento = "bo_establecimiento";
          $Lab_bodega = "bodega";
       }
       else
       {
       $Lab_bo_establecimiento = "" . $this->Ini->Nm_lang['lang_establecimiento'] . "";
       $Lab_bodega = "" . $this->Ini->Nm_lang['lang_bodega'] . "";
       }
       $this->comp_field = array(
           $Lab_bo_establecimiento,
           $Lab_bodega,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['bo_establecimiento'] = $Lab_bo_establecimiento; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['bodega'] = $Lab_bodega; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['pro_codigo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['pro_codigo'] = "" . $this->Ini->Nm_lang['lang_codigo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['pro_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['pro_descripcion'] = "" . $this->Ini->Nm_lang['lang_producto'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['cat_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['cat_descripcion'] = "" . $this->Ini->Nm_lang['lang_categoria'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['kar_unidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['kar_unidad'] = "" . $this->Ini->Nm_lang['lang_unidad'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['cantidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['cantidad'] = "" . $this->Ini->Nm_lang['lang_inventario'] . " " . $this->Ini->Nm_lang['lang_kardex'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['costo_promedio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['costo_promedio'] = "" . $this->Ini->Nm_lang['lang_costo_promedio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['total'] = "" . $this->Ini->Nm_lang['lang_valor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['kardex']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['kardex'] = "" . $this->Ini->Nm_lang['lang_kardex'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['kar_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['kar_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['bo_establecimiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['bo_establecimiento'] = "" . $this->Ini->Nm_lang['lang_establecimiento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['bodega']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['bodega'] = "" . $this->Ini->Nm_lang['lang_bodega'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['pro_codigo_aux']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['pro_codigo_aux'] = "" . $this->Ini->Nm_lang['lang_codigo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['kar_producto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['kar_producto'] = "" . $this->Ini->Nm_lang['lang_codigo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['pro_cantidad_inventario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['pro_cantidad_inventario'] = "" . $this->Ini->Nm_lang['lang_inventario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['kar_bodega']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['labels']['kar_bodega'] = "" . $this->Ini->Nm_lang['lang_bodega'] . ""; 
       }
       //-----
       $this->comp_field_nm = array(
           'bo_establecimiento' => 0,
           'bodega' => 1,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_order']['kar_bodega']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_order']['kar_bodega'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_order']['kar_bodega'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['summarizing_fields_display']['kar_bodega'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_bo_establecimiento as $i_bo_establecimiento => $d_bo_establecimiento) {
           if (!isset($i_bo_establecimiento, $this->comp_label[0]) || !in_array($i_bo_establecimiento, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_bo_establecimiento[3] ] = $d_bo_establecimiento[2];
               $this->comp_label[0][ $d_bo_establecimiento[3] ] = $d_bo_establecimiento[2];
           }
           foreach ($this->array_total_bodega[$i_bo_establecimiento] as $i_bodega => $d_bodega) {
               if (!isset($i_bodega, $this->comp_label[1][ $d_bo_establecimiento[3] ]) || !in_array($i_bodega, $this->comp_label[1][ $d_bo_establecimiento[3] ], true)) {
                   $this->comp_index[1][ $d_bodega[3] ] = $d_bodega[2];
                   $this->comp_label[1][ $d_bo_establecimiento[3] ][ $d_bodega[3] ] = $d_bodega[2];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'bo_establecimiento', 'prot' => ''),
           array('name' => 'bodega', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_bo_establecimiento => $l_bo_establecimiento) {
           if (isset($this->array_total_bo_establecimiento[$i_bo_establecimiento])) {
               $this->comp_group[$i_bo_establecimiento] = array();
           }
           foreach ($this->comp_label[1][$i_bo_establecimiento] as $i_bodega => $l_bodega) {
               if (isset($this->array_total_bodega[$i_bo_establecimiento][$i_bodega])) {
                   $this->comp_group[$i_bo_establecimiento][$i_bodega] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_bo_establecimiento;
       }
       elseif (1 == $level) {
           $return = $this->array_total_bodega;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_del_inventario@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_v_del_inventario_total.class.php"); 
      }
      ...
      $this->Total   = new grid_v_del_inventario_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_bo_establecimiento)) {
          ksort($this->array_total_bo_establecimiento);
      }
      if (is_array($this->array_total_bodega)) {
          ksort($this->array_total_bodega);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_v_del_inventario_jquery_1174.js\"></script>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_v_del_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_del_inventario/grid_v_del_inventario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_inventario/grid_v_del_inventario_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_inventario/grid_v_del_inventario_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_del_inventario&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_inventario/grid_v_del_inventario_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_inventario/grid_v_del_inventario_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_inventario/grid_v_del_inventario_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_del_inventario/grid_v_del_inventario_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_del_inventario/grid_v_del_inventario_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_v_del_inventario_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_del_inventario']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_del_inventario']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_v_del_inventario_config_pivot.php?nome_apl=grid_v_del_inventario&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_v_del_inventario_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_inventario_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_v_del_inventario/grid_v_del_inventario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $cat_descripcion = (isset($Busca_temp['cat_descripcion'])) ? $Busca_temp['cat_descripcion'] : ""; 
          $tmp_pos = (is_string($cat_descripcion)) ? strpos($cat_descripcion, "##@@") : false;
          if ($tmp_pos !== false && !is_array($cat_descripcion))
          {
              $cat_descripcion = substr($cat_descripcion, 0, $tmp_pos);
          }
          $pro_codigo = (isset($Busca_temp['pro_codigo'])) ? $Busca_temp['pro_codigo'] : ""; 
          $tmp_pos = (is_string($pro_codigo)) ? strpos($pro_codigo, "##@@") : false;
          if ($tmp_pos !== false && !is_array($pro_codigo))
          {
              $pro_codigo = substr($pro_codigo, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($sum_total, $quebra_bo_establecimiento, $quebra_bodega, $quebra_bo_establecimiento_orig, $quebra_bodega_orig)
   {
      //----- bo_establecimiento
      if (!isset($this->array_total_bo_establecimiento[$quebra_bo_establecimiento_orig]))
      {
         $this->array_total_bo_establecimiento[$quebra_bo_establecimiento_orig][0] = 1;
         $this->array_total_bo_establecimiento[$quebra_bo_establecimiento_orig][1] = $sum_total;
         $this->array_total_bo_establecimiento[$quebra_bo_establecimiento_orig][2] = $quebra_bo_establecimiento;
         $this->array_total_bo_establecimiento[$quebra_bo_establecimiento_orig][3] = $quebra_bo_establecimiento_orig;
      }
      else
      {
         $this->array_total_bo_establecimiento[$quebra_bo_establecimiento_orig][0]++;
         $this->array_total_bo_establecimiento[$quebra_bo_establecimiento_orig][1] = bcadd($this->array_total_bo_establecimiento[$quebra_bo_establecimiento_orig][1], $sum_total, 10);
      }
      //----- bodega
      if (!isset($this->array_total_bodega[$quebra_bo_establecimiento_orig][$quebra_bodega_orig]))
      {
         $this->array_total_bodega[$quebra_bo_establecimiento_orig][$quebra_bodega_orig][0] = 1;
         $this->array_total_bodega[$quebra_bo_establecimiento_orig][$quebra_bodega_orig][1] = $sum_total;
         $this->array_total_bodega[$quebra_bo_establecimiento_orig][$quebra_bodega_orig][2] = $quebra_bodega;
         $this->array_total_bodega[$quebra_bo_establecimiento_orig][$quebra_bodega_orig][3] = $quebra_bodega_orig;
      }
      else
      {
         $this->array_total_bodega[$quebra_bo_establecimiento_orig][$quebra_bodega_orig][0]++;
         $this->array_total_bodega[$quebra_bo_establecimiento_orig][$quebra_bodega_orig][1] = bcadd($this->array_total_bodega[$quebra_bo_establecimiento_orig][$quebra_bodega_orig][1], $sum_total, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->cat_descripcion = $Busca_temp['cat_descripcion']; 
       $this->cat_descripcion = (isset($Busca_temp['cat_descripcion'])) ? $Busca_temp['cat_descripcion'] : ""; 
       $tmp_pos = (is_string($this->cat_descripcion)) ? strpos($this->cat_descripcion, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->cat_descripcion))
       {
       ...
       $this->pro_codigo = $Busca_temp['pro_codigo']; 
       $this->pro_codigo = (isset($Busca_temp['pro_codigo'])) ? $Busca_temp['pro_codigo'] : ""; 
       $tmp_pos = (is_string($this->pro_codigo)) ? strpos($this->pro_codigo, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->pro_codigo))
       {
     ...
     { 
         $nmgp_select = "SELECT pro_codigo, pro_descripcion, cat_descripcion, kar_unidad, cantidad, costo_promedio, total, kar_empresa, bo_establecimiento, bodega, pro_codigo_aux, pro_cantidad_inventario, kar_producto, kar_bodega from " . $this->Ini->nm_tabela; 
     } 
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('kar_bodega', 'bo_establecimiento');
     $campos_order = $this->Ini->Get_date_order_groupby("bo_establecimiento", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('kar_bodega', 'bodega');
     $campos_order = $this->Ini->Get_date_order_groupby("bodega", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->pro_codigo = $rs_res->fields[0] ;  
            $this->pro_descripcion = $rs_res->fields[1] ;  
            $this->cat_descripcion = $rs_res->fields[2] ;  
            $this->kar_unidad = $rs_res->fields[3] ;  
            $this->cantidad = $rs_res->fields[4] ;  
            $this->costo_promedio = $rs_res->fields[5] ;  
            $this->total = $rs_res->fields[6] ;  
            $this->kar_empresa = $rs_res->fields[7] ;  
            $this->bo_establecimiento = $rs_res->fields[8] ;  
            $this->bodega = $rs_res->fields[9] ;  
            $this->pro_codigo_aux = $rs_res->fields[10] ;  
            $this->pro_cantidad_inventario = $rs_res->fields[11] ;  
            $this->kar_producto = $rs_res->fields[12] ;  
            $this->kar_bodega = $rs_res->fields[13] ;  
            $this->look_bo_establecimiento = $this->bo_establecimiento; 
            $this->Lookup->lookup_bo_establecimiento($this->look_bo_establecimiento, $this->bo_establecimiento) ; 
            $this->bo_establecimiento_orig = $this->bo_establecimiento;
            $this->bodega_orig = $this->bodega;
            $this->bo_establecimiento = $this->look_bo_establecimiento ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->bo_establecimiento, $this->bodega, $this->bo_establecimiento_orig,  $this->bodega_orig);
            }
   }
//
   ...
   {
       global $nm_saida;
       $this->Cmps_select2_grid = array('cat_descripcion','kar_bodega','pro_codigo');
       $lin_obj  = "";
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('kar_bodega','cat_descripcion','pro_codigo');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['grid_pesq']) < 3)
       {
   ...
   function grid_search_kar_bodega($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['psq_check_ret']['kar_bodega'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['psq_check_ret']['kar_bodega'][] = trim($rs->fields[0]);
   ...
   function grid_search_pro_codigo($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['psq_check_ret']['pro_codigo'] = array();
       $pro_codigo_look = (is_string($pro_codigo) ? substr($this->Db->qstr($pro_codigo), 1, -1) : $pro_codigo); 
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "" . $this->Ini->Nm_lang['lang_seleccione'] . "?#??#?N?@?"; 
       $nm_comando = "SELECT pro_codigo, pro_descripcion  FROM del_producto  WHERE pro_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and pro_familia_producto=3 ORDER BY pro_descripcion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['psq_check_ret']['pro_codigo'][] = trim($rs->fields[0]);
       ...
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"grid_search_pro_codigo_val_" . $ind . "\" name=\"val_grid_search_pro_codigo_" . $ind . "\"  size=1>";
       $delimitador = "##@@";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       $val = isset($val[0]) ? $val[0] : array();
       foreach ($nm_opcoes as $nm_opcao)
       {
          if (!empty($nm_opcao))
          {
             ...
             {
                $pro_codigo_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $pro_codigo_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "       </span>";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("      );\r\n");
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida("     function Sc_carga_select2_grid_pro_codigo(SEQ)\r\n");
       $nm_saida->saida("     {\r\n");
       $nm_saida->saida("      $(\"#grid_search_pro_codigo_val_\" + SEQ).select2(\r\n");
       $nm_saida->saida("        {\r\n");
       $nm_saida->saida("          language: {\r\n");
       $nm_saida->saida("            noResults: function() {\r\n");
       $nm_saida->saida("              return \"" . $this->Ini->Nm_lang['lang_autocomp_notfound'] . "\";\r\n");
