...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_v_del_inventario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_v_del_inventario"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_inventario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_v_del_inventario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_inventario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_v_del_inventario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_v_del_inventario']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_v_del_inventario</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_inventario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_v_del_inventario']['embutida_filho'] as $ind => $sc_init)
          {
