...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "pr_id";$Nm_numeric[] = "pr_pais";$Nm_numeric[] = "pr_provincia";$Nm_numeric[] = "pr_ciudad";$Nm_numeric[] = "pr_retencion_iva";$Nm_numeric[] = "pr_id";$Nm_numeric[] = "pr_pais";$Nm_numeric[] = "pr_provincia";$Nm_numeric[] = "pr_ciudad";$Nm_numeric[] = "pr_retencion_iva";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_pr_email"  <?php echo $str_hide_pr_email?>><?php
      if ($pr_email != "")
      {
      $pr_email_look = (is_string($pr_email) ? substr($this->Db->qstr($pr_email), 1, -1) : $pr_email); 
      $nmgp_def_dados = array(); 
