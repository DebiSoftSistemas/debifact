...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "fac_fecha";$Nm_numeric[] = "fac_numero";$Nm_numeric[] = "fac_total";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fac_secuencial"  <?php echo $str_hide_fac_secuencial?>><INPUT  type="text" id="SC_fac_secuencial" name="fac_secuencial" value="<?php echo NM_encode_input($fac_secuencial) ?>"  size=9 alt="{datatype: 'text', maxLength: 9, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fac_comentario"  <?php echo $str_hide_fac_comentario?>><?php
      if ($fac_comentario != "")
      {
      $fac_comentario_look = (is_string($fac_comentario) ? substr($this->Db->qstr($fac_comentario), 1, -1) : $fac_comentario); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_cl_email"  <?php echo $str_hide_cl_email?>><?php
      if ($cl_email != "")
      {
      $cl_email_look = (is_string($cl_email) ? substr($this->Db->qstr($cl_email), 1, -1) : $cl_email); 
      $nmgp_def_dados = array(); 
