...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_v_del_movimientos_kardex"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_v_del_movimientos_kardex"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_movimientos_kardex']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_v_del_movimientos_kardex']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_movimientos_kardex']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_v_del_movimientos_kardex']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_v_del_movimientos_kardex']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_v_del_movimientos_kardex</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_movimientos_kardex']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_v_del_movimientos_kardex']['embutida_filho'] as $ind => $sc_init)
          {
