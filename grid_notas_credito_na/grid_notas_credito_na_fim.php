...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_notas_credito_na"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_notas_credito_na"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_notas_credito_na']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_notas_credito_na']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_notas_credito_na']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_notas_credito_na']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_notas_credito_na']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_notas_credito_na</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_notas_credito_na']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_notas_credito_na']['embutida_filho'] as $ind => $sc_init)
          {
