<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_fac_factura']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_fac_factura_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_factura_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['fac_numero'] = "fac_numero";
   $tab_labels["fac_numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_numero"] : "" . $this->Nm_lang['lang_id'] . "";
   $tab_ger_campos['fac_serie'] = "on";
   $tab_def_campos['fac_serie'] = "fac_serie";
   $tab_labels["fac_serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_serie"] : "" . $this->Nm_lang['lang_serie_sri'] . "";
   $tab_ger_campos['fac_numero_doc'] = "on";
   $tab_def_campos['fac_numero_doc'] = "fac_numero_doc";
   $tab_labels["fac_numero_doc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_numero_doc"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_numero_doc"] : "" . $this->Nm_lang['lang_secuencial'] . "";
   $tab_ger_campos['fac_cliente'] = "on";
   $tab_def_campos['fac_cliente'] = "fac_cliente";
   $tab_labels["fac_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_cliente"] : "" . $this->Nm_lang['lang_cliente'] . "";
   $tab_ger_campos['fac_fecha'] = "on";
   $tab_def_campos['fac_fecha'] = "fac_fecha";
   $tab_labels["fac_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['fac_subtotal'] = "on";
   $tab_def_campos['fac_subtotal'] = "fac_subtotal";
   $tab_labels["fac_subtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_subtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_subtotal"] : "" . $this->Nm_lang['lang_subtotal'] . "";
   $tab_ger_campos['fac_descuento'] = "on";
   $tab_def_campos['fac_descuento'] = "fac_descuento";
   $tab_labels["fac_descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_descuento"] : "" . $this->Nm_lang['lang_descuento'] . "";
   $tab_ger_campos['fac_total_iva'] = "on";
   $tab_def_campos['fac_total_iva'] = "fac_total_iva";
   $tab_labels["fac_total_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_total_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_total_iva"] : "" . $this->Nm_lang['lang_iva'] . "";
   $tab_ger_campos['fac_total'] = "on";
   $tab_def_campos['fac_total'] = "fac_total";
   $tab_labels["fac_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_total"] : "" . $this->Nm_lang['lang_total'] . "";
   $tab_ger_campos['fac_estado_sri'] = "on";
   $tab_def_campos['fac_estado_sri'] = "fac_estado_sri";
   $tab_labels["fac_estado_sri"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_estado_sri"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_estado_sri"] : "" . $this->Nm_lang['lang_estado'] . " SRI";
   $tab_ger_campos['fac_forma_pago'] = "on";
   $tab_def_campos['fac_forma_pago'] = "fac_forma_pago";
   $tab_labels["fac_forma_pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_forma_pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['labels']["fac_forma_pago"] : "" . $this->Nm_lang['lang_formas_pago'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_factura_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_factura']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
