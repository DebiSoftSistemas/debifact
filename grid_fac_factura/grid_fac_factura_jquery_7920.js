...
function grid_fac_factura_fac_estado_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_fac_estado" + seqRow).html();
}

function grid_fac_factura_fac_estado_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
...
function grid_fac_factura_getValue(field, seqRow) {
  ...
  if ("fac_estado" == field) {
    SC_tmp = grid_fac_factura_fac_estado_getValue(seqRow);
  }
...
function grid_fac_factura_setValue(field, newValue, seqRow) {
  ...
  if ("fac_estado" == field) {
    grid_fac_factura_fac_estado_setValue(newValue, seqRow);
  }
  if ("fac_estado_sri" == field) {
