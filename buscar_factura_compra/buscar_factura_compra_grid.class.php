<?php
class buscar_factura_compra_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'])
   { 
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['buscar_factura_compra'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_bot();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "buscar_factura_compra/buscar_factura_compra_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['pesq_tab_label'] .= "fc_fecha?#?" . "" . $this->Ini->Nm_lang['lang_fecha'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['pesq_tab_label'] .= "pr_nombre?#?" . "" . $this->Ini->Nm_lang['lang_proveedor'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['pesq_tab_label'] .= "pr_identificacion?#?" . "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['pesq_tab_label'] .= "fc_tipo_comprobante?#?" . "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("pr_nombre","pr_identificacion");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("buscar_factura_compra", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] = "muda_qt_linhas";
   } 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['buscar_factura_compra'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['buscar_factura_compra'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "buscar_factura_compra/buscar_factura_compra_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "buscar_factura_compra_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new buscar_factura_compra_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_select']['fc_fecha'] = 'desc'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_orig'] = " where (fc_tipo_comprobante<>'03' and fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fc_estado='V')";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid'];
   }
//----- 
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
   { 
       $nmgp_select = "SELECT fc_id, fc_tipo_comprobante, str_replace (convert(char(10),fc_fecha,102), '.', '-') + ' ' + convert(char(8),fc_fecha,20), pr_nombre, pr_identificacion, fc_total, fc_autorizacion from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT fc_id, fc_tipo_comprobante, fc_fecha, pr_nombre, pr_identificacion, fc_total, fc_autorizacion from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT fc_id, fc_tipo_comprobante, convert(char(23),fc_fecha,121), pr_nombre, pr_identificacion, fc_total, fc_autorizacion from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT fc_id, fc_tipo_comprobante, EXTEND(fc_fecha, YEAR TO DAY), pr_nombre, pr_identificacion, fc_total, fc_autorizacion from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT fc_id, fc_tipo_comprobante, fc_fecha, pr_nombre, pr_identificacion, fc_total, fc_autorizacion from " . $this->Ini->nm_tabela; 
   } 
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       $this->fc_id = $this->rs_grid->fields[0] ;  
       $this->fc_id = (string)$this->fc_id;
       $this->fc_tipo_comprobante = $this->rs_grid->fields[1] ;  
       ...
       $GLOBALS["fc_tipo_comprobante"] = $this->rs_grid->fields[1] ;  
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
           $this->pb = new scProgressBar();
           $this->pb->setRoot($this->Ini->root);
           $this->pb->setDir($_SESSION['scriptcase']['buscar_factura_compra']['glo_nm_path_imag_temp'] . "/");
           $this->pb->setProgressbarMd5($_GET['pbmd5']);
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               buscar_factura_compra_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               buscar_factura_compra_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               buscar_factura_compra_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               buscar_factura_compra_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               buscar_factura_compra_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"buscar_factura_compra_jquery_1781.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"buscar_factura_compra_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"buscar_factura_compra_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida']) {  
...
$nm_saida->saida("    </style>\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-buscar_factura_compra-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-buscar_factura_compra-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-buscar_factura_compra-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-7a2cc989\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_buscar_factura_compra_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_buscar_factura_compra_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_buscar_factura_compra_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "buscar_factura_compra/buscar_factura_compra_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".buscar_factura_compra_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .buscar_factura_compra_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".buscar_factura_compra_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'])
   { 
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf" && !$this->Print_All)
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['buscar_factura_compra']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['buscar_factura_compra']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['buscar_factura_compra']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['buscar_factura_compra']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida']) ? "buscar_factura_compra_" : "";
   $this->css_sep = " ";
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_label'])
   { 
       $this->New_label['fc_id'] = "" . $this->Ini->Nm_lang['lang_id'] . "";
       $this->New_label['fc_tipo_comprobante'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . "";
       $this->New_label['fc_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_buscar_factura_compra__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-buscar_factura_compra-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fc_autorizacion_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fc_autorizacion_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".buscar_factura_compra_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_fc_id()
 {
   ...
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != 'pdf') {
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['labels']['fc_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fc_tipo_comprobante'])) ? $this->New_label['fc_tipo_comprobante'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['labels']['fc_tipo_comprobante'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fc_fecha'])) ? $this->New_label['fc_fecha'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['labels']['fc_fecha'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pr_nombre'])) ? $this->New_label['pr_nombre'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['labels']['pr_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pr_identificacion'])) ? $this->New_label['pr_identificacion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['labels']['pr_identificacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fc_total'])) ? $this->New_label['fc_total'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['labels']['fc_total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fc_autorizacion'])) ? $this->New_label['fc_autorizacion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['labels']['fc_autorizacion'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura_compra']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_buscar_factura_compra#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
   ...
   { 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf'])
{
}
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_buscar_factura_compra#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-7a2cc989\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['Page_break_PDF'] = array();
       }
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  buscar_factura_compra_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $GLOBALS["fc_tipo_comprobante"] = $this->rs_grid->fields[1] ;  
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['rows_emb']++;
          $this->sc_proc_grid = true;
          $_SESSION['scriptcase']['buscar_factura_compra']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['buscar_factura_compra']['contr_erro'] = 'off';
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf'])
          {
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_fc_autorizacion_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_fc_autorizacion_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_fc_id()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_fc_id_grid_line . "\"  style=\"" . $this->Css_Cmp['css_fc_id_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fc_id_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_fc_tipo_comprobante()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['fc_tipo_comprobante']) || $this->NM_cmp_hidden['fc_tipo_comprobante'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['print_navigator'] == "Netscape")
            {
        ...
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ajax_nav'])
          {
          ...
          if (is_file("buscar_factura_compra_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("buscar_factura_compra_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['sc_modal'])
        {
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "buscar_factura_compra/buscar_factura_compra_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "buscar_factura_compra/buscar_factura_compra_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
...
$nm_saida->saida("    </style>\r\n");
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['cond_pesq'];
       $pos = strrpos($tmp, "##*@@");
       if ($pos !== false)
       {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq']) < 4)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_pr_nombre($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nm_comando = "select distinct pr_nombre from " . $this->Ini->nm_tabela . " where (fc_tipo_comprobante<>'03' and fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fc_estado='V') and #lowerI#pr_nombre#lowerF# = #lowerI#'$pr_nombre_look'#lowerF# order by pr_nombre"; 
   ...
   function grid_search_pr_identificacion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct pr_identificacion from " . $this->Ini->nm_tabela . " where (fc_tipo_comprobante<>'03' and fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fc_estado='V') and #lowerI#pr_identificacion#lowerF# = #lowerI#'$pr_identificacion_look'#lowerF# order by pr_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function grid_search_fc_tipo_comprobante($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['psq_check_ret']['fc_tipo_comprobante'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['psq_check_ret']['fc_tipo_comprobante'][] = trim($rs->fields[0]);
   ...
   function lookup_ajax_pr_nombre($pr_nombre)
   {
       ...
       $pr_nombre_look = (is_string($pr_nombre) ? substr($this->Db->qstr($pr_nombre), 1, -1) : $pr_nombre); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct pr_nombre from " . $this->Ini->nm_tabela . " where (fc_tipo_comprobante<>'03' and fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fc_estado='V') and  #lowerI#pr_nombre#lowerF# like #lowerI#'%" . $pr_nombre . "%'#lowerF# order by pr_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = buscar_factura_compra_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_pr_identificacion($pr_identificacion)
   {
       ...
       $pr_identificacion_look = (is_string($pr_identificacion) ? substr($this->Db->qstr($pr_identificacion), 1, -1) : $pr_identificacion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct pr_identificacion from " . $this->Ini->nm_tabela . " where (fc_tipo_comprobante<>'03' and fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fc_estado='V') and  #lowerI#pr_identificacion#lowerF# like #lowerI#'%" . $pr_identificacion . "%'#lowerF# order by pr_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "debi_doc_electronicos/buscar_factura_compra";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_buscar_factura_compra_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_buscar_factura_compra_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fc_fecha_mes'] =  'sc_buscar_factura_compra_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fc_fecha_dia'] =  'sc_buscar_factura_compra_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fc_fecha_v2__mes'] =  'sc_buscar_factura_compra_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fc_fecha_v2__dia'] =  'sc_buscar_factura_compra_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fc_fecha_mes']", 'value' => 'sc_buscar_factura_compra_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fc_fecha_dia']", 'value' => 'sc_buscar_factura_compra_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fc_fecha_v2__mes']", 'value' => 'sc_buscar_factura_compra_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fc_fecha_v2__dia']", 'value' => 'sc_buscar_factura_compra_valida_dia(this)');
       } 
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('buscar_factura_compra', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"buscar_factura_compra\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"buscar_factura_compra_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "buscar_factura_compra/buscar_factura_compra_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"buscar_factura_compra_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['buscar_factura_compra_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@buscar_factura_compra@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"buscar_factura_compra_iframe.php\";\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"buscar_factura_compra_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['buscar_factura_compra']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"buscar_factura_compra_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura_compra']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('buscar_factura_compra')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('buscar_factura_compra', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
