...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____buscar_factura_compra"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____buscar_factura_compra"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_factura_compra']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['buscar_factura_compra']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_factura_compra']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['buscar_factura_compra']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['buscar_factura_compra']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>buscar_factura_compra</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['buscar_factura_compra']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['buscar_factura_compra']['embutida_filho'] as $ind => $sc_init)
          {
