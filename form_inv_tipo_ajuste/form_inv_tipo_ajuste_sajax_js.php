  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_tipo_ajuste" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inv_tipo_ajuste_form();
	}
...
?>
  ...
  // ---------- Validate ta_id_
  function do_ajax_form_inv_tipo_ajuste_validate_ta_id_(iNumLinha)
  {
    var nomeCampo_ta_id_ = "ta_id_" + iNumLinha;
    var var_ta_id_ = scAjaxGetFieldHidden(nomeCampo_ta_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_tipo_ajuste_validate_ta_id_(var_ta_id_, iNumLinha, var_script_case_init, do_ajax_form_inv_tipo_ajuste_validate_ta_id__cb);
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_id_

  function do_ajax_form_inv_tipo_ajuste_validate_ta_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "ta_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ta_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "ta_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ta_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_id__cb

  // ---------- Validate ta_descripcion_
  function do_ajax_form_inv_tipo_ajuste_validate_ta_descripcion_(iNumLinha)
  {
    var nomeCampo_ta_descripcion_ = "ta_descripcion_" + iNumLinha;
    var var_ta_descripcion_ = scAjaxGetFieldText(nomeCampo_ta_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_tipo_ajuste_validate_ta_descripcion_(var_ta_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_inv_tipo_ajuste_validate_ta_descripcion__cb);
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_descripcion_

  function do_ajax_form_inv_tipo_ajuste_validate_ta_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ta_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ta_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ta_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ta_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_descripcion__cb

  // ---------- Validate ta_tipo_
  function do_ajax_form_inv_tipo_ajuste_validate_ta_tipo_(iNumLinha)
  {
    var nomeCampo_ta_tipo_ = "ta_tipo_" + iNumLinha;
    var var_ta_tipo_ = scAjaxGetFieldSelect(nomeCampo_ta_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_tipo_ajuste_validate_ta_tipo_(var_ta_tipo_, iNumLinha, var_script_case_init, do_ajax_form_inv_tipo_ajuste_validate_ta_tipo__cb);
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_tipo_

  function do_ajax_form_inv_tipo_ajuste_validate_ta_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ta_tipo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ta_tipo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ta_tipo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ta_tipo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_tipo__cb

  // ---------- Validate ta_movimiento_kardex_
  function do_ajax_form_inv_tipo_ajuste_validate_ta_movimiento_kardex_(iNumLinha)
  {
    var nomeCampo_ta_movimiento_kardex_ = "ta_movimiento_kardex_" + iNumLinha;
    var var_ta_movimiento_kardex_ = scAjaxGetFieldSelect(nomeCampo_ta_movimiento_kardex_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_tipo_ajuste_validate_ta_movimiento_kardex_(var_ta_movimiento_kardex_, iNumLinha, var_script_case_init, do_ajax_form_inv_tipo_ajuste_validate_ta_movimiento_kardex__cb);
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_movimiento_kardex_

  function do_ajax_form_inv_tipo_ajuste_validate_ta_movimiento_kardex__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ta_movimiento_kardex_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ta_movimiento_kardex_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ta_movimiento_kardex_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ta_movimiento_kardex_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_movimiento_kardex__cb

  // ---------- Validate ta_empresa_
  function do_ajax_form_inv_tipo_ajuste_validate_ta_empresa_(iNumLinha)
  {
    var nomeCampo_ta_empresa_ = "ta_empresa_" + iNumLinha;
    var var_ta_empresa_ = scAjaxGetFieldText(nomeCampo_ta_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_tipo_ajuste_validate_ta_empresa_(var_ta_empresa_, iNumLinha, var_script_case_init, do_ajax_form_inv_tipo_ajuste_validate_ta_empresa__cb);
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_empresa_

  function do_ajax_form_inv_tipo_ajuste_validate_ta_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ta_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ta_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ta_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ta_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_empresa__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_inv_tipo_ajuste_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_inv_tipo_ajuste_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_tipo_ajuste_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_inv_tipo_ajuste_add_new_line_cb);
  } // do_ajax_form_inv_tipo_ajuste_add_new_line

  function do_ajax_form_inv_tipo_ajuste_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_inv_tipo_ajuste_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_inv_tipo_ajuste_backup_line(iNumLinha)
  {
    var var_ta_id_ = scAjaxGetFieldHidden("ta_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_tipo_ajuste_backup_line(var_ta_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_inv_tipo_ajuste_backup_line_cb);
  } // do_ajax_form_inv_tipo_ajuste_backup_line

  function do_ajax_form_inv_tipo_ajuste_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_inv_tipo_ajuste_backup_line_cb

  function do_ajax_form_inv_tipo_ajuste_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_inv_tipo_ajuste_cancel_insert

  function do_ajax_form_inv_tipo_ajuste_cancel_update(iSeqVert)
  {
    do_ajax_form_inv_tipo_ajuste_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_inv_tipo_ajuste_cancel_update

  function do_ajax_form_inv_tipo_ajuste_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_inv_tipo_ajuste_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_inv_tipo_ajuste_table_refresh()
  {
    var var_ta_id_ = document.F2.ta_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_inv_tipo_ajuste_table_refresh(var_ta_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_tipo_ajuste_table_refresh_cb);
  } //  do_ajax_form_inv_tipo_ajuste_table_refresh

  function do_ajax_form_inv_tipo_ajuste_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.ta_id_.value = scAjaxGetKeyValue("ta_id_");
    ...
    scAjaxAlert(do_ajax_form_inv_tipo_ajuste_table_refresh_cb_after_alert);
  } // do_ajax_form_inv_tipo_ajuste_table_refresh_cb
  function do_ajax_form_inv_tipo_ajuste_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_inv_tipo_ajuste_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_inv_tipo_ajuste_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_inv_tipo_ajuste_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_ta_id_ = scAjaxGetFieldHidden("ta_id_" + iNumLinha);
    var var_ta_descripcion_ = scAjaxGetFieldText("ta_descripcion_" + iNumLinha);
    var var_ta_tipo_ = scAjaxGetFieldSelect("ta_tipo_" + iNumLinha);
    var var_ta_movimiento_kardex_ = scAjaxGetFieldSelect("ta_movimiento_kardex_" + iNumLinha);
    var var_ta_empresa_ = scAjaxGetFieldText("ta_empresa_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_inv_tipo_ajuste_submit_form(var_ta_id_, var_ta_descripcion_, var_ta_tipo_, var_ta_movimiento_kardex_, var_ta_empresa_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_tipo_ajuste_submit_form_cb);
  } // do_ajax_form_inv_tipo_ajuste_submit_form

  function do_ajax_form_inv_tipo_ajuste_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ta_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ta_descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ta_tipo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ta_movimiento_kardex_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ta_empresa_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inv_tipo_ajuste_submit_form_cb_after_alert);
  } // do_ajax_form_inv_tipo_ajuste_submit_form_cb
  function do_ajax_form_inv_tipo_ajuste_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_tipo_ajuste_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_inv_tipo_ajuste_navigate_form()
  {
    perform_ajax_form_inv_tipo_ajuste_navigate_form();
  }

  function perform_ajax_form_inv_tipo_ajuste_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_inv_tipo_ajuste_cancel_insert(sc_form_inv_tipo_ajuste_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("ta_id_" + iNavForm);
      scAjaxHideErrorDisplay("ta_descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("ta_tipo_" + iNavForm);
      scAjaxHideErrorDisplay("ta_movimiento_kardex_" + iNavForm);
      scAjaxHideErrorDisplay("ta_empresa_" + iNavForm);
    }
    var var_ta_id_ = document.F2.ta_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_inv_tipo_ajuste_navigate_form(var_ta_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_tipo_ajuste_navigate_form_cb);
  } // do_ajax_form_inv_tipo_ajuste_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_tipo_ajuste']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_tipo_ajuste_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ta_id_.value = scAjaxGetKeyValue("ta_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_tipo_ajuste_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_tipo_ajuste_navigate_form_cb
  function do_ajax_form_inv_tipo_ajuste_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_inv_tipo_ajuste_navigate_form_cb_after_alert

    function sc_form_inv_tipo_ajuste_get_last_line_number()
    {
    ...
    } //sc_form_inv_tipo_ajuste_get_last_line_number

  function sc_hide_form_inv_tipo_ajuste_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "ta_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ta_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ta_tipo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ta_movimiento_kardex_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ta_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["ta_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ta_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ta_tipo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ta_movimiento_kardex_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_movimiento_kardex'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ta_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["ta_id_"][iNumLinha] = "ta_id_" + iNumLinha;
    ajax_field_mult["ta_descripcion_"][iNumLinha] = "ta_descripcion_" + iNumLinha;
    ajax_field_mult["ta_tipo_"][iNumLinha] = "ta_tipo_" + iNumLinha;
    ajax_field_mult["ta_movimiento_kardex_"][iNumLinha] = "ta_movimiento_kardex_" + iNumLinha;
    ajax_field_mult["ta_empresa_"][iNumLinha] = "ta_empresa_" + iNumLinha;
    ajax_field_id["ta_descripcion_" + iNumLinha] = new Array("hidden_field_label_ta_descripcion_", "hidden_field_data_ta_descripcion_" + iNumLinha);
    ajax_field_id["ta_tipo_" + iNumLinha] = new Array("hidden_field_label_ta_tipo_", "hidden_field_data_ta_tipo_" + iNumLinha);
    ajax_field_id["ta_movimiento_kardex_" + iNumLinha] = new Array("hidden_field_label_ta_movimiento_kardex_", "hidden_field_data_ta_movimiento_kardex_" + iNumLinha);
    ajax_error_count["ta_id_" + iNumLinha] = "off";
    ajax_error_count["ta_descripcion_" + iNumLinha] = "off";
    ajax_error_count["ta_tipo_" + iNumLinha] = "off";
    ajax_error_count["ta_movimiento_kardex_" + iNumLinha] = "off";
    ajax_error_count["ta_empresa_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["ta_id_" + iNumLinha] = "on";
    ajax_read_only["ta_descripcion_" + iNumLinha] = "off";
    ajax_read_only["ta_tipo_" + iNumLinha] = "off";
    ajax_read_only["ta_movimiento_kardex_" + iNumLinha] = "off";
    ajax_read_only["ta_empresa_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["ta_id_" + iNumLinha] = "on";
    ajax_read_only["ta_descripcion_" + iNumLinha] = "on";
    ajax_read_only["ta_tipo_" + iNumLinha] = "on";
    ajax_read_only["ta_movimiento_kardex_" + iNumLinha] = "on";
    ajax_read_only["ta_empresa_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["ta_id_" + iNumLinha] = null;
    ajax_error_list["ta_descripcion_" + iNumLinha] = null;
    ajax_error_list["ta_tipo_" + iNumLinha] = null;
    ajax_error_list["ta_movimiento_kardex_" + iNumLinha] = null;
    ajax_error_list["ta_empresa_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "ta_id_": new Array(),
    "ta_descripcion_": new Array(),
    "ta_tipo_": new Array(),
    "ta_movimiento_kardex_": new Array(),
    "ta_empresa_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["ta_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ta_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ta_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ta_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ta_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ta_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ta_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ta_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ta_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ta_descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ta_tipo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ta_tipo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ta_tipo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ta_tipo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ta_tipo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ta_movimiento_kardex_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ta_movimiento_kardex_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ta_movimiento_kardex_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ta_movimiento_kardex_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ta_movimiento_kardex_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ta_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ta_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ta_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ta_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ta_empresa_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ta_id_'])) ? $this->nmgp_cmp_readonly['ta_id_'] : 'on';
?>
    scAjaxFieldRead("ta_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ta_descripcion_'])) ? $this->nmgp_cmp_readonly['ta_descripcion_'] : 'off';
?>
    scAjaxFieldRead("ta_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ta_tipo_'])) ? $this->nmgp_cmp_readonly['ta_tipo_'] : 'off';
?>
    scAjaxFieldRead("ta_tipo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ta_movimiento_kardex_'])) ? $this->nmgp_cmp_readonly['ta_movimiento_kardex_'] : 'off';
?>
    scAjaxFieldRead("ta_movimiento_kardex_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ta_empresa_'])) ? $this->nmgp_cmp_readonly['ta_empresa_'] : 'off';
?>
    scAjaxFieldRead("ta_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("ta_id_" + iSeq, "on");
    scAjaxFieldRead("ta_descripcion_" + iSeq, "on");
    scAjaxFieldRead("ta_tipo_" + iSeq, "on");
    scAjaxFieldRead("ta_movimiento_kardex_" + iSeq, "on");
    scAjaxFieldRead("ta_empresa_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["ta_id_" + iRow] || "on" == ajax_error_count["ta_descripcion_" + iRow] || "on" == ajax_error_count["ta_tipo_" + iRow] || "on" == ajax_error_count["ta_movimiento_kardex_" + iRow] || "on" == ajax_error_count["ta_empresa_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ta_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ta_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ta_tipo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ta_movimiento_kardex_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ta_empresa_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["ta_id_" + iRow] && "off" == ajax_error_count["ta_descripcion_" + iRow] && "off" == ajax_error_count["ta_tipo_" + iRow] && "off" == ajax_error_count["ta_movimiento_kardex_" + iRow] && "off" == ajax_error_count["ta_empresa_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["ta_id_" + iRow] = "off";
        ajax_error_count["ta_descripcion_" + iRow] = "off";
        ajax_error_count["ta_tipo_" + iRow] = "off";
        ajax_error_count["ta_movimiento_kardex_" + iRow] = "off";
        ajax_error_count["ta_empresa_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_ta_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ta_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ta_tipo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ta_movimiento_kardex_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ta_empresa_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("ta_movimiento_kardex_" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
