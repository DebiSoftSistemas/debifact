...
class grid_v_sis_reporte_ventas_comisionistas_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_mes;
   var $array_total_com_ruc;
   var $array_total_com_razon_social;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_com_ruc          = array();
      $this->array_total_com_razon_social = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_v_sis_reporte_ventas_comisionistas']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_v_sis_reporte_ventas_comisionistas']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['tot_geral'][4];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['tot_geral'][5];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['arr_total']['periodo'] = $this->array_total_periodo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['arr_total']['mes'] = $this->array_total_mes;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['arr_total']['com_ruc'] = $this->array_total_com_ruc;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['arr_total']['com_razon_social'] = $this->array_total_com_razon_social;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['json_use_label'])
       {
          $Lab_periodo = "periodo";
          $Lab_mes = "mes";
          $Lab_com_ruc = "com_ruc";
          $Lab_com_razon_social = "com_razon_social";
       }
       else
       {
       $Lab_periodo = "" . $this->Ini->Nm_lang['lang_periodo'] . "";
       $Lab_mes = "" . $this->Ini->Nm_lang['lang_srch_mnth'] . "";
       $Lab_com_ruc = "" . $this->Ini->Nm_lang['lang_comisionistas'] . "";
       $Lab_com_razon_social = "" . $this->Ini->Nm_lang['lang_nombre'] . "";
       }
       $prep_field = array();
       $prep_field['periodo'] = $Lab_periodo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['periodo'] = $Lab_periodo; 
       $prep_field['mes'] = $Lab_mes;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['mes'] = $Lab_mes; 
       $prep_field['com_ruc'] = $Lab_com_ruc;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['com_ruc'] = $Lab_com_ruc; 
       $prep_field['com_razon_social'] = $Lab_com_razon_social;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['com_razon_social'] = $Lab_com_razon_social; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['mes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['mes'] = "" . $this->Ini->Nm_lang['lang_srch_mnth'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['periodo'] = "" . $this->Ini->Nm_lang['lang_periodo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['emp_ruc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['emp_ruc'] = "" . $this->Ini->Nm_lang['lang_cliente'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['emp_razon_social']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['emp_razon_social'] = "" . $this->Ini->Nm_lang['lang_razon_social'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_serie'] = "" . $this->Ini->Nm_lang['lang_serie_sri'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_numero_doc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_numero_doc'] = "" . $this->Ini->Nm_lang['lang_secuencial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_base_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_base_iva'] = "" . $this->Ini->Nm_lang['lang_base_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_total_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_total_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_total'] = "" . $this->Ini->Nm_lang['lang_total'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['com_ruc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['com_ruc'] = "" . $this->Ini->Nm_lang['lang_comisionistas'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['com_razon_social']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['com_razon_social'] = "" . $this->Ini->Nm_lang['lang_nombre'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['com_porcentaje_comision']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['com_porcentaje_comision'] = "" . $this->Ini->Nm_lang['lang_porcentaje_comision'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['valor_comision']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['valor_comision'] = "Valor Comisión"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_primera_compra']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['labels']['fac_primera_compra'] = "Primera Compra"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "" .  $this->Ini->Nm_lang['lang_base_iva'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "" .  $this->Ini->Nm_lang['lang_iva'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "" .  $this->Ini->Nm_lang['lang_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           5 => "Valor Comisión (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "fac_base_iva", 'show' => true),
           3 => array('field' => "fac_total_iva", 'show' => true),
           4 => array('field' => "fac_total", 'show' => true),
           5 => array('field' => "valor_comision", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_fac_base_iva_sum",
           3 => "css_fac_total_iva_sum",
           4 => "css_fac_total_sum",
           5 => "css_valor_comision_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['com_ruc']['alin'] = "''";
       $Arr_parms['com_ruc']['link'] = "S";
       $Arr_parms['com_razon_social']['alin'] = "''";
       $Arr_parms['com_razon_social']['link'] = "S";
       ...
       $Arr_parms['periodo']['order_datatype'] = 'int4';
       $Arr_parms['periodo']['rating_function'] = '';
       ...
       $Arr_parms['mes']['order_datatype'] = 'int4';
       $Arr_parms['mes']['rating_function'] = '';
       $Arr_parms['com_ruc']['fill'] = "true";
       $Arr_parms['com_ruc']['order'] = "label";
       $Arr_parms['com_ruc']['order_start'] = 'asc';
       $Arr_parms['com_ruc']['order_invert'] = 'false';
       $Arr_parms['com_ruc']['order_enabled'] = 'true';
       $Arr_parms['com_ruc']['order_datatype'] = 'varchar';
       $Arr_parms['com_ruc']['rating_function'] = '';
       $Arr_parms['com_razon_social']['fill'] = "true";
       $Arr_parms['com_razon_social']['order'] = "label";
       $Arr_parms['com_razon_social']['order_start'] = 'asc';
       $Arr_parms['com_razon_social']['order_invert'] = 'false';
       $Arr_parms['com_razon_social']['order_enabled'] = 'true';
       $Arr_parms['com_razon_social']['order_datatype'] = 'varchar';
       $Arr_parms['com_razon_social']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['mes'] = array(0 => 'mes', 1 => '');
       $prep_links_fl['com_ruc'] = array(0 => 'com_ruc', 1 => '@aspass@');
       $prep_links_fl['com_razon_social'] = array(0 => 'com_razon_social', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_sis_reporte_ventas_comisionistas@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_v_sis_reporte_ventas_comisionistas_total.class.php"); 
      }
      ...
      $this->Total   = new grid_v_sis_reporte_ventas_comisionistas_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " v_sis_reporte_ventas_comisionistas</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['ajax_nav']) {  
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_sis_reporte_ventas_comisionistas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_v_sis_reporte_ventas_comisionistas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_sis_reporte_ventas_comisionistas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_sis_reporte_ventas_comisionistas/grid_v_sis_reporte_ventas_comisionistas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_v_sis_reporte_ventas_comisionistas/grid_v_sis_reporte_ventas_comisionistas_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_sis_reporte_ventas_comisionistas/grid_v_sis_reporte_ventas_comisionistas_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume&nm_all_modules=grid,resume&nm_json_format=N&nm_json_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_sis_reporte_ventas_comisionistas/grid_v_sis_reporte_ventas_comisionistas_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_sis_reporte_ventas_comisionistas/grid_v_sis_reporte_ventas_comisionistas_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_sis_reporte_ventas_comisionistas/grid_v_sis_reporte_ventas_comisionistas_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_v_sis_reporte_ventas_comisionistas_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_sis_reporte_ventas_comisionistas']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_sis_reporte_ventas_comisionistas']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_v_sis_reporte_ventas_comisionistas_config_pivot.php?nome_apl=grid_v_sis_reporte_ventas_comisionistas&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_v_sis_reporte_ventas_comisionistas_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_sis_reporte_ventas_comisionistas_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_v_sis_reporte_ventas_comisionistas/grid_v_sis_reporte_ventas_comisionistas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $periodo = (isset($Busca_temp['periodo'])) ? $Busca_temp['periodo'] : ""; 
          $tmp_pos = (is_string($periodo)) ? strpos($periodo, "##@@") : false;
          ...
          $com_ruc = (isset($Busca_temp['com_ruc'])) ? $Busca_temp['com_ruc'] : ""; 
          $tmp_pos = (is_string($com_ruc)) ? strpos($com_ruc, "##@@") : false;
          if ($tmp_pos !== false && !is_array($com_ruc))
          {
              $com_ruc = substr($com_ruc, 0, $tmp_pos);
          }
          $com_razon_social = (isset($Busca_temp['com_razon_social'])) ? $Busca_temp['com_razon_social'] : ""; 
          $tmp_pos = (is_string($com_razon_social)) ? strpos($com_razon_social, "##@@") : false;
          if ($tmp_pos !== false && !is_array($com_razon_social))
          {
              $com_razon_social = substr($com_razon_social, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($sum_fac_base_iva, $sum_fac_total_iva, $sum_fac_total, $sum_valor_comision, $quebra_periodo, $quebra_mes, $quebra_com_ruc, $quebra_com_razon_social, $quebra_periodo_orig, $quebra_mes_orig, $quebra_com_ruc_orig, $quebra_com_razon_social_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_sis_reporte_ventas_comisionistas']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_fac_base_iva)) {$sum_fac_base_iva = '0';}
          if (empty($sum_fac_total_iva)) {$sum_fac_total_iva = '0';}
          if (empty($sum_fac_total)) {$sum_fac_total = '0';}
          if (empty($sum_valor_comision)) {$sum_valor_comision = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_fac_base_iva . ';
              $this->' . $arr_name . '[2] = ' . $sum_fac_total_iva . ';
              $this->' . $arr_name . '[3] = ' . $sum_fac_total . ';
              $this->' . $arr_name . '[4] = ' . $sum_valor_comision . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_fac_base_iva . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_fac_total_iva . ', 10);
              $this->' . $arr_name . '[3] = bcadd($this->' . $arr_name . '[3], ' . $sum_fac_total . ', 10);
              $this->' . $arr_name . '[4] = bcadd($this->' . $arr_name . '[4], ' . $sum_valor_comision . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->com_ruc = $Busca_temp['com_ruc']; 
       $this->com_ruc = (isset($Busca_temp['com_ruc'])) ? $Busca_temp['com_ruc'] : ""; 
       $tmp_pos = (is_string($this->com_ruc)) ? strpos($this->com_ruc, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->com_ruc))
       {
       ...
       $this->com_razon_social = $Busca_temp['com_razon_social']; 
       $this->com_razon_social = (isset($Busca_temp['com_razon_social'])) ? $Busca_temp['com_razon_social'] : ""; 
       $tmp_pos = (is_string($this->com_razon_social)) ? strpos($this->com_razon_social, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->com_razon_social))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->periodo = $rs_res->fields[2] ;  
            $this->emp_ruc = $rs_res->fields[3] ;  
            $this->emp_razon_social = $rs_res->fields[4] ;  
            $this->fac_serie = $rs_res->fields[5] ;  
            $this->fac_numero_doc = $rs_res->fields[6] ;  
            $this->fac_base_iva = $rs_res->fields[7] ;  
            $this->fac_total_iva = $rs_res->fields[8] ;  
            $this->fac_total = $rs_res->fields[9] ;  
            $this->com_ruc = $rs_res->fields[10] ;  
            $this->com_razon_social = $rs_res->fields[11] ;  
            $this->com_porcentaje_comision = $rs_res->fields[12] ;  
            $this->valor_comision = $rs_res->fields[13] ;  
            $this->fac_primera_compra = $rs_res->fields[14] ;  
            $this->periodo_orig = $this->periodo;
            $this->mes_orig = $this->mes;
            $this->com_ruc_orig = $this->com_ruc;
            $this->com_razon_social_orig = $this->com_razon_social;
            nmgp_Form_Num_Val($this->periodo, "", ",", "0", "S", "2", "", "N:", "-") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->fac_base_iva, $this->fac_total_iva, $this->fac_total, $this->valor_comision, $this->periodo, $this->mes, $this->com_ruc, $this->com_razon_social, $this->periodo_orig,  $this->mes_orig,  $this->com_ruc_orig,  $this->com_razon_social_orig);
            }
   }
//
