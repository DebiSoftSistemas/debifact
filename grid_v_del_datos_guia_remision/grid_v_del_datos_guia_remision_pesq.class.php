...
class grid_v_del_datos_guia_remision_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_v_del_datos_guia_remision_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_v_del_datos_guia_remision_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_v_del_datos_guia_remision_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_gr_tipo_comprobante')
      {
          $gr_tipo_comprobante = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_gr_tipo_comprobante($gr_tipo_comprobante);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_gr_empresa')
      {
          $gr_empresa = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_gr_empresa($gr_empresa);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      $Nm_datas[] = "gr_fecha_ini_transporte";$Nm_datas[] = "gr_fecha_fin_transporte";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "v_del_datos_guia_remision.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> v_del_datos_guia_remision</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_v_del_datos_guia_remision/grid_v_del_datos_guia_remision_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_v_del_datos_guia_remision_ajax_search.js"></script>
 <script type="text/javascript" src="grid_v_del_datos_guia_remision_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_v_del_datos_guia_remision_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_v_del_datos_guia_remision']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_v_del_datos_guia_remision']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_gr_numero_cond#NMF#' + search_get_sel_txt('SC_gr_numero_cond') + '@NMF@';
  str_out += 'SC_gr_numero#NMF#' + search_get_text('SC_gr_numero') + '@NMF@';
  str_out += 'SC_gr_tipo_comprobante_cond#NMF#' + search_get_sel_txt('SC_gr_tipo_comprobante_cond') + '@NMF@';
  str_out += 'SC_gr_tipo_comprobante#NMF#' + search_get_text('SC_gr_tipo_comprobante') + '@NMF@';
  str_out += 'id_ac_gr_tipo_comprobante#NMF#' + search_get_title('select2-id_ac_gr_tipo_comprobante-container') + '@NMF@';
  str_out += 'SC_gr_empresa_cond#NMF#' + search_get_sel_txt('SC_gr_empresa_cond') + '@NMF@';
  str_out += 'SC_gr_empresa#NMF#' + search_get_text('SC_gr_empresa') + '@NMF@';
  str_out += 'id_ac_gr_empresa#NMF#' + search_get_title('select2-id_ac_gr_empresa-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-gr_tipo_comprobante").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_gr_tipo_comprobante",
      max_itens: "10",
   ...
   $("#SC_gr_tipo_comprobante").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-gr_empresa").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_gr_empresa",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_gr_empresa").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $gr_numero_cond, $gr_numero,
             $gr_tipo_comprobante_cond, $gr_tipo_comprobante, $gr_tipo_comprobante_autocomp,
             $gr_empresa_cond, $gr_empresa, $gr_empresa_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $gr_numero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['gr_numero']; 
          $gr_numero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['gr_numero_cond']; 
          $gr_tipo_comprobante = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['gr_tipo_comprobante']; 
          $gr_tipo_comprobante_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['gr_tipo_comprobante_cond']; 
          $gr_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['gr_empresa']; 
          $gr_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['gr_empresa_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['NM_operador']; 
          if (strtoupper($gr_numero_cond) != "II" && strtoupper($gr_numero_cond) != "QP" && strtoupper($gr_numero_cond) != "NP" && strtoupper($gr_numero_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($gr_numero, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($gr_numero_cond) || empty($gr_numero_cond))
      {
         $gr_numero_cond = "gt";
      }
      if (!isset($gr_tipo_comprobante_cond) || empty($gr_tipo_comprobante_cond))
      {
         $gr_tipo_comprobante_cond = "qp";
      }
      if (!isset($gr_empresa_cond) || empty($gr_empresa_cond))
      {
         $gr_empresa_cond = "qp";
      }
      ...
      $str_hide_gr_numero = (in_array($gr_numero_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_gr_tipo_comprobante = (in_array($gr_tipo_comprobante_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_gr_empresa = (in_array($gr_empresa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($gr_numero) || $gr_numero == "")
      {
          $gr_numero = "";
      }
      if (isset($gr_numero) && !empty($gr_numero))
      {
      ...
      if (!isset($gr_tipo_comprobante) || $gr_tipo_comprobante == "")
      {
          $gr_tipo_comprobante = "";
      }
      if (isset($gr_tipo_comprobante) && !empty($gr_tipo_comprobante))
      {
      ...
      if (!isset($gr_empresa) || $gr_empresa == "")
      {
          $gr_empresa = "";
      }
      if (isset($gr_empresa) && !empty($gr_empresa))
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_gr_numero_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['gr_numero'])) ? $this->New_label['gr_numero'] : "" . $this->Ini->Nm_lang['lang_id'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_gr_numero_cond" name="gr_numero_cond" onChange="nm_campos_between(document.getElementById('id_vis_gr_numero'), this, 'gr_numero')">
       <OPTION value="gt" <?php if ("gt" == $gr_numero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $gr_numero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $gr_numero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_gr_numero" <?php echo $str_hide_gr_numero?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['gr_numero'])) ? $this->New_label['gr_numero'] : "" . $this->Ini->Nm_lang['lang_id'] . "";
 $nmgp_tab_label .= "gr_numero?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_gr_numero" name="gr_numero" value="<?php echo NM_encode_input($gr_numero) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_gr_tipo_comprobante_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['gr_tipo_comprobante'])) ? $this->New_label['gr_tipo_comprobante'] : "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_gr_tipo_comprobante_cond" name="gr_tipo_comprobante_cond" onChange="nm_campos_between(document.getElementById('id_vis_gr_tipo_comprobante'), this, 'gr_tipo_comprobante')">
       <OPTION value="qp" <?php if ("qp" == $gr_tipo_comprobante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $gr_tipo_comprobante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $gr_tipo_comprobante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $gr_tipo_comprobante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_gr_tipo_comprobante" <?php echo $str_hide_gr_tipo_comprobante?> valign="top">
 ...
 $nmgp_tab_label .= "gr_tipo_comprobante?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $gr_tipo_comprobante;
      }
?>
<INPUT  type="text" id="SC_gr_tipo_comprobante" name="gr_tipo_comprobante" value="<?php echo NM_encode_input($gr_tipo_comprobante) ?>"  size=2 alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-gr_tipo_comprobante" id="id_ac_gr_tipo_comprobante" name="gr_tipo_comprobante_autocomp"><?php if ('' !=  $gr_tipo_comprobante) { ?><option value="<?php echo $gr_tipo_comprobante ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_gr_empresa_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['gr_empresa'])) ? $this->New_label['gr_empresa'] : "" . $this->Ini->Nm_lang['lang_empresa'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_gr_empresa_cond" name="gr_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_gr_empresa'), this, 'gr_empresa')">
       <OPTION value="qp" <?php if ("qp" == $gr_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $gr_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $gr_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $gr_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_gr_empresa" <?php echo $str_hide_gr_empresa?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['gr_empresa'])) ? $this->New_label['gr_empresa'] : "" . $this->Ini->Nm_lang['lang_empresa'] . "";
 $nmgp_tab_label .= "gr_empresa?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $gr_empresa;
      }
?>
<INPUT  type="text" id="SC_gr_empresa" name="gr_empresa" value="<?php echo NM_encode_input($gr_empresa) ?>"  size=13 alt="{datatype: 'text', maxLength: 13, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-gr_empresa" id="id_ac_gr_empresa" name="gr_empresa_autocomp"><?php if ('' !=  $gr_empresa) { ?><option value="<?php echo $gr_empresa ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_v_del_datos_guia_remision_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_datos_guia_remision']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_datos_guia_remision']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.gr_numero_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_gr_numero'), document.F1.gr_numero_cond, 'gr_numero');
   document.F1.gr_numero.value = "";
   document.F1.gr_tipo_comprobante_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_gr_tipo_comprobante'), document.F1.gr_tipo_comprobante_cond, 'gr_tipo_comprobante');
   document.F1.gr_tipo_comprobante.value = "";
   document.F1.gr_tipo_comprobante_autocomp.value = "";
   $('#select2-id_ac_gr_tipo_comprobante-container').html('<?php echo $this->Val_init_gr_tipo_comprobante['desc'] ?>');;
   document.F1.gr_empresa_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_gr_empresa'), document.F1.gr_empresa_cond, 'gr_empresa');
   document.F1.gr_empresa.value = "";
   document.F1.gr_empresa_autocomp.value = "";
   $('#select2-id_ac_gr_empresa-container').html('<?php echo $this->Val_init_gr_empresa['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_v_del_datos_guia_remision/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_gr_numero_cond'] = 'cond';
      $tp_fields['SC_gr_numero'] = 'text';
      $tp_fields['SC_gr_tipo_comprobante_cond'] = 'cond';
      $tp_fields['SC_gr_tipo_comprobante'] = 'text_aut';
      $tp_fields['id_ac_gr_tipo_comprobante'] = 'select2_aut';
      $tp_fields['SC_gr_empresa_cond'] = 'cond';
      $tp_fields['SC_gr_empresa'] = 'text_aut';
      $tp_fields['id_ac_gr_empresa'] = 'select2_aut';
   ...
   {
      global $gr_numero_cond, $gr_numero,
             $gr_tipo_comprobante_cond, $gr_tipo_comprobante, $gr_tipo_comprobante_autocomp,
             $gr_empresa_cond, $gr_empresa, $gr_empresa_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($gr_tipo_comprobante_autocomp) && empty($gr_tipo_comprobante))
      {
          $gr_tipo_comprobante = $gr_tipo_comprobante_autocomp;
      }
      if (!empty($gr_empresa_autocomp) && empty($gr_empresa))
      {
          $gr_empresa = $gr_empresa_autocomp;
      }
      $gr_numero_cond_salva = $gr_numero_cond; 
      if (!isset($gr_numero_input_2) || $gr_numero_input_2 == "")
      {
          $gr_numero_input_2 = $gr_numero;
      }
      $gr_tipo_comprobante_cond_salva = $gr_tipo_comprobante_cond; 
      if (!isset($gr_tipo_comprobante_input_2) || $gr_tipo_comprobante_input_2 == "")
      {
          $gr_tipo_comprobante_input_2 = $gr_tipo_comprobante;
      }
      $gr_empresa_cond_salva = $gr_empresa_cond; 
      if (!isset($gr_empresa_input_2) || $gr_empresa_input_2 == "")
      {
          $gr_empresa_input_2 = $gr_empresa;
      }
      if ($gr_numero_cond != "in")
      {
          nm_limpa_numero($gr_numero, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['gr_numero'] = $gr_numero; 
      if (is_array($gr_numero) && !empty($gr_numero))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid]['val'][0] = $gr_numero;
      }
      elseif ($gr_numero_cond_salva == "nu" || $gr_numero_cond_salva == "nn" || $gr_numero_cond_salva == "ep" || $gr_numero_cond_salva == "ne" || !empty($gr_numero))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid]['val'][0][0] = $gr_numero;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['gr_numero_cond'] = $gr_numero_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid]['cmp'] = "gr_numero"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid]['opc'] = $gr_numero_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq']['gr_numero'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['gr_tipo_comprobante'] = $gr_tipo_comprobante; 
      if (is_array($gr_tipo_comprobante) && !empty($gr_tipo_comprobante))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid]['val'][0] = $gr_tipo_comprobante;
      }
      elseif ($gr_tipo_comprobante_cond_salva == "nu" || $gr_tipo_comprobante_cond_salva == "nn" || $gr_tipo_comprobante_cond_salva == "ep" || $gr_tipo_comprobante_cond_salva == "ne" || !empty($gr_tipo_comprobante))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid]['val'][0][0] = $gr_tipo_comprobante;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['gr_tipo_comprobante_cond'] = $gr_tipo_comprobante_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid]['cmp'] = "gr_tipo_comprobante"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid]['opc'] = $gr_tipo_comprobante_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq']['gr_tipo_comprobante'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['gr_empresa'] = $gr_empresa; 
      if (is_array($gr_empresa) && !empty($gr_empresa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid]['val'][0] = $gr_empresa;
      }
      elseif ($gr_empresa_cond_salva == "nu" || $gr_empresa_cond_salva == "nn" || $gr_empresa_cond_salva == "ep" || $gr_empresa_cond_salva == "ne" || !empty($gr_empresa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid]['val'][0][0] = $gr_empresa;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['gr_empresa_cond'] = $gr_empresa_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid]['cmp'] = "gr_empresa"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid]['opc'] = $gr_empresa_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['grid_pesq']['gr_empresa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['gr_numero'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($gr_tipo_comprobante != '') {
      $gr_tipo_comprobante_look = (is_string($gr_tipo_comprobante) ? substr($this->Db->qstr($gr_tipo_comprobante), 1, -1) : $gr_tipo_comprobante); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['gr_tipo_comprobante'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['gr_tipo_comprobante'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['gr_tipo_comprobante'] = $gr_tipo_comprobante;
      }
      $nmgp_def_dados = array();
    if ($gr_empresa != '') {
      $gr_empresa_look = (is_string($gr_empresa) ? substr($this->Db->qstr($gr_empresa), 1, -1) : $gr_empresa); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['gr_empresa'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['gr_empresa'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['gr_empresa'] = $gr_empresa;
      }

      //----- $gr_numero
      $this->Date_part = false;
      if (isset($gr_numero) || $gr_numero_cond == "nu" || $gr_numero_cond == "nn" || $gr_numero_cond == "ep" || $gr_numero_cond == "ne")
      {
         $this->monta_condicao("gr_numero", $gr_numero_cond, $gr_numero, "", "gr_numero", "INT4", false);
      }

      //----- $gr_tipo_comprobante
      $this->Date_part = false;
      if (isset($gr_tipo_comprobante) || $gr_tipo_comprobante_cond == "nu" || $gr_tipo_comprobante_cond == "nn" || $gr_tipo_comprobante_cond == "ep" || $gr_tipo_comprobante_cond == "ne")
      {
         $this->monta_condicao("gr_tipo_comprobante", $gr_tipo_comprobante_cond, $gr_tipo_comprobante, "", "gr_tipo_comprobante", "VARCHAR", false);
      }

      //----- $gr_empresa
      $this->Date_part = false;
      if (isset($gr_empresa) || $gr_empresa_cond == "nu" || $gr_empresa_cond == "nn" || $gr_empresa_cond == "ep" || $gr_empresa_cond == "ne")
      {
         $this->monta_condicao("gr_empresa", $gr_empresa_cond, $gr_empresa, "", "gr_empresa", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_guia_remision']['cond_pesq'] .= $this->NM_operador;
