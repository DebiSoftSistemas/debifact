...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "gr_fecha_ini_transporte";$Nm_datas[] = "gr_fecha_fin_transporte";$Nm_numeric[] = "gr_numero";$Nm_numeric[] = "gr_transportista";$Nm_numeric[] = "gr_ambiente";$Nm_numeric[] = "gr_libretin";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_gr_numero_cond" name="gr_numero_cond" onChange="nm_campos_between(document.getElementById('id_vis_gr_numero'), this, 'gr_numero')">
      ...
      <br><span id="id_hide_gr_numero"  <?php echo $str_hide_gr_numero?>><INPUT  type="text" id="SC_gr_numero" name="gr_numero" value="<?php echo NM_encode_input($gr_numero) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_gr_tipo_comprobante_cond" name="gr_tipo_comprobante_cond" onChange="nm_campos_between(document.getElementById('id_vis_gr_tipo_comprobante'), this, 'gr_tipo_comprobante')">
      ...
      <br><span id="id_hide_gr_tipo_comprobante"  <?php echo $str_hide_gr_tipo_comprobante?>><?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_gr_empresa_cond" name="gr_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_gr_empresa'), this, 'gr_empresa')">
      ...
      <br><span id="id_hide_gr_empresa"  <?php echo $str_hide_gr_empresa?>><?php
      if ($gr_empresa != "")
      {
      $gr_empresa_look = (is_string($gr_empresa) ? substr($this->Db->qstr($gr_empresa), 1, -1) : $gr_empresa); 
      $nmgp_def_dados = array(); 
