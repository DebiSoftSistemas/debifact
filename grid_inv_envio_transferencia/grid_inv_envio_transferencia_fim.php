...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_inv_envio_transferencia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_inv_envio_transferencia"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inv_envio_transferencia']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_inv_envio_transferencia']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inv_envio_transferencia']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_inv_envio_transferencia']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_inv_envio_transferencia']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_inv_envio_transferencia</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_inv_envio_transferencia']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_inv_envio_transferencia']['embutida_filho'] as $ind => $sc_init)
          {
