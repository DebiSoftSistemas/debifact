...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____buscar_factura"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____buscar_factura"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_factura']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['buscar_factura']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_factura']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['buscar_factura']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['buscar_factura']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['buscar_factura']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['buscar_factura']['embutida_filho'] as $ind => $sc_init)
          {
