...
class buscar_factura_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . buscar_factura_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . buscar_factura_pack_protect_string($Tipo_filter[0]) . "\">.." . buscar_factura_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>buscar_factura/buscar_factura_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="buscar_factura_ajax_search.js"></script>
 <script type="text/javascript" src="buscar_factura_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="buscar_factura_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['buscar_factura']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['buscar_factura']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_cond']; 
          $fac_secuencial = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fac_secuencial']; 
          $fac_secuencial_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fac_secuencial_cond']; 
          $cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['cl_nombre']; 
          $cl_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['cl_nombre_cond']; 
          $cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['cl_identificacion']; 
          $cl_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['cl_identificacion_cond']; 
          $cl_email = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['cl_email']; 
          $cl_email_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['cl_email_cond']; 
          $fac_comentario = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fac_comentario']; 
          $fac_comentario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fac_comentario_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fecha_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "" . $this->Ini->Nm_lang['lang_fecha'] . ""; ?></TD>
...
?>
<INPUT  type="text" id="SC_cl_nombre" name="cl_nombre" value="<?php echo NM_encode_input($cl_nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
...
?>
<INPUT  type="text" id="SC_cl_email" name="cl_email" value="<?php echo NM_encode_input($cl_email) ?>"  size=50 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: 'lower', autoTab: false, enterTab: false}" style="display: none">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("buscar_factura_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_factura']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['buscar_factura']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_buscar_factura_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_buscar_factura_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_buscar_factura_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_buscar_factura_valida_mes(this)});
 }
 function sc_buscar_factura_valida_dia(obj)
 {
 ...
 function sc_buscar_factura_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      global $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano, $fecha_input_2_dia, $fecha_input_2_mes, $fecha_input_2_ano,
             ...
             $cl_identificacion_cond, $cl_identificacion, $cl_identificacion_autocomp,
             $cl_email_cond, $cl_email, $cl_email_autocomp,
             $fac_comentario_cond, $fac_comentario, $fac_comentario_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['cmp'] = "fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['opc'] = $fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq']['fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fac_secuencial'] = $fac_secuencial; 
      if (is_array($fac_secuencial) && !empty($fac_secuencial))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0] = $fac_secuencial;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0][0] = $fac_secuencial;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fac_secuencial_cond'] = $fac_secuencial_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['cmp'] = "fac_secuencial"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['opc'] = $fac_secuencial_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq']['fac_secuencial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['cl_nombre'] = $cl_nombre; 
      if (is_array($cl_nombre) && !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0] = $cl_nombre;
      }
      elseif ($cl_nombre_cond_salva == "nu" || $cl_nombre_cond_salva == "nn" || $cl_nombre_cond_salva == "ep" || $cl_nombre_cond_salva == "ne" || !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0][0] = $cl_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['cl_nombre_cond'] = $cl_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['cmp'] = "cl_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['opc'] = $cl_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq']['cl_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['cl_identificacion'] = $cl_identificacion; 
      if (is_array($cl_identificacion) && !empty($cl_identificacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0] = $cl_identificacion;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0][0] = $cl_identificacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['cl_identificacion_cond'] = $cl_identificacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['cmp'] = "cl_identificacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['opc'] = $cl_identificacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq']['cl_identificacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['cl_email'] = $cl_email; 
      if (is_array($cl_email) && !empty($cl_email))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0] = $cl_email;
      }
      elseif ($cl_email_cond_salva == "nu" || $cl_email_cond_salva == "nn" || $cl_email_cond_salva == "ep" || $cl_email_cond_salva == "ne" || !empty($cl_email))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0][0] = $cl_email;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['cl_email_cond'] = $cl_email_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['cmp'] = "cl_email"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['opc'] = $cl_email_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq']['cl_email'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fac_comentario'] = $fac_comentario; 
      if (is_array($fac_comentario) && !empty($fac_comentario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0] = $fac_comentario;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['val'][0][0] = $fac_comentario;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fac_comentario_cond'] = $fac_comentario_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['cmp'] = "fac_comentario"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid]['opc'] = $fac_comentario_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq']['fac_comentario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($fac_comentario != '') {
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "ND", "TEXT", $fecha_cond, "aaaa-mm-dd", "data");
          $fecha = $val[0];
          $this->cmp_formatado['fecha'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fecha'], "AAAA-MM-DD");
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']['fecha_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fecha_input_2'], "AAAA-MM-DD");
          ...
          {
              $this->monta_condicao("fecha", $fecha_cond, $fecha, $fecha_input_2, 'fecha', 'TEXT');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq']['fecha']['label'] = $nmgp_tab_label['fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq']['fecha']['descr'] = $nmgp_tab_label['fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['grid_pesq']['fecha']['hint']  = $nmgp_tab_label['fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      if (isset($cl_nombre) && !empty($cl_nombre))
      { 
           $cl_nombre = strtoupper($cl_nombre);
      } 
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_factura']['cond_pesq'] .= $this->NM_operador;
